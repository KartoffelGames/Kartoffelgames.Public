...
`;function ki(){function f(c,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),c.push(l)}}function t(c,n,u,l,o,b,v,E,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=f(l,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(c,n,u,l,o,b,v,E,w){var p=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,C;if(typeof p=="function")h=t(p,l,s,E,o,b,v,w,i),h!==void 0&&(a(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var P=p.length-1;P>=0;P--){var M=p[P];if(h=t(M,l,s,E,o,b,v,w,i),h!==void 0){a(o,h);var N;o===0?N=h:o===1?(N=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,N!==void 0&&(d===void 0?d=N:typeof d=="function"?d=[d,N]:d.push(N))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var L=D,R=0;R<_.length;R++)L=_[R].call(I,L);return L}}else{var V=d;d=function(I,D){return V.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,C;if(h?(x=c,s=s-5,b=b||[],C=b):(x=c.prototype,o=o||[],C=o),s!==0&&!i){var P=h?E:v,M=P.get(d)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!M&&s>2?P.set(d,s):P.set(d,!0)}m(l,x,p,d,s,h,i,C,u)}}return y(l,o),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function T(c,n,u){if(n.length>0){for(var l=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:f(l,E),metadata:u})}finally{E.v=!0}w!==void 0&&(a(10,w),o=w)}return[S(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function S(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return l.length||S(n,v),{e:E,get c(){return T(n,l,v)}}}}function _o(f,t,e,r){return(_o=ki())(f,t,e,r)}var jo,Po,Vo,zo,$o,Go,Bo,Mo,No,Ao,Lo,Ro,Oo,ur;jo=J({selector:"potatno-node-selection-popup",template:Co,style:So}),Vo=H.state({complexValue:!0}),zo=mt("searchInput"),$o=qt("node-select"),Go=H.state(),Bo=H.state();var Fo=class{static{({e:[Mo,No,Ao,Lo,Ro,Oo],c:[ur,Po]}=_o(this,[[Vo,1,"results"],[zo,1,"searchInput"],[$o,1,"mNodeSelect"],[Go,1,"searchValue"],[Bo,1,"selectedDefinitionId"]],[jo]))}constructor(t=O.use(K)){this.mManager=t,this.selectedDefinitionId=null,this.results=new Array,this.searchValue=""}mManager;#t=(Oo(this),Mo(this));get results(){return this.#t}set results(t){this.#t=t}#e=No(this);get searchInput(){return this.#e}set searchInput(t){this.#e=t}#r=Ao(this);get mNodeSelect(){return this.#r}set mNodeSelect(t){this.#r=t}#o=Lo(this);get searchValue(){return this.#o}set searchValue(t){this.#o=t}#n=Ro(this);get selectedDefinitionId(){return this.#n}set selectedDefinitionId(t){this.#n=t}onConnect(){this.searchInput.focus()}onKeyDown(t){if(this.results.length!==0){if(t.key==="ArrowDown"||t.key==="ArrowUp"){t.preventDefault();let e=this.results.findIndex(m=>m.definition.id===this.selectedDefinitionId);e=Math.max(0,e);let r=t.key==="ArrowDown"?1:-1,a=(e+r+this.results.length)%this.results.length;this.selectedDefinitionId=this.results[a].definition.id;return}t.key==="Enter"&&this.sendSelectedEntry(this.selectedDefinitionId)}}onUpdate(){this.rebuildResults()}stopPropagation(t){t.stopPropagation()}rebuildResults(){if(!this.mManager.activeFunction){this.results=new Array;return}let t=this.mManager.activeFunction.dynamicNodeDefinitions.map(r=>({category:r.category.name,definition:r,label:r.label.toLowerCase(),color:this.mManager.generateStringColor(r.category.name),icon:r.category.icon})),e=this.searchValue.trim().toLowerCase();this.results=t.filter(r=>r.label.includes(e)),this.results.some(r=>r.definition.id===this.selectedDefinitionId)||(this.selectedDefinitionId=this.results[0]?.definition.id??null)}sendSelectedEntry(t){if(t===null)return;let e=this.results.find(r=>r.definition.id===t);e&&this.mNodeSelect.dispatchEvent(e.definition)}static{Po()}};var Uo=`:host {\r
    position: absolute;\r
    top: 0;\r
    left: 0;\r
    height: 1px;\r
...
<div class="preview-container" style="height: {{this.windowSize.height}}px; width: {{this.windowSize.width}}px;">
...
return ${a};`)();return{type:e.documentPort.resolvedDataType,execute:()=>y(...m)}}});Tt.preview.addDisplay(new Ee(mi));Tt.preview.addDisplay(new Ee(fi));Tt.preview.addDisplay(new Te(mi));Tt.preview.addDisplay(new Te(fi));var Ds=document.getElementById("application-root"),De=new Xe(Tt);De.appendTo(Ds);De.document=new Mt(Tt);pi();async function pi(){try{await De.update()}catch(f){}requestAnimationFrame(pi)}document.getElementById("load-button").addEventListener("click",Is);document.getElementById("save-button").addEventListener("click",Ss);var gi="potatno-code-document.json";async function Is(){if(window.confirm("Load saved document?"))try{let r=await(await(await navigator.storage.getDirectory()).getFileHandle(gi)).getFile();De.load(await r.text())}catch{window.alert("Could not load document.")}}async function Ss(){if(window.confirm("Override saved document?"))try{let r=await(await(await navigator.storage.getDirectory()).getFileHandle(gi,{create:!0})).createWritable();await r.write(De.save()),await r.close()}catch{window.alert("Could not save document.")}}})();
