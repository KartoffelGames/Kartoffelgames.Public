...
potatno-code-editor {\r
    ...
    width: 100%;\r
    height: 100%;\r
}`;var oe=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new jt(this.mProject);for(let o of t.functions)e.addFunction(this.deserializeFunction(o,e));return e}deserializeFunction(t,e){let o=new Et(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let m of t.imports)o.addImport(m);for(let m of t.inputs)o.addInput({label:m.label,dataType:m.dataType});for(let m of t.outputs)o.addOutput({label:m.label,dataType:m.dataType});let l=new Map;for(let m of t.nodes)l.set(m.id,this.deserializeNode(m,o,e));for(let m of t.connections){if(!l.has(m.sourceNodeId)||!l.has(m.targetNodeId))continue;let g=l.get(m.sourceNodeId),y=l.get(m.targetNodeId),x=g.outputs.map.get(m.sourcePortId),C=y.inputs.map.get(m.targetPortId);!x||!C||x.connect(C)}return o}deserializeNode(t,e,o){let l=o.nodeDefinitions.find(g=>g.id===t.definitionId),m=(()=>{if(l)return e.addNodeByDefinition(l,t.transformation);let g=t.ports.filter(x=>x.direction==="input").map(x=>({dataType:x.dataType,definitionId:x.definitionId,label:x.label,portType:x.portType})),y=t.ports.filter(x=>x.direction==="output").map(x=>({dataType:x.dataType,definitionId:x.definitionId,label:x.label,portType:x.portType}));return new St(this.mProject,o,e,{definitionId:t.definitionId,ports:{input:g,output:y},label:t.label,transformation:{...t.transformation}})})();m.label=t.label,e.addNode(m);for(let g of t.ports)if(g.portType==="value"&&g.directValue.length>0){let y=m.inputs.map.get(g.definitionId);y&&y.setDirectValue(g.directValue)}return m.preview=t.preview??null,m}};var ne=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((y,x)=>{e.set(y,`n${x}`)});let o=[...t.nodes].map(y=>this.serializeNode(y,e.get(y))),l=[];for(let y of t.nodes){let x=e.get(y);for(let C of y.outputs.list)for(let c of C.connectedPorts){let n=e.get(c.node);l.push({sourceNodeId:x,sourcePortId:C.definitionId,targetNodeId:n,targetPortId:c.definitionId})}}let m=t.inputs.map(y=>({label:y.label,dataType:y.dataType})),g=t.outputs.map(y=>({label:y.label,dataType:y.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:m,outputs:g,imports:[...t.imports],nodes:o,connections:l}}serializeNode(t,e){let o=[...t.inputs.list,...t.outputs.list].map(m=>({definitionId:m.definitionId,label:m.label,direction:m.direction,portType:m.portType,dataType:m.portType==="value"?m.dataType:null,directValue:[...m.directValue]})),l=t.preview?{portDefinitionId:t.preview.portDefinitionId,displayId:t.preview.displayId}:null;return{id:e,definitionId:t.definitionId,label:t.label,transformation:{...t.transformation},ports:o,preview:l}}};var xo=`:host {\r
    /* Globals */\r
...
`;function Ns(){function p(c,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),c.push(a)}}function t(c,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(l(r,h),r===0?d=h:r===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,r,b,v,w,i),h!==void 0){l(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,r),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),r=w)}return[C(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function Go(p,t,e,o){return(Go=Ns())(p,t,e,o)}var Bo,Oo,Uo,Ho,Xo,Fo,jo,zo,Vo,qt;Bo=Y({selector:"potatno-resize-box",template:Ro,style:_o}),Uo=$.state({proxy:!0}),Ho=yt("resize"),Xo=yt("resize-end");var $o=class{static{({e:[Fo,jo,zo,Vo],c:[qt,Oo]}=Go(this,[[Uo,1,"mConfiguration"],[Ho,1,"mResize"],[Xo,1,"mResizeEnd"],[tt,3,"bottom"],[tt,3,"left"],[tt,3,"right"],[tt,3,"snap"],[tt,3,"top"],[tt,3,"virtual"],[tt,2,"resize"]],[Bo]))}constructor(t=R.use(G)){this.mComponentElement=t.element,this.mConfiguration={snap:1,isVirtual:!1,enabledDirections:{top:!1,right:!1,bottom:!1,left:!1}}}mComponentElement;#t=(Vo(this),Fo(this));get mConfiguration(){return this.#t}set mConfiguration(t){this.#t=t}#e=jo(this);get mResize(){return this.#e}set mResize(t){this.#e=t}#r=zo(this);get mResizeEnd(){return this.#r}set mResizeEnd(t){this.#r=t}get bottom(){return this.mConfiguration.enabledDirections.bottom}set bottom(t){this.mConfiguration.enabledDirections.bottom=this.parseBoolean(t)}get left(){return this.mConfiguration.enabledDirections.left}set left(t){this.mConfiguration.enabledDirections.left=this.parseBoolean(t)}get right(){return this.mConfiguration.enabledDirections.right}set right(t){this.mConfiguration.enabledDirections.right=this.parseBoolean(t)}get snap(){return this.mConfiguration.snap}set snap(t){this.mConfiguration.snap=parseInt(t.toString())}get top(){return this.mConfiguration.enabledDirections.top}set top(t){this.mConfiguration.enabledDirections.top=this.parseBoolean(t)}get virtual(){return this.mConfiguration.isVirtual}set virtual(t){this.mConfiguration.isVirtual=this.parseBoolean(t)}resize(t,e){let o=this.mComponentElement.getBoundingClientRect(),l=o.width,m=o.height;return this.mComponentElement.style.setProperty("width",`${t}px`),this.mComponentElement.style.setProperty("height",`${e}px`),t!==l||e!==m}resizeCorner(t){this.handleResize(t,"both")}resizeHorizontal(t){this.handleResize(t,"horizontal")}resizeVertical(t){this.handleResize(t,"vertical")}createResizeEvent(t,e,o,l,m){let g=t;return e===l&&(g&=~(wt.right|wt.left)),o===m&&(g&=~(wt.top|wt.bottom)),new vr(e,o,g)}handleResize(t,e){t.preventDefault(),t.stopPropagation();let o=this.mComponentElement.getBoundingClientRect(),l=this.mComponentElement.offsetWidth?o.width/this.mComponentElement.offsetWidth:1,m=this.mComponentElement.offsetHeight?o.height/this.mComponentElement.offsetHeight:1,g=o.width/l,y=o.height/m,x=t.clientX,C=t.clientY,c=1;Math.abs(x-o.left)<Math.abs(x-o.right)&&(c=-1);let n=1;Math.abs(C-o.top)<Math.abs(C-o.bottom)&&(n=-1);let u=0;u+=c===1?wt.right:wt.left,u+=n===1?wt.bottom:wt.top;let a=g,r=y,b=E=>{let w=(E.clientX-x)/l*c,f=(E.clientY-C)/m*n,s=g+w,d=y+f;e==="horizontal"&&(s=g),e==="vertical"&&(d=y),[a,r]=this.updateComponentSize(u,s,d,a,r)},v=()=>{document.removeEventListener("pointermove",b),document.removeEventListener("pointerup",v),(a!==g||r!==y)&&this.mResizeEnd.dispatchEvent(this.createResizeEvent(u,a,r,g,y))};document.addEventListener("pointermove",b),document.addEventListener("pointerup",v)}parseBoolean(t){return!!(()=>{if(typeof t=="string"){let o=t.toLowerCase();if(["true","false"].includes(o))return o==="true"}return t})()}updateComponentSize(t,e,o,l,m){let g=l;(this.mConfiguration.enabledDirections.left||this.mConfiguration.enabledDirections.right)&&(g=Math.floor(Math.abs(e)/this.mConfiguration.snap)*this.mConfiguration.snap*(e/Math.abs(e)),this.mConfiguration.isVirtual||this.mComponentElement.style.setProperty("width",`${g}px`));let y=m;return(this.mConfiguration.enabledDirections.top||this.mConfiguration.enabledDirections.bottom)&&(y=Math.floor(Math.abs(o)/this.mConfiguration.snap)*this.mConfiguration.snap*(o/Math.abs(o)),this.mConfiguration.isVirtual||this.mComponentElement.style.setProperty("height",`${y}px`)),(g!==l||y!==m)&&this.mResize.dispatchEvent(this.createResizeEvent(t,g,y,l,m)),[g,y]}static{Oo()}},vr=class{mHeight;mResizeHandle;mWidth;get height(){return this.mHeight}get resizeHandle(){return this.mResizeHandle}get width(){return this.mWidth}constructor(t,e,o){this.mHeight=e,this.mResizeHandle=o,this.mWidth=t}},wt={top:1,right:2,bottom:4,left:8};var Yo=`:host {\r
    position: absolute;\r
    z-index: 200;\r
}\r
\r
...
`;function Rs(){function p(c,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),c.push(a)}}function t(c,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(l(r,h),r===0?d=h:r===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,r,b,v,w,i),h!==void 0){l(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,r),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),r=w)}return[C(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function en(p,t,e,o){return(en=Rs())(p,t,e,o)}function Os(p){return p}var rn,Zo,on,nn,sn,an,ln,qo,Jo,Ko,Qo,ko,tn,ie;rn=Y({selector:"potatno-node-selection-popup",template:Wo,style:Yo,components:[qt]}),on=$.state({complexValue:!0}),nn=bt("searchInput"),sn=yt("node-select"),an=$.state(),ln=$.state();new class extends Os{constructor(){super(ie),Zo()}static{class p{static{({e:[qo,Jo,Ko,Qo,ko,tn],c:[ie,Zo]}=en(this,[[on,1,"results"],[nn,1,"searchInput"],[sn,1,"mNodeSelect"],[an,1,"searchValue"],[ln,1,"selectedDefinitionId"]],[rn]))}static POPUP_WIDTH=280;static POPUP_HEIGHT=320;mComponent;mManager;#t=(tn(this),qo(this));get results(){return this.#t}set results(e){this.#t=e}#e=Jo(this);get searchInput(){return this.#e}set searchInput(e){this.#e=e}#r=Ko(this);get mNodeSelect(){return this.#r}set mNodeSelect(e){this.#r=e}#o=Qo(this);get searchValue(){return this.#o}set searchValue(e){this.#o=e}#n=ko(this);get selectedDefinitionId(){return this.#n}set selectedDefinitionId(e){this.#n=e}constructor(e=R.use(G),o=R.use(X)){this.mManager=o,this.mComponent=e,this.selectedDefinitionId=null,this.results=new Array,this.searchValue=""}onConnect(){this.searchInput?.focus()}onKeyDown(e){if(this.results.length!==0){if(e.key==="ArrowDown"||e.key==="ArrowUp"){e.preventDefault();let o=this.results.findIndex(g=>g.definition.id===this.selectedDefinitionId);o=Math.max(0,o);let l=e.key==="ArrowDown"?1:-1,m=(o+l+this.results.length)%this.results.length;this.selectedDefinitionId=this.results[m].definition.id;return}e.key==="Enter"&&this.sendSelectedEntry(this.selectedDefinitionId)}}onUpdate(){this.rebuildResults();let e=this.mComponent.element.shadowRoot.querySelector(".selection-popup__result.selected");e&&e.scrollIntoView()}stopPropagation(e,o){e.stopPropagation(),o&&e.preventDefault()}rebuildResults(){let e=this.mManager.activeFunction.dynamicNodeDefinitions.map(l=>({category:l.category.name,definition:l,label:l.label.toLowerCase(),color:this.mManager.generateStringColor(l.category.name),icon:l.category.icon})),o=this.searchValue.trim().toLowerCase();this.results=e.filter(l=>l.label.includes(o)),this.results.some(l=>l.definition.id===this.selectedDefinitionId)||(this.selectedDefinitionId=this.results[0]?.definition.id??null)}sendSelectedEntry(e){if(e===null)return;let o=this.results.find(l=>l.definition.id===e);o&&this.mNodeSelect.dispatchEvent(o.definition)}}}};var cn=`:host {\r
    display: block;\r
    font-family: var(--potatno-font-family);\r
    font-size: var(--potatno-font-size);\r
    z-index: -1;\r
...
`;function zs(){function p(c,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),c.push(a)}}function t(c,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(l(r,h),r===0?d=h:r===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,r,b,v,w,i),h!==void 0){l(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,r),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),r=w)}return[C(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function yn(p,t,e,o){return(yn=zs())(p,t,e,o)}var bn,hn,wn,xn,Tn,En,dn,mn,fn,pn,gn,br;bn=Y({selector:"potatno-comment-node",template:un,style:cn,components:[qt]}),wn=$.state(),xn=yt("node-drag"),Tn=bt("ResizeBox"),En=bt("CommentInput");var vn=class{static{({e:[dn,mn,fn,pn,gn],c:[br,hn]}=yn(this,[[wn,1,"editMode"],[tt,3,"nodeData"],[xn,1,"mDrag"],[Tn,1,"resizeBox"],[En,1,"commentInput"]],[bn]))}constructor(t=R.use(G),e=R.use(X)){this.mComponent=t,this.mManager=e,this.mNodeData=null,this.mDoubleClickState=null,this.editMode=!1,this.mUnsubscribe=this.mManager.subscribe(O.Node,o=>{o.item===this.nodeData&&this.resyncComponent(this.nodeData)})}mComponent;mManager;mUnsubscribe;mNodeData;mDoubleClickState;#t=(gn(this),dn(this));get editMode(){return this.#t}set editMode(t){this.#t=t}get nodeData(){return this.mNodeData}set nodeData(t){this.mNodeData=t,t&&(this.resyncComponent(t),this.mComponent.updater.update())}#e=mn(this);get mDrag(){return this.#e}set mDrag(t){this.#e=t}#r=fn(this);get resizeBox(){return this.#r}set resizeBox(t){this.#r=t}get comment(){return this.nodeData?.label??""}set comment(t){this.nodeData&&(this.nodeData.label=t)}#o=pn(this);get commentInput(){return this.#o}set commentInput(t){this.#o=t}onConnect(){this.nodeData&&this.resyncComponent(this.nodeData)}onDeconstruct(){this.mUnsubscribe()}onUpdate(){this.commentInput&&this.getFocusedElement(document)!==this.commentInput&&this.commentInput.select()}getFocusedElement(t){let e=t.activeElement;return e?e.shadowRoot?this.getFocusedElement(e.shadowRoot):e:null}dragNodeOrEnableEdit(t){if(!this.nodeData||(this.mDoubleClickState?this.editMode=!0:this.mDoubleClickState={timer:globalThis.setTimeout(()=>{this.mDoubleClickState=null},300)},this.editMode))return;t.preventDefault();let e=this.nodeData.transformation.x*this.mManager.grid.gridSize,o=this.nodeData.transformation.y*this.mManager.grid.gridSize,l=this.nodeData.transformation.x,m=this.nodeData.transformation.y,g=this.mComponent.element.getBoundingClientRect(),y=this.mComponent.element.offsetWidth?g.width/this.mComponent.element.offsetWidth:1,x=this.mComponent.element.offsetHeight?g.height/this.mComponent.element.offsetHeight:1,C=t.clientX,c=t.clientY,n=a=>{a.stopPropagation();let r=(a.clientX-C)/y,b=(a.clientY-c)/x,v=Math.round((e+r)/this.mManager.grid.gridSize),E=Math.round((o+b)/this.mManager.grid.gridSize);l===v&&m===E||(this.mManager.graph.transformNode(this.nodeData,w=>{w.moveTo(v,E)}),this.mDrag.dispatchEvent(new yr(v-l,E-m)),l=v,m=E)},u=()=>{document.removeEventListener("pointermove",n),document.removeEventListener("pointerup",u)};document.addEventListener("pointermove",n),document.addEventListener("pointerup",u)}escapeEditMode(t){(t.key==="Escape"||t.key==="Enter")&&(t.preventDefault(),this.editMode=!1)}transformNodeData(t){this.mManager.graph.transformNode(this.nodeData,e=>{let o=e.transformation.width,l=e.transformation.height;e.resizeTo(t.width/this.mManager.grid.gridSize,t.height/this.mManager.grid.gridSize);let m=e.transformation.width-o,g=e.transformation.height-l;g!==0&&(t.resizeHandle&wt.top)>0&&e.moveTo(e.transformation.x,e.transformation.y-g),m!==0&&(t.resizeHandle&wt.left)>0&&e.moveTo(e.transformation.x-m,e.transformation.y)})}resyncComponent(t){let e=t.transformation.x*this.mManager.grid.gridSize,o=t.transformation.y*this.mManager.grid.gridSize;if(this.mComponent.element.style.setProperty("left",`${e}px`),this.mComponent.element.style.setProperty("top",`${o}px`),this.resizeBox){let l=t.transformation.width*this.mManager.grid.gridSize,m=t.transformation.height*this.mManager.grid.gridSize;this.resizeBox.resize(l,m)}}static{hn()}},yr=class{mX;mY;get x(){return this.mX}get y(){return this.mY}constructor(t,e){this.mX=t,this.mY=e}};var Dn=`:host {\r
    position: absolute;\r
    top: 0;\r
    left: 0;\r
    height: 1px;\r
...
`;function Gs(){function p(c,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),c.push(a)}}function t(c,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(l(r,h),r===0?d=h:r===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,r,b,v,w,i),h!==void 0){l(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,r),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),r=w)}return[C(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function An(p,t,e,o){return(An=Gs())(p,t,e,o)}var Nn,Cn,Ln,Pn,Mn,wr;Nn=Y({selector:"potatno-connection-layer",template:In,style:Dn}),Ln=bt("svgLayer");var Sn=class{static{({e:[Pn,Mn],c:[wr,Cn]}=An(this,[[Ln,1,"svgLayer"]],[Nn]))}constructor(t=R.use(X)){this.mConnectionRegistry=new Map,this.mManager=t;let e=0;this.mUnsubscribe=this.mManager.subscribe(O.SpecialActiveFunction|O.Node|O.Connection,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.renderConnections()}))})}mConnectionRegistry;mManager;mUnsubscribe;#t=(Mn(this),Pn(this));get svgLayer(){return this.#t}set svgLayer(t){this.#t=t}onConnectionDelete(t){if(t.button!==2||!(t.target instanceof Element))return;let e=parseInt(t.target.getAttribute("data-connection-id")??"");if(isNaN(e))return;t.preventDefault(),t.stopPropagation();let o=this.mConnectionRegistry.get(e);o&&this.mManager.graph.disconnectPorts(o.sourcePort,o.targetPort)}onDeconstruct(){this.mUnsubscribe()}renderConnectionPath(t,e,o,l,m){let g="http://www.w3.org/2000/svg",y=this.mManager.connections.getConnectionPath(o,l),x=document.createElementNS(g,"path");x.classList.add("path"),x.classList.toggle(".path--invalid",!m),x.setAttribute("d",y),o.portType==="value"&&x.style.setProperty("--path-color",this.mManager.generateStringColor(o.resolvedDataType));let C=document.createElementNS(g,"path");C.classList.add("path","path--mouse-target"),C.setAttribute("d",y),C.setAttribute("data-connection-id",e.toString()),t.appendChild(x),t.appendChild(C)}renderConnections(){if(!this.svgLayer)return;this.svgLayer.innerHTML="",this.mConnectionRegistry.clear();let t=this.mManager.integrity.errorItems,e=0;for(let o of this.mManager.activeFunction.nodes)for(let l of o.outputs.list)for(let m of l.connectedPorts){let g=e++;this.mConnectionRegistry.set(g,{sourcePort:l,targetPort:m});let y=t.has(l)||t.has(m);this.renderConnectionPath(this.svgLayer,g,l,m,!y)}}static{Cn()}};function Bs(){function p(c,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),c.push(a)}}function t(c,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(l(r,h),r===0?d=h:r===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,r,b,v,w,i),h!==void 0){l(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,r),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),r=w)}return[C(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function On(p,t,e,o){return(On=Bs())(p,t,e,o)}var Fn,_n,Pe;Fn=vt({access:W.Read,selector:/^potatno-preview$/});var Rn=class{static{({c:[Pe,_n]}=On(this,[],[Fn]))}constructor(t=R.use(Q),e=R.use(H),o=R.use(ot)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(o.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let o=this.mTarget.childNodes.length>0;return o&&(this.mTarget.innerHTML=""),o}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{_n()}};var jn=`:host {\r
    display: block;\r
    position: relative;\r
\r
