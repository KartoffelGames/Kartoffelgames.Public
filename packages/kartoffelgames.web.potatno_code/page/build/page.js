...
potatno-code-editor {\r
    ...
    width: 100%;\r
    height: 100%;\r
}`;var Jt=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new Mt(this.mProject);for(let o of t.functions)e.addFunction(this.deserializeFunction(o,e));return e}deserializeFunction(t,e){let o=new yt(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let m of t.imports)o.addImport(m);for(let m of t.inputs)o.addInput({label:m.label,dataType:m.dataType});for(let m of t.outputs)o.addOutput({label:m.label,dataType:m.dataType});let c=new Map;for(let m of t.nodes)c.set(m.id,this.deserializeNode(m,o,e));for(let m of t.connections){if(!c.has(m.sourceNodeId)||!c.has(m.targetNodeId))continue;let v=c.get(m.sourceNodeId),y=c.get(m.targetNodeId),T=v.outputs.map.get(m.sourcePortId),P=y.inputs.map.get(m.targetPortId);!T||!P||T.connect(P)}return o}deserializeNode(t,e,o){let c=o.nodeDefinitions.find(v=>v.id===t.definitionId),m=(()=>{if(c)return e.addNodeByDefinition(c,t.transformation);let v=t.ports.filter(T=>T.direction==="input").map(T=>({dataType:T.dataType,definitionId:T.definitionId,label:T.label,portType:T.portType})),y=t.ports.filter(T=>T.direction==="output").map(T=>({dataType:T.dataType,definitionId:T.definitionId,label:T.label,portType:T.portType}));return new Tt(this.mProject,o,e,{definitionId:t.definitionId,ports:{input:v,output:y},label:t.label,transformation:{...t.transformation}})})();m.label=t.label,e.addNode(m);for(let v of t.ports)if(v.portType==="value"&&v.directValue.length>0){let y=m.inputs.map.get(v.definitionId);y&&y.setDirectValue(v.directValue)}return m.preview=t.preview??null,m}};var Kt=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((y,T)=>{e.set(y,`n${T}`)});let o=[...t.nodes].map(y=>this.serializeNode(y,e.get(y))),c=[];for(let y of t.nodes){let T=e.get(y);for(let P of y.outputs.list)for(let l of P.connectedPorts){let n=e.get(l.node);c.push({sourceNodeId:T,sourcePortId:P.definitionId,targetNodeId:n,targetPortId:l.definitionId})}}let m=t.inputs.map(y=>({label:y.label,dataType:y.dataType})),v=t.outputs.map(y=>({label:y.label,dataType:y.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:m,outputs:v,imports:[...t.imports],nodes:o,connections:c}}serializeNode(t,e){let o=[...t.inputs.list,...t.outputs.list].map(m=>({definitionId:m.definitionId,label:m.label,direction:m.direction,portType:m.portType,dataType:m.portType==="value"?m.dataType:null,directValue:[...m.directValue]})),c=t.preview?structuredClone(t.preview):null;return{id:e,definitionId:t.definitionId,label:t.label,transformation:{...t.transformation},ports:o,preview:c}}};var fo=`:host {\r
    /* Globals */\r
...
`;function ms(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,g,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:g?"#"+n:n,static:b,private:g,metadata:E},d={v:!1};s.addInitializer=f(a,d);var i,h;r===0?g?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,g,E,w){var p=u[0],s,d,i;g?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof p=="function")h=t(p,a,s,E,r,b,g,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var S=p.length-1;S>=0;S--){var M=p[S];if(h=t(M,a,s,E,r,b,g,w,i),h!==void 0){c(r,h);var N;r===0?N=h:r===1?(N=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,N!==void 0&&(d===void 0?d=N:typeof d=="function"?d=[d,N]:d.push(N))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,R=0;R<F.length;R++)L=F[R].call(I,L);return L}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),g?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function v(l,n,u){for(var a=[],r,b,g=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var S=h?E:g,M=S.get(d)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!M&&s>2?S.set(d,s):S.set(d,!0)}m(a,x,p,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,g=n.length-1;g>=0;g--){var E={v:!1};try{var w=n[g](r,{kind:"class",name:b,addInitializer:f(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[P(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function P(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var g=Object.create(b===void 0?null:b),E=v(n,u,g);return a.length||P(n,g),{e:E,get c(){return T(n,a,g)}}}}function jo(f,t,e,o){return(jo=ms())(f,t,e,o)}var Vo,Ro,zo,_o,Oo,Te;Vo=W({selector:"potatno-resize-box",template:Lo,style:Ao}),zo=$.state({proxy:!0});var Fo=class{static{({e:[_o,Oo],c:[Te,Ro]}=jo(this,[[zo,1,"enabledDirections"],[rt,3,"bottom"],[rt,3,"left"],[rt,3,"right"],[rt,3,"snap"],[rt,3,"top"]],[Vo]))}constructor(t=_.use(G)){this.mComponentElement=t.element,this.enabledDirections={snap:1,enabled:{top:!1,right:!1,bottom:!1,left:!1}}}mComponentElement;#t=(Oo(this),_o(this));get enabledDirections(){return this.#t}set enabledDirections(t){this.#t=t}get bottom(){return this.enabledDirections.enabled.bottom}set bottom(t){this.enabledDirections.enabled.bottom=this.parseBoolean(t)}get left(){return this.enabledDirections.enabled.left}set left(t){this.enabledDirections.enabled.left=this.parseBoolean(t)}get right(){return this.enabledDirections.enabled.right}set right(t){this.enabledDirections.enabled.right=this.parseBoolean(t)}get snap(){return this.enabledDirections.snap}set snap(t){this.enabledDirections.snap=parseInt(t.toString())}get top(){return this.enabledDirections.enabled.top}set top(t){this.enabledDirections.enabled.top=this.parseBoolean(t)}resizeCorner(t){this.handleResize(t,"both")}resizeHorizontal(t){this.handleResize(t,"horizontal")}resizeVertical(t){this.handleResize(t,"vertical")}handleResize(t,e){t.preventDefault(),t.stopPropagation();let o=this.mComponentElement.getBoundingClientRect(),c=o.width,m=o.height,v=t.clientX,y=t.clientY,T=1;Math.abs(v-o.left)<Math.abs(v-o.right)&&(T=-1);let P=1;Math.abs(y-o.top)<Math.abs(y-o.bottom)&&(P=-1);let l=u=>{let a=(u.clientX-v)*T,r=(u.clientY-y)*P,b=c+a,g=m+r;e==="horizontal"&&(b=c),e==="vertical"&&(g=m),this.updateComponentSize(b,g)},n=()=>{document.removeEventListener("pointermove",l),document.removeEventListener("pointerup",n)};document.addEventListener("pointermove",l),document.addEventListener("pointerup",n)}parseBoolean(t){return!!(()=>{if(typeof t=="string"){let o=t.toLowerCase();if(["true","false"].includes(o))return o==="true"}return t})()}updateComponentSize(t,e){if(this.enabledDirections.enabled.left||this.enabledDirections.enabled.right){let o=Math.floor(Math.abs(t)/this.enabledDirections.snap)*this.enabledDirections.snap*(t/Math.abs(t));this.mComponentElement.style.setProperty("width",`${o}px`)}if(this.enabledDirections.enabled.top||this.enabledDirections.enabled.bottom){let o=Math.floor(Math.abs(e)/this.enabledDirections.snap)*this.enabledDirections.snap*(e/Math.abs(e));this.mComponentElement.style.setProperty("height",`${o}px`)}}static{Ro()}};var $o=`:host {\r
    position: absolute;\r
    z-index: 200;\r
}\r
\r
...
`;function bs(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,g,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:g?"#"+n:n,static:b,private:g,metadata:E},d={v:!1};s.addInitializer=f(a,d);var i,h;r===0?g?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,g,E,w){var p=u[0],s,d,i;g?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof p=="function")h=t(p,a,s,E,r,b,g,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var S=p.length-1;S>=0;S--){var M=p[S];if(h=t(M,a,s,E,r,b,g,w,i),h!==void 0){c(r,h);var N;r===0?N=h:r===1?(N=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,N!==void 0&&(d===void 0?d=N:typeof d=="function"?d=[d,N]:d.push(N))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,R=0;R<F.length;R++)L=F[R].call(I,L);return L}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),g?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function v(l,n,u){for(var a=[],r,b,g=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var S=h?E:g,M=S.get(d)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!M&&s>2?S.set(d,s):S.set(d,!0)}m(a,x,p,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,g=n.length-1;g>=0;g--){var E={v:!1};try{var w=n[g](r,{kind:"class",name:b,addInitializer:f(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[P(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function P(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var g=Object.create(b===void 0?null:b),E=v(n,u,g);return a.length||P(n,g),{e:E,get c(){return T(n,a,g)}}}}function un(f,t,e,o){return(un=bs())(f,t,e,o)}var hn,sn,dn,an,ln,mr;hn=W({selector:"potatno-connection-layer",template:nn,style:on}),dn=jt("svgLayer");var cn=class{static{({e:[an,ln],c:[mr,sn]}=un(this,[[dn,1,"svgLayer"]],[hn]))}constructor(t=_.use(K)){this.mConnectionRegistry=new Map,this.mManager=t;let e=0;this.mUnsubscribe=this.mManager.subscribe(O.SpecialActiveFunction|O.Node|O.Connection,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.renderConnections()}))})}mConnectionRegistry;mManager;mUnsubscribe;#t=(ln(this),an(this));get svgLayer(){return this.#t}set svgLayer(t){this.#t=t}onConnectionDelete(t){if(!(t.target instanceof Element))return;let e=parseInt(t.target.getAttribute("data-connection-id")??"");if(isNaN(e))return;t.preventDefault(),t.stopPropagation();let o=this.mConnectionRegistry.get(e);o&&this.mManager.graph.disconnectPorts(o.sourcePort,o.targetPort)}onDeconstruct(){this.mUnsubscribe()}renderConnectionPath(t,e,o,c,m){let v="http://www.w3.org/2000/svg",y=this.mManager.connections.getConnectionPath(o,c),T=document.createElementNS(v,"path");T.classList.add("path"),T.classList.toggle(".path--invalid",!m),T.setAttribute("d",y),o.portType==="value"&&T.style.setProperty("--path-color",this.mManager.generateStringColor(o.resolvedDataType));let P=document.createElementNS(v,"path");P.classList.add("path","path--mouse-target"),P.setAttribute("d",y),P.setAttribute("data-connection-id",e.toString()),t.appendChild(T),t.appendChild(P)}renderConnections(){this.svgLayer.innerHTML="",this.mConnectionRegistry.clear();let t=this.mManager.activeFunction;if(!t)return;let e=this.mManager.integrity.errorItems,o=0;for(let c of t.nodes)for(let m of c.outputs.list)for(let v of m.connectedPorts){let y=o++;this.mConnectionRegistry.set(y,{sourcePort:m,targetPort:v});let T=e.has(m)||e.has(v);this.renderConnectionPath(this.svgLayer,y,m,v,!T)}}static{sn()}};function ws(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,g,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:g?"#"+n:n,static:b,private:g,metadata:E},d={v:!1};s.addInitializer=f(a,d);var i,h;r===0?g?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,g,E,w){var p=u[0],s,d,i;g?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof p=="function")h=t(p,a,s,E,r,b,g,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var S=p.length-1;S>=0;S--){var M=p[S];if(h=t(M,a,s,E,r,b,g,w,i),h!==void 0){c(r,h);var N;r===0?N=h:r===1?(N=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,N!==void 0&&(d===void 0?d=N:typeof d=="function"?d=[d,N]:d.push(N))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,R=0;R<F.length;R++)L=F[R].call(I,L);return L}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),g?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function v(l,n,u){for(var a=[],r,b,g=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var S=h?E:g,M=S.get(d)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!M&&s>2?S.set(d,s):S.set(d,!0)}m(a,x,p,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,g=n.length-1;g>=0;g--){var E={v:!1};try{var w=n[g](r,{kind:"class",name:b,addInitializer:f(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[P(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function P(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var g=Object.create(b===void 0?null:b),E=v(n,u,g);return a.length||P(n,g),{e:E,get c(){return T(n,a,g)}}}}function pn(f,t,e,o){return(pn=ws())(f,t,e,o)}var gn,mn,Ee;gn=vt({access:X.Read,selector:/^potatno-preview$/});var fn=class{static{({c:[Ee,mn]}=pn(this,[],[gn]))}constructor(t=_.use(q),e=_.use(H),o=_.use(et)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(o.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let o=this.mTarget.childNodes.length>0;return o&&(this.mTarget.innerHTML=""),o}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{mn()}};(function(f){f.Function="function",f.Comment="comment",f.Input="input",f.Output="output",f.Reroute="reroute"})(kt||(kt={}));var kt;var vn=`:host {\r
    display: block;\r
    position: relative;\r
\r
...
\r
    $for(nodeState of this.visibleNodes) {\r
        <potatno-node class="grid-content__node {{this.nodeState.selected ? 'selected' : ''}}" style="left:{{this.nodeState.pixelX}}px; top:{{this.nodeState.pixelY}}px; width:{{this.nodeState.pixelW}}px; height:{{this.nodeState.pixelH}}px;" [nodeData]="this.nodeState.node" (pointerdown)="this.onNodePointerDown($event, this.nodeState.node)" (resize-start)="this.onNodeResizeStart($event)"/>\r
    }\r
</div>\r
\r
...
`)}}};var Ie=class f extends ne{static PREVIEW_HEIGHT=48;static PREVIEW_WIDTH=48;constructor(t){super(t,{id:"2dCanvas",name:"Canvas 2D",generate:()=>{let e=document.createElement("canvas");return e.width=f.PREVIEW_WIDTH,e.height=f.PREVIEW_HEIGHT,e.style.width="100%",e.style.height="100%",e.style.imageRendering="pixelated",e},typeAdapter:{[st.MAIN]:e=>e,number:e=>[e,e,e],boolean:e=>{let o=e?1:0;return[o,o,o]}},update:async(e,o)=>{await this.updateCanvasPreview(e,o)}})}async updateCanvasPreview(t,e){let o=t.getContext("2d");if(!o)return;let c=t.width,m=t.height,v=o.createImageData(c,m),y=v.data;for(let T=0;T<m;T++)for(let P=0;P<c;P++){let l=P/c,n=T/m,u=await Promise.resolve(e({x:l,y:n})),a=(T*c+P)*4;y[a]=Math.floor(Math.max(0,Math.min(1,u[0]||0))*255),y[a+1]=Math.floor(Math.max(0,Math.min(1,u[1]||0))*255),y[a+2]=Math.floor(Math.max(0,Math.min(1,u[2]||0))*255),y[a+3]=255}o.putImageData(v,0,0)}};(()=>{let f=new WebSocket("ws://127.0.0.1:8088");f.addEventListener("open",()=>{console.log("Refresh connection established")}),f.addEventListener("message",t=>{console.log("Bundle finished. Start refresh"),t.data==="REFRESH"&&window.location.reload()})})();var wt=new or;wt.addImport(new nr);wt.addImport(new ir);var Ni=new st(wt.entryPoint,{defaultParameters:{x:0,y:0},types:[st.MAIN,"number","string","boolean"],build:(f,t,e)=>{let o=t.code,c=f.function.id;if(!e){let y=new Function(`${o}
return ${c};`)();return{type:st.MAIN,execute:T=>y(T.x,T.y)}}let m=o.replace(e.nodeHook,`; return ${e.value};`),v=new Function(`${m}
return ${c};`)();return{type:e.documentPort.resolvedDataType,execute:y=>v(y.x,y.y)}}}),Ai=new st(wt.userFunction,{defaultParameters:{x:0,y:0},types:["number","string","boolean"],build:(f,t,e)=>{if(!e)return{type:"number",execute:()=>0};let o=t.entryPoint.function,c=`__fn_${o.id.replaceAll("-","_")}`,m=o.inputs.map(T=>f.projectTypes.getDefaultValue(T.dataType)),v=t.code.replace(e.nodeHook,`return ${e.value};`),y=new Function(`${v}
return ${c};`)();return{type:e.documentPort.resolvedDataType,execute:()=>y(...m)}}});wt.preview.addDisplay(new Ie(Ni));wt.preview.addDisplay(new Ie(Ai));wt.preview.addDisplay(new De(Ni));wt.preview.addDisplay(new De(Ai));var $s=document.getElementById("application-root"),Pe=new Je(wt);Pe.appendTo($s);Pe.document=new Mt(wt);Li();async function Li(){try{await Pe.update()}catch(f){}requestAnimationFrame(Li)}document.getElementById("load-button").addEventListener("click",Gs);document.getElementById("save-button").addEventListener("click",Bs);var Ri="potatno-code-document.json";async function Gs(){if(window.confirm("Load saved document?"))try{let o=await(await(await navigator.storage.getDirectory()).getFileHandle(Ri)).getFile();Pe.load(await o.text())}catch{window.alert("Could not load document.")}}async function Bs(){if(window.confirm("Override saved document?"))try{let o=await(await(await navigator.storage.getDirectory()).getFileHandle(Ri,{create:!0})).createWritable();await o.write(Pe.save()),await o.close()}catch{window.alert("Could not save document.")}}})();
