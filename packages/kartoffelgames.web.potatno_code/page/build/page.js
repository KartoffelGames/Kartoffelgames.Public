...
potatno-code-editor {\r
    ...
    width: 100%;\r
    height: 100%;\r
}`;var re=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new zt(this.mProject),r=[];for(let c of t.functions){let d=this.deserializeFunctionHead(c,e);r.push([d,c]),e.addFunction(d)}for(let[c,d]of r)this.deserializeFunctionBody(c,d,e);return e}deserializeFunctionBody(t,e,r){let c=new Map;for(let d of e.nodes)c.set(d.id,this.deserializeNode(d,t,r));for(let d of e.connections){if(!c.has(d.sourceNodeId)||!c.has(d.targetNodeId))continue;let g=c.get(d.sourceNodeId),y=c.get(d.targetNodeId),E=g.outputs.map.get(d.sourcePortId),C=y.inputs.map.get(d.targetPortId);!E||!C||E.connect(C)}}deserializeFunctionHead(t,e){let r=new Et(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let c of t.imports)r.addImport(c);for(let c of t.inputs)r.addInput({label:c.label,dataType:c.dataType});for(let c of t.outputs)r.addOutput({label:c.label,dataType:c.dataType});return r}deserializeNode(t,e,r){let c=r.nodeDefinitions.find(g=>g.id===t.definitionId),d=(()=>{if(c)return e.addNodeByDefinition(c,t.transformation);let g=t.ports.filter(E=>E.direction==="input").map(E=>({dataType:E.dataType,definitionId:E.definitionId,label:E.label,portType:E.portType})),y=t.ports.filter(E=>E.direction==="output").map(E=>({dataType:E.dataType,definitionId:E.definitionId,label:E.label,portType:E.portType}));return new St(this.mProject,r,e,{definitionId:t.definitionId,ports:{input:g,output:y},label:t.label,transformation:{...t.transformation}})})();d.label=t.label,e.addNode(d);for(let g of t.ports)if(g.portType==="value"&&g.directValue.length>0){let y=d.inputs.map.get(g.definitionId);y&&y.setDirectValue(g.directValue)}return d.preview=t.preview??null,d}};var ne=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((y,E)=>{e.set(y,`n${E}`)});let r=[...t.nodes].map(y=>this.serializeNode(y,e.get(y))),c=[];for(let y of t.nodes){let E=e.get(y);for(let C of y.outputs.list)for(let l of C.connectedPorts){let n=e.get(l.node);c.push({sourceNodeId:E,sourcePortId:C.definitionId,targetNodeId:n,targetPortId:l.definitionId})}}let d=t.inputs.map(y=>({label:y.label,dataType:y.dataType})),g=t.outputs.map(y=>({label:y.label,dataType:y.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:d,outputs:g,imports:[...t.imports],nodes:r,connections:c}}serializeNode(t,e){let r=[...t.inputs.list,...t.outputs.list].map(d=>({definitionId:d.definitionId,label:d.label,direction:d.direction,portType:d.portType,dataType:d.portType==="value"?d.dataType:null,directValue:[...d.directValue]})),c=t.preview?{portDefinitionId:t.preview.portDefinitionId,displayId:t.preview.displayId}:null;return{id:e,definitionId:t.definitionId,label:t.label,transformation:{...t.transformation},ports:r,preview:c}}};var Dr=`:host {\r
    /* Globals */\r
...
`;function Js(){function p(l,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),l.push(a)}}function t(l,n,u,a,o,b,v,T,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:T},m={v:!1};s.addInitializer=p(a,m);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,o,b,v,T,w){var f=u[0],s,m,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,a,s,T,o,b,v,w,i),h!==void 0&&(c(o,h),o===0?m=h:o===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,T,o,b,v,w,i),h!==void 0){c(o,h);var N;o===0?N=h:o===1?(N=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,N!==void 0&&(m===void 0?m=N:typeof m=="function"?m=[m,N]:m.push(N))}}if(o===0||o===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var _=D,L=0;L<F.length;L++)_=F[L].call(I,_);return _}}else{var j=m;m=function(I,D){return j.call(I,D)}}l.push(m)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):o===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],o,b,v=new Map,T=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=l,s=s-5,b=b||[],P=b):(x=l.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(a,x,f,m,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function E(l,n,u){if(n.length>0){for(var a=[],o=l,b=l.name,v=n.length-1;v>=0;v--){var T={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),T=g(n,u,v);return a.length||C(n,v),{e:T,get c(){return E(n,a,v)}}}}function nn(p,t,e,r){return(nn=Js())(p,t,e,r)}function Ks(p){return p}var sn,Kr,an,ln,cn,un,hn,Qr,kr,tn,en,on,rn,ie;sn=Y({selector:"potatno-node-selection-popup",template:Jr,style:qr,components:[qt]}),an=$.state({complexValue:!0}),ln=xt("searchInput"),cn=pt("node-select"),un=$.state(),hn=$.state();new class extends Ks{constructor(){super(ie),Kr()}static{class p{static{({e:[Qr,kr,tn,en,on,rn],c:[ie,Kr]}=nn(this,[[an,1,"results"],[ln,1,"searchInput"],[cn,1,"mNodeSelect"],[un,1,"searchValue"],[hn,1,"selectedDefinitionId"]],[sn]))}static POPUP_HEIGHT=320;static POPUP_WIDTH=280;mComponent;mManager;#t=(rn(this),Qr(this));get results(){return this.#t}set results(e){this.#t=e}#e=kr(this);get searchInput(){return this.#e}set searchInput(e){this.#e=e}#o=tn(this);get mNodeSelect(){return this.#o}set mNodeSelect(e){this.#o=e}#r=en(this);get searchValue(){return this.#r}set searchValue(e){this.#r=e}#n=on(this);get selectedDefinitionId(){return this.#n}set selectedDefinitionId(e){this.#n=e}constructor(e=R.use(B),r=R.use(X)){this.mManager=r,this.mComponent=e,this.selectedDefinitionId=null,this.results=new Array,this.searchValue=""}onConnect(){this.searchInput?.focus()}onKeyDown(e){if(this.results.length!==0){if(e.key==="ArrowDown"||e.key==="ArrowUp"){e.preventDefault();let r=this.results.findIndex(g=>g.definition.id===this.selectedDefinitionId);r=Math.max(0,r);let c=e.key==="ArrowDown"?1:-1,d=(r+c+this.results.length)%this.results.length;this.selectedDefinitionId=this.results[d].definition.id;return}e.key==="Enter"&&this.sendSelectedEntry(this.selectedDefinitionId)}}onUpdate(){this.rebuildResults();let e=this.mComponent.element.shadowRoot.querySelector(".selection-popup__result.selected");e&&e.scrollIntoView()}stopPropagation(e,r){e.stopPropagation(),r&&e.preventDefault()}rebuildResults(){let e=this.mManager.activeFunction.dynamicNodeDefinitions.map(c=>({category:c.category.name,definition:c,label:c.label.toLowerCase(),color:this.mManager.generateStringColor(c.category.name),icon:c.category.icon})),r=this.searchValue.trim().toLowerCase();this.results=e.filter(c=>c.label.includes(r)),this.results.some(c=>c.definition.id===this.selectedDefinitionId)||(this.selectedDefinitionId=this.results[0]?.definition.id??null)}sendSelectedEntry(e){if(e===null)return;let r=this.results.find(c=>c.definition.id===e);r&&this.mNodeSelect.dispatchEvent(r.definition)}}}};var mn=`:host {\r
    display: block;\r
    font-family: var(--potatno-font-family);\r
    font-size: var(--potatno-font-size);\r
\r
...
`;function ra(){function p(l,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),l.push(a)}}function t(l,n,u,a,o,b,v,T,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:T},m={v:!1};s.addInitializer=p(a,m);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,o,b,v,T,w){var f=u[0],s,m,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,a,s,T,o,b,v,w,i),h!==void 0&&(c(o,h),o===0?m=h:o===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,T,o,b,v,w,i),h!==void 0){c(o,h);var N;o===0?N=h:o===1?(N=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,N!==void 0&&(m===void 0?m=N:typeof m=="function"?m=[m,N]:m.push(N))}}if(o===0||o===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var _=D,L=0;L<F.length;L++)_=F[L].call(I,_);return _}}else{var j=m;m=function(I,D){return j.call(I,D)}}l.push(m)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):o===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],o,b,v=new Map,T=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=l,s=s-5,b=b||[],P=b):(x=l.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(a,x,f,m,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function E(l,n,u){if(n.length>0){for(var a=[],o=l,b=l.name,v=n.length-1;v>=0;v--){var T={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),T=g(n,u,v);return a.length||C(n,v),{e:T,get c(){return E(n,a,v)}}}}function zn(p,t,e,r){return(zn=ra())(p,t,e,r)}var jn,Ln,Vn,Rn,On,To;jn=Y({selector:"potatno-connection-layer",template:_n,style:An}),Vn=xt("svgLayer");var Fn=class{static{({e:[Rn,On],c:[To,Ln]}=zn(this,[[Vn,1,"svgLayer"]],[jn]))}constructor(t=R.use(X)){this.mConnectionRegistry=new Map,this.mManager=t;let e=0;this.mUnsubscribe=this.mManager.subscribe(O.SpecialActiveFunction|O.Node|O.Connection,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.renderConnections()}))})}mConnectionRegistry;mManager;mUnsubscribe;#t=(On(this),Rn(this));get svgLayer(){return this.#t}set svgLayer(t){this.#t=t}onConnectionDelete(t){if(t.button!==2||!(t.target instanceof Element))return;let e=parseInt(t.target.getAttribute("data-connection-id")??"");if(isNaN(e))return;t.preventDefault(),t.stopPropagation();let r=this.mConnectionRegistry.get(e);r&&this.mManager.graph.disconnectPorts(r.sourcePort,r.targetPort)}onDeconstruct(){this.mUnsubscribe()}renderConnectionPath(t,e,r,c,d){let g="http://www.w3.org/2000/svg",y=this.mManager.connections.getConnectionPath(r,c),E=document.createElementNS(g,"path");E.classList.add("path"),E.classList.toggle(".path--invalid",!d),E.setAttribute("d",y),r.portType==="value"&&E.style.setProperty("--path-color",this.mManager.generateStringColor(r.resolvedDataType));let C=document.createElementNS(g,"path");C.classList.add("path","path--mouse-target"),C.setAttribute("d",y),C.setAttribute("data-connection-id",e.toString()),t.appendChild(E),t.appendChild(C)}renderConnections(){if(!this.svgLayer)return;this.svgLayer.innerHTML="",this.mConnectionRegistry.clear();let t=this.mManager.integrity.errorItems,e=0;for(let r of this.mManager.activeFunction.nodes)for(let c of r.outputs.list)for(let d of c.connectedPorts){let g=e++;this.mConnectionRegistry.set(g,{sourcePort:c,targetPort:d});let y=t.has(c)||t.has(d);this.renderConnectionPath(this.svgLayer,g,c,d,!y)}}static{Ln()}};function na(){function p(l,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),l.push(a)}}function t(l,n,u,a,o,b,v,T,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:T},m={v:!1};s.addInitializer=p(a,m);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,o,b,v,T,w){var f=u[0],s,m,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,a,s,T,o,b,v,w,i),h!==void 0&&(c(o,h),o===0?m=h:o===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,T,o,b,v,w,i),h!==void 0){c(o,h);var N;o===0?N=h:o===1?(N=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,N!==void 0&&(m===void 0?m=N:typeof m=="function"?m=[m,N]:m.push(N))}}if(o===0||o===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var _=D,L=0;L<F.length;L++)_=F[L].call(I,_);return _}}else{var j=m;m=function(I,D){return j.call(I,D)}}l.push(m)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):o===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],o,b,v=new Map,T=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=l,s=s-5,b=b||[],P=b):(x=l.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(a,x,f,m,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function E(l,n,u){if(n.length>0){for(var a=[],o=l,b=l.name,v=n.length-1;v>=0;v--){var T={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),T=g(n,u,v);return a.length||C(n,v),{e:T,get c(){return E(n,a,v)}}}}function Gn(p,t,e,r){return(Gn=na())(p,t,e,r)}var Un,$n,Me;Un=wt({access:Z.Read,selector:/^potatno-preview$/});var Bn=class{static{({c:[Me,$n]}=Gn(this,[],[Un]))}constructor(t=R.use(Q),e=R.use(H),r=R.use(ot)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(r.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let r=this.mTarget.childNodes.length>0;return r&&(this.mTarget.innerHTML=""),r}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{$n()}};var Xn=`:host {\r
    display: block;\r
    position: relative;\r
\r
...
`;function aa(){function p(l,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),l.push(a)}}function t(l,n,u,a,o,b,v,T,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:T},m={v:!1};s.addInitializer=p(a,m);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,o,b,v,T,w){var f=u[0],s,m,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,a,s,T,o,b,v,w,i),h!==void 0&&(c(o,h),o===0?m=h:o===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,T,o,b,v,w,i),h!==void 0){c(o,h);var N;o===0?N=h:o===1?(N=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,N!==void 0&&(m===void 0?m=N:typeof m=="function"?m=[m,N]:m.push(N))}}if(o===0||o===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var _=D,L=0;L<F.length;L++)_=F[L].call(I,_);return _}}else{var j=m;m=function(I,D){return j.call(I,D)}}l.push(m)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):o===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],o,b,v=new Map,T=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=l,s=s-5,b=b||[],P=b):(x=l.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(a,x,f,m,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function E(l,n,u){if(n.length>0){for(var a=[],o=l,b=l.name,v=n.length-1;v>=0;v--){var T={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),T=g(n,u,v);return a.length||C(n,v),{e:T,get c(){return E(n,a,v)}}}}function qn(p,t,e,r){return(qn=aa())(p,t,e,r)}function la(p){return p}var Jn,Yn,Kn,Zn,Wn,se;Jn=Y({selector:"potatno-port",template:Hn,style:Xn}),Kn=xt("dragConnection");new class extends la{constructor(){super(se),Yn()}static{class p{static{({e:[Zn,Wn],c:[se,Yn]}=qn(this,[[Kn,1,"dragConnectionSvg"],[q,3,"port"]],[Jn]))}static DRAG_MIME_TYPE="application/x-potatno-port";mComponent;mDragPositionEventHandler;mManager;mPort;mUnsubscribe;get dragPositionEventHandler(){return this.mDragPositionEventHandler}#t=(Wn(this),Zn(this));get dragConnectionSvg(){return this.#t}set dragConnectionSvg(e){this.#t=e}get hasError(){return this.port===null?!1:this.mManager.integrity.errorItems.has(this.port)}get inputDefinitions(){if(!this.port)return new Array;let e=this.port.project.types.getType(this.port.resolvedDataType);return e.inputs.map((r,c)=>({htmlType:(()=>{switch(r.type){case"boolean":return"checkbox";case"number":return"number";case"string":return"text"}})(),index:c,name:r.name,value:this.port.directValue[c]??"",totalCount:e.inputs.length}))}get port(){return this.mPort}set port(e){if(this.mPort!==e){if(e===null)throw new A("A null port cant be assigned.",this);this.mPort=e,this.mComponent.updater.update()}}get portColor(){return!this.port||this.port.portType==="flow"?"var(--potatno-color-text)":this.mManager.generateStringColor(this.port.resolvedDataType)}get portDirection(){return this.port?.direction??"output"}get portHandleClasses(){if(!this.port)return"";let e=[this.port.portType];return this.port.connectedPorts.size>0&&e.push("connected"),this.hasError&&e.push("error"),e.join(" ")}get portName(){return this.port?.label??""}get portType(){return!this.port||this.port.portType!=="value"?"":this.port.resolvedDataType??""}get showValueInput(){return!this.port||this.port.portType!=="value"||this.port.direction!=="input"||this.port.connectedPorts.size>0||this.mManager.grid.draggedPort.hasPort(this.port)?!1:!this.port.node.project.types.isGenericType(this.port.dataType??"")}constructor(e=R.use(B),r=R.use(X)){this.mComponent=e,this.mManager=r,this.mPort=null,this.mDragPositionEventHandler=c=>{this.mManager.grid.draggedPort.isDragging&&this.mManager.grid.draggedPort.hasPort(this.port)&&(performance.now()-c.timeStamp>100||this.renderDragWire(c.clientX,c.clientY))},document.addEventListener("dragover",this.mDragPositionEventHandler,{capture:!0}),this.mUnsubscribe=this.mManager.subscribe(O.Connection,()=>{this.mComponent.updater.updateAsync()})}onDeconstruct(){this.mUnsubscribe(),document.removeEventListener("dragover",this.mDragPositionEventHandler,{capture:!0})}onDirectValueInput(e,r){if(!this.port)return;let c=e.target,d=[...this.port.directValue];d[r]=c.type==="checkbox"?c.checked?"true":"false":c.value,this.mManager.graph.setPortDirectValue(this.port,d)}onDragEnd(e){e.stopPropagation(),e.preventDefault(),this.dragConnectionSvg&&(this.dragConnectionSvg.innerHTML=""),this.mComponent.updater.updateAsync()}onDragOver(e){this.draggedPortCanConnect(e.dataTransfer)&&(e.preventDefault(),e.stopPropagation(),e.dataTransfer&&(e.dataTransfer.dropEffect="link"))}onDragStart(e){if(!this.port||!e.dataTransfer){e.preventDefault();return}e.stopPropagation(),e.dataTransfer.effectAllowed="link",e.dataTransfer.setData(p.DRAG_MIME_TYPE,this.port.definitionId),e.dataTransfer.setDragImage(document.createElement("div"),0,0),this.mManager.grid.setDraggingPort([this.port]),this.mComponent.updater.updateAsync()}onDrop(e){if(this.draggedPortCanConnect(e.dataTransfer)&&(e.preventDefault(),e.stopPropagation(),!!this.mManager.grid.draggedPort.isDragging&&this.port))for(let r of this.mManager.grid.draggedPort.ports)this.mManager.graph.connectPorts(r,this.port)}createDragPath(e,r){if(!this.port)return"";let c=this.mManager.connections.pixelToGridSpace(e,r);return this.mManager.connections.createTemporaryPath(this.port,c)}draggedPortCanConnect(e){if(!this.port||!this.mManager.grid.draggedPort.isDragging||!e||!e.types.includes(p.DRAG_MIME_TYPE))return!1;for(let r of this.mManager.grid.draggedPort.ports)if(r!==this.port&&r.direction!==this.port.direction&&r.portType===this.port.portType)return!0;return!1}renderDragWire(e,r){if(!this.mManager.grid.draggedPort.hasPort(this.port)||!this.dragConnectionSvg)return;let c=this.dragConnectionSvg.firstChild;if(c||(c=document.createElementNS("http://www.w3.org/2000/svg","path"),this.dragConnectionSvg.appendChild(c)),!this.mManager.grid.draggedPort.updatePointer(e,r))return;let d=this.mManager.grid.draggedPort.portPositions.get(this.port);if(!d)return;let g=d.x*this.mManager.grid.gridSize,y=d.y*this.mManager.grid.gridSize;this.dragConnectionSvg.style.setProperty("transform",`translate(${-g}px, ${-y}px)`),c.setAttribute("d",this.createDragPath(e,r))}}}};var Qn=`:host {\r
    display: block;\r
    font-family: var(--potatno-font-family);\r
    font-size: var(--potatno-font-size);\r
\r
...
\r
}`;var kn=`<!-- Resizeable part of node -->\r
...
\r
        ...
        `;function ha(){function p(l,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),l.push(a)}}function t(l,n,u,a,o,b,v,T,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:T},m={v:!1};s.addInitializer=p(a,m);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,o,b,v,T,w){var f=u[0],s,m,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,a,s,T,o,b,v,w,i),h!==void 0&&(c(o,h),o===0?m=h:o===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,T,o,b,v,w,i),h!==void 0){c(o,h);var N;o===0?N=h:o===1?(N=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,N!==void 0&&(m===void 0?m=N:typeof m=="function"?m=[m,N]:m.push(N))}}if(o===0||o===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var _=D,L=0;L<F.length;L++)_=F[L].call(I,_);return _}}else{var j=m;m=function(I,D){return j.call(I,D)}}l.push(m)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):o===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],o,b,v=new Map,T=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=l,s=s-5,b=b||[],P=b):(x=l.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(a,x,f,m,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function E(l,n,u){if(n.length>0){for(var a=[],o=l,b=l.name,v=n.length-1;v>=0;v--){var T={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),T=g(n,u,v);return a.length||C(n,v),{e:T,get c(){return E(n,a,v)}}}}function li(p,t,e,r){return(li=ha())(p,t,e,r)}var ci,ti,ui,hi,mi,di,fi,ei,oi,ri,ni,ii,si,Do;ci=Y({selector:"potatno-node",template:kn,style:Qn,modules:[Me],components:[se]}),ui=pt("node-drag"),hi=$.state(),mi=$.state({proxy:!0}),di=$.state({complexValue:!0}),fi=$.state({complexValue:!0});var ai=class{static{({e:[ei,oi,ri,ni,ii,si],c:[Do,ti]}=li(this,[[ui,1,"mDrag"],[hi,1,"isPreviewDisplaySelectionOpen"],[q,3,"nodeData"],[mi,1,"nodeTransformation"],[di,1,"previewPorts"],[fi,1,"previewDisplays"]],[ci]))}constructor(t=R.use(B),e=R.use(X)){this.mComponent=t,this.mManager=e,this.mNodeDefinition=null,this.mNodeData=null,this.isPreviewDisplaySelectionOpen=!1,this.nodeTransformation={height:0,width:0},this.previewPorts=new Array,this.previewDisplays=new Array,this.mUnsubscribe=this.mManager.subscribe(O.Node,r=>{r.item===this.nodeData&&this.resyncComponent(this.nodeData)})}mComponent;mManager;mNodeData;mNodeDefinition;mUnsubscribe;get canPreview(){return this.previewPorts.length>0}#t=(si(this),ei(this));get mDrag(){return this.#t}set mDrag(t){this.#t=t}get hasError(){if(!this.nodeData)return!1;if(this.mManager.integrity.errorItems.has(this.nodeData))return!0;for(let t of this.nodeData.inputs.list)if(this.mManager.integrity.errorItems.has(t))return!0;for(let t of this.nodeData.outputs.list)if(this.mManager.integrity.errorItems.has(t))return!0;return!1}get inputPorts(){return this.nodeData?this.nodeData.inputs.list:new Array}get isFunction(){return this.mNodeDefinition instanceof Mt}get isPreviewActive(){return!!this.nodeData?.preview}#e=oi(this);get isPreviewDisplaySelectionOpen(){return this.#e}set isPreviewDisplaySelectionOpen(t){this.#e=t}get nodeColor(){return this.mManager.generateStringColor(this.mNodeDefinition?.category.name??"")}get nodeData(){return this.mNodeData}set nodeData(t){this.mNodeData=t,this.mNodeDefinition=null,t&&(this.mNodeDefinition=this.mManager.activeFunction.nodeDefinitions.find(e=>e.id===this.nodeData.definitionId)??null,this.resyncComponent(t),this.mComponent.updater.update())}get nodeIcon(){return this.mNodeDefinition?.category.icon??""}get nodeLabel(){return this.nodeData?.label??""}#o=ri(this);get nodeTransformation(){return this.#o}set nodeTransformation(t){this.#o=t}get outputPorts(){return this.nodeData?this.nodeData.outputs.list:new Array}#r=ni(this);get previewPorts(){return this.#r}set previewPorts(t){this.#r=t}#n=ii(this);get previewDisplays(){return this.#n}set previewDisplays(t){this.#n=t}get previewDisplayId(){return this.nodeData?.preview?.displayId??""}get previewDriver(){if(!this.nodeData?.preview)return null;let t=this.nodeData.outputs.map.get(this.nodeData.preview.portDefinitionId);return t?this.mManager.preview.requestDriver(t,this.nodeData.preview.displayId):null}get previewPortDefinitionId(){return this.nodeData?.preview?.portDefinitionId??""}dragNode(t){if(!this.nodeData)return;t.preventDefault();let e=this.nodeData.transformation.x*this.mManager.grid.gridSize,r=this.nodeData.transformation.y*this.mManager.grid.gridSize,c=this.nodeData.transformation.x,d=this.nodeData.transformation.y,g=this.mComponent.element.getBoundingClientRect(),y=this.mComponent.element.offsetWidth?g.width/this.mComponent.element.offsetWidth:1,E=this.mComponent.element.offsetHeight?g.height/this.mComponent.element.offsetHeight:1,C=t.clientX,l=t.clientY,n=a=>{a.stopPropagation();let o=(a.clientX-C)/y,b=(a.clientY-l)/E,v=Math.round((e+o)/this.mManager.grid.gridSize),T=Math.round((r+b)/this.mManager.grid.gridSize);c===v&&d===T||(this.mManager.graph.transformNode(this.nodeData,w=>{w.moveTo(v,T)}),this.mDrag.dispatchEvent(new Eo(v-c,T-d)),c=v,d=T)},u=()=>{document.removeEventListener("pointermove",n),document.removeEventListener("pointerup",u)};document.addEventListener("pointermove",n),document.addEventListener("pointerup",u)}onDeconstruct(){this.mUnsubscribe()}openFunction(){this.mNodeDefinition instanceof Mt&&this.mManager.setActiveFunction(this.mNodeDefinition.function)}selectPreviewDisplay(t){this.mManager.graph.updateNode(this.nodeData,e=>{e.preview={portDefinitionId:e.preview.portDefinitionId,displayId:t}}),document.activeElement instanceof HTMLElement&&document.activeElement.blur()}selectPreviewPort(t){if(!this.nodeData)return;let e=(()=>{let r=this.previewPorts;return r.length===0?null:typeof t<"u"?r.find(c=>c.definitionId===t)??null:this.nodeData.preview?null:r[0]})();if(!e)return this.mManager.graph.updateNode(this.nodeData,r=>{r.preview=null});this.mManager.graph.updateNode(this.nodeData,r=>{let c=r.project.getFunction(r.function.definitionId),d=r.project.preview.availableDisplays(c,e.resolvedDataType);d.length===0&&(r.preview=null);let g=r.preview&&d.includes(r.preview.displayId)?r.preview.displayId:d[0];r.preview={portDefinitionId:e.definitionId,displayId:g}}),this.resyncComponent(this.nodeData)}getPreviewDisplays(t){if(!this.nodeData||!t)return new Array;let e=this.nodeData.outputs.map.get(t);if(!e)return new Array;let r=e.project.getFunction(e.node.function.definitionId);return r?e.project.preview.availableDisplays(r,e.resolvedDataType).map(d=>({id:d,label:e.project.preview.getDisplay(d)?.name??d})):new Array}getPreviewablePorts(t){let e=t.project.getFunction(t.function.definitionId);if(!this.mManager.activeFunction.dynamicNodeDefinitions.find(d=>d.id===t.definitionId))return new Array;let c=new Map;return t.outputs.value.filter(d=>{let g=d.resolvedDataType;if(c.has(g))return c.get(g);let y=t.project.preview.availableDisplays(e,d.resolvedDataType);return c.set(g,y.length>0),c.get(g)})}resyncComponent(t){let e=t.transformation.x*this.mManager.grid.gridSize,r=t.transformation.y*this.mManager.grid.gridSize;this.mComponent.element.style.setProperty("left",`${e}px`),this.mComponent.element.style.setProperty("top",`${r}px`),this.nodeTransformation.width=t.transformation.width,this.nodeTransformation.height=t.transformation.height,this.previewPorts=this.getPreviewablePorts(this.nodeData),this.previewDisplays=this.getPreviewDisplays(t.preview?.portDefinitionId??null)}static{ti()}},Eo=class{mX;mY;get x(){return this.mX}get y(){return this.mY}constructor(t,e){this.mX=t,this.mY=e}};var pi=`:host {\r
    position: relative;\r
    flex: 1;\r
    display: flex;\r
    min-height: 0;\r
...
}`;var yi=`<div class="node {{this.hasError ? 'error' : ''}}" (pointerdown)="this.dragNode($event)">\r
\r
</div>\r
    `;function ga(){function p(l,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),l.push(a)}}function t(l,n,u,a,o,b,v,T,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:T},m={v:!1};s.addInitializer=p(a,m);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,o,b,v,T,w){var f=u[0],s,m,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,a,s,T,o,b,v,w,i),h!==void 0&&(c(o,h),o===0?m=h:o===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,T,o,b,v,w,i),h!==void 0){c(o,h);var N;o===0?N=h:o===1?(N=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,N!==void 0&&(m===void 0?m=N:typeof m=="function"?m=[m,N]:m.push(N))}}if(o===0||o===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var _=D,L=0;L<F.length;L++)_=F[L].call(I,_);return _}}else{var j=m;m=function(I,D){return j.call(I,D)}}l.push(m)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):o===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],o,b,v=new Map,T=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=l,s=s-5,b=b||[],P=b):(x=l.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(a,x,f,m,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function E(l,n,u){if(n.length>0){for(var a=[],o=l,b=l.name,v=n.length-1;v>=0;v--){var T={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),T=g(n,u,v);return a.length||C(n,v),{e:T,get c(){return E(n,a,v)}}}}function Ei(p,t,e,r){return(Ei=ga())(p,t,e,r)}var Di,bi,Ii,wi,xi,Co;Di=Y({selector:"potatno-conjunction-node",template:yi,style:vi,components:[se]}),Ii=pt("node-drag");var Ti=class{static{({e:[wi,xi],c:[Co,bi]}=Ei(this,[[Ii,1,"mDrag"],[q,3,"nodeData"]],[Di]))}constructor(t=R.use(B),e=R.use(X)){this.mComponent=t,this.mManager=e,this.mNodeData=null,this.mUnsubscribe=this.mManager.subscribe(O.Node,r=>{r.item===this.nodeData&&this.resyncComponent(this.nodeData)})}mComponent;mManager;mNodeData;mUnsubscribe;#t=(xi(this),wi(this));get mDrag(){return this.#t}set mDrag(t){this.#t=t}get hasError(){if(!this.nodeData)return!1;if(this.mManager.integrity.errorItems.has(this.nodeData))return!0;for(let t of this.nodeData.inputs.list)if(this.mManager.integrity.errorItems.has(t))return!0;for(let t of this.nodeData.outputs.list)if(this.mManager.integrity.errorItems.has(t))return!0;return!1}get nodeData(){return this.mNodeData}set nodeData(t){this.mNodeData=t,t&&this.resyncComponent(t)}dragNode(t){if(!this.nodeData)return;t.preventDefault();let e=this.nodeData.transformation.x*this.mManager.grid.gridSize,r=this.nodeData.transformation.y*this.mManager.grid.gridSize,c=this.nodeData.transformation.x,d=this.nodeData.transformation.y,g=this.mComponent.element.getBoundingClientRect(),y=this.mComponent.element.offsetWidth?g.width/this.mComponent.element.offsetWidth:1,E=this.mComponent.element.offsetHeight?g.height/this.mComponent.element.offsetHeight:1,C=t.clientX,l=t.clientY,n=a=>{a.stopPropagation();let o=(a.clientX-C)/y,b=(a.clientY-l)/E,v=Math.round((e+o)/this.mManager.grid.gridSize),T=Math.round((r+b)/this.mManager.grid.gridSize);c===v&&d===T||(this.mManager.graph.transformNode(this.nodeData,w=>{w.moveTo(v,T)}),this.mDrag.dispatchEvent(new Io(v-c,T-d)),c=v,d=T)},u=()=>{document.removeEventListener("pointermove",n),document.removeEventListener("pointerup",u)};document.addEventListener("pointermove",n),document.addEventListener("pointerup",u)}onDeconstruct(){this.mUnsubscribe()}resyncComponent(t){let e=t.transformation.x*this.mManager.grid.gridSize,r=t.transformation.y*this.mManager.grid.gridSize;this.mComponent.element.style.setProperty("left",`${e}px`),this.mComponent.element.style.setProperty("top",`${r}px`),this.mComponent.updater.update()}static{bi()}},Io=class{mX;mY;get x(){return this.mX}get y(){return this.mY}constructor(t,e){this.mX=t,this.mY=e}};function va(){function p(l,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),l.push(a)}}function t(l,n,u,a,o,b,v,T,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:T},m={v:!1};s.addInitializer=p(a,m);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,o,b,v,T,w){var f=u[0],s,m,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,a,s,T,o,b,v,w,i),h!==void 0&&(c(o,h),o===0?m=h:o===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,T,o,b,v,w,i),h!==void 0){c(o,h);var N;o===0?N=h:o===1?(N=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,N!==void 0&&(m===void 0?m=N:typeof m=="function"?m=[m,N]:m.push(N))}}if(o===0||o===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var _=D,L=0;L<F.length;L++)_=F[L].call(I,_);return _}}else{var j=m;m=function(I,D){return j.call(I,D)}}l.push(m)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):o===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],o,b,v=new Map,T=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=l,s=s-5,b=b||[],P=b):(x=l.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(a,x,f,m,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function E(l,n,u){if(n.length>0){for(var a=[],o=l,b=l.name,v=n.length-1;v>=0;v--){var T={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),T=g(n,u,v);return a.length||C(n,v),{e:T,get c(){return E(n,a,v)}}}}function Ni(p,t,e,r){return(Ni=va())(p,t,e,r)}function ya(p){return p}var Ai,Ci,_i,Li,Pi,Mi,Si,Qe;Ai=Y({selector:"potatno-node-graph",template:gi,style:pi,components:[ie,Do,xo,Co,To]}),_i=$.state(),Li=$.state({complexValue:!0});new class extends ya{constructor(){super(Qe),Ci()}static{class p{static{({e:[Pi,Mi,Si],c:[Qe,Ci]}=Ni(this,[[_i,1,"popupPosition"],[Li,1,"selectBox"]],[Ai]))}static ZOOM_STRENGTH=.1;mComponent;mIsMouseInsideGrid;mKeyboardHandler;mManager;mSelectedNodes;mUnsubscribeFunctionChange;mUnsubscribeGraphChange;#t=(Si(this),Pi(this));get popupPosition(){return this.#t}set popupPosition(e){this.#t=e}#e=Mi(this);get selectBox(){return this.#e}set selectBox(e){this.#e=e}get gridBackgroundStyle(){let e=this.mManager.grid.gridSize*this.mManager.grid.zoom,r=this.mManager.grid.panX%e,c=this.mManager.grid.panY%e;return`background-size: ${e}px ${e}px; background-position: ${r}px ${c}px;`}get gridTransformStyle(){return`transform: translate(${this.mManager.grid.panX}px, ${this.mManager.grid.panY}px) scale(${this.mManager.grid.zoom})`}get nodes(){return this.mManager.activeFunction.nodes}get selectedNode(){return this.mSelectedNodes}constructor(e=R.use(B),r=R.use(X)){this.mComponent=e,this.mManager=r,this.mSelectedNodes=new Set,this.mIsMouseInsideGrid=!1,this.popupPosition=null,this.selectBox=null,e.element.addEventListener("pointerdown",c=>{this.onPointerDown(c)}),e.element.addEventListener("wheel",c=>{this.onScroll(c)}),e.element.addEventListener("contextmenu",c=>{c.preventDefault()}),e.element.addEventListener("pointerenter",()=>{this.mIsMouseInsideGrid=!0}),e.element.addEventListener("pointerleave",()=>{this.mIsMouseInsideGrid=!1}),this.mKeyboardHandler=c=>{this.onKeyDown(c)},document.addEventListener("keydown",this.mKeyboardHandler),this.mUnsubscribeFunctionChange=this.mManager.subscribe(O.Document|O.Function|O.SpecialActiveFunction,()=>{this.popupPosition=null,this.selectBox=null,this.selectNodes([],!1)}),this.mUnsubscribeGraphChange=this.mManager.subscribe(O.NodeAdd|O.NodeDelete|O.SpecialGrid,()=>{this.mComponent.updater.updateAsync()})}createNodeOnPopupPosition(e){let r=this.mManager.graph.addNode(this.mManager.activeFunction,e,{x:this.popupPosition?.grid.x??0,y:this.popupPosition?.grid.y??0,height:0,width:0});this.popupPosition=null,this.selectNodes([r],!1)}moveAllSelected(e,r){for(let c of this.mSelectedNodes)c!==e&&this.mManager.graph.transformNode(c,d=>{d.moveTo(d.transformation.x+r.x,d.transformation.y+r.y)})}onConnect(){this.mManager.connections.gridElement=this.mComponent.element}onDeconstruct(){this.mUnsubscribeFunctionChange(),this.mUnsubscribeGraphChange(),document.removeEventListener("keydown",this.mKeyboardHandler)}selectNodes(e,r){this.popupPosition=null;let c=!!r;r instanceof PointerEvent&&(r.stopPropagation(),c=r.ctrlKey);let d=new Set;if(!c)if(e.length===1&&this.mSelectedNodes.has(e.at(0)))for(let y of this.mSelectedNodes)d.add(y);else this.mSelectedNodes.clear();let g=[...e];for(let y of g)d.has(y)||(d.add(y),y.definitionId===gt.DEFINITION_ID&&g.push(...this.getNodesInRectangle({top:y.transformation.y,right:y.transformation.x+y.transformation.width,bottom:y.transformation.y+y.transformation.height,left:y.transformation.x})),this.mSelectedNodes.has(y)?this.mSelectedNodes.delete(y):this.mSelectedNodes.add(y));this.mComponent.updater.updateAsync()}typeOfNode(e){switch(e.definitionId){case gt.DEFINITION_ID:return"comment";case lt.DEFINITION_ID:case at.DEFINITION_ID:return"conjunction";default:return"node"}}convertGlobalToGridPosition(e,r){let c=this.mComponent.element.getBoundingClientRect();return{x:e-c.left,y:r-c.top}}convertLocalToGridCoordinate(e,r){return{x:(e-this.mManager.grid.panX)/this.mManager.grid.zoom,y:(r-this.mManager.grid.panY)/this.mManager.grid.zoom}}getNodesInRectangle(e){let r=new Array;for(let c of this.mManager.activeFunction.nodes){let d=c.transformation.y,g=c.transformation.x,y=g+c.transformation.width,E=d+c.transformation.height;if(g<e.right&&y>e.left&&d<e.bottom&&E>e.top){if(e.top>d&&e.right<y&&e.bottom<E&&e.left>g)continue;r.push(c)}}return r}onKeyDown(e){if(!this.mIsMouseInsideGrid)return;let r=document.activeElement;if(!(r instanceof HTMLInputElement||r instanceof HTMLTextAreaElement||r instanceof HTMLSelectElement)){switch(e.key){case"Escape":{this.popupPosition=null;return}case"Delete":{for(let c of this.mSelectedNodes)this.mManager.graph.removeNode(c);this.selectNodes([],!1);return}}if(e.ctrlKey)switch(e.key){case"z":{e.preventDefault(),this.mManager.history.undo();return}case"y":{e.preventDefault(),this.mManager.history.redo();return}case"c":{this.mManager.clipboard.copy(this.mSelectedNodes);return}case"v":e.preventDefault(),this.pasteFromClipboard()}}}onPointerDown(e){switch(this.popupPosition=null,e.button){case 0:{e.ctrlKey||this.selectNodes([],!1),this.pointerDrag(e,"selecting");return}case 1:{e.preventDefault(),this.pointerDrag(e,"panning");return}case 2:{this.openAddNodePopupAtPointer(e.clientX,e.clientY);return}}}onScroll(e){e.preventDefault();let r=e.deltaY>0?-1:1,c=this.convertGlobalToGridPosition(e.clientX,e.clientY);this.mManager.grid.zoomAt(c.x,c.y,r*p.ZOOM_STRENGTH)}openAddNodePopupAtPointer(e,r){let c=this.mComponent.element,d=this.convertGlobalToGridPosition(e,r),g=this.convertLocalToGridCoordinate(d.x,d.y),y=8,E=Math.max(0,c.clientWidth-ie.POPUP_WIDTH-y),C=Math.max(0,c.clientHeight-ie.POPUP_HEIGHT-y);this.popupPosition={local:{x:Math.max(y,Math.min(d.x,E)),y:Math.max(y,Math.min(d.y,C))},grid:{x:Math.round(g.x/this.mManager.grid.gridSize),y:Math.round(g.y/this.mManager.grid.gridSize)}}}pasteFromClipboard(){let e=this.mManager.clipboard.paste();e.length!==0&&this.selectNodes(e,!1)}pointerDrag(e,r){let c=this.convertGlobalToGridPosition(e.clientX,e.clientY),d=c,g=E=>{let C=this.convertGlobalToGridPosition(E.clientX,E.clientY);switch(r){case"panning":{this.mManager.grid.pan(C.x-d.x,C.y-d.y);break}case"selecting":{this.selectBox={x:Math.min(c.x,C.x),y:Math.min(c.y,C.y),width:Math.abs(C.x-c.x),height:Math.abs(C.y-c.y)};break}}d=C},y=E=>{if(document.removeEventListener("pointermove",g),document.removeEventListener("pointerup",y),r==="selecting"&&this.selectBox){let C=this.convertLocalToGridCoordinate(this.selectBox.x,this.selectBox.y),l=this.convertLocalToGridCoordinate(this.selectBox.x+this.selectBox.width,this.selectBox.y+this.selectBox.height),n=this.mManager.grid.gridSize,u=this.getNodesInRectangle({top:C.y/n,right:l.x/n,bottom:l.y/n,left:C.x/n});this.selectNodes(u,E.ctrlKey),this.selectBox=null}};document.addEventListener("pointermove",g),document.addEventListener("pointerup",y)}}}};var ae=class{mCodeGenerator;mId;mLabel;mNodesProvider;mStatics;get codeGenerator(){return this.mCodeGenerator}get id(){return this.mId}get label(){return this.mLabel}get statics(){return this.mStatics}constructor(t){this.mId=t.id,this.mLabel=t.label,this.mNodesProvider=t.nodes,this.mStatics=t.statics,this.mCodeGenerator=t.generator.code}getNodeDefinitions(t){let e=c=>{if(!c)return new Array;let d=new Array;return c(g=>{d.push(g)},t),d},r={};return Object.defineProperty(r,"entry",{get:()=>e(this.mNodesProvider.entry)}),Object.defineProperty(r,"exit",{get:()=>e(this.mNodesProvider.exit)}),Object.defineProperty(r,"dynamic",{get:()=>e(this.mNodesProvider.dynamic)}),r}},Ot={none:0,imports:1,inputs:2,outputs:4};var Ri=`:host {\r
    display: flex;\r
    flex-direction: column;\r
    height: 100%;\r
    overflow: hidden;\r
