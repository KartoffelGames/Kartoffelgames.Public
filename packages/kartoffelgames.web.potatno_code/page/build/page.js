...
.port {
    ...
    .port__handle {
        ...
        .port-handle {
            ...
            &.port-handle--type-flow {
                ...
                &.port-handle--connected::before {
                    background: var(---potatno-port-color);
                }

                &.port-handle--disconnected::before {
                    background: color-mix(in srgb, var(---potatno-port-color) 30%, var(--potatno-color-background));
                }

                &.port-handle--has-error::before {
            ...
            &.port-handle--type-value {
                ...
                &.port-handle--disconnected {
                    background: color-mix(in srgb, var(---potatno-port-color) 30%, var(--potatno-color-background));
                }

                &.port-handle--has-error {
                    background: var(--potatno-color-error);
                }
            }
    ...
    <!-- Actual port handle. -->
    <div class="port" [title]="this.portTypeLabel" (pointerdown)="this.onPointerDown($event)">
...
`;function gs(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,g,T,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:g?"#"+n:n,static:b,private:g,metadata:T},d={v:!1};s.addInitializer=f(a,d);var i,h;r===0?g?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,g,T,w){var p=u[0],s,d,i;g?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof p=="function")h=t(p,a,s,T,r,b,g,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var P=p.length-1;P>=0;P--){var M=p[P];if(h=t(M,a,s,T,r,b,g,w,i),h!==void 0){c(r,h);var N;r===0?N=h:r===1?(N=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,N!==void 0&&(d===void 0?d=N:typeof d=="function"?d=[d,N]:d.push(N))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var $=d;d=function(I,D){return $.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),g?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function v(l,n,u){for(var a=[],r,b,g=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var P=h?T:g,M=P.get(d)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!M&&s>2?P.set(d,s):P.set(d,!0)}m(a,x,p,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function E(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,g=n.length-1;g>=0;g--){var T={v:!1};try{var w=n[g](r,{kind:"class",name:b,addInitializer:f(a,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var g=Object.create(b===void 0?null:b),T=v(n,u,g);return a.length||S(n,g),{e:T,get c(){return E(n,a,g)}}}}function hn(f,t,e,o){return(hn=gs())(f,t,e,o)}var dn,sn,mn,pn,an,ln,cn,lr;dn=J({selector:"potatno-port",template:nn,style:on}),mn=G.state(),pn=Et("port-drag-start");var un=class{static{({e:[an,ln,cn],c:[lr,sn]}=hn(this,[[[rt,mn],1,"port"],[pn,1,"mPortDragStart"]],[dn]))}constructor(t=O.use(z),e=O.use(K)){this.mComponent=t,this.mLastRegisteredElement=null,this.mLastRegisteredPort=null,this.mManager=e,this.mUnsubscribe=null}mComponent;mLastRegisteredElement;mLastRegisteredPort;mManager;mUnsubscribe;#t=(cn(this),an(this,null));get port(){return this.#t}set port(t){this.#t=t}#e=ln(this);get mPortDragStart(){return this.#e}set mPortDragStart(t){this.#e=t}get inputDefinitions(){if(!this.port||this.port.portType!=="value")return[];if(this.port.node.project.types.isGenericType(this.port.dataType??""))return[];let t=this.port.project.types.getType(this.port.dataType??"");return t.inputs.map((e,o)=>({htmlType:e.type==="number"?"number":e.type==="boolean"?"checkbox":"text",index:o,name:e.name,value:this.port.directValue[o]??"",totalCount:t.inputs.length}))}get hasError(){return this.port!==null&&this.mManager.integrity.errorItems.has(this.port)}get portColor(){return!this.port||this.port.portType==="flow"?"var(--potatno-color-text)":this.getTypeColor(this.port.resolvedDataType)}get portDirection(){return this.port?.direction??"output"}get portHandleClasses(){if(!this.port)return"port-handle--disconnected";let t=new Array;return t.push(this.port.connectedPorts.size>0?"port-handle--connected":"port-handle--disconnected"),t.push(this.port.portType==="value"?"port-handle--type-value":"port-handle--type-flow"),this.hasError&&t.push("port-handle--has-error"),t.join(" ")}get portName(){return this.port?.label??""}get portTypeLabel(){return this.port?.dataType??""}get showDirectValueInput(){return this.port?this.port.portType==="value"&&this.port.direction==="input"&&this.port.connectedPorts.size===0&&!this.port.node.project.types.isGenericType(this.port.dataType??""):!1}onConnect(){this.mUnsubscribe=this.mManager.subscribe(F.Connection|F.Node,null,()=>{this.mComponent.updater.update()})}onDeconstruct(){this.mUnsubscribe?.(),this.mUnsubscribe=null}onDirectValueInput(t,e){if(!this.port)return;let o=t.target,c=[...this.port.directValue];c[e]=o.type==="checkbox"?o.checked?"true":"false":o.value,this.mManager.graph.setPortDirectValue(this.port,c)}onPointerDown(t){t.stopPropagation(),t.preventDefault(),this.mPortDragStart.dispatchEvent({port:this.port})}onUpdate(){let t=this.port;if(!t)return;let e=this.mComponent.element;t===this.mLastRegisteredPort&&e===this.mLastRegisteredElement||(this.mLastRegisteredElement=e,this.mLastRegisteredPort=t,this.mManager.grid.registerPortElement(t,e))}getTypeColor(t){let e=0;for(let c=0;c<t.length;c++)e=t.charCodeAt(c)+((e<<5)-e);return`hsl(${Math.abs(e)*137.508%360}, 70%, 60%)`}static{sn()}};var fn=`:host {\r
    display: block;\r
    height: 100%;\r
    width: 100%;\r
    font-family: var(--pn-font-family);\r
...
`;var ri=`<div class="resize-handle" (pointerdown)="this.onResizePointerDown($event)"></div>
