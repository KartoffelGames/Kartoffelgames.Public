...
.node-header {\r
    ...
    font-weight: bold;\r
    font-size: var(--potatno-font-size-small);\r
    border-bottom: 1px solid var(--node-category-color);\r
    overflow: hidden;\r
    cursor: grab;\r
\r
