...
`)){let m=e.value.split(`
`);c=e.lineNumber+m.length-1,o=1+m[m.length-1].length}else o=e.columnNumber+e.value.length,c=e.lineNumber;return{graph:t.graph,lineStart:e.lineNumber,columnStart:e.columnNumber,lineEnd:c,columnEnd:o}}graphIsCircular(t){let e=this.mGraphStack.top;if(!e.circularGraphs.has(t))return!1;if(t.isJunction){if(e.circularGraphs.get(t)>p.MAX_JUNCTION_CIRCULAR_REFERENCES)throw new N("Junction graph called circular too often.",this);return!1}return!0}moveNextToken(){let t=this.mGraphStack.top;if(t.circularGraphs.size>0&&(t.circularGraphs=new k),t.graph&&t.graph.isJunction)throw new N("Junction graph must not have own nodes.",this);if(t.token.cursor++,t.token.cursor<this.mTokenCache.length)return;let e=this.mTokenGenerator.next();if(e.done){this.mTokenCache.push(null);return}this.mLastTokenPosition.column=e.value.columnNumber,this.mLastTokenPosition.line=e.value.lineNumber,this.mTokenCache.push(e.value)}popGraphStack(t){let e=this.mGraphStack.pop(),o=this.mGraphStack.top;if(t&&(e.token.cursor=e.token.start),e.token.cursor!==e.token.start&&o.circularGraphs.size>0&&(o.circularGraphs=new k),!this.mTrimTokenCache){o.token.cursor=e.token.cursor;return}e.linear?(this.mTokenCache.splice(0,e.token.cursor),o.token.start=0,o.token.cursor=0):o.token.cursor=e.token.cursor}pushGraphStack(t,e){let o=this.mGraphStack.top,c={graph:t,linear:e&&o.linear,circularGraphs:new k(o.circularGraphs),token:{start:o.token.cursor,cursor:o.token.cursor}},m=c.circularGraphs.get(t)??0;c.circularGraphs.set(t,m+1),this.mGraphStack.push(c)}};var de=class p{static NODE_NULL_RESULT=Symbol("FAILED_NODE_VALUE_PARSE");static NODE_VALUE_LIST_END_MEET=Symbol("FAILED_NODE_VALUE_PARSE");mConfiguration;mLexer;mRootPart;get lexer(){return this.mLexer}constructor(t,e){this.mLexer=t,this.mRootPart=null,this.mConfiguration={keepTraceIncidents:!1,trimTokenCache:!1,...e}}parse(t,e){if(this.mRootPart===null)throw new N("Parser has not root part set.",this);let o=new Ne(this.mLexer.tokenize(t,e),this.mConfiguration.keepTraceIncidents,this.mConfiguration.trimTokenCache),c=(()=>{try{return this.beginParseProcess(o,this.mRootPart)}catch(g){if(g instanceof Gt)return o.incidentTrace.push(g.message,o.currentGraph,g.lineStart,g.columnStart,g.lineEnd,g.columnEnd,!0,g),H.PARSER_ERROR;let y=g instanceof Error?g.message:g.toString(),T=o.getGraphPosition();return o.incidentTrace.push(y,o.currentGraph,T.lineStart,T.columnStart,T.lineEnd,T.columnEnd,!0,g),H.PARSER_ERROR}})();if(c===H.PARSER_ERROR)throw new H(o.incidentTrace);let m=o.collapse();if(m.length!==0){let g=m[0];if(o.incidentTrace.top.range.lineEnd===1&&o.incidentTrace.top.range.columnEnd===1){let y=`Tokens could not be parsed. Graph end meet without reaching last token. Current: "${g.value}" (${g.type})`;o.incidentTrace.push(y,this.mRootPart,g.lineNumber,g.columnNumber,g.lineNumber,g.columnNumber)}throw new H(o.incidentTrace)}return c}setRootGraph(t){this.mRootPart=t}beginParseProcess(t,e){t.moveNextToken(),t.processStack.push({type:"graph-parse",parameter:{graph:e,linear:!0},state:0});let o=p.NODE_NULL_RESULT;for(;t.processStack.top;)o=this.processStack(t,t.processStack.top,o);return o}processChainedNodeParseProcess(t,e,o){switch(e.state){case 0:{let g=e.parameter.node.connections.next;return g===null?(t.processStack.pop(),{}):(e.state++,t.processStack.push({type:"node-parse",parameter:{node:g},state:0,values:{}}),p.NODE_NULL_RESULT)}case 1:{let c=o;return c===H.PARSER_ERROR?(t.processStack.pop(),H.PARSER_ERROR):(t.processStack.pop(),c)}}throw new N(`Invalid node next parse state "${e.state}".`,this)}processGraphParseProcess(t,e,o){let c=e.parameter.graph;switch(e.state){case 0:{if(t.graphIsCircular(c)){let g=t.getGraphPosition();return t.incidentTrace.push("Circular graph detected.",c,g.lineStart,g.columnStart,g.lineEnd,g.columnEnd),t.processStack.pop(),H.PARSER_ERROR}let m=e.parameter.linear;return t.pushGraphStack(c,m),e.state++,t.processStack.push({type:"node-parse",parameter:{node:c.node},state:0,values:{}}),p.NODE_NULL_RESULT}case 1:{let m=o;if(m===H.PARSER_ERROR)return t.popGraphStack(!0),t.processStack.pop(),H.PARSER_ERROR;let g=c.convert(m,t);if(typeof g=="symbol"){let y=t.getGraphPosition();return t.incidentTrace.push(g.description??"Unknown data convert error",y.graph,y.lineStart,y.columnStart,y.lineEnd,y.columnEnd),t.popGraphStack(!0),t.processStack.pop(),H.PARSER_ERROR}return t.popGraphStack(!1),t.processStack.pop(),g}}throw new N(`Invalid graph parse state "${e.state}".`,this)}processNodeParseProcess(t,e,o){let c=e.parameter.node;switch(e.state){case 0:return t.processStack.push({type:"node-value-parse",parameter:{node:c,valueIndex:0},state:0,values:{}}),e.state++,p.NODE_NULL_RESULT;case 1:{let m=o;return m===H.PARSER_ERROR?(t.processStack.pop(),H.PARSER_ERROR):(e.values.nodeValueResult=m,t.processStack.push({type:"node-next-parse",parameter:{node:c},state:0}),e.state++,p.NODE_NULL_RESULT)}case 2:{let m=o;if(m===H.PARSER_ERROR)return t.processStack.pop(),H.PARSER_ERROR;let g=c.mergeData(e.values.nodeValueResult,m);return t.processStack.pop(),g}}throw new N(`Invalid node parse state "${e.state}".`,this)}processNodeValueParseProcess(t,e,o){let c=e.parameter.node;switch(e.state){case 0:{if(o!==p.NODE_NULL_RESULT&&o!==H.PARSER_ERROR)return e.values.parseResult=o,e.state++,p.NODE_NULL_RESULT;let m=e.parameter.valueIndex,g=c.connections;if(m>=g.values.length)return e.values.parseResult=p.NODE_VALUE_LIST_END_MEET,e.state++,p.NODE_NULL_RESULT;e.parameter.valueIndex++;let y=t.currentToken,T=g.values[m];if(typeof T=="string"){if(!y){if(g.required){let S=t.getTokenPosition();t.incidentTrace.push(`Unexpected end of statement. Token "${T}" expected.`,t.currentGraph,S.lineStart,S.columnStart,S.lineEnd,S.columnEnd)}return p.NODE_NULL_RESULT}if(T!==y.type){if(g.required){let S=t.getTokenPosition();t.incidentTrace.push(`Unexpected token "${y.value}". "${T}" expected`,t.currentGraph,S.lineStart,S.columnStart,S.lineEnd,S.columnEnd)}return p.NODE_NULL_RESULT}return t.moveNextToken(),y.value}else{let S=g.values.length===1||g.values.length===m+1;return t.processStack.push({type:"graph-parse",parameter:{graph:T,linear:S},state:0}),p.NODE_NULL_RESULT}}case 1:{let m=e.values.parseResult,g=c.connections;if(m===p.NODE_VALUE_LIST_END_MEET&&!g.required){t.processStack.pop();return}return m===p.NODE_VALUE_LIST_END_MEET?(t.processStack.pop(),H.PARSER_ERROR):(t.processStack.pop(),m)}}throw new N(`Invalid node value parse state "${e.state}".`,this)}processStack(t,e,o){switch(e.type){case"graph-parse":return this.processGraphParseProcess(t,e,o);case"node-parse":return this.processNodeParseProcess(t,e,o);case"node-value-parse":return this.processNodeValueParseProcess(t,e,o);case"node-next-parse":return this.processChainedNodeParseProcess(t,e,o)}}};var q=class p{static define(t,e=!1){return new p(t,e)}mDataConverterList;mGraphCollector;mIsJunction;mResolvedGraphNode;get isJunction(){return this.mIsJunction}get node(){return this.mResolvedGraphNode||(this.mResolvedGraphNode=this.mGraphCollector().root),this.mResolvedGraphNode}constructor(t,e){this.mGraphCollector=t,this.mDataConverterList=new Array,this.mResolvedGraphNode=null,this.mIsJunction=e}convert(t,e){if(this.mDataConverterList.length===0)return t;let o=e.getGraphBoundingToken(),c=o[0]??void 0,m=o[1]??void 0;if(this.mDataConverterList.length===1)return this.mDataConverterList[0](t,c,m);let g=t;for(let y of this.mDataConverterList)if(g=y(g,c,m),typeof g=="symbol")return g;return g}converter(t){let e=new p(this.mGraphCollector,this.isJunction);return e.mDataConverterList.push(...this.mDataConverterList,t),e}};var U=class p{static new(){let t=new p("",!1,[]);return t.mRootNode=null,t}mConnections;mIdentifier;mRootNode;get configuration(){return{dataKey:this.mIdentifier.dataKey,isList:this.mIdentifier.type==="list",isRequired:this.mConnections.required,isBranch:this.mConnections.values.length>1}}get connections(){return this.mConnections}get root(){if(!this.mRootNode)throw new N("Staring nodes must be chained with another node to be used.",this);return this.mRootNode}constructor(t,e,o,c){if(t==="")this.mIdentifier={type:"empty",dataKey:"",mergeKey:""};else if(t.endsWith("[]"))this.mIdentifier={type:"list",mergeKey:"",dataKey:t.substring(0,t.length-2)};else if(t.includes("<-")){let g=t.split("<-");this.mIdentifier={type:"merge",dataKey:g[0],mergeKey:g[1]}}else this.mIdentifier={type:"single",mergeKey:"",dataKey:t};let m=o.map(g=>g instanceof p?q.define(()=>g):g);this.mConnections={required:e,values:m,next:null},c?this.mRootNode=c:this.mRootNode=this}mergeData(t,e){if(this.mIdentifier.type==="empty")return e;let o=e,c=typeof t>"u";if(this.mIdentifier.type==="single"){if(this.mIdentifier.dataKey in e)throw new N(`Graph path has a duplicate value identifier "${this.mIdentifier.dataKey}"`,this);return c||(o[this.mIdentifier.dataKey]=t),e}if(this.mIdentifier.type==="list"){let y;c?y=new Array:Array.isArray(t)?y=t:y=[t];let T=(()=>{if(this.mIdentifier.dataKey in e){let S=o[this.mIdentifier.dataKey];return Array.isArray(S)?(S.unshift(...y),S):(y.push(S),y)}return y})();return o[this.mIdentifier.dataKey]=T,e}if(c)return e;let m=(()=>{if(!this.mIdentifier.mergeKey)throw new N("Cant merge data without a merge key.",this);if(typeof t!="object"||t===null)throw new N("Node data must be an object when merge key is set.",this);if(!(this.mIdentifier.mergeKey in t))throw new N(`Node data does not contain merge key "${this.mIdentifier.mergeKey}"`,this);return t[this.mIdentifier.mergeKey]})();if(typeof m>"u")return e;let g=o[this.mIdentifier.dataKey];if(typeof g>"u")return o[this.mIdentifier.dataKey]=m,o;if(!Array.isArray(g))throw new N("Chain data merge value is not an array but should be.",this);return Array.isArray(m)?g.unshift(...m):g.unshift(m),e}optional(t,e){let o=typeof e>"u"?"":t,c=typeof e>"u"?t:e,m=new Array;Array.isArray(c)?m.push(...c):m.push(c);let g=new p(o,!1,m,this.mRootNode);return this.setChainedNode(g),g}required(t,e){let o=typeof e>"u"?"":t,c=typeof e>"u"?t:e,m=new Array;Array.isArray(c)?m.push(...c):m.push(c);let g=new p(o,!0,m,this.mRootNode);return this.setChainedNode(g),g}setChainedNode(t){if(this.mConnections.next!==null)throw new N("Node can only be chained to a single node.",this);this.mConnections.next=t}};var j={XmlIdentifier:"Identifier",XmlAssignment:"XmlAssignment",XmlValue:"XmlValue",XmlComment:"XmlComment",XmlOpenClosingBracket:"XmlOpenClosingBracket",XmlCloseBracket:"XmlCloseBracket",XmlOpenBracket:"XmlOpenBracket",XmlCloseClosingBracket:"XmlCloseClosingBracket",XmlExplicitValueIdentifier:"XmlExplicitValueIdentifier",ExpressionStart:"ExpressionStart",ExpressionEnd:"ExpressionEnd",ExpressionValue:"ExpressionValue",InstructionStart:"InstructionStart",InstructionInstructionValue:"InstructionInstructionValue",InstructionBodyStartBraket:"InstructionBodyStartBraket",InstructionBodyCloseBraket:"InstructionBodyCloseBraket",InstructionInstructionClosingBracket:"InstructionInstructionClosingBracket",InstructionInstructionOpeningBracket:"InstructionInstructionOpeningBracket"};var Re=class extends he{constructor(){super(),this.validWhitespaces=` 
\r`,this.trimWhitespace=!0;let t=this.createTokenPattern({pattern:{regex:/(?:(?!}}).)*/,type:j.ExpressionValue}}),e=this.createTokenPattern({pattern:{start:{regex:/{{/,type:j.ExpressionStart},end:{regex:/}}/,type:j.ExpressionEnd}}},s=>{s.useChildPattern(t)}),o=this.createTokenPattern({pattern:{regex:/[^>\s\n="/]+/,type:j.XmlIdentifier}}),c=this.createTokenPattern({pattern:{regex:/(?:(?!{{|"|<).)+/,type:j.XmlValue}}),m=this.createTokenPattern({pattern:{regex:/<!--.*?-->/,type:j.XmlComment}}),g=this.createTokenPattern({pattern:{regex:/=/,type:j.XmlAssignment}}),y=this.createTokenPattern({pattern:{start:{regex:/"/,type:j.XmlExplicitValueIdentifier},end:{regex:/"/,type:j.XmlExplicitValueIdentifier}}},s=>{s.useChildPattern(e),s.useChildPattern(c)}),T=this.createTokenPattern({pattern:{start:{regex:/<\//,type:j.XmlOpenClosingBracket},end:{regex:/>/,type:j.XmlCloseBracket}}},s=>{s.useChildPattern(o)}),S=this.createTokenPattern({pattern:{start:{regex:/</,type:j.XmlOpenBracket},end:{regex:/(?<closeClosingBracket>\/>)|(?<closeBracket>>)/,type:{closeClosingBracket:j.XmlCloseClosingBracket,closeBracket:j.XmlCloseBracket}}}},s=>{s.useChildPattern(g),s.useChildPattern(o),s.useChildPattern(y)}),l=this.createTokenPattern({pattern:{regex:/[^()"'`/)]+/,type:j.InstructionInstructionValue}}),n=this.createTokenPattern({pattern:{innerType:j.InstructionInstructionValue,start:{regex:/\//,type:j.InstructionInstructionValue},end:{regex:/\//,type:j.InstructionInstructionValue}}},s=>{s.useChildPattern(a),s.useChildPattern(r),s.useChildPattern(b),s.useChildPattern(u),s.useChildPattern(l)}),u=this.createTokenPattern({pattern:{innerType:j.InstructionInstructionValue,start:{regex:/\(/,type:j.InstructionInstructionValue},end:{regex:/\)/,type:j.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(a),s.useChildPattern(r),s.useChildPattern(b),s.useChildPattern(l)}),a=this.createTokenPattern({pattern:{innerType:j.InstructionInstructionValue,start:{regex:/"/,type:j.InstructionInstructionValue},end:{regex:/"/,type:j.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(r),s.useChildPattern(b),s.useChildPattern(u),s.useChildPattern(l)}),r=this.createTokenPattern({pattern:{innerType:j.InstructionInstructionValue,start:{regex:/'/,type:j.InstructionInstructionValue},end:{regex:/'/,type:j.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(a),s.useChildPattern(b),s.useChildPattern(u),s.useChildPattern(l)}),b=this.createTokenPattern({pattern:{innerType:j.InstructionInstructionValue,start:{regex:/`/,type:j.InstructionInstructionValue},end:{regex:/`/,type:j.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(a),s.useChildPattern(r),s.useChildPattern(u),s.useChildPattern(l)}),v=this.createTokenPattern({pattern:{regex:/\$[^(\s\n/{]+/,type:j.InstructionStart}}),E=this.createTokenPattern({pattern:{start:{regex:/\(/,type:j.InstructionInstructionOpeningBracket},end:{regex:/\)/,type:j.InstructionInstructionClosingBracket}}},s=>{s.useChildPattern(n),s.useChildPattern(a),s.useChildPattern(r),s.useChildPattern(b),s.useChildPattern(u),s.useChildPattern(l)}),w=this.createTokenPattern({pattern:{start:{regex:/{/,type:j.InstructionBodyStartBraket},end:{regex:/}/,type:j.InstructionBodyCloseBraket}}},s=>{for(let d of f)s.useChildPattern(d)}),f=[m,T,S,y,e,v,E,w,c];for(let s of f)this.useRootTokenPattern(s)}};var me=class extends de{constructor(){super(new Re),this.initGraph()}initGraph(){let t=q.define(()=>U.new().required(j.ExpressionStart).optional("value",j.ExpressionValue).required(j.ExpressionEnd)).converter(r=>new bt(r.value??"")),e=q.define(()=>{let r=e;return U.new().required("data[]",U.new().required("value",[t,U.new().required("text",j.XmlValue)])).optional("data<-data",r)}),o=q.define(()=>U.new().required("name",j.XmlIdentifier).optional("attributeValue",U.new().required(j.XmlAssignment).required(j.XmlExplicitValueIdentifier).optional("list<-data",e).required(j.XmlExplicitValueIdentifier))).converter(r=>{let b=new Array;if(r.attributeValue?.list)for(let v of r.attributeValue.list)v.value instanceof bt?b.push(v.value):b.push(v.value.text);return{name:r.name,values:b}}),c=q.define(()=>{let r=c;return U.new().required("data[]",o).optional("data<-data",r)}),m=q.define(()=>{let r=m;return U.new().required("data[]",U.new().required("value",[t,U.new().required("text",j.XmlValue),U.new().required(j.XmlExplicitValueIdentifier).required("text",j.XmlValue).required(j.XmlExplicitValueIdentifier)])).optional("data<-data",r)}),g=q.define(()=>U.new().required("list<-data",m)).converter(r=>{let b=new St;for(let v of r.list)v.value instanceof bt?b.addValue(v.value):b.addValue(v.value.text);return b}),y=q.define(()=>U.new().required(j.XmlComment)).converter(()=>null),T=q.define(()=>U.new().required(j.XmlOpenBracket).required("openingTagName",j.XmlIdentifier).optional("attributes<-data",c).required("closing",[U.new().required(j.XmlCloseClosingBracket),U.new().required(j.XmlCloseBracket).required("values",u).required(j.XmlOpenClosingBracket).required("closingTageName",j.XmlIdentifier).required(j.XmlCloseBracket)])).converter(r=>{if("closingTageName"in r.closing&&r.openingTagName!==r.closing.closingTageName)throw new N(`Opening (${r.openingTagName}) and closing tagname (${r.closing.closingTageName}) does not match`,this);let b=new Ct(r.openingTagName);if(r.attributes)for(let v of r.attributes)b.setAttribute(v.name).addValue(...v.values);return"values"in r.closing&&b.appendChild(...r.closing.values),b}),S=q.define(()=>{let r=S;return U.new().required("list[]",j.InstructionInstructionValue).optional("list<-list",r)}),l=q.define(()=>U.new().required("instructionName",j.InstructionStart).optional("instruction",U.new().required(j.InstructionInstructionOpeningBracket).required("value<-list",S).required(j.InstructionInstructionClosingBracket)).optional("body",U.new().required(j.InstructionBodyStartBraket).required("value",u).required(j.InstructionBodyCloseBraket))).converter(r=>{let b=r.instructionName.substring(1),v=r.instruction?.value.join("")??"",E=new Ut(b,v);return r.body&&E.appendChild(...r.body.value),E}),n=q.define(()=>{let r=n;return U.new().required("list[]",[y,T,l,g]).optional("list<-list",r)}),u=q.define(()=>{let r=n;return U.new().optional("list<-list",r)}).converter(r=>{let b=new Array;if(r.list)for(let v of r.list)v!==null&&b.push(v);return b}),a=q.define(()=>U.new().required("content",u)).converter(r=>{let b=new ct;return b.appendChild(...r.content),b});this.setRootGraph(a)}};var z=class p extends Ie{static mTemplateCache=new k;static mXmlParser=new me;mComponentElement;mRootBuilder;get element(){return this.mComponentElement.htmlElement}constructor(t){super({constructor:t.processorConstructor,parent:null}),at.registerComponent(this,t.htmlElement),this.setProcessorInjection(p,this),this.addConstructionHook(o=>{at.registerComponent(this,this.mComponentElement.htmlElement,o)}),p.mTemplateCache.has(t.processorConstructor)||p.mTemplateCache.set(t.processorConstructor,p.mXmlParser.parse(t.templateString??""));let e=p.mTemplateCache.get(t.processorConstructor).clone();this.mComponentElement=new ue(t.htmlElement),this.mRootBuilder=new qt(e,new Pe(this,t.expressionModule),new mt(this),"ROOT"),this.mComponentElement.shadowRoot.appendChild(this.mRootBuilder.anchor),this.setProcessorInjection(Tt,new Tt(this.mRootBuilder.values))}addStyle(t){let e=document.createElement("style");e.innerHTML=t,this.mComponentElement.shadowRoot.prepend(e)}attributeChanged(t,e,o){this.call("onAttributeChange",t,e,o)}connected(){this.call("onConnect")}deconstruct(){this.call("onDeconstruct"),this.mRootBuilder.deconstruct(),super.deconstruct()}disconnected(){this.call("onDisconnect")}onUpdate(){return this.mRootBuilder.update()?(this.call("onUpdate"),!0):!1}};function J(p){return(t,e)=>{O.registerInjectable(t,e.metadata,"instanced"),at.registerConstructor(t,p.selector);let o=class extends HTMLElement{mComponent;constructor(){super(),this.mComponent=new z({processorConstructor:t,templateString:p.template??null,expressionModule:p.expressionmodule,htmlElement:this}).setup(),p.style&&this.mComponent.addStyle(p.style),this.mComponent.updater.update()}connectedCallback(){this.mComponent.connected()}disconnectedCallback(){this.mComponent.disconnected()}};globalThis.customElements.define(p.selector,o)}}function Xt(p){return(t,e)=>{O.registerInjectable(t,e.metadata,"instanced"),lt.register(Rt,t,{access:p.access,targetRestrictions:p.targetRestrictions})}}function xt(p){return(t,e)=>{O.registerInjectable(t,e.metadata,"instanced"),lt.register(wt,t,{access:p.access,selector:p.selector})}}function Mt(p){return(t,e)=>{O.registerInjectable(t,e.metadata,"instanced"),lt.register(Vt,t,{instructionType:p.instructionType})}}function pi(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var M=f.length-1;M>=0;M--){var P=f[M];if(h=t(P,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var M=h?E:v,P=M.get(d)||0;if(P===!0||P===3&&s!==4||P===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!P&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,f,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||S(n,v),{e:E,get c(){return T(n,a,v)}}}}function pr(p,t,e,o){return(pr=pi())(p,t,e,o)}function gi(p){return p}var gr,fr,fe;gr=Xt({access:X.Read,targetRestrictions:[z]});new class extends gi{constructor(){super(fe),fr()}static{class p{static{({c:[fe,fr]}=pr(this,[],[gr]))}static METADATA_USER_EVENT_LISTENER_PROPERIES="pwb:user_event_listener_properties";mEventListenerList;mTargetElement;constructor(e=O.use(z)){let o=new Array,c=e.processorConstructor;do{let m=nt.get(c).getMetadata(p.METADATA_USER_EVENT_LISTENER_PROPERIES);if(m)for(let g of m)o.push(g)}while(c=Object.getPrototypeOf(c));this.mEventListenerList=new Array,this.mTargetElement=e.element;for(let m of o){let[g,y]=m,T=Reflect.get(e.processor,g);T=T.bind(e.processor),this.mEventListenerList.push([y,T]),this.mTargetElement.addEventListener(y,T)}}onDeconstruct(){for(let e of this.mEventListenerList){let[o,c]=e;this.mTargetElement.removeEventListener(o,c)}}}}};var pe=class extends window.Event{mValue;get value(){return this.mValue}constructor(t,e){super(t),this.mValue=e}};var ge=class{mElement;mEventName;constructor(t,e){this.mEventName=t,this.mElement=e}dispatchEvent(t){let e=new pe(this.mEventName,t);this.mElement.dispatchEvent(e)}};function Ht(p){return(t,e)=>{if(e.static)throw new N("Event target is not for a static property.",Ht);let o=null;return{get(){if(!o){let c=(()=>{try{return at.ofProcessor(this).component}catch{throw new N("PwbComponentEvent target class is not a component.",this)}})();o=new ge(p,c.element)}return o}}}}function vi(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var M=f.length-1;M>=0;M--){var P=f[M];if(h=t(P,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var M=h?E:v,P=M.get(d)||0;if(P===!0||P===3&&s!==4||P===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!P&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,f,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||S(n,v),{e:E,get c(){return T(n,a,v)}}}}function yr(p,t,e,o){return(yr=vi())(p,t,e,o)}function yi(p){return p}var br,vr,ve;br=Xt({access:X.ReadWrite,targetRestrictions:[z]});new class extends yi{constructor(){super(ve),vr()}static{class p{static{({c:[ve,vr]}=yr(this,[],[br]))}static METADATA_EXPORTED_PROPERTIES="pwb:exported_properties";mComponent;constructor(e=O.use(z)){this.mComponent=e;let o=new $t,c=e.processorConstructor;do{let g=nt.get(c).getMetadata(p.METADATA_EXPORTED_PROPERTIES);g&&o.push(...g)}while(c=Object.getPrototypeOf(c));let m=new Set(o);m.size>0&&this.connectExportedProperties(m)}connectExportedProperties(e){this.exportPropertyAsAttribute(e),this.patchHtmlAttributes(e)}exportPropertyAsAttribute(e){for(let o of e){let c={};c.enumerable=!0,c.configurable=!0,delete c.value,delete c.writable,c.set=m=>{Reflect.set(this.mComponent.processor,o,m)},c.get=()=>{let m=Reflect.get(this.mComponent.processor,o);return typeof m=="function"&&(m=m.bind(this.mComponent.processor)),m},Object.defineProperty(this.mComponent.element,o,c)}}patchHtmlAttributes(e){let o=this.mComponent.element.getAttribute;new MutationObserver(m=>{for(let g of m){let y=g.attributeName,T=o.call(this.mComponent.element,y);Reflect.set(this.mComponent.element,y,T),this.mComponent.attributeChanged(y,g.oldValue,T)}}).observe(this.mComponent.element,{attributeFilter:[...e],attributeOldValue:!0});for(let m of e)if(this.mComponent.element.hasAttribute(m)){let g=o.call(this.mComponent.element,m);this.mComponent.element.setAttribute(m,g)}this.mComponent.element.getAttribute=m=>e.has(m)?Reflect.get(this.mComponent.element,m):o.call(this.mComponent.element,m)}}}};function pt(p,t){if(t.static)throw new N("Event target is not for a static property.",pt);let e=nt.forInternalDecorator(t.metadata),o=e.getMetadata(ve.METADATA_EXPORTED_PROPERTIES)??new Array;o.push(t.name),e.setMetadata(ve.METADATA_EXPORTED_PROPERTIES,o)}function st(p){return(t,e)=>{if(e.static)throw new N("Child decorator is not for a static property.",st);return{get(){let m=(()=>{try{return at.ofProcessor(this).component}catch{throw new N("PwbChild target class is not a component.",this)}})().getProcessorInjection(Tt).data.store[p];if(m instanceof Element)return m;throw new N(`Can't find child "${p}".`,this)}}}}function bi(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var M=f.length-1;M>=0;M--){var P=f[M];if(h=t(P,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var M=h?E:v,P=M.get(d)||0;if(P===!0||P===3&&s!==4||P===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!P&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,f,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||S(n,v),{e:E,get c(){return T(n,a,v)}}}}function Tr(p,t,e,o){return(Tr=bi())(p,t,e,o)}var Er,wr,wi;Er=Mt({instructionType:"dynamic-content"});var xr=class{static{({c:[wi,wr]}=Tr(this,[],[Er]))}constructor(t=O.use(Q),e=O.use(G)){this.mModuleValues=e,this.mLastTemplate=null,this.mProcedure=this.mModuleValues.createExpressionProcedure(t.value)}mLastTemplate;mModuleValues;mProcedure;onUpdate(){let t=this.mProcedure.execute();if(!t||!(t instanceof ct))throw new N("Dynamic content method has a wrong result type.",this);if(this.mLastTemplate!==null&&this.mLastTemplate.equals(t))return null;let e=t.clone();this.mLastTemplate=e;let o=new ut;return o.addElement(e,new mt(this.mModuleValues.data)),o}static{wr()}};function xi(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var M=f.length-1;M>=0;M--){var P=f[M];if(h=t(P,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var M=h?E:v,P=M.get(d)||0;if(P===!0||P===3&&s!==4||P===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!P&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,f,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||S(n,v),{e:E,get c(){return T(n,a,v)}}}}function Sr(p,t,e,o){return(Sr=xi())(p,t,e,o)}var Cr,Dr,Ti;Cr=xt({access:X.Write,selector:/^\([[\w\-$]+\)$/});var Ir=class{static{({c:[Ti,Dr]}=Sr(this,[],[Cr]))}constructor(t=O.use(Z),e=O.use(G),o=O.use(et)){this.mTarget=t,this.mEventName=o.name.substring(1,o.name.length-1);let c=e.createExpressionProcedure(o.value,["$event"]);this.mListener=m=>{c.setTemporaryValue("$event",m),c.execute()},this.mTarget.addEventListener(this.mEventName,this.mListener)}mEventName;mListener;mTarget;onDeconstruct(){this.mTarget.removeEventListener(this.mEventName,this.mListener)}static{Dr()}};function Ei(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var M=f.length-1;M>=0;M--){var P=f[M];if(h=t(P,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var M=h?E:v,P=M.get(d)||0;if(P===!0||P===3&&s!==4||P===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!P&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,f,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||S(n,v),{e:E,get c(){return T(n,a,v)}}}}function Ar(p,t,e,o){return(Ar=Ei())(p,t,e,o)}var Nr,Mr,Di;Nr=Mt({instructionType:"for"});var Pr=class{static{({c:[Di,Mr]}=Ar(this,[],[Nr]))}constructor(t=O.use(ft),e=O.use(G),o=O.use(Q)){this.mTemplate=t,this.mModuleValues=e,this.mLastEntries=new Array;let c=o.value,g=new RegExp(/^\s*([a-zA-Z]+[a-zA-Z0-9]*)\s*of\s+([^;]+)\s*(;\s*([a-zA-Z]+[a-zA-Z0-9]*)\s*=\s*(.*)\s*)?$/).exec(c);if(!g)throw new N(`For-Parameter value has wrong format: ${c}`,this);let y=g[1],T=g[2],S=g[4]??null,l=g[5],n=this.mModuleValues.createExpressionProcedure(T),u=S?this.mModuleValues.createExpressionProcedure(l,["$index",y]):null;this.mExpression={iterateVariableName:y,iterateValueProcedure:n,indexExportVariableName:S,indexExportProcedure:u}}mExpression;mLastEntries;mModuleValues;mTemplate;onUpdate(){let t=new ut,e=this.mExpression.iterateValueProcedure.execute();if(typeof e=="object"&&e!==null||Array.isArray(e)){let o=Symbol.iterator in e?Object.entries([...e]):Object.entries(e);if(this.compareEntries(o,this.mLastEntries))return null;this.mLastEntries=o;for(let[c,m]of o)this.addTemplateForElement(t,this.mExpression,m,c);return t}else return null}addTemplateForElement=(t,e,o,c)=>{let m=new mt(this.mModuleValues.data);if(m.setTemporaryValue(e.iterateVariableName,o),e.indexExportProcedure&&e.indexExportVariableName){e.indexExportProcedure.setTemporaryValue("$index",c),e.indexExportProcedure.setTemporaryValue(e.iterateVariableName,o);let y=e.indexExportProcedure.execute();m.setTemporaryValue(e.indexExportVariableName,y)}let g=new ct;g.appendChild(...this.mTemplate.childList),t.addElement(g,m)};compareEntries(t,e){if(t.length!==e.length)return!1;for(let o=0;o<t.length;o++){let[c,m]=t[o],[g,y]=e[o];if(c!==g||m!==y)return!1}return!0}static{Mr()}};function Ii(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var M=f.length-1;M>=0;M--){var P=f[M];if(h=t(P,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var M=h?E:v,P=M.get(d)||0;if(P===!0||P===3&&s!==4||P===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!P&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,f,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||S(n,v),{e:E,get c(){return T(n,a,v)}}}}function Or(p,t,e,o){return(Or=Ii())(p,t,e,o)}var Fr,Rr,Si;Fr=Mt({instructionType:"if"});var Lr=class{static{({c:[Si,Rr]}=Or(this,[],[Fr]))}constructor(t=O.use(ft),e=O.use(G),o=O.use(Q)){this.mTemplateReference=t,this.mModuleValues=e,this.mProcedure=this.mModuleValues.createExpressionProcedure(o.value),this.mLastBoolean=!1}mLastBoolean;mModuleValues;mProcedure;mTemplateReference;onUpdate(){let t=this.mProcedure.execute();if(!!t!==this.mLastBoolean){this.mLastBoolean=!!t;let e=new ut;if(t){let o=new ct;o.appendChild(...this.mTemplateReference.childList),e.addElement(o,new mt(this.mModuleValues.data))}return e}else return null}static{Rr()}};function Ci(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var M=f.length-1;M>=0;M--){var P=f[M];if(h=t(P,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var M=h?E:v,P=M.get(d)||0;if(P===!0||P===3&&s!==4||P===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!P&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,f,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||S(n,v),{e:E,get c(){return T(n,a,v)}}}}function Vr(p,t,e,o){return(Vr=Ci())(p,t,e,o)}var $r,_r,Mi;$r=xt({access:X.Read,selector:/^\[[\w$]+\]$/});var jr=class{static{({c:[Mi,_r]}=Vr(this,[],[$r]))}constructor(t=O.use(Z),e=O.use(G),o=O.use(et)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(o.value),this.mTargetProperty=o.name.substring(1,o.name.length-1),this.mLastValue=Symbol("Uncomparable")}mLastValue;mProcedure;mTarget;mTargetProperty;onUpdate(){let t=this.mProcedure.execute();return t===this.mLastValue?!1:(this.mLastValue=t,Reflect.set(this.mTarget,this.mTargetProperty,t),!0)}static{_r()}};function Pi(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var M=f.length-1;M>=0;M--){var P=f[M];if(h=t(P,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var M=h?E:v,P=M.get(d)||0;if(P===!0||P===3&&s!==4||P===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!P&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,f,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||S(n,v),{e:E,get c(){return T(n,a,v)}}}}function Ur(p,t,e,o){return(Ur=Pi())(p,t,e,o)}var Gr,zr,Ai;Gr=xt({access:X.Write,selector:/^#[[\w$]+$/});var Br=class{static{({c:[Ai,zr]}=Ur(this,[],[Gr]))}constructor(t=O.use(Z),e=O.use(et),o=O.use(Tt)){o.setTemporaryValue(e.name.substring(1),t)}static{zr()}};function Ni(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var M=f.length-1;M>=0;M--){var P=f[M];if(h=t(P,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var M=h?E:v,P=M.get(d)||0;if(P===!0||P===3&&s!==4||P===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!P&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,f,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||S(n,v),{e:E,get c(){return T(n,a,v)}}}}function Yr(p,t,e,o){return(Yr=Ni())(p,t,e,o)}var Wr,Xr,Ri;Wr=Mt({instructionType:"slot"});var Hr=class{static{({c:[Ri,Xr]}=Yr(this,[],[Wr]))}constructor(t=O.use(G),e=O.use(Q)){this.mModuleValues=t,this.mSlotName=e.value,this.mIsSetup=!1}mIsSetup;mModuleValues;mSlotName;onUpdate(){if(this.mIsSetup)return null;this.mIsSetup=!0;let t=new Ct("slot");this.mSlotName!==""&&t.setAttribute("name").addValue(this.mSlotName);let e=new ct;e.appendChild(t);let o=new ut;return o.addElement(e,this.mModuleValues.data),o}static{Xr()}};function Li(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var M=f.length-1;M>=0;M--){var P=f[M];if(h=t(P,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var M=h?E:v,P=M.get(d)||0;if(P===!0||P===3&&s!==4||P===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!P&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,f,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||S(n,v),{e:E,get c(){return T(n,a,v)}}}}function Jr(p,t,e,o){return(Jr=Li())(p,t,e,o)}var Kr,Zr,Oi;Kr=xt({access:X.ReadWrite,selector:/^\[\([[\w$]+\)\]$/});var qr=class{static{({c:[Oi,Zr]}=Jr(this,[],[Kr]))}constructor(t=O.use(z),e=O.use(Z),o=O.use(G),c=O.use(et)){this.mTargetNode=e,this.mAttributeKey=c.name.substring(2,c.name.length-2),this.mReadProcedure=o.createExpressionProcedure(c.value),this.mWriteProcedure=o.createExpressionProcedure(`${c.value} = $DATA;`,["$DATA"]),this.mLastDataValue=Symbol("Uncomparable");let m=g=>{this.mLastDataValue!==g&&t.updater.updateAsync()};this.mTargetNode.addEventListener("input",g=>{m(Reflect.get(this.mTargetNode,this.mAttributeKey))}),this.mTargetNode.addEventListener("change",g=>{m(Reflect.get(this.mTargetNode,this.mAttributeKey))})}mAttributeKey;mLastDataValue;mReadProcedure;mTargetNode;mWriteProcedure;onUpdate(){let t=this.mReadProcedure.execute();if(t!==this.mLastDataValue)return Reflect.set(this.mTargetNode,this.mAttributeKey,t),this.mLastDataValue=t,!0;let e=Reflect.get(this.mTargetNode,this.mAttributeKey);return e!==t?(this.mWriteProcedure.setTemporaryValue("$DATA",e),this.mWriteProcedure.execute(),this.mLastDataValue=e,!0):!1}static{Zr()}};function Fi(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var M=f.length-1;M>=0;M--){var P=f[M];if(h=t(P,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var M=h?E:v,P=M.get(d)||0;if(P===!0||P===3&&s!==4||P===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!P&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,f,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||S(n,v),{e:E,get c(){return T(n,a,v)}}}}function to(p,t,e,o){return(to=Fi())(p,t,e,o)}var eo,Qr,_i;eo=Xt({access:X.Read,targetRestrictions:[wt]});var kr=class{static{({c:[_i,Qr]}=to(this,[],[eo]))}constructor(t=O.use(wt),e=O.use(Z)){let o=new Array,c=t.processorConstructor;do{let m=nt.get(c).getMetadata(fe.METADATA_USER_EVENT_LISTENER_PROPERIES);if(m)for(let g of m)o.push(g)}while(c=Object.getPrototypeOf(c));this.mEventListenerList=new Array,this.mTargetElement=e;for(let m of o){let[g,y]=m,T=Reflect.get(t.processor,g);T=T.bind(t.processor),this.mEventListenerList.push([y,T]),this.mTargetElement.addEventListener(y,T)}}mEventListenerList;mTargetElement;onDeconstruct(){for(let t of this.mEventListenerList){let[e,o]=t;this.mTargetElement.removeEventListener(e,o)}}static{Qr()}};var Qt=class{mCodeGenerator;mId;mLabel;mNodesProvider;mStatics;get codeGenerator(){return this.mCodeGenerator}get id(){return this.mId}get label(){return this.mLabel}get statics(){return this.mStatics}constructor(t){this.mId=t.id,this.mLabel=t.label,this.mNodesProvider=t.nodes,this.mStatics=t.statics,this.mCodeGenerator=t.generator.code}getNodeDefinitions(t){let e=c=>{if(!c)return new Array;let m=new Array;return c(g=>{m.push(g)},t),m},o={};return Object.defineProperty(o,"entry",{get:()=>e(this.mNodesProvider.entry)}),Object.defineProperty(o,"exit",{get:()=>e(this.mNodesProvider.exit)}),Object.defineProperty(o,"dynamic",{get:()=>e(this.mNodesProvider.dynamic)}),o}},rt={none:0,imports:1,inputs:2,outputs:4};var Le=class p{static PASTE_OFFSET=2;mClipboardNodes;mManager;constructor(t){this.mManager=t,this.mClipboardNodes=new Array}copy(t){if(t.size===0)return;let e=[...t],o=new Map;for(let c=0;c<e.length;c++){let m=e[c],g=m.inputs.value.map(T=>({definitionId:T.definitionId,values:[...T.directValue]})),y={...m.transformation};y.x+=p.PASTE_OFFSET,y.y+=p.PASTE_OFFSET,o.set(m,{connections:new Array,definitionId:m.definitionId,id:c,portDirectValues:g,label:m.label,transformation:y})}for(let[c,m]of o)for(let g of c.outputs.list)for(let y of g.connectedPorts){let T=o.get(y.node);T&&m.connections.push({sourcePortName:g.definitionId,targetNodeId:T.id,targetPortName:y.definitionId})}this.mClipboardNodes=[...o.values()]}paste(){if(this.mClipboardNodes.length===0)return new Array;let t=this.mManager.activeFunction;if(!t)return[];let e=new Map;for(let o of this.mClipboardNodes){let c=t.dynamicNodeDefinitions.find(g=>g.id===o.definitionId);if(!c)continue;let m=this.mManager.graph.addNode(t,c,o.transformation);this.mManager.graph.updateNode(m,g=>{g.label=o.label;for(let y of o.portDirectValues)g.inputs.map.has(y.definitionId)&&g.inputs.map.get(y.definitionId).setDirectValue(y.values)}),e.set(o.id,m)}for(let o of this.mClipboardNodes){let c=e.get(o.id);if(c)for(let m of o.connections){let g=e.get(m.targetNodeId);if(!g)continue;let y=c.outputs.map.get(m.sourcePortName),T=g.inputs.map.get(m.targetPortName);!y||!T||this.mManager.graph.connectPorts(y,T)}}return[...e.values()]}};var Oe=class p{static MAX_ZOOM=2;static MIN_ZOOM=.25;mPanX;mPanY;mGridSize;mZoom;get panX(){return this.mPanX}get panY(){return this.mPanY}get zoom(){return this.mZoom}constructor(t){this.mGridSize=t,this.mPanX=0,this.mPanY=0,this.mZoom=1}getGridBackgroundCss(){let t=this.mGridSize*this.mZoom,e=this.mPanX%t,o=this.mPanY%t;return[`background-size: ${t}px ${t}px`,`background-position: ${e}px ${o}px`,'background-image: url("data:image/svg+xml,%3Csvg xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22 viewBox%3D%220 0 100 100%22%3E%3Cpath d%3D%22M0 0h18M0 0v18M100 0H82M100 0v18M0 100h18M0 100V82M100 100H82M100 100V82%22 stroke%3D%22%23313244%22 stroke-width%3D%225%22 stroke-linecap%3D%22round%22%2F%3E%3C%2Fsvg%3E")'].join("; ")}getTransformCss(){return`translate(${this.mPanX}px, ${this.mPanY}px) scale(${this.mZoom})`}pan(t,e){this.mPanX+=t,this.mPanY+=e}screenToWorld(t,e){return{x:(t-this.mPanX)/this.mZoom,y:(e-this.mPanY)/this.mZoom}}snapToGrid(t,e){return{x:Math.round(t/this.mGridSize)*this.mGridSize,y:Math.round(e/this.mGridSize)*this.mGridSize}}zoomAt(t,e,o){let c=this.mZoom,m=1+o,g=this.mZoom*m;g=Math.max(p.MIN_ZOOM,Math.min(p.MAX_ZOOM,g));let y=(t-this.mPanX)/c,T=(e-this.mPanY)/c;this.mZoom=g,this.mPanX=t-y*this.mZoom,this.mPanY=e-T*this.mZoom}};var Fe=class p{static GRID_SIZE=25;mElementPorts;mInteraction;mPortElements;draggedPort;get gridSize(){return p.GRID_SIZE}get interaction(){return this.mInteraction}constructor(){this.mElementPorts=new WeakMap,this.mInteraction=new Oe(p.GRID_SIZE),this.mPortElements=new WeakMap,this.draggedPort=null}createConnectionPath(t,e,o){let c=this.gridSize,m=e.x>=t.x?1:-1,g={x:this.snapToGridCenter(t.x+m*c),y:this.snapToGridCenter(t.y)},y={x:this.snapToGridCenter(e.x-m*c),y:this.snapToGridCenter(e.y)},T=Math.min(g.x,y.x),S=Math.max(g.x,y.x),l=this.snapToGridCenter(g.x+(y.x-g.x)/2),n=this.getSourceConnectionLaneOffset(o)*m,u=Math.max(T,Math.min(S,this.snapToGridCenter(l+n)));return this.generateRoundedPath([t,g,{x:u,y:g.y},{x:u,y:y.y},y,e])}getPortElement(t){return this.mPortElements.get(t)}getPortFromPosition(t,e){let o=this.getElementFromPosition(t,e);if(!o)return null;let c=(()=>{let m=o.getRootNode();return m instanceof ShadowRoot&&m.host instanceof Element?m.host:o})();return this.mElementPorts.get(c)??null}registerPortElement(t,e){this.mElementPorts.set(e,t),this.mPortElements.set(t,e)}snapToGridCenter(t){return Math.round((t-this.gridSize/2)/this.gridSize)*this.gridSize+this.gridSize/2}getElementFromPosition(t,e){let o=(c,m,g)=>{let y=c.elementFromPoint(m,g);if(!y)return null;if(y.shadowRoot){let T=o(y.shadowRoot,m,g);if(T)return T}return y};return o(document,t,e)}getSourceConnectionLaneOffset(t){if(!t||t.direction!=="output")return 0;let e=t.node.outputs.list,o=e.indexOf(t);return o===-1?0:(e.length-o-1)*this.gridSize}generateRoundedPath(t){let e=Math.min(8,this.gridSize/3),o=[];for(let g of t){let y=o[o.length-1];(!y||y.x!==g.x||y.y!==g.y)&&o.push(g)}if(o.length<2)return"";let c=`M ${o[0].x} ${o[0].y}`;for(let g=1;g<o.length-1;g++){let y=o[g-1],T=o[g],S=o[g+1],l=Math.hypot(T.x-y.x,T.y-y.y),n=Math.hypot(S.x-T.x,S.y-T.y),u=Math.min(e,l/2,n/2);if(u<=0){c+=` L ${T.x} ${T.y}`;continue}let a=this.moveTowards(T,y,u),r=this.moveTowards(T,S,u);c+=` L ${a.x} ${a.y} Q ${T.x} ${T.y} ${r.x} ${r.y}`}let m=o[o.length-1];return`${c} L ${m.x} ${m.y}`}moveTowards(t,e,o){let c=Math.hypot(e.x-t.x,e.y-t.y);return c===0?t:{x:t.x+(e.x-t.x)/c*o,y:t.y+(e.y-t.y)/c*o}}};var _e=class{mManager;mDocument;get document(){return this.mDocument}constructor(t){this.mManager=t,this.mDocument=null}setDocument(t){this.mDocument=t,this.mDocument.validate(),this.mManager.dispatch(F.Document,this.mDocument),this.setDefaultActiveFunction()}removeFunction(t){let e=this.mDocument;if(!e)return;let o=null;for(let c of e.functions)if(c.id===t){o=c,e.removeFunction(c);break}o&&(this.mManager.dispatch(F.FunctionDelete,o),this.setDefaultActiveFunction())}transformNode(t,e){let o={x:t.transformation.x,y:t.transformation.y,width:t.transformation.width,height:t.transformation.height,...e};t.moveTo(o.x,o.y),t.resizeTo(o.width,o.height),this.mManager.dispatch(F.NodeTransform,t)}addFunction(t){let e=this.mDocument,o=this.mManager.project;if(!e||!o||!o.userFunctions.has(t))return;let c=new gt(o,e,{definitionId:t,id:crypto.randomUUID(),isSystem:!1,label:`Function ${e.functions.size}`});e.addFunction(c),e.validate(),this.mManager.dispatch(F.FunctionAdd,c),this.mManager.setActiveFunction(c.id)}addNode(t,e,o){let c=t.addNodeByDefinition(e,o);return this.mManager.dispatch(F.NodeAdd,c),c}removeNode(t){t.function.removeNode(t),this.mManager.dispatch(F.NodeDelete,t)}connectPorts(t,e){try{t.connect(e)}catch(o){return console.error("[PotatnoCodeUiManager] Connection failed:",o),!1}return this.mManager.dispatch(F.ConnectionAdd,t),this.mManager.dispatch(F.ConnectionAdd,e),!0}disconnectPorts(t,e){t.disconnect(e),this.mManager.dispatch(F.ConnectionDelete,t),this.mManager.dispatch(F.ConnectionDelete,e)}setPortDirectValue(t,e){t.setDirectValue(e),this.mManager.dispatch(F.NodeUpdate,t)}updateNode(t,e){t&&(e(t),this.mManager.dispatch(F.NodeUpdate,t))}setDefaultActiveFunction(){if(!this.mDocument||this.mDocument.functions.size===0)return;let t=(()=>{let e=[...this.mDocument.functions];return e.some(c=>c.id===this.mManager.activeFunctionId)?this.mManager.activeFunctionId:e[0].id})();this.mManager.activeFunctionId!==t&&this.mManager.setActiveFunction(t)}};var je=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new Nt(this.mProject);for(let o of t.functions)e.addFunction(this.deserializeFunction(o,e));return e}deserializeFunction(t,e){let o=new gt(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let m of t.imports)o.addImport(m);for(let m of t.inputs)o.addInput({label:m.label,dataType:m.dataType});for(let m of t.outputs)o.addOutput({label:m.label,dataType:m.dataType});let c=new Map;for(let m of t.nodes)c.set(m.id,this.deserializeNode(m,o,e));for(let m of t.connections){if(!c.has(m.sourceNodeId)||!c.has(m.targetNodeId))continue;let g=c.get(m.sourceNodeId),y=c.get(m.targetNodeId),T=g.outputs.map.get(m.sourcePortId),S=y.inputs.map.get(m.targetPortId);!T||!S||T.connect(S)}return o}deserializeNode(t,e,o){let c=o.nodeDefinitions.find(g=>g.id===t.definitionId),m=(()=>{if(c)return e.addNodeByDefinition(c,t.transformation);let g=t.ports.filter(T=>T.direction==="input").map(T=>({dataType:T.dataType,definitionId:T.definitionId,label:T.label,portType:T.portType})),y=t.ports.filter(T=>T.direction==="output").map(T=>({dataType:T.dataType,definitionId:T.definitionId,label:T.label,portType:T.portType}));return new yt(this.mProject,o,e,{category:t.category,definitionId:t.definitionId,ports:{input:g,output:y},label:t.label,transformation:{...t.transformation}})})();m.label=t.label,e.addNode(m);for(let g of t.ports)if(g.portType==="value"&&g.directValue.length>0){let y=m.inputs.map.get(g.definitionId);y&&y.setDirectValue(g.directValue)}return m.preview=t.preview??null,m}};var Ve=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((y,T)=>{e.set(y,`n${T}`)});let o=[...t.nodes].map(y=>this.serializeNode(y,e.get(y))),c=[];for(let y of t.nodes){let T=e.get(y);for(let S of y.outputs.list)for(let l of S.connectedPorts){let n=e.get(l.node);c.push({sourceNodeId:T,sourcePortId:S.definitionId,targetNodeId:n,targetPortId:l.definitionId})}}let m=t.inputs.map(y=>({label:y.label,dataType:y.dataType})),g=t.outputs.map(y=>({label:y.label,dataType:y.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:m,outputs:g,imports:[...t.imports],nodes:o,connections:c}}serializeNode(t,e){let o=[...t.inputs.list,...t.outputs.list].map(m=>({definitionId:m.definitionId,label:m.label,direction:m.direction,portType:m.portType,dataType:m.portType==="value"?m.dataType:null,directValue:[...m.directValue]})),c=t.preview?structuredClone(t.preview):null;return{id:e,definitionId:t.definitionId,category:t.category,label:t.label,transformation:{...t.transformation},ports:o,preview:c}}};var $e=class p{static MAX_HISTORY_ITEMS=100;mManager;mSnapshots;mSnapshotIndex;get canRedo(){return this.mSnapshotIndex<this.mSnapshots.length-1}get canUndo(){return this.mSnapshotIndex>0}constructor(t){this.mManager=t,this.mSnapshotIndex=-1,this.mSnapshots=new Array;let e=0;this.mManager.subscribe(F.Any,null,()=>{globalThis.clearTimeout(e),e=globalThis.setTimeout(()=>{this.pushHistory()},1e3)})}undo(){if(!this.canUndo)return;let t=this.mSnapshots[--this.mSnapshotIndex],e=JSON.parse(t);this.restoreHistory(e)}redo(){if(!this.canRedo)return;let t=this.mSnapshots[++this.mSnapshotIndex],e=JSON.parse(t);this.restoreHistory(e)}clear(){this.mSnapshots.length=0,this.mSnapshotIndex=-1}pushHistory(){let t=this.mManager.graph.document;if(!t)return;this.mSnapshots.splice(this.mSnapshotIndex+1);let e=new Ve().serialize(t),o=JSON.stringify(e);this.mSnapshots.length>0&&this.mSnapshots.at(-1)===o||(this.mSnapshotIndex=this.mSnapshots.push(o)-1,this.mSnapshots.length>p.MAX_HISTORY_ITEMS&&(this.mSnapshots.shift(),this.mSnapshotIndex--))}restoreHistory(t){let e=this.mManager.project;e&&this.mManager.graph.setDocument(new je(e).deserialize(t))}};var ze=class{mErrorList;mErrorItems;mIsDirty;mManager;get errors(){return this.mIsDirty&&this.revalidate(),this.mErrorList}get errorItems(){return this.mIsDirty&&this.revalidate(),this.mErrorItems}get isValid(){return this.mIsDirty&&this.revalidate(),this.mErrorItems.size===0}constructor(t){this.mManager=t,this.mErrorList=new Array,this.mErrorItems=new Set,this.mIsDirty=!0;let e=0;this.mManager.subscribe(F.Any,null,()=>{this.mIsDirty=!0,globalThis.clearTimeout(e),e=globalThis.setTimeout(()=>{this.mIsDirty&&(this.revalidate(),this.mIsDirty=!1)},1e3)})}revalidate(){if(!this.mManager.graph.document)return;this.mErrorList.splice(0,this.mErrorList.length),this.mErrorItems.clear();let t=this.mManager.graph.document.validate();for(let e of t.errors)switch(this.mErrorItems.add(e.item),!0){case e.item instanceof dt:{this.mErrorList.push({location:`Node "${e.item.node.label}"`,message:e.message});break}case e.item instanceof yt:{this.mErrorList.push({location:`Node "${e.item.label}"`,message:e.message});break}}for(let e of t.affectedItems)switch(!0){case e instanceof dt:{this.mManager.dispatch(F.PortAdd|F.PortUpdate|F.PortDelete,e);break}case e instanceof yt:{this.mManager.dispatch(F.NodeAdd|F.NodeUpdate|F.NodeDelete,e);break}case e instanceof gt:{this.mManager.dispatch(F.FunctionAdd|F.FunctionUpdate|F.FunctionDelete,e);break}}}};var Be=class{mDriverList;mElementDriver;mDriverElements;mDriverActivity;mDrivers;mManager;mPreviewIntersection;constructor(t){this.mManager=t,this.mDriverList=new Array,this.mDrivers=new WeakMap,this.mDriverActivity=new WeakMap,this.mDriverElements=new WeakMap,this.mElementDriver=new WeakMap,this.mManager.subscribe(F.Document,null,()=>{this.mDriverList.splice(0,this.mDriverList.length)});let e=0,o=F.Connection|F.Function|F.Node;this.mManager.subscribe(o,null,()=>{globalThis.clearTimeout(e),e=globalThis.setTimeout(()=>this.refresh(),1e3)}),this.mPreviewIntersection=new IntersectionObserver(c=>{for(let m of c){let g=this.mElementDriver.get(m.target);if(!g)continue;let y=g.deref();y&&this.mDriverActivity.set(y,m.isIntersecting)}})}async execute(){let t=this.mDriverList.map(async e=>{let o=e.deref();if(o&&this.mDriverActivity.get(o))try{await o.execute()}catch(c){console.error("[PotatnoUiManagerPreview] Driver render failed:",c)}});await Promise.all(t)}refresh(){if(this.mManager.integrity.isValid)for(let t=this.mDriverList.length-1;t>=0;t--){let e=this.mDriverList[t].deref();if(!e){this.unregister(this.mDriverList[t]);continue}e.refresh()}}unregister(t){let e=this.mDriverList.indexOf(t);if(e===-1)return;this.mDriverList.splice(e,1);let o=this.mDriverElements.get(t);o&&this.mPreviewIntersection.unobserve(o)}register(t,e){this.mDrivers.set(t,e);let o=new WeakRef(e);this.mDriverList.push(o);let c=e.element;this.mDriverElements.set(o,c),this.mElementDriver.set(c,o),this.mPreviewIntersection.observe(c)}requestDriver(t,e){let o=this.mDrivers.get(t);if(o&&o.display.id===e)return o;if(!this.mManager.project)return null;let c=this.mManager.project.preview.getDisplay(e);if(!c)throw new N(`Preview has no display for "${e}".`,this);let m=c.createDriver(t);return this.register(t,m),this.mManager.integrity.isValid&&m.refresh(),m}};function ji(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var M=f.length-1;M>=0;M--){var P=f[M];if(h=t(P,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var M=h?E:v,P=M.get(d)||0;if(P===!0||P===3&&s!==4||P===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!P&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,f,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||S(n,v),{e:E,get c(){return T(n,a,v)}}}}function io(p,t,e,o){return(io=ji())(p,t,e,o)}var so,ro,oo,K;so=O.injectable("singleton");var no=class extends(oo=EventTarget){static{({c:[K,ro]}=io(this,[],[so],oo))}constructor(){super(),this.mClipboard=new Le(this),this.mIntegrity=new ze(this),this.mGrid=new Fe,this.mGraph=new _e(this),this.mHistory=new $e(this),this.mPreview=new Be(this),this.mActiveFunctionId="",this.mProject=null,this.mEventBuffer=new Map,this.mEventBufferDispatchRequest=-1}mClipboard;mEventBuffer;mGraph;mGrid;mHistory;mIntegrity;mPreview;mActiveFunctionId;mEventBufferDispatchRequest;mProject;get clipboard(){return this.mClipboard}get grid(){return this.mGrid}get graph(){return this.mGraph}get history(){return this.mHistory}get integrity(){return this.mIntegrity}get activeFunction(){let t=this.mGraph.document;if(!t)return null;for(let e of t.functions)if(e.id===this.mActiveFunctionId)return e;return null}get activeFunctionId(){return this.mActiveFunctionId}get project(){return this.mProject}get preview(){return this.mPreview}deconstruct(){}initialize(t,e){this.mProject=t,this.mGraph.setDocument(e)}subscribe(t,e,o){let c=g=>{if(!e)return!0;let y=g;for(;y!==null;){if(e.has(y))return!0;switch(!0){case y instanceof dt:{y=y.node;break}case y instanceof yt:{y=y.function;break}case y instanceof gt:{y=y.document;break}default:y=null}}return!1},m=g=>{t!==F.Any&&(g.changeType&t)===0||e!==null&&!c(g.item)||o(g)};return this.addEventListener(ye.EVENT_TYPE,m),()=>{this.removeEventListener(ye.EVENT_TYPE,m)}}setActiveFunction(t){let e=this.mGraph.document;if(!(!e||this.mActiveFunctionId===t)){for(let o of e.functions)if(o.id===t){this.mActiveFunctionId=t,this.dispatch(F.SpecialActiveFunction,o);return}}}generateTypeColor(t){let e=(()=>{let c=0;for(let m=0;m<t.length;m++)c=t.charCodeAt(m)+((c<<5)-c);return c})();return`hsl(${Math.abs(e)*137.508%360}, 70%, 60%)`}updateFunctionProperties(t){let e=this.activeFunction;if(!e)return;let c=e.project.getFunction(e.definitionId)?.statics??rt.imports|rt.inputs|rt.outputs;if(t.name!==void 0&&(e.label=t.name),t.inputs!==void 0&&(c&rt.inputs)===0){for(let m of[...e.inputs])e.removeInput(m);for(let m of t.inputs)e.addInput({dataType:m.type,label:m.name})}if(t.outputs!==void 0&&(c&rt.outputs)===0){for(let m of[...e.outputs])e.removeOutput(m);for(let m of t.outputs)e.addOutput({dataType:m.type,label:m.name})}if(t.imports!==void 0&&(c&rt.imports)===0){let m=new Set(e.imports),g=new Set(t.imports);for(let y of[...e.imports])g.has(y)||e.removeImport(y);for(let y of t.imports)m.has(y)||e.addImport(y)}this.dispatch(F.FunctionUpdate,e)}dispatch(t,e){let o=this.mEventBuffer.get(e)??0;this.mEventBuffer.set(e,o|t),this.mEventBufferDispatchRequest!==-1&&globalThis.cancelAnimationFrame(this.mEventBufferDispatchRequest),this.mEventBufferDispatchRequest=requestAnimationFrame(()=>{this.mEventBufferDispatchRequest=-1;for(let[c,m]of this.mEventBuffer)this.dispatchEvent(new ye(m,c));this.mEventBuffer.clear()})}static{ro()}},F={Any:16777215,Connection:15,ConnectionAdd:1,ConnectionUpdate:2,ConnectionDelete:4,Document:240,Function:3840,FunctionAdd:256,FunctionUpdate:512,FunctionDelete:1024,Node:61440,NodeAdd:4096,NodeUpdate:8192,NodeDelete:16384,NodeTransform:32768,Port:983040,PortAdd:65536,PortUpdate:131072,PortDelete:262144,Special:15728640,SpecialActiveFunction:1048576},ye=class p extends Event{static EVENT_TYPE="PotatnoUiManagerChangeEvent";mChangeType;mEventItem;get changeType(){return this.mChangeType}get item(){return this.mEventItem}constructor(t,e){super(p.EVENT_TYPE),this.mChangeType=t,this.mEventItem=e}};var ao=`:host {\r
    display: flex;\r
    width: 100%;\r
    height: 100%;\r
...
`;(function(p){p.Function="function",p.Comment="comment",p.Input="input",p.Output="output",p.Reroute="reroute"})(ot||(ot={}));var Pt=class p{static META={[ot.Function]:{icon:"f",cssColor:"var(--pn-accent-blue)",label:"Function"},[ot.Comment]:{icon:"\u{1F4AC}",cssColor:"var(--pn-accent-yellow)",label:"Comment"},[ot.Input]:{icon:"\u2192",cssColor:"var(--pn-accent-green)",label:"Input"},[ot.Output]:{icon:"\u2190",cssColor:"var(--pn-accent-red)",label:"Output"},[ot.Reroute]:{icon:"\u25C7",cssColor:"var(--pn-text-muted)",label:"Reroute"}};static get(t){let e=p.META[t];return e||{icon:"\u25C6",cssColor:p.hashStringToHue(t),label:t.charAt(0).toUpperCase()+t.slice(1)}}static hashStringToHue(t){let e=(()=>{let c=0;for(let m=0;m<t.length;m++)c=t.charCodeAt(m)+((c<<5)-c);return c})();return`hsl(${Math.abs(e)*137.508%360}, 70%, 60%)`}},ot;var xo=`:host {
    position: absolute;
    z-index: 1500;
}
...
}`;var $o=`<svg #svgLayer class="svg-layer" xmlns="http://www.w3.org/2000/svg" (contextmenu)="this.onContextMenu($event)"></svg>
`;function Qi(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var M=f.length-1;M>=0;M--){var P=f[M];if(h=t(P,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var M=h?E:v,P=M.get(d)||0;if(P===!0||P===3&&s!==4||P===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!P&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,f,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||S(n,v),{e:E,get c(){return T(n,a,v)}}}}function Ho(p,t,e,o){return(Ho=Qi())(p,t,e,o)}var Yo,zo,Wo,Bo,Uo,ki=12,Go="http://www.w3.org/2000/svg",ts;Yo=J({selector:"potatno-connection-layer",template:$o,style:Vo}),Wo=st("svgLayer");var Xo=class{static{({e:[Bo,Uo],c:[ts,zo]}=Ho(this,[[Wo,1,"svgLayer"]],[Yo]))}constructor(t=O.use(K)){this.mConnectionRegistry=new Map,this.mManager=t,this.mPendingRenderFrame=0,this.mUnsubscribe=null}mConnectionRegistry;mManager;mPendingRenderFrame;mUnsubscribe;#t=(Uo(this),Bo(this));get svgLayer(){return this.#t}set svgLayer(t){this.#t=t}onConnect(){this.mUnsubscribe=this.mManager.subscribe(F.Document|F.Function|F.SpecialActiveFunction|F.Node|F.NodeTransform|F.Connection,null,()=>{this.scheduleRender()}),this.scheduleRender()}onDeconstruct(){this.mUnsubscribe?.(),this.mUnsubscribe=null,this.mPendingRenderFrame!==0&&(cancelAnimationFrame(this.mPendingRenderFrame),this.mPendingRenderFrame=0)}onContextMenu(t){if(!(t.target instanceof Element))return;let e=t.target.getAttribute("data-connection-id");e&&(t.preventDefault(),t.stopPropagation(),this.deleteConnectionById(e))}clearPaths(t){let e=t.querySelectorAll("path");for(let o of e)o.remove()}deleteConnectionById(t){let e=this.mConnectionRegistry.get(t);if(!e)return;let o=e.sourcePort.node.outputs.map.get(e.sourcePort.definitionId)??e.sourcePort,c=e.targetPort.node.inputs.map.get(e.targetPort.definitionId)??e.targetPort;this.mManager.graph.disconnectPorts(o,c)}getPortPosition(t){let e=this.mManager.grid.interaction.zoom,o=this.mManager.grid.gridSize,c=this.mManager.grid.getPortElement(t),m=this.getSvgLayerOrNull();if(c&&m){let u=m.getBoundingClientRect(),a=c.getBoundingClientRect(),r=t.direction==="output"?a.right:a.left;return{x:this.mManager.grid.snapToGridCenter((r-u.left)/e),y:this.mManager.grid.snapToGridCenter((a.top+a.height/2-u.top)/e)}}let g=t.node,y=g.transformation.x*o,T=g.transformation.y*o,S=g.transformation.width*o,l=t.direction==="output"?g.outputs.list:g.inputs.list,n=0;for(let u of l){if(u===t)break;n++}return{x:t.direction==="output"?y+S-o/2:y+o/2,y:T+o+(n+.5)*o}}getSvgLayerOrNull(){try{return this.svgLayer}catch{return null}}renderConnections(){let t=this.getSvgLayerOrNull();if(!t)return;let e=this.mManager.activeFunction;if(!e){this.clearPaths(t),this.mConnectionRegistry.clear();return}this.clearPaths(t),this.mConnectionRegistry.clear();let o=this.mManager.integrity.errorItems,c=0;for(let m of e.nodes)for(let g of m.outputs.list)for(let y of g.connectedPorts){let T=`c${c++}`,S=this.getPortPosition(g),l=this.getPortPosition(y),n=o.has(g)||o.has(y);this.mConnectionRegistry.set(T,{sourcePort:g,targetPort:y}),this.renderConnectionPath(t,T,g,S,l,!n)}}renderConnectionPath(t,e,o,c,m,g){let y=this.mManager.grid.createConnectionPath(c,m,o),T=document.createElementNS(Go,"path");T.setAttribute("d",y),T.setAttribute("data-connection-id",e),T.setAttribute("data-hit-area","true"),T.setAttribute("fill","none"),T.style.cursor="pointer",T.style.pointerEvents="stroke",T.style.stroke="transparent",T.style.strokeLinecap="round",T.style.strokeLinejoin="round",T.style.strokeWidth=`${ki}`,t.appendChild(T);let S=document.createElementNS(Go,"path");S.setAttribute("d",y),S.setAttribute("data-connection-id",e),S.setAttribute("fill","none"),S.style.pointerEvents="none",S.style.stroke=g?"#a6adc8":"#f38ba8",S.style.strokeLinecap="round",S.style.strokeLinejoin="round",S.style.strokeWidth="2",g||S.setAttribute("stroke-dasharray","6 3"),t.appendChild(S)}scheduleRender(){this.mPendingRenderFrame===0&&(this.mPendingRenderFrame=requestAnimationFrame(()=>{this.mPendingRenderFrame=0,this.renderConnections()}))}static{zo()}};function es(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var M=f.length-1;M>=0;M--){var P=f[M];if(h=t(P,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var M=h?E:v,P=M.get(d)||0;if(P===!0||P===3&&s!==4||P===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!P&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,f,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||S(n,v),{e:E,get c(){return T(n,a,v)}}}}function Jo(p,t,e,o){return(Jo=es())(p,t,e,o)}var Ko,Zo,be;Ko=xt({access:X.Read,selector:/^potatno-preview$/});var qo=class{static{({c:[be,Zo]}=Jo(this,[],[Ko]))}constructor(t=O.use(Z),e=O.use(G),o=O.use(et)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(o.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let o=this.mTarget.childNodes.length>0;return o&&(this.mTarget.innerHTML=""),o}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{Zo()}};var Qo=`:host {
    display: block;
    position: relative;
...
`;var ko=`<div class="port-wrapper {{this.portDirection}}" style="--type-color: {{this.portColor}}" (dragover)="this.onDragOver($event)" (drop)="this.onDrop($event)">

    <!-- Actual port handle. -->
    <div class="port" draggable="true" [title]="this.portType" (dragstart)="this.onDragStart($event)" (drag)="this.onDrag($event)" (dragend)="this.onDragEnd($event)" (pointerdown)="this.onPointerDown($event)">
    ...
    <svg #dragWire class="port-drag-wire" xmlns="http://www.w3.org/2000/svg"></svg>
...
`;function ns(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var f=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var M=f.length-1;M>=0;M--){var P=f[M];if(h=t(P,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var M=h?E:v,P=M.get(d)||0;if(P===!0||P===3&&s!==4||P===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!P&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,f,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||S(n,v),{e:E,get c(){return T(n,a,v)}}}}function on(p,t,e,o){return(on=ns())(p,t,e,o)}function is(p){return p}var nn,tn,sn,en,rn,Ue;nn=J({selector:"potatno-port",template:ko,style:Qo}),sn=st("dragWire");new class extends is{constructor(){super(Ue),tn()}static{class p{static{({e:[en,rn],c:[Ue,tn]}=on(this,[[pt,3,"port"],[sn,1,"dragWire"]],[nn]))}static DRAG_MIME_TYPE="application/x-potatno-port";mComponent;mManager;mDragPathElement;mPort;mUnsubscribe;get port(){return this.mPort}set port(e){if(this.mPort!==e){if(e===null)throw new N("A null port cant be assigned.",this);this.mPort=e,this.mManager.grid.registerPortElement(e,this.mComponent.element),this.mComponent.updater.updateAsync()}}#t=(rn(this),en(this));get dragWire(){return this.#t}set dragWire(e){this.#t=e}get inputDefinitions(){if(!this.port)return new Array;let e=this.port.project.types.getType(this.port.resolvedDataType);return e.inputs.map((o,c)=>({htmlType:(()=>{switch(o.type){case"boolean":return"checkbox";case"number":return"number";case"string":return"text"}})(),index:c,name:o.name,value:this.port.directValue[c]??"",totalCount:e.inputs.length}))}get hasError(){return this.port===null?!1:this.mManager.integrity.errorItems.has(this.port)}get portColor(){return!this.port||this.port.portType==="flow"?"var(--potatno-color-text)":this.mManager.generateTypeColor(this.port.resolvedDataType)}get portDirection(){return this.port?.direction??"output"}get portHandleClasses(){if(!this.port)return"";let e=[this.port.portType];return this.port.connectedPorts.size>0&&e.push("connected"),this.hasError&&e.push("error"),e.join(" ")}get portName(){return this.port?.label??""}get portType(){return!this.port||this.port.portType!=="value"?"":this.port.resolvedDataType??""}get showValueInput(){return!this.port||this.port.portType!=="value"||this.port.direction!=="input"||this.port.connectedPorts.size>0||this.mManager.grid.draggedPort===this.port?!1:!this.port.node.project.types.isGenericType(this.port.dataType??"")}constructor(e=O.use(z),o=O.use(K)){this.mComponent=e,this.mDragPathElement=null,this.mManager=o,this.mPort=null,this.mUnsubscribe=null}onConnect(){this.mUnsubscribe=this.mManager.subscribe(F.Connection|F.Node,null,()=>{this.mComponent.updater.updateAsync()})}onDeconstruct(){this.clearDragState(),this.mUnsubscribe?.(),this.mUnsubscribe=null}onDirectValueInput(e,o){if(!this.port)return;let c=e.target,m=[...this.port.directValue];m[o]=c.type==="checkbox"?c.checked?"true":"false":c.value,this.mManager.graph.setPortDirectValue(this.port,m)}onDrag(e){this.mManager.grid.draggedPort!==this.port||!this.port||e.clientX===0&&e.clientY===0||this.renderDragWire(e.clientX,e.clientY)}onDragEnd(e){e.stopPropagation(),e.preventDefault(),this.clearDragState()}onDragOver(e){let o=this.mManager.grid.draggedPort;!this.port||!o||!this.isPotatnoPortDrag(e.dataTransfer)||!this.canConnectPorts(o,this.port)||(e.preventDefault(),e.stopPropagation(),e.dataTransfer&&(e.dataTransfer.dropEffect="link"))}onDragStart(e){if(!this.port||!e.dataTransfer){e.preventDefault();return}e.stopPropagation(),this.mManager.grid.draggedPort=this.port,e.dataTransfer.effectAllowed="link",e.dataTransfer.setData(p.DRAG_MIME_TYPE,"potatno-port"),this.renderDragWire(e.clientX,e.clientY),this.mComponent.updater.updateAsync();let o=document.createElement("canvas");o.width=1,o.height=1,e.dataTransfer.setDragImage(o,0,0)}onDrop(e){let o=this.mManager.grid.draggedPort;!this.port||!o||!this.isPotatnoPortDrag(e.dataTransfer)||!this.canConnectPorts(o,this.port)||(e.preventDefault(),e.stopPropagation(),this.mManager.graph.connectPorts(o,this.port),this.mManager.grid.draggedPort=null)}onPointerDown(e){e.stopPropagation()}canConnectPorts(e,o){return e!==o&&e.direction!==o.direction&&e.portType===o.portType}clearDragState(){this.mManager.grid.draggedPort===this.port&&(this.mManager.grid.draggedPort=null),this.clearDragWire(),this.mComponent.updater.updateAsync()}createDragPath(e,o){let c=this.port;if(!c)return"";let m=this.mManager.grid.interaction.zoom,g=this.mComponent.element.getBoundingClientRect(),y={x:c.direction==="output"?g.width/m:0,y:g.height/2/m},T={x:(e-g.left)/m,y:(o-g.top)/m};return this.mManager.grid.createConnectionPath(y,T,c)}clearDragWire(){this.mDragPathElement&&(this.mDragPathElement.remove(),this.mDragPathElement=null)}getDragWireOrNull(){try{return this.dragWire}catch{return null}}isPotatnoPortDrag(e){return e?Array.from(e.types).includes(p.DRAG_MIME_TYPE):!1}renderDragWire(e,o){let c=this.getDragWireOrNull();c&&(this.mDragPathElement||(this.mDragPathElement=document.createElementNS("http://www.w3.org/2000/svg","path"),c.appendChild(this.mDragPathElement)),this.mDragPathElement.setAttribute("d",this.createDragPath(e,o)))}}}};var an=`:host {\r
    display: block;\r
    height: 100%;\r
    width: 100%;\r
    font-family: var(--pn-font-family);\r
...
`;var Vn=`<div class="properties-header">Properties</div>\r
...
`;var Xn=`<div class="resize-handle" (pointerdown)="this.onResizePointerDown($event)"></div>
