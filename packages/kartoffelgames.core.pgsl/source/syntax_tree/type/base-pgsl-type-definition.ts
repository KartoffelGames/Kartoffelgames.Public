 ...
 */
export abstract class BasePgslTypeDefinition<TAdditional extends object = {}> extends BasePgslSyntaxTree<BasePgslTypeDefinitionSyntaxTreeValidationAttachment<TAdditional>> {
    /**
     * Constructor.
     * 
     ...
     */
    public abstract equals(pValidationTrace: PgslValidationTrace, pTarget: BasePgslTypeDefinition): boolean;
     ...
     */
    public abstract isExplicitCastableInto(pValidationTrace: PgslValidationTrace, pTarget: BasePgslTypeDefinition): boolean;
     ...
     */
    public abstract isImplicitCastableInto(pValidationTrace: PgslValidationTrace, pTarget: BasePgslTypeDefinition): boolean;
}
