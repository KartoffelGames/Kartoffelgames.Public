(()=>{var Yt=class g extends Array{static newListWith(...t){let e=new g;return e.push(...t),e}clear(){this.splice(0,this.length)}clone(){return g.newListWith(...this)}distinct(){return g.newListWith(...new Set(this))}equals(t){if(this===t)return!0;if(!t||this.length!==t.length)return!1;for(let e=0;e<this.length;++e)if(this[e]!==t[e])return!1;return!0}remove(t){let e=this.indexOf(t);if(e!==-1)return this.splice(e,1)[0]}replace(t,e){let r=this.indexOf(t);if(r!==-1){let c=this[r];return this[r]=e,c}}toString(){return`[${super.join(", ")}]`}};var N=class extends Error{mTarget;get target(){return this.mTarget}constructor(t,e,r){super(t,r),this.mTarget=e}};var rt=class g extends Map{add(t,e){if(!this.has(t))this.set(t,e);else throw new N("Can't add duplicate key to dictionary.",this)}clone(){return new g(this)}getAllKeysOfValue(t){return[...this.entries()].filter(c=>c[1]===t).map(c=>c[0])}getOrDefault(t,e){let r=this.get(t);return typeof r<"u"?r:e}map(t){let e=new Yt;for(let r of this){let c=t(r[0],r[1]);e.push(c)}return e}};var zt=class g{mSize;mTopItem;get size(){return this.mSize}get top(){if(this.mTopItem)return this.mTopItem.value}constructor(){this.mTopItem=null,this.mSize=0}clone(){let t=new g;return t.mTopItem=this.mTopItem,t.mSize=this.mSize,t}*entries(){let t=this.mTopItem;for(;t!==null;)yield t.value,t=t.previous}flush(){let t=new Array;for(;this.mTopItem;)t.push(this.pop());return t}pop(){if(!this.mTopItem)return;let t=this.mTopItem.value;return this.mTopItem=this.mTopItem.previous,this.mSize--,t}push(t){let e={previous:this.mTopItem,value:t};this.mTopItem=e,this.mSize++}toArray(){return[...this.entries()]}};var de=class{mCompareFunction;constructor(t){this.mCompareFunction=t}differencesOf(t,e){let r;if(t.length===0||e.length===0){if(r=new Array,t.length===0)for(let C=0;C<e.length;C++)r.push({changeState:_t.Insert,item:e[C]});else for(let C=0;C<t.length;C++)r.push({changeState:_t.Remove,item:t[C]});return r}let c={1:{x:0,history:[]}},m=C=>C-1,v=t.length,b=e.length,D;for(let C=0;C<v+b+1;C++)for(let a=-C;a<C+1;a+=2){let n=a===-C||a!==C&&c[a-1].x<c[a+1].x;if(n){let l=c[a+1];D=l.x,r=l.history}else{let l=c[a-1];D=l.x+1,r=l.history}r=r.slice();let u=D-a;for(1<=u&&u<=b&&n?r.push({changeState:_t.Insert,item:e[m(u)]}):1<=D&&D<=v&&r.push({changeState:_t.Remove,item:t[m(D)]});D<v&&u<b&&this.mCompareFunction(t[m(D+1)],e[m(u+1)]);)D+=1,u+=1,r.push({changeState:_t.Keep,item:t[m(D)]});if(D>=v&&u>=b)return r;c[a]={x:D,history:r}}return new Array}},_t=function(g){return g[g.Remove=1]="Remove",g[g.Insert=2]="Insert",g[g.Keep=3]="Keep",g}({});var me=class{mNodeCache;constructor(){this.mNodeCache=new Map}start(t,e){let r=this.readFromCache(t),c=this.readFromCache(e),m=new vo;m.set(r,0);let v=new Map;v.set(r,0);let b=new Map,D=new Array;for(;m.length!==0;){let C=m.popLowest();if(D.push(C),C===c)return{path:[...this.pathTracer(C,b)].reverse(),processedNodes:D};for(let a of this.getNeighborNodes(C)){let n=(v.get(C)??Number.POSITIVE_INFINITY)+this.costOfTraversal(a,{startNode:r,endNode:c,path:this.pathTracer(C,b)}),u=v.get(a)??Number.POSITIVE_INFINITY;if(n>=u)continue;b.set(a,C),v.set(a,n);let l=n+this.heuristic(a,{startNode:r,endNode:c,path:this.pathTracer(C,b)});m.set(a,l)}}return{path:new Array,processedNodes:D}}getNeighborNodes(t){return this.neighborNodes(t).map(e=>this.readFromCache(e))}*pathTracer(t,e){let r=t;for(;yield r,!!e.has(r);)r=e.get(r)}readFromCache(t){let e=this.nodeId(t);return this.mNodeCache.has(e)?this.mNodeCache.get(e):(this.mNodeCache.set(e,t),t)}},vo=class{mExistingNodes;mList;mLowestCost;mLowestCostCounter;get length(){return this.mList.length}constructor(){this.mList=new Array,this.mExistingNodes=new Map,this.mLowestCost=Number.POSITIVE_INFINITY,this.mLowestCostCounter=0}popLowest(){if(this.mList.length===0)throw new N("Can not read next node from an empty priority list.",this);let[t,e]=(()=>{let v=null,b=0;for(let D=this.mList.length-1;D>-1;D--){let C=this.mList[D];if(C.cost===this.mLowestCost)return[C,0];(v===null||C.cost<v.cost)&&(v=C,b=0),C.cost===v.cost&&b++}if(v===null)throw new N("Lowest could not be found. Data is corrupted.",this);return[v,b]})();t.cost<this.mLowestCost&&(this.mLowestCost=t.cost,this.mLowestCostCounter=e),t.cost===this.mLowestCost&&this.mLowestCostCounter--,this.mLowestCostCounter<1&&(this.mLowestCost=Number.POSITIVE_INFINITY,this.mLowestCostCounter=0);let r=this.mExistingNodes.get(t.node),c=this.mList.length-1,m=this.mList[c];return this.mList[c]=t,this.mList[r]=m,this.mExistingNodes.set(m.node,r),this.mExistingNodes.delete(t.node),this.mList.pop().node}set(t,e){if(this.mLowestCostCounter>0&&e<this.mLowestCost&&(this.mLowestCost=e,this.mLowestCostCounter=0),e===this.mLowestCost&&this.mLowestCostCounter++,this.mExistingNodes.has(t)){let r=this.mExistingNodes.get(t),c=this.mList[r];if(c.cost===e){e===this.mLowestCost&&this.mLowestCostCounter--;return}c.cost=e;return}this.mList.push({cost:e,node:t}),this.mExistingNodes.set(t,this.mList.length-1)}};var pe=class{mDataType;mId;mLabel;mPortType;mRegions;get dataType(){return this.mDataType}get id(){return this.mId}get label(){return this.mLabel}get portType(){return this.mPortType}get regions(){return this.mRegions}constructor(t){this.mLabel=t.label,this.mId=t.id,this.mPortType=t.portType,t.portType==="value"?this.mDataType=t.dataType:this.mDataType=null,this.mRegions={add:t.regions?.add??new Array}}};var st=class{mCategory;mCodeGenerator;mId;mLabel;mPortProvider;mRegions;get category(){return this.mCategory}get codeGenerator(){return this.mCodeGenerator}get id(){return this.mId}get inputs(){let t=!1,e=[];return this.mPortProvider.inputs(r=>{if(e.push(new pe(r)),r.portType==="flow"){if(t)throw new N(`Node definition ${this.id} has multiple input flow ports, which is not allowed.`,this);t=!0}}),e}get label(){return this.mLabel}get outputs(){let t=[];return this.mPortProvider.outputs(e=>{t.push(new pe(e))}),t}get regions(){return this.mRegions}constructor(t){this.mId=t.id,this.mLabel=t.label,this.mCategory={name:t.category.name,icon:t.category.icon??"\u25C6"},this.mCodeGenerator=t.generators.code,this.mPortProvider=t.generators.ports,this.mRegions={add:t.regions?.add??new Array,allows:t.regions?.allows??new Array,requires:t.regions?.requires??new Array}}getPort(t){return[...this.inputs,...this.outputs].find(e=>e.id===t)}};var wt=class extends st{mFunction;get function(){return this.mFunction}get label(){return this.mFunction.label}constructor(t){let e=(c,m,v)=>b=>{v.length===0&&b({label:c,id:c,portType:"flow"});for(let D of m)b({label:D.label,id:D.label,portType:"value",dataType:D.dataType})},r=t.project.getFunction(t.definitionId);super({id:`USERFUNCTION_${t.id}`,label:t.label,category:{name:"user function",icon:"\u0192"},generators:{ports:{inputs:e("Input",t.inputs,t.outputs),outputs:e("Output",t.outputs,t.outputs)},code:c=>r?r.codeGenerator.value({function:t,inputs:c.inputs,outputs:c.outputs,code:c.code}):""}}),this.mFunction=t}};var xt=class g extends st{static DEFINITION_ID="8124c652-3a8e-4333-b405-f905522a4610";constructor(){super({id:g.DEFINITION_ID,label:"Comment",category:{name:"Comment",icon:"\u270E"},generators:{ports:{inputs:()=>{},outputs:()=>{}},code:()=>{throw new N("Comment node code generators should never be called.",g)}}})}};var K=class g extends st{static DEFINITION_ID="23e9319b-3b62-4dd8-858a-17d97ddee94e";constructor(){super({id:g.DEFINITION_ID,label:"Flow Conjunction",category:{name:"Conjunction",icon:"\u25C7"},generators:{ports:{inputs:t=>{t({label:"in",id:"in",portType:"flow"})},outputs:t=>{t({label:"out",id:"out",portType:"flow"})}},code:()=>{throw new N("Conjunction node code generators should never be called.",g)}}})}};var et=class g extends st{static DEFINITION_ID="a579584d-5d35-42b5-b2ba-3daddee488e0";constructor(){super({id:g.DEFINITION_ID,label:"Value Conjunction",category:{name:"Conjunction",icon:"\u25C7"},generators:{ports:{inputs:t=>{t({label:"in",id:"in",portType:"value",dataType:"<T>"})},outputs:t=>{t({label:"out",id:"out",portType:"value",dataType:"<T>"})}},code:()=>{throw new N("Conjunction node code generators should never be called.",g)}}})}};var Tt=class{mAffectedItems;mErrors;get affectedItems(){return this.mAffectedItems}get errors(){return this.mErrors}constructor(){this.mErrors=new Array,this.mAffectedItems=new Set}addAffectedItem(t){this.mAffectedItems.add(t)}merge(t){this.mErrors.push(...t.mErrors);for(let e of t.mAffectedItems)this.mAffectedItems.add(e);return this}pushError(...t){this.mErrors.push(...t)}},Z=class{mItem;mMessage;get item(){return this.mItem}get message(){return this.mMessage}constructor(t,e){this.mMessage=t,this.mItem=e}};var nt=class{mConnectedPorts;mDataType;mDefinitionId;mDirectValue;mDirection;mDocument;mLabel;mNode;mPortType;mProject;get connectedPorts(){return this.mConnectedPorts}get dataType(){return this.mDataType}get definitionId(){return this.mDefinitionId}get directValue(){return this.mDirectValue}get direction(){return this.mDirection}get document(){return this.mDocument}get label(){return this.mLabel}set label(t){this.mLabel=t}get node(){return this.mNode}get portType(){return this.mPortType}get project(){return this.mProject}get resolvedDataType(){return this.resolveDataType(new Set)}constructor(t,e,r){if(r.portType==="flow"&&r.dataType!==null)throw new N("Flow ports cannot have a value type.",this);if(r.portType==="value"&&r.dataType===null)throw new N("Value ports must have a value type.",this);this.mProject=t,this.mDocument=e,this.mNode=r.node,this.mDefinitionId=r.definitionId,this.mLabel=r.label,this.mDataType=r.dataType,this.mDirection=r.direction,this.mPortType=r.portType,this.mConnectedPorts=new Set,this.mDirectValue=new Array,r.dataType&&!this.mProject.types.isGenericType(r.dataType)&&this.mDirectValue.push(...t.types.getType(r.dataType).default.string)}connect(t){if(this.mConnectedPorts.has(t))return;if(this.mPortType!==t.portType)throw new N(`Cannot connect port ${this.mDefinitionId} of node ${this.mNode.label} to port ${t.mDefinitionId} of node ${t.node.label} due to incompatible port types.`,this);if(this.mDirection===t.direction)throw new N(`Cannot connect port ${this.mDefinitionId} of node ${this.mNode.label} to port ${t.mDefinitionId} of node ${t.node.label} due to incompatible directions.`,this);if(this.node===t.node)throw new N(`Cannot connect port ${this.mDefinitionId} of node ${this.mNode.label} to another port of the same node.`,this);if(!(this.mPortType==="flow"&&this.mDirection==="input"||this.mPortType==="value"&&this.mDirection==="output"))for(let r of Array.from(this.mConnectedPorts))this.disconnect(r);this.mConnectedPorts.add(t),t.connect(this)}disconnect(t){this.mConnectedPorts.has(t)&&(this.mConnectedPorts.delete(t),t.disconnect(this))}setDirectValue(t){if(this.mPortType!=="value")throw new N("Only value ports can have a direct value.",this);if(this.mProject.types.isGenericType(this.mDataType))throw new N("Generic value ports cannot have a direct value.",this);if(t.length!==this.mProject.types.getType(this.mDataType).default.string.length)throw new N("The provided value does not match the expected length of the default value for this port's type.",this);this.mDirectValue.splice(0,this.mDirectValue.length),this.mDirectValue.push(...t)}validate(){let t=new Tt;if(this.mDirection==="output"){if(this.mPortType==="flow"&&this.mConnectedPorts.size>1&&t.pushError(new Z(`Flow output port "${this.mDefinitionId}" on node "${this.mNode.label}" can only have one connection.`,this)),this.mPortType==="value"&&this.mProject.types.isGenericType(this.mDataType??"")){let e=this.mNode.inputs.value.filter(r=>r.dataType===this.mDataType);for(let r of e)r.connectedPorts.size===0&&t.pushError(new Z(`Generic output port "${this.mDefinitionId}" on node "${this.mNode.label}" cannot resolve generic type "${this.mDataType}" because its input port "${r.definitionId}" is not connected.`,this))}return t}if(this.mDirection==="input"){if(this.mPortType==="flow")return this.mConnectedPorts.size===0&&t.pushError(new Z(`Flow input port "${this.mDefinitionId}" on node "${this.mNode.label}" must have at least one connection.`,this)),t;if(this.mPortType==="value"){this.mConnectedPorts.size>1&&t.pushError(new Z(`Value input port "${this.mDefinitionId}" on node "${this.mNode.label}" can only have one connection.`,this));for(let e of this.mConnectedPorts)e.resolvedDataType!==this.resolvedDataType&&t.pushError(new Z(`Value input port "${this.mDefinitionId}" on node "${this.mNode.label}" expects type "${this.resolvedDataType}" but is connected to type "${e.resolvedDataType}".`,this));return t}}return t}resolveDataType(t){if(t.has(this.node))return this.mDataType;if(this.mDirection==="input"&&t.add(this.node),this.mPortType!=="value")throw new N("Port data type couldn't be resolved as it is no value port.",this);if(!this.mProject.types.isGenericType(this.mDataType??""))return this.mDataType;if(this.mDirection==="output"){let r=this.mNode.inputs.value.find(c=>c.dataType===this.mDataType);if(!r)throw new N("Port type couldn't be resolved as it has no resolving sibling port",this);return r.resolveDataType(t)}return this.mConnectedPorts.size===0?this.mDataType:this.mConnectedPorts.values().next().value.resolveDataType(t)}};var pt=class{mDefinitionId;mDocument;mFunction;mInputs;mLabel;mOutputs;mPreview;mProject;mTransformation;get definitionId(){return this.mDefinitionId}get document(){return this.mDocument}get function(){return this.mFunction}get hasFlowPorts(){return this.mOutputs.flow.length>0||this.mInputs.flow.length>0}get hasValuePorts(){return this.mOutputs.value.length>0||this.mInputs.value.length>0}get inputs(){return this.mInputs}get label(){return this.mLabel}set label(t){this.mLabel=t}get outputs(){return this.mOutputs}get preview(){return this.mPreview}set preview(t){this.mPreview=t}get project(){return this.mProject}get transformation(){return this.mTransformation}constructor(t,e,r,c){this.mDocument=e,this.mDefinitionId=c.definitionId,this.mFunction=r,this.mLabel=c.label,this.mPreview=c.preview??null,this.mProject=t,this.mTransformation={x:0,y:0,width:0,height:0};let m=(v,b)=>{let D={direction:b,list:new Array,map:new Map,flow:new Array,value:new Array};for(let C of v){let a=new nt(this.mProject,this.mDocument,{definitionId:C.definitionId,direction:b,label:C.label,node:this,portType:C.portType,dataType:C.dataType});D.list.push(a),D.map.set(a.definitionId,a),(a.portType==="flow"?D.flow:D.value).push(a)}return D};this.mInputs=m(c.ports.input,"input"),this.mOutputs=m(c.ports.output,"output"),this.resizeTo(c.transformation.width,c.transformation.height),this.moveTo(c.transformation.x,c.transformation.y)}moveTo(t,e){this.mTransformation.x=Math.round(t),this.mTransformation.y=Math.round(e)}resizeTo(t,e){let r=this.mFunction.nodeDefinitions.find(v=>v.id===this.mDefinitionId),[c,m]=(()=>{switch(r?.id){case xt.DEFINITION_ID:return[Math.max(6,t),Math.max(6,e)];case et.DEFINITION_ID:case K.DEFINITION_ID:return[1,1];default:return[6,Math.max(this.mInputs.list.length,this.mOutputs.list.length)+1]}})();this.mTransformation.width=c,this.mTransformation.height=m}validate(t){let e=new Tt,r=t??new Set,c=this.mFunction.nodeDefinitions.find(m=>m.id===this.mDefinitionId);if(!c)e.pushError(new Z(`Node "${this.mLabel}" definition "${this.mDefinitionId}" could not be found.`,this));else{e.merge(this.resyncPorts(this.mInputs,c.inputs)),e.merge(this.resyncPorts(this.mOutputs,c.outputs));let m=new Set([...c.regions.requires,...c.regions.allows]);if(m.size>0)for(let v of r)m.has(v)||e.pushError(new Z(`Node "${this.mLabel}" does not allow region "${v}".`,this));if(c.regions.requires.length>0)for(let v of c.regions.requires)r.has(v)||e.pushError(new Z(`Node "${this.mLabel}" requires region "${v}" but it is not active.`,this))}for(let m of[...this.mInputs.list,...this.mOutputs.list])e.merge(m.validate());return this.resizeTo(this.transformation.width,this.transformation.height),e}addPort(t,e,r){let c=new nt(this.mProject,this.mDocument,{definitionId:e.id,direction:t.direction,label:e.label,node:this,portType:e.portType,dataType:e.dataType});return t.list.splice(r,0,c),t.map.set(c.definitionId,c),(c.portType==="flow"?t.flow:t.value).push(c),c}removePort(t,e){let r=t.list.indexOf(e);if(r===-1)throw new N(`Port "${e.label}" was not found and can not be removed.`,this);t.list.splice(r,1),t.map.delete(e.definitionId);let c=e.portType==="flow"?t.flow:t.value,m=c.indexOf(e);if(r===-1)throw new N(`Port "${e.label}" was not found in typed list and can not be removed.`,this);return c.splice(m,1),r}replacePort(t,e,r){let c=Array.from(e.connectedPorts);for(let b of Array.from(e.connectedPorts))e.disconnect(b);let m=this.removePort(t,e),v=this.addPort(t,r,m);for(let b of c)v.connect(b);return v}resyncPorts(t,e){let r=new Tt,c=new Set(e.map(m=>m.id));for(let m=0;m<e.length;m++){let v=e[m];if(!t.map.has(v.id)){let n=this.addPort(t,v,m);r.addAffectedItem(n);continue}let b=t.map.get(v.id),D=b.portType!==v.portType,C=b.dataType!==v.dataType;if(!D&&!C)continue;if(b.connectedPorts.size>0&&D){r.pushError(new Z(`Port "${b.label}" on node "${this.mLabel}" has a changed type.`,b));continue}let a=this.replacePort(t,b,v);r.addAffectedItem(b),r.addAffectedItem(a)}for(let m of t.list)if(!c.has(m.definitionId)){if(m.connectedPorts.size===0){r.addAffectedItem(m),this.removePort(t,m);continue}r.pushError(new Z(`Port "${m.label}" on node "${this.mLabel}" no longer exists in its definition.`,m))}return r}};var at=class{mDefinitionId;mDocument;mId;mImportIds;mInputs;mIsSystem;mLabel;mNodes;mOutputs;mProject;get definitionId(){return this.mDefinitionId}get document(){return this.mDocument}get dynamicNodeDefinitions(){let t=this.mDocument.nodeDefinitions.filter(m=>!(m instanceof wt&&m.function===this)),e=this.mProject.getFunction(this.definitionId);if(!e)return t;let r=e.getNodeDefinitions(this),c=this.mProject.imports.filter(m=>this.mImportIds.has(m.id)).flatMap(m=>m.nodes);return[...t,...c,...r.dynamic]}get id(){return this.mId}get imports(){return this.mImportIds}get inputs(){return this.mInputs}get isSystem(){return this.mIsSystem}get label(){return this.mLabel}set label(t){this.mLabel=t}get nodeDefinitions(){let t=this.mProject.getFunction(this.definitionId);if(!t)return this.dynamicNodeDefinitions;let e=t.getNodeDefinitions(this);return[...this.dynamicNodeDefinitions,...e.entry,...e.exit]}get nodes(){return this.mNodes}get outputs(){return this.mOutputs}get project(){return this.mProject}constructor(t,e,r){this.mProject=t,this.mDocument=e,this.mLabel=r.label,this.mIsSystem=r.isSystem,this.mDefinitionId=r.definitionId,this.mId=r.id,this.mNodes=new Set,this.mInputs=new Array,this.mOutputs=new Array,this.mImportIds=new Set}addImport(t){if(!this.project.imports.some(r=>r.id===t))throw new N(`Project does not contain import ${t}`,this);this.mImportIds.add(t)}addInput(t){this.mInputs.some(e=>e.label===t.label)||this.mInputs.push(t)}addNode(t){this.mNodes.add(t)}addNodeByDefinition(t,e){let r=m=>({definitionId:m.id,label:m.label,portType:m.portType,dataType:m.dataType}),c=new pt(this.mProject,this.mDocument,this,{definitionId:t.id,ports:{input:t.inputs.map(r),output:t.outputs.map(r)},label:t.label,transformation:e});return this.mNodes.add(c),c}addOutput(t){this.mOutputs.some(e=>e.label===t.label)||this.mOutputs.push(t)}getExitNodes(){let t=this.mProject.getFunction(this.mDefinitionId);if(!t)throw new N(`Function definition not found for function "${this.mLabel}".`,this);let e=new Set(t.getNodeDefinitions(this).exit.map(r=>r.id));return[...this.mNodes].filter(r=>e.has(r.definitionId))}removeImport(t){this.mImportIds.delete(t)}removeInput(t){let e=this.mInputs.findIndex(r=>r.label===t.label);e!==-1&&this.mInputs.splice(e,1)}removeNode(t){for(let e of[...t.inputs.list,...t.outputs.list])for(let r of Array.from(e.connectedPorts))e.disconnect(r);this.mNodes.delete(t)}removeOutput(t){let e=this.mOutputs.findIndex(r=>r.label===t.label);e!==-1&&this.mOutputs.splice(e,1)}validate(){let t=new Tt,e=this.mProject.getFunction(this.mDefinitionId);e||t.pushError(new Z(`Function "${this.mLabel}" definition "${this.mDefinitionId}" could not be found.`,this));let r=e?.getNodeDefinitions(this);r&&this.resyncFunction(r,t);let c=this.collectRegions(this.mNodes,t),m=new Set(r?.entry.map(b=>b.id)??new Array),v=new Map;for(let b of this.mNodes)t.merge(b.validate(c.get(b))),this.collectEntryDomains(b,m,v).size>1&&t.pushError(new Z(`Node "${b.label}" is reachable from multiple entry nodes.`,b));return t}collectEntryDomains(t,e,r){if(r.has(t))return r.get(t);let c=new Set;r.set(t,c);for(let m of t.inputs.list)for(let v of m.connectedPorts){let b=v.node;e.has(b.definitionId)&&c.add(b);for(let D of this.collectEntryDomains(b,e,r))c.add(D)}return c}collectRegions(t,e){let r=new Map;for(let b of this.nodeDefinitions)r.set(b.id,b);let c=(()=>{let b=new Map;return(D,C)=>{if(!b.has(D.id)){let a=new Map;for(let n of D.outputs)a.set(n.id,n.regions.add);b.set(D.id,a)}return[...b.get(D.id).get(C)??new Array,...D.regions.add]}})(),m=(()=>{let b=new Map;return(D,C)=>{if(b.has(D))return b.get(D);if(C.has(D))return e.pushError(new Z(`Node "${D.label}" is part of a connection cycle.`,D)),new Set;C.add(D);let a=new Set;for(let n of D.inputs.list)for(let u of n.connectedPorts){let l=u.node;for(let o of m(l,C))a.add(o);if(r.has(l.definitionId))for(let o of c(r.get(l.definitionId),u.definitionId))a.add(o)}return b.set(D,a),a}})(),v=new Map;for(let b of t)v.set(b,m(b,new Set));return v}resyncFunction(t,e){let r=[...t.entry,...t.exit],c=new Set(this.mNodes.values().map(b=>b.definitionId)),m=0,v=20;for(let b of r){if(c.has(b.id))continue;let D=this.addNodeByDefinition(b,{x:Math.floor(m/(r.length/2))*v+2,y:m*v+2-Math.floor(m/(r.length/2))*(r.length/2*v),width:0,height:0});e.addAffectedItem(D),m++}}};var jt=class{mFunctionNodeDefinitions;mFunctions;mProject;get functions(){return this.mFunctions}get nodeDefinitions(){return[...this.mFunctionNodeDefinitions.values(),...this.mProject.nodeDefinitions.values()]}get project(){return this.mProject}constructor(t){this.mProject=t,this.mFunctions=new Array,this.mFunctionNodeDefinitions=new Map}addFunction(t){let e=this.mFunctions.indexOf(t);e!==-1&&this.mFunctions.splice(e,1),this.mFunctions.push(t);let r=new wt(t);return this.mFunctionNodeDefinitions.set(r.id,r),t}newFunction(t){return this.addFunction(new at(this.mProject,this,t))}removeFunction(t){if(t.isSystem)throw new N("Cannot remove a system function.",this);let e=this.mFunctions.indexOf(t);if(e===-1)return!1;this.mFunctions.splice(e,1);for(let r of this.mFunctionNodeDefinitions.values())r.function===t&&this.mFunctionNodeDefinitions.delete(r.id);return!0}validate(){let t=new Tt,e=this.mProject.entryPoint.id;if(!this.mFunctions.values().some(c=>c.definitionId===e)){let c=this.newFunction({definitionId:e,id:crypto.randomUUID(),isSystem:!0,label:this.mProject.entryPoint.label});t.addAffectedItem(c)}for(let c of this.mFunctions)t.merge(c.validate());t.pushError(...this.detectCrossFunctionRecursion());let r=new Set;for(let c of this.mFunctions){let m=this.mProject.generator.value.name(c.label);r.has(m)&&t.pushError(new Z(`Function name "${m}" is used by multiple functions. Function names must be unique.`,c)),r.add(m)}return t}detectCrossFunctionRecursion(){let t=[],e=new Map,r=b=>{if(!e.has(b)){let D=new Set;for(let C of b.nodes)this.mFunctionNodeDefinitions.has(C.definitionId)&&D.add(this.mFunctionNodeDefinitions.get(C.definitionId).function);e.set(b,D)}return e.get(b)},c=new Set,m=new Set,v=b=>{if(!c.has(b)){if(m.has(b)){t.push(new Z(`Function "${b.label}" participates in a cross-function recursion cycle.`,b));return}m.add(b);for(let D of r(b))v(D);m.delete(b),c.add(b)}};for(let b of this.mFunctions)v(b);return t}};var Vt=class{mData;mInteractionType;mOrigin;get data(){return this.mData}get origin(){return this.mOrigin}get triggerType(){return this.mInteractionType}constructor(t,e,r){this.mInteractionType=t,this.mData=r,this.mOrigin=e}};var Dt=class g{static mCurrentZone=new g("Default");static get current(){return g.mCurrentZone}static create(t){return new g(t,g.current)}mAttachments;mInteractionListener;mName;mParent;mTriggerFilterBitmap;get name(){return this.mName}get parent(){return this.mParent}constructor(t,e=null){this.mName=t,this.mParent=e,this.mTriggerFilterBitmap=-1,this.mInteractionListener=new Map,this.mAttachments=new WeakMap}addInteractionListener(t){return this.mInteractionListener.set(t,g.current),this}execute(t,...e){let r=g.mCurrentZone;g.mCurrentZone=this;try{return t(...e)}finally{g.mCurrentZone=r}}getAttachment(t){return this.mAttachments.has(t)?this.mAttachments.get(t):this.mParent!==null?this.mParent.getAttachment(t):null}pushInteraction(t,e){if((this.mTriggerFilterBitmap&t)===0)return!1;if(this.mInteractionListener.size===0)return!0;let r=new Vt(t,this,e);for(let[c,m]of this.mInteractionListener.entries())m.execute(()=>{c.call(this,r)});return!0}removeInteractionListener(t){return t?(this.mInteractionListener.delete(t),this):(this.mInteractionListener.clear(),this)}setAttachment(t,e){this.mAttachments.set(t,e)}setTriggerRestriction(t){return this.mTriggerFilterBitmap=t,this}};var Q=class g{static mComponents=new WeakMap;static mConstructorSelector=new WeakMap;static mElements=new WeakMap;static elementIsComponent(t){return g.mComponents.has(t)}static ofComponent(t){let e=t.processorConstructor,r=g.mConstructorSelector.get(e);if(!r)throw new N(`Constructor "${e.name}" is not a registered custom element`,e);let c=g.mElements.get(t);if(!c)throw new N(`Component "${t}" is not a registered component`,t);return{selector:r,constructor:e,element:c,component:t,processor:t.processor}}static ofConstructor(t){let e=g.mConstructorSelector.get(t);if(!e)throw new N(`Constructor "${t.name}" is not a registered custom element`,t);let r=globalThis.customElements.get(e);if(!r)throw new N(`Constructor "${t.name}" is not a registered custom element`,t);return{selector:e,constructor:t,elementConstructor:r}}static ofElement(t){let e=g.mComponents.get(t);if(!e)throw new N(`Element "${t}" is not a PwbComponent.`,t);return g.ofComponent(e)}static ofProcessor(t){let e=g.mComponents.get(t);if(!e)throw new N("Processor is not a PwbComponent.",t);return g.ofComponent(e)}static registerComponent(t,e,r){g.mComponents.has(e)||g.mComponents.set(e,t),r&&!g.mComponents.has(r)&&g.mComponents.set(r,t),g.mElements.has(t)||g.mElements.set(t,e)}static registerConstructor(t,e){t&&!g.mConstructorSelector.has(t)&&g.mConstructorSelector.set(t,e)}};var Ct=class{static ATTACHMENT_KEY=Symbol("ComponentZoneConfiguration");mFrameTime;mInjection;get guaranteedFrameTime(){return this.mFrameTime}set guaranteedFrameTime(t){this.mFrameTime=t}get injections(){return this.mInjection}constructor(){this.mInjection=new Map,this.mFrameTime=Number.MAX_SAFE_INTEGER}setInjection(t,e){this.mInjection.set(t,e)}};var Kt=class extends Error{mZone;get zone(){return this.mZone}constructor(t,e){let r=t instanceof Error?t.message:"Non-error value thrown";super(`Update error in zone "${e.name}": ${r}`,{cause:t}),this.mZone=e}};var fe=class g{static new(t,e){let r=new g;t(r),e&&r.appendTo(e)}mComponentZoneConfiguration;mContent;mCurrentTarget;mErrorListener;mFragment;mInteractionZone;constructor(){this.mContent=new Array,this.mFragment=document.createDocumentFragment(),this.mCurrentTarget=null,this.mErrorListener=new Array,this.mInteractionZone=Dt.create("PwbApplication"),this.mComponentZoneConfiguration=new Ct,this.mInteractionZone.setAttachment(Ct.ATTACHMENT_KEY,this.mComponentZoneConfiguration),globalThis.addEventListener("error",t=>{this.handleZoneError(t,t.error)}),globalThis.addEventListener("unhandledrejection",t=>{this.handleZoneError(t,t.reason)})}addContent(t){let e=Q.ofConstructor(t).elementConstructor,r=this.mInteractionZone.execute(()=>Q.ofElement(new e));return this.mContent.push(r.component),this.mFragment.appendChild(r.element),this.updateTarget(),r.processor}addErrorListener(t){this.mErrorListener.includes(t)&&this.removeErrorListener(t),this.mErrorListener.push(t)}addStyle(t){let e=document.createElement("style");e.textContent=t,this.mFragment.prepend(e)}appendTo(t){this.mCurrentTarget=t,this.updateTarget()}removeErrorListener(t){let e=this.mErrorListener.indexOf(t);e!==-1&&this.mErrorListener.splice(e,1)}setInjection(t,e){this.mComponentZoneConfiguration.setInjection(t,e)}handleZoneError(t,e){if(!(e instanceof Kt)||!this.zoneBelongsToApplication(e.zone))return;t.preventDefault();let r=!1;for(let c of this.mErrorListener)c(e.cause)===!0&&(r=!0);r||console.error(e.cause)}updateTarget(){this.mCurrentTarget&&(this.mCurrentTarget.shadowRoot||this.mCurrentTarget.attachShadow({mode:"open"}),this.mCurrentTarget.shadowRoot.appendChild(this.mFragment))}zoneBelongsToApplication(t){let e=t;for(;e!==null;){if(e===this.mInteractionZone)return!0;e=e.parent}return!1}};var Qt=class{mCustomMetadata;constructor(){this.mCustomMetadata=new Map}getMetadata(t){return this.mCustomMetadata.get(t)??null}setMetadata(t,e){this.mCustomMetadata.set(t,e)}};var ge=class extends Qt{};var ve=class g extends Qt{static mPrivateMetadataKey=Symbol("Metadata");mDecoratorMetadataObject;mPropertyMetadata;constructor(t){super(),this.mDecoratorMetadataObject=t,this.mPropertyMetadata=new Map,t[g.mPrivateMetadataKey]=this}getInheritedMetadata(t){let e=new Array,r=this.mDecoratorMetadataObject;do{if(Object.hasOwn(r,g.mPrivateMetadataKey)){let m=r[g.mPrivateMetadataKey].getMetadata(t);m!==null&&e.push(m)}r=Object.getPrototypeOf(r)}while(r!==null);return e.reverse()}getProperty(t){return this.mPropertyMetadata.has(t)||this.mPropertyMetadata.set(t,new ge),this.mPropertyMetadata.get(t)}};Symbol.metadata??=Symbol("Symbol.metadata");var lt=class g{static mMetadataMapping=new Map;static add(t,e){return(r,c)=>{let m=g.forInternalDecorator(c.metadata);switch(c.kind){case"class":m.setMetadata(t,e);return;case"method":case"field":case"getter":case"setter":case"accessor":if(c.static)throw new Error("@Metadata.add not supported for statics.");m.getProperty(c.name).setMetadata(t,e);return}}}static forInternalDecorator(t){return g.mapMetadata(t)}static get(t){Object.hasOwn(t,Symbol.metadata)||g.polyfillMissingMetadata(t);let e=t[Symbol.metadata];return g.mapMetadata(e)}static init(){return(t,e)=>{g.forInternalDecorator(e.metadata)}}static mapMetadata(t){if(g.mMetadataMapping.has(t))return g.mMetadataMapping.get(t);let e=new ve(t);return g.mMetadataMapping.set(t,e),e}static polyfillMissingMetadata(t){let e=new Array,r=t;do e.push(r),r=Object.getPrototypeOf(r);while(r!==null);for(let c=e.length-1;c>=0;c--){let m=e[c];if(!Object.hasOwn(m,Symbol.metadata)){let v=null;c<e.length-2&&(v=e[c+1][Symbol.metadata]),m[Symbol.metadata]=Object.create(v,{})}}}};var O=class g{static mCurrentInjectionContext=null;static mInjectMode=new Map;static mInjectableConstructor=new Map;static mInjectableReplacement=new Map;static mInjectionConstructorIdentificationMetadataKey=Symbol("InjectionConstructorIdentification");static mSingletonMapping=new Map;static createObject(t,e,r){let[c,m]=typeof e=="object"&&e!==null?[!1,e]:[!!e,r??new Map],v=g.getInjectionIdentification(t);if(!g.mInjectableConstructor.has(v))throw new N(`Constructor "${t.name}" is not registered for injection and can not be built`,g);let b=c?"instanced":g.mInjectMode.get(v),D=new Map(m.entries().map(([n,u])=>[g.getInjectionIdentification(n),u])),C=g.mCurrentInjectionContext,a=new Map([...C?.localInjections.entries()??[],...D.entries()]);g.mCurrentInjectionContext={injectionMode:b,localInjections:a};try{if(!c&&b==="singleton"&&g.mSingletonMapping.has(v))return g.mSingletonMapping.get(v);let n=new t;return b==="singleton"&&!g.mSingletonMapping.has(v)&&g.mSingletonMapping.set(v,n),n}finally{g.mCurrentInjectionContext=C}}static injectable(t="instanced"){return(e,r)=>{g.registerInjectable(e,r.metadata,t)}}static registerInjectable(t,e,r){let c=g.getInjectionIdentification(t,e);g.mInjectableConstructor.set(c,t),g.mInjectMode.set(c,r)}static replaceInjectable(t,e){let r=g.getInjectionIdentification(t);if(!g.mInjectableConstructor.has(r))throw new N("Original constructor is not registered.",g);let c=g.getInjectionIdentification(e);if(!g.mInjectableConstructor.has(c))throw new N("Replacement constructor is not registered.",g);g.mInjectableReplacement.set(r,e)}static use(t){if(g.mCurrentInjectionContext===null)throw new N("Can't create object outside of an injection context.",g);let e=g.getInjectionIdentification(t);if(g.mCurrentInjectionContext.injectionMode!=="singleton"&&g.mCurrentInjectionContext.localInjections.has(e))return g.mCurrentInjectionContext.localInjections.get(e);let r=g.mInjectableReplacement.get(e);if(r||(r=g.mInjectableConstructor.get(e)),!r)throw new N(`Constructor "${t.name}" is not registered for injection and can not be built`,g);return g.createObject(r)}static getInjectionIdentification(t,e){let r=e?lt.forInternalDecorator(e):lt.get(t),c=r.getMetadata(g.mInjectionConstructorIdentificationMetadataKey);return c||(c=Symbol(t.name),r.setMetadata(g.mInjectionConstructorIdentificationMetadataKey,c)),c}};var q=function(g){return g[g.Read=1]="Read",g[g.ReadWrite=2]="ReadWrite",g[g.Write=3]="Write",g}({});var Nt=class{mHooks;mInjections;mProcessor;mProcessorConstructor;get processor(){if(!this.mProcessor)throw new N("Processor is not created yet. Call setup to create processor.",this);return this.mProcessor}get processorConstructor(){return this.mProcessorConstructor}constructor(t){if(this.mProcessorConstructor=t.constructor,this.mProcessor=null,this.mInjections=new Map,this.mHooks={create:new Array},t.parent)for(let[e,r]of t.parent.mInjections.entries())this.setProcessorInjection(e,r)}deconstruct(){}getProcessorInjection(t){return this.mInjections.get(t)}setProcessorInjection(t,e){if(this.mProcessor)throw new N("Cant add injections to after construction.",this);this.mInjections.set(t,e)}setup(){return this.mProcessor=this.createProcessor(),this}addConstructionHook(t){return this.mHooks.create.push(t),this}call(t,...e){let r=Reflect.get(this.processor,t);return typeof r!="function"?null:r.apply(this.processor,e)}createProcessor(){let t=O.createObject(this.mProcessorConstructor,this.mInjections),e;for(;e=this.mHooks.create.pop();){let r=e.call(this,t);r&&(t=r)}return t}};var $t=class g extends Nt{constructor(t,e){super({constructor:t,parent:e}),this.setProcessorInjection(g,this)}deconstruct(){this.call("onDeconstruct"),super.deconstruct()}setup(){return super.setup(),this.call("onExecute"),this}onUpdate(){return!1}};var yo=class g{static mInstance;mCoreEntityConstructor;mProcessorConstructorConfiguration;constructor(){if(g.mInstance)return g.mInstance;g.mInstance=this,this.mCoreEntityConstructor=new Map,this.mProcessorConstructorConfiguration=new Map}get(t){let e=this.mCoreEntityConstructor.get(t);if(!e)return new Array;let r=new Array;for(let c of e)r.push({processorConstructor:c,processorConfiguration:this.mProcessorConstructorConfiguration.get(c)});return r}register(t,e,r){this.mProcessorConstructorConfiguration.set(e,r);let c=t;do{if(!(c.prototype instanceof Nt)&&c!==Nt)break;this.mCoreEntityConstructor.has(c)||this.mCoreEntityConstructor.set(c,new Set),this.mCoreEntityConstructor.get(c).add(e)}while(c=Object.getPrototypeOf(c))}},ht=new yo;var kt=class g extends Nt{static mExtensionCache=new WeakMap;mExtensionList;constructor(t){super(t),this.mExtensionList=new Array}deconstruct(){for(let t of this.mExtensionList)t.deconstruct();super.deconstruct()}setup(){return super.setup(),this.executeExtensions(),this}executeExtensions(){let t=(()=>{if(!g.mExtensionCache.has(this.processorConstructor)){let c=ht.get($t).filter(v=>{for(let b of v.processorConfiguration.targetRestrictions)if(this instanceof b||this.processorConstructor.prototype instanceof b||this.processorConstructor===b)return!0;return!1}),m={read:c.filter(v=>v.processorConfiguration.access===q.Read),write:c.filter(v=>v.processorConfiguration.access===q.Write),readWrite:c.filter(v=>v.processorConfiguration.access===q.ReadWrite)};g.mExtensionCache.set(this.processorConstructor,m)}return g.mExtensionCache.get(this.processorConstructor)})(),e=[...t.write,...t.readWrite,...t.read];for(let r of e)this.mExtensionList.push(new $t(r.processorConstructor,this).setup())}};var U={get:1,set:2,manual:4};var Re=class g{static ORIGINAL_TO_INTERACTION_MAPPING=new WeakMap;static PROXY_TO_ORIGINAL_MAPPING=new WeakMap;static UNTRACEABLE_FUNCTION_UPDATE_TRIGGER=(()=>{let t=new WeakMap;return t.set(Array.prototype.fill,U.set),t.set(Array.prototype.pop,U.get),t.set(Array.prototype.push,U.set),t.set(Array.prototype.shift,U.get),t.set(Array.prototype.unshift,U.set),t.set(Array.prototype.splice,U.set),t.set(Array.prototype.reverse,U.set),t.set(Array.prototype.sort,U.set),t.set(Array.prototype.concat,U.set),t.set(Map.prototype.clear,U.set),t.set(Map.prototype.delete,U.set),t.set(Map.prototype.set,U.set),t.set(Set.prototype.clear,U.set),t.set(Set.prototype.delete,U.set),t.set(Set.prototype.add,U.set),t})();static getOriginal(t){return g.PROXY_TO_ORIGINAL_MAPPING.get(t)??t}static getWrapper(t){let e=g.getOriginal(t);return g.ORIGINAL_TO_INTERACTION_MAPPING.get(e)}mProxyObject;mStateChangeCallback;get proxy(){return this.mProxyObject}constructor(t,e){let r=g.getWrapper(t);if(r)return r;this.mProxyObject=this.createProxyObject(t),this.mStateChangeCallback=e,g.PROXY_TO_ORIGINAL_MAPPING.set(this.mProxyObject,t),g.ORIGINAL_TO_INTERACTION_MAPPING.set(t,this)}convertToProxy(t){return t===null||typeof t!="object"&&typeof t!="function"?t:new g(t,this.mStateChangeCallback).proxy}createProxyObject(t){let e=(c,m,v)=>{let b=g.getOriginal(m);try{let D=c.call(b,...v);return this.convertToProxy(D)}finally{if(g.UNTRACEABLE_FUNCTION_UPDATE_TRIGGER.has(c)){let D=g.getWrapper(m);D&&D.dispatch(g.UNTRACEABLE_FUNCTION_UPDATE_TRIGGER.get(c))}}};return new Proxy(t,{apply:(c,m,v)=>{let b=c;try{let D=b.call(m,...v);return this.convertToProxy(D)}catch(D){if(!(D instanceof TypeError))throw D;return e(b,m,v)}},set:(c,m,v)=>{try{let b=v;return(b!==null&&typeof b=="object"||typeof b=="function")&&(b=g.getOriginal(b)),Reflect.set(c,m,b)}finally{this.dispatch(U.set)}},get:(c,m,v)=>{try{return this.convertToProxy(Reflect.get(c,m))}finally{this.dispatch(U.get)}},deleteProperty:(c,m)=>{try{return delete c[m]}finally{this.dispatch(U.set)}}})}dispatch(t){this.mStateChangeCallback(t)}};var $=class g{static reaction(t){let e=Dt.create("ComponentState reaction");e.addInteractionListener(r=>{(r.triggerType&U.set)!==0&&t()}),e.execute(()=>{t()})}static state(t){return(e,r)=>{if(r.static)throw new N("Event target is not for a static property.",g);let c=new WeakMap,m=(v,b)=>{c.set(v,new g(b,t))};return{init(v){return typeof v>"u"||m(this,v),v},set(v){c.has(this)?c.get(this).set(v):m(this,v)},get(){return c.has(this)||m(this,void 0),c.get(this).get()}}}}mConfiguration;mLinkedZones;mLinkedZonesArray;mValue;constructor(t,e){if(this.mLinkedZones=new Set,this.mLinkedZonesArray=new Array,this.mConfiguration={complexValue:e?.complexValue??!1,proxy:e?.proxy??!1},this.mConfiguration.proxy){if(typeof t!="object"||t===null)throw new N("Proxied component state value must be an object.",this);this.mValue=new Re(t,r=>{switch(r){case U.set:return this.dispatchChange();case U.get:return this.linkCurrentZone()}}).proxy}else this.mValue=t}get(){return this.linkCurrentZone(),this.mValue}set(t){if(this.mConfiguration.proxy)throw new N("Proxy is not implemented yet.",this);!this.mConfiguration.complexValue&&this.mValue===t||(this.mValue=t,this.dispatchChange())}dispatchChange(){for(let t of this.mLinkedZonesArray)t.pushInteraction(U.set,this)}linkCurrentZone(){let t=Dt.current;this.mLinkedZones.has(t)||(this.mLinkedZones.add(t),this.mLinkedZonesArray.push(t))}};var Gt=class g{static mCurrentUpdateCycle=null;static openResheduledCycle(t,e){let r=!1;if(!g.mCurrentUpdateCycle){let c=performance.now();g.mCurrentUpdateCycle={initiator:t.initiator,startTime:c,forcedSync:t.forcedSync,runner:t.runner},r=!0}try{return e(g.mCurrentUpdateCycle)}finally{r&&(g.mCurrentUpdateCycle=null)}}static openUpdateCycle(t,e){let r=!1;if(!g.mCurrentUpdateCycle){let c=performance.now();g.mCurrentUpdateCycle={initiator:t.updater,startTime:c,forcedSync:t.runSync,runner:Symbol("Runner "+c)},r=!0}try{return e(g.mCurrentUpdateCycle)}finally{r&&(g.mCurrentUpdateCycle=null)}}static updateCycleRunId(t,e){if(t.initiator===e){let r=performance.now(),c=t;c.runner=Symbol("Runner "+r)}}static updateCyleStartTime(t){let e=performance.now(),r=t;r.startTime=e}};var Oe=class extends Error{mChain;get chain(){return this.mChain}constructor(t,e){let r=e.slice(-20).map(c=>c.toString()).join(`
`);super(`${t}: 
${r}`),this.mChain=[...e]}};var Fe=class g{static DEFAULT_FRAME_TIME=Number.MAX_SAFE_INTEGER;static STACK_CAP=100;mFrameTime;mInteractionZone;mManualComponentState;mUpdateFunction;mUpdateRunCache;mUpdateStates;get zone(){return this.mInteractionZone}constructor(t){this.mUpdateRunCache=new WeakMap,this.mUpdateFunction=t.onUpdate,this.mFrameTime=g.DEFAULT_FRAME_TIME;let e=Dt.current.getAttachment(Ct.ATTACHMENT_KEY);e&&(this.mFrameTime=e.guaranteedFrameTime),this.mManualComponentState=new $(Symbol("Manual Update")),this.mUpdateStates={chainCompleteHooks:new zt,async:{hasSheduledTask:!1,hasRunningTask:!1,sheduledTaskIsResheduled:!1},sync:{running:!1},cycle:{chainedTask:null}},this.mInteractionZone=Dt.create("Update-Zone"),this.mInteractionZone.addInteractionListener(r=>{(r.triggerType&U.set)!==0&&this.runUpdateAsynchron(r,null)})}deconstruct(){this.mInteractionZone.removeInteractionListener()}executeInZone(t){return this.mInteractionZone.execute(t)}update(){let t=new Vt(U.manual,this.mInteractionZone,this.mManualComponentState);return this.runUpdateSynchron(t)}updateAsync(){let t=new Vt(U.manual,this.mInteractionZone,this.mManualComponentState);this.runUpdateAsynchron(t,null)}async waitForUpdate(){return this.mUpdateStates.async.hasSheduledTask?new Promise((t,e)=>{this.mUpdateStates.chainCompleteHooks.push((r,c)=>{c?e(c):t(r)})}):!1}executeTaskChain(t,e,r,c){if(c.length>g.STACK_CAP)throw new Oe("Call loop detected",c);let m=performance.now();if(!e.forcedSync&&m-e.startTime>this.mFrameTime)throw new ye;c.push(t);let v=this.mInteractionZone.execute(()=>this.mUpdateFunction.call(this))||r;if(Gt.updateCycleRunId(e,this),!this.mUpdateStates.cycle.chainedTask)return v;let b=this.mUpdateStates.cycle.chainedTask;return this.mUpdateStates.cycle.chainedTask=null,this.executeTaskChain(b,e,v,c)}releaseUpdateChainCompleteHooks(t,e){if(!this.mUpdateStates.chainCompleteHooks.top)return;let r;for(;r=this.mUpdateStates.chainCompleteHooks.pop();)r(t,e)}runUpdateAsynchron(t,e){if(this.mUpdateStates.async.hasRunningTask||this.mUpdateStates.async.sheduledTaskIsResheduled){this.mUpdateStates.cycle.chainedTask=t;return}if(this.mUpdateStates.async.hasSheduledTask)return;let r=c=>{this.mUpdateStates.async.hasRunningTask=!0,this.mUpdateStates.async.hasSheduledTask=!1,this.mUpdateStates.async.sheduledTaskIsResheduled=!1;let m=!1;try{this.runUpdateSynchron(t)}catch(v){if(v instanceof ye&&c.initiator===this)m=!0;else throw new Kt(v,this.zone)}finally{this.mUpdateStates.async.hasRunningTask=!1}m&&this.runUpdateAsynchron(t,c)};this.mUpdateStates.async.hasSheduledTask=!0,e&&(this.mUpdateStates.async.sheduledTaskIsResheduled=!0),globalThis.requestAnimationFrame(()=>{e?Gt.openResheduledCycle(e,r):Gt.openUpdateCycle({updater:this,runSync:!1},r)})}runUpdateSynchron(t){if(this.mUpdateStates.sync.running)return this.mUpdateStates.cycle.chainedTask=t,!1;this.mUpdateStates.sync.running=!0;try{let e=Gt.openUpdateCycle({updater:this,runSync:!0},r=>{if(this.mUpdateRunCache.has(r.runner))return Gt.updateCyleStartTime(r),this.mUpdateRunCache.get(r.runner);let c=this.executeTaskChain(t,r,!1,new Array);return this.mUpdateRunCache.set(r.runner,c),c});return this.releaseUpdateChainCompleteHooks(e),e}catch(e){throw e instanceof ye||this.releaseUpdateChainCompleteHooks(!1,e),e}finally{this.mUpdateStates.sync.running=!1}}},ye=class extends Error{constructor(){super("Update resheduled")}};var ze=class extends kt{mUpdater;get updater(){return this.mUpdater}constructor(t){super(t),this.mUpdater=new Fe({label:t.constructor.name,onUpdate:()=>this.onUpdate()})}call(t,...e){return this.mUpdater.executeInZone(()=>super.call(t,...e))}deconstruct(){this.mUpdater.deconstruct(),super.deconstruct()}createProcessor(){return this.mUpdater.executeInZone(()=>super.createProcessor())}};var Wt=class{mExpression;mTemporaryValues;constructor(t,e,r){if(this.mTemporaryValues=new rt,r.length>0)for(let c of r)this.mTemporaryValues.set(c,void 0);this.mExpression=this.createEvaluationFunction(t,this.mTemporaryValues).bind(e.store)}execute(){return this.mExpression()}setTemporaryValue(t,e){if(!this.mTemporaryValues.has(t))throw new N(`Temporary value "${t}" does not exist for this procedure.`,this);this.mTemporaryValues.set(t,e)}createEvaluationFunction(t,e){let r,c=`__${Math.random().toString(36).substring(2)}`;if(r="return function () {",e.size>0)for(let m of e.keys())r+=`const ${m} = ${c}.get('${m}');`;return r+=`return ${t};`,r+="};",new Function(c,r)(e)}};var Pt=class{mDataLevel;get data(){return this.mDataLevel}constructor(t){this.mDataLevel=t}createExpressionProcedure(t,e){return new Wt(t,this.data,e??[])}setTemporaryValue(t,e){this.data.setTemporaryValue(t,e)}};var ft=class{mComponent;mDataProxy;mParentLevel;mTemporaryValues;get store(){return this.mDataProxy}constructor(t){this.mTemporaryValues=new rt,t instanceof G?(this.mParentLevel=null,this.mComponent=t):(this.mParentLevel=t,this.mComponent=t.mComponent),this.mDataProxy=this.createAccessProxy()}deleteTemporaryValue(t){this.mTemporaryValues.delete(t)}setTemporaryValue(t,e){this.mTemporaryValues.set(t,e)}updateLevelData(t){if(t.mParentLevel!==this.mParentLevel)throw new N("Can't update InstructionLevelData for a deeper level than it target data.",this);this.mTemporaryValues=t.mTemporaryValues}createAccessProxy(){return new Proxy(new Object,{get:(t,e)=>this.getValue(e),set:(t,e,r)=>(this.hasTemporaryValue(e)&&this.setTemporaryValue(e,r),e in this.mComponent.processor?(this.mComponent.processor[e]=r,!0):(this.setTemporaryValue(e,r),!0)),deleteProperty:()=>{throw new N("Deleting properties is not allowed",this)},ownKeys:()=>[...new Set([...Object.keys(this.mComponent.processor),...this.getTemporaryValuesList()])]})}getTemporaryValuesList(){let t=this.mTemporaryValues.map(e=>e);return this.mParentLevel&&t.push(...this.mParentLevel.getTemporaryValuesList()),t}getValue(t){if(this.mTemporaryValues.has(t))return this.mTemporaryValues.get(t);if(this.mParentLevel)return this.mParentLevel.getValue(t);if(t in this.mComponent.processor)return this.mComponent.processor[t]}hasTemporaryValue(t){return this.mTemporaryValues.has(t)?!0:this.mParentLevel?this.mParentLevel.hasTemporaryValue(t):!1}};var Zt=class g{mChildList;mInstruction;mInstructionType;get childList(){return this.mChildList}get instruction(){return this.mInstruction}get instructionType(){return this.mInstructionType}constructor(t,e){this.mChildList=Array(),this.mInstruction=e,this.mInstructionType=t}appendChild(...t){this.mChildList.push(...t)}clone(){let t=new g(this.instructionType,this.instruction);for(let e of this.mChildList)t.appendChild(e.clone());return t}equals(t){if(!(t instanceof g)||t.instruction!==this.instruction||t.instructionType!==this.instructionType||t.childList.length!==this.childList.length)return!1;for(let e=0;e<t.childList.length;e++)if(!t.childList[e].equals(this.childList[e]))return!1;return!0}removeChild(t){let e=this.mChildList.indexOf(t);if(e!==-1)return this.mChildList.splice(e,1)[0]}};var At=class g{mExpression;get value(){return this.mExpression}constructor(t){this.mExpression=t}clone(){return new g(this.mExpression)}equals(t){return t instanceof g&&t.value===this.value}toString(){return`{{ ${this.mExpression} }}`}};var Lt=class g{mContainsExpression;mTextValue;mValues;get containsExpression(){return this.mContainsExpression}get values(){return this.mValues}constructor(){this.mTextValue="",this.mContainsExpression=!1,this.mValues=[]}addValue(...t){for(let e of t)(this.mContainsExpression===!0||e instanceof At)&&(this.mContainsExpression=!0),this.mValues.push(e),this.mTextValue+=e.toString()}clone(){let t=new g;for(let e of this.values)typeof e=="string"?t.addValue(e):t.addValue(e.clone());return t}equals(t){if(!(t instanceof g)||t.values.length!==this.values.length)return!1;for(let e=0;e<this.values.length;e++){let r=this.values[e],c=t.values[e];if(r!==c&&(typeof r!=typeof c||typeof r=="string"&&r!==c||!c.equals(r)))return!1}return!0}toString(){return this.mTextValue}};var be=class g{mName;mValue;get name(){return this.mName}get values(){return this.mValue}constructor(t){this.mName=t,this.mValue=new Lt}clone(){let t=new g(this.name);for(let e of this.values.values)typeof e=="string"?t.values.addValue(e):t.values.addValue(e.clone());return t}equals(t){return!(!(t instanceof g)||t.name!==this.name||!t.values.equals(this.values))}};var Rt=class g{mAttributeDictionary;mChildList;mTagName;get attributes(){return[...this.mAttributeDictionary.values()]}get childList(){return this.mChildList}get tagName(){return this.mTagName}constructor(t){this.mAttributeDictionary=new Map,this.mChildList=Array(),this.mTagName=t}appendChild(...t){this.mChildList.push(...t)}clone(){let t=new g(this.tagName);for(let e of this.mAttributeDictionary.values()){let r=t.setAttribute(e.name);for(let c of e.values.values)typeof c=="string"?r.addValue(c):r.addValue(c.clone())}for(let e of this.mChildList)t.appendChild(e.clone());return t}equals(t){if(!(t instanceof g)||t.tagName!==this.tagName||t.attributes.length!==this.mAttributeDictionary.size||t.childList.length!==this.mChildList.length)return!1;for(let e of t.mAttributeDictionary.values()){let r=this.mAttributeDictionary.get(e.name);if(!r||!r.equals(e))return!1}for(let e=0;e<t.childList.length;e++)if(!t.childList[e].equals(this.mChildList[e]))return!1;return!0}getAttribute(t){return this.mAttributeDictionary.get(t)?.values??null}removeAttribute(t){return this.mAttributeDictionary.delete(t)}removeChild(t){let e=this.mChildList.indexOf(t);if(e!==-1)return this.mChildList.splice(e,1)[0]}setAttribute(t){if(this.mAttributeDictionary.has(t))return this.mAttributeDictionary.get(t).values;let e=new be(t);return this.mAttributeDictionary.set(t,e),e.values}};var dt=class g{mBodyElementList;get body(){return this.mBodyElementList}constructor(){this.mBodyElementList=new Array}appendChild(...t){this.mBodyElementList.push(...t)}clone(){let t=new g;for(let e of this.mBodyElementList)t.appendChild(e.clone());return t}equals(t){if(!(t instanceof g)||t.body.length!==this.mBodyElementList.length)return!1;for(let e=0;e<this.mBodyElementList.length;e++)if(!this.mBodyElementList[e].equals(t.body[e]))return!1;return!0}removeChild(t){let e=this.mBodyElementList.indexOf(t);if(e!==-1)return this.mBodyElementList.splice(e,1)[0]}};var ct=class{mComponentValues;mContent;mModules;mTemplate;get anchor(){return this.mContent.contentAnchor}get content(){return this.mContent}get modules(){return this.mModules}get template(){return this.mTemplate}get values(){return this.mComponentValues}constructor(t,e,r,c){this.mTemplate=t,this.mComponentValues=r,this.mContent=c,this.mModules=e,c.setCoreBuilder(this)}deconstruct(){this.content.deconstruct()}update(){let t=this.onUpdate(),e=!1,r=this.content.builders;if(r.length>0)for(let c=0;c<r.length;c++)e=r[c].update()||e;return t||e}createTextNode(t){return document.createTextNode(t)}};var te=class{mChildBuilderList;mChildComponents;mContentAnchor;mContentBoundary;mLinkedContent;mRootChildList;get body(){return this.mRootChildList}get builders(){return this.mChildBuilderList}get contentAnchor(){return this.mContentAnchor}constructor(t){this.mChildBuilderList=new Array,this.mRootChildList=new Array,this.mChildComponents=new Map,this.mLinkedContent=new WeakSet,this.mContentAnchor=document.createComment(t),this.mContentBoundary={start:this.mContentAnchor,end:this.mContentAnchor}}deconstruct(){this.onDeconstruct();let t;for(;t=this.mChildBuilderList.pop();)t.deconstruct();for(let r of this.mChildComponents.values())r.deconstruct();this.mChildComponents.clear();let e;for(;e=this.mRootChildList.pop();)e instanceof ct||e.remove();this.contentAnchor.remove()}getBoundary(){let t=this.mContentBoundary.end instanceof ct?this.mContentBoundary.end.content.getBoundary().end:this.mContentBoundary.end;return{start:this.mContentBoundary.start,end:t}}insert(t,e,r){if(!this.mLinkedContent.has(r))throw new N("Can't add content to builder. Target is not part of builder.",this);let c=t instanceof ct?t.anchor:t;switch(e){case"After":{this.insertAfter(c,r);break}case"TopOf":{this.insertTop(c,r);break}case"BottomOf":{this.insertBottom(c,r);break}}this.mLinkedContent.add(t),t instanceof ct?this.mChildBuilderList.push(t):this.addChildComponent(t);let m=c.parentElement??c.getRootNode(),v=this.mContentAnchor.parentElement??this.mContentAnchor.getRootNode();if(m===v){let b=(()=>{switch(e){case"After":return this.mRootChildList.indexOf(r)+1;case"TopOf":return 0;case"BottomOf":return this.mRootChildList.length}})();b===this.mRootChildList.length&&(this.mContentBoundary.end=t),this.mRootChildList.splice(b+1,0,t)}}remove(t){if(!this.mLinkedContent.has(t))throw new N("Child node cant be deleted from builder when it not a child of them",this);if(this.mLinkedContent.delete(t),t instanceof ct){let r=this.mChildBuilderList.indexOf(t);r!==-1&&this.mChildBuilderList.splice(r,1),t.deconstruct()}else{let r=this.mChildComponents.get(t);r&&(r.deconstruct(),this.mChildComponents.delete(t)),t.remove()}let e=this.mRootChildList.indexOf(t);e!==-1&&(this.mRootChildList.splice(e,1),this.mContentBoundary.end=this.mRootChildList.at(-1)??this.mContentAnchor)}setCoreBuilder(t){this.mLinkedContent.add(t)}addChildComponent(t){Q.elementIsComponent(t)&&this.mChildComponents.set(t,Q.ofElement(t).component)}insertAfter(t,e){let r=e instanceof ct?e.content.getBoundary().end:e;(r.parentElement??r.getRootNode()).insertBefore(t,r.nextSibling)}insertBottom(t,e){if(e instanceof ct){this.insertAfter(t,e);return}if(e instanceof Element){e.appendChild(t);return}throw new N("Source node does not support child nodes.",this)}insertTop(t,e){if(e instanceof ct){this.insertAfter(t,e.anchor);return}if(e instanceof Element){e.prepend(t);return}throw new N("Source node does not support child nodes.",this)}};var je=class extends te{mAttributeModulesChangedOrder;mLinkedAttributeData;mLinkedAttributeExpressionModules;mLinkedAttributeModuleList;mLinkedExpressionModuleList;get linkedAttributeModules(){return this.mAttributeModulesChangedOrder&&(this.mAttributeModulesChangedOrder=!1,this.mLinkedAttributeModuleList.sort((t,e)=>t.accessMode-e.accessMode)),this.mLinkedAttributeModuleList}get linkedExpressionModules(){return this.mLinkedExpressionModuleList}constructor(t){super(t),this.mLinkedExpressionModuleList=new Array,this.mLinkedAttributeModuleList=new Array,this.mLinkedAttributeExpressionModules=new WeakMap,this.mLinkedAttributeData=new WeakMap,this.mAttributeModulesChangedOrder=!1}attributeOfLinkedExpressionModule(t){return this.mLinkedAttributeExpressionModules.get(t)}getLinkedAttributeData(t){if(!this.mLinkedAttributeData.has(t))throw new N("Attribute has no linked data.",this);return this.mLinkedAttributeData.get(t)}linkAttributeExpression(t,e){this.mLinkedAttributeExpressionModules.set(t,e)}linkAttributeModule(t){this.mLinkedAttributeModuleList.push(t),this.mAttributeModulesChangedOrder=!0}linkAttributeNodes(t,e,r){this.mLinkedAttributeData.set(t,{values:r,node:e})}linkExpressionModule(t){this.mLinkedExpressionModuleList.push(t)}onDeconstruct(){for(let t of this.mLinkedAttributeModuleList)t.deconstruct();for(let t of this.mLinkedExpressionModuleList)t.deconstruct()}};var Ve=class extends te{mInstructionModule;get instructionModule(){return this.mInstructionModule}constructor(t,e){super(e),this.mInstructionModule=t}onDeconstruct(){this.mInstructionModule.deconstruct()}};var $e=class extends ct{constructor(t,e,r){let c=e.createInstructionModule(t,r);super(t,e,r,new Ve(c,`Instruction - {$${t.instructionType}}`))}onUpdate(){if(this.content.instructionModule.update()){let t=this.content.body;this.updateStaticBuilder(t,this.content.instructionModule.instructionResult.elementList)}return!1}insertNewContent(t,e){let r=new ee(t.template,this.modules,t.dataLevel,`Child - {$${this.template.instructionType}}`,t.key);return e===null?this.content.insert(r,"TopOf",this):this.content.insert(r,"After",e),r}updateStaticBuilder(t,e){let c=new de((b,D)=>D.template.equals(b.template)&&D.key===b.key).differencesOf(t,e),m=0,v=null;for(let b=0;b<c.length;b++){let D=c[b];if(D.changeState===_t.Remove)this.content.remove(D.item);else if(D.changeState===_t.Insert)v=this.insertNewContent(D.item,v),m++;else{let C=e[m].dataLevel;D.item.values.updateLevelData(C),v=D.item,m++}}}};var ee=class extends ct{mInitialized;mKey;get key(){return this.mKey}constructor(t,e,r,c,m){super(t,e,r,new je(`Static - {${c}}`)),this.mKey=m,this.mInitialized=!1}onUpdate(){this.mInitialized||(this.mInitialized=!0,this.buildTemplate([this.template],this));let t=!1,e=this.content.linkedAttributeModules;for(let m=0;m<e.length;m++)t=e[m].update()||t;let r=!1,c=this.content.linkedExpressionModules;for(let m=0;m<c.length;m++){let v=c[m];if(v.update()){r=!0;let b=this.content.attributeOfLinkedExpressionModule(v);if(!b)continue;let D=this.content.getLinkedAttributeData(b),C=D.values.reduce((a,n)=>a+n.data,"");D.node.setAttribute(b.name,C)}}return t||r}buildInstructionTemplate(t,e){this.content.insert(new $e(t,this.modules,new ft(this.values)),"BottomOf",e)}buildStaticTemplate(t,e){let{element:r,isComponent:c}=this.createHtmlElement(t),m=null;c&&(m=new Array);for(let v of t.attributes){let b=this.modules.createAttributeModule(v,r,this.values);if(b){this.content.linkAttributeModule(b),c&&m.push(b);continue}if(v.values.containsExpression){let D=new Array;for(let C of v.values.values){let a=this.createTextNode("");if(D.push(a),!(C instanceof At)){a.data=C;continue}let n=this.modules.createExpressionModule(C,a,this.values);this.content.linkExpressionModule(n),this.content.linkAttributeExpression(n,v)}this.content.linkAttributeNodes(v,r,D);continue}r.setAttribute(v.name,v.values.toString())}if(c){for(let v of m)v.update();Q.ofElement(r).component.updater.update()}this.content.insert(r,"BottomOf",e),this.buildTemplate(t.childList,r)}buildTemplate(t,e){for(let r of t)r instanceof dt?this.buildTemplate(r.body,e):r instanceof Lt?this.buildTextTemplate(r,e):r instanceof Zt?this.buildInstructionTemplate(r,e):r instanceof Rt&&this.buildStaticTemplate(r,e)}buildTextTemplate(t,e){for(let r of t.values){if(typeof r=="string"){this.content.insert(this.createTextNode(r),"BottomOf",e);continue}let c=this.createTextNode("");this.content.insert(c,"BottomOf",e);let m=this.modules.createExpressionModule(r,c,this.values);this.content.linkExpressionModule(m)}}createHtmlElement(t){let e=t.tagName;if(e.includes("-")){let c=globalThis.customElements.get(e);if(typeof c<"u"){let m=new c;return{element:m,isComponent:Q.elementIsComponent(m)}}}let r=t.getAttribute("xmlns");return r&&!r.containsExpression?{element:document.createElementNS(r.values[0],e),isComponent:!1}:{element:document.createElement(e),isComponent:!1}}};var we=class{mHtmlElement;mShadowRoot;get htmlElement(){return this.mHtmlElement}get shadowRoot(){return this.mShadowRoot}constructor(t){this.mHtmlElement=t,this.mShadowRoot=this.mHtmlElement.attachShadow({mode:"open"})}};var Y=class{mDataLevel;get data(){return this.mDataLevel}constructor(t){this.mDataLevel=t}createExpressionProcedure(t,e){return new Wt(t,this.data,e??[])}};var Bt=class extends kt{constructor(t){super({constructor:t.constructor,parent:t.parent}),this.setProcessorInjection(Y,new Y(t.values))}deconstruct(){super.deconstruct(),this.call("onDeconstruct")}update(){return this.onUpdate()}};var ot=class{mValue;get value(){return this.mValue}constructor(t){this.mValue=t}};var k=class{constructor(){throw new N("Reference should not be instanced.",this)}};var gt=class{constructor(){throw new N("Reference should not be instanced.",this)}};var Ut=class g extends Bt{mLastResult;mTargetTextNode;constructor(t){super({constructor:t.constructor,parent:t.parent,values:t.values}),this.mTargetTextNode=t.targetNode,this.mLastResult=null,this.setProcessorInjection(g,this),this.setProcessorInjection(gt,t.targetTemplate.clone()),this.setProcessorInjection(k,t.targetNode),this.setProcessorInjection(ot,new ot(t.targetTemplate.value))}onUpdate(){let t=this.call("onUpdate");t===null&&(t="");let e=this.mLastResult===null||this.mLastResult!==t;if(e){let r=this.mTargetTextNode;r.data=t,this.mLastResult=t}return e}};function bo(){return(g,t)=>{O.registerInjectable(g,t.metadata,"instanced"),ht.register(Ut,g,{})}}function Js(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function Oo(g,t,e,r){return(Oo=Js())(g,t,e,r)}var Fo,Lo,wo;Fo=bo();var Ro=class{static{({c:[wo,Lo]}=Oo(this,[],[Fo]))}constructor(t=O.use(Y),e=O.use(ot)){this.mProcedure=t.createExpressionProcedure(e.value)}mProcedure;onUpdate(){let t=this.mProcedure.execute();return typeof t>"u"?null:t?.toString()}static{Lo()}};var it=class{mName;mValue;get name(){return this.mName}get value(){return this.mValue}constructor(t,e){this.mName=t,this.mValue=e}};var Et=class g extends Bt{mAccessMode;get accessMode(){return this.mAccessMode}constructor(t){super({constructor:t.constructor,parent:t.parent,values:t.values}),this.mAccessMode=t.accessMode,this.setProcessorInjection(g,this),this.setProcessorInjection(gt,t.targetTemplate.clone()),this.setProcessorInjection(k,t.targetNode),this.setProcessorInjection(it,new it(t.targetTemplate.name,t.targetTemplate.values.toString()))}onUpdate(){return this.call("onUpdate")??!1}};var mt=class{mDataLevels;mElementList;mTemplates;get elementList(){return this.mElementList}constructor(){this.mElementList=new Array,this.mTemplates=new Set,this.mDataLevels=new Set}addElement(t,e,r){if(this.mTemplates.has(t)||this.mDataLevels.has(e))throw new N("Can't add same template or values for multiple Elements.",this);this.mTemplates.add(t),this.mDataLevels.add(e),this.mElementList.push({template:t,dataLevel:e,key:r})}};var Xt=class g extends Bt{mLastResult;get instructionResult(){return this.mLastResult}constructor(t){super({constructor:t.constructor,parent:t.parent,values:t.values}),this.setProcessorInjection(g,this),this.setProcessorInjection(gt,t.targetTemplate.clone()),this.setProcessorInjection(ot,new ot(t.targetTemplate.instruction)),this.mLastResult=new mt}onUpdate(){let t=this.call("onUpdate");return t instanceof mt?(this.mLastResult=t,!0):!1}};var Ge=class g{static mAttributeModuleCache=new rt;static mExpressionModuleCache=new WeakMap;static mInstructionModuleCache=new rt;mComponent;mExpressionModule;constructor(t,e){this.mExpressionModule=e??wo,this.mComponent=t}createAttributeModule(t,e,r){let c=(()=>{let m=g.mAttributeModuleCache.get(t.name);if(m||m===null)return m;for(let v of ht.get(Et))if(v.processorConfiguration.selector.test(t.name))return g.mAttributeModuleCache.set(t.name,v),v;return g.mAttributeModuleCache.set(t.name,null),null})();return c===null?null:new Et({accessMode:c.processorConfiguration.access,constructor:c.processorConstructor,parent:this.mComponent,targetNode:e,targetTemplate:t,values:r}).setup()}createExpressionModule(t,e,r){let c=(()=>{let m=g.mExpressionModuleCache.get(this.mExpressionModule);if(m)return m;let v=ht.get(Ut).find(b=>b.processorConstructor===this.mExpressionModule);if(!v)throw new N("An expression module could not be found.",this);return g.mExpressionModuleCache.set(this.mExpressionModule,v),v})();return new Ut({constructor:c.processorConstructor,parent:this.mComponent,targetNode:e,targetTemplate:t,values:r}).setup()}createInstructionModule(t,e){let r=(()=>{let c=g.mInstructionModuleCache.get(t.instructionType);if(c)return c;for(let m of ht.get(Xt))if(m.processorConfiguration.instructionType===t.instructionType)return g.mInstructionModuleCache.set(t.instructionType,m),m;throw new N(`Instruction module type "${t.instructionType}" not found.`,this)})();return new Xt({constructor:r.processorConstructor,parent:this.mComponent,targetTemplate:t,values:e}).setup()}};var qt=class extends N{mColumnEnd;mColumnStart;mLineEnd;mLineStart;get columnEnd(){return this.mColumnEnd}get columnStart(){return this.mColumnStart}get lineEnd(){return this.mLineEnd}get lineStart(){return this.mLineStart}constructor(t,e,r,c,m,v,b){super(t,e,b),this.mColumnStart=r,this.mLineStart=c,this.mColumnEnd=m,this.mLineEnd=v}};var oe=class{mDependencyFetch;mDependencyFetchResolved;mLexer;mMeta;mPattern;mPatternDependencies;mType;get dependencies(){return this.mPatternDependencies}get dependenciesResolved(){return this.mDependencyFetchResolved}get lexer(){return this.mLexer}get meta(){return this.mMeta}get pattern(){return this.mPattern}constructor(t,e){if(this.mLexer=t,this.mType=e.type,this.mMeta=e.metadata,this.mPatternDependencies=new Array,this.mDependencyFetch=e.dependencyFetch??null,this.mDependencyFetchResolved=!e.dependencyFetch,this.mType==="split"&&!this.mDependencyFetch)throw new N("Split token with a start and end token, need inner token definitions.",this);if(this.mType==="single"&&this.mDependencyFetch)throw new N("Pattern does not allow inner token pattern.",this);this.mPattern=this.convertTokenPattern(this.mType,e.pattern)}isSplit(){return this.mType==="split"}resolveDependencies(){this.mDependencyFetchResolved||(this.mDependencyFetch(this),this.mDependencyFetchResolved=!0)}useChildPattern(t){if(this.mLexer!==t.lexer)throw new N("Can only add dependencies of the same lexer.",this);this.mPatternDependencies.push(t)}convertTokenPattern(t,e){if("single"in e){if(t==="split")throw new N("Can't use split pattern type with single pattern definition.",this);return{start:{regex:e.single.regex,types:e.single.types,validator:e.single.validator??null}}}else{if(t==="single")throw new N("Can't use single pattern type with split pattern definition.",this);return{start:{regex:e.start.regex,types:e.start.types,validator:e.start.validator??null},end:{regex:e.end.regex,types:e.end.types,validator:e.end.validator??null},innerType:e.innerType??null}}}};var re=class{mColumnNumber;mLineNumber;mMetas;mType;mValue;get columnNumber(){return this.mColumnNumber}get lineNumber(){return this.mLineNumber}get metas(){return[...this.mMetas]}get type(){return this.mType}get value(){return this.mValue}constructor(t,e,r,c){this.mValue=e,this.mColumnNumber=r,this.mLineNumber=c,this.mType=t,this.mMetas=new Set}addMeta(...t){for(let e of t)this.mMetas.add(e)}hasMeta(t){return this.mMetas.has(t)}};var xe=class{mRootPattern;mSettings;get errorType(){return this.mSettings.errorType}set errorType(t){this.mSettings.errorType=t}get trimWhitespace(){return this.mSettings.trimSpaces}set trimWhitespace(t){this.mSettings.trimSpaces=t}get validWhitespaces(){return[...this.mSettings.whiteSpaces].join("")}set validWhitespaces(t){this.mSettings.whiteSpaces=new Set(t.split(""))}constructor(){this.mSettings={errorType:null,trimSpaces:!0,whiteSpaces:new Set},this.mRootPattern=new oe(this,{type:"single",pattern:{single:{regex:/^/,types:{},validator:null}},metadata:[],dependencyFetch:null})}createTokenPattern(t,e){let r=b=>typeof b=="string"?{token:b}:b,c=b=>{let D=new Set(b.flags.split(""));return new RegExp(`^(?<token>${b.source})`,[...D].join(""))},m=new Array;t.meta&&(typeof t.meta=="string"?m.push(t.meta):m.push(...t.meta));let v;return"regex"in t.pattern?v={single:{regex:c(t.pattern.regex),types:r(t.pattern.type),validator:t.pattern.validator??null}}:v={start:{regex:c(t.pattern.start.regex),types:r(t.pattern.start.type),validator:t.pattern.start.validator??null},end:{regex:c(t.pattern.end.regex),types:r(t.pattern.end.type),validator:t.pattern.end.validator??null},innerType:t.pattern.innerType??null},new oe(this,{type:"regex"in t.pattern?"single":"split",pattern:v,metadata:m,dependencyFetch:e??null})}*tokenize(t,e){let r={data:t,cursor:{position:0,column:1,line:1},error:null,progressTracker:e??null};yield*this.tokenizeRecursionLayer(r,this.mRootPattern,new Array,null)}useRootTokenPattern(t){if(t.lexer!==this)throw new N("Token pattern must be created by this lexer.",this);this.mRootPattern.useChildPattern(t)}findNextStartToken(t,e,r,c){for(let m of e){let v=m.pattern.start,b=this.matchToken(m,v,t,r,c);if(b!==null)return{pattern:m,token:b}}return null}findTokenTypeOfMatch(t,e,r){for(let v in t.groups){let b=t.groups[v],D=e[v];if(!(!b||!D)){if(b.length!==t[0].length)throw new N("A group of a token pattern must match the whole token.",this);return D}}let c=new Array;for(let v in t.groups)t.groups[v]&&c.push(v);let m=new Array;for(let v in e)m.push(v);throw new N(`No token type found for any defined pattern regex group. Full: "${t[0]}", Matches: "${c.join(", ")}", Available: "${m.join(", ")}", Regex: "${r.source}"`,this)}*generateErrorToken(t,e){if(!t.error||!this.mSettings.errorType)return;let r=new re(this.mSettings.errorType,t.error.data,t.error.startColumn,t.error.startLine);r.addMeta(...e),t.error=null,yield r}generateToken(t,e,r,c,m,v){let b=r[0],D=this.findTokenTypeOfMatch(r,c,v),C=new re(m??D,b,t.cursor.column,t.cursor.line);return C.addMeta(...e),C}matchToken(t,e,r,c,m){let v=e.regex;v.lastIndex=0;let b=v.exec(r.data);if(!b||b.index!==0)return null;let D=this.generateToken(r,[...c,...t.meta],b,e.types,m,v);if(e.validator){let C=r.data.substring(D.value.length);if(!e.validator(D,C,r.cursor.position))return null}return this.moveCursor(r,D.value),D}moveCursor(t,e){let r=e.split(`
`);r.length>1&&(t.cursor.column=1),t.cursor.line+=r.length-1,t.cursor.column+=r.at(-1).length,t.cursor.position+=e.length,t.data=t.data.substring(e.length),this.trackProgress(t)}pushNextCharToErrorState(t){if(!this.mSettings.errorType)throw new qt(`Unable to parse next token. No valid pattern found for "${t.data.substring(0,20)}".`,this,t.cursor.column,t.cursor.line,t.cursor.column,t.cursor.line);t.error||(t.error={data:"",startColumn:t.cursor.column,startLine:t.cursor.line});let e=t.data.charAt(0);t.error.data+=e,this.moveCursor(t,e)}skipNextWhitespace(t){let e=t.data.charAt(0);return!this.mSettings.trimSpaces||!this.mSettings.whiteSpaces.has(e)?!1:(this.moveCursor(t,e),!0)}*tokenizeRecursionLayer(t,e,r,c){let m=e.dependencies;for(;t.data.length>0;){if(!t.error&&this.skipNextWhitespace(t))continue;if(e.isSplit()){let D=this.matchToken(e,e.pattern.end,t,r,c);if(D!==null){yield*this.generateErrorToken(t,r),yield D;return}}let v=this.findNextStartToken(t,m,r,c);if(!v){this.pushNextCharToErrorState(t);continue}yield*this.generateErrorToken(t,r),yield v.token;let b=v.pattern;b.isSplit()&&(b.resolveDependencies(),yield*this.tokenizeRecursionLayer(t,b,[...r,...b.meta],c??b.pattern.innerType))}yield*this.generateErrorToken(t,r)}trackProgress(t){t.progressTracker!==null&&t.progressTracker(t.cursor.position,t.cursor.line,t.cursor.column)}};var J=class extends Error{static PARSER_ERROR=Symbol("PARSER_ERROR");mTrace;get columnEnd(){return this.mTrace.top.range.columnEnd}get columnStart(){return this.mTrace.top.range.columnStart}get graph(){return this.mTrace.top.graph}get incidents(){return this.mTrace.incidents}get lineEnd(){return this.mTrace.top.range.lineEnd}get lineStart(){return this.mTrace.top.range.lineStart}constructor(t){super(t.top.message,{cause:t.top.cause}),this.mTrace=t}};var Be=class{mIncidents;mTop;get incidents(){if(this.mIncidents===null)throw new N("A complete incident list is only available on debug mode.",this);return this.mIncidents}get top(){return this.mTop}constructor(t){this.mTop={message:"Unknown parser error",priority:0,graph:null,range:{lineStart:1,columnStart:1,lineEnd:1,columnEnd:1},cause:null},t?this.mIncidents=new Array:this.mIncidents=null}push(t,e,r,c,m,v,b=!1,D=null){let C;if(b?C=this.mTop.priority+1:C=m*1e4+v,this.mIncidents!==null){let a={message:t,priority:C,graph:e,range:{lineStart:r,columnStart:c,lineEnd:m,columnEnd:v},cause:D};this.mIncidents.push(a)}this.mTop&&C<this.mTop.priority||this.setTop({message:t,priority:C,graph:e,range:{lineStart:r,columnStart:c,lineEnd:m,columnEnd:v},cause:D})}setTop(t){this.mTop=t}};var Ue=class g{static MAX_JUNCTION_CIRCULAR_REFERENCES=1e3;mGraphStack;mIncidentTrace;mLastTokenPosition;mProcessStack;mTokenCache;mTokenGenerator;mTrimTokenCache;get currentGraph(){return this.mGraphStack.top.graph}get currentToken(){let t=this.mGraphStack.top;return this.mTokenCache[t.token.cursor]}get incidentTrace(){return this.mIncidentTrace}get processStack(){return this.mProcessStack}constructor(t,e,r){this.mTokenGenerator=t,this.mGraphStack=new zt,this.mLastTokenPosition={column:1,line:1},this.mTokenCache=new Array,this.mProcessStack=new zt,this.mTrimTokenCache=r,this.mIncidentTrace=new Be(e),this.mGraphStack.push({graph:null,linear:!0,circularGraphs:new rt,token:{start:0,cursor:-1}})}collapse(){let t=this.mGraphStack.top,e=this.mTokenCache.slice(t.token.cursor);e.length!==0&&e.at(-1)===null&&e.pop();for(let r of this.mTokenGenerator)e.push(r);return e}getGraphBoundingToken(){let t=this.mGraphStack.top,e=this.mTokenCache[t.token.start],r=this.mTokenCache[t.token.cursor-1];return e??=r,r??=e,[e??null,r??null]}getGraphPosition(){let t=this.mGraphStack.top,e,r;if(e=this.mTokenCache[t.token.start],r=this.mTokenCache[t.token.cursor-1],e??=r,r??=e,!e||!r)return{graph:t.graph,columnEnd:this.mLastTokenPosition.column,columnStart:this.mLastTokenPosition.column,lineEnd:this.mLastTokenPosition.line,lineStart:this.mLastTokenPosition.line};let c,m;if(r.value.includes(`
`)){let v=r.value.split(`
`);m=r.lineNumber+v.length-1,c=1+v[v.length-1].length}else c=r.columnNumber+r.value.length,m=r.lineNumber;return{graph:t.graph,lineStart:e.lineNumber,columnStart:e.columnNumber,lineEnd:m,columnEnd:c}}getTokenPosition(){let t=this.mGraphStack.top,e=this.currentToken;if(!e)return{graph:t.graph,columnEnd:this.mLastTokenPosition.column,columnStart:this.mLastTokenPosition.column,lineEnd:this.mLastTokenPosition.line,lineStart:this.mLastTokenPosition.line};let r,c;if(e.value.includes(`
`)){let m=e.value.split(`
`);c=e.lineNumber+m.length-1,r=1+m[m.length-1].length}else r=e.columnNumber+e.value.length,c=e.lineNumber;return{graph:t.graph,lineStart:e.lineNumber,columnStart:e.columnNumber,lineEnd:c,columnEnd:r}}graphIsCircular(t){let e=this.mGraphStack.top;if(!e.circularGraphs.has(t))return!1;if(t.isJunction){if(e.circularGraphs.get(t)>g.MAX_JUNCTION_CIRCULAR_REFERENCES)throw new N("Junction graph called circular too often.",this);return!1}return!0}moveNextToken(){let t=this.mGraphStack.top;if(t.circularGraphs.size>0&&(t.circularGraphs=new rt),t.graph&&t.graph.isJunction)throw new N("Junction graph must not have own nodes.",this);if(t.token.cursor++,t.token.cursor<this.mTokenCache.length)return;let e=this.mTokenGenerator.next();if(e.done){this.mTokenCache.push(null);return}this.mLastTokenPosition.column=e.value.columnNumber,this.mLastTokenPosition.line=e.value.lineNumber,this.mTokenCache.push(e.value)}popGraphStack(t){let e=this.mGraphStack.pop(),r=this.mGraphStack.top;if(t&&(e.token.cursor=e.token.start),e.token.cursor!==e.token.start&&r.circularGraphs.size>0&&(r.circularGraphs=new rt),!this.mTrimTokenCache){r.token.cursor=e.token.cursor;return}e.linear?(this.mTokenCache.splice(0,e.token.cursor),r.token.start=0,r.token.cursor=0):r.token.cursor=e.token.cursor}pushGraphStack(t,e){let r=this.mGraphStack.top,c={graph:t,linear:e&&r.linear,circularGraphs:new rt(r.circularGraphs),token:{start:r.token.cursor,cursor:r.token.cursor}},m=c.circularGraphs.get(t)??0;c.circularGraphs.set(t,m+1),this.mGraphStack.push(c)}};var Te=class g{static NODE_NULL_RESULT=Symbol("FAILED_NODE_VALUE_PARSE");static NODE_VALUE_LIST_END_MEET=Symbol("FAILED_NODE_VALUE_PARSE");mConfiguration;mLexer;mRootPart;get lexer(){return this.mLexer}constructor(t,e){this.mLexer=t,this.mRootPart=null,this.mConfiguration={keepTraceIncidents:!1,trimTokenCache:!1,...e}}parse(t,e){if(this.mRootPart===null)throw new N("Parser has not root part set.",this);let r=new Ue(this.mLexer.tokenize(t,e),this.mConfiguration.keepTraceIncidents,this.mConfiguration.trimTokenCache),c=(()=>{try{return this.beginParseProcess(r,this.mRootPart)}catch(v){if(v instanceof qt)return r.incidentTrace.push(v.message,r.currentGraph,v.lineStart,v.columnStart,v.lineEnd,v.columnEnd,!0,v),J.PARSER_ERROR;let b=v instanceof Error?v.message:v.toString(),D=r.getGraphPosition();return r.incidentTrace.push(b,r.currentGraph,D.lineStart,D.columnStart,D.lineEnd,D.columnEnd,!0,v),J.PARSER_ERROR}})();if(c===J.PARSER_ERROR)throw new J(r.incidentTrace);let m=r.collapse();if(m.length!==0){let v=m[0];if(r.incidentTrace.top.range.lineEnd===1&&r.incidentTrace.top.range.columnEnd===1){let b=`Tokens could not be parsed. Graph end meet without reaching last token. Current: "${v.value}" (${v.type})`;r.incidentTrace.push(b,this.mRootPart,v.lineNumber,v.columnNumber,v.lineNumber,v.columnNumber)}throw new J(r.incidentTrace)}return c}setRootGraph(t){this.mRootPart=t}beginParseProcess(t,e){t.moveNextToken(),t.processStack.push({type:"graph-parse",parameter:{graph:e,linear:!0},state:0});let r=g.NODE_NULL_RESULT;for(;t.processStack.top;)r=this.processStack(t,t.processStack.top,r);return r}processChainedNodeParseProcess(t,e,r){switch(e.state){case 0:{let v=e.parameter.node.connections.next;return v===null?(t.processStack.pop(),{}):(e.state++,t.processStack.push({type:"node-parse",parameter:{node:v},state:0,values:{}}),g.NODE_NULL_RESULT)}case 1:{let c=r;return c===J.PARSER_ERROR?(t.processStack.pop(),J.PARSER_ERROR):(t.processStack.pop(),c)}}throw new N(`Invalid node next parse state "${e.state}".`,this)}processGraphParseProcess(t,e,r){let c=e.parameter.graph;switch(e.state){case 0:{if(t.graphIsCircular(c)){let v=t.getGraphPosition();return t.incidentTrace.push("Circular graph detected.",c,v.lineStart,v.columnStart,v.lineEnd,v.columnEnd),t.processStack.pop(),J.PARSER_ERROR}let m=e.parameter.linear;return t.pushGraphStack(c,m),e.state++,t.processStack.push({type:"node-parse",parameter:{node:c.node},state:0,values:{}}),g.NODE_NULL_RESULT}case 1:{let m=r;if(m===J.PARSER_ERROR)return t.popGraphStack(!0),t.processStack.pop(),J.PARSER_ERROR;let v=c.convert(m,t);if(typeof v=="symbol"){let b=t.getGraphPosition();return t.incidentTrace.push(v.description??"Unknown data convert error",b.graph,b.lineStart,b.columnStart,b.lineEnd,b.columnEnd),t.popGraphStack(!0),t.processStack.pop(),J.PARSER_ERROR}return t.popGraphStack(!1),t.processStack.pop(),v}}throw new N(`Invalid graph parse state "${e.state}".`,this)}processNodeParseProcess(t,e,r){let c=e.parameter.node;switch(e.state){case 0:return t.processStack.push({type:"node-value-parse",parameter:{node:c,valueIndex:0},state:0,values:{}}),e.state++,g.NODE_NULL_RESULT;case 1:{let m=r;return m===J.PARSER_ERROR?(t.processStack.pop(),J.PARSER_ERROR):(e.values.nodeValueResult=m,t.processStack.push({type:"node-next-parse",parameter:{node:c},state:0}),e.state++,g.NODE_NULL_RESULT)}case 2:{let m=r;if(m===J.PARSER_ERROR)return t.processStack.pop(),J.PARSER_ERROR;let v=c.mergeData(e.values.nodeValueResult,m);return t.processStack.pop(),v}}throw new N(`Invalid node parse state "${e.state}".`,this)}processNodeValueParseProcess(t,e,r){let c=e.parameter.node;switch(e.state){case 0:{if(r!==g.NODE_NULL_RESULT&&r!==J.PARSER_ERROR)return e.values.parseResult=r,e.state++,g.NODE_NULL_RESULT;let m=e.parameter.valueIndex,v=c.connections;if(m>=v.values.length)return e.values.parseResult=g.NODE_VALUE_LIST_END_MEET,e.state++,g.NODE_NULL_RESULT;e.parameter.valueIndex++;let b=t.currentToken,D=v.values[m];if(typeof D=="string"){if(!b){if(v.required){let C=t.getTokenPosition();t.incidentTrace.push(`Unexpected end of statement. Token "${D}" expected.`,t.currentGraph,C.lineStart,C.columnStart,C.lineEnd,C.columnEnd)}return g.NODE_NULL_RESULT}if(D!==b.type){if(v.required){let C=t.getTokenPosition();t.incidentTrace.push(`Unexpected token "${b.value}". "${D}" expected`,t.currentGraph,C.lineStart,C.columnStart,C.lineEnd,C.columnEnd)}return g.NODE_NULL_RESULT}return t.moveNextToken(),b.value}else{let C=v.values.length===1||v.values.length===m+1;return t.processStack.push({type:"graph-parse",parameter:{graph:D,linear:C},state:0}),g.NODE_NULL_RESULT}}case 1:{let m=e.values.parseResult,v=c.connections;if(m===g.NODE_VALUE_LIST_END_MEET&&!v.required){t.processStack.pop();return}return m===g.NODE_VALUE_LIST_END_MEET?(t.processStack.pop(),J.PARSER_ERROR):(t.processStack.pop(),m)}}throw new N(`Invalid node value parse state "${e.state}".`,this)}processStack(t,e,r){switch(e.type){case"graph-parse":return this.processGraphParseProcess(t,e,r);case"node-parse":return this.processNodeParseProcess(t,e,r);case"node-value-parse":return this.processNodeValueParseProcess(t,e,r);case"node-next-parse":return this.processChainedNodeParseProcess(t,e,r)}}};var tt=class g{static define(t,e=!1){return new g(t,e)}mDataConverterList;mGraphCollector;mIsJunction;mResolvedGraphNode;get isJunction(){return this.mIsJunction}get node(){return this.mResolvedGraphNode||(this.mResolvedGraphNode=this.mGraphCollector().root),this.mResolvedGraphNode}constructor(t,e){this.mGraphCollector=t,this.mDataConverterList=new Array,this.mResolvedGraphNode=null,this.mIsJunction=e}convert(t,e){if(this.mDataConverterList.length===0)return t;let r=e.getGraphBoundingToken(),c=r[0]??void 0,m=r[1]??void 0;if(this.mDataConverterList.length===1)return this.mDataConverterList[0](t,c,m);let v=t;for(let b of this.mDataConverterList)if(v=b(v,c,m),typeof v=="symbol")return v;return v}converter(t){let e=new g(this.mGraphCollector,this.isJunction);return e.mDataConverterList.push(...this.mDataConverterList,t),e}};var X=class g{static new(){let t=new g("",!1,[]);return t.mRootNode=null,t}mConnections;mIdentifier;mRootNode;get configuration(){return{dataKey:this.mIdentifier.dataKey,isList:this.mIdentifier.type==="list",isRequired:this.mConnections.required,isBranch:this.mConnections.values.length>1}}get connections(){return this.mConnections}get root(){if(!this.mRootNode)throw new N("Staring nodes must be chained with another node to be used.",this);return this.mRootNode}constructor(t,e,r,c){if(t==="")this.mIdentifier={type:"empty",dataKey:"",mergeKey:""};else if(t.endsWith("[]"))this.mIdentifier={type:"list",mergeKey:"",dataKey:t.substring(0,t.length-2)};else if(t.includes("<-")){let v=t.split("<-");this.mIdentifier={type:"merge",dataKey:v[0],mergeKey:v[1]}}else this.mIdentifier={type:"single",mergeKey:"",dataKey:t};let m=r.map(v=>v instanceof g?tt.define(()=>v):v);this.mConnections={required:e,values:m,next:null},c?this.mRootNode=c:this.mRootNode=this}mergeData(t,e){if(this.mIdentifier.type==="empty")return e;let r=e,c=typeof t>"u";if(this.mIdentifier.type==="single"){if(this.mIdentifier.dataKey in e)throw new N(`Graph path has a duplicate value identifier "${this.mIdentifier.dataKey}"`,this);return c||(r[this.mIdentifier.dataKey]=t),e}if(this.mIdentifier.type==="list"){let b;c?b=new Array:Array.isArray(t)?b=t:b=[t];let D=(()=>{if(this.mIdentifier.dataKey in e){let C=r[this.mIdentifier.dataKey];return Array.isArray(C)?(C.unshift(...b),C):(b.push(C),b)}return b})();return r[this.mIdentifier.dataKey]=D,e}if(c)return e;let m=(()=>{if(!this.mIdentifier.mergeKey)throw new N("Cant merge data without a merge key.",this);if(typeof t!="object"||t===null)throw new N("Node data must be an object when merge key is set.",this);if(!(this.mIdentifier.mergeKey in t))throw new N(`Node data does not contain merge key "${this.mIdentifier.mergeKey}"`,this);return t[this.mIdentifier.mergeKey]})();if(typeof m>"u")return e;let v=r[this.mIdentifier.dataKey];if(typeof v>"u")return r[this.mIdentifier.dataKey]=m,r;if(!Array.isArray(v))throw new N("Chain data merge value is not an array but should be.",this);return Array.isArray(m)?v.unshift(...m):v.unshift(m),e}optional(t,e){let r=typeof e>"u"?"":t,c=typeof e>"u"?t:e,m=new Array;Array.isArray(c)?m.push(...c):m.push(c);let v=new g(r,!1,m,this.mRootNode);return this.setChainedNode(v),v}required(t,e){let r=typeof e>"u"?"":t,c=typeof e>"u"?t:e,m=new Array;Array.isArray(c)?m.push(...c):m.push(c);let v=new g(r,!0,m,this.mRootNode);return this.setChainedNode(v),v}setChainedNode(t){if(this.mConnections.next!==null)throw new N("Node can only be chained to a single node.",this);this.mConnections.next=t}};var z={XmlIdentifier:"Identifier",XmlAssignment:"XmlAssignment",XmlValue:"XmlValue",XmlComment:"XmlComment",XmlOpenClosingBracket:"XmlOpenClosingBracket",XmlCloseBracket:"XmlCloseBracket",XmlOpenBracket:"XmlOpenBracket",XmlCloseClosingBracket:"XmlCloseClosingBracket",XmlExplicitValueIdentifier:"XmlExplicitValueIdentifier",ExpressionStart:"ExpressionStart",ExpressionEnd:"ExpressionEnd",ExpressionValue:"ExpressionValue",InstructionStart:"InstructionStart",InstructionInstructionValue:"InstructionInstructionValue",InstructionBodyStartBraket:"InstructionBodyStartBraket",InstructionBodyCloseBraket:"InstructionBodyCloseBraket",InstructionInstructionClosingBracket:"InstructionInstructionClosingBracket",InstructionInstructionOpeningBracket:"InstructionInstructionOpeningBracket"};var Xe=class extends xe{constructor(){super(),this.validWhitespaces=` 
\r`,this.trimWhitespace=!0;let t=this.createTokenPattern({pattern:{regex:/(?:(?!}}).)*/,type:z.ExpressionValue}}),e=this.createTokenPattern({pattern:{start:{regex:/{{/,type:z.ExpressionStart},end:{regex:/}}[ \n\r]?/,type:z.ExpressionEnd}}},s=>{s.useChildPattern(t)}),r=this.createTokenPattern({pattern:{regex:/[^>\s\n="/]+/,type:z.XmlIdentifier}}),c=this.createTokenPattern({pattern:{regex:/(?:(?!{{|"|<).)+/,type:z.XmlValue}}),m=this.createTokenPattern({pattern:{regex:/<!--.*?-->/,type:z.XmlComment}}),v=this.createTokenPattern({pattern:{regex:/=/,type:z.XmlAssignment}}),b=this.createTokenPattern({pattern:{start:{regex:/"/,type:z.XmlExplicitValueIdentifier},end:{regex:/"/,type:z.XmlExplicitValueIdentifier}}},s=>{s.useChildPattern(e),s.useChildPattern(c)}),D=this.createTokenPattern({pattern:{start:{regex:/<\//,type:z.XmlOpenClosingBracket},end:{regex:/>/,type:z.XmlCloseBracket}}},s=>{s.useChildPattern(r)}),C=this.createTokenPattern({pattern:{start:{regex:/</,type:z.XmlOpenBracket},end:{regex:/(?<closeClosingBracket>\/>)|(?<closeBracket>>)/,type:{closeClosingBracket:z.XmlCloseClosingBracket,closeBracket:z.XmlCloseBracket}}}},s=>{s.useChildPattern(v),s.useChildPattern(r),s.useChildPattern(b)}),a=this.createTokenPattern({pattern:{regex:/[^()"'`/)]+/,type:z.InstructionInstructionValue}}),n=this.createTokenPattern({pattern:{innerType:z.InstructionInstructionValue,start:{regex:/\//,type:z.InstructionInstructionValue},end:{regex:/\//,type:z.InstructionInstructionValue}}},s=>{s.useChildPattern(l),s.useChildPattern(o),s.useChildPattern(y),s.useChildPattern(u),s.useChildPattern(a)}),u=this.createTokenPattern({pattern:{innerType:z.InstructionInstructionValue,start:{regex:/\(/,type:z.InstructionInstructionValue},end:{regex:/\)/,type:z.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(l),s.useChildPattern(o),s.useChildPattern(y),s.useChildPattern(a)}),l=this.createTokenPattern({pattern:{innerType:z.InstructionInstructionValue,start:{regex:/"/,type:z.InstructionInstructionValue},end:{regex:/"/,type:z.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(o),s.useChildPattern(y),s.useChildPattern(u),s.useChildPattern(a)}),o=this.createTokenPattern({pattern:{innerType:z.InstructionInstructionValue,start:{regex:/'/,type:z.InstructionInstructionValue},end:{regex:/'/,type:z.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(l),s.useChildPattern(y),s.useChildPattern(u),s.useChildPattern(a)}),y=this.createTokenPattern({pattern:{innerType:z.InstructionInstructionValue,start:{regex:/`/,type:z.InstructionInstructionValue},end:{regex:/`/,type:z.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(l),s.useChildPattern(o),s.useChildPattern(u),s.useChildPattern(a)}),f=this.createTokenPattern({pattern:{regex:/\$[^(\s\n/{]+/,type:z.InstructionStart}}),T=this.createTokenPattern({pattern:{start:{regex:/\(/,type:z.InstructionInstructionOpeningBracket},end:{regex:/\)/,type:z.InstructionInstructionClosingBracket}}},s=>{s.useChildPattern(n),s.useChildPattern(l),s.useChildPattern(o),s.useChildPattern(y),s.useChildPattern(u),s.useChildPattern(a)}),w=this.createTokenPattern({pattern:{start:{regex:/{/,type:z.InstructionBodyStartBraket},end:{regex:/}/,type:z.InstructionBodyCloseBraket}}},s=>{for(let d of p)s.useChildPattern(d)}),p=[m,D,C,b,e,f,T,w,c];for(let s of p)this.useRootTokenPattern(s)}};var De=class extends Te{constructor(){super(new Xe),this.initGraph()}initGraph(){let t=tt.define(()=>X.new().required(z.ExpressionStart).optional("value",z.ExpressionValue).required("end",z.ExpressionEnd)).converter(o=>({expression:new At(o.value??""),hasTrailingWhitespace:o.end.length>2})),e=tt.define(()=>{let o=e;return X.new().required("data[]",X.new().required("value",[t,X.new().required("text",z.XmlValue)])).optional("data<-data",o)}),r=tt.define(()=>X.new().required("name",z.XmlIdentifier).optional("attributeValue",X.new().required(z.XmlAssignment).required(z.XmlExplicitValueIdentifier).optional("list<-data",e).required(z.XmlExplicitValueIdentifier))).converter(o=>{let y=new Array;if(o.attributeValue?.list)for(let f of o.attributeValue.list)"expression"in f.value?(y.push(f.value.expression),f.value.hasTrailingWhitespace&&y.push(" ")):y.push(f.value.text);return{name:o.name,values:y}}),c=tt.define(()=>{let o=c;return X.new().required("data[]",r).optional("data<-data",o)}),m=tt.define(()=>{let o=m;return X.new().required("data[]",X.new().required("value",[t,X.new().required("text",z.XmlValue),X.new().required(z.XmlExplicitValueIdentifier).required("text",z.XmlValue).required(z.XmlExplicitValueIdentifier)])).optional("data<-data",o)}),v=tt.define(()=>X.new().required("list<-data",m)).converter(o=>{let y=new Lt;for(let f of o.list)"expression"in f.value?(y.addValue(f.value.expression),f.value.hasTrailingWhitespace&&y.addValue(" ")):y.addValue(f.value.text);return y}),b=tt.define(()=>X.new().required(z.XmlComment)).converter(()=>null),D=tt.define(()=>X.new().required(z.XmlOpenBracket).required("openingTagName",z.XmlIdentifier).optional("attributes<-data",c).required("closing",[X.new().required(z.XmlCloseClosingBracket),X.new().required(z.XmlCloseBracket).required("values",u).required(z.XmlOpenClosingBracket).required("closingTageName",z.XmlIdentifier).required(z.XmlCloseBracket)])).converter(o=>{if("closingTageName"in o.closing&&o.openingTagName!==o.closing.closingTageName)throw new N(`Opening (${o.openingTagName}) and closing tagname (${o.closing.closingTageName}) does not match`,this);let y=new Rt(o.openingTagName);if(o.attributes)for(let f of o.attributes)y.setAttribute(f.name).addValue(...f.values);return"values"in o.closing&&y.appendChild(...o.closing.values),y}),C=tt.define(()=>{let o=C;return X.new().required("list[]",z.InstructionInstructionValue).optional("list<-list",o)}),a=tt.define(()=>X.new().required("instructionName",z.InstructionStart).optional("instruction",X.new().required(z.InstructionInstructionOpeningBracket).required("value<-list",C).required(z.InstructionInstructionClosingBracket)).optional("body",X.new().required(z.InstructionBodyStartBraket).required("value",u).required(z.InstructionBodyCloseBraket))).converter(o=>{let y=o.instructionName.substring(1),f=o.instruction?.value.join("")??"",T=new Zt(y,f);return o.body&&T.appendChild(...o.body.value),T}),n=tt.define(()=>{let o=n;return X.new().required("list[]",[b,D,a,v]).optional("list<-list",o)}),u=tt.define(()=>{let o=n;return X.new().optional("list<-list",o)}).converter(o=>{let y=new Array;if(o.list)for(let f of o.list)f!==null&&y.push(f);return y}),l=tt.define(()=>X.new().required("content",u)).converter(o=>{let y=new dt;return y.appendChild(...o.content),y});this.setRootGraph(l)}};var G=class g extends ze{static mTemplateCache=new rt;static mXmlParser=new De;mComponentElement;mIsUpdated;mRootBuilder;get element(){return this.mComponentElement.htmlElement}constructor(t){super({constructor:t.processorConstructor,parent:null}),Q.registerComponent(this,t.htmlElement),this.setProcessorInjection(g,this),this.addConstructionHook(c=>{Q.registerComponent(this,this.mComponentElement.htmlElement,c)}),g.mTemplateCache.has(t.processorConstructor)||g.mTemplateCache.set(t.processorConstructor,g.mXmlParser.parse(t.templateString??""));let e=g.mTemplateCache.get(t.processorConstructor).clone();this.mIsUpdated=!1,this.mComponentElement=new we(t.htmlElement),this.mRootBuilder=new ee(e,new Ge(this,t.expressionModule),new ft(this),"ROOT",null),this.mComponentElement.shadowRoot.appendChild(this.mRootBuilder.anchor),this.setProcessorInjection(Pt,new Pt(this.mRootBuilder.values));let r=this.updater.zone.getAttachment(Ct.ATTACHMENT_KEY);if(r)for(let[c,m]of r.injections)this.setProcessorInjection(c,m)}addStyle(t){let e=document.createElement("style");e.innerHTML=t,this.mComponentElement.shadowRoot.prepend(e)}attributeChanged(t,e,r){this.call("onAttributeChange",t,e,r)}connected(){this.mIsUpdated||this.updater.update(),this.call("onConnect")}deconstruct(){this.call("onDeconstruct"),this.mRootBuilder.deconstruct(),super.deconstruct()}disconnected(){this.call("onDisconnect")}onUpdate(){return this.mIsUpdated||(this.mIsUpdated=!0),this.mRootBuilder.update()?(this.call("onUpdate"),!0):!1}};function B(g){return(t,e)=>{O.registerInjectable(t,e.metadata,"instanced"),Q.registerConstructor(t,g.selector);let r=class extends HTMLElement{mComponent;constructor(){super(),this.mComponent=new G({processorConstructor:t,templateString:g.template??null,expressionModule:g.expressionmodule,htmlElement:this}).setup(),g.style&&this.mComponent.addStyle(g.style)}connectedCallback(){this.mComponent.connected()}disconnectedCallback(){this.mComponent.disconnected()}};globalThis.customElements.define(g.selector,r)}}function Jt(g){return(t,e)=>{O.registerInjectable(t,e.metadata,"instanced"),ht.register($t,t,{access:g.access,targetRestrictions:g.targetRestrictions})}}function It(g){return(t,e)=>{O.registerInjectable(t,e.metadata,"instanced"),ht.register(Et,t,{access:g.access,selector:g.selector})}}function Ot(g){return(t,e)=>{O.registerInjectable(t,e.metadata,"instanced"),ht.register(Xt,t,{instructionType:g.instructionType})}}function Ks(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function jo(g,t,e,r){return(jo=Ks())(g,t,e,r)}function Qs(g){return g}var Vo,zo,Ee;Vo=Jt({access:q.Read,targetRestrictions:[G]});new class extends Qs{constructor(){super(Ee),zo()}static{class g{static{({c:[Ee,zo]}=jo(this,[],[Vo]))}static METADATA_USER_EVENT_LISTENER_PROPERIES="pwb:user_event_listener_properties";mEventListenerList;mTargetElement;constructor(e=O.use(G)){let r=new Array,c=e.processorConstructor;do{let m=lt.get(c).getMetadata(g.METADATA_USER_EVENT_LISTENER_PROPERIES);if(m)for(let v of m)r.push(v)}while(c=Object.getPrototypeOf(c));this.mEventListenerList=new Array,this.mTargetElement=e.element;for(let m of r){let[v,b]=m,D=Reflect.get(e.processor,v);D=D.bind(e.processor),this.mEventListenerList.push([b,D]),this.mTargetElement.addEventListener(b,D)}}onDeconstruct(){for(let e of this.mEventListenerList){let[r,c]=e;this.mTargetElement.removeEventListener(r,c)}}}}};var Ie=class extends window.Event{mValue;get value(){return this.mValue}constructor(t,e){super(t),this.mValue=e}};var Ce=class{mElement;mEventName;constructor(t,e){this.mEventName=t,this.mElement=e}dispatchEvent(t){let e=new Ie(this.mEventName,t);this.mElement.dispatchEvent(e)}};function vt(g){return(t,e)=>{if(e.static)throw new N("Event target is not for a static property.",vt);let r=new WeakMap;return{get(){if(!r.has(this)){let c=(()=>{try{return Q.ofProcessor(this).component}catch{throw new N("PwbComponentEvent target class is not a component.",this)}})();r.set(this,new Ce(g,c.element))}return r.get(this)}}}}function ks(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function Go(g,t,e,r){return(Go=ks())(g,t,e,r)}function ta(g){return g}var Bo,$o,Pe;Bo=Jt({access:q.ReadWrite,targetRestrictions:[G]});new class extends ta{constructor(){super(Pe),$o()}static{class g{static{({c:[Pe,$o]}=Go(this,[],[Bo]))}static METADATA_EXPORTED_PROPERTIES="pwb:exported_properties";mComponent;constructor(e=O.use(G)){this.mComponent=e;let r=new Yt,c=e.processorConstructor;do{let v=lt.get(c).getMetadata(g.METADATA_EXPORTED_PROPERTIES);v&&r.push(...v)}while(c=Object.getPrototypeOf(c));let m=new Set(r);m.size>0&&this.connectExportedProperties(m)}connectExportedProperties(e){this.exportPropertyAsAttribute(e),this.patchHtmlAttributes(e)}exportPropertyAsAttribute(e){for(let r of e){let c={};c.enumerable=!0,c.configurable=!0,delete c.value,delete c.writable,c.set=m=>{Reflect.set(this.mComponent.processor,r,m)},c.get=()=>{let m=Reflect.get(this.mComponent.processor,r);return typeof m=="function"&&(m=m.bind(this.mComponent.processor)),m},Object.defineProperty(this.mComponent.element,r,c)}}patchHtmlAttributes(e){let r=this.mComponent.element,c=r.getAttribute,m=r.setAttribute,v=(C,a,n)=>(Reflect.set(r,C,n),this.mComponent.attributeChanged(C,a,n),!0),b=new Map;new MutationObserver(C=>{for(let a of C){let n=a.attributeName,u=c.call(r,n);b.get(n)!==u&&v(n,a.oldValue,u)}}).observe(r,{attributeFilter:[...e],attributeOldValue:!0});for(let C of e)if(r.hasAttribute(C)){let a=c.call(r,C);v(C,a,a)}r.setAttribute=(C,a)=>{let n=c.call(r,C);m.call(r,C,a),e.has(C)&&(b.set(C,a.toString()),m.call(r,C,a),v(C,n,a))},r.getAttribute=C=>e.has(C)?Reflect.get(r,C):c.call(r,C)}}}};function W(g,t){if(t.static)throw new N("Event target is not for a static property.",W);let e=lt.forInternalDecorator(t.metadata),r=e.getMetadata(Pe.METADATA_EXPORTED_PROPERTIES)??new Array;r.push(t.name),e.setMetadata(Pe.METADATA_EXPORTED_PROPERTIES,r)}function yt(g){return(t,e)=>{if(e.static)throw new N("Child decorator is not for a static property.",yt);return{get(){let m=(()=>{try{return Q.ofProcessor(this).component}catch{throw new N("PwbChild target class is not a component.",this)}})().getProcessorInjection(Pt).data.store[g];return m instanceof Element?m:null}}}}function ea(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function Ho(g,t,e,r){return(Ho=ea())(g,t,e,r)}var Yo,Uo,oa;Yo=Ot({instructionType:"dynamic-content"});var Xo=class{static{({c:[oa,Uo]}=Ho(this,[],[Yo]))}constructor(t=O.use(ot),e=O.use(Y)){this.mModuleValues=e,this.mLastTemplate=null,this.mProcedure=this.mModuleValues.createExpressionProcedure(t.value)}mLastTemplate;mModuleValues;mProcedure;onUpdate(){let t=this.mProcedure.execute();if(!t||!(t instanceof dt))throw new N("Dynamic content method has a wrong result type.",this);if(this.mLastTemplate!==null&&this.mLastTemplate.equals(t))return null;let e=t.clone();this.mLastTemplate=e;let r=new mt;return r.addElement(e,new ft(this.mModuleValues.data),null),r}static{Uo()}};function ra(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function qo(g,t,e,r){return(qo=ra())(g,t,e,r)}var Jo,Wo,na;Jo=It({access:q.Write,selector:/^\([[\w\-$]+\)$/});var Zo=class{static{({c:[na,Wo]}=qo(this,[],[Jo]))}constructor(t=O.use(k),e=O.use(Y),r=O.use(it)){this.mTarget=t,this.mEventName=r.name.substring(1,r.name.length-1);let c=e.createExpressionProcedure(r.value,["$event"]);this.mListener=m=>{c.setTemporaryValue("$event",m),c.execute()},this.mTarget.addEventListener(this.mEventName,this.mListener)}mEventName;mListener;mTarget;onDeconstruct(){this.mTarget.removeEventListener(this.mEventName,this.mListener)}static{Wo()}};function ia(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function ko(g,t,e,r){return(ko=ia())(g,t,e,r)}function sa(g){return g}var tr,Ko,Qo;tr=Ot({instructionType:"for"});new class extends sa{constructor(){super(Qo),Ko()}static{class g{static{({c:[Qo,Ko]}=ko(this,[],[tr]))}static REGEX_HEAD=new RegExp(/^\s*([a-zA-Z]+[a-zA-Z0-9]*)\s*of\s+([^;]+)\s*(?:;(.*))?$/);static REGEX_MODIFIER_INSTRUCTION=new RegExp(/^\s*(\$?[a-zA-Z]+[a-zA-Z0-9]*)\s*=\s*(.+?)\s*$/);mExpression;mLastEntries;mModuleValues;mTemplate;constructor(e=O.use(gt),r=O.use(Y),c=O.use(ot)){this.mTemplate=e,this.mModuleValues=r,this.mLastEntries=new Array;let m=c.value,v=g.REGEX_HEAD.exec(m);if(!v)throw new N(`For-Parameter value has wrong format: ${m}`,this);let b=v[1],D=v[2],C=v[3]?v[3].split(";"):new Array,a=new Array;for(let n of C){let u=g.REGEX_MODIFIER_INSTRUCTION.exec(n);if(!u)throw new N(`For-Parameter optional instruction has wrong format: ${n}`,this);a.push({variableName:u[1],procedure:this.mModuleValues.createExpressionProcedure(u[2],["$index",b])})}this.mExpression={iterateVariableName:b,iterateValueProcedure:this.mModuleValues.createExpressionProcedure(D),modifier:a}}onUpdate(){let e=new mt,r=this.mExpression.iterateValueProcedure.execute();if(typeof r=="object"&&r!==null||Array.isArray(r)){let c=Symbol.iterator in r?Object.entries([...r]):Object.entries(r);if(this.compareEntries(c,this.mLastEntries))return null;this.mLastEntries=c;for(let[m,v]of c)this.addTemplateForElement(e,this.mExpression,v,m);return e}else return null}addTemplateForElement=(e,r,c,m)=>{let v=new ft(this.mModuleValues.data);v.setTemporaryValue(r.iterateVariableName,c);let b=c;for(let C of r.modifier){C.procedure.setTemporaryValue("$index",m),C.procedure.setTemporaryValue(r.iterateVariableName,c);let a=C.procedure.execute();if(C.variableName==="$key"){b=a;continue}v.setTemporaryValue(C.variableName,a)}let D=new dt;D.appendChild(...this.mTemplate.childList),e.addElement(D,v,b)};compareEntries(e,r){if(e.length!==r.length)return!1;for(let c=0;c<e.length;c++){let[m,v]=e[c],[b,D]=r[c];if(m!==b||v!==D)return!1}return!0}}}};function aa(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function rr(g,t,e,r){return(rr=aa())(g,t,e,r)}var nr,er,la;nr=Ot({instructionType:"if"});var or=class{static{({c:[la,er]}=rr(this,[],[nr]))}constructor(t=O.use(gt),e=O.use(Y),r=O.use(ot)){this.mTemplateReference=t,this.mModuleValues=e,this.mProcedure=this.mModuleValues.createExpressionProcedure(r.value),this.mLastBoolean=!1}mLastBoolean;mModuleValues;mProcedure;mTemplateReference;onUpdate(){let t=this.mProcedure.execute();if(!!t!==this.mLastBoolean){this.mLastBoolean=!!t;let e=new mt;if(t){let r=new dt;r.appendChild(...this.mTemplateReference.childList),e.addElement(r,new ft(this.mModuleValues.data),null)}return e}else return null}static{er()}};function ca(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function ar(g,t,e,r){return(ar=ca())(g,t,e,r)}var lr,ir,ua;lr=It({access:q.Read,selector:/^\[[\w$]+\]$/});var sr=class{static{({c:[ua,ir]}=ar(this,[],[lr]))}constructor(t=O.use(k),e=O.use(Y),r=O.use(it)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(r.value),this.mTargetProperty=r.name.substring(1,r.name.length-1),this.mLastValue=Symbol("Uncomparable")}mLastValue;mProcedure;mTarget;mTargetProperty;onUpdate(){let t=this.mProcedure.execute();return t===this.mLastValue?!1:(this.mLastValue=t,Reflect.set(this.mTarget,this.mTargetProperty,t),!0)}static{ir()}};function ha(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function hr(g,t,e,r){return(hr=ha())(g,t,e,r)}var dr,cr,da;dr=It({access:q.Write,selector:/^#[[\w$]+$/});var ur=class{static{({c:[da,cr]}=hr(this,[],[dr]))}constructor(t=O.use(k),e=O.use(it),r=O.use(Pt)){this.mChildName=e.name.substring(1),this.mComponentScopeValue=r,this.mTargetNode=t,this.mComponentScopeValue.setTemporaryValue(this.mChildName,this.mTargetNode)}mChildName;mComponentScopeValue;mTargetNode;onDeconstruct(){this.mComponentScopeValue.data.store[this.mChildName]===this.mTargetNode&&this.mComponentScopeValue.data.deleteTemporaryValue(this.mChildName)}static{cr()}};function ma(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function fr(g,t,e,r){return(fr=ma())(g,t,e,r)}var gr,mr,pa;gr=Ot({instructionType:"slot"});var pr=class{static{({c:[pa,mr]}=fr(this,[],[gr]))}constructor(t=O.use(Y),e=O.use(ot)){this.mModuleValues=t,this.mSlotName=e.value,this.mIsSetup=!1}mIsSetup;mModuleValues;mSlotName;onUpdate(){if(this.mIsSetup)return null;this.mIsSetup=!0;let t=new Rt("slot");this.mSlotName!==""&&t.setAttribute("name").addValue(this.mSlotName);let e=new dt;e.appendChild(t);let r=new mt;return r.addElement(e,this.mModuleValues.data,null),r}static{mr()}};function fa(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function br(g,t,e,r){return(br=fa())(g,t,e,r)}var wr,vr,ga;wr=It({access:q.ReadWrite,selector:/^\[\([[\w$]+\)\]$/});var yr=class{static{({c:[ga,vr]}=br(this,[],[wr]))}constructor(t=O.use(G),e=O.use(k),r=O.use(Y),c=O.use(it)){this.mTargetNode=e,this.mAttributeKey=c.name.substring(2,c.name.length-2),this.mReadProcedure=r.createExpressionProcedure(c.value),this.mWriteProcedure=r.createExpressionProcedure(`${c.value} = $DATA;`,["$DATA"]),this.mLastDataValue=Symbol("Uncomparable");let m=v=>{this.mLastDataValue!==v&&t.updater.updateAsync()};this.mTargetNode.addEventListener("input",v=>{m(Reflect.get(this.mTargetNode,this.mAttributeKey))}),this.mTargetNode.addEventListener("change",v=>{m(Reflect.get(this.mTargetNode,this.mAttributeKey))})}mAttributeKey;mLastDataValue;mReadProcedure;mTargetNode;mWriteProcedure;onUpdate(){let t=this.mReadProcedure.execute();if(t!==this.mLastDataValue)return Reflect.set(this.mTargetNode,this.mAttributeKey,t),this.mLastDataValue=t,!0;let e=Reflect.get(this.mTargetNode,this.mAttributeKey);return e!==t?(this.mWriteProcedure.setTemporaryValue("$DATA",e),this.mWriteProcedure.execute(),this.mLastDataValue=e,!0):!1}static{vr()}};function va(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function Dr(g,t,e,r){return(Dr=va())(g,t,e,r)}var Er,xr,ya;Er=Jt({access:q.Read,targetRestrictions:[Et]});var Tr=class{static{({c:[ya,xr]}=Dr(this,[],[Er]))}constructor(t=O.use(Et),e=O.use(k)){let r=new Array,c=t.processorConstructor;do{let m=lt.get(c).getMetadata(Ee.METADATA_USER_EVENT_LISTENER_PROPERIES);if(m)for(let v of m)r.push(v)}while(c=Object.getPrototypeOf(c));this.mEventListenerList=new Array,this.mTargetElement=e;for(let m of r){let[v,b]=m,D=Reflect.get(t.processor,v);D=D.bind(t.processor),this.mEventListenerList.push([b,D]),this.mTargetElement.addEventListener(b,D)}}mEventListenerList;mTargetElement;onDeconstruct(){for(let t of this.mEventListenerList){let[e,r]=t;this.mTargetElement.removeEventListener(e,r)}}static{xr()}};var Ir=`:host {\r
    display: block;\r
    width: 100%;\r
    height: 100%;\r
}\r
...
potatno-code-editor {\r
    ...
    width: 100%;\r
    height: 100%;\r
}`;var ne=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new jt(this.mProject),r=[];for(let c of t.functions){let m=this.deserializeFunctionHead(c,e);r.push([m,c]),e.addFunction(m)}for(let[c,m]of r)this.deserializeFunctionBody(c,m,e);return e}deserializeFunctionBody(t,e,r){let c=new Map;for(let m of e.nodes)c.set(m.id,this.deserializeNode(m,t,r));for(let m of e.connections){if(!c.has(m.sourceNodeId)||!c.has(m.targetNodeId))continue;let v=c.get(m.sourceNodeId),b=c.get(m.targetNodeId),D=v.outputs.map.get(m.sourcePortId),C=b.inputs.map.get(m.targetPortId);!D||!C||D.connect(C)}}deserializeFunctionHead(t,e){let r=new at(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let c of t.imports)r.addImport(c);for(let c of t.inputs)r.addInput({label:c.label,dataType:c.dataType});for(let c of t.outputs)r.addOutput({label:c.label,dataType:c.dataType});return r}deserializeNode(t,e,r){let c=r.nodeDefinitions.find(v=>v.id===t.definitionId),m=(()=>{if(c)return e.addNodeByDefinition(c,t.transformation);let v=t.ports.filter(D=>D.direction==="input").map(D=>({dataType:D.dataType,definitionId:D.definitionId,label:D.label,portType:D.portType})),b=t.ports.filter(D=>D.direction==="output").map(D=>({dataType:D.dataType,definitionId:D.definitionId,label:D.label,portType:D.portType}));return new pt(this.mProject,r,e,{definitionId:t.definitionId,ports:{input:v,output:b},label:t.label,transformation:{...t.transformation}})})();m.label=t.label,e.addNode(m);for(let v of t.ports)if(v.portType==="value"&&v.directValue.length>0){let b=m.inputs.map.get(v.definitionId);b&&b.setDirectValue(v.directValue)}return m.preview=t.preview??null,m}};var ie=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((b,D)=>{e.set(b,`n${D}`)});let r=[...t.nodes].map(b=>this.serializeNode(b,e.get(b))),c=[];for(let b of t.nodes){let D=e.get(b);for(let C of b.outputs.list)for(let a of C.connectedPorts){let n=e.get(a.node);c.push({sourceNodeId:D,sourcePortId:C.definitionId,targetNodeId:n,targetPortId:a.definitionId})}}let m=t.inputs.map(b=>({label:b.label,dataType:b.dataType})),v=t.outputs.map(b=>({label:b.label,dataType:b.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:m,outputs:v,imports:[...t.imports],nodes:r,connections:c}}serializeNode(t,e){let r=[...t.inputs.list,...t.outputs.list].map(m=>({definitionId:m.definitionId,label:m.label,direction:m.direction,portType:m.portType,dataType:m.portType==="value"?m.dataType:null,directValue:[...m.directValue]})),c=t.preview?{portDefinitionId:t.preview.portDefinitionId,displayId:t.preview.displayId}:null;return{id:e,definitionId:t.definitionId,label:t.label,transformation:{...t.transformation},ports:r,preview:c}}};var Cr=`:host {\r
    /* Globals */\r
...
`;function Da(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function Rr(g,t,e,r){return(Rr=Da())(g,t,e,r)}var Or,Sr,Fr,zr,_r,Nr,Ar,Ht;Or=B({selector:"kg-button",template:Mr,style:Pr}),Fr=$.state(),zr=$.state();var Lr=class{static{({e:[_r,Nr,Ar],c:[Ht,Sr]}=Rr(this,[[Fr,1,"mSelected"],[zr,1,"mType"],[W,3,"selected"],[W,3,"type"]],[Or]))}constructor(){this.mType="primary",this.mSelected=!1}#t=(Ar(this),_r(this));get mSelected(){return this.#t}set mSelected(t){this.#t=t}#e=Nr(this);get mType(){return this.#e}set mType(t){this.#e=t}get selected(){return this.mSelected}set selected(t){this.mSelected=this.parseBoolean(t)}get type(){return this.mType}set type(t){if(t!=="primary"&&t!=="secondary"){this.mType="secondary";return}this.mType=t}parseBoolean(t){if(typeof t=="string"){let e=t.toLowerCase();if(e==="true"||e==="false")return e==="true"}return!!t}static{Sr()}};var jr=`:host {\r
...
`;function Ca(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function Br(g,t,e,r){return(Br=Ca())(g,t,e,r)}var Ur,$r,Xr;Ur=B({selector:"kg-information",template:Vr,style:jr});var Gr=class{static{({c:[Xr,$r]}=Br(this,[],[Ur]))}static{$r()}};var Hr=`:host {\r
...
}`;var Yr="$slot";function Sa(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function qr(g,t,e,r){return(qr=Sa())(g,t,e,r)}var Jr,Wr,se;Jr=B({selector:"kg-popup",template:Yr,style:Hr});var Zr=class{static{({c:[se,Wr]}=qr(this,[],[Jr]))}static{Wr()}};var Kr=`:host {\r
...
}`;var dn=`<kg-resize-box class="resize-box" right="true">\r
...
`;function Oa(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function yn(g,t,e,r){return(yn=Oa())(g,t,e,r)}var bn,mn,wn,xn,pn,fn,gn,xo;bn=B({selector:"potatno-function-list",template:dn,style:hn,components:[Mt,se,Ht]}),wn=$.state({complexValue:!0}),xn=$.state();var vn=class{static{({e:[pn,fn,gn],c:[xo,mn]}=yn(this,[[wn,1,"documentFunctions"],[xn,1,"showPopup"]],[bn]))}constructor(t=O.use(H)){this.mManager=t,this.documentFunctions=new Array,this.showPopup=!1,this.mUnsubscribe=this.mManager.subscribe(R.Document|R.Function|R.SpecialActiveFunction,()=>{this.documentFunctions=this.mManager.graph.document.functions.map(e=>({id:e.id,label:e.label,isSystem:e.isSystem,function:e}))})}mManager;mUnsubscribe;#t=(gn(this),pn(this));get documentFunctions(){return this.#t}set documentFunctions(t){this.#t=t}#e=fn(this);get showPopup(){return this.#e}set showPopup(t){this.#e=t}get activeFunctionId(){return this.mManager.activeFunction.id}get userFunctionDefinitions(){return[...this.mManager.project.userFunctions.values()]}createFunction(t){this.showPopup=!1,this.mManager.graph.addFunction(t.id)}deleteFunction(t){this.mManager.graph.removeFunction(t.id)}onDeconstruct(){this.mUnsubscribe()}selectFunction(t){this.mManager.setActiveFunction(t.function)}static{mn()}};var Tn=`:host {\r
    position: absolute;\r
    z-index: 200;\r
\r
...
`;function ja(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function Nn(g,t,e,r){return(Nn=ja())(g,t,e,r)}function Va(g){return g}var An,En,Ln,Rn,On,Fn,zn,In,Cn,Pn,Mn,Sn,_n,ae;An=B({selector:"potatno-node-selection-popup",template:Dn,style:Tn,components:[se]}),Ln=$.state({complexValue:!0}),Rn=yt("searchInput"),On=vt("node-select"),Fn=$.state(),zn=$.state();new class extends Va{constructor(){super(ae),En()}static{class g{static{({e:[In,Cn,Pn,Mn,Sn,_n],c:[ae,En]}=Nn(this,[[Ln,1,"results"],[Rn,1,"searchInput"],[On,1,"mNodeSelect"],[Fn,1,"searchValue"],[zn,1,"selectedDefinitionId"]],[An]))}static POPUP_HEIGHT=320;static POPUP_WIDTH=280;mAvailableEntries;mComponent;mManager;#t=(_n(this),In(this));get results(){return this.#t}set results(e){this.#t=e}#e=Cn(this);get searchInput(){return this.#e}set searchInput(e){this.#e=e}#o=Pn(this);get mNodeSelect(){return this.#o}set mNodeSelect(e){this.#o=e}#r=Mn(this);get searchValue(){return this.#r}set searchValue(e){this.#r=e}#n=Sn(this);get selectedDefinitionId(){return this.#n}set selectedDefinitionId(e){this.#n=e}constructor(e=O.use(G),r=O.use(H)){this.mManager=r,this.mComponent=e,this.mAvailableEntries=this.fetchNodeEntries(),this.selectedDefinitionId=null,this.results=new Array,this.searchValue=""}onConnect(){this.searchInput?.focus()}onKeyDown(e){if(this.results.length!==0){if(e.key==="ArrowDown"||e.key==="ArrowUp"){e.preventDefault();let r=this.results.findIndex(v=>v.definition.id===this.selectedDefinitionId);r=Math.max(0,r);let c=e.key==="ArrowDown"?1:-1,m=(r+c+this.results.length)%this.results.length;this.selectedDefinitionId=this.results[m].definition.id;return}e.key==="Enter"&&this.sendSelectedEntry(this.selectedDefinitionId)}}onUpdate(){this.results=this.filterResults(),this.results.some(r=>r.definition.id===this.selectedDefinitionId)||(this.selectedDefinitionId=this.results[0]?.definition.id??null);let e=this.mComponent.element.shadowRoot.querySelector(".selection-popup__result.selected");e&&e.scrollIntoView()}stopPropagation(e,r){e.stopPropagation(),r&&e.preventDefault()}fetchNodeEntries(){return this.mManager.activeFunction.dynamicNodeDefinitions.map(e=>({category:e.category.name,definition:e,label:e.label.toLowerCase(),color:this.mManager.generateStringColor(e.category.name),icon:e.category.icon}))}filterResults(){let e=this.searchValue.trim().toLowerCase();return this.mAvailableEntries.filter(r=>r.label.includes(e))}sendSelectedEntry(e){if(e===null)return;let r=this.results.find(c=>c.definition.id===e);r&&this.mNodeSelect.dispatchEvent(r.definition)}}}};var jn=`:host {\r
...
}`;var fi=`<div class="node" style="--type-color: {{this.portColor}}" (dragover)="this.onDragOver($event)" (drop)="this.onDrop($event)">\r
\r
...
`;function Ka(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function Li(g,t,e,r){return(Li=Ka())(g,t,e,r)}var Ri,Si,Oi,_i,Ni,Co;Ri=B({selector:"potatno-connection-layer",template:Mi,style:Pi}),Oi=$.state({complexValue:!0});var Ai=class{static{({e:[_i,Ni],c:[Co,Si]}=Li(this,[[Oi,1,"connections"]],[Ri]))}constructor(t=O.use(H)){this.mManager=t,this.connections=new Map;let e=0;this.mUnsubscribe=this.mManager.subscribe(R.SpecialActiveFunction|R.Node|R.Connection,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.updateConnections()}))})}mManager;mUnsubscribe;#t=(Ni(this),_i(this));get connections(){return this.#t}set connections(t){this.#t=t}createConjunction(t,e){t.preventDefault(),t.stopPropagation();let r=e.port.output.portType==="flow"?this.mManager.project.nodeDefinitions.get(K.DEFINITION_ID):this.mManager.project.nodeDefinitions.get(et.DEFINITION_ID),c=this.mManager.grid.pixelToGridSpace(t.clientX,t.clientY),m=this.mManager.graph.addNode(this.mManager.activeFunction,r,{x:c.x,y:c.y,height:0,width:0});this.mManager.graph.disconnectPorts(e.port.output,e.port.input);let v=m.inputs.list[0],b=m.outputs.list[0];this.mManager.graph.connectPorts(v,e.port.output),this.mManager.graph.connectPorts(v,e.port.input),this.mManager.graph.connectPorts(b,e.port.output),this.mManager.graph.connectPorts(b,e.port.input)}deleteConnection(t,e){t.button===2&&(t.preventDefault(),t.stopPropagation(),this.mManager.graph.disconnectPorts(e.port.output,e.port.input))}onDeconstruct(){this.mUnsubscribe()}createConnection(t,e,r){let c=this.mManager.integrity.errorItems,m=c.has(e)||c.has(r),v=(()=>{switch(r.portType){case"value":return r;case"flow":return e}})(),b=e.portType==="flow"?"":this.mManager.generateStringColor(e.resolvedDataType),D=this.mManager.connections.getConnectionPath(e,r);return{color:b,path:{attributeValue:D.attributeValue,length:D.length},state:{isNew:!t.has(v),hasError:m},port:{primary:v,output:e,input:r}}}updateConnections(){let t=this.connections;this.connections=new Map;for(let e of this.mManager.activeFunction.nodes)for(let r of e.outputs.list)for(let c of r.connectedPorts){let m=this.createConnection(t,r,c);this.connections.set(m.port.primary,m)}}static{Si()}};function Qa(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function ji(g,t,e,r){return(ji=Qa())(g,t,e,r)}var Vi,Fi,_e;Vi=It({access:q.Read,selector:/^potatno-preview$/});var zi=class{static{({c:[_e,Fi]}=ji(this,[],[Vi]))}constructor(t=O.use(k),e=O.use(Y),r=O.use(it)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(r.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let r=this.mTarget.childNodes.length>0;return r&&(this.mTarget.innerHTML=""),r}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{Fi()}};var $i=`:host {\r
    --node-border-radius: 2px;\r
    --node-border-color: color-mix(in srgb, var(--potatno-color-text) 30%, var(--potatno-color-background));\r
...
`;function nl(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function cs(g,t,e,r){return(cs=nl())(g,t,e,r)}function il(g){return g}var us,is,hs,ds,ss,as,ls,eo;us=B({selector:"potatno-node-graph",template:ns,style:rs,components:[ae,Mo,Do,Io,Co]}),hs=$.state(),ds=$.state({complexValue:!0});new class extends il{constructor(){super(eo),is()}static{class g{static{({e:[ss,as,ls],c:[eo,is]}=cs(this,[[hs,1,"popup"],[ds,1,"selectBox"]],[us]))}static ZOOM_STRENGTH=.1;mComponent;mIsMouseInsideGrid;mKeyboardHandler;mManager;mUnsubscribeFunctionChange;mUnsubscribeGraphChange;#t=(ls(this),ss(this));get popup(){return this.#t}set popup(e){this.#t=e}#e=as(this);get selectBox(){return this.#e}set selectBox(e){this.#e=e}get gridBackgroundStyle(){let e=this.mManager.grid.gridSize*this.mManager.grid.zoom,r=this.mManager.grid.panX%e,c=this.mManager.grid.panY%e;return`--grid-size: ${e}px; --grid-position-x: ${r}px; --grid-position-y: ${c}px;`}get gridTransformStyle(){return`transform: translate(${this.mManager.grid.panX}px, ${this.mManager.grid.panY}px) scale(${this.mManager.grid.zoom})`}get nodes(){return this.mManager.activeFunction.nodes}get selectedNodes(){return this.mManager.grid.selectedNodes}constructor(e=O.use(G),r=O.use(H)){this.mComponent=e,this.mManager=r,this.mIsMouseInsideGrid=!1,this.popup=null,this.selectBox=null,this.mManager.grid.gridElement=this.mComponent.element,e.element.addEventListener("pointerdown",c=>{this.onPointerDown(c)}),e.element.addEventListener("wheel",c=>{this.onScroll(c)}),e.element.addEventListener("contextmenu",c=>{c.preventDefault()}),e.element.addEventListener("pointerenter",()=>{this.mIsMouseInsideGrid=!0}),e.element.addEventListener("pointerleave",()=>{this.mIsMouseInsideGrid=!1}),e.element.addEventListener("dragover",c=>{this.mManager.grid.draggedPort.isDragging&&(c.preventDefault(),c.stopPropagation(),c.dataTransfer&&(c.dataTransfer.dropEffect="link"))}),e.element.addEventListener("drop",c=>{this.createDroppedConjunction(c)}),this.mKeyboardHandler=c=>{this.onKeyDown(c)},document.addEventListener("keydown",this.mKeyboardHandler),this.mUnsubscribeFunctionChange=this.mManager.subscribe(R.Document|R.Function|R.SpecialActiveFunction,()=>{this.popup=null,this.selectBox=null}),this.mUnsubscribeGraphChange=this.mManager.subscribe(R.NodeAdd|R.NodeDelete|R.SpecialGrid|R.SpecialSelectNode,()=>{this.mComponent.updater.updateAsync()})}createNode(e){let r=this.mManager.graph.addNode(this.mManager.activeFunction,e,{x:this.popup?.position.grid.x??0,y:this.popup?.position.grid.y??0,height:0,width:0});this.popup=null,this.selectNodes([r],!1)}moveAllSelected(e,r){for(let c of this.mManager.grid.selectedNodes)c!==e&&this.mManager.graph.transformNode(c,m=>{m.moveTo(m.transformation.x+r.x,m.transformation.y+r.y)})}onDeconstruct(){this.mUnsubscribeFunctionChange(),this.mUnsubscribeGraphChange(),document.removeEventListener("keydown",this.mKeyboardHandler)}selectNodes(e,r){let c=!!r;r instanceof PointerEvent&&(r.stopPropagation(),c=r.ctrlKey);let m=new Set,v=new Set(this.mManager.grid.selectedNodes);if(!c)if(e.length===1&&v.has(e.at(0)))for(let D of v)m.add(D);else v.clear();let b=[...e];for(let D of b)m.has(D)||(m.add(D),D.definitionId===xt.DEFINITION_ID&&b.push(...this.getNodesInRectangle({top:D.transformation.y,right:D.transformation.x+D.transformation.width,bottom:D.transformation.y+D.transformation.height,left:D.transformation.x})),v.has(D)?v.delete(D):v.add(D));this.mManager.grid.selectNodes([...v])}typeOfNode(e){switch(e.definitionId){case xt.DEFINITION_ID:return"comment";case et.DEFINITION_ID:case K.DEFINITION_ID:return"conjunction";default:return"node"}}convertGlobalToGridLocalPosition(e,r){let c=this.mComponent.element.getBoundingClientRect();return{x:e-c.left,y:r-c.top}}createDroppedConjunction(e){if(!this.mManager.grid.draggedPort.isDragging)return;e.preventDefault(),e.stopPropagation();let r=this.mManager.grid.pixelToGridSpace(e.clientX,e.clientY),c=this.mManager.graph.priorizePorts(r,this.mManager.grid.draggedPort.ports);this.openPopupAtPosition(e.clientX,e.clientY,c[0])}getNodesInRectangle(e){let r=new Array;for(let c of this.mManager.activeFunction.nodes){let m=c.transformation.y,v=c.transformation.x,b=v+c.transformation.width,D=m+c.transformation.height;if(v<e.right&&b>e.left&&m<e.bottom&&D>e.top){if(e.top>m&&e.right<b&&e.bottom<D&&e.left>v)continue;r.push(c)}}return r}onKeyDown(e){if(!this.mIsMouseInsideGrid)return;let r=document.activeElement;if(!(r instanceof HTMLInputElement||r instanceof HTMLTextAreaElement||r instanceof HTMLSelectElement)){switch(e.key){case"Escape":{this.popup=null;return}case"Delete":{for(let c of this.mManager.grid.selectedNodes)this.mManager.graph.removeNode(c);this.selectNodes([],!1);return}}if(e.ctrlKey)switch(e.key){case"z":{e.preventDefault(),this.mManager.history.undo();return}case"y":{e.preventDefault(),this.mManager.history.redo();return}case"c":{this.mManager.clipboard.copy(this.mManager.grid.selectedNodes);return}case"v":e.preventDefault(),this.pasteFromClipboard()}}}onPointerDown(e){switch(e.button){case 0:{e.ctrlKey||this.selectNodes([],!1),this.pointerDrag(e,"selecting");return}case 1:{e.preventDefault(),this.pointerDrag(e,"panning");return}case 2:{this.openPopupAtPosition(e.clientX,e.clientY,null);return}}}onScroll(e){e.preventDefault();let r=e.deltaY>0?-1:1,c=this.convertGlobalToGridLocalPosition(e.clientX,e.clientY);this.mManager.grid.zoomAt(c.x,c.y,r*g.ZOOM_STRENGTH)}openPopupAtPosition(e,r,c){let m=this.mComponent.element,v=this.convertGlobalToGridLocalPosition(e,r),b=this.mManager.grid.pixelToGridSpace(e,r),D=8,C=Math.max(0,m.clientWidth-ae.POPUP_WIDTH-D),a=Math.max(0,m.clientHeight-ae.POPUP_HEIGHT-D);this.popup={position:{local:{x:Math.max(D,Math.min(v.x,C)),y:Math.max(D,Math.min(v.y,a))},grid:b},context:{port:c}}}pasteFromClipboard(){let e=this.mManager.clipboard.paste();e.length!==0&&this.selectNodes(e,!1)}pointerDrag(e,r){let c=this.mManager.grid.pixelToGridPixelSpace(e.clientX,e.clientY),m={x:e.clientX,y:e.clientY},v=D=>{switch(r){case"panning":{this.mManager.grid.pan(D.clientX-m.x,D.clientY-m.y),m.x=D.clientX,m.y=D.clientY;break}case"selecting":{let C=this.mManager.grid.pixelToGridPixelSpace(D.clientX,D.clientY);this.selectBox={x:Math.min(c.x,C.x),y:Math.min(c.y,C.y),width:Math.abs(C.x-c.x),height:Math.abs(C.y-c.y)};break}}},b=D=>{if(document.removeEventListener("pointermove",v),document.removeEventListener("pointerup",b),r==="selecting"&&this.selectBox){let C=this.mManager.grid.gridPixelSpaceToGridSpace({x:this.selectBox.x,y:this.selectBox.y},!1),a=this.mManager.grid.gridPixelSpaceToGridSpace({x:this.selectBox.x+this.selectBox.width,y:this.selectBox.y+this.selectBox.height},!1),n=this.getNodesInRectangle({top:C.y,right:a.x,bottom:a.y,left:C.x});this.selectNodes(n,D.ctrlKey),this.selectBox=null}};document.addEventListener("pointermove",v),document.addEventListener("pointerup",b)}}}};var le=class{mCodeGenerator;mId;mLabel;mNodesProvider;mStatics;get codeGenerator(){return this.mCodeGenerator}get id(){return this.mId}get label(){return this.mLabel}get statics(){return this.mStatics}constructor(t){this.mId=t.id,this.mLabel=t.label,this.mNodesProvider=t.nodes,this.mStatics=t.statics,this.mCodeGenerator=t.generator.code}getNodeDefinitions(t){let e=c=>{if(!c)return new Array;let m=new Array;return c(v=>{m.push(v)},t),m},r={};return Object.defineProperty(r,"entry",{get:()=>e(this.mNodesProvider.entry)}),Object.defineProperty(r,"exit",{get:()=>e(this.mNodesProvider.exit)}),Object.defineProperty(r,"dynamic",{get:()=>e(this.mNodesProvider.dynamic)}),r}},Ft={none:0,imports:1,inputs:2,outputs:4};var ms=`:host {\r
    display: flex;\r
    flex-direction: column;\r
    height: 100%;\r
    overflow: hidden;\r
...
}`;var ps=`<kg-resize-box class="resize-box" left="true">\r
\r
    <!-- Function name -->\r
    <div class="section">\r
...
`;function ll(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,y,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:y,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,y,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,y,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,y,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,y,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,y=y||[],P=y):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return b(l,o),b(l,y),l}function b(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,y=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:y,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var y=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(y===void 0?null:y),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function bs(g,t,e,r){return(bs=ll())(g,t,e,r)}var ws,fs,xs,gs,vs,So;ws=B({selector:"potatno-function-properties",template:ps,style:ms,components:[Mt,Ht]}),xs=$.state({complexValue:!0});var ys=class{static{({e:[gs,vs],c:[So,fs]}=bs(this,[[xs,1,"functionProperties"]],[ws]))}constructor(t=O.use(H)){this.mManager=t,this.mSelectedImportId="",this.mProjectTypes=new Set,this.functionProperties=this.convertFunctionProperties(),this.mUnsubscribe=this.mManager.subscribe(R.Document|R.Function|R.SpecialActiveFunction,()=>{this.mProjectTypes.clear();for(let[e]of this.mManager.project.types.types)this.mProjectTypes.add(e);this.functionProperties=this.convertFunctionProperties()})}mManager;mProjectTypes;mSelectedImportId;mUnsubscribe;#t=(vs(this),gs(this));get functionProperties(){return this.#t}set functionProperties(t){this.#t=t}get projectTypes(){return this.mProjectTypes}get selectedImportId(){return this.mSelectedImportId}set selectedImportId(t){this.mSelectedImportId=t}get unusedImports(){return this.mManager.activeFunction.project.imports.filter(t=>!this.functionProperties.imports.find(e=>t.id===e.id))}addPort(t){let e=this.projectTypes.values().next().value;if(!e)return;let r=t===this.functionProperties.inputs?"Input":"Output";t.push({label:r,dataType:e,hasError:!1}),this.submitChange()}addSelectedImport(){let t=this.unusedImports;if(t.length===0)return;let e=t.find(r=>r.id===this.mSelectedImportId);e||(e=t.at(0)),this.functionProperties.imports.push(e),this.submitChange()}deleteImport(t){let e=this.functionProperties.imports.indexOf(t);e!==-1&&(this.functionProperties.imports.splice(e,1),this.submitChange())}deletePort(t,e){let r=e.indexOf(t);r!==-1&&(e.splice(r,1),this.submitChange())}onDeconstruct(){this.mUnsubscribe()}async submitChange(){let t=!1,e=new Set;for(let v of this.functionProperties.inputs)v.hasError=e.has(v.label),t||=v.hasError,e.add(v.label);let r=new Set;for(let v of this.functionProperties.outputs)v.hasError=r.has(v.label),t||=v.hasError,r.add(v.label);if(t){this.functionProperties=this.functionProperties;return}let c=this.mManager.activeFunction,m=this.functionProperties;await new Promise(v=>{globalThis.setTimeout(v,10)}),this.mManager.graph.updateFunction(c,v=>{if(v.label=m.label,!m.statics.inputs){for(;v.inputs.length>0;)v.removeInput(v.inputs.at(0));for(let b of m.inputs)v.addInput({dataType:b.dataType,label:b.label})}if(!m.statics.outputs){for(;v.outputs.length>0;)v.removeOutput(v.outputs.at(0));for(let b of m.outputs)v.addOutput({dataType:b.dataType,label:b.label})}if(!m.statics.imports){for(let b of v.imports)v.removeImport(b);for(let b of m.imports)v.addImport(b.id)}})}convertFunctionProperties(){let t={label:"",inputs:new Array,outputs:new Array,imports:new Array,statics:{label:!0,imports:!0,inputs:!0,outputs:!0}},e=this.mManager.activeFunction,r=e.project.getFunction(e.definitionId);r&&(t.statics.label=e.isSystem,t.statics.imports=(r.statics&Ft.imports)!==0,t.statics.inputs=(r.statics&Ft.inputs)!==0,t.statics.outputs=(r.statics&Ft.outputs)!==0),t.label=e.label;for(let c of e.project.imports)e.imports.has(c.id)&&t.imports.push({id:c.id,label:c.label});for(let c of e.inputs)t.inputs.push({label:c.label,dataType:c.dataType,hasError:!1});for(let c of e.outputs)t.outputs.push({label:c.label,dataType:c.dataType,hasError:!1});return t}static{fs()}};var oo=class{mDependencies;mDocument;mEntryPoint;get code(){return this.mDocument.project.generator.code(this)}get dependencies(){return this.mDependencies}get entryPoint(){return this.mEntryPoint}constructor(t,e,r){this.mDocument=t,this.mEntryPoint=e,this.mDependencies=r}};var ro=class{mFunction;mGraphs;get code(){let t=this.mFunction.project.getFunction(this.mFunction.definitionId);if(!t)throw new N("Function result has an invalid function definition id.",this);return t.codeGenerator.body(this)}get function(){return this.mFunction}get graphs(){return Array.from(this.mGraphs.values())}constructor(t){this.mFunction=t,this.mGraphs=new Map}addGraph(t){this.mGraphs.set(t.entryNode.definitionId,t)}graphResultOf(t){return this.mGraphs.get(t)}};var no=class{mBodyCode;mDependencies;mEntryNode;mExitNode;mNodeIds;mPorts;get code(){return this.mBodyCode}get dependencies(){return this.mDependencies}get entryNode(){return this.mEntryNode}get exitNode(){return this.mExitNode}get nodes(){return this.mNodeIds}get ports(){return this.mPorts}constructor(t){this.mBodyCode=t.bodyCode,this.mDependencies=[...t.dependencies],this.mEntryNode=t.entryNode,this.mExitNode=t.exitNode,this.mNodeIds=t.nodeIds,this.mPorts=t.portValues}};var ce=class{mProject;constructor(t){this.mProject=t}generateDocument(t,e=!1){let r=[...t.functions].find(c=>c.isSystem);if(!r)throw new N("No entry point function found for code generation.",this);return this.generateFunction(r,e)}generateFunction(t,e=!1){return this.buildDocumentResult(t.document,t.getExitNodes(),e)}generateNode(t,e=!1){return this.buildDocumentResult(t.document,[t],e)}buildDocumentResult(t,e,r){if(t.validate().errors.length>0)throw new N("Code generation exited. Code graph validation failed.",this);let m={counter:{nodeIndex:0,portIndex:0},debug:r,nodeDefinitions:new Map},v=this.generateFunctionWithDependencies(m,e,new Set),b=v.pop();return new oo(t,b,v)}countNodeEncounter(t,e){let r=new Map,c=new Set,m=new Array(t);for(;m.length>0;){let v=m.pop();if(r.set(v,(r.get(v)??0)+1),!(v===e||c.has(v))){c.add(v);for(let b of v.inputs.flow)for(let D of this.resolveFlowConjunctions(b))m.push(D.node);for(let b of v.inputs.value){let D=this.resolveValueConjunctions(b);D&&m.push(D.node)}}}return r}createScope(t,e){return{emittedNodes:new Set,remaining:this.countNodeEncounter(t,e)}}emitNode(t,e,r,c,m){if(!t.nodeDefinitions.get(r.function)){let l=new Map;for(let o of r.function.nodeDefinitions)l.set(o.id,o);t.nodeDefinitions.set(r.function,l)}let v=t.nodeDefinitions.get(r.function).get(r.definitionId);if(!v)throw new N(`Node definition "${r.definitionId}" not found for node "${r.label}".`,this);v instanceof wt&&e.dependencies.push(v.function);let b={},D=new Array;for(let l of r.inputs.value){let o=this.resolveInputValue(t,e,l);b[l.definitionId]=o.inputPort,e.ports.set(l,o.inputPort.value),o.emitResult&&D.push(o.emitResult)}let C={};for(let l of r.outputs.list)C[l.definitionId]={value:this.generatePortValue(t,e,l),code:{inner:c[l.definitionId]??""}};let a=v.codeGenerator({inputs:b,outputs:C,code:{next:m??""}}),n=this.getGeneratedNodeId(t,e,r);t.debug&&(a=this.mProject.generator.value.hook(`start-${n}`)+a+this.mProject.generator.value.hook(`end-${n}`));let u=new Array;for(let l of D)u.push(...l.codeOutput);return u.push(a),{codeOutput:u,lastGeneratedNode:r,endFlowPort:null}}findBranchStartPoint(t){let e=this.getNodesInputFlowPorts(t),r=e.length,c=new Map,m=new Array,v=(b,D)=>{let C=(c.has(b)||c.set(b,new Set),c.get(b)),a=C.size;for(let n of D)C.add(n);return C.size>a&&m.push(b),C};for(let[b,D]of e.entries())v(D.node,[b]);for(;m.length>0;){let b=m.shift(),D=c.get(b);for(let C of this.getNodesInputFlowPorts(b))if(v(C.node,D).size===r)return C.node}throw new N("No common branch point found for merge node.",this)}generateFunctionWithDependencies(t,e,r){let c=new Array;if(e.length===0)return c;let m=e.at(0).function;r.add(m);let v=new ro(m);c.push(v);for(let b of e){let D=this.generateNodeCode(t,b);v.addGraph(D);for(let C of D.dependencies)r.has(C)||c.push(...this.generateFunctionWithDependencies(t,C.getExitNodes(),r))}return c.reverse()}generateNodeCode(t,e){let r={dependencies:new Array,nodes:new Map,ports:new Map,scope:this.createScope(e,null)},c=this.walkBackward(t,r,e,null),m=c.codeOutput.join(" ");return new no({bodyCode:m,dependencies:r.dependencies,entryNode:c.lastGeneratedNode,exitNode:e,nodeIds:new Map(r.nodes),portValues:new Map(r.ports)})}generatePortValue(t,e,r){if(!e.ports.has(r)){let c=this.mProject.generator.value.name(r.label),m=this.mProject.generator.value.id(c,t.counter.portIndex++);e.ports.set(r,m)}return e.ports.get(r)}getGeneratedNodeId(t,e,r){if(!e.nodes.has(r)){let m=(++t.counter.nodeIndex).toString(16).toUpperCase().padStart(8,"0");e.nodes.set(r,m)}return e.nodes.get(r)}getNodesInputFlowPorts(t){let e=new Array;for(let r of t.inputs.flow)e.push(...this.resolveFlowConjunctions(r));return[...new Set(e)]}handleFlowMerge(t,e,r,c,m){let v=m.join(" "),b=this.findBranchStartPoint(r),D={},C=e.scope;try{for(let a of c){e.scope=this.createScope(a.node,b);let n=this.walkBackward(t,e,a.node,b);D[n.endFlowPort.definitionId]=n.codeOutput.join(" ")}}finally{e.scope=C}return this.emitNode(t,e,b,D,v)}resolveFlowConjunctions(t){let e=new Array;for(let r of t.connectedPorts){if(r.node.definitionId!==K.DEFINITION_ID){e.push(r);continue}let c=r.node.inputs.flow[0];!c||c.connectedPorts.size===0||e.push(...this.resolveFlowConjunctions(c))}return e}resolveInputValue(t,e,r){let c=this.resolveValueConjunctions(r);if(!c){if(this.mProject.types.isGenericType(r.dataType))throw new N("Generic value inputs must be allways connected",this);return{inputPort:{value:this.mProject.types.getType(r.dataType).convert([...r.directValue]),isDirectValue:!0},emitResult:null}}let m=c.node,v=!m.hasFlowPorts,b=(()=>{if(!m.hasFlowPorts){if(e.scope.emittedNodes.has(m))return null;let D=e.scope.remaining.get(m);if(v&&(D=0),e.scope.remaining.set(m,D),D<=0)return e.scope.emittedNodes.add(m),this.emitNode(t,e,m,{})}return null})();return{inputPort:{value:this.generatePortValue(t,e,c),isDirectValue:!1},emitResult:b}}resolveValueConjunctions(t){if(t.connectedPorts.size===0)return null;let e=t.connectedPorts.values().next().value;if(e.node.definitionId!==et.DEFINITION_ID)return e;let r=e.node.inputs.value[0];return!r||r.connectedPorts.size===0?null:this.resolveValueConjunctions(r)}walkBackward(t,e,r,c){let m={codeOutput:new Array,lastGeneratedNode:null,endFlowPort:null},v=null,b=r;for(;b!==null&&b!==c;){let D={};v!==null&&(D[v.definitionId]=m.codeOutput.join(" "),m.codeOutput=new Array);let C=m.codeOutput;m=this.emitNode(t,e,b,D),m.codeOutput=[...m.codeOutput,...C];let a=this.getNodesInputFlowPorts(b);if(a.length===0)break;a.length>1&&(m=this.handleFlowMerge(t,e,b,a,m.codeOutput),a=this.getNodesInputFlowPorts(m.lastGeneratedNode)),v=a[0]??null,b=v?.node??null}if(!m.lastGeneratedNode)throw new N(`Walk did not reach an entry node from exit "${r.label}".`,this);if(c&&b!==c)throw new N("Malformed graph. End node not reached",this);return m.endFlowPort=v,m}};var ut=class{static MAIN="MAIN";mBuild;mDefaultParameters;mFunction;mTypes;get defaultParameters(){return this.mDefaultParameters}get function(){return this.mFunction}get types(){return this.mTypes}constructor(t,e){this.mFunction=t,this.mDefaultParameters=e.defaultParameters,this.mTypes=new Set(e.types),this.mBuild=e.build}compile(t,e){return this.mBuild({defaultParameters:this.mDefaultParameters,function:this.mFunction,projectTypes:t.entryPoint.function.project.types},t,e)}};var Ts=`:host {\r
