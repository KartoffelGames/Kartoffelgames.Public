...
potatno-code-editor {\r
    ...
    width: 100%;\r
    height: 100%;\r
}`;var ne=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new Vt(this.mProject),i=[];for(let h of t.functions){let m=this.deserializeFunctionHead(h,e);i.push([m,h]),e.addFunction(m)}for(let[h,m]of i)this.deserializeFunctionBody(h,m,e);return e}deserializeFunctionBody(t,e,i){let h=new Map;for(let m of e.nodes)h.set(m.id,this.deserializeNode(m,t,i));for(let m of e.connections){if(!h.has(m.sourceNodeId)||!h.has(m.targetNodeId))continue;let v=h.get(m.sourceNodeId),w=h.get(m.targetNodeId),D=v.outputs.map.get(m.sourcePortId),S=w.inputs.map.get(m.targetPortId);!D||!S||D.connect(S)}}deserializeFunctionHead(t,e){let i=new lt(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let h of t.imports)i.addImport(h);for(let h of t.inputs)i.addInput({label:h.label,dataType:h.dataType});for(let h of t.outputs)i.addOutput({label:h.label,dataType:h.dataType});return i}deserializeNode(t,e,i){let h=i.nodeDefinitions.find(v=>v.id===t.definitionId),m=(()=>{if(h)return e.addNodeByDefinition(h,t.transformation);let v=t.ports.filter(D=>D.direction==="input").map(D=>({dataType:D.dataType,definitionId:D.definitionId,label:D.label,portType:D.portType})),w=t.ports.filter(D=>D.direction==="output").map(D=>({dataType:D.dataType,definitionId:D.definitionId,label:D.label,portType:D.portType}));return new pt(this.mProject,i,e,{definitionId:t.definitionId,ports:{input:v,output:w},label:t.label,transformation:{...t.transformation}})})();m.label=t.label,e.addNode(m);for(let v of t.ports)if(v.portType==="value"&&v.directValue.length>0){let w=m.inputs.map.get(v.definitionId);w&&w.setDirectValue(v.directValue)}return m.preview=t.preview??null,m}};var ie=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((w,D)=>{e.set(w,`n${D}`)});let i=[...t.nodes].map(w=>this.serializeNode(w,e.get(w))),h=[];for(let w of t.nodes){let D=e.get(w);for(let S of w.outputs.list)for(let l of S.connectedPorts){let r=e.get(l.node);h.push({sourceNodeId:D,sourcePortId:S.definitionId,targetNodeId:r,targetPortId:l.definitionId})}}let m=t.inputs.map(w=>({label:w.label,dataType:w.dataType})),v=t.outputs.map(w=>({label:w.label,dataType:w.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:m,outputs:v,imports:[...t.imports],nodes:i,connections:h}}serializeNode(t,e){let i=[...t.inputs.list,...t.outputs.list].map(m=>({definitionId:m.definitionId,label:m.label,direction:m.direction,portType:m.portType,dataType:m.portType==="value"?m.dataType:null,directValue:[...m.directValue]})),h=t.preview?{portDefinitionId:t.preview.portDefinitionId,displayId:t.preview.displayId}:null;return{id:e,definitionId:t.definitionId,label:t.label,transformation:{...t.transformation},ports:i,preview:h}}};var Nr=`:host {   \r
    /* Font */\r
...
`;function kl(){function y(l,r){return function(c){e(r,"addInitializer"),i(c,"An initializer"),l.push(c)}}function t(l,r,u,c,o,b,p,T,x){var d;switch(o){case 1:d="accessor";break;case 2:d="method";break;case 3:d="getter";break;case 4:d="setter";break;default:d="field"}var s={kind:d,name:p?"#"+r:r,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=y(c,f);var n,a;if(o===0?p?(n=u.get,a=u.set):(n=function(){return this[r]},a=function(g){this[r]=g}):o===2?n=function(){return u.value}:((o===1||o===3)&&(n=function(){return u.get.call(this)}),(o===1||o===4)&&(a=function(g){u.set.call(this,g)})),p)s.access=n&&a?{get:n,set:a}:n?{get:n}:{set:a};else{if(n){var I=n;n=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return r in g};s.access=n&&a?{has:E,get:n,set:a}:n?{has:E,get:n}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,r){if(l.v)throw new Error("attempted to call "+r+" after decoration was finished")}function i(l,r){if(typeof l!="function")throw new TypeError(r+" must be a function")}function h(l,r){var u=typeof r;if(l===1){if(u!=="object"||r===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");r.get!==void 0&&i(r.get,"accessor.get"),r.set!==void 0&&i(r.set,"accessor.set"),r.init!==void 0&&i(r.init,"accessor.init")}else if(u!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,r,u,c,o,b,p,T,x){var d=u[0],s,f,n;p?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(r,c)),o===1?n={get:s.get,set:s.set}:o===2?n=s.value:o===3?n=s.get:o===4&&(n=s.set);var a,I,P;if(typeof d=="function")a=t(d,c,s,T,o,b,p,x,n),a!==void 0&&(h(o,a),o===0?f=a:o===1?(f=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a);else for(var E=d.length-1;E>=0;E--){var g=d[E];if(a=t(g,c,s,T,o,b,p,x,n),a!==void 0){h(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,C){return C};else if(typeof f!="function"){var F=f;f=function(M,C){for(var N=C,L=0;L<F.length;L++)N=F[L].call(M,N);return N}}else{var j=f;f=function(M,C){return j.call(M,C)}}l.push(f)}o!==0&&(o===1?(s.get=n.get,s.set=n.set):o===2?s.value=n:o===3?s.get=n:o===4&&(s.set=n),p?o===1?(l.push(function(M,C){return n.get.call(M,C)}),l.push(function(M,C){return n.set.call(M,C)})):o===2?l.push(n):l.push(function(M,C){return n.call(M,C)}):Object.defineProperty(r,c,s))}function v(l,r,u){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<r.length;x++){var d=r[x];if(Array.isArray(d)){var s=d[1],f=d[2],n=d.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!n){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}m(c,I,d,f,s,a,n,P,u)}}return w(c,o),w(c,b),c}function w(l,r){r&&l.push(function(u){for(var c=0;c<r.length;c++)r[c].call(u);return u})}function D(l,r,u){if(r.length>0){for(var c=[],o=l,b=l.name,p=r.length-1;p>=0;p--){var T={v:!1};try{var x=r[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:u})}finally{T.v=!0}x!==void 0&&(h(10,x),o=x)}return[S(o,u),function(){for(var d=0;d<c.length;d++)c[d].call(o)}]}}function S(l,r){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:r})}return function(r,u,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(r,u,p);return c.length||S(r,p),{e:T,get c(){return D(r,c,p)}}}}function Jr(y,t,e,i){return(Jr=kl())(y,t,e,i)}var Kr,Zr,Qr;Kr=U({selector:"kg-information",template:Wr,style:Yr});var qr=class{static{({c:[Qr,Zr]}=Jr(this,[],[Kr]))}static{Zr()}};var kr=`:host {\r
...
}`;var tn="$slot";function oc(){function y(l,r){return function(c){e(r,"addInitializer"),i(c,"An initializer"),l.push(c)}}function t(l,r,u,c,o,b,p,T,x){var d;switch(o){case 1:d="accessor";break;case 2:d="method";break;case 3:d="getter";break;case 4:d="setter";break;default:d="field"}var s={kind:d,name:p?"#"+r:r,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=y(c,f);var n,a;if(o===0?p?(n=u.get,a=u.set):(n=function(){return this[r]},a=function(g){this[r]=g}):o===2?n=function(){return u.value}:((o===1||o===3)&&(n=function(){return u.get.call(this)}),(o===1||o===4)&&(a=function(g){u.set.call(this,g)})),p)s.access=n&&a?{get:n,set:a}:n?{get:n}:{set:a};else{if(n){var I=n;n=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return r in g};s.access=n&&a?{has:E,get:n,set:a}:n?{has:E,get:n}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,r){if(l.v)throw new Error("attempted to call "+r+" after decoration was finished")}function i(l,r){if(typeof l!="function")throw new TypeError(r+" must be a function")}function h(l,r){var u=typeof r;if(l===1){if(u!=="object"||r===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");r.get!==void 0&&i(r.get,"accessor.get"),r.set!==void 0&&i(r.set,"accessor.set"),r.init!==void 0&&i(r.init,"accessor.init")}else if(u!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,r,u,c,o,b,p,T,x){var d=u[0],s,f,n;p?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(r,c)),o===1?n={get:s.get,set:s.set}:o===2?n=s.value:o===3?n=s.get:o===4&&(n=s.set);var a,I,P;if(typeof d=="function")a=t(d,c,s,T,o,b,p,x,n),a!==void 0&&(h(o,a),o===0?f=a:o===1?(f=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a);else for(var E=d.length-1;E>=0;E--){var g=d[E];if(a=t(g,c,s,T,o,b,p,x,n),a!==void 0){h(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,C){return C};else if(typeof f!="function"){var F=f;f=function(M,C){for(var N=C,L=0;L<F.length;L++)N=F[L].call(M,N);return N}}else{var j=f;f=function(M,C){return j.call(M,C)}}l.push(f)}o!==0&&(o===1?(s.get=n.get,s.set=n.set):o===2?s.value=n:o===3?s.get=n:o===4&&(s.set=n),p?o===1?(l.push(function(M,C){return n.get.call(M,C)}),l.push(function(M,C){return n.set.call(M,C)})):o===2?l.push(n):l.push(function(M,C){return n.call(M,C)}):Object.defineProperty(r,c,s))}function v(l,r,u){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<r.length;x++){var d=r[x];if(Array.isArray(d)){var s=d[1],f=d[2],n=d.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!n){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}m(c,I,d,f,s,a,n,P,u)}}return w(c,o),w(c,b),c}function w(l,r){r&&l.push(function(u){for(var c=0;c<r.length;c++)r[c].call(u);return u})}function D(l,r,u){if(r.length>0){for(var c=[],o=l,b=l.name,p=r.length-1;p>=0;p--){var T={v:!1};try{var x=r[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:u})}finally{T.v=!0}x!==void 0&&(h(10,x),o=x)}return[S(o,u),function(){for(var d=0;d<c.length;d++)c[d].call(o)}]}}function S(l,r){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:r})}return function(r,u,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(r,u,p);return c.length||S(r,p),{e:T,get c(){return D(r,c,p)}}}}function rn(y,t,e,i){return(rn=oc())(y,t,e,i)}var nn,en,se;nn=U({selector:"kg-popup",template:tn,style:kr});var on=class{static{({c:[se,en]}=rn(this,[],[nn]))}static{en()}};var sn=`:host {\r
...
}`;var As=`<div class="node" style="--type-color: {{this.portColor}}" (dragover)="this.onDragOver($event)" (drop)="this.onDrop($event)">\r
\r
...
}`;var Xs=`<svg class="svg-layer" xmlns="http://www.w3.org/2000/svg" >\r
...
`;function Lc(){function y(l,r){return function(c){e(r,"addInitializer"),i(c,"An initializer"),l.push(c)}}function t(l,r,u,c,o,b,p,T,x){var d;switch(o){case 1:d="accessor";break;case 2:d="method";break;case 3:d="getter";break;case 4:d="setter";break;default:d="field"}var s={kind:d,name:p?"#"+r:r,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=y(c,f);var n,a;if(o===0?p?(n=u.get,a=u.set):(n=function(){return this[r]},a=function(g){this[r]=g}):o===2?n=function(){return u.value}:((o===1||o===3)&&(n=function(){return u.get.call(this)}),(o===1||o===4)&&(a=function(g){u.set.call(this,g)})),p)s.access=n&&a?{get:n,set:a}:n?{get:n}:{set:a};else{if(n){var I=n;n=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return r in g};s.access=n&&a?{has:E,get:n,set:a}:n?{has:E,get:n}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,r){if(l.v)throw new Error("attempted to call "+r+" after decoration was finished")}function i(l,r){if(typeof l!="function")throw new TypeError(r+" must be a function")}function h(l,r){var u=typeof r;if(l===1){if(u!=="object"||r===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");r.get!==void 0&&i(r.get,"accessor.get"),r.set!==void 0&&i(r.set,"accessor.set"),r.init!==void 0&&i(r.init,"accessor.init")}else if(u!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,r,u,c,o,b,p,T,x){var d=u[0],s,f,n;p?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(r,c)),o===1?n={get:s.get,set:s.set}:o===2?n=s.value:o===3?n=s.get:o===4&&(n=s.set);var a,I,P;if(typeof d=="function")a=t(d,c,s,T,o,b,p,x,n),a!==void 0&&(h(o,a),o===0?f=a:o===1?(f=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a);else for(var E=d.length-1;E>=0;E--){var g=d[E];if(a=t(g,c,s,T,o,b,p,x,n),a!==void 0){h(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,C){return C};else if(typeof f!="function"){var F=f;f=function(M,C){for(var N=C,L=0;L<F.length;L++)N=F[L].call(M,N);return N}}else{var j=f;f=function(M,C){return j.call(M,C)}}l.push(f)}o!==0&&(o===1?(s.get=n.get,s.set=n.set):o===2?s.value=n:o===3?s.get=n:o===4&&(s.set=n),p?o===1?(l.push(function(M,C){return n.get.call(M,C)}),l.push(function(M,C){return n.set.call(M,C)})):o===2?l.push(n):l.push(function(M,C){return n.call(M,C)}):Object.defineProperty(r,c,s))}function v(l,r,u){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<r.length;x++){var d=r[x];if(Array.isArray(d)){var s=d[1],f=d[2],n=d.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!n){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}m(c,I,d,f,s,a,n,P,u)}}return w(c,o),w(c,b),c}function w(l,r){r&&l.push(function(u){for(var c=0;c<r.length;c++)r[c].call(u);return u})}function D(l,r,u){if(r.length>0){for(var c=[],o=l,b=l.name,p=r.length-1;p>=0;p--){var T={v:!1};try{var x=r[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:u})}finally{T.v=!0}x!==void 0&&(h(10,x),o=x)}return[S(o,u),function(){for(var d=0;d<c.length;d++)c[d].call(o)}]}}function S(l,r){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:r})}return function(r,u,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(r,u,p);return c.length||S(r,p),{e:T,get c(){return D(r,c,p)}}}}function Js(y,t,e,i){return(Js=Lc())(y,t,e,i)}var Ks,Ys,Qs,Ws,Zs,No;Ks=U({selector:"potatno-connection-layer",template:Xs,style:Hs}),Qs=V.state({complexValue:!0});var qs=class{static{({e:[Ws,Zs],c:[No,Ys]}=Js(this,[[Qs,1,"connections"]],[Ks]))}constructor(t=O.use(H)){this.mManager=t,this.connections=new Map;let e=0;this.mUnsubscribe=this.mManager.subscribe(R.SpecialActiveFunction|R.Node|R.Connection|R.ProgrammResize,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.updateConnections()}))})}mManager;mUnsubscribe;#t=(Zs(this),Ws(this));get connections(){return this.#t}set connections(t){this.#t=t}createConjunction(t,e){t.preventDefault(),t.stopPropagation();let i=e.port.output.portType==="flow"?this.mManager.project.nodeDefinitions.get(K.DEFINITION_ID):this.mManager.project.nodeDefinitions.get(et.DEFINITION_ID),h=this.mManager.grid.pixelToGridSpace(t.clientX,t.clientY),m=this.mManager.graph.addNode(this.mManager.activeFunction,i,{x:h.x,y:h.y,height:0,width:0});this.mManager.graph.disconnectPorts(e.port.output,e.port.input);let v=m.inputs.list[0],w=m.outputs.list[0];this.mManager.graph.connectPorts(v,e.port.output),this.mManager.graph.connectPorts(v,e.port.input),this.mManager.graph.connectPorts(w,e.port.output),this.mManager.graph.connectPorts(w,e.port.input)}deleteConnection(t,e){t.button===2&&(t.preventDefault(),t.stopPropagation(),this.mManager.graph.disconnectPorts(e.port.output,e.port.input))}onDeconstruct(){this.mUnsubscribe()}createConnection(t,e,i){let h=this.mManager.integrity.errorItems,m=h.has(e)||h.has(i),v=(()=>{switch(i.portType){case"value":return i;case"flow":return e}})(),w=e.portType==="flow"?"":this.mManager.generateStringColor(e.resolvedDataType),D=this.mManager.connections.getConnectionPath(e,i);return{color:w,path:{attributeValue:D.attributeValue,length:D.length},state:{isNew:!t.has(v),hasError:m},port:{primary:v,output:e,input:i}}}updateConnections(){let t=this.connections;this.connections=new Map;for(let e of this.mManager.activeFunction.nodes)for(let i of e.outputs.list)for(let h of i.connectedPorts){let m=this.createConnection(t,i,h);this.connections.set(m.port.primary,m)}}static{Ys()}};function Rc(){function y(l,r){return function(c){e(r,"addInitializer"),i(c,"An initializer"),l.push(c)}}function t(l,r,u,c,o,b,p,T,x){var d;switch(o){case 1:d="accessor";break;case 2:d="method";break;case 3:d="getter";break;case 4:d="setter";break;default:d="field"}var s={kind:d,name:p?"#"+r:r,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=y(c,f);var n,a;if(o===0?p?(n=u.get,a=u.set):(n=function(){return this[r]},a=function(g){this[r]=g}):o===2?n=function(){return u.value}:((o===1||o===3)&&(n=function(){return u.get.call(this)}),(o===1||o===4)&&(a=function(g){u.set.call(this,g)})),p)s.access=n&&a?{get:n,set:a}:n?{get:n}:{set:a};else{if(n){var I=n;n=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return r in g};s.access=n&&a?{has:E,get:n,set:a}:n?{has:E,get:n}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,r){if(l.v)throw new Error("attempted to call "+r+" after decoration was finished")}function i(l,r){if(typeof l!="function")throw new TypeError(r+" must be a function")}function h(l,r){var u=typeof r;if(l===1){if(u!=="object"||r===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");r.get!==void 0&&i(r.get,"accessor.get"),r.set!==void 0&&i(r.set,"accessor.set"),r.init!==void 0&&i(r.init,"accessor.init")}else if(u!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,r,u,c,o,b,p,T,x){var d=u[0],s,f,n;p?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(r,c)),o===1?n={get:s.get,set:s.set}:o===2?n=s.value:o===3?n=s.get:o===4&&(n=s.set);var a,I,P;if(typeof d=="function")a=t(d,c,s,T,o,b,p,x,n),a!==void 0&&(h(o,a),o===0?f=a:o===1?(f=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a);else for(var E=d.length-1;E>=0;E--){var g=d[E];if(a=t(g,c,s,T,o,b,p,x,n),a!==void 0){h(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,C){return C};else if(typeof f!="function"){var F=f;f=function(M,C){for(var N=C,L=0;L<F.length;L++)N=F[L].call(M,N);return N}}else{var j=f;f=function(M,C){return j.call(M,C)}}l.push(f)}o!==0&&(o===1?(s.get=n.get,s.set=n.set):o===2?s.value=n:o===3?s.get=n:o===4&&(s.set=n),p?o===1?(l.push(function(M,C){return n.get.call(M,C)}),l.push(function(M,C){return n.set.call(M,C)})):o===2?l.push(n):l.push(function(M,C){return n.call(M,C)}):Object.defineProperty(r,c,s))}function v(l,r,u){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<r.length;x++){var d=r[x];if(Array.isArray(d)){var s=d[1],f=d[2],n=d.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!n){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}m(c,I,d,f,s,a,n,P,u)}}return w(c,o),w(c,b),c}function w(l,r){r&&l.push(function(u){for(var c=0;c<r.length;c++)r[c].call(u);return u})}function D(l,r,u){if(r.length>0){for(var c=[],o=l,b=l.name,p=r.length-1;p>=0;p--){var T={v:!1};try{var x=r[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:u})}finally{T.v=!0}x!==void 0&&(h(10,x),o=x)}return[S(o,u),function(){for(var d=0;d<c.length;d++)c[d].call(o)}]}}function S(l,r){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:r})}return function(r,u,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(r,u,p);return c.length||S(r,p),{e:T,get c(){return D(r,c,p)}}}}function ea(y,t,e,i){return(ea=Rc())(y,t,e,i)}var oa,ks,Ae;oa=Ct({access:q.Read,selector:/^potatno-preview$/});var ta=class{static{({c:[Ae,ks]}=ea(this,[],[oa]))}constructor(t=O.use(k),e=O.use(W),i=O.use(st)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(i.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let i=this.mTarget.childNodes.length>0;return i&&(this.mTarget.innerHTML=""),i}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{ks()}};var ra=`:host {\r
    display: block;\r
    position: relative;\r
}\r
\r
...
`;var na=`<div class="port-wrapper {{this.portDirection}}" style="--type-color: {{this.portColor}}" (dragover)="this.onDragOver($event)" (drop)="this.onDrop($event)">\r
\r
...
}`;var ga=`<div class="node {{this.hasError ? 'error' : ''}} {{this.selected ? 'selected' : ''}}" style="--node-category-color: {{this.nodeColor}}">\r
    <!-- Header -->\r
...
}`;var za=`<!-- Serves only as a background. -->\r
...
}`;var Wa=`<kg-resize-box class="resize-box" left top bottom="false">\r
    <div class="header">\r
