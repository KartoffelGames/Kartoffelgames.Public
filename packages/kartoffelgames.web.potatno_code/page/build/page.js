...
\r
\r
`;var zn=`<div #canvasWrapper class="canvas-wrapper" [style]="this.gridBackgroundStyle" (pointerdown)="this.onCanvasPointerDown($event)" (wheel)="this.onCanvasWheel($event)" (contextmenu)="this.onContextMenu($event)">\r
...
\r
        <div class="section__list">\r
            $for(inputPort of this.functionProperties.inputs) {\r
                <div class="list-item">\r
                    <!-- Label/Name -->\r
                    <input class="list-item__input" type="text" [(value)]="this.inputPort.label" [disabled]="this.functionProperties.statics.inputs" (change)="this.submitChange()"/>\r
\r
                    <!-- Type Selection -->\r
                    <select class="port-type-input" [(value)]="this.inputPort.dataType" [disabled]="this.functionProperties.statics.inputs" (change)="this.submitChange()">\r
                        $for(portType of this.projectTypes) {\r
                            <option [value]="this.portType" [selected]="this.portType === this.inputPort.dataType">{{this.portType}}</option>\r
                        }\r
                    </select>\r
\r
                    <!-- Delete button if not static -->\r
                    $if(!this.functionProperties.statics.inputs) {\r
                        <div class="list-item__delete" (click)="this.deletePort(this.inputPort, this.functionProperties.inputs)">\u2715</div>\r
                    }\r
                </div>\r
            }\r
\r
...
\r
    <div class="section">\r
        ...
        <div class="section__list">\r
            $for(outputPort of this.functionOutputs; index = $index) {\r
                <div class="list-item">\r
                    <input class="list-item__input" type="text" [value]="this.outputPort.name" [disabled]="this.functionProperties.statics.outputs" pattern="[a-zA-Z][a-zA-Z0-9_]*" title="Must start with a letter, use only letters, digits, underscores" (change)="this.onOutputNameChange(this.index, $event)" />\r
                    <select class="port-type-input" [disabled]="this.functionProperties.statics.outputs" (change)="this.onOutputTypeChange(this.index, $event)">\r
                        $for(portType of this.projectTypes) {\r
                            <option [value]="this.portType" [selected]="this.portType === this.outputPort.type">{{this.portType}}</option>\r
                        }\r
                    </select>\r
                    $if(!this.functionProperties.statics.outputs) {\r
                        <div class="list-item__delete" (click)="this.onDeleteOutput(this.index)">\u2715</div>\r
                    }\r
                </div>\r
            }\r
...
\r
            $if(!this.functionProperties.statics.outputs) {\r
                <div class="section__button" (click)="this.onAddOutput()">\r
                    <div>+</div>\r
            ...
            $for(imp of this.functionImports; index = $index) {\r
                <div class="list-item">\r
                    ...
                    $if(!this.functionProperties.statics.imports) {\r
                        <div class="list-item__delete" (click)="this.onDeleteImport(this.index)">\u2715</div>\r
                    }\r
                </div>\r
            }\r
\r
...
\r
            $if(!this.functionProperties.statics.imports && this.unusedImports.length > 0) {\r
                <div class="list-item">\r
                    <select class="list-item__input" (change)="this.onImportSelectChange($event)">\r
                        $for(avail of this.unusedImports) {\r
                            <option [value]="this.avail.id">{{this.avail.label}}</option>\r
                        }\r
                    </select>\r
                    <button class="section__button" (click)="this.onAddSelectedImport()">+ Add</button>\r
                </div>\r
            }\r
        </div>\r
        \r
