...
potatno-code-editor {\r
    ...
    width: 100%;\r
    height: 100%;\r
}`;var ne=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new jt(this.mProject),r=[];for(let u of t.functions){let f=this.deserializeFunctionHead(u,e);r.push([f,u]),e.addFunction(f)}for(let[u,f]of r)this.deserializeFunctionBody(u,f,e);return e}deserializeFunctionBody(t,e,r){let u=new Map;for(let f of e.nodes)u.set(f.id,this.deserializeNode(f,t,r));for(let f of e.connections){if(!u.has(f.sourceNodeId)||!u.has(f.targetNodeId))continue;let v=u.get(f.sourceNodeId),w=u.get(f.targetNodeId),T=v.outputs.map.get(f.sourcePortId),_=w.inputs.map.get(f.targetPortId);!T||!_||T.connect(_)}}deserializeFunctionHead(t,e){let r=new lt(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let u of t.imports)r.addImport(u);for(let u of t.inputs)r.addInput({label:u.label,dataType:u.dataType});for(let u of t.outputs)r.addOutput({label:u.label,dataType:u.dataType});return r}deserializeNode(t,e,r){let u=r.nodeDefinitions.find(v=>v.id===t.definitionId),f=(()=>{if(u)return e.addNodeByDefinition(u,t.transformation);let v=t.ports.filter(T=>T.direction==="input").map(T=>({dataType:T.dataType,definitionId:T.definitionId,label:T.label,portType:T.portType})),w=t.ports.filter(T=>T.direction==="output").map(T=>({dataType:T.dataType,definitionId:T.definitionId,label:T.label,portType:T.portType}));return new pt(this.mProject,r,e,{definitionId:t.definitionId,ports:{input:v,output:w},label:t.label,transformation:{...t.transformation}})})();f.label=t.label,e.addNode(f);for(let v of t.ports)if(v.portType==="value"&&v.directValue.length>0){let w=f.inputs.map.get(v.definitionId);w&&w.setDirectValue(v.directValue)}return f.preview=t.preview??null,f}};var ie=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((w,T)=>{e.set(w,`n${T}`)});let r=[...t.nodes].map(w=>this.serializeNode(w,e.get(w))),u=[];for(let w of t.nodes){let T=e.get(w);for(let _ of w.outputs.list)for(let l of _.connectedPorts){let n=e.get(l.node);u.push({sourceNodeId:T,sourcePortId:_.definitionId,targetNodeId:n,targetPortId:l.definitionId})}}let f=t.inputs.map(w=>({label:w.label,dataType:w.dataType})),v=t.outputs.map(w=>({label:w.label,dataType:w.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:f,outputs:v,imports:[...t.imports],nodes:r,connections:u}}serializeNode(t,e){let r=[...t.inputs.list,...t.outputs.list].map(f=>({definitionId:f.definitionId,label:f.label,direction:f.direction,portType:f.portType,dataType:f.portType==="value"?f.dataType:null,directValue:[...f.directValue]})),u=t.preview?{portDefinitionId:t.preview.portDefinitionId,displayId:t.preview.displayId}:null;return{id:e,definitionId:t.definitionId,label:t.label,transformation:{...t.transformation},ports:r,preview:u}}};var Sr=`:host {\r
...
:host([selected]:not([selected=false])) {\r
    color: var(--button-text-color);\r
    background-color: color-mix(in srgb, var(--button-accent-color) 50%, transparent);\r
}\r
\r
\r
...
`;function hl(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,D,x){var d;switch(o){case 1:d="accessor";break;case 2:d="method";break;case 3:d="getter";break;case 4:d="setter";break;default:d="field"}var s={kind:d,name:p?"#"+n:n,static:b,private:p,metadata:D},m={v:!1};s.addInitializer=y(c,m);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var I=i;i=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,S){return arguments.length===1&&(S=g,g=this),P.call(g,S)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function f(l,n,h,c,o,b,p,D,x){var d=h[0],s,m,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,I,P;if(typeof d=="function")a=t(d,c,s,D,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?m=a:o===1?(m=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a);else for(var E=d.length-1;E>=0;E--){var g=d[E];if(a=t(g,c,s,D,o,b,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a,S!==void 0&&(m===void 0?m=S:typeof m=="function"?m=[m,S]:m.push(S))}}if(o===0||o===1){if(m===void 0)m=function(M,C){return C};else if(typeof m!="function"){var F=m;m=function(M,C){for(var A=C,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=m;m=function(M,C){return j.call(M,C)}}l.push(m)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,C){return i.get.call(M,C)}),l.push(function(M,C){return i.set.call(M,C)})):o===2?l.push(i):l.push(function(M,C){return i.call(M,C)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,b,p=new Map,D=new Map,x=0;x<n.length;x++){var d=n[x];if(Array.isArray(d)){var s=d[1],m=d[2],i=d.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,g=E.get(m)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!g&&s>2?E.set(m,s):E.set(m,!0)}f(c,I,d,m,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:y(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[_(o,h),function(){for(var d=0;d<c.length;d++)c[d].call(o)}]}}function _(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),D=v(n,h,p);return c.length||_(n,p),{e:D,get c(){return T(n,c,p)}}}}function Wr(y,t,e,r){return(Wr=hl())(y,t,e,r)}var Zr,Xr,qr;Zr=U({selector:"kg-information",template:Hr,style:Ur});var Yr=class{static{({c:[qr,Xr]}=Wr(this,[],[Zr]))}static{Xr()}};var Jr=`:host {\r
...
}`;var Kr="$slot";function dl(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,D,x){var d;switch(o){case 1:d="accessor";break;case 2:d="method";break;case 3:d="getter";break;case 4:d="setter";break;default:d="field"}var s={kind:d,name:p?"#"+n:n,static:b,private:p,metadata:D},m={v:!1};s.addInitializer=y(c,m);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var I=i;i=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,S){return arguments.length===1&&(S=g,g=this),P.call(g,S)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function f(l,n,h,c,o,b,p,D,x){var d=h[0],s,m,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,I,P;if(typeof d=="function")a=t(d,c,s,D,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?m=a:o===1?(m=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a);else for(var E=d.length-1;E>=0;E--){var g=d[E];if(a=t(g,c,s,D,o,b,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a,S!==void 0&&(m===void 0?m=S:typeof m=="function"?m=[m,S]:m.push(S))}}if(o===0||o===1){if(m===void 0)m=function(M,C){return C};else if(typeof m!="function"){var F=m;m=function(M,C){for(var A=C,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=m;m=function(M,C){return j.call(M,C)}}l.push(m)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,C){return i.get.call(M,C)}),l.push(function(M,C){return i.set.call(M,C)})):o===2?l.push(i):l.push(function(M,C){return i.call(M,C)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,b,p=new Map,D=new Map,x=0;x<n.length;x++){var d=n[x];if(Array.isArray(d)){var s=d[1],m=d[2],i=d.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,g=E.get(m)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!g&&s>2?E.set(m,s):E.set(m,!0)}f(c,I,d,m,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:y(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[_(o,h),function(){for(var d=0;d<c.length;d++)c[d].call(o)}]}}function _(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),D=v(n,h,p);return c.length||_(n,p),{e:D,get c(){return T(n,c,p)}}}}function tn(y,t,e,r){return(tn=dl())(y,t,e,r)}var en,Qr,se;en=U({selector:"kg-popup",template:Kr,style:Jr});var kr=class{static{({c:[se,Qr]}=tn(this,[],[en]))}static{Qr()}};var on=`:host {\r
...
\r
    .selection-popup__search {\r
        width: 100%;\r
        box-sizing: border-box;\r
        padding: 0.5rem 0.625rem;\r
        outline: none;\r
\r
        /* Mistreat border as fake background. */\r
        border: 0.375rem solid var(--potatno-color-background-light);\r
\r
        color: var(--potatno-color-text);\r
        background-color: var(--potatno-color-background);\r
\r
...
\r
    .selection-popup__results {\r
        ...
        overflow-y: auto;\r
        padding: 0.25rem 0;\r
        border-top: 0.125rem solid var(--potatno-color-accent);\r
\r
        scrollbar-color: var(--potatno-color-scrollbar-thumb) var(--potatno-color-scrollbar-track);\r
        scrollbar-width: thin;\r
    }\r
...
`;function Vl(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,D,x){var d;switch(o){case 1:d="accessor";break;case 2:d="method";break;case 3:d="getter";break;case 4:d="setter";break;default:d="field"}var s={kind:d,name:p?"#"+n:n,static:b,private:p,metadata:D},m={v:!1};s.addInitializer=y(c,m);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var I=i;i=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,S){return arguments.length===1&&(S=g,g=this),P.call(g,S)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function f(l,n,h,c,o,b,p,D,x){var d=h[0],s,m,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,I,P;if(typeof d=="function")a=t(d,c,s,D,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?m=a:o===1?(m=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a);else for(var E=d.length-1;E>=0;E--){var g=d[E];if(a=t(g,c,s,D,o,b,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a,S!==void 0&&(m===void 0?m=S:typeof m=="function"?m=[m,S]:m.push(S))}}if(o===0||o===1){if(m===void 0)m=function(M,C){return C};else if(typeof m!="function"){var F=m;m=function(M,C){for(var A=C,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=m;m=function(M,C){return j.call(M,C)}}l.push(m)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,C){return i.get.call(M,C)}),l.push(function(M,C){return i.set.call(M,C)})):o===2?l.push(i):l.push(function(M,C){return i.call(M,C)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,b,p=new Map,D=new Map,x=0;x<n.length;x++){var d=n[x];if(Array.isArray(d)){var s=d[1],m=d[2],i=d.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,g=E.get(m)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!g&&s>2?E.set(m,s):E.set(m,!0)}f(c,I,d,m,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:y(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[_(o,h),function(){for(var d=0;d<c.length;d++)c[d].call(o)}]}}function _(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),D=v(n,h,p);return c.length||_(n,p),{e:D,get c(){return T(n,c,p)}}}}function ps(y,t,e,r){return(ps=Vl())(y,t,e,r)}var gs,hs,vs,ms,fs,So;gs=U({selector:"potatno-connection-layer",template:us,style:cs}),vs=V.state({complexValue:!0});var ds=class{static{({e:[ms,fs],c:[So,hs]}=ps(this,[[vs,1,"connections"]],[gs]))}constructor(t=O.use(Y)){this.mManager=t,this.connections=new Map;let e=0;this.mUnsubscribe=this.mManager.subscribe(R.SpecialActiveFunction|R.Node|R.Connection,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.updateConnections()}))})}mManager;mUnsubscribe;#t=(fs(this),ms(this));get connections(){return this.#t}set connections(t){this.#t=t}createConjunction(t,e){t.preventDefault(),t.stopPropagation();let r=e.port.output.portType==="flow"?this.mManager.project.nodeDefinitions.get(K.DEFINITION_ID):this.mManager.project.nodeDefinitions.get(et.DEFINITION_ID),u=this.mManager.grid.pixelToGridSpace(t.clientX,t.clientY),f=this.mManager.graph.addNode(this.mManager.activeFunction,r,{x:u.x,y:u.y,height:0,width:0});this.mManager.graph.disconnectPorts(e.port.output,e.port.input);let v=f.inputs.list[0],w=f.outputs.list[0];this.mManager.graph.connectPorts(v,e.port.output),this.mManager.graph.connectPorts(v,e.port.input),this.mManager.graph.connectPorts(w,e.port.output),this.mManager.graph.connectPorts(w,e.port.input)}deleteConnection(t,e){t.button===2&&(t.preventDefault(),t.stopPropagation(),this.mManager.graph.disconnectPorts(e.port.output,e.port.input))}onDeconstruct(){this.mUnsubscribe()}createConnection(t,e,r){let u=this.mManager.integrity.errorItems,f=u.has(e)||u.has(r),v=(()=>{switch(r.portType){case"value":return r;case"flow":return e}})(),w=e.portType==="flow"?"":this.mManager.generateStringColor(e.resolvedDataType),T=this.mManager.connections.getConnectionPath(e,r);return{color:w,path:{attributeValue:T.attributeValue,length:T.length},state:{isNew:!t.has(v),hasError:f},port:{primary:v,output:e,input:r}}}updateConnections(){let t=this.connections;this.connections=new Map;for(let e of this.mManager.activeFunction.nodes)for(let r of e.outputs.list)for(let u of r.connectedPorts){let f=this.createConnection(t,r,u);this.connections.set(f.port.primary,f)}}static{hs()}};function $l(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,D,x){var d;switch(o){case 1:d="accessor";break;case 2:d="method";break;case 3:d="getter";break;case 4:d="setter";break;default:d="field"}var s={kind:d,name:p?"#"+n:n,static:b,private:p,metadata:D},m={v:!1};s.addInitializer=y(c,m);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var I=i;i=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,S){return arguments.length===1&&(S=g,g=this),P.call(g,S)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function f(l,n,h,c,o,b,p,D,x){var d=h[0],s,m,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,I,P;if(typeof d=="function")a=t(d,c,s,D,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?m=a:o===1?(m=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a);else for(var E=d.length-1;E>=0;E--){var g=d[E];if(a=t(g,c,s,D,o,b,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a,S!==void 0&&(m===void 0?m=S:typeof m=="function"?m=[m,S]:m.push(S))}}if(o===0||o===1){if(m===void 0)m=function(M,C){return C};else if(typeof m!="function"){var F=m;m=function(M,C){for(var A=C,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=m;m=function(M,C){return j.call(M,C)}}l.push(m)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,C){return i.get.call(M,C)}),l.push(function(M,C){return i.set.call(M,C)})):o===2?l.push(i):l.push(function(M,C){return i.call(M,C)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,b,p=new Map,D=new Map,x=0;x<n.length;x++){var d=n[x];if(Array.isArray(d)){var s=d[1],m=d[2],i=d.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,g=E.get(m)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!g&&s>2?E.set(m,s):E.set(m,!0)}f(c,I,d,m,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:y(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[_(o,h),function(){for(var d=0;d<c.length;d++)c[d].call(o)}]}}function _(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),D=v(n,h,p);return c.length||_(n,p),{e:D,get c(){return T(n,c,p)}}}}function ws(y,t,e,r){return(ws=$l())(y,t,e,r)}var xs,ys,Ne;xs=Ct({access:q.Read,selector:/^potatno-preview$/});var bs=class{static{({c:[Ne,ys]}=ws(this,[],[xs]))}constructor(t=O.use(k),e=O.use(W),r=O.use(it)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(r.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let r=this.mTarget.childNodes.length>0;return r&&(this.mTarget.innerHTML=""),r}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{ys()}};var Ts=`:host {\r
    display: block;\r
    font-family: var(--potatno-font-family);\r
    font-size: var(--potatno-font-size);\r
\r
...
\r
    .list-item__select-input {\r
        ...
        min-width: 2.75rem;\r
        padding: 0.25rem 0.6rem 0.25rem 0rem;\r
        background-color: var(--potatno-color-background);\r
        font-size: var(--potatno-font-size);\r
        color: var(--potatno-color-text);\r
        font: inherit;\r
...
\r
    ...
    padding: 0.125rem 0.125rem 0 0.125rem;\r
\r
...
\r
        ...
        font-size: 1.25rem;\r
        font-weight: bold;\r
        padding: 0 0.625rem 0 0.625rem;\r
\r
