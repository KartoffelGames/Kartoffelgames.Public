...
\r
    $for(node of this.nodes) {\r
        <potatno-node class="grid-content__node {{this.selectedNode.has(this.node) ? 'selected' : ''}}" [nodeData]="this.node" (drag)="this.moveAllSelected(this.node, $event.value)"/>\r
    }\r
</div>\r
\r
