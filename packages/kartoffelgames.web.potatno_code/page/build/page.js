...
potatno-code-editor {\r
    ...
    width: 100%;\r
    height: 100%;\r
}`;var re=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new jt(this.mProject),r=[];for(let a of t.functions){let d=this.deserializeFunctionHead(a,e);r.push([d,a]),e.addFunction(d)}for(let[a,d]of r)this.deserializeFunctionBody(a,d,e);return e}deserializeFunctionBody(t,e,r){let a=new Map;for(let d of e.nodes)a.set(d.id,this.deserializeNode(d,t,r));for(let d of e.connections){if(!a.has(d.sourceNodeId)||!a.has(d.targetNodeId))continue;let g=a.get(d.sourceNodeId),y=a.get(d.targetNodeId),E=g.outputs.map.get(d.sourcePortId),C=y.inputs.map.get(d.targetPortId);!E||!C||E.connect(C)}}deserializeFunctionHead(t,e){let r=new Et(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let a of t.imports)r.addImport(a);for(let a of t.inputs)r.addInput({label:a.label,dataType:a.dataType});for(let a of t.outputs)r.addOutput({label:a.label,dataType:a.dataType});return r}deserializeNode(t,e,r){let a=r.nodeDefinitions.find(g=>g.id===t.definitionId),d=(()=>{if(a)return e.addNodeByDefinition(a,t.transformation);let g=t.ports.filter(E=>E.direction==="input").map(E=>({dataType:E.dataType,definitionId:E.definitionId,label:E.label,portType:E.portType})),y=t.ports.filter(E=>E.direction==="output").map(E=>({dataType:E.dataType,definitionId:E.definitionId,label:E.label,portType:E.portType}));return new St(this.mProject,r,e,{definitionId:t.definitionId,ports:{input:g,output:y},label:t.label,transformation:{...t.transformation}})})();d.label=t.label,e.addNode(d);for(let g of t.ports)if(g.portType==="value"&&g.directValue.length>0){let y=d.inputs.map.get(g.definitionId);y&&y.setDirectValue(g.directValue)}return d.preview=t.preview??null,d}};var ne=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((y,E)=>{e.set(y,`n${E}`)});let r=[...t.nodes].map(y=>this.serializeNode(y,e.get(y))),a=[];for(let y of t.nodes){let E=e.get(y);for(let C of y.outputs.list)for(let c of C.connectedPorts){let n=e.get(c.node);a.push({sourceNodeId:E,sourcePortId:C.definitionId,targetNodeId:n,targetPortId:c.definitionId})}}let d=t.inputs.map(y=>({label:y.label,dataType:y.dataType})),g=t.outputs.map(y=>({label:y.label,dataType:y.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:d,outputs:g,imports:[...t.imports],nodes:r,connections:a}}serializeNode(t,e){let r=[...t.inputs.list,...t.outputs.list].map(d=>({definitionId:d.definitionId,label:d.label,direction:d.direction,portType:d.portType,dataType:d.portType==="value"?d.dataType:null,directValue:[...d.directValue]})),a=t.preview?{portDefinitionId:t.preview.portDefinitionId,displayId:t.preview.displayId}:null;return{id:e,definitionId:t.definitionId,label:t.label,transformation:{...t.transformation},ports:r,preview:a}}};var Tr=`:host {\r
    /* Globals */\r
...
}`;var Dr=`<potatno-resize-box class="resize-box" right="true">\r
...
`;function Ls(){function p(c,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),c.push(l)}}function t(c,n,u,l,o,b,v,T,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:T},m={v:!1};s.addInitializer=p(l,m);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{m.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function d(c,n,u,l,o,b,v,T,w){var f=u[0],s,m,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,l,s,T,o,b,v,w,i),h!==void 0&&(a(o,h),o===0?m=h:o===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,l,s,T,o,b,v,w,i),h!==void 0){a(o,h);var N;o===0?N=h:o===1?(N=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,N!==void 0&&(m===void 0?m=N:typeof m=="function"?m=[m,N]:m.push(N))}}if(o===0||o===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var _=D,L=0;L<F.length;L++)_=F[L].call(I,_);return _}}else{var z=m;m=function(I,D){return z.call(I,D)}}c.push(m)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],o,b,v=new Map,T=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=c,s=s-5,b=b||[],P=b):(x=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(l,x,f,m,s,h,i,P,u)}}return y(l,o),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function E(c,n,u){if(n.length>0){for(var l=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var T={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(a(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<l.length;f++)l[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),T=g(n,u,v);return l.length||C(n,v),{e:T,get c(){return E(n,l,v)}}}}function Nr(p,t,e,r){return(Nr=Ls())(p,t,e,r)}var Ar,Ir,_r,Lr,Cr,Pr,Mr,yo;Ar=Y({selector:"potatno-function-list",template:Dr,style:Er}),_r=$.state({complexValue:!0}),Lr=$.state();var Sr=class{static{({e:[Cr,Pr,Mr],c:[yo,Ir]}=Nr(this,[[_r,1,"documentFunctions"],[Lr,1,"showPopup"]],[Ar]))}constructor(t=R.use(X)){this.mManager=t,this.documentFunctions=new Array,this.showPopup=!1,this.mUnsubscribe=this.mManager.subscribe(O.Document|O.Function|O.SpecialActiveFunction,()=>{this.documentFunctions=this.mManager.graph.document.functions.map(e=>({id:e.id,label:e.label,isSystem:e.isSystem,function:e}))})}mManager;mUnsubscribe;#t=(Mr(this),Cr(this));get documentFunctions(){return this.#t}set documentFunctions(t){this.#t=t}#e=Pr(this);get showPopup(){return this.#e}set showPopup(t){this.#e=t}get activeFunctionId(){return this.mManager.activeFunction.id}get userFunctionDefinitions(){return[...this.mManager.project.userFunctions.values()]}createFunction(t){this.showPopup=!1,this.mManager.graph.addFunction(t.id)}deleteFunction(t){this.mManager.graph.removeFunction(t.id)}onDeconstruct(){this.mUnsubscribe()}selectFunction(t){this.mManager.setActiveFunction(t.function)}static{Ir()}};var Rr=`:host {\r
    display: flex;\r
    flex-direction: column;\r
    position: relative;\r
\r
...
}`;var Or=`<!-- In order of top-left clockwise. Needed for styling -->\r
...
`;function Fs(){function p(c,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),c.push(l)}}function t(c,n,u,l,o,b,v,T,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:T},m={v:!1};s.addInitializer=p(l,m);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{m.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function d(c,n,u,l,o,b,v,T,w){var f=u[0],s,m,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,l,s,T,o,b,v,w,i),h!==void 0&&(a(o,h),o===0?m=h:o===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,l,s,T,o,b,v,w,i),h!==void 0){a(o,h);var N;o===0?N=h:o===1?(N=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,N!==void 0&&(m===void 0?m=N:typeof m=="function"?m=[m,N]:m.push(N))}}if(o===0||o===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var _=D,L=0;L<F.length;L++)_=F[L].call(I,_);return _}}else{var z=m;m=function(I,D){return z.call(I,D)}}c.push(m)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],o,b,v=new Map,T=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=c,s=s-5,b=b||[],P=b):(x=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(l,x,f,m,s,h,i,P,u)}}return y(l,o),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function E(c,n,u){if(n.length>0){for(var l=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var T={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(a(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<l.length;f++)l[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),T=g(n,u,v);return l.length||C(n,v),{e:T,get c(){return E(n,l,v)}}}}function Gr(p,t,e,r){return(Gr=Fs())(p,t,e,r)}var Ur,Fr,Hr,Xr,Yr,jr,zr,Vr,$r,qt;Ur=Y({selector:"potatno-resize-box",template:Or,style:Rr}),Hr=$.state({proxy:!0}),Xr=wt("resize"),Yr=wt("resize-end");var Br=class{static{({e:[jr,zr,Vr,$r],c:[qt,Fr]}=Gr(this,[[Hr,1,"mConfiguration"],[Xr,1,"mResize"],[Yr,1,"mResizeEnd"],[k,3,"bottom"],[k,3,"left"],[k,3,"right"],[k,3,"snap"],[k,3,"top"],[k,3,"virtual"],[k,2,"resize"]],[Ur]))}constructor(t=R.use(B)){this.mComponentElement=t.element,this.mConfiguration={snap:1,isVirtual:!1,enabledDirections:{top:!1,right:!1,bottom:!1,left:!1}}}mComponentElement;#t=($r(this),jr(this));get mConfiguration(){return this.#t}set mConfiguration(t){this.#t=t}#e=zr(this);get mResize(){return this.#e}set mResize(t){this.#e=t}#o=Vr(this);get mResizeEnd(){return this.#o}set mResizeEnd(t){this.#o=t}get bottom(){return this.mConfiguration.enabledDirections.bottom}set bottom(t){this.mConfiguration.enabledDirections.bottom=this.parseBoolean(t)}get left(){return this.mConfiguration.enabledDirections.left}set left(t){this.mConfiguration.enabledDirections.left=this.parseBoolean(t)}get right(){return this.mConfiguration.enabledDirections.right}set right(t){this.mConfiguration.enabledDirections.right=this.parseBoolean(t)}get snap(){return this.mConfiguration.snap}set snap(t){this.mConfiguration.snap=parseInt(t.toString())}get top(){return this.mConfiguration.enabledDirections.top}set top(t){this.mConfiguration.enabledDirections.top=this.parseBoolean(t)}get virtual(){return this.mConfiguration.isVirtual}set virtual(t){this.mConfiguration.isVirtual=this.parseBoolean(t)}resize(t,e){let r=this.mComponentElement.getBoundingClientRect(),a=r.width,d=r.height;return this.mComponentElement.style.setProperty("width",`${t}px`),this.mComponentElement.style.setProperty("height",`${e}px`),t!==a||e!==d}resizeCorner(t){this.handleResize(t,"both")}resizeHorizontal(t){this.handleResize(t,"horizontal")}resizeVertical(t){this.handleResize(t,"vertical")}createResizeEvent(t,e,r,a,d){let g=t;return e===a&&(g&=~(Tt.right|Tt.left)),r===d&&(g&=~(Tt.top|Tt.bottom)),new bo(e,r,g)}handleResize(t,e){t.preventDefault(),t.stopPropagation();let r=this.mComponentElement.getBoundingClientRect(),a=this.mComponentElement.offsetWidth?r.width/this.mComponentElement.offsetWidth:1,d=this.mComponentElement.offsetHeight?r.height/this.mComponentElement.offsetHeight:1,g=r.width/a,y=r.height/d,E=t.clientX,C=t.clientY,c=1;Math.abs(E-r.left)<Math.abs(E-r.right)&&(c=-1);let n=1;Math.abs(C-r.top)<Math.abs(C-r.bottom)&&(n=-1);let u=0;u+=c===1?Tt.right:Tt.left,u+=n===1?Tt.bottom:Tt.top;let l=g,o=y,b=T=>{let w=(T.clientX-E)/a*c,f=(T.clientY-C)/d*n,s=g+w,m=y+f;e==="horizontal"&&(s=g),e==="vertical"&&(m=y),[l,o]=this.updateComponentSize(u,s,m,l,o)},v=()=>{document.removeEventListener("pointermove",b),document.removeEventListener("pointerup",v),(l!==g||o!==y)&&this.mResizeEnd.dispatchEvent(this.createResizeEvent(u,l,o,g,y))};document.addEventListener("pointermove",b),document.addEventListener("pointerup",v)}parseBoolean(t){return!!(()=>{if(typeof t=="string"){let r=t.toLowerCase();if(["true","false"].includes(r))return r==="true"}return t})()}updateComponentSize(t,e,r,a,d){let g=a;(this.mConfiguration.enabledDirections.left||this.mConfiguration.enabledDirections.right)&&(g=Math.floor(Math.abs(e)/this.mConfiguration.snap)*this.mConfiguration.snap*(e/Math.abs(e)),this.mConfiguration.isVirtual||this.mComponentElement.style.setProperty("width",`${g}px`));let y=d;return(this.mConfiguration.enabledDirections.top||this.mConfiguration.enabledDirections.bottom)&&(y=Math.floor(Math.abs(r)/this.mConfiguration.snap)*this.mConfiguration.snap*(r/Math.abs(r)),this.mConfiguration.isVirtual||this.mComponentElement.style.setProperty("height",`${y}px`)),(g!==a||y!==d)&&this.mResize.dispatchEvent(this.createResizeEvent(t,g,y,a,d)),[g,y]}static{Fr()}},bo=class{mHeight;mResizeHandle;mWidth;get height(){return this.mHeight}get resizeHandle(){return this.mResizeHandle}get width(){return this.mWidth}constructor(t,e,r){this.mHeight=e,this.mResizeHandle=r,this.mWidth=t}},Tt={top:1,right:2,bottom:4,left:8};var Zr=`:host {\r
    position: absolute;\r
    z-index: 200;\r
}\r
\r
...
`;function Vs(){function p(c,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),c.push(l)}}function t(c,n,u,l,o,b,v,T,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:T},m={v:!1};s.addInitializer=p(l,m);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{m.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function d(c,n,u,l,o,b,v,T,w){var f=u[0],s,m,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,l,s,T,o,b,v,w,i),h!==void 0&&(a(o,h),o===0?m=h:o===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,l,s,T,o,b,v,w,i),h!==void 0){a(o,h);var N;o===0?N=h:o===1?(N=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,N!==void 0&&(m===void 0?m=N:typeof m=="function"?m=[m,N]:m.push(N))}}if(o===0||o===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var _=D,L=0;L<F.length;L++)_=F[L].call(I,_);return _}}else{var z=m;m=function(I,D){return z.call(I,D)}}c.push(m)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],o,b,v=new Map,T=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=c,s=s-5,b=b||[],P=b):(x=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(l,x,f,m,s,h,i,P,u)}}return y(l,o),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function E(c,n,u){if(n.length>0){for(var l=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var T={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(a(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<l.length;f++)l[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),T=g(n,u,v);return l.length||C(n,v),{e:T,get c(){return E(n,l,v)}}}}function on(p,t,e,r){return(on=Vs())(p,t,e,r)}function $s(p){return p}var rn,qr,nn,sn,an,ln,cn,Jr,Kr,Qr,kr,tn,en,ie;rn=Y({selector:"potatno-node-selection-popup",template:Wr,style:Zr,components:[qt]}),nn=$.state({complexValue:!0}),sn=xt("searchInput"),an=wt("node-select"),ln=$.state(),cn=$.state();new class extends $s{constructor(){super(ie),qr()}static{class p{static{({e:[Jr,Kr,Qr,kr,tn,en],c:[ie,qr]}=on(this,[[nn,1,"results"],[sn,1,"searchInput"],[an,1,"mNodeSelect"],[ln,1,"searchValue"],[cn,1,"selectedDefinitionId"]],[rn]))}static POPUP_HEIGHT=320;static POPUP_WIDTH=280;mComponent;mManager;#t=(en(this),Jr(this));get results(){return this.#t}set results(e){this.#t=e}#e=Kr(this);get searchInput(){return this.#e}set searchInput(e){this.#e=e}#o=Qr(this);get mNodeSelect(){return this.#o}set mNodeSelect(e){this.#o=e}#r=kr(this);get searchValue(){return this.#r}set searchValue(e){this.#r=e}#n=tn(this);get selectedDefinitionId(){return this.#n}set selectedDefinitionId(e){this.#n=e}constructor(e=R.use(B),r=R.use(X)){this.mManager=r,this.mComponent=e,this.selectedDefinitionId=null,this.results=new Array,this.searchValue=""}onConnect(){this.searchInput?.focus()}onKeyDown(e){if(this.results.length!==0){if(e.key==="ArrowDown"||e.key==="ArrowUp"){e.preventDefault();let r=this.results.findIndex(g=>g.definition.id===this.selectedDefinitionId);r=Math.max(0,r);let a=e.key==="ArrowDown"?1:-1,d=(r+a+this.results.length)%this.results.length;this.selectedDefinitionId=this.results[d].definition.id;return}e.key==="Enter"&&this.sendSelectedEntry(this.selectedDefinitionId)}}onUpdate(){this.rebuildResults();let e=this.mComponent.element.shadowRoot.querySelector(".selection-popup__result.selected");e&&e.scrollIntoView()}stopPropagation(e,r){e.stopPropagation(),r&&e.preventDefault()}rebuildResults(){let e=this.mManager.activeFunction.dynamicNodeDefinitions.map(a=>({category:a.category.name,definition:a,label:a.label.toLowerCase(),color:this.mManager.generateStringColor(a.category.name),icon:a.category.icon})),r=this.searchValue.trim().toLowerCase();this.results=e.filter(a=>a.label.includes(r)),this.results.some(a=>a.definition.id===this.selectedDefinitionId)||(this.selectedDefinitionId=this.results[0]?.definition.id??null)}sendSelectedEntry(e){if(e===null)return;let r=this.results.find(a=>a.definition.id===e);r&&this.mNodeSelect.dispatchEvent(r.definition)}}}};var un=`:host {\r
    display: block;\r
    font-family: var(--potatno-font-family);\r
    font-size: var(--potatno-font-size);\r
\r
...
}`;var hn=`<!-- Resizeable part of node -->\r
...
`;function Us(){function p(c,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),c.push(l)}}function t(c,n,u,l,o,b,v,T,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:T},m={v:!1};s.addInitializer=p(l,m);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{m.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function d(c,n,u,l,o,b,v,T,w){var f=u[0],s,m,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,l,s,T,o,b,v,w,i),h!==void 0&&(a(o,h),o===0?m=h:o===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,l,s,T,o,b,v,w,i),h!==void 0){a(o,h);var N;o===0?N=h:o===1?(N=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,N!==void 0&&(m===void 0?m=N:typeof m=="function"?m=[m,N]:m.push(N))}}if(o===0||o===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var _=D,L=0;L<F.length;L++)_=F[L].call(I,_);return _}}else{var z=m;m=function(I,D){return z.call(I,D)}}c.push(m)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],o,b,v=new Map,T=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=c,s=s-5,b=b||[],P=b):(x=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(l,x,f,m,s,h,i,P,u)}}return y(l,o),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function E(c,n,u){if(n.length>0){for(var l=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var T={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(a(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<l.length;f++)l[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),T=g(n,u,v);return l.length||C(n,v),{e:T,get c(){return E(n,l,v)}}}}function xn(p,t,e,r){return(xn=Us())(p,t,e,r)}var Tn,mn,En,Dn,In,Cn,Pn,Mn,dn,fn,pn,gn,vn,yn,bn,xo;Tn=Y({selector:"potatno-comment-node",template:hn,style:un,components:[qt]}),En=$.state(),Dn=$.state(),In=$.state(),Cn=xt("CommentInput"),Pn=wt("node-drag"),Mn=xt("ResizeBox");var wn=class{static{({e:[dn,fn,pn,gn,vn,yn,bn],c:[xo,mn]}=xn(this,[[En,1,"editMode"],[Dn,1,"enableBigview"],[In,1,"gridZoom"],[k,3,"nodeData"],[Cn,1,"mCommentInput"],[Pn,1,"mDrag"],[Mn,1,"mResizeBox"]],[Tn]))}constructor(t=R.use(B),e=R.use(X)){this.mComponent=t,this.mManager=e,this.mNodeData=null,this.mDoubleClickState=null,this.editMode=!1,this.enableBigview=!1,this.gridZoom=0,this.updateForZoomLevel(),this.mUnsubscribeGrid=this.mManager.subscribe(O.SpecialGrid,()=>{this.updateForZoomLevel()}),this.mUnsubscribe=this.mManager.subscribe(O.Node,r=>{r.item===this.nodeData&&this.resyncComponent(this.nodeData)})}mComponent;mDoubleClickState;mManager;mNodeData;mUnsubscribe;mUnsubscribeGrid;get comment(){return this.nodeData?.label??""}set comment(t){this.nodeData&&(this.nodeData.label=t)}#t=(bn(this),dn(this));get editMode(){return this.#t}set editMode(t){this.#t=t}#e=fn(this);get enableBigview(){return this.#e}set enableBigview(t){this.#e=t}#o=pn(this);get gridZoom(){return this.#o}set gridZoom(t){this.#o=t}get nodeData(){return this.mNodeData}set nodeData(t){this.mNodeData=t,t&&(this.resyncComponent(t),this.mComponent.updater.update())}#r=gn(this);get mCommentInput(){return this.#r}set mCommentInput(t){this.#r=t}#n=vn(this);get mDrag(){return this.#n}set mDrag(t){this.#n=t}#i=yn(this);get mResizeBox(){return this.#i}set mResizeBox(t){this.#i=t}dragNodeOrEnableEdit(t){if(!this.nodeData||(this.mDoubleClickState?this.editMode=!0:this.mDoubleClickState={timer:globalThis.setTimeout(()=>{this.mDoubleClickState=null},300)},this.editMode))return;t.preventDefault();let e=this.nodeData.transformation.x*this.mManager.grid.gridSize,r=this.nodeData.transformation.y*this.mManager.grid.gridSize,a=this.nodeData.transformation.x,d=this.nodeData.transformation.y,g=this.mComponent.element.getBoundingClientRect(),y=this.mComponent.element.offsetWidth?g.width/this.mComponent.element.offsetWidth:1,E=this.mComponent.element.offsetHeight?g.height/this.mComponent.element.offsetHeight:1,C=t.clientX,c=t.clientY,n=l=>{l.stopPropagation();let o=(l.clientX-C)/y,b=(l.clientY-c)/E,v=Math.round((e+o)/this.mManager.grid.gridSize),T=Math.round((r+b)/this.mManager.grid.gridSize);a===v&&d===T||(this.mManager.graph.transformNode(this.nodeData,w=>{w.moveTo(v,T)}),this.mDrag.dispatchEvent(new wo(v-a,T-d)),a=v,d=T)},u=()=>{document.removeEventListener("pointermove",n),document.removeEventListener("pointerup",u)};document.addEventListener("pointermove",n),document.addEventListener("pointerup",u)}escapeEditMode(t){(t.key==="Escape"||t.key==="Enter")&&(t.preventDefault(),this.editMode=!1)}onConnect(){this.nodeData&&this.resyncComponent(this.nodeData)}onDeconstruct(){this.mUnsubscribe(),this.mUnsubscribeGrid()}onUpdate(){this.mCommentInput&&this.getFocusedElement(document)!==this.mCommentInput&&this.mCommentInput.select()}transformNodeData(t){this.mManager.graph.transformNode(this.nodeData,e=>{let r=e.transformation.width,a=e.transformation.height;e.resizeTo(t.width/this.mManager.grid.gridSize,t.height/this.mManager.grid.gridSize);let d=e.transformation.width-r,g=e.transformation.height-a;g!==0&&(t.resizeHandle&Tt.top)>0&&e.moveTo(e.transformation.x,e.transformation.y-g),d!==0&&(t.resizeHandle&Tt.left)>0&&e.moveTo(e.transformation.x-d,e.transformation.y)})}getFocusedElement(t){let e=t.activeElement;return e?e.shadowRoot?this.getFocusedElement(e.shadowRoot):e:null}resyncComponent(t){let e=t.transformation.x*this.mManager.grid.gridSize,r=t.transformation.y*this.mManager.grid.gridSize;if(this.mComponent.element.style.setProperty("left",`${e}px`),this.mComponent.element.style.setProperty("top",`${r}px`),this.mResizeBox){let a=t.transformation.width*this.mManager.grid.gridSize,d=t.transformation.height*this.mManager.grid.gridSize;this.mResizeBox.resize(a,d)}this.mComponent.updater.updateAsync()}updateForZoomLevel(){this.enableBigview=this.mManager.grid.zoom<.25,this.enableBigview&&(this.gridZoom=this.mManager.grid.zoom),this.mComponent.element.style.setProperty("z-index",(this.enableBigview?9999:-1).toString())}static{mn()}},wo=class{mX;mY;get x(){return this.mX}get y(){return this.mY}constructor(t,e){this.mX=t,this.mY=e}};var Sn=`:host {\r
    position: absolute;\r
    top: 0;\r
    left: 0;\r
    height: 1px;\r
...
}`;var Un=`<div class="port-wrapper {{this.portDirection}}" style="--type-color: {{this.portColor}}" (dragover)="this.onDragOver($event)" (drop)="this.onDrop($event)">\r
\r
...
`;function Js(){function p(c,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),c.push(l)}}function t(c,n,u,l,o,b,v,T,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:T},m={v:!1};s.addInitializer=p(l,m);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{m.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function d(c,n,u,l,o,b,v,T,w){var f=u[0],s,m,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,l,s,T,o,b,v,w,i),h!==void 0&&(a(o,h),o===0?m=h:o===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,l,s,T,o,b,v,w,i),h!==void 0){a(o,h);var N;o===0?N=h:o===1?(N=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,N!==void 0&&(m===void 0?m=N:typeof m=="function"?m=[m,N]:m.push(N))}}if(o===0||o===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var _=D,L=0;L<F.length;L++)_=F[L].call(I,_);return _}}else{var z=m;m=function(I,D){return z.call(I,D)}}c.push(m)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],o,b,v=new Map,T=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=c,s=s-5,b=b||[],P=b):(x=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(l,x,f,m,s,h,i,P,u)}}return y(l,o),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function E(c,n,u){if(n.length>0){for(var l=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var T={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(a(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<l.length;f++)l[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),T=g(n,u,v);return l.length||C(n,v),{e:T,get c(){return E(n,l,v)}}}}function Zn(p,t,e,r){return(Zn=Js())(p,t,e,r)}function Ks(p){return p}var Wn,Hn,qn,Xn,Yn,Ke;Wn=Y({selector:"potatno-port",template:Un,style:Gn}),qn=xt("dragConnection");new class extends Ks{constructor(){super(Ke),Hn()}static{class p{static{({e:[Xn,Yn],c:[Ke,Hn]}=Zn(this,[[qn,1,"dragConnectionSvg"],[k,3,"port"]],[Wn]))}static DRAG_MIME_TYPE="application/x-potatno-port";mComponent;mDragPositionEventHandler;mManager;mPort;mUnsubscribe;get dragPositionEventHandler(){return this.mDragPositionEventHandler}#t=(Yn(this),Xn(this));get dragConnectionSvg(){return this.#t}set dragConnectionSvg(e){this.#t=e}get hasError(){return this.port===null?!1:this.mManager.integrity.errorItems.has(this.port)}get inputDefinitions(){if(!this.port)return new Array;let e=this.port.project.types.getType(this.port.resolvedDataType);return e.inputs.map((r,a)=>({htmlType:(()=>{switch(r.type){case"boolean":return"checkbox";case"number":return"number";case"string":return"text"}})(),index:a,name:r.name,value:this.port.directValue[a]??"",totalCount:e.inputs.length}))}get port(){return this.mPort}set port(e){if(this.mPort!==e){if(e===null)throw new A("A null port cant be assigned.",this);this.mPort=e,this.mComponent.updater.update()}}get portColor(){return!this.port||this.port.portType==="flow"?"var(--potatno-color-text)":this.mManager.generateStringColor(this.port.resolvedDataType)}get portDirection(){return this.port?.direction??"output"}get portHandleClasses(){if(!this.port)return"";let e=[this.port.portType];return this.port.connectedPorts.size>0&&e.push("connected"),this.hasError&&e.push("error"),e.join(" ")}get portName(){return this.port?.label??""}get portType(){return!this.port||this.port.portType!=="value"?"":this.port.resolvedDataType??""}get showValueInput(){return!this.port||this.port.portType!=="value"||this.port.direction!=="input"||this.port.connectedPorts.size>0||this.mManager.grid.draggedPort.isDragging&&this.mManager.grid.draggedPort.port===this.port?!1:!this.port.node.project.types.isGenericType(this.port.dataType??"")}constructor(e=R.use(B),r=R.use(X)){this.mComponent=e,this.mManager=r,this.mPort=null,this.mDragPositionEventHandler=a=>{this.mManager.grid.draggedPort.isDragging&&this.mManager.grid.draggedPort.port===this.port&&(performance.now()-a.timeStamp>100||this.renderDragWire(a.clientX,a.clientY))},document.addEventListener("dragover",this.mDragPositionEventHandler,{capture:!0}),this.mUnsubscribe=this.mManager.subscribe(O.Connection,()=>{this.mComponent.updater.updateAsync()})}onDeconstruct(){this.mUnsubscribe(),document.removeEventListener("dragover",this.mDragPositionEventHandler,{capture:!0})}onDirectValueInput(e,r){if(!this.port)return;let a=e.target,d=[...this.port.directValue];d[r]=a.type==="checkbox"?a.checked?"true":"false":a.value,this.mManager.graph.setPortDirectValue(this.port,d)}onDragEnd(e){e.stopPropagation(),e.preventDefault(),this.dragConnectionSvg&&(this.dragConnectionSvg.innerHTML=""),this.mComponent.updater.updateAsync()}onDragOver(e){this.draggedPortCanConnect(e.dataTransfer)&&(e.preventDefault(),e.stopPropagation(),e.dataTransfer&&(e.dataTransfer.dropEffect="link"))}onDragStart(e){if(!this.port||!e.dataTransfer){e.preventDefault();return}e.stopPropagation(),e.dataTransfer.effectAllowed="link",e.dataTransfer.setData(p.DRAG_MIME_TYPE,this.port.definitionId),e.dataTransfer.setDragImage(document.createElement("div"),0,0),this.mManager.grid.setDraggingPort(this.port),this.mComponent.updater.updateAsync()}onDrop(e){if(!this.draggedPortCanConnect(e.dataTransfer)||(e.preventDefault(),e.stopPropagation(),!this.mManager.grid.draggedPort.isDragging)||!this.port)return;let r=this.mManager.grid.draggedPort.port;this.mManager.graph.connectPorts(r,this.port)}createDragPath(e,r){if(!this.port)return"";let a=this.mManager.connections.pixelToGridSpace(e,r);return this.mManager.connections.createTemporaryPath(this.port,a)}draggedPortCanConnect(e){if(!this.port||!this.mManager.grid.draggedPort.isDragging||!e||!e.types.includes(p.DRAG_MIME_TYPE))return!1;let r=this.mManager.grid.draggedPort.port;return r!==this.port&&r.direction!==this.port.direction&&r.portType===this.port.portType}renderDragWire(e,r){if(!this.mManager.grid.draggedPort.isDragging||!this.dragConnectionSvg)return;let a=this.dragConnectionSvg.firstChild;if(a||(a=document.createElementNS("http://www.w3.org/2000/svg","path"),this.dragConnectionSvg.appendChild(a)),!this.mManager.grid.draggedPort.updatePointer(e,r))return;let d=this.mManager.grid.draggedPort.portPosition,g=d.x*this.mManager.grid.gridSize,y=d.y*this.mManager.grid.gridSize;this.dragConnectionSvg.style.setProperty("transform",`translate(${-g}px, ${-y}px)`),a.setAttribute("d",this.createDragPath(e,r))}}}};var Jn=`:host {\r
    display: block;\r
    font-family: var(--potatno-font-family);\r
    font-size: var(--potatno-font-size);\r
\r
...
.selection-box {\r
    ...
    pointer-events: none;\r
    z-index: 1000;\r
}`;var fi=`<!-- Serves only as a background. -->\r
...
`;function ra(){function p(c,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),c.push(l)}}function t(c,n,u,l,o,b,v,T,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:T},m={v:!1};s.addInitializer=p(l,m);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{m.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function d(c,n,u,l,o,b,v,T,w){var f=u[0],s,m,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,l,s,T,o,b,v,w,i),h!==void 0&&(a(o,h),o===0?m=h:o===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,l,s,T,o,b,v,w,i),h!==void 0){a(o,h);var N;o===0?N=h:o===1?(N=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,N!==void 0&&(m===void 0?m=N:typeof m=="function"?m=[m,N]:m.push(N))}}if(o===0||o===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var _=D,L=0;L<F.length;L++)_=F[L].call(I,_);return _}}else{var z=m;m=function(I,D){return z.call(I,D)}}c.push(m)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],o,b,v=new Map,T=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=c,s=s-5,b=b||[],P=b):(x=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(l,x,f,m,s,h,i,P,u)}}return y(l,o),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function E(c,n,u){if(n.length>0){for(var l=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var T={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(a(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<l.length;f++)l[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),T=g(n,u,v);return l.length||C(n,v),{e:T,get c(){return E(n,l,v)}}}}function bi(p,t,e,r){return(bi=ra())(p,t,e,r)}function na(p){return p}var wi,pi,xi,Ti,gi,vi,yi,Qe;wi=Y({selector:"potatno-node-graph",template:fi,style:di,components:[ie,Do,xo,To]}),xi=$.state(),Ti=$.state({complexValue:!0});new class extends na{constructor(){super(Qe),pi()}static{class p{static{({e:[gi,vi,yi],c:[Qe,pi]}=bi(this,[[xi,1,"popupPosition"],[Ti,1,"selectBox"]],[wi]))}static ZOOM_STRENGTH=.1;mComponent;mIsMouseInsideGrid;mKeyboardHandler;mManager;mSelectedNodes;mUnsubscribeFunctionChange;mUnsubscribeGraphChange;#t=(yi(this),gi(this));get popupPosition(){return this.#t}set popupPosition(e){this.#t=e}#e=vi(this);get selectBox(){return this.#e}set selectBox(e){this.#e=e}get gridBackgroundStyle(){let e=this.mManager.grid.gridSize*this.mManager.grid.zoom,r=this.mManager.grid.panX%e,a=this.mManager.grid.panY%e;return`background-size: ${e}px ${e}px; background-position: ${r}px ${a}px;`}get gridTransformStyle(){return`transform: translate(${this.mManager.grid.panX}px, ${this.mManager.grid.panY}px) scale(${this.mManager.grid.zoom})`}get nodes(){return this.mManager.activeFunction.nodes}get selectedNode(){return this.mSelectedNodes}constructor(e=R.use(B),r=R.use(X)){this.mComponent=e,this.mManager=r,this.mSelectedNodes=new Set,this.mIsMouseInsideGrid=!1,this.popupPosition=null,this.selectBox=null,e.element.addEventListener("pointerdown",a=>{this.onPointerDown(a)}),e.element.addEventListener("wheel",a=>{this.onScroll(a)}),e.element.addEventListener("contextmenu",a=>{a.preventDefault()}),e.element.addEventListener("pointerenter",()=>{this.mIsMouseInsideGrid=!0}),e.element.addEventListener("pointerleave",()=>{this.mIsMouseInsideGrid=!1}),this.mKeyboardHandler=a=>{this.onKeyDown(a)},document.addEventListener("keydown",this.mKeyboardHandler),this.mUnsubscribeFunctionChange=this.mManager.subscribe(O.Document|O.Function|O.SpecialActiveFunction,()=>{this.popupPosition=null,this.selectBox=null,this.selectNodes([],!1)}),this.mUnsubscribeGraphChange=this.mManager.subscribe(O.NodeAdd|O.NodeDelete|O.SpecialGrid,()=>{this.mComponent.updater.updateAsync()})}createNodeOnPopupPosition(e){let r=this.mManager.graph.addNode(this.mManager.activeFunction,e,{x:this.popupPosition?.grid.x??0,y:this.popupPosition?.grid.y??0,height:0,width:0});this.popupPosition=null,this.selectNodes([r],!1)}moveAllSelected(e,r){for(let a of this.mSelectedNodes)a!==e&&this.mManager.graph.transformNode(a,d=>{d.moveTo(d.transformation.x+r.x,d.transformation.y+r.y)})}onConnect(){this.mManager.connections.gridElement=this.mComponent.element}onDeconstruct(){this.mUnsubscribeFunctionChange(),this.mUnsubscribeGraphChange(),document.removeEventListener("keydown",this.mKeyboardHandler)}selectNodes(e,r){this.popupPosition=null;let a=!!r;r instanceof PointerEvent&&(r.stopPropagation(),a=r.ctrlKey);let d=new Set;if(!a)if(e.length===1&&this.mSelectedNodes.has(e.at(0)))for(let y of this.mSelectedNodes)d.add(y);else this.mSelectedNodes.clear();let g=[...e];for(let y of g)d.has(y)||(d.add(y),y.definitionId===pt.DEFINITION_ID&&g.push(...this.getNodesInRectangle({top:y.transformation.y,right:y.transformation.x+y.transformation.width,bottom:y.transformation.y+y.transformation.height,left:y.transformation.x})),this.mSelectedNodes.has(y)?this.mSelectedNodes.delete(y):this.mSelectedNodes.add(y));this.mComponent.updater.updateAsync()}typeOfNode(e){switch(e.definitionId){case pt.DEFINITION_ID:return"comment";case ft.DEFINITION_ID:case dt.DEFINITION_ID:return"conjunction";default:return"node"}}convertGlobalToGridPosition(e,r){let a=this.mComponent.element.getBoundingClientRect();return{x:e-a.left,y:r-a.top}}convertLocalToGridCoordinate(e,r){return{x:(e-this.mManager.grid.panX)/this.mManager.grid.zoom,y:(r-this.mManager.grid.panY)/this.mManager.grid.zoom}}getNodesInRectangle(e){let r=new Array;for(let a of this.mManager.activeFunction.nodes){let d=a.transformation.y,g=a.transformation.x,y=g+a.transformation.width,E=d+a.transformation.height;if(g<e.right&&y>e.left&&d<e.bottom&&E>e.top){if(e.top>d&&e.right<y&&e.bottom<E&&e.left>g)continue;r.push(a)}}return r}onKeyDown(e){if(!this.mIsMouseInsideGrid)return;let r=document.activeElement;if(!(r instanceof HTMLInputElement||r instanceof HTMLTextAreaElement||r instanceof HTMLSelectElement)){switch(e.key){case"Escape":{this.popupPosition=null;return}case"Delete":{for(let a of this.mSelectedNodes)this.mManager.graph.removeNode(a);this.selectNodes([],!1);return}}if(e.ctrlKey)switch(e.key){case"z":{e.preventDefault(),this.mManager.history.undo();return}case"y":{e.preventDefault(),this.mManager.history.redo();return}case"c":{this.mManager.clipboard.copy(this.mSelectedNodes);return}case"v":e.preventDefault(),this.pasteFromClipboard()}}}onPointerDown(e){switch(this.popupPosition=null,e.button){case 0:{e.ctrlKey||this.selectNodes([],!1),this.pointerDrag(e,"selecting");return}case 1:{e.preventDefault(),this.pointerDrag(e,"panning");return}case 2:{this.openAddNodePopupAtPointer(e.clientX,e.clientY);return}}}onScroll(e){e.preventDefault();let r=e.deltaY>0?-1:1,a=this.convertGlobalToGridPosition(e.clientX,e.clientY);this.mManager.grid.zoomAt(a.x,a.y,r*p.ZOOM_STRENGTH)}openAddNodePopupAtPointer(e,r){let a=this.mComponent.element,d=this.convertGlobalToGridPosition(e,r),g=this.convertLocalToGridCoordinate(d.x,d.y),y=8,E=Math.max(0,a.clientWidth-ie.POPUP_WIDTH-y),C=Math.max(0,a.clientHeight-ie.POPUP_HEIGHT-y);this.popupPosition={local:{x:Math.max(y,Math.min(d.x,E)),y:Math.max(y,Math.min(d.y,C))},grid:{x:Math.round(g.x/this.mManager.grid.gridSize),y:Math.round(g.y/this.mManager.grid.gridSize)}}}pasteFromClipboard(){let e=this.mManager.clipboard.paste();e.length!==0&&this.selectNodes(e,!1)}pointerDrag(e,r){let a=this.convertGlobalToGridPosition(e.clientX,e.clientY),d=a,g=E=>{let C=this.convertGlobalToGridPosition(E.clientX,E.clientY);switch(r){case"panning":{this.mManager.grid.pan(C.x-d.x,C.y-d.y);break}case"selecting":{this.selectBox={x:Math.min(a.x,C.x),y:Math.min(a.y,C.y),width:Math.abs(C.x-a.x),height:Math.abs(C.y-a.y)};break}}d=C},y=E=>{if(document.removeEventListener("pointermove",g),document.removeEventListener("pointerup",y),r==="selecting"&&this.selectBox){let C=this.convertLocalToGridCoordinate(this.selectBox.x,this.selectBox.y),c=this.convertLocalToGridCoordinate(this.selectBox.x+this.selectBox.width,this.selectBox.y+this.selectBox.height),n=this.mManager.grid.gridSize,u=this.getNodesInRectangle({top:C.y/n,right:c.x/n,bottom:c.y/n,left:C.x/n});this.selectNodes(u,E.ctrlKey),this.selectBox=null}};document.addEventListener("pointermove",g),document.addEventListener("pointerup",y)}}}};var se=class{mCodeGenerator;mId;mLabel;mNodesProvider;mStatics;get codeGenerator(){return this.mCodeGenerator}get id(){return this.mId}get label(){return this.mLabel}get statics(){return this.mStatics}constructor(t){this.mId=t.id,this.mLabel=t.label,this.mNodesProvider=t.nodes,this.mStatics=t.statics,this.mCodeGenerator=t.generator.code}getNodeDefinitions(t){let e=a=>{if(!a)return new Array;let d=new Array;return a(g=>{d.push(g)},t),d},r={};return Object.defineProperty(r,"entry",{get:()=>e(this.mNodesProvider.entry)}),Object.defineProperty(r,"exit",{get:()=>e(this.mNodesProvider.exit)}),Object.defineProperty(r,"dynamic",{get:()=>e(this.mNodesProvider.dynamic)}),r}},Ot={none:0,imports:1,inputs:2,outputs:4};var Ei=`:host {\r
    display: flex;\r
    flex-direction: column;\r
    height: 100%;\r
    overflow: hidden;\r
...
}`;var Li=`<potatno-resize-box class="resize-box" left="true" top="true">\r
    <div class="header">\r
