...
`;function ds(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=f(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var p=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof p=="function")h=t(p,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var S=p.length-1;S>=0;S--){var M=p[S];if(h=t(M,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var N;r===0?N=h:r===1?(N=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,N!==void 0&&(d===void 0?d=N:typeof d=="function"?d=[d,N]:d.push(N))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,R=0;R<F.length;R++)L=F[R].call(I,L);return L}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var S=h?E:v,M=S.get(d)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!M&&s>2?S.set(d,s):S.set(d,!0)}m(a,x,p,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[P(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function P(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||P(n,v),{e:E,get c(){return T(n,a,v)}}}}function Co(f,t,e,o){return(Co=ds())(f,t,e,o)}var So,To,Mo,No,Eo,Do,Io,hr;So=W({selector:"potatno-function-list",template:xo,style:wo}),Mo=$.state({complexValue:!0}),No=$.state();var Po=class{static{({e:[Eo,Do,Io],c:[hr,To]}=Co(this,[[Mo,1,"documentFunctions"],[No,1,"showPopup"]],[So]))}constructor(t=_.use(K)){this.mManager=t,this.documentFunctions=new Array,this.showPopup=!1,this.mUnsubscribe=this.mManager.subscribe(O.Document|O.Function|O.SpecialActiveFunction,()=>{this.documentFunctions=this.mManager.graph.document?.functions.map(e=>({id:e.id,label:e.label,isSystem:e.isSystem,function:e}))??new Array})}mManager;mUnsubscribe;#t=(Io(this),Eo(this));get documentFunctions(){return this.#t}set documentFunctions(t){this.#t=t}#e=Do(this);get showPopup(){return this.#e}set showPopup(t){this.#e=t}get activeFunctionId(){return this.mManager.activeFunction?.id??""}get userFunctionDefinitions(){return this.mManager.project?[...this.mManager.project.userFunctions.values()]:new Array}createFunction(t){this.showPopup=!1,this.mManager.graph.addFunction(t.id)}deleteFunction(t){this.mManager.graph.removeFunction(t.id)}onDeconstruct(){this.mUnsubscribe()}selectFunction(t){this.mManager.setActiveFunction(t.function)}static{To()}};var Ao=`:host {\r
    display: flex;\r
    flex-direction: column;\r
    position: relative;\r
}\r
...
`;function ps(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=f(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var p=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof p=="function")h=t(p,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var S=p.length-1;S>=0;S--){var M=p[S];if(h=t(M,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var N;r===0?N=h:r===1?(N=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,N!==void 0&&(d===void 0?d=N:typeof d=="function"?d=[d,N]:d.push(N))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,R=0;R<F.length;R++)L=F[R].call(I,L);return L}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var S=h?E:v,M=S.get(d)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!M&&s>2?S.set(d,s):S.set(d,!0)}m(a,x,p,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[P(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function P(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||P(n,v),{e:E,get c(){return T(n,a,v)}}}}function jo(f,t,e,o){return(jo=ps())(f,t,e,o)}var Vo,Ro,zo,_o,Oo,Te;Vo=W({selector:"potatno-resize-box",template:Lo,style:Ao}),zo=$.state({proxy:!0});var Fo=class{static{({e:[_o,Oo],c:[Te,Ro]}=jo(this,[[zo,1,"enabledDirections"],[it,3,"bottom"],[it,3,"left"],[it,3,"right"],[it,3,"top"]],[Vo]))}constructor(t=_.use(G)){this.mComponentElement=t.element,this.enabledDirections={top:!1,right:!1,bottom:!1,left:!1}}mComponentElement;#t=(Oo(this),_o(this));get enabledDirections(){return this.#t}set enabledDirections(t){this.#t=t}get bottom(){return this.enabledDirections.bottom}set bottom(t){this.enabledDirections.bottom=this.parseBoolean(t)}get left(){return this.enabledDirections.left}set left(t){this.enabledDirections.left=this.parseBoolean(t)}get right(){return this.enabledDirections.right}set right(t){this.enabledDirections.right=this.parseBoolean(t)}get top(){return this.enabledDirections.top}set top(t){this.enabledDirections.top=this.parseBoolean(t)}resizeCorner(t){this.handleResize(t,"both")}resizeHorizontal(t){this.handleResize(t,"horizontal")}resizeVertical(t){this.handleResize(t,"vertical")}handleResize(t,e){t.preventDefault(),t.stopPropagation();let o=this.mComponentElement.getBoundingClientRect(),c=o.width,m=o.height,g=t.clientX,y=t.clientY,T=1;Math.abs(g-o.left)<Math.abs(g-o.right)&&(T=-1);let P=1;Math.abs(y-o.top)<Math.abs(y-o.bottom)&&(P=-1);let l=u=>{let a=(u.clientX-g)*T,r=(u.clientY-y)*P,b=c+a,v=m+r;e==="horizontal"&&(b=c),e==="vertical"&&(v=m),this.updateComponentSize(b,v)},n=()=>{document.removeEventListener("pointermove",l),document.removeEventListener("pointerup",n)};document.addEventListener("pointermove",l),document.addEventListener("pointerup",n)}parseBoolean(t){return!!(()=>{if(typeof t=="string"){let o=t.toLowerCase();if(["true","false"].includes(o))return o==="true"}return t})()}updateComponentSize(t,e){(this.enabledDirections.left||this.enabledDirections.right)&&this.mComponentElement.style.setProperty("width",`${t}px`),(this.enabledDirections.top||this.enabledDirections.bottom)&&this.mComponentElement.style.setProperty("height",`${e}px`)}static{Ro()}};var $o=`:host {\r
    position: absolute;\r
    z-index: 200;\r
}\r
\r
...
}`;var Go=`<div class="selection-popup" (pointerdown)="this.stopPropagation($event)" (wheel)="this.stopPropagation($event)" (contextmenu)="this.stopPropagation($event)">\r
...
`;var nn=`<svg #svgLayer class="svg-layer" xmlns="http://www.w3.org/2000/svg" (contextmenu)="this.onConnectionDelete($event)"></svg>\r
`;function xs(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=f(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var p=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof p=="function")h=t(p,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var S=p.length-1;S>=0;S--){var M=p[S];if(h=t(M,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var N;r===0?N=h:r===1?(N=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,N!==void 0&&(d===void 0?d=N:typeof d=="function"?d=[d,N]:d.push(N))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,R=0;R<F.length;R++)L=F[R].call(I,L);return L}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var S=h?E:v,M=S.get(d)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!M&&s>2?S.set(d,s):S.set(d,!0)}m(a,x,p,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[P(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function P(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||P(n,v),{e:E,get c(){return T(n,a,v)}}}}function un(f,t,e,o){return(un=xs())(f,t,e,o)}var hn,sn,dn,an,ln,mr;hn=W({selector:"potatno-connection-layer",template:nn,style:on}),dn=wt("svgLayer");var cn=class{static{({e:[an,ln],c:[mr,sn]}=un(this,[[dn,1,"svgLayer"]],[hn]))}constructor(t=_.use(K)){this.mConnectionRegistry=new Map,this.mManager=t;let e=0;this.mUnsubscribe=this.mManager.subscribe(O.SpecialActiveFunction|O.Node|O.Connection,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.renderConnections()}))})}mConnectionRegistry;mManager;mUnsubscribe;#t=(ln(this),an(this));get svgLayer(){return this.#t}set svgLayer(t){this.#t=t}onConnectionDelete(t){if(!(t.target instanceof Element))return;let e=parseInt(t.target.getAttribute("data-connection-id")??"");if(isNaN(e))return;t.preventDefault(),t.stopPropagation();let o=this.mConnectionRegistry.get(e);o&&this.mManager.graph.disconnectPorts(o.sourcePort,o.targetPort)}onDeconstruct(){this.mUnsubscribe()}renderConnectionPath(t,e,o,c,m){let g="http://www.w3.org/2000/svg",y=this.mManager.connections.getConnectionPath(o,c),T=document.createElementNS(g,"path");T.classList.add("path"),T.classList.toggle(".path--invalid",!m),T.setAttribute("d",y),o.portType==="value"&&T.style.setProperty("--path-color",this.mManager.generateStringColor(o.resolvedDataType));let P=document.createElementNS(g,"path");P.classList.add("path","path--mouse-target"),P.setAttribute("d",y),P.setAttribute("data-connection-id",e.toString()),t.appendChild(T),t.appendChild(P)}renderConnections(){this.svgLayer.innerHTML="",this.mConnectionRegistry.clear();let t=this.mManager.activeFunction;if(!t)return;let e=this.mManager.integrity.errorItems,o=0;for(let c of t.nodes)for(let m of c.outputs.list)for(let g of m.connectedPorts){let y=o++;this.mConnectionRegistry.set(y,{sourcePort:m,targetPort:g});let T=e.has(m)||e.has(g);this.renderConnectionPath(this.svgLayer,y,m,g,!T)}}static{sn()}};function Ts(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=f(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var p=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof p=="function")h=t(p,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var S=p.length-1;S>=0;S--){var M=p[S];if(h=t(M,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var N;r===0?N=h:r===1?(N=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,N!==void 0&&(d===void 0?d=N:typeof d=="function"?d=[d,N]:d.push(N))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,R=0;R<F.length;R++)L=F[R].call(I,L);return L}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var S=h?E:v,M=S.get(d)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!M&&s>2?S.set(d,s):S.set(d,!0)}m(a,x,p,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[P(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function P(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||P(n,v),{e:E,get c(){return T(n,a,v)}}}}function pn(f,t,e,o){return(pn=Ts())(f,t,e,o)}var gn,mn,Ee;gn=vt({access:X.Read,selector:/^potatno-preview$/});var fn=class{static{({c:[Ee,mn]}=pn(this,[],[gn]))}constructor(t=_.use(q),e=_.use(H),o=_.use(et)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(o.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let o=this.mTarget.childNodes.length>0;return o&&(this.mTarget.innerHTML=""),o}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{mn()}};(function(f){f.Function="function",f.Comment="comment",f.Input="input",f.Output="output",f.Reroute="reroute"})(kt||(kt={}));var kt;var vn=`:host {\r
    display: block;\r
    position: relative;\r
\r
...
`;var Pn=`$if(this.nodeData) {
    $if(this.isReroute) {
        <div class="node-reroute {{this.hasErrorClass}}">
    ...
    $if(!this.isReroute) {
    $if(this.isComment) {
        <div class="node-comment {{this.hasErrorClass}}">
    ...
    $if(!this.isComment) {
        <div class="node {{this.hasErrorClass}}">
...
\r
        &.selected {\r
            outline: 2px solid var(--potatno-color-accent);\r
        }\r
    }\r
}\r
\r
...
.selection-box {\r
    ...
    pointer-events: none;\r
    z-index: 1000;\r
}`;var jn=`<div #canvasWrapper class="canvas-wrapper" [style]="this.gridBackgroundStyle" (pointerdown)="this.onCanvasPointerDown($event)" (wheel)="this.onCanvasWheel($event)" (contextmenu)="this.onContextMenu($event)">\r
    <div class="grid" [style]="this.gridTransformStyle">\r
        <potatno-connection-layer/>\r
\r
        $for(nodeState of this.visibleNodes) {\r
            <potatno-node class="grid__node {{this.nodeState.selected ? 'selected' : ''}}" style="left:{{this.nodeState.pixelX}}px; top:{{this.nodeState.pixelY}}px; width:{{this.nodeState.pixelW}}px; height:{{this.nodeState.pixelH}}px;" [nodeData]="this.nodeState.node" (pointerdown)="this.onNodePointerDown($event, this.nodeState.node)" (resize-start)="this.onNodeResizeStart($event)"/>\r
        }\r
    </div>\r
    \r
