...
export class ExpressionModule extends BaseModule<IPwbExpressionModuleProcessor> {
    ...
    public constructor(pParameter: ExpressionModuleConstructorParameter) {
        ...
        this.setProcessorInjection(ExpressionModule, this);
        ...
        this.setProcessorInjection(ModuleExpression, new ModuleExpression(pParameter.targetTemplate.value));
    }
     ...
     */
    public override onUpdate(): boolean {
        // Try to update expression when an onUpdate method is defined.
        let lNewValue: string | null = this.call<IExpressionOnUpdate, 'onUpdate'>('onUpdate');
