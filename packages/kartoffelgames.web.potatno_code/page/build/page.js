...
`)){let d=e.value.split(`
`);u=e.lineNumber+d.length-1,r=1+d[d.length-1].length}else r=e.columnNumber+e.value.length,u=e.lineNumber;return{graph:t.graph,lineStart:e.lineNumber,columnStart:e.columnNumber,lineEnd:u,columnEnd:r}}graphIsCircular(t){let e=this.mGraphStack.top;if(!e.circularGraphs.has(t))return!1;if(t.isJunction){if(e.circularGraphs.get(t)>v.MAX_JUNCTION_CIRCULAR_REFERENCES)throw new N("Junction graph called circular too often.",this);return!1}return!0}moveNextToken(){let t=this.mGraphStack.top;if(t.circularGraphs.size>0&&(t.circularGraphs=new rt),t.graph&&t.graph.isJunction)throw new N("Junction graph must not have own nodes.",this);if(t.token.cursor++,t.token.cursor<this.mTokenCache.length)return;let e=this.mTokenGenerator.next();if(e.done){this.mTokenCache.push(null);return}this.mLastTokenPosition.column=e.value.columnNumber,this.mLastTokenPosition.line=e.value.lineNumber,this.mTokenCache.push(e.value)}popGraphStack(t){let e=this.mGraphStack.pop(),r=this.mGraphStack.top;if(t&&(e.token.cursor=e.token.start),e.token.cursor!==e.token.start&&r.circularGraphs.size>0&&(r.circularGraphs=new rt),!this.mTrimTokenCache){r.token.cursor=e.token.cursor;return}e.linear?(this.mTokenCache.splice(0,e.token.cursor),r.token.start=0,r.token.cursor=0):r.token.cursor=e.token.cursor}pushGraphStack(t,e){let r=this.mGraphStack.top,u={graph:t,linear:e&&r.linear,circularGraphs:new rt(r.circularGraphs),token:{start:r.token.cursor,cursor:r.token.cursor}},d=u.circularGraphs.get(t)??0;u.circularGraphs.set(t,d+1),this.mGraphStack.push(u)}};var xe=class v{static NODE_NULL_RESULT=Symbol("FAILED_NODE_VALUE_PARSE");static NODE_VALUE_LIST_END_MEET=Symbol("FAILED_NODE_VALUE_PARSE");mConfiguration;mLexer;mRootPart;get lexer(){return this.mLexer}constructor(t,e){this.mLexer=t,this.mRootPart=null,this.mConfiguration={keepTraceIncidents:!1,trimTokenCache:!1,...e}}parse(t,e){if(this.mRootPart===null)throw new N("Parser has not root part set.",this);let r=new Be(this.mLexer.tokenize(t,e),this.mConfiguration.keepTraceIncidents,this.mConfiguration.trimTokenCache),u=(()=>{try{return this.beginParseProcess(r,this.mRootPart)}catch(y){if(y instanceof Zt)return r.incidentTrace.push(y.message,r.currentGraph,y.lineStart,y.columnStart,y.lineEnd,y.columnEnd,!0,y),K.PARSER_ERROR;let b=y instanceof Error?y.message:y.toString(),D=r.getGraphPosition();return r.incidentTrace.push(b,r.currentGraph,D.lineStart,D.columnStart,D.lineEnd,D.columnEnd,!0,y),K.PARSER_ERROR}})();if(u===K.PARSER_ERROR)throw new K(r.incidentTrace);let d=r.collapse();if(d.length!==0){let y=d[0];if(r.incidentTrace.top.range.lineEnd===1&&r.incidentTrace.top.range.columnEnd===1){let b=`Tokens could not be parsed. Graph end meet without reaching last token. Current: "${y.value}" (${y.type})`;r.incidentTrace.push(b,this.mRootPart,y.lineNumber,y.columnNumber,y.lineNumber,y.columnNumber)}throw new K(r.incidentTrace)}return u}setRootGraph(t){this.mRootPart=t}beginParseProcess(t,e){t.moveNextToken(),t.processStack.push({type:"graph-parse",parameter:{graph:e,linear:!0},state:0});let r=v.NODE_NULL_RESULT;for(;t.processStack.top;)r=this.processStack(t,t.processStack.top,r);return r}processChainedNodeParseProcess(t,e,r){switch(e.state){case 0:{let y=e.parameter.node.connections.next;return y===null?(t.processStack.pop(),{}):(e.state++,t.processStack.push({type:"node-parse",parameter:{node:y},state:0,values:{}}),v.NODE_NULL_RESULT)}case 1:{let u=r;return u===K.PARSER_ERROR?(t.processStack.pop(),K.PARSER_ERROR):(t.processStack.pop(),u)}}throw new N(`Invalid node next parse state "${e.state}".`,this)}processGraphParseProcess(t,e,r){let u=e.parameter.graph;switch(e.state){case 0:{if(t.graphIsCircular(u)){let y=t.getGraphPosition();return t.incidentTrace.push("Circular graph detected.",u,y.lineStart,y.columnStart,y.lineEnd,y.columnEnd),t.processStack.pop(),K.PARSER_ERROR}let d=e.parameter.linear;return t.pushGraphStack(u,d),e.state++,t.processStack.push({type:"node-parse",parameter:{node:u.node},state:0,values:{}}),v.NODE_NULL_RESULT}case 1:{let d=r;if(d===K.PARSER_ERROR)return t.popGraphStack(!0),t.processStack.pop(),K.PARSER_ERROR;let y=u.convert(d,t);if(typeof y=="symbol"){let b=t.getGraphPosition();return t.incidentTrace.push(y.description??"Unknown data convert error",b.graph,b.lineStart,b.columnStart,b.lineEnd,b.columnEnd),t.popGraphStack(!0),t.processStack.pop(),K.PARSER_ERROR}return t.popGraphStack(!1),t.processStack.pop(),y}}throw new N(`Invalid graph parse state "${e.state}".`,this)}processNodeParseProcess(t,e,r){let u=e.parameter.node;switch(e.state){case 0:return t.processStack.push({type:"node-value-parse",parameter:{node:u,valueIndex:0},state:0,values:{}}),e.state++,v.NODE_NULL_RESULT;case 1:{let d=r;return d===K.PARSER_ERROR?(t.processStack.pop(),K.PARSER_ERROR):(e.values.nodeValueResult=d,t.processStack.push({type:"node-next-parse",parameter:{node:u},state:0}),e.state++,v.NODE_NULL_RESULT)}case 2:{let d=r;if(d===K.PARSER_ERROR)return t.processStack.pop(),K.PARSER_ERROR;let y=u.mergeData(e.values.nodeValueResult,d);return t.processStack.pop(),y}}throw new N(`Invalid node parse state "${e.state}".`,this)}processNodeValueParseProcess(t,e,r){let u=e.parameter.node;switch(e.state){case 0:{if(r!==v.NODE_NULL_RESULT&&r!==K.PARSER_ERROR)return e.values.parseResult=r,e.state++,v.NODE_NULL_RESULT;let d=e.parameter.valueIndex,y=u.connections;if(d>=y.values.length)return e.values.parseResult=v.NODE_VALUE_LIST_END_MEET,e.state++,v.NODE_NULL_RESULT;e.parameter.valueIndex++;let b=t.currentToken,D=y.values[d];if(typeof D=="string"){if(!b){if(y.required){let S=t.getTokenPosition();t.incidentTrace.push(`Unexpected end of statement. Token "${D}" expected.`,t.currentGraph,S.lineStart,S.columnStart,S.lineEnd,S.columnEnd)}return v.NODE_NULL_RESULT}if(D!==b.type){if(y.required){let S=t.getTokenPosition();t.incidentTrace.push(`Unexpected token "${b.value}". "${D}" expected`,t.currentGraph,S.lineStart,S.columnStart,S.lineEnd,S.columnEnd)}return v.NODE_NULL_RESULT}return t.moveNextToken(),b.value}else{let S=y.values.length===1||y.values.length===d+1;return t.processStack.push({type:"graph-parse",parameter:{graph:D,linear:S},state:0}),v.NODE_NULL_RESULT}}case 1:{let d=e.values.parseResult,y=u.connections;if(d===v.NODE_VALUE_LIST_END_MEET&&!y.required){t.processStack.pop();return}return d===v.NODE_VALUE_LIST_END_MEET?(t.processStack.pop(),K.PARSER_ERROR):(t.processStack.pop(),d)}}throw new N(`Invalid node value parse state "${e.state}".`,this)}processStack(t,e,r){switch(e.type){case"graph-parse":return this.processGraphParseProcess(t,e,r);case"node-parse":return this.processNodeParseProcess(t,e,r);case"node-value-parse":return this.processNodeValueParseProcess(t,e,r);case"node-next-parse":return this.processChainedNodeParseProcess(t,e,r)}}};var et=class v{static define(t,e=!1){return new v(t,e)}mDataConverterList;mGraphCollector;mIsJunction;mResolvedGraphNode;get isJunction(){return this.mIsJunction}get node(){return this.mResolvedGraphNode||(this.mResolvedGraphNode=this.mGraphCollector().root),this.mResolvedGraphNode}constructor(t,e){this.mGraphCollector=t,this.mDataConverterList=new Array,this.mResolvedGraphNode=null,this.mIsJunction=e}convert(t,e){if(this.mDataConverterList.length===0)return t;let r=e.getGraphBoundingToken(),u=r[0]??void 0,d=r[1]??void 0;if(this.mDataConverterList.length===1)return this.mDataConverterList[0](t,u,d);let y=t;for(let b of this.mDataConverterList)if(y=b(y,u,d),typeof y=="symbol")return y;return y}converter(t){let e=new v(this.mGraphCollector,this.isJunction);return e.mDataConverterList.push(...this.mDataConverterList,t),e}};var X=class v{static new(){let t=new v("",!1,[]);return t.mRootNode=null,t}mConnections;mIdentifier;mRootNode;get configuration(){return{dataKey:this.mIdentifier.dataKey,isList:this.mIdentifier.type==="list",isRequired:this.mConnections.required,isBranch:this.mConnections.values.length>1}}get connections(){return this.mConnections}get root(){if(!this.mRootNode)throw new N("Staring nodes must be chained with another node to be used.",this);return this.mRootNode}constructor(t,e,r,u){if(t==="")this.mIdentifier={type:"empty",dataKey:"",mergeKey:""};else if(t.endsWith("[]"))this.mIdentifier={type:"list",mergeKey:"",dataKey:t.substring(0,t.length-2)};else if(t.includes("<-")){let y=t.split("<-");this.mIdentifier={type:"merge",dataKey:y[0],mergeKey:y[1]}}else this.mIdentifier={type:"single",mergeKey:"",dataKey:t};let d=r.map(y=>y instanceof v?et.define(()=>y):y);this.mConnections={required:e,values:d,next:null},u?this.mRootNode=u:this.mRootNode=this}mergeData(t,e){if(this.mIdentifier.type==="empty")return e;let r=e,u=typeof t>"u";if(this.mIdentifier.type==="single"){if(this.mIdentifier.dataKey in e)throw new N(`Graph path has a duplicate value identifier "${this.mIdentifier.dataKey}"`,this);return u||(r[this.mIdentifier.dataKey]=t),e}if(this.mIdentifier.type==="list"){let b;u?b=new Array:Array.isArray(t)?b=t:b=[t];let D=(()=>{if(this.mIdentifier.dataKey in e){let S=r[this.mIdentifier.dataKey];return Array.isArray(S)?(S.unshift(...b),S):(b.push(S),b)}return b})();return r[this.mIdentifier.dataKey]=D,e}if(u)return e;let d=(()=>{if(!this.mIdentifier.mergeKey)throw new N("Cant merge data without a merge key.",this);if(typeof t!="object"||t===null)throw new N("Node data must be an object when merge key is set.",this);if(!(this.mIdentifier.mergeKey in t))throw new N(`Node data does not contain merge key "${this.mIdentifier.mergeKey}"`,this);return t[this.mIdentifier.mergeKey]})();if(typeof d>"u")return e;let y=r[this.mIdentifier.dataKey];if(typeof y>"u")return r[this.mIdentifier.dataKey]=d,r;if(!Array.isArray(y))throw new N("Chain data merge value is not an array but should be.",this);return Array.isArray(d)?y.unshift(...d):y.unshift(d),e}optional(t,e){let r=typeof e>"u"?"":t,u=typeof e>"u"?t:e,d=new Array;Array.isArray(u)?d.push(...u):d.push(u);let y=new v(r,!1,d,this.mRootNode);return this.setChainedNode(y),y}required(t,e){let r=typeof e>"u"?"":t,u=typeof e>"u"?t:e,d=new Array;Array.isArray(u)?d.push(...u):d.push(u);let y=new v(r,!0,d,this.mRootNode);return this.setChainedNode(y),y}setChainedNode(t){if(this.mConnections.next!==null)throw new N("Node can only be chained to a single node.",this);this.mConnections.next=t}};var z={XmlIdentifier:"Identifier",XmlAssignment:"XmlAssignment",XmlValue:"XmlValue",XmlComment:"XmlComment",XmlOpenClosingBracket:"XmlOpenClosingBracket",XmlCloseBracket:"XmlCloseBracket",XmlOpenBracket:"XmlOpenBracket",XmlCloseClosingBracket:"XmlCloseClosingBracket",XmlExplicitValueIdentifier:"XmlExplicitValueIdentifier",ExpressionStart:"ExpressionStart",ExpressionEnd:"ExpressionEnd",ExpressionValue:"ExpressionValue",InstructionStart:"InstructionStart",InstructionInstructionValue:"InstructionInstructionValue",InstructionBodyStartBraket:"InstructionBodyStartBraket",InstructionBodyCloseBraket:"InstructionBodyCloseBraket",InstructionInstructionClosingBracket:"InstructionInstructionClosingBracket",InstructionInstructionOpeningBracket:"InstructionInstructionOpeningBracket"};var Ue=class extends we{constructor(){super(),this.validWhitespaces=` 
\r`,this.trimWhitespace=!0;let t=this.createTokenPattern({pattern:{regex:/(?:(?!}}).)*/,type:z.ExpressionValue}}),e=this.createTokenPattern({pattern:{start:{regex:/{{/,type:z.ExpressionStart},end:{regex:/}}[ \n\r]?/,type:z.ExpressionEnd}}},s=>{s.useChildPattern(t)}),r=this.createTokenPattern({pattern:{regex:/[^>\s\n="/]+/,type:z.XmlIdentifier}}),u=this.createTokenPattern({pattern:{regex:/(?:(?!{{|"|<).)+/,type:z.XmlValue}}),d=this.createTokenPattern({pattern:{regex:/<!--.*?-->/,type:z.XmlComment}}),y=this.createTokenPattern({pattern:{regex:/=/,type:z.XmlAssignment}}),b=this.createTokenPattern({pattern:{start:{regex:/"/,type:z.XmlExplicitValueIdentifier},end:{regex:/"/,type:z.XmlExplicitValueIdentifier}}},s=>{s.useChildPattern(e),s.useChildPattern(u)}),D=this.createTokenPattern({pattern:{start:{regex:/<\//,type:z.XmlOpenClosingBracket},end:{regex:/>/,type:z.XmlCloseBracket}}},s=>{s.useChildPattern(r)}),S=this.createTokenPattern({pattern:{start:{regex:/</,type:z.XmlOpenBracket},end:{regex:/(?<closeClosingBracket>\/>)|(?<closeBracket>>)/,type:{closeClosingBracket:z.XmlCloseClosingBracket,closeBracket:z.XmlCloseBracket}}}},s=>{s.useChildPattern(y),s.useChildPattern(r),s.useChildPattern(b)}),l=this.createTokenPattern({pattern:{regex:/[^()"'`/)]+/,type:z.InstructionInstructionValue}}),n=this.createTokenPattern({pattern:{innerType:z.InstructionInstructionValue,start:{regex:/\//,type:z.InstructionInstructionValue},end:{regex:/\//,type:z.InstructionInstructionValue}}},s=>{s.useChildPattern(c),s.useChildPattern(o),s.useChildPattern(w),s.useChildPattern(h),s.useChildPattern(l)}),h=this.createTokenPattern({pattern:{innerType:z.InstructionInstructionValue,start:{regex:/\(/,type:z.InstructionInstructionValue},end:{regex:/\)/,type:z.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(c),s.useChildPattern(o),s.useChildPattern(w),s.useChildPattern(l)}),c=this.createTokenPattern({pattern:{innerType:z.InstructionInstructionValue,start:{regex:/"/,type:z.InstructionInstructionValue},end:{regex:/"/,type:z.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(o),s.useChildPattern(w),s.useChildPattern(h),s.useChildPattern(l)}),o=this.createTokenPattern({pattern:{innerType:z.InstructionInstructionValue,start:{regex:/'/,type:z.InstructionInstructionValue},end:{regex:/'/,type:z.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(c),s.useChildPattern(w),s.useChildPattern(h),s.useChildPattern(l)}),w=this.createTokenPattern({pattern:{innerType:z.InstructionInstructionValue,start:{regex:/`/,type:z.InstructionInstructionValue},end:{regex:/`/,type:z.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(c),s.useChildPattern(o),s.useChildPattern(h),s.useChildPattern(l)}),p=this.createTokenPattern({pattern:{regex:/\$[^(\s\n/{]+/,type:z.InstructionStart}}),T=this.createTokenPattern({pattern:{start:{regex:/\(/,type:z.InstructionInstructionOpeningBracket},end:{regex:/\)/,type:z.InstructionInstructionClosingBracket}}},s=>{s.useChildPattern(n),s.useChildPattern(c),s.useChildPattern(o),s.useChildPattern(w),s.useChildPattern(h),s.useChildPattern(l)}),x=this.createTokenPattern({pattern:{start:{regex:/{/,type:z.InstructionBodyStartBraket},end:{regex:/}/,type:z.InstructionBodyCloseBraket}}},s=>{for(let f of m)s.useChildPattern(f)}),m=[d,D,S,b,e,p,T,x,u];for(let s of m)this.useRootTokenPattern(s)}};var Te=class extends xe{constructor(){super(new Ue),this.initGraph()}initGraph(){let t=et.define(()=>X.new().required(z.ExpressionStart).optional("value",z.ExpressionValue).required("end",z.ExpressionEnd)).converter(o=>({expression:new At(o.value??""),hasTrailingWhitespace:o.end.length>2})),e=et.define(()=>{let o=e;return X.new().required("data[]",X.new().required("value",[t,X.new().required("text",z.XmlValue)])).optional("data<-data",o)}),r=et.define(()=>X.new().required("name",z.XmlIdentifier).optional("attributeValue",X.new().required(z.XmlAssignment).required(z.XmlExplicitValueIdentifier).optional("list<-data",e).required(z.XmlExplicitValueIdentifier))).converter(o=>{let w=new Array;if(o.attributeValue?.list)for(let p of o.attributeValue.list)"expression"in p.value?(w.push(p.value.expression),p.value.hasTrailingWhitespace&&w.push(" ")):w.push(p.value.text);return{name:o.name,values:w}}),u=et.define(()=>{let o=u;return X.new().required("data[]",r).optional("data<-data",o)}),d=et.define(()=>{let o=d;return X.new().required("data[]",X.new().required("value",[t,X.new().required("text",z.XmlValue),X.new().required(z.XmlExplicitValueIdentifier).required("text",z.XmlValue).required(z.XmlExplicitValueIdentifier)])).optional("data<-data",o)}),y=et.define(()=>X.new().required("list<-data",d)).converter(o=>{let w=new Lt;for(let p of o.list)"expression"in p.value?(w.addValue(p.value.expression),p.value.hasTrailingWhitespace&&w.addValue(" ")):w.addValue(p.value.text);return w}),b=et.define(()=>X.new().required(z.XmlComment)).converter(()=>null),D=et.define(()=>X.new().required(z.XmlOpenBracket).required("openingTagName",z.XmlIdentifier).optional("attributes<-data",u).required("closing",[X.new().required(z.XmlCloseClosingBracket),X.new().required(z.XmlCloseBracket).required("values",h).required(z.XmlOpenClosingBracket).required("closingTageName",z.XmlIdentifier).required(z.XmlCloseBracket)])).converter(o=>{if("closingTageName"in o.closing&&o.openingTagName!==o.closing.closingTageName)throw new N(`Opening (${o.openingTagName}) and closing tagname (${o.closing.closingTageName}) does not match`,this);let w=new Rt(o.openingTagName);if(o.attributes)for(let p of o.attributes)w.setAttribute(p.name).addValue(...p.values);return"values"in o.closing&&w.appendChild(...o.closing.values),w}),S=et.define(()=>{let o=S;return X.new().required("list[]",z.InstructionInstructionValue).optional("list<-list",o)}),l=et.define(()=>X.new().required("instructionName",z.InstructionStart).optional("instruction",X.new().required(z.InstructionInstructionOpeningBracket).required("value<-list",S).required(z.InstructionInstructionClosingBracket)).optional("body",X.new().required(z.InstructionBodyStartBraket).required("value",h).required(z.InstructionBodyCloseBraket))).converter(o=>{let w=o.instructionName.substring(1),p=o.instruction?.value.join("")??"",T=new Wt(w,p);return o.body&&T.appendChild(...o.body.value),T}),n=et.define(()=>{let o=n;return X.new().required("list[]",[b,D,l,y]).optional("list<-list",o)}),h=et.define(()=>{let o=n;return X.new().optional("list<-list",o)}).converter(o=>{let w=new Array;if(o.list)for(let p of o.list)p!==null&&w.push(p);return w}),c=et.define(()=>X.new().required("content",h)).converter(o=>{let w=new dt;return w.appendChild(...o.content),w});this.setRootGraph(c)}};var G=class v extends Fe{static mTemplateCache=new rt;static mXmlParser=new Te;mComponentElement;mIsUpdated;mRootBuilder;get element(){return this.mComponentElement.htmlElement}constructor(t){super({constructor:t.processorConstructor,parent:null}),Q.registerComponent(this,t.htmlElement),this.setProcessorInjection(v,this),this.addConstructionHook(u=>{Q.registerComponent(this,this.mComponentElement.htmlElement,u)}),v.mTemplateCache.has(t.processorConstructor)||v.mTemplateCache.set(t.processorConstructor,v.mXmlParser.parse(t.templateString??""));let e=v.mTemplateCache.get(t.processorConstructor).clone();this.mIsUpdated=!1,this.mComponentElement=new be(t.htmlElement),this.mRootBuilder=new te(e,new $e(this,t.expressionModule),new gt(this),"ROOT",null),this.mComponentElement.shadowRoot.appendChild(this.mRootBuilder.anchor),this.setProcessorInjection(Pt,new Pt(this.mRootBuilder.values));let r=this.updater.zone.getAttachment(Ct.ATTACHMENT_KEY);if(r)for(let[u,d]of r.injections)this.setProcessorInjection(u,d)}addStyle(t){let e=document.createElement("style");e.innerHTML=t,this.mComponentElement.shadowRoot.prepend(e)}attributeChanged(t,e,r){this.call("onAttributeChange",t,e,r)}connected(){this.mIsUpdated||this.updater.update(),this.call("onConnect")}deconstruct(){this.call("onDeconstruct"),this.mRootBuilder.deconstruct(),super.deconstruct()}disconnected(){this.call("onDisconnect")}onUpdate(){return this.mIsUpdated||(this.mIsUpdated=!0),this.mRootBuilder.update()?(this.call("onUpdate"),!0):!1}};function B(v){return(t,e)=>{O.registerInjectable(t,e.metadata,"instanced"),Q.registerConstructor(t,v.selector);let r=class extends HTMLElement{mComponent;constructor(){super(),this.mComponent=new G({processorConstructor:t,templateString:v.template??null,expressionModule:v.expressionmodule,htmlElement:this}).setup(),v.style&&this.mComponent.addStyle(v.style)}connectedCallback(){this.mComponent.connected()}disconnectedCallback(){this.mComponent.disconnected()}};globalThis.customElements.define(v.selector,r)}}function qt(v){return(t,e)=>{O.registerInjectable(t,e.metadata,"instanced"),ft.register($t,t,{access:v.access,targetRestrictions:v.targetRestrictions})}}function It(v){return(t,e)=>{O.registerInjectable(t,e.metadata,"instanced"),ft.register(Et,t,{access:v.access,selector:v.selector})}}function Ot(v){return(t,e)=>{O.registerInjectable(t,e.metadata,"instanced"),ft.register(Xt,t,{instructionType:v.instructionType})}}function ks(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,T,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,T,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,w,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,w,p=new Map,T=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function zo(v,t,e,r){return(zo=ks())(v,t,e,r)}function ta(v){return v}var jo,Fo,De;jo=qt({access:J.Read,targetRestrictions:[G]});new class extends ta{constructor(){super(De),Fo()}static{class v{static{({c:[De,Fo]}=zo(this,[],[jo]))}static METADATA_USER_EVENT_LISTENER_PROPERIES="pwb:user_event_listener_properties";mEventListenerList;mTargetElement;constructor(e=O.use(G)){let r=new Array,u=e.processorConstructor;do{let d=lt.get(u).getMetadata(v.METADATA_USER_EVENT_LISTENER_PROPERIES);if(d)for(let y of d)r.push(y)}while(u=Object.getPrototypeOf(u));this.mEventListenerList=new Array,this.mTargetElement=e.element;for(let d of r){let[y,b]=d,D=Reflect.get(e.processor,y);D=D.bind(e.processor),this.mEventListenerList.push([b,D]),this.mTargetElement.addEventListener(b,D)}}onDeconstruct(){for(let e of this.mEventListenerList){let[r,u]=e;this.mTargetElement.removeEventListener(r,u)}}}}};var Ee=class extends window.Event{mValue;get value(){return this.mValue}constructor(t,e){super(t),this.mValue=e}};var Ie=class{mElement;mEventName;constructor(t,e){this.mEventName=t,this.mElement=e}dispatchEvent(t){let e=new Ee(this.mEventName,t);this.mElement.dispatchEvent(e)}};function ut(v){return(t,e)=>{if(e.static)throw new N("Event target is not for a static property.",ut);let r=new WeakMap;return{get(){if(!r.has(this)){let u=(()=>{try{return Q.ofProcessor(this).component}catch{throw new N("PwbComponentEvent target class is not a component.",this)}})();r.set(this,new Ie(v,u.element))}return r.get(this)}}}}function ea(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,T,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,T,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,w,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,w,p=new Map,T=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function $o(v,t,e,r){return($o=ea())(v,t,e,r)}function oa(v){return v}var Go,Vo,Ce;Go=qt({access:J.ReadWrite,targetRestrictions:[G]});new class extends oa{constructor(){super(Ce),Vo()}static{class v{static{({c:[Ce,Vo]}=$o(this,[],[Go]))}static METADATA_EXPORTED_PROPERTIES="pwb:exported_properties";mComponent;constructor(e=O.use(G)){this.mComponent=e;let r=new Ht,u=e.processorConstructor;do{let y=lt.get(u).getMetadata(v.METADATA_EXPORTED_PROPERTIES);y&&r.push(...y)}while(u=Object.getPrototypeOf(u));let d=new Set(r);d.size>0&&this.connectExportedProperties(d)}connectExportedProperties(e){this.exportPropertyAsAttribute(e),this.patchHtmlAttributes(e)}exportPropertyAsAttribute(e){for(let r of e){let u={};u.enumerable=!0,u.configurable=!0,delete u.value,delete u.writable,u.set=d=>{Reflect.set(this.mComponent.processor,r,d)},u.get=()=>{let d=Reflect.get(this.mComponent.processor,r);return typeof d=="function"&&(d=d.bind(this.mComponent.processor)),d},Object.defineProperty(this.mComponent.element,r,u)}}patchHtmlAttributes(e){let r=this.mComponent.element,u=r.getAttribute,d=r.setAttribute,y=(S,l,n)=>(Reflect.set(r,S,n),this.mComponent.attributeChanged(S,l,n),!0),b=new Map;new MutationObserver(S=>{for(let l of S){let n=l.attributeName,h=u.call(r,n);b.get(n)!==h&&y(n,l.oldValue,h)}}).observe(r,{attributeFilter:[...e],attributeOldValue:!0});for(let S of e)if(r.hasAttribute(S)){let l=u.call(r,S);y(S,l,l)}r.setAttribute=(S,l)=>{let n=u.call(r,S);d.call(r,S,l),e.has(S)&&(b.set(S,l.toString()),d.call(r,S,l),y(S,n,l))},r.getAttribute=S=>e.has(S)?Reflect.get(r,S):u.call(r,S)}}}};function W(v,t){if(t.static)throw new N("Event target is not for a static property.",W);let e=lt.forInternalDecorator(t.metadata),r=e.getMetadata(Ce.METADATA_EXPORTED_PROPERTIES)??new Array;r.push(t.name),e.setMetadata(Ce.METADATA_EXPORTED_PROPERTIES,r)}function yt(v){return(t,e)=>{if(e.static)throw new N("Child decorator is not for a static property.",yt);return{get(){let d=(()=>{try{return Q.ofProcessor(this).component}catch{throw new N("PwbChild target class is not a component.",this)}})().getProcessorInjection(Pt).data.store[v];return d instanceof Element?d:null}}}}function ra(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,T,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,T,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,w,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,w,p=new Map,T=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function Xo(v,t,e,r){return(Xo=ra())(v,t,e,r)}var Ho,Bo,na;Ho=Ot({instructionType:"dynamic-content"});var Uo=class{static{({c:[na,Bo]}=Xo(this,[],[Ho]))}constructor(t=O.use(ot),e=O.use(Y)){this.mModuleValues=e,this.mLastTemplate=null,this.mProcedure=this.mModuleValues.createExpressionProcedure(t.value)}mLastTemplate;mModuleValues;mProcedure;onUpdate(){let t=this.mProcedure.execute();if(!t||!(t instanceof dt))throw new N("Dynamic content method has a wrong result type.",this);if(this.mLastTemplate!==null&&this.mLastTemplate.equals(t))return null;let e=t.clone();this.mLastTemplate=e;let r=new mt;return r.addElement(e,new gt(this.mModuleValues.data),null),r}static{Bo()}};function ia(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,T,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,T,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,w,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,w,p=new Map,T=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function Zo(v,t,e,r){return(Zo=ia())(v,t,e,r)}var qo,Yo,sa;qo=It({access:J.Write,selector:/^\([[\w\-$]+\)$/});var Wo=class{static{({c:[sa,Yo]}=Zo(this,[],[qo]))}constructor(t=O.use(tt),e=O.use(Y),r=O.use(it)){this.mTarget=t,this.mEventName=r.name.substring(1,r.name.length-1);let u=e.createExpressionProcedure(r.value,["$event"]);this.mListener=d=>{u.setTemporaryValue("$event",d),u.execute()},this.mTarget.addEventListener(this.mEventName,this.mListener)}mEventName;mListener;mTarget;onDeconstruct(){this.mTarget.removeEventListener(this.mEventName,this.mListener)}static{Yo()}};function aa(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,T,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,T,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,w,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,w,p=new Map,T=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function Qo(v,t,e,r){return(Qo=aa())(v,t,e,r)}function la(v){return v}var ko,Jo,Ko;ko=Ot({instructionType:"for"});new class extends la{constructor(){super(Ko),Jo()}static{class v{static{({c:[Ko,Jo]}=Qo(this,[],[ko]))}static REGEX_HEAD=new RegExp(/^\s*([a-zA-Z]+[a-zA-Z0-9]*)\s*of\s+([^;]+)\s*(?:;(.*))?$/);static REGEX_MODIFIER_INSTRUCTION=new RegExp(/^\s*(\$?[a-zA-Z]+[a-zA-Z0-9]*)\s*=\s*(.+?)\s*$/);mExpression;mLastEntries;mModuleValues;mTemplate;constructor(e=O.use(vt),r=O.use(Y),u=O.use(ot)){this.mTemplate=e,this.mModuleValues=r,this.mLastEntries=new Array;let d=u.value,y=v.REGEX_HEAD.exec(d);if(!y)throw new N(`For-Parameter value has wrong format: ${d}`,this);let b=y[1],D=y[2],S=y[3]?y[3].split(";"):new Array,l=new Array;for(let n of S){let h=v.REGEX_MODIFIER_INSTRUCTION.exec(n);if(!h)throw new N(`For-Parameter optional instruction has wrong format: ${n}`,this);l.push({variableName:h[1],procedure:this.mModuleValues.createExpressionProcedure(h[2],["$index",b])})}this.mExpression={iterateVariableName:b,iterateValueProcedure:this.mModuleValues.createExpressionProcedure(D),modifier:l}}onUpdate(){let e=new mt,r=this.mExpression.iterateValueProcedure.execute();if(typeof r=="object"&&r!==null||Array.isArray(r)){let u=Symbol.iterator in r?Object.entries([...r]):Object.entries(r);if(this.compareEntries(u,this.mLastEntries))return null;this.mLastEntries=u;for(let[d,y]of u)this.addTemplateForElement(e,this.mExpression,y,d);return e}else return null}addTemplateForElement=(e,r,u,d)=>{let y=new gt(this.mModuleValues.data);y.setTemporaryValue(r.iterateVariableName,u);let b=u;for(let S of r.modifier){S.procedure.setTemporaryValue("$index",d),S.procedure.setTemporaryValue(r.iterateVariableName,u);let l=S.procedure.execute();if(S.variableName==="$key"){b=l;continue}y.setTemporaryValue(S.variableName,l)}let D=new dt;D.appendChild(...this.mTemplate.childList),e.addElement(D,y,b)};compareEntries(e,r){if(e.length!==r.length)return!1;for(let u=0;u<e.length;u++){let[d,y]=e[u],[b,D]=r[u];if(d!==b||y!==D)return!1}return!0}}}};function ca(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,T,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,T,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,w,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,w,p=new Map,T=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function or(v,t,e,r){return(or=ca())(v,t,e,r)}var rr,tr,ua;rr=Ot({instructionType:"if"});var er=class{static{({c:[ua,tr]}=or(this,[],[rr]))}constructor(t=O.use(vt),e=O.use(Y),r=O.use(ot)){this.mTemplateReference=t,this.mModuleValues=e,this.mProcedure=this.mModuleValues.createExpressionProcedure(r.value),this.mLastBoolean=!1}mLastBoolean;mModuleValues;mProcedure;mTemplateReference;onUpdate(){let t=this.mProcedure.execute();if(!!t!==this.mLastBoolean){this.mLastBoolean=!!t;let e=new mt;if(t){let r=new dt;r.appendChild(...this.mTemplateReference.childList),e.addElement(r,new gt(this.mModuleValues.data),null)}return e}else return null}static{tr()}};function ha(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,T,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,T,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,w,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,w,p=new Map,T=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function sr(v,t,e,r){return(sr=ha())(v,t,e,r)}var ar,nr,fa;ar=It({access:J.Read,selector:/^\[[\w$]+\]$/});var ir=class{static{({c:[fa,nr]}=sr(this,[],[ar]))}constructor(t=O.use(tt),e=O.use(Y),r=O.use(it)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(r.value),this.mTargetProperty=r.name.substring(1,r.name.length-1),this.mLastValue=Symbol("Uncomparable")}mLastValue;mProcedure;mTarget;mTargetProperty;onUpdate(){let t=this.mProcedure.execute();return t===this.mLastValue?!1:(this.mLastValue=t,Reflect.set(this.mTarget,this.mTargetProperty,t),!0)}static{nr()}};function da(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,T,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,T,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,w,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,w,p=new Map,T=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function ur(v,t,e,r){return(ur=da())(v,t,e,r)}var hr,lr,ma;hr=It({access:J.Write,selector:/^#[[\w$]+$/});var cr=class{static{({c:[ma,lr]}=ur(this,[],[hr]))}constructor(t=O.use(tt),e=O.use(it),r=O.use(Pt)){this.mChildName=e.name.substring(1),this.mComponentScopeValue=r,this.mTargetNode=t,this.mComponentScopeValue.setTemporaryValue(this.mChildName,this.mTargetNode)}mChildName;mComponentScopeValue;mTargetNode;onDeconstruct(){this.mComponentScopeValue.data.store[this.mChildName]===this.mTargetNode&&this.mComponentScopeValue.data.deleteTemporaryValue(this.mChildName)}static{lr()}};function pa(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,T,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,T,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,w,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,w,p=new Map,T=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function mr(v,t,e,r){return(mr=pa())(v,t,e,r)}var pr,fr,ga;pr=Ot({instructionType:"slot"});var dr=class{static{({c:[ga,fr]}=mr(this,[],[pr]))}constructor(t=O.use(Y),e=O.use(ot)){this.mModuleValues=t,this.mSlotName=e.value,this.mIsSetup=!1}mIsSetup;mModuleValues;mSlotName;onUpdate(){if(this.mIsSetup)return null;this.mIsSetup=!0;let t=new Rt("slot");this.mSlotName!==""&&t.setAttribute("name").addValue(this.mSlotName);let e=new dt;e.appendChild(t);let r=new mt;return r.addElement(e,this.mModuleValues.data,null),r}static{fr()}};function va(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,T,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,T,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,w,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,w,p=new Map,T=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function yr(v,t,e,r){return(yr=va())(v,t,e,r)}var br,gr,ya;br=It({access:J.ReadWrite,selector:/^\[\([[\w$]+\)\]$/});var vr=class{static{({c:[ya,gr]}=yr(this,[],[br]))}constructor(t=O.use(G),e=O.use(tt),r=O.use(Y),u=O.use(it)){this.mTargetNode=e,this.mAttributeKey=u.name.substring(2,u.name.length-2),this.mReadProcedure=r.createExpressionProcedure(u.value),this.mWriteProcedure=r.createExpressionProcedure(`${u.value} = $DATA;`,["$DATA"]),this.mLastDataValue=Symbol("Uncomparable");let d=y=>{this.mLastDataValue!==y&&t.updater.updateAsync()};this.mTargetNode.addEventListener("input",y=>{d(Reflect.get(this.mTargetNode,this.mAttributeKey))}),this.mTargetNode.addEventListener("change",y=>{d(Reflect.get(this.mTargetNode,this.mAttributeKey))})}mAttributeKey;mLastDataValue;mReadProcedure;mTargetNode;mWriteProcedure;onUpdate(){let t=this.mReadProcedure.execute();if(t!==this.mLastDataValue)return Reflect.set(this.mTargetNode,this.mAttributeKey,t),this.mLastDataValue=t,!0;let e=Reflect.get(this.mTargetNode,this.mAttributeKey);return e!==t?(this.mWriteProcedure.setTemporaryValue("$DATA",e),this.mWriteProcedure.execute(),this.mLastDataValue=e,!0):!1}static{gr()}};function ba(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,T,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,T,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,w,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,w,p=new Map,T=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function Tr(v,t,e,r){return(Tr=ba())(v,t,e,r)}var Dr,wr,wa;Dr=qt({access:J.Read,targetRestrictions:[Et]});var xr=class{static{({c:[wa,wr]}=Tr(this,[],[Dr]))}constructor(t=O.use(Et),e=O.use(tt)){let r=new Array,u=t.processorConstructor;do{let d=lt.get(u).getMetadata(De.METADATA_USER_EVENT_LISTENER_PROPERIES);if(d)for(let y of d)r.push(y)}while(u=Object.getPrototypeOf(u));this.mEventListenerList=new Array,this.mTargetElement=e;for(let d of r){let[y,b]=d,D=Reflect.get(t.processor,y);D=D.bind(t.processor),this.mEventListenerList.push([b,D]),this.mTargetElement.addEventListener(b,D)}}mEventListenerList;mTargetElement;onDeconstruct(){for(let t of this.mEventListenerList){let[e,r]=t;this.mTargetElement.removeEventListener(e,r)}}static{wr()}};var Er=`:host {\r
    display: block;\r
    width: 100%;\r
    height: 100%;\r
}\r
...
potatno-code-editor {\r
    ...
    width: 100%;\r
    height: 100%;\r
}`;var re=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new jt(this.mProject),r=[];for(let u of t.functions){let d=this.deserializeFunctionHead(u,e);r.push([d,u]),e.addFunction(d)}for(let[u,d]of r)this.deserializeFunctionBody(u,d,e);return e}deserializeFunctionBody(t,e,r){let u=new Map;for(let d of e.nodes)u.set(d.id,this.deserializeNode(d,t,r));for(let d of e.connections){if(!u.has(d.sourceNodeId)||!u.has(d.targetNodeId))continue;let y=u.get(d.sourceNodeId),b=u.get(d.targetNodeId),D=y.outputs.map.get(d.sourcePortId),S=b.inputs.map.get(d.targetPortId);!D||!S||D.connect(S)}}deserializeFunctionHead(t,e){let r=new at(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let u of t.imports)r.addImport(u);for(let u of t.inputs)r.addInput({label:u.label,dataType:u.dataType});for(let u of t.outputs)r.addOutput({label:u.label,dataType:u.dataType});return r}deserializeNode(t,e,r){let u=r.nodeDefinitions.find(y=>y.id===t.definitionId),d=(()=>{if(u)return e.addNodeByDefinition(u,t.transformation);let y=t.ports.filter(D=>D.direction==="input").map(D=>({dataType:D.dataType,definitionId:D.definitionId,label:D.label,portType:D.portType})),b=t.ports.filter(D=>D.direction==="output").map(D=>({dataType:D.dataType,definitionId:D.definitionId,label:D.label,portType:D.portType}));return new pt(this.mProject,r,e,{definitionId:t.definitionId,ports:{input:y,output:b},label:t.label,transformation:{...t.transformation}})})();d.label=t.label,e.addNode(d);for(let y of t.ports)if(y.portType==="value"&&y.directValue.length>0){let b=d.inputs.map.get(y.definitionId);b&&b.setDirectValue(y.directValue)}return d.preview=t.preview??null,d}};var ne=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((b,D)=>{e.set(b,`n${D}`)});let r=[...t.nodes].map(b=>this.serializeNode(b,e.get(b))),u=[];for(let b of t.nodes){let D=e.get(b);for(let S of b.outputs.list)for(let l of S.connectedPorts){let n=e.get(l.node);u.push({sourceNodeId:D,sourcePortId:S.definitionId,targetNodeId:n,targetPortId:l.definitionId})}}let d=t.inputs.map(b=>({label:b.label,dataType:b.dataType})),y=t.outputs.map(b=>({label:b.label,dataType:b.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:d,outputs:y,imports:[...t.imports],nodes:r,connections:u}}serializeNode(t,e){let r=[...t.inputs.list,...t.outputs.list].map(d=>({definitionId:d.definitionId,label:d.label,direction:d.direction,portType:d.portType,dataType:d.portType==="value"?d.dataType:null,directValue:[...d.directValue]})),u=t.preview?{portDefinitionId:t.preview.portDefinitionId,displayId:t.preview.displayId}:null;return{id:e,definitionId:t.definitionId,label:t.label,transformation:{...t.transformation},ports:r,preview:u}}};var Ir=`:host {\r
    /* Globals */\r
 ...
 * Secondary\r
 */\r
:host(:hover):has(.secondary) {\r
    background-color: color-mix(in srgb, var(--button-background-color) 75%, transparent);\r
}\r
\r
:host(:active):has(.secondary) {\r
    background-color: color-mix(in srgb, var(--button-background-color) 50%, transparent);\r
    scale: 0.98;\r
}\r
\r
/* \r
...
\r
:host(:active):has(.selectable)::before {\r
    opacity: 0.8;\r
}\r
\r
:host:has(.selectable.selected) {\r
    color: var(--potatno-color-text-contrast);\r
\r
    &::before {\r
        opacity: 1;\r
...
`;var Pr=`<div class="button {{this.type}} {{this.selected ? 'selected' : ''}}" (click)="this.onClick()">\r
    $slot\r
</div>\r
`;function Ia(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,T,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,T,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,w,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,w,p=new Map,T=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function Rr(v,t,e,r){return(Rr=Ia())(v,t,e,r)}var Or,Mr,Fr,zr,jr,Sr,_r,Nr,Ar,Vr;Or=B({selector:"kg-button",template:Pr,style:Cr}),Fr=ut("select"),zr=$.state(),jr=$.state();var Lr=class{static{({e:[Sr,_r,Nr,Ar],c:[Vr,Mr]}=Rr(this,[[Fr,1,"mSelect"],[zr,1,"mSelected"],[jr,1,"mType"],[W,3,"selected"],[W,3,"type"]],[Or]))}constructor(){this.mType="primary",this.mSelected=!1}#t=(Ar(this),Sr(this));get mSelect(){return this.#t}set mSelect(t){this.#t=t}#e=_r(this);get mSelected(){return this.#e}set mSelected(t){this.#e=t}#o=Nr(this);get mType(){return this.#o}set mType(t){this.#o=t}get selected(){return this.mSelected}set selected(t){this.mSelected=this.parseBoolean(t)}get type(){return this.mType}set type(t){if(t!=="primary"&&t!=="secondary"&&t!=="selectable"){this.mType="secondary";return}this.mType=t}onClick(){this.mType==="selectable"&&(this.mSelected=!0,this.mSelect.dispatchEvent(this.mSelected))}parseBoolean(t){if(typeof t=="string"){let e=t.toLowerCase();if(e==="true"||e==="false")return e==="true"}return!!t}static{Mr()}};var $r=`:host {
...
@position-try --kg-information-top-left {
    ...
    bottom: calc(anchor(top) + 10px);
    left: auto;
}`;var Gr=`<div class="icon">i</div>
<div class="information">
    $slot
</div>
`;function Ma(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,T,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,T,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,w,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,w,p=new Map,T=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function Xr(v,t,e,r){return(Xr=Ma())(v,t,e,r)}var Hr,Br,Yr;Hr=B({selector:"kg-information",template:Gr,style:$r});var Ur=class{static{({c:[Yr,Br]}=Xr(this,[],[Hr]))}static{Br()}};var Wr=`:host {\r
...
}`;var Zr="$slot";function Na(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,T,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,T,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,w,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,w,p=new Map,T=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function Kr(v,t,e,r){return(Kr=Na())(v,t,e,r)}var Qr,qr,ie;Qr=B({selector:"kg-popup",template:Zr,style:Wr});var Jr=class{static{({c:[ie,qr]}=Kr(this,[],[Qr]))}static{qr()}};var kr=`:host {\r
    position: relative;\r
    display: flex;\r
    flex-direction: column;\r
\r
...
}`;var mn=`<kg-resize-box class="resize-box" right="true">\r
...
`;function ka(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,T,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,T,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,w,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,w,p=new Map,T=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function Oi(v,t,e,r){return(Oi=ka())(v,t,e,r)}var Fi,Ni,zi,Ai,Li,Io;Fi=B({selector:"potatno-connection-layer",template:_i,style:Si}),zi=$.state({complexValue:!0});var Ri=class{static{({e:[Ai,Li],c:[Io,Ni]}=Oi(this,[[zi,1,"connections"]],[Fi]))}constructor(t=O.use(H)){this.mManager=t,this.connections=new Map;let e=0;this.mUnsubscribe=this.mManager.subscribe(R.SpecialActiveFunction|R.Node|R.Connection,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.updateConnections()}))})}mManager;mUnsubscribe;#t=(Li(this),Ai(this));get connections(){return this.#t}set connections(t){this.#t=t}createConjunction(t,e){t.preventDefault(),t.stopPropagation();let r=e.port.output.portType==="flow"?this.mManager.project.nodeDefinitions.get(Z.DEFINITION_ID):this.mManager.project.nodeDefinitions.get(k.DEFINITION_ID),u=this.mManager.grid.pixelToGridSpace(t.clientX,t.clientY),d=this.mManager.graph.addNode(this.mManager.activeFunction,r,{x:u.x,y:u.y,height:0,width:0});this.mManager.graph.disconnectPorts(e.port.output,e.port.input);let y=d.inputs.list[0],b=d.outputs.list[0];this.mManager.graph.connectPorts(y,e.port.output),this.mManager.graph.connectPorts(y,e.port.input),this.mManager.graph.connectPorts(b,e.port.output),this.mManager.graph.connectPorts(b,e.port.input)}deleteConnection(t,e){t.button===2&&(t.preventDefault(),t.stopPropagation(),this.mManager.graph.disconnectPorts(e.port.output,e.port.input))}onDeconstruct(){this.mUnsubscribe()}createConnection(t,e,r){let u=this.mManager.integrity.errorItems,d=u.has(e)||u.has(r),y=(()=>{switch(r.portType){case"value":return r;case"flow":return e}})(),b=e.portType==="flow"?"":this.mManager.generateStringColor(e.resolvedDataType),D=this.mManager.connections.getConnectionPath(e,r);return{color:b,path:{attributeValue:D.attributeValue,length:D.length},state:{isNew:!t.has(y),hasError:d},port:{primary:y,output:e,input:r}}}updateConnections(){let t=this.connections;this.connections=new Map;for(let e of this.mManager.activeFunction.nodes)for(let r of e.outputs.list)for(let u of r.connectedPorts){let d=this.createConnection(t,r,u);this.connections.set(d.port.primary,d)}}static{Ni()}};function tl(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,T,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,T,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,w,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,w,p=new Map,T=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function $i(v,t,e,r){return($i=tl())(v,t,e,r)}var Gi,ji,Se;Gi=It({access:J.Read,selector:/^potatno-preview$/});var Vi=class{static{({c:[Se,ji]}=$i(this,[],[Gi]))}constructor(t=O.use(tt),e=O.use(Y),r=O.use(it)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(r.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let r=this.mTarget.childNodes.length>0;return r&&(this.mTarget.innerHTML=""),r}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{ji()}};var Bi=`:host {\r
    display: block;\r
    font-family: var(--potatno-font-family);\r
    font-size: var(--potatno-font-size);\r
\r
