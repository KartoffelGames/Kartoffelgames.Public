...
potatno-code-editor {\r
    ...
    width: 100%;\r
    height: 100%;\r
}`;var kt=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new At(this.mProject);for(let o of t.functions)e.addFunction(this.deserializeFunction(o,e));return e}deserializeFunction(t,e){let o=new gt(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let d of t.imports)o.addImport(d);for(let d of t.inputs)o.addInput({label:d.label,dataType:d.dataType});for(let d of t.outputs)o.addOutput({label:d.label,dataType:d.dataType});let c=new Map;for(let d of t.nodes)c.set(d.id,this.deserializeNode(d,o,e));for(let d of t.connections){if(!c.has(d.sourceNodeId)||!c.has(d.targetNodeId))continue;let g=c.get(d.sourceNodeId),y=c.get(d.targetNodeId),x=g.outputs.map.get(d.sourcePortId),C=y.inputs.map.get(d.targetPortId);!x||!C||x.connect(C)}return o}deserializeNode(t,e,o){let c=o.nodeDefinitions.find(g=>g.id===t.definitionId),d=(()=>{if(c)return e.addNodeByDefinition(c,t.transformation);let g=t.ports.filter(x=>x.direction==="input").map(x=>({dataType:x.dataType,definitionId:x.definitionId,label:x.label,portType:x.portType})),y=t.ports.filter(x=>x.direction==="output").map(x=>({dataType:x.dataType,definitionId:x.definitionId,label:x.label,portType:x.portType}));return new Tt(this.mProject,o,e,{definitionId:t.definitionId,ports:{input:g,output:y},label:t.label,transformation:{...t.transformation}})})();d.label=t.label,e.addNode(d);for(let g of t.ports)if(g.portType==="value"&&g.directValue.length>0){let y=d.inputs.map.get(g.definitionId);y&&y.setDirectValue(g.directValue)}return d.preview=t.preview??null,d}};var te=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((y,x)=>{e.set(y,`n${x}`)});let o=[...t.nodes].map(y=>this.serializeNode(y,e.get(y))),c=[];for(let y of t.nodes){let x=e.get(y);for(let C of y.outputs.list)for(let l of C.connectedPorts){let n=e.get(l.node);c.push({sourceNodeId:x,sourcePortId:C.definitionId,targetNodeId:n,targetPortId:l.definitionId})}}let d=t.inputs.map(y=>({label:y.label,dataType:y.dataType})),g=t.outputs.map(y=>({label:y.label,dataType:y.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:d,outputs:g,imports:[...t.imports],nodes:o,connections:c}}serializeNode(t,e){let o=[...t.inputs.list,...t.outputs.list].map(d=>({definitionId:d.definitionId,label:d.label,direction:d.direction,portType:d.portType,dataType:d.portType==="value"?d.dataType:null,directValue:[...d.directValue]})),c=t.preview?structuredClone(t.preview):null;return{id:e,definitionId:t.definitionId,label:t.label,transformation:{...t.transformation},ports:o,preview:c}}};var vo=`:host {\r
    /* Globals */\r
...
`;function cs(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},m={v:!1};s.addInitializer=f(a,m);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,r,b,v,E,w){var p=u[0],s,m,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof p=="function")h=t(p,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?m=h:r===1?(m=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var S=p.length-1;S>=0;S--){var M=p[S];if(h=t(M,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(m===void 0?m=A:typeof m=="function"?m=[m,A]:m.push(A))}}if(r===0||r===1){if(m===void 0)m=function(D,I){return I};else if(typeof m!="function"){var F=m;m=function(D,I){for(var L=I,_=0;_<F.length;_++)L=F[_].call(D,L);return L}}else{var V=m;m=function(D,I){return V.call(D,I)}}l.push(m)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(D,I){return i.get.call(D,I)}),l.push(function(D,I){return i.set.call(D,I)})):r===2?l.push(i):l.push(function(D,I){return i.call(D,I)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],m=p[2],i=p.length>3,h=s>=5,T,P;if(h?(T=l,s=s-5,b=b||[],P=b):(T=l.prototype,r=r||[],P=r),s!==0&&!i){var S=h?E:v,M=S.get(m)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!M&&s>2?S.set(m,s):S.set(m,!0)}d(a,T,p,m,s,h,i,P,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[C(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function Do(f,t,e,o){return(Do=cs())(f,t,e,o)}var Co,wo,Po,So,xo,To,Eo,dr;Co=Z({selector:"potatno-function-list",template:bo,style:yo}),Po=B.state({complexValue:!0}),So=B.state();var Io=class{static{({e:[xo,To,Eo],c:[dr,wo]}=Do(this,[[Po,1,"documentFunctions"],[So,1,"showPopup"]],[Co]))}constructor(t=R.use(X)){this.mManager=t,this.documentFunctions=new Array,this.showPopup=!1,this.mUnsubscribe=this.mManager.subscribe(O.Document|O.Function|O.SpecialActiveFunction,()=>{this.documentFunctions=this.mManager.graph.document.functions.map(e=>({id:e.id,label:e.label,isSystem:e.isSystem,function:e}))})}mManager;mUnsubscribe;#t=(Eo(this),xo(this));get documentFunctions(){return this.#t}set documentFunctions(t){this.#t=t}#e=To(this);get showPopup(){return this.#e}set showPopup(t){this.#e=t}get activeFunctionId(){return this.mManager.activeFunction?.id??""}get userFunctionDefinitions(){return[...this.mManager.project.userFunctions.values()]}createFunction(t){this.showPopup=!1,this.mManager.graph.addFunction(t.id)}deleteFunction(t){this.mManager.graph.removeFunction(t.id)}onDeconstruct(){this.mUnsubscribe()}selectFunction(t){this.mManager.setActiveFunction(t.function)}static{wo()}};var Mo=`:host {\r
    display: flex;\r
    flex-direction: column;\r
    position: relative;\r
\r
...
}`;var Ao=`<!-- In order of top-left clockwise. Needed for styling -->\r
...
}`;var Uo=`<div class="selection-popup" (pointerdown)="this.stopPropagation($event)" (wheel)="this.stopPropagation($event)" (contextmenu)="this.stopPropagation($event)">\r
...
`;function ys(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},m={v:!1};s.addInitializer=f(a,m);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,r,b,v,E,w){var p=u[0],s,m,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof p=="function")h=t(p,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?m=h:r===1?(m=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var S=p.length-1;S>=0;S--){var M=p[S];if(h=t(M,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(m===void 0?m=A:typeof m=="function"?m=[m,A]:m.push(A))}}if(r===0||r===1){if(m===void 0)m=function(D,I){return I};else if(typeof m!="function"){var F=m;m=function(D,I){for(var L=I,_=0;_<F.length;_++)L=F[_].call(D,L);return L}}else{var V=m;m=function(D,I){return V.call(D,I)}}l.push(m)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(D,I){return i.get.call(D,I)}),l.push(function(D,I){return i.set.call(D,I)})):r===2?l.push(i):l.push(function(D,I){return i.call(D,I)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],m=p[2],i=p.length>3,h=s>=5,T,P;if(h?(T=l,s=s-5,b=b||[],P=b):(T=l.prototype,r=r||[],P=r),s!==0&&!i){var S=h?E:v,M=S.get(m)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!M&&s>2?S.set(m,s):S.set(m,!0)}d(a,T,p,m,s,h,i,P,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[C(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function mn(f,t,e,o){return(mn=ys())(f,t,e,o)}var dn,ln,fn,cn,un,gr;dn=Z({selector:"potatno-connection-layer",template:an,style:sn}),fn=jt("svgLayer");var hn=class{static{({e:[cn,un],c:[gr,ln]}=mn(this,[[fn,1,"svgLayer"]],[dn]))}constructor(t=R.use(X)){this.mConnectionRegistry=new Map,this.mManager=t;let e=0;this.mUnsubscribe=this.mManager.subscribe(O.SpecialActiveFunction|O.Node|O.Connection,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.renderConnections()}))})}mConnectionRegistry;mManager;mUnsubscribe;#t=(un(this),cn(this));get svgLayer(){return this.#t}set svgLayer(t){this.#t=t}onConnectionDelete(t){if(!(t.target instanceof Element))return;let e=parseInt(t.target.getAttribute("data-connection-id")??"");if(isNaN(e))return;t.preventDefault(),t.stopPropagation();let o=this.mConnectionRegistry.get(e);o&&this.mManager.graph.disconnectPorts(o.sourcePort,o.targetPort)}onDeconstruct(){this.mUnsubscribe()}renderConnectionPath(t,e,o,c,d){let g="http://www.w3.org/2000/svg",y=this.mManager.connections.getConnectionPath(o,c),x=document.createElementNS(g,"path");x.classList.add("path"),x.classList.toggle(".path--invalid",!d),x.setAttribute("d",y),o.portType==="value"&&x.style.setProperty("--path-color",this.mManager.generateStringColor(o.resolvedDataType));let C=document.createElementNS(g,"path");C.classList.add("path","path--mouse-target"),C.setAttribute("d",y),C.setAttribute("data-connection-id",e.toString()),t.appendChild(x),t.appendChild(C)}renderConnections(){this.svgLayer.innerHTML="",this.mConnectionRegistry.clear();let t=this.mManager.activeFunction;if(!t)return;let e=this.mManager.integrity.errorItems,o=0;for(let c of t.nodes)for(let d of c.outputs.list)for(let g of d.connectedPorts){let y=o++;this.mConnectionRegistry.set(y,{sourcePort:d,targetPort:g});let x=e.has(d)||e.has(g);this.renderConnectionPath(this.svgLayer,y,d,g,!x)}}static{ln()}};function bs(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},m={v:!1};s.addInitializer=f(a,m);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,r,b,v,E,w){var p=u[0],s,m,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof p=="function")h=t(p,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?m=h:r===1?(m=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var S=p.length-1;S>=0;S--){var M=p[S];if(h=t(M,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(m===void 0?m=A:typeof m=="function"?m=[m,A]:m.push(A))}}if(r===0||r===1){if(m===void 0)m=function(D,I){return I};else if(typeof m!="function"){var F=m;m=function(D,I){for(var L=I,_=0;_<F.length;_++)L=F[_].call(D,L);return L}}else{var V=m;m=function(D,I){return V.call(D,I)}}l.push(m)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(D,I){return i.get.call(D,I)}),l.push(function(D,I){return i.set.call(D,I)})):r===2?l.push(i):l.push(function(D,I){return i.call(D,I)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],m=p[2],i=p.length>3,h=s>=5,T,P;if(h?(T=l,s=s-5,b=b||[],P=b):(T=l.prototype,r=r||[],P=r),s!==0&&!i){var S=h?E:v,M=S.get(m)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!M&&s>2?S.set(m,s):S.set(m,!0)}d(a,T,p,m,s,h,i,P,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[C(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function vn(f,t,e,o){return(vn=bs())(f,t,e,o)}var yn,pn,De;yn=pt({access:Y.Read,selector:/^potatno-preview$/});var gn=class{static{({c:[De,pn]}=vn(this,[],[yn]))}constructor(t=R.use(J),e=R.use(H),o=R.use(rt)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(o.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let o=this.mTarget.childNodes.length>0;return o&&(this.mTarget.innerHTML=""),o}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{pn()}};var bn=`:host {\r
    display: block;\r
    position: relative;\r
\r
...
<div class="node {{this.hasError ? 'error' : ''}}" style="--node-width: {{ this.nodeTransformation.width }}; --node-height: {{ this.nodeTransformation.height }};">\r
    <div class="node-header" style="--node-category-color: {{this.nodeColor}}">\r
...
\r
            <select class="select" (change)="this.selectPreviewPort($event.target.value)">\r
                $for(port of this.previewPorts) {\r
                    <option [value]="this.port.definitionId" [selected]="this.port.definitionId === this.previewPortId">{{this.port.label}}</option>\r
                }\r
            </select>\r
        </div>\r
\r
        ...
        `;function Cs(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},m={v:!1};s.addInitializer=f(a,m);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,r,b,v,E,w){var p=u[0],s,m,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof p=="function")h=t(p,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?m=h:r===1?(m=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var S=p.length-1;S>=0;S--){var M=p[S];if(h=t(M,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(m===void 0?m=A:typeof m=="function"?m=[m,A]:m.push(A))}}if(r===0||r===1){if(m===void 0)m=function(D,I){return I};else if(typeof m!="function"){var F=m;m=function(D,I){for(var L=I,_=0;_<F.length;_++)L=F[_].call(D,L);return L}}else{var V=m;m=function(D,I){return V.call(D,I)}}l.push(m)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(D,I){return i.get.call(D,I)}),l.push(function(D,I){return i.set.call(D,I)})):r===2?l.push(i):l.push(function(D,I){return i.call(D,I)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],m=p[2],i=p.length>3,h=s>=5,T,P;if(h?(T=l,s=s-5,b=b||[],P=b):(T=l.prototype,r=r||[],P=r),s!==0&&!i){var S=h?E:v,M=S.get(m)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!M&&s>2?S.set(m,s):S.set(m,!0)}d(a,T,p,m,s,h,i,P,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[C(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function Rn(f,t,e,o){return(Rn=Cs())(f,t,e,o)}var On,Mn,Fn,jn,An,Nn,Ln,vr;On=Z({selector:"potatno-node",template:Sn,style:Pn,modules:[De],components:[Ze,Xt]}),Fn=B.state({proxy:!0}),jn=B.state({complexValue:!0});var _n=class{static{({e:[An,Nn,Ln],c:[vr,Mn]}=Rn(this,[[et,3,"nodeData"],[Fn,1,"nodeTransformation"],[jn,1,"previewPorts"]],[On]))}constructor(t=R.use($),e=R.use(X)){this.mComponent=t,this.mManager=e,this.mNodeDefinition=null,this.mNodeData=null,this.nodeTransformation={height:0,width:0},this.previewPorts=new Array,this.mUnsubscribe=this.mManager.subscribe(O.Node,o=>{o.item===this.nodeData&&this.resyncComponent(this.nodeData)})}mComponent;mManager;mUnsubscribe;mNodeDefinition;mNodeData;get nodeData(){return this.mNodeData}set nodeData(t){this.mNodeData=t,this.mNodeDefinition=null,t&&(this.mNodeDefinition=this.mManager.activeFunction?this.mManager.activeFunction.nodeDefinitions.find(e=>e.id===this.nodeData.definitionId)??null:null,this.resyncComponent(t))}#t=(Ln(this),An(this));get nodeTransformation(){return this.#t}set nodeTransformation(t){this.#t=t}get hasError(){if(!this.nodeData)return!1;if(this.mManager.integrity.errorItems.has(this.nodeData))return!0;for(let t of this.nodeData.inputs.list)if(this.mManager.integrity.errorItems.has(t))return!0;for(let t of this.nodeData.outputs.list)if(this.mManager.integrity.errorItems.has(t))return!0;return!1}get isFunction(){return this.mNodeDefinition instanceof xt}#e=Nn(this);get previewPorts(){return this.#e}set previewPorts(t){this.#e=t}get canPreview(){return this.previewPorts.length>0}get isPreviewActive(){return!!this.nodeData?.preview}get previewDisplays(){if(!this.nodeData)return[];let t=this.nodeData.project,e=t.getFunction(this.nodeData.function.definitionId);if(!e)return[];let o=(y,x)=>x.map(C=>({id:C,label:y.preview.getDisplay(C)?.name??C})),c=this.nodeData.preview,d=c?this.nodeData.outputs.map.get(c.portId):void 0;if(d&&d.portType==="value")return o(t,t.preview.availableDisplays(e,d.resolvedDataType));let g=new Set;for(let y of this.nodeData.outputs.value)for(let x of t.preview.availableDisplays(e,y.resolvedDataType))g.add(x);return o(t,[...g])}get previewDisplayId(){return this.nodeData?.preview?.displayId??""}get previewPortId(){return this.nodeData?.preview?.portId??""}get previewDriver(){if(!this.nodeData?.preview)return null;let t=this.nodeData.outputs.map.get(this.nodeData.preview.portId);return t?this.mManager.preview.requestDriver(t,this.nodeData.preview.displayId):null}get nodeColor(){return this.mManager.generateStringColor(this.mNodeDefinition?.category.name??"")}get nodeIcon(){return this.mNodeDefinition?.category.icon??""}get nodeLabel(){return this.nodeData?.label??""}get inputPorts(){return this.nodeData?this.nodeData.inputs.list:new Array}get outputPorts(){return this.nodeData?this.nodeData.outputs.list:new Array}onDeconstruct(){this.mUnsubscribe()}resyncComponent(t){let e=t.transformation.x*this.mManager.grid.gridSize,o=t.transformation.y*this.mManager.grid.gridSize;this.mComponent.element.style.setProperty("left",`${e}px`),this.mComponent.element.style.setProperty("top",`${o}px`),this.nodeTransformation.width=t.transformation.width,this.nodeTransformation.height=t.transformation.height,this.previewPorts=this.getPreviewablePorts(this.nodeData)}openFunction(){this.mNodeDefinition instanceof xt&&this.mManager.setActiveFunction(this.mNodeDefinition.function)}selectPreviewPort(t){if(!this.nodeData)return;let e=(()=>{let o=this.previewPorts;return o.length===0?null:typeof t<"u"?o.find(c=>c.definitionId===t)??null:this.nodeData.preview?null:o[0]})();if(!e)return this.mManager.graph.updateNode(this.nodeData,o=>{o.preview=null});this.mManager.graph.updateNode(this.nodeData,o=>{let c=o.project.getFunction(o.function.definitionId),d=o.project.preview.availableDisplays(c,e.resolvedDataType);d.length===0&&(o.preview=null);let g=o.preview&&d.includes(o.preview.displayId)?o.preview.displayId:d[0];o.preview={portId:e.definitionId,displayId:g}})}selectPreviewDisplay(t){this.mManager.graph.updateNode(this.nodeData,e=>{e.preview={portId:e.preview.portId,displayId:t}}),document.activeElement instanceof HTMLElement&&document.activeElement.blur()}getPreviewablePorts(t){if(!this.mManager.activeFunction)return new Array;let e=t.project.getFunction(t.function.definitionId);if(!this.mManager.activeFunction.dynamicNodeDefinitions.find(d=>d.id===t.definitionId))return new Array;let c=new Map;return t.outputs.value.filter(d=>{let g=d.resolvedDataType;if(c.has(g))return c.get(g);let y=t.project.preview.availableDisplays(e,d.resolvedDataType);return c.set(g,y.length>0),c.get(g)})}static{Mn()}};var Vn=`:host {\r
    position: relative;\r
    flex: 1;\r
    display: flex;\r
    min-height: 0;\r
...
.selection-box {\r
    ...
    pointer-events: none;\r
    z-index: 1000;\r
}`;var zn=`<!-- Serves only as a background. -->\r
...
}`;var ti=`<potatno-resize-box class="resize-box" left="true">\r
\r
    <!-- Function name -->\r
    <div class="section">\r
...
}`;var ci=`<potatno-resize-box class="resize-box" left="true" top="true">\r
    <div class="header">\r
...
`;function Os(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},m={v:!1};s.addInitializer=f(a,m);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,r,b,v,E,w){var p=u[0],s,m,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof p=="function")h=t(p,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?m=h:r===1?(m=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var S=p.length-1;S>=0;S--){var M=p[S];if(h=t(M,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(m===void 0?m=A:typeof m=="function"?m=[m,A]:m.push(A))}}if(r===0||r===1){if(m===void 0)m=function(D,I){return I};else if(typeof m!="function"){var F=m;m=function(D,I){for(var L=I,_=0;_<F.length;_++)L=F[_].call(D,L);return L}}else{var V=m;m=function(D,I){return V.call(D,I)}}l.push(m)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(D,I){return i.get.call(D,I)}),l.push(function(D,I){return i.set.call(D,I)})):r===2?l.push(i):l.push(function(D,I){return i.call(D,I)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],m=p[2],i=p.length>3,h=s>=5,T,P;if(h?(T=l,s=s-5,b=b||[],P=b):(T=l.prototype,r=r||[],P=r),s!==0&&!i){var S=h?E:v,M=S.get(m)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!M&&s>2?S.set(m,s):S.set(m,!0)}d(a,T,p,m,s,h,i,P,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[C(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function vi(f,t,e,o){return(vi=Os())(f,t,e,o)}var yi,ui,bi,wi,xi,Ti,hi,mi,di,fi,pi,wr;yi=Z({selector:"potatno-preview",template:ci,style:li,modules:[De],components:[Xt]}),bi=B.state(),wi=B.state(),xi=B.state(),Ti=B.state();var gi=class{static{({e:[hi,mi,di,fi,pi],c:[wr,ui]}=vi(this,[[bi,1,"mSelectedDisplayId"],[wi,1,"mSelectedOutputId"],[xi,1,"selectedTab"],[Ti,1,"previewCode"]],[yi]))}constructor(t=R.use($),e=R.use(X)){this.mComponent=t,this.mManager=e,this.mSelectedDisplayId="",this.mSelectedOutputId="",this.selectedTab="preview",this.previewCode="";let o=O.NodeUpdate|O.NodeAdd|O.NodeDelete;this.mPreviewTargets=this.findFunctionPreviewTargets(),this.mUnsubscribeOutputFetch=this.mManager.subscribe(O.SpecialActiveFunction|o,()=>{this.mPreviewTargets=this.findFunctionPreviewTargets()}),this.mUnsubscribeErrorResolve=this.mManager.subscribe(O.SpecialActiveFunction|o|O.Connection,()=>{this.mComponent.updater.updateAsync()});let c=0;this.mManager.subscribe(O.Any,()=>{globalThis.clearTimeout(c),c=globalThis.setTimeout(()=>{this.previewCode=this.generateFunctionCode()},1e3)})}mComponent;mManager;mPreviewTargets;mUnsubscribeErrorResolve;mUnsubscribeOutputFetch;#t=(pi(this),hi(this));get mSelectedDisplayId(){return this.#t}set mSelectedDisplayId(t){this.#t=t}#e=mi(this);get mSelectedOutputId(){return this.#e}set mSelectedOutputId(t){this.#e=t}#r=di(this);get selectedTab(){return this.#r}set selectedTab(t){this.#r=t}#o=fi(this);get previewCode(){return this.#o}set previewCode(t){this.#o=t}get displayOptions(){let t=this.mPreviewTargets.get(this.selectedOutputId);return t?t.displays:new Map}get errors(){return this.mManager.integrity.errors}get outputOptions(){return this.mPreviewTargets}get previewDriver(){let t=this.mPreviewTargets.get(this.selectedOutputId);return t?this.mManager.preview.requestDriver(t.target,this.selectedDisplayId):null}get selectedDisplayId(){let t=this.displayOptions;if(!t.has(this.mSelectedDisplayId)){let e=t.keys().next().value;typeof e<"u"&&(this.mSelectedDisplayId=e)}return this.mSelectedDisplayId}set selectedDisplayId(t){this.mSelectedDisplayId=t}get selectedOutputId(){let t=this.outputOptions;if(!t.has(this.mSelectedOutputId)){let e=t.keys().next().value;typeof e<"u"&&(this.mSelectedOutputId=e)}return this.mSelectedOutputId}set selectedOutputId(t){this.mSelectedOutputId=t}onDeconstruct(){this.mUnsubscribeErrorResolve(),this.mUnsubscribeOutputFetch()}findFunctionPreviewTargets(){let t=new Map;if(!this.mManager.activeFunction)return t;let e=this.mManager.activeFunction,o=e.project.getFunction(e.definitionId);if(!o)return t;let c=y=>{let x=new Map;for(let C of y)x.set(C,e.project.preview.getDisplay(C).name);return x},d=e.project.preview.availableDisplays(o,it.MAIN);d.length>0&&t.set(it.MAIN,{label:it.MAIN,target:e,displays:c(d)});let g=new Map;for(let y of e.getExitNodes())for(let x of y.inputs.value){let C=x.resolvedDataType;g.has(C)||g.set(C,x.project.preview.availableDisplays(o,C));let l=g.get(C);l.length!==0&&t.set(x.definitionId,{label:x.label,target:x,displays:c(l)})}return t}generateFunctionCode(){if(!this.mManager.integrity.isValid||!this.mManager.activeFunction)return"";let t=this.mManager.activeFunction;return new ne(t.project).generateFunction(t,!1).code}static{ui()}};var Ei=`:host {\r
    font-family: var(--potatno-font-family);\r
    font-size: var(--potatno-font-size);\r
}\r
\r
