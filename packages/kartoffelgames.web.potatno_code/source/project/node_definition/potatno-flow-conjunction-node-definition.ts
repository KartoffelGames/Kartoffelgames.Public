...
export class PotatnoFlowConjunctionNodeDefinition<TProjectTypes extends PotatnoProjectTypesDefinition> extends PotatnoNodeDefinition<TProjectTypes> {
    ...
    public constructor() {
        super({
            id: PotatnoFlowConjunctionNodeDefinition.DEFINITION_ID,
            ...
            generators: {
                ...
                code: () => { throw new Exception('Conjunction node code generators should never be called.', PotatnoFlowConjunctionNodeDefinition); }
            }
        });
    }
}
