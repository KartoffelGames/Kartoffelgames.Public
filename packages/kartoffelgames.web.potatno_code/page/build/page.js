...
`)){let m=e.value.split(`
`);u=e.lineNumber+m.length-1,r=1+m[m.length-1].length}else r=e.columnNumber+e.value.length,u=e.lineNumber;return{graph:t.graph,lineStart:e.lineNumber,columnStart:e.columnNumber,lineEnd:u,columnEnd:r}}graphIsCircular(t){let e=this.mGraphStack.top;if(!e.circularGraphs.has(t))return!1;if(t.isJunction){if(e.circularGraphs.get(t)>g.MAX_JUNCTION_CIRCULAR_REFERENCES)throw new _("Junction graph called circular too often.",this);return!1}return!0}moveNextToken(){let t=this.mGraphStack.top;if(t.circularGraphs.size>0&&(t.circularGraphs=new rt),t.graph&&t.graph.isJunction)throw new _("Junction graph must not have own nodes.",this);if(t.token.cursor++,t.token.cursor<this.mTokenCache.length)return;let e=this.mTokenGenerator.next();if(e.done){this.mTokenCache.push(null);return}this.mLastTokenPosition.column=e.value.columnNumber,this.mLastTokenPosition.line=e.value.lineNumber,this.mTokenCache.push(e.value)}popGraphStack(t){let e=this.mGraphStack.pop(),r=this.mGraphStack.top;if(t&&(e.token.cursor=e.token.start),e.token.cursor!==e.token.start&&r.circularGraphs.size>0&&(r.circularGraphs=new rt),!this.mTrimTokenCache){r.token.cursor=e.token.cursor;return}e.linear?(this.mTokenCache.splice(0,e.token.cursor),r.token.start=0,r.token.cursor=0):r.token.cursor=e.token.cursor}pushGraphStack(t,e){let r=this.mGraphStack.top,u={graph:t,linear:e&&r.linear,circularGraphs:new rt(r.circularGraphs),token:{start:r.token.cursor,cursor:r.token.cursor}},m=u.circularGraphs.get(t)??0;u.circularGraphs.set(t,m+1),this.mGraphStack.push(u)}};var we=class g{static NODE_NULL_RESULT=Symbol("FAILED_NODE_VALUE_PARSE");static NODE_VALUE_LIST_END_MEET=Symbol("FAILED_NODE_VALUE_PARSE");mConfiguration;mLexer;mRootPart;get lexer(){return this.mLexer}constructor(t,e){this.mLexer=t,this.mRootPart=null,this.mConfiguration={keepTraceIncidents:!1,trimTokenCache:!1,...e}}parse(t,e){if(this.mRootPart===null)throw new _("Parser has not root part set.",this);let r=new Ge(this.mLexer.tokenize(t,e),this.mConfiguration.keepTraceIncidents,this.mConfiguration.trimTokenCache),u=(()=>{try{return this.beginParseProcess(r,this.mRootPart)}catch(v){if(v instanceof Zt)return r.incidentTrace.push(v.message,r.currentGraph,v.lineStart,v.columnStart,v.lineEnd,v.columnEnd,!0,v),J.PARSER_ERROR;let b=v instanceof Error?v.message:v.toString(),T=r.getGraphPosition();return r.incidentTrace.push(b,r.currentGraph,T.lineStart,T.columnStart,T.lineEnd,T.columnEnd,!0,v),J.PARSER_ERROR}})();if(u===J.PARSER_ERROR)throw new J(r.incidentTrace);let m=r.collapse();if(m.length!==0){let v=m[0];if(r.incidentTrace.top.range.lineEnd===1&&r.incidentTrace.top.range.columnEnd===1){let b=`Tokens could not be parsed. Graph end meet without reaching last token. Current: "${v.value}" (${v.type})`;r.incidentTrace.push(b,this.mRootPart,v.lineNumber,v.columnNumber,v.lineNumber,v.columnNumber)}throw new J(r.incidentTrace)}return u}setRootGraph(t){this.mRootPart=t}beginParseProcess(t,e){t.moveNextToken(),t.processStack.push({type:"graph-parse",parameter:{graph:e,linear:!0},state:0});let r=g.NODE_NULL_RESULT;for(;t.processStack.top;)r=this.processStack(t,t.processStack.top,r);return r}processChainedNodeParseProcess(t,e,r){switch(e.state){case 0:{let v=e.parameter.node.connections.next;return v===null?(t.processStack.pop(),{}):(e.state++,t.processStack.push({type:"node-parse",parameter:{node:v},state:0,values:{}}),g.NODE_NULL_RESULT)}case 1:{let u=r;return u===J.PARSER_ERROR?(t.processStack.pop(),J.PARSER_ERROR):(t.processStack.pop(),u)}}throw new _(`Invalid node next parse state "${e.state}".`,this)}processGraphParseProcess(t,e,r){let u=e.parameter.graph;switch(e.state){case 0:{if(t.graphIsCircular(u)){let v=t.getGraphPosition();return t.incidentTrace.push("Circular graph detected.",u,v.lineStart,v.columnStart,v.lineEnd,v.columnEnd),t.processStack.pop(),J.PARSER_ERROR}let m=e.parameter.linear;return t.pushGraphStack(u,m),e.state++,t.processStack.push({type:"node-parse",parameter:{node:u.node},state:0,values:{}}),g.NODE_NULL_RESULT}case 1:{let m=r;if(m===J.PARSER_ERROR)return t.popGraphStack(!0),t.processStack.pop(),J.PARSER_ERROR;let v=u.convert(m,t);if(typeof v=="symbol"){let b=t.getGraphPosition();return t.incidentTrace.push(v.description??"Unknown data convert error",b.graph,b.lineStart,b.columnStart,b.lineEnd,b.columnEnd),t.popGraphStack(!0),t.processStack.pop(),J.PARSER_ERROR}return t.popGraphStack(!1),t.processStack.pop(),v}}throw new _(`Invalid graph parse state "${e.state}".`,this)}processNodeParseProcess(t,e,r){let u=e.parameter.node;switch(e.state){case 0:return t.processStack.push({type:"node-value-parse",parameter:{node:u,valueIndex:0},state:0,values:{}}),e.state++,g.NODE_NULL_RESULT;case 1:{let m=r;return m===J.PARSER_ERROR?(t.processStack.pop(),J.PARSER_ERROR):(e.values.nodeValueResult=m,t.processStack.push({type:"node-next-parse",parameter:{node:u},state:0}),e.state++,g.NODE_NULL_RESULT)}case 2:{let m=r;if(m===J.PARSER_ERROR)return t.processStack.pop(),J.PARSER_ERROR;let v=u.mergeData(e.values.nodeValueResult,m);return t.processStack.pop(),v}}throw new _(`Invalid node parse state "${e.state}".`,this)}processNodeValueParseProcess(t,e,r){let u=e.parameter.node;switch(e.state){case 0:{if(r!==g.NODE_NULL_RESULT&&r!==J.PARSER_ERROR)return e.values.parseResult=r,e.state++,g.NODE_NULL_RESULT;let m=e.parameter.valueIndex,v=u.connections;if(m>=v.values.length)return e.values.parseResult=g.NODE_VALUE_LIST_END_MEET,e.state++,g.NODE_NULL_RESULT;e.parameter.valueIndex++;let b=t.currentToken,T=v.values[m];if(typeof T=="string"){if(!b){if(v.required){let N=t.getTokenPosition();t.incidentTrace.push(`Unexpected end of statement. Token "${T}" expected.`,t.currentGraph,N.lineStart,N.columnStart,N.lineEnd,N.columnEnd)}return g.NODE_NULL_RESULT}if(T!==b.type){if(v.required){let N=t.getTokenPosition();t.incidentTrace.push(`Unexpected token "${b.value}". "${T}" expected`,t.currentGraph,N.lineStart,N.columnStart,N.lineEnd,N.columnEnd)}return g.NODE_NULL_RESULT}return t.moveNextToken(),b.value}else{let N=v.values.length===1||v.values.length===m+1;return t.processStack.push({type:"graph-parse",parameter:{graph:T,linear:N},state:0}),g.NODE_NULL_RESULT}}case 1:{let m=e.values.parseResult,v=u.connections;if(m===g.NODE_VALUE_LIST_END_MEET&&!v.required){t.processStack.pop();return}return m===g.NODE_VALUE_LIST_END_MEET?(t.processStack.pop(),J.PARSER_ERROR):(t.processStack.pop(),m)}}throw new _(`Invalid node value parse state "${e.state}".`,this)}processStack(t,e,r){switch(e.type){case"graph-parse":return this.processGraphParseProcess(t,e,r);case"node-parse":return this.processNodeParseProcess(t,e,r);case"node-value-parse":return this.processNodeValueParseProcess(t,e,r);case"node-next-parse":return this.processChainedNodeParseProcess(t,e,r)}}};var et=class g{static define(t,e=!1){return new g(t,e)}mDataConverterList;mGraphCollector;mIsJunction;mResolvedGraphNode;get isJunction(){return this.mIsJunction}get node(){return this.mResolvedGraphNode||(this.mResolvedGraphNode=this.mGraphCollector().root),this.mResolvedGraphNode}constructor(t,e){this.mGraphCollector=t,this.mDataConverterList=new Array,this.mResolvedGraphNode=null,this.mIsJunction=e}convert(t,e){if(this.mDataConverterList.length===0)return t;let r=e.getGraphBoundingToken(),u=r[0]??void 0,m=r[1]??void 0;if(this.mDataConverterList.length===1)return this.mDataConverterList[0](t,u,m);let v=t;for(let b of this.mDataConverterList)if(v=b(v,u,m),typeof v=="symbol")return v;return v}converter(t){let e=new g(this.mGraphCollector,this.isJunction);return e.mDataConverterList.push(...this.mDataConverterList,t),e}};var U=class g{static new(){let t=new g("",!1,[]);return t.mRootNode=null,t}mConnections;mIdentifier;mRootNode;get configuration(){return{dataKey:this.mIdentifier.dataKey,isList:this.mIdentifier.type==="list",isRequired:this.mConnections.required,isBranch:this.mConnections.values.length>1}}get connections(){return this.mConnections}get root(){if(!this.mRootNode)throw new _("Staring nodes must be chained with another node to be used.",this);return this.mRootNode}constructor(t,e,r,u){if(t==="")this.mIdentifier={type:"empty",dataKey:"",mergeKey:""};else if(t.endsWith("[]"))this.mIdentifier={type:"list",mergeKey:"",dataKey:t.substring(0,t.length-2)};else if(t.includes("<-")){let v=t.split("<-");this.mIdentifier={type:"merge",dataKey:v[0],mergeKey:v[1]}}else this.mIdentifier={type:"single",mergeKey:"",dataKey:t};let m=r.map(v=>v instanceof g?et.define(()=>v):v);this.mConnections={required:e,values:m,next:null},u?this.mRootNode=u:this.mRootNode=this}mergeData(t,e){if(this.mIdentifier.type==="empty")return e;let r=e,u=typeof t>"u";if(this.mIdentifier.type==="single"){if(this.mIdentifier.dataKey in e)throw new _(`Graph path has a duplicate value identifier "${this.mIdentifier.dataKey}"`,this);return u||(r[this.mIdentifier.dataKey]=t),e}if(this.mIdentifier.type==="list"){let b;u?b=new Array:Array.isArray(t)?b=t:b=[t];let T=(()=>{if(this.mIdentifier.dataKey in e){let N=r[this.mIdentifier.dataKey];return Array.isArray(N)?(N.unshift(...b),N):(b.push(N),b)}return b})();return r[this.mIdentifier.dataKey]=T,e}if(u)return e;let m=(()=>{if(!this.mIdentifier.mergeKey)throw new _("Cant merge data without a merge key.",this);if(typeof t!="object"||t===null)throw new _("Node data must be an object when merge key is set.",this);if(!(this.mIdentifier.mergeKey in t))throw new _(`Node data does not contain merge key "${this.mIdentifier.mergeKey}"`,this);return t[this.mIdentifier.mergeKey]})();if(typeof m>"u")return e;let v=r[this.mIdentifier.dataKey];if(typeof v>"u")return r[this.mIdentifier.dataKey]=m,r;if(!Array.isArray(v))throw new _("Chain data merge value is not an array but should be.",this);return Array.isArray(m)?v.unshift(...m):v.unshift(m),e}optional(t,e){let r=typeof e>"u"?"":t,u=typeof e>"u"?t:e,m=new Array;Array.isArray(u)?m.push(...u):m.push(u);let v=new g(r,!1,m,this.mRootNode);return this.setChainedNode(v),v}required(t,e){let r=typeof e>"u"?"":t,u=typeof e>"u"?t:e,m=new Array;Array.isArray(u)?m.push(...u):m.push(u);let v=new g(r,!0,m,this.mRootNode);return this.setChainedNode(v),v}setChainedNode(t){if(this.mConnections.next!==null)throw new _("Node can only be chained to a single node.",this);this.mConnections.next=t}};var z={XmlIdentifier:"Identifier",XmlAssignment:"XmlAssignment",XmlValue:"XmlValue",XmlComment:"XmlComment",XmlOpenClosingBracket:"XmlOpenClosingBracket",XmlCloseBracket:"XmlCloseBracket",XmlOpenBracket:"XmlOpenBracket",XmlCloseClosingBracket:"XmlCloseClosingBracket",XmlExplicitValueIdentifier:"XmlExplicitValueIdentifier",ExpressionStart:"ExpressionStart",ExpressionEnd:"ExpressionEnd",ExpressionValue:"ExpressionValue",InstructionStart:"InstructionStart",InstructionInstructionValue:"InstructionInstructionValue",InstructionBodyStartBraket:"InstructionBodyStartBraket",InstructionBodyCloseBraket:"InstructionBodyCloseBraket",InstructionInstructionClosingBracket:"InstructionInstructionClosingBracket",InstructionInstructionOpeningBracket:"InstructionInstructionOpeningBracket"};var Be=class extends be{constructor(){super(),this.validWhitespaces=` 
\r`,this.trimWhitespace=!0;let t=this.createTokenPattern({pattern:{regex:/(?:(?!}}).)*/,type:z.ExpressionValue}}),e=this.createTokenPattern({pattern:{start:{regex:/{{/,type:z.ExpressionStart},end:{regex:/}}[ \n\r]?/,type:z.ExpressionEnd}}},s=>{s.useChildPattern(t)}),r=this.createTokenPattern({pattern:{regex:/[^>\s\n="/]+/,type:z.XmlIdentifier}}),u=this.createTokenPattern({pattern:{regex:/(?:(?!{{|"|<).)+/,type:z.XmlValue}}),m=this.createTokenPattern({pattern:{regex:/<!--.*?-->/,type:z.XmlComment}}),v=this.createTokenPattern({pattern:{regex:/=/,type:z.XmlAssignment}}),b=this.createTokenPattern({pattern:{start:{regex:/"/,type:z.XmlExplicitValueIdentifier},end:{regex:/"/,type:z.XmlExplicitValueIdentifier}}},s=>{s.useChildPattern(e),s.useChildPattern(u)}),T=this.createTokenPattern({pattern:{start:{regex:/<\//,type:z.XmlOpenClosingBracket},end:{regex:/>/,type:z.XmlCloseBracket}}},s=>{s.useChildPattern(r)}),N=this.createTokenPattern({pattern:{start:{regex:/</,type:z.XmlOpenBracket},end:{regex:/(?<closeClosingBracket>\/>)|(?<closeBracket>>)/,type:{closeClosingBracket:z.XmlCloseClosingBracket,closeBracket:z.XmlCloseBracket}}}},s=>{s.useChildPattern(v),s.useChildPattern(r),s.useChildPattern(b)}),l=this.createTokenPattern({pattern:{regex:/[^()"'`/)]+/,type:z.InstructionInstructionValue}}),n=this.createTokenPattern({pattern:{innerType:z.InstructionInstructionValue,start:{regex:/\//,type:z.InstructionInstructionValue},end:{regex:/\//,type:z.InstructionInstructionValue}}},s=>{s.useChildPattern(c),s.useChildPattern(o),s.useChildPattern(w),s.useChildPattern(h),s.useChildPattern(l)}),h=this.createTokenPattern({pattern:{innerType:z.InstructionInstructionValue,start:{regex:/\(/,type:z.InstructionInstructionValue},end:{regex:/\)/,type:z.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(c),s.useChildPattern(o),s.useChildPattern(w),s.useChildPattern(l)}),c=this.createTokenPattern({pattern:{innerType:z.InstructionInstructionValue,start:{regex:/"/,type:z.InstructionInstructionValue},end:{regex:/"/,type:z.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(o),s.useChildPattern(w),s.useChildPattern(h),s.useChildPattern(l)}),o=this.createTokenPattern({pattern:{innerType:z.InstructionInstructionValue,start:{regex:/'/,type:z.InstructionInstructionValue},end:{regex:/'/,type:z.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(c),s.useChildPattern(w),s.useChildPattern(h),s.useChildPattern(l)}),w=this.createTokenPattern({pattern:{innerType:z.InstructionInstructionValue,start:{regex:/`/,type:z.InstructionInstructionValue},end:{regex:/`/,type:z.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(c),s.useChildPattern(o),s.useChildPattern(h),s.useChildPattern(l)}),p=this.createTokenPattern({pattern:{regex:/\$[^(\s\n/{]+/,type:z.InstructionStart}}),D=this.createTokenPattern({pattern:{start:{regex:/\(/,type:z.InstructionInstructionOpeningBracket},end:{regex:/\)/,type:z.InstructionInstructionClosingBracket}}},s=>{s.useChildPattern(n),s.useChildPattern(c),s.useChildPattern(o),s.useChildPattern(w),s.useChildPattern(h),s.useChildPattern(l)}),x=this.createTokenPattern({pattern:{start:{regex:/{/,type:z.InstructionBodyStartBraket},end:{regex:/}/,type:z.InstructionBodyCloseBraket}}},s=>{for(let d of f)s.useChildPattern(d)}),f=[m,T,N,b,e,p,D,x,u];for(let s of f)this.useRootTokenPattern(s)}};var xe=class extends we{constructor(){super(new Be),this.initGraph()}initGraph(){let t=et.define(()=>U.new().required(z.ExpressionStart).optional("value",z.ExpressionValue).required("end",z.ExpressionEnd)).converter(o=>({expression:new At(o.value??""),hasTrailingWhitespace:o.end.length>2})),e=et.define(()=>{let o=e;return U.new().required("data[]",U.new().required("value",[t,U.new().required("text",z.XmlValue)])).optional("data<-data",o)}),r=et.define(()=>U.new().required("name",z.XmlIdentifier).optional("attributeValue",U.new().required(z.XmlAssignment).required(z.XmlExplicitValueIdentifier).optional("list<-data",e).required(z.XmlExplicitValueIdentifier))).converter(o=>{let w=new Array;if(o.attributeValue?.list)for(let p of o.attributeValue.list)"expression"in p.value?(w.push(p.value.expression),p.value.hasTrailingWhitespace&&w.push(" ")):w.push(p.value.text);return{name:o.name,values:w}}),u=et.define(()=>{let o=u;return U.new().required("data[]",r).optional("data<-data",o)}),m=et.define(()=>{let o=m;return U.new().required("data[]",U.new().required("value",[t,U.new().required("text",z.XmlValue),U.new().required(z.XmlExplicitValueIdentifier).required("text",z.XmlValue).required(z.XmlExplicitValueIdentifier)])).optional("data<-data",o)}),v=et.define(()=>U.new().required("list<-data",m)).converter(o=>{let w=new Lt;for(let p of o.list)"expression"in p.value?(w.addValue(p.value.expression),p.value.hasTrailingWhitespace&&w.addValue(" ")):w.addValue(p.value.text);return w}),b=et.define(()=>U.new().required(z.XmlComment)).converter(()=>null),T=et.define(()=>U.new().required(z.XmlOpenBracket).required("openingTagName",z.XmlIdentifier).optional("attributes<-data",u).required("closing",[U.new().required(z.XmlCloseClosingBracket),U.new().required(z.XmlCloseBracket).required("values",h).required(z.XmlOpenClosingBracket).required("closingTageName",z.XmlIdentifier).required(z.XmlCloseBracket)])).converter(o=>{if("closingTageName"in o.closing&&o.openingTagName!==o.closing.closingTageName)throw new _(`Opening (${o.openingTagName}) and closing tagname (${o.closing.closingTageName}) does not match`,this);let w=new Rt(o.openingTagName);if(o.attributes)for(let p of o.attributes)w.setAttribute(p.name).addValue(...p.values);return"values"in o.closing&&w.appendChild(...o.closing.values),w}),N=et.define(()=>{let o=N;return U.new().required("list[]",z.InstructionInstructionValue).optional("list<-list",o)}),l=et.define(()=>U.new().required("instructionName",z.InstructionStart).optional("instruction",U.new().required(z.InstructionInstructionOpeningBracket).required("value<-list",N).required(z.InstructionInstructionClosingBracket)).optional("body",U.new().required(z.InstructionBodyStartBraket).required("value",h).required(z.InstructionBodyCloseBraket))).converter(o=>{let w=o.instructionName.substring(1),p=o.instruction?.value.join("")??"",D=new Wt(w,p);return o.body&&D.appendChild(...o.body.value),D}),n=et.define(()=>{let o=n;return U.new().required("list[]",[b,T,l,v]).optional("list<-list",o)}),h=et.define(()=>{let o=n;return U.new().optional("list<-list",o)}).converter(o=>{let w=new Array;if(o.list)for(let p of o.list)p!==null&&w.push(p);return w}),c=et.define(()=>U.new().required("content",h)).converter(o=>{let w=new ut;return w.appendChild(...o.content),w});this.setRootGraph(c)}};var G=class g extends Oe{static mTemplateCache=new rt;static mXmlParser=new xe;mComponentElement;mIsUpdated;mRootBuilder;get element(){return this.mComponentElement.htmlElement}constructor(t){super({constructor:t.processorConstructor,parent:null}),Q.registerComponent(this,t.htmlElement),this.setProcessorInjection(g,this),this.addConstructionHook(u=>{Q.registerComponent(this,this.mComponentElement.htmlElement,u)}),g.mTemplateCache.has(t.processorConstructor)||g.mTemplateCache.set(t.processorConstructor,g.mXmlParser.parse(t.templateString??""));let e=g.mTemplateCache.get(t.processorConstructor).clone();this.mIsUpdated=!1,this.mComponentElement=new ye(t.htmlElement),this.mRootBuilder=new te(e,new Ve(this,t.expressionModule),new mt(this),"ROOT",null),this.mComponentElement.shadowRoot.appendChild(this.mRootBuilder.anchor),this.setProcessorInjection(Ct,new Ct(this.mRootBuilder.values));let r=this.updater.zone.getAttachment(It.ATTACHMENT_KEY);if(r)for(let[u,m]of r.injections)this.setProcessorInjection(u,m)}addStyle(t){let e=document.createElement("style");e.innerHTML=t,this.mComponentElement.shadowRoot.prepend(e)}attributeChanged(t,e,r){this.call("onAttributeChange",t,e,r)}connected(){this.mIsUpdated||this.updater.update(),this.call("onConnect")}deconstruct(){this.call("onDeconstruct"),this.mRootBuilder.deconstruct(),super.deconstruct()}disconnected(){this.call("onDisconnect")}onUpdate(){return this.mIsUpdated||(this.mIsUpdated=!0),this.mRootBuilder.update()?(this.call("onUpdate"),!0):!1}};function Y(g){return(t,e)=>{O.registerInjectable(t,e.metadata,"instanced"),Q.registerConstructor(t,g.selector);let r=class extends HTMLElement{mComponent;constructor(){super(),this.mComponent=new G({processorConstructor:t,templateString:g.template??null,expressionModule:g.expressionmodule,htmlElement:this}).setup(),g.style&&this.mComponent.addStyle(g.style)}connectedCallback(){this.mComponent.connected()}disconnectedCallback(){this.mComponent.disconnected()}};globalThis.customElements.define(g.selector,r)}}function qt(g){return(t,e)=>{O.registerInjectable(t,e.metadata,"instanced"),ct.register($t,t,{access:g.access,targetRestrictions:g.targetRestrictions})}}function Dt(g){return(t,e)=>{O.registerInjectable(t,e.metadata,"instanced"),ct.register(Tt,t,{access:g.access,selector:g.selector})}}function Ot(g){return(t,e)=>{O.registerInjectable(t,e.metadata,"instanced"),ct.register(Xt,t,{instructionType:g.instructionType})}}function Ps(){function g(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:w,private:p,metadata:D},d={v:!1};s.addInitializer=g(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(y){this[n]=y}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(y){h.set.call(this,y)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(y){return arguments.length===0&&(y=this),C.call(y)}}if(a){var P=a;a=function(y,S){return arguments.length===1&&(S=y,y=this),P.call(y,S)}}var E=function(y){return n in y};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,w,p,D,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof f=="function")a=t(f,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var y=f[E];if(a=t(y,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(d===void 0?d=S:typeof d=="function"?d=[d,S]:d.push(S))}}if(o===0||o===1){if(d===void 0)d=function(M,I){return I};else if(typeof d!="function"){var F=d;d=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,I){return j.call(M,I)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,y=E.get(d)||0;if(y===!0||y===3&&s!==4||y===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!y&&s>2?E.set(d,s):E.set(d,!0)}m(c,C,f,d,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:g(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[N(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function N(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||N(n,p),{e:D,get c(){return T(n,c,p)}}}}function Fo(g,t,e,r){return(Fo=Ps())(g,t,e,r)}function Ms(g){return g}var zo,Oo,Te;zo=qt({access:q.Read,targetRestrictions:[G]});new class extends Ms{constructor(){super(Te),Oo()}static{class g{static{({c:[Te,Oo]}=Fo(this,[],[zo]))}static METADATA_USER_EVENT_LISTENER_PROPERIES="pwb:user_event_listener_properties";mEventListenerList;mTargetElement;constructor(e=O.use(G)){let r=new Array,u=e.processorConstructor;do{let m=st.get(u).getMetadata(g.METADATA_USER_EVENT_LISTENER_PROPERIES);if(m)for(let v of m)r.push(v)}while(u=Object.getPrototypeOf(u));this.mEventListenerList=new Array,this.mTargetElement=e.element;for(let m of r){let[v,b]=m,T=Reflect.get(e.processor,v);T=T.bind(e.processor),this.mEventListenerList.push([b,T]),this.mTargetElement.addEventListener(b,T)}}onDeconstruct(){for(let e of this.mEventListenerList){let[r,u]=e;this.mTargetElement.removeEventListener(r,u)}}}}};var De=class extends window.Event{mValue;get value(){return this.mValue}constructor(t,e){super(t),this.mValue=e}};var Ee=class{mElement;mEventName;constructor(t,e){this.mEventName=t,this.mElement=e}dispatchEvent(t){let e=new De(this.mEventName,t);this.mElement.dispatchEvent(e)}};function pt(g){return(t,e)=>{if(e.static)throw new _("Event target is not for a static property.",pt);let r=new WeakMap;return{get(){if(!r.has(this)){let u=(()=>{try{return Q.ofProcessor(this).component}catch{throw new _("PwbComponentEvent target class is not a component.",this)}})();r.set(this,new Ee(g,u.element))}return r.get(this)}}}}function Ss(){function g(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:w,private:p,metadata:D},d={v:!1};s.addInitializer=g(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(y){this[n]=y}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(y){h.set.call(this,y)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(y){return arguments.length===0&&(y=this),C.call(y)}}if(a){var P=a;a=function(y,S){return arguments.length===1&&(S=y,y=this),P.call(y,S)}}var E=function(y){return n in y};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,w,p,D,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof f=="function")a=t(f,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var y=f[E];if(a=t(y,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(d===void 0?d=S:typeof d=="function"?d=[d,S]:d.push(S))}}if(o===0||o===1){if(d===void 0)d=function(M,I){return I};else if(typeof d!="function"){var F=d;d=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,I){return j.call(M,I)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,y=E.get(d)||0;if(y===!0||y===3&&s!==4||y===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!y&&s>2?E.set(d,s):E.set(d,!0)}m(c,C,f,d,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:g(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[N(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function N(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||N(n,p),{e:D,get c(){return T(n,c,p)}}}}function Vo(g,t,e,r){return(Vo=Ss())(g,t,e,r)}function Ns(g){return g}var $o,jo,Ie;$o=qt({access:q.ReadWrite,targetRestrictions:[G]});new class extends Ns{constructor(){super(Ie),jo()}static{class g{static{({c:[Ie,jo]}=Vo(this,[],[$o]))}static METADATA_EXPORTED_PROPERTIES="pwb:exported_properties";mComponent;constructor(e=O.use(G)){this.mComponent=e;let r=new Ht,u=e.processorConstructor;do{let v=st.get(u).getMetadata(g.METADATA_EXPORTED_PROPERTIES);v&&r.push(...v)}while(u=Object.getPrototypeOf(u));let m=new Set(r);m.size>0&&this.connectExportedProperties(m)}connectExportedProperties(e){this.exportPropertyAsAttribute(e),this.patchHtmlAttributes(e)}exportPropertyAsAttribute(e){for(let r of e){let u={};u.enumerable=!0,u.configurable=!0,delete u.value,delete u.writable,u.set=m=>{Reflect.set(this.mComponent.processor,r,m)},u.get=()=>{let m=Reflect.get(this.mComponent.processor,r);return typeof m=="function"&&(m=m.bind(this.mComponent.processor)),m},Object.defineProperty(this.mComponent.element,r,u)}}patchHtmlAttributes(e){let r=this.mComponent.element.getAttribute;new MutationObserver(m=>{for(let v of m){let b=v.attributeName,T=r.call(this.mComponent.element,b);Reflect.set(this.mComponent.element,b,T),this.mComponent.attributeChanged(b,v.oldValue,T)}}).observe(this.mComponent.element,{attributeFilter:[...e],attributeOldValue:!0});for(let m of e)if(this.mComponent.element.hasAttribute(m)){let v=r.call(this.mComponent.element,m);this.mComponent.element.setAttribute(m,v)}this.mComponent.element.getAttribute=m=>e.has(m)?Reflect.get(this.mComponent.element,m):r.call(this.mComponent.element,m)}}}};function W(g,t){if(t.static)throw new _("Event target is not for a static property.",W);let e=st.forInternalDecorator(t.metadata),r=e.getMetadata(Ie.METADATA_EXPORTED_PROPERTIES)??new Array;r.push(t.name),e.setMetadata(Ie.METADATA_EXPORTED_PROPERTIES,r)}function gt(g){return(t,e)=>{if(e.static)throw new _("Child decorator is not for a static property.",gt);return{get(){let m=(()=>{try{return Q.ofProcessor(this).component}catch{throw new _("PwbChild target class is not a component.",this)}})().getProcessorInjection(Ct).data.store[g];return m instanceof Element?m:null}}}}function _s(){function g(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:w,private:p,metadata:D},d={v:!1};s.addInitializer=g(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(y){this[n]=y}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(y){h.set.call(this,y)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(y){return arguments.length===0&&(y=this),C.call(y)}}if(a){var P=a;a=function(y,S){return arguments.length===1&&(S=y,y=this),P.call(y,S)}}var E=function(y){return n in y};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,w,p,D,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof f=="function")a=t(f,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var y=f[E];if(a=t(y,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(d===void 0?d=S:typeof d=="function"?d=[d,S]:d.push(S))}}if(o===0||o===1){if(d===void 0)d=function(M,I){return I};else if(typeof d!="function"){var F=d;d=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,I){return j.call(M,I)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,y=E.get(d)||0;if(y===!0||y===3&&s!==4||y===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!y&&s>2?E.set(d,s):E.set(d,!0)}m(c,C,f,d,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:g(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[N(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function N(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||N(n,p),{e:D,get c(){return T(n,c,p)}}}}function Uo(g,t,e,r){return(Uo=_s())(g,t,e,r)}var Xo,Go,As;Xo=Ot({instructionType:"dynamic-content"});var Bo=class{static{({c:[As,Go]}=Uo(this,[],[Xo]))}constructor(t=O.use(ot),e=O.use(H)){this.mModuleValues=e,this.mLastTemplate=null,this.mProcedure=this.mModuleValues.createExpressionProcedure(t.value)}mLastTemplate;mModuleValues;mProcedure;onUpdate(){let t=this.mProcedure.execute();if(!t||!(t instanceof ut))throw new _("Dynamic content method has a wrong result type.",this);if(this.mLastTemplate!==null&&this.mLastTemplate.equals(t))return null;let e=t.clone();this.mLastTemplate=e;let r=new ht;return r.addElement(e,new mt(this.mModuleValues.data),null),r}static{Go()}};function Ls(){function g(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:w,private:p,metadata:D},d={v:!1};s.addInitializer=g(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(y){this[n]=y}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(y){h.set.call(this,y)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(y){return arguments.length===0&&(y=this),C.call(y)}}if(a){var P=a;a=function(y,S){return arguments.length===1&&(S=y,y=this),P.call(y,S)}}var E=function(y){return n in y};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,w,p,D,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof f=="function")a=t(f,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var y=f[E];if(a=t(y,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(d===void 0?d=S:typeof d=="function"?d=[d,S]:d.push(S))}}if(o===0||o===1){if(d===void 0)d=function(M,I){return I};else if(typeof d!="function"){var F=d;d=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,I){return j.call(M,I)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,y=E.get(d)||0;if(y===!0||y===3&&s!==4||y===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!y&&s>2?E.set(d,s):E.set(d,!0)}m(c,C,f,d,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:g(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[N(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function N(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||N(n,p),{e:D,get c(){return T(n,c,p)}}}}function Wo(g,t,e,r){return(Wo=Ls())(g,t,e,r)}var Zo,Ho,Rs;Zo=Dt({access:q.Write,selector:/^\([[\w\-$]+\)$/});var Yo=class{static{({c:[Rs,Ho]}=Wo(this,[],[Zo]))}constructor(t=O.use(tt),e=O.use(H),r=O.use(nt)){this.mTarget=t,this.mEventName=r.name.substring(1,r.name.length-1);let u=e.createExpressionProcedure(r.value,["$event"]);this.mListener=m=>{u.setTemporaryValue("$event",m),u.execute()},this.mTarget.addEventListener(this.mEventName,this.mListener)}mEventName;mListener;mTarget;onDeconstruct(){this.mTarget.removeEventListener(this.mEventName,this.mListener)}static{Ho()}};function Os(){function g(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:w,private:p,metadata:D},d={v:!1};s.addInitializer=g(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(y){this[n]=y}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(y){h.set.call(this,y)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(y){return arguments.length===0&&(y=this),C.call(y)}}if(a){var P=a;a=function(y,S){return arguments.length===1&&(S=y,y=this),P.call(y,S)}}var E=function(y){return n in y};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,w,p,D,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof f=="function")a=t(f,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var y=f[E];if(a=t(y,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(d===void 0?d=S:typeof d=="function"?d=[d,S]:d.push(S))}}if(o===0||o===1){if(d===void 0)d=function(M,I){return I};else if(typeof d!="function"){var F=d;d=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,I){return j.call(M,I)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,y=E.get(d)||0;if(y===!0||y===3&&s!==4||y===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!y&&s>2?E.set(d,s):E.set(d,!0)}m(c,C,f,d,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:g(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[N(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function N(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||N(n,p),{e:D,get c(){return T(n,c,p)}}}}function Ko(g,t,e,r){return(Ko=Os())(g,t,e,r)}function Fs(g){return g}var Qo,qo,Jo;Qo=Ot({instructionType:"for"});new class extends Fs{constructor(){super(Jo),qo()}static{class g{static{({c:[Jo,qo]}=Ko(this,[],[Qo]))}static REGEX_HEAD=new RegExp(/^\s*([a-zA-Z]+[a-zA-Z0-9]*)\s*of\s+([^;]+)\s*(?:;(.*))?$/);static REGEX_MODIFIER_INSTRUCTION=new RegExp(/^\s*(\$?[a-zA-Z]+[a-zA-Z0-9]*)\s*=\s*(.+?)\s*$/);mExpression;mLastEntries;mModuleValues;mTemplate;constructor(e=O.use(ft),r=O.use(H),u=O.use(ot)){this.mTemplate=e,this.mModuleValues=r,this.mLastEntries=new Array;let m=u.value,v=g.REGEX_HEAD.exec(m);if(!v)throw new _(`For-Parameter value has wrong format: ${m}`,this);let b=v[1],T=v[2],N=v[3]?v[3].split(";"):new Array,l=new Array;for(let n of N){let h=g.REGEX_MODIFIER_INSTRUCTION.exec(n);if(!h)throw new _(`For-Parameter optional instruction has wrong format: ${n}`,this);l.push({variableName:h[1],procedure:this.mModuleValues.createExpressionProcedure(h[2],["$index",b])})}this.mExpression={iterateVariableName:b,iterateValueProcedure:this.mModuleValues.createExpressionProcedure(T),modifier:l}}onUpdate(){let e=new ht,r=this.mExpression.iterateValueProcedure.execute();if(typeof r=="object"&&r!==null||Array.isArray(r)){let u=Symbol.iterator in r?Object.entries([...r]):Object.entries(r);if(this.compareEntries(u,this.mLastEntries))return null;this.mLastEntries=u;for(let[m,v]of u)this.addTemplateForElement(e,this.mExpression,v,m);return e}else return null}addTemplateForElement=(e,r,u,m)=>{let v=new mt(this.mModuleValues.data);v.setTemporaryValue(r.iterateVariableName,u);let b=u;for(let N of r.modifier){N.procedure.setTemporaryValue("$index",m),N.procedure.setTemporaryValue(r.iterateVariableName,u);let l=N.procedure.execute();if(N.variableName==="$key"){b=l;continue}v.setTemporaryValue(N.variableName,l)}let T=new ut;T.appendChild(...this.mTemplate.childList),e.addElement(T,v,b)};compareEntries(e,r){if(e.length!==r.length)return!1;for(let u=0;u<e.length;u++){let[m,v]=e[u],[b,T]=r[u];if(m!==b||v!==T)return!1}return!0}}}};function zs(){function g(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:w,private:p,metadata:D},d={v:!1};s.addInitializer=g(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(y){this[n]=y}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(y){h.set.call(this,y)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(y){return arguments.length===0&&(y=this),C.call(y)}}if(a){var P=a;a=function(y,S){return arguments.length===1&&(S=y,y=this),P.call(y,S)}}var E=function(y){return n in y};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,w,p,D,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof f=="function")a=t(f,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var y=f[E];if(a=t(y,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(d===void 0?d=S:typeof d=="function"?d=[d,S]:d.push(S))}}if(o===0||o===1){if(d===void 0)d=function(M,I){return I};else if(typeof d!="function"){var F=d;d=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,I){return j.call(M,I)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,y=E.get(d)||0;if(y===!0||y===3&&s!==4||y===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!y&&s>2?E.set(d,s):E.set(d,!0)}m(c,C,f,d,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:g(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[N(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function N(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||N(n,p),{e:D,get c(){return T(n,c,p)}}}}function er(g,t,e,r){return(er=zs())(g,t,e,r)}var or,ko,js;or=Ot({instructionType:"if"});var tr=class{static{({c:[js,ko]}=er(this,[],[or]))}constructor(t=O.use(ft),e=O.use(H),r=O.use(ot)){this.mTemplateReference=t,this.mModuleValues=e,this.mProcedure=this.mModuleValues.createExpressionProcedure(r.value),this.mLastBoolean=!1}mLastBoolean;mModuleValues;mProcedure;mTemplateReference;onUpdate(){let t=this.mProcedure.execute();if(!!t!==this.mLastBoolean){this.mLastBoolean=!!t;let e=new ht;if(t){let r=new ut;r.appendChild(...this.mTemplateReference.childList),e.addElement(r,new mt(this.mModuleValues.data),null)}return e}else return null}static{ko()}};function Vs(){function g(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:w,private:p,metadata:D},d={v:!1};s.addInitializer=g(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(y){this[n]=y}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(y){h.set.call(this,y)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(y){return arguments.length===0&&(y=this),C.call(y)}}if(a){var P=a;a=function(y,S){return arguments.length===1&&(S=y,y=this),P.call(y,S)}}var E=function(y){return n in y};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,w,p,D,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof f=="function")a=t(f,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var y=f[E];if(a=t(y,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(d===void 0?d=S:typeof d=="function"?d=[d,S]:d.push(S))}}if(o===0||o===1){if(d===void 0)d=function(M,I){return I};else if(typeof d!="function"){var F=d;d=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,I){return j.call(M,I)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,y=E.get(d)||0;if(y===!0||y===3&&s!==4||y===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!y&&s>2?E.set(d,s):E.set(d,!0)}m(c,C,f,d,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:g(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[N(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function N(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||N(n,p),{e:D,get c(){return T(n,c,p)}}}}function ir(g,t,e,r){return(ir=Vs())(g,t,e,r)}var sr,rr,$s;sr=Dt({access:q.Read,selector:/^\[[\w$]+\]$/});var nr=class{static{({c:[$s,rr]}=ir(this,[],[sr]))}constructor(t=O.use(tt),e=O.use(H),r=O.use(nt)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(r.value),this.mTargetProperty=r.name.substring(1,r.name.length-1),this.mLastValue=Symbol("Uncomparable")}mLastValue;mProcedure;mTarget;mTargetProperty;onUpdate(){let t=this.mProcedure.execute();return t===this.mLastValue?!1:(this.mLastValue=t,Reflect.set(this.mTarget,this.mTargetProperty,t),!0)}static{rr()}};function Gs(){function g(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:w,private:p,metadata:D},d={v:!1};s.addInitializer=g(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(y){this[n]=y}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(y){h.set.call(this,y)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(y){return arguments.length===0&&(y=this),C.call(y)}}if(a){var P=a;a=function(y,S){return arguments.length===1&&(S=y,y=this),P.call(y,S)}}var E=function(y){return n in y};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,w,p,D,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof f=="function")a=t(f,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var y=f[E];if(a=t(y,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(d===void 0?d=S:typeof d=="function"?d=[d,S]:d.push(S))}}if(o===0||o===1){if(d===void 0)d=function(M,I){return I};else if(typeof d!="function"){var F=d;d=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,I){return j.call(M,I)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,y=E.get(d)||0;if(y===!0||y===3&&s!==4||y===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!y&&s>2?E.set(d,s):E.set(d,!0)}m(c,C,f,d,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:g(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[N(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function N(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||N(n,p),{e:D,get c(){return T(n,c,p)}}}}function cr(g,t,e,r){return(cr=Gs())(g,t,e,r)}var ur,ar,Bs;ur=Dt({access:q.Write,selector:/^#[[\w$]+$/});var lr=class{static{({c:[Bs,ar]}=cr(this,[],[ur]))}constructor(t=O.use(tt),e=O.use(nt),r=O.use(Ct)){this.mChildName=e.name.substring(1),this.mComponentScopeValue=r,this.mTargetNode=t,this.mComponentScopeValue.setTemporaryValue(this.mChildName,this.mTargetNode)}mChildName;mComponentScopeValue;mTargetNode;onDeconstruct(){this.mComponentScopeValue.data.store[this.mChildName]===this.mTargetNode&&this.mComponentScopeValue.data.deleteTemporaryValue(this.mChildName)}static{ar()}};function Us(){function g(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:w,private:p,metadata:D},d={v:!1};s.addInitializer=g(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(y){this[n]=y}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(y){h.set.call(this,y)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(y){return arguments.length===0&&(y=this),C.call(y)}}if(a){var P=a;a=function(y,S){return arguments.length===1&&(S=y,y=this),P.call(y,S)}}var E=function(y){return n in y};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,w,p,D,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof f=="function")a=t(f,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var y=f[E];if(a=t(y,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(d===void 0?d=S:typeof d=="function"?d=[d,S]:d.push(S))}}if(o===0||o===1){if(d===void 0)d=function(M,I){return I};else if(typeof d!="function"){var F=d;d=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,I){return j.call(M,I)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,y=E.get(d)||0;if(y===!0||y===3&&s!==4||y===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!y&&s>2?E.set(d,s):E.set(d,!0)}m(c,C,f,d,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:g(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[N(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function N(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||N(n,p),{e:D,get c(){return T(n,c,p)}}}}function mr(g,t,e,r){return(mr=Us())(g,t,e,r)}var fr,hr,Xs;fr=Ot({instructionType:"slot"});var dr=class{static{({c:[Xs,hr]}=mr(this,[],[fr]))}constructor(t=O.use(H),e=O.use(ot)){this.mModuleValues=t,this.mSlotName=e.value,this.mIsSetup=!1}mIsSetup;mModuleValues;mSlotName;onUpdate(){if(this.mIsSetup)return null;this.mIsSetup=!0;let t=new Rt("slot");this.mSlotName!==""&&t.setAttribute("name").addValue(this.mSlotName);let e=new ut;e.appendChild(t);let r=new ht;return r.addElement(e,this.mModuleValues.data,null),r}static{hr()}};function Hs(){function g(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:w,private:p,metadata:D},d={v:!1};s.addInitializer=g(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(y){this[n]=y}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(y){h.set.call(this,y)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(y){return arguments.length===0&&(y=this),C.call(y)}}if(a){var P=a;a=function(y,S){return arguments.length===1&&(S=y,y=this),P.call(y,S)}}var E=function(y){return n in y};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,w,p,D,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof f=="function")a=t(f,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var y=f[E];if(a=t(y,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(d===void 0?d=S:typeof d=="function"?d=[d,S]:d.push(S))}}if(o===0||o===1){if(d===void 0)d=function(M,I){return I};else if(typeof d!="function"){var F=d;d=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,I){return j.call(M,I)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,y=E.get(d)||0;if(y===!0||y===3&&s!==4||y===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!y&&s>2?E.set(d,s):E.set(d,!0)}m(c,C,f,d,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:g(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[N(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function N(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||N(n,p),{e:D,get c(){return T(n,c,p)}}}}function vr(g,t,e,r){return(vr=Hs())(g,t,e,r)}var yr,pr,Ys;yr=Dt({access:q.ReadWrite,selector:/^\[\([[\w$]+\)\]$/});var gr=class{static{({c:[Ys,pr]}=vr(this,[],[yr]))}constructor(t=O.use(G),e=O.use(tt),r=O.use(H),u=O.use(nt)){this.mTargetNode=e,this.mAttributeKey=u.name.substring(2,u.name.length-2),this.mReadProcedure=r.createExpressionProcedure(u.value),this.mWriteProcedure=r.createExpressionProcedure(`${u.value} = $DATA;`,["$DATA"]),this.mLastDataValue=Symbol("Uncomparable");let m=v=>{this.mLastDataValue!==v&&t.updater.updateAsync()};this.mTargetNode.addEventListener("input",v=>{m(Reflect.get(this.mTargetNode,this.mAttributeKey))}),this.mTargetNode.addEventListener("change",v=>{m(Reflect.get(this.mTargetNode,this.mAttributeKey))})}mAttributeKey;mLastDataValue;mReadProcedure;mTargetNode;mWriteProcedure;onUpdate(){let t=this.mReadProcedure.execute();if(t!==this.mLastDataValue)return Reflect.set(this.mTargetNode,this.mAttributeKey,t),this.mLastDataValue=t,!0;let e=Reflect.get(this.mTargetNode,this.mAttributeKey);return e!==t?(this.mWriteProcedure.setTemporaryValue("$DATA",e),this.mWriteProcedure.execute(),this.mLastDataValue=e,!0):!1}static{pr()}};function Ws(){function g(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:w,private:p,metadata:D},d={v:!1};s.addInitializer=g(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(y){this[n]=y}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(y){h.set.call(this,y)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(y){return arguments.length===0&&(y=this),C.call(y)}}if(a){var P=a;a=function(y,S){return arguments.length===1&&(S=y,y=this),P.call(y,S)}}var E=function(y){return n in y};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,w,p,D,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof f=="function")a=t(f,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var y=f[E];if(a=t(y,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(d===void 0?d=S:typeof d=="function"?d=[d,S]:d.push(S))}}if(o===0||o===1){if(d===void 0)d=function(M,I){return I};else if(typeof d!="function"){var F=d;d=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,I){return j.call(M,I)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,y=E.get(d)||0;if(y===!0||y===3&&s!==4||y===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!y&&s>2?E.set(d,s):E.set(d,!0)}m(c,C,f,d,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:g(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[N(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function N(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||N(n,p),{e:D,get c(){return T(n,c,p)}}}}function xr(g,t,e,r){return(xr=Ws())(g,t,e,r)}var Tr,br,Zs;Tr=qt({access:q.Read,targetRestrictions:[Tt]});var wr=class{static{({c:[Zs,br]}=xr(this,[],[Tr]))}constructor(t=O.use(Tt),e=O.use(tt)){let r=new Array,u=t.processorConstructor;do{let m=st.get(u).getMetadata(Te.METADATA_USER_EVENT_LISTENER_PROPERIES);if(m)for(let v of m)r.push(v)}while(u=Object.getPrototypeOf(u));this.mEventListenerList=new Array,this.mTargetElement=e;for(let m of r){let[v,b]=m,T=Reflect.get(t.processor,v);T=T.bind(t.processor),this.mEventListenerList.push([b,T]),this.mTargetElement.addEventListener(b,T)}}mEventListenerList;mTargetElement;onDeconstruct(){for(let t of this.mEventListenerList){let[e,r]=t;this.mTargetElement.removeEventListener(e,r)}}static{br()}};var Dr=`:host {\r
    display: block;\r
    width: 100%;\r
    height: 100%;\r
}\r
...
potatno-code-editor {\r
    ...
    width: 100%;\r
    height: 100%;\r
}`;var re=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new jt(this.mProject),r=[];for(let u of t.functions){let m=this.deserializeFunctionHead(u,e);r.push([m,u]),e.addFunction(m)}for(let[u,m]of r)this.deserializeFunctionBody(u,m,e);return e}deserializeFunctionBody(t,e,r){let u=new Map;for(let m of e.nodes)u.set(m.id,this.deserializeNode(m,t,r));for(let m of e.connections){if(!u.has(m.sourceNodeId)||!u.has(m.targetNodeId))continue;let v=u.get(m.sourceNodeId),b=u.get(m.targetNodeId),T=v.outputs.map.get(m.sourcePortId),N=b.inputs.map.get(m.targetPortId);!T||!N||T.connect(N)}}deserializeFunctionHead(t,e){let r=new Et(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let u of t.imports)r.addImport(u);for(let u of t.inputs)r.addInput({label:u.label,dataType:u.dataType});for(let u of t.outputs)r.addOutput({label:u.label,dataType:u.dataType});return r}deserializeNode(t,e,r){let u=r.nodeDefinitions.find(v=>v.id===t.definitionId),m=(()=>{if(u)return e.addNodeByDefinition(u,t.transformation);let v=t.ports.filter(T=>T.direction==="input").map(T=>({dataType:T.dataType,definitionId:T.definitionId,label:T.label,portType:T.portType})),b=t.ports.filter(T=>T.direction==="output").map(T=>({dataType:T.dataType,definitionId:T.definitionId,label:T.label,portType:T.portType}));return new Nt(this.mProject,r,e,{definitionId:t.definitionId,ports:{input:v,output:b},label:t.label,transformation:{...t.transformation}})})();m.label=t.label,e.addNode(m);for(let v of t.ports)if(v.portType==="value"&&v.directValue.length>0){let b=m.inputs.map.get(v.definitionId);b&&b.setDirectValue(v.directValue)}return m.preview=t.preview??null,m}};var ne=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((b,T)=>{e.set(b,`n${T}`)});let r=[...t.nodes].map(b=>this.serializeNode(b,e.get(b))),u=[];for(let b of t.nodes){let T=e.get(b);for(let N of b.outputs.list)for(let l of N.connectedPorts){let n=e.get(l.node);u.push({sourceNodeId:T,sourcePortId:N.definitionId,targetNodeId:n,targetPortId:l.definitionId})}}let m=t.inputs.map(b=>({label:b.label,dataType:b.dataType})),v=t.outputs.map(b=>({label:b.label,dataType:b.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:m,outputs:v,imports:[...t.imports],nodes:r,connections:u}}serializeNode(t,e){let r=[...t.inputs.list,...t.outputs.list].map(m=>({definitionId:m.definitionId,label:m.label,direction:m.direction,portType:m.portType,dataType:m.portType==="value"?m.dataType:null,directValue:[...m.directValue]})),u=t.preview?{portDefinitionId:t.preview.portDefinitionId,displayId:t.preview.displayId}:null;return{id:e,definitionId:t.definitionId,label:t.label,transformation:{...t.transformation},ports:r,preview:u}}};var Er=`:host {\r
    /* Globals */\r
...
`;function ya(){function g(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:w,private:p,metadata:D},d={v:!1};s.addInitializer=g(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(y){this[n]=y}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(y){h.set.call(this,y)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(y){return arguments.length===0&&(y=this),C.call(y)}}if(a){var P=a;a=function(y,S){return arguments.length===1&&(S=y,y=this),P.call(y,S)}}var E=function(y){return n in y};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,w,p,D,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof f=="function")a=t(f,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var y=f[E];if(a=t(y,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(d===void 0?d=S:typeof d=="function"?d=[d,S]:d.push(S))}}if(o===0||o===1){if(d===void 0)d=function(M,I){return I};else if(typeof d!="function"){var F=d;d=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,I){return j.call(M,I)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,y=E.get(d)||0;if(y===!0||y===3&&s!==4||y===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!y&&s>2?E.set(d,s):E.set(d,!0)}m(c,C,f,d,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:g(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[N(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function N(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||N(n,p),{e:D,get c(){return T(n,c,p)}}}}function ci(g,t,e,r){return(ci=ya())(g,t,e,r)}var ui,ii,hi,si,ai,Eo;ui=Y({selector:"potatno-connection-layer",template:ni,style:ri}),hi=$.state({complexValue:!0});var li=class{static{({e:[si,ai],c:[Eo,ii]}=ci(this,[[hi,1,"connections"]],[ui]))}constructor(t=O.use(X)){this.mManager=t,this.connections=new Map;let e=0;this.mUnsubscribe=this.mManager.subscribe(R.SpecialActiveFunction|R.Node|R.Connection,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.updateConnections()}))})}mManager;mUnsubscribe;#t=(ai(this),si(this));get connections(){return this.#t}set connections(t){this.#t=t}createConjunction(t,e){t.preventDefault(),t.stopPropagation();let r=e.port.output.portType==="flow"?this.mManager.project.nodeDefinitions.get(Z.DEFINITION_ID):this.mManager.project.nodeDefinitions.get(k.DEFINITION_ID),u=this.mManager.grid.pixelToGridSpace(t.clientX,t.clientY),m=this.mManager.graph.addNode(this.mManager.activeFunction,r,{x:u.x,y:u.y,height:0,width:0});this.mManager.graph.disconnectPorts(e.port.output,e.port.input);let v=m.inputs.list[0],b=m.outputs.list[0];this.mManager.graph.connectPorts(v,e.port.output),this.mManager.graph.connectPorts(v,e.port.input),this.mManager.graph.connectPorts(b,e.port.output),this.mManager.graph.connectPorts(b,e.port.input)}deleteConnection(t,e){t.button===2&&(t.preventDefault(),t.stopPropagation(),this.mManager.graph.disconnectPorts(e.port.output,e.port.input))}onDeconstruct(){this.mUnsubscribe()}createConnection(t,e,r){let u=this.mManager.integrity.errorItems,m=u.has(e)||u.has(r),v=(()=>{switch(r.portType){case"value":return r;case"flow":return e}})(),b=e.portType==="flow"?"":this.mManager.generateStringColor(e.resolvedDataType),T=this.mManager.connections.getConnectionPath(e,r);return{color:b,path:{attributeValue:T.attributeValue,length:T.length},state:{isNew:!t.has(v),hasError:m},port:{primary:v,output:e,input:r}}}updateConnections(){let t=this.connections;this.connections=new Map;for(let e of this.mManager.activeFunction.nodes)for(let r of e.outputs.list)for(let u of r.connectedPorts){let m=this.createConnection(t,r,u);this.connections.set(m.port.primary,m)}}static{ii()}};function ba(){function g(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:w,private:p,metadata:D},d={v:!1};s.addInitializer=g(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(y){this[n]=y}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(y){h.set.call(this,y)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(y){return arguments.length===0&&(y=this),C.call(y)}}if(a){var P=a;a=function(y,S){return arguments.length===1&&(S=y,y=this),P.call(y,S)}}var E=function(y){return n in y};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,w,p,D,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof f=="function")a=t(f,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var y=f[E];if(a=t(y,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(d===void 0?d=S:typeof d=="function"?d=[d,S]:d.push(S))}}if(o===0||o===1){if(d===void 0)d=function(M,I){return I};else if(typeof d!="function"){var F=d;d=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,I){return j.call(M,I)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,y=E.get(d)||0;if(y===!0||y===3&&s!==4||y===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!y&&s>2?E.set(d,s):E.set(d,!0)}m(c,C,f,d,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:g(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[N(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function N(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||N(n,p),{e:D,get c(){return T(n,c,p)}}}}function fi(g,t,e,r){return(fi=ba())(g,t,e,r)}var pi,di,Me;pi=Dt({access:q.Read,selector:/^potatno-preview$/});var mi=class{static{({c:[Me,di]}=fi(this,[],[pi]))}constructor(t=O.use(tt),e=O.use(H),r=O.use(nt)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(r.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let r=this.mTarget.childNodes.length>0;return r&&(this.mTarget.innerHTML=""),r}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{di()}};var gi=`:host {\r
    display: block;\r
    font-family: var(--potatno-font-family);\r
    font-size: var(--potatno-font-size);\r
\r
