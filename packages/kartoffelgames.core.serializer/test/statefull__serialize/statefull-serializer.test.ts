...
Deno.test('StatefullSerializer.objectify()', async (pContext) => {
    ...
    await pContext.step('Class', async (pContext) => {
        ...
        await pContext.step('Ignore set and get', () => {
            // Setup. CLass id.
        ...
        await pContext.step('Ignore readonly properties.', () => {
            // Setup. CLass id.
...
Deno.test('StatefullSerializer.serialize()', async (pContext) => {
