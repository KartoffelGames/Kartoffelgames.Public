...
`;(function(p){p.Function="function",p.Comment="comment",p.Input="input",p.Output="output",p.Reroute="reroute"})(ot||(ot={}));var Mt=class p{static META={[ot.Function]:{icon:"f",cssColor:"var(--pn-accent-blue)",label:"Function"},[ot.Comment]:{icon:"\u{1F4AC}",cssColor:"var(--pn-accent-yellow)",label:"Comment"},[ot.Input]:{icon:"\u2192",cssColor:"var(--pn-accent-green)",label:"Input"},[ot.Output]:{icon:"\u2190",cssColor:"var(--pn-accent-red)",label:"Output"},[ot.Reroute]:{icon:"\u25C7",cssColor:"var(--pn-text-muted)",label:"Reroute"}};static get(t){let e=p.META[t];return e||{icon:"\u25C6",cssColor:p.hashStringToHue(t),label:t.charAt(0).toUpperCase()+t.slice(1)}}static hashStringToHue(t){let e=(()=>{let a=0;for(let m=0;m<t.length;m++)a=t.charCodeAt(m)+((a<<5)-a);return a})();return`hsl(${Math.abs(e)*137.508%360}, 70%, 60%)`}},ot;var xo=`:host {
    position: absolute;
    z-index: 1500;
}
