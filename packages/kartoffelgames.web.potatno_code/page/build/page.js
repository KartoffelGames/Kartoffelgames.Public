...
`;function Qi(){function f(c,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),c.push(a)}}function t(c,n,u,a,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=f(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,r,b,v,E,w){var p=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof p=="function")h=t(p,a,s,E,r,b,v,w,i),h!==void 0&&(l(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var M=p.length-1;M>=0;M--){var P=p[M];if(h=t(P,a,s,E,r,b,v,w,i),h!==void 0){l(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=d;d=function(I,D){return V.call(I,D)}}c.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,C;if(h?(x=c,s=s-5,b=b||[],C=b):(x=c.prototype,r=r||[],C=r),s!==0&&!i){var M=h?E:v,P=M.get(d)||0;if(P===!0||P===3&&s!==4||P===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!P&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,p,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(c,n,u){if(n.length>0){for(var a=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),r=w)}return[S(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function S(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||S(n,v),{e:E,get c(){return T(n,a,v)}}}}function Ho(f,t,e,o){return(Ho=Qi())(f,t,e,o)}var Yo,zo,Wo,Bo,Go,ki=12,Uo="http://www.w3.org/2000/svg",ts;Yo=J({selector:"potatno-connection-layer",template:$o,style:Vo}),Wo=st("svgLayer");var Xo=class{static{({e:[Bo,Go],c:[ts,zo]}=Ho(this,[[Wo,1,"svgLayer"]],[Yo]))}constructor(t=O.use(K)){this.mConnectionRegistry=new Map,this.mManager=t,this.mPendingRenderFrame=0,this.mUnsubscribe=null}mConnectionRegistry;mManager;mPendingRenderFrame;mUnsubscribe;#t=(Go(this),Bo(this));get svgLayer(){return this.#t}set svgLayer(t){this.#t=t}onConnect(){this.mUnsubscribe=this.mManager.subscribe(F.Document|F.Function|F.SpecialActiveFunction|F.Node|F.NodeTransform|F.Connection,null,()=>{this.scheduleRender()}),this.scheduleRender()}onDeconstruct(){this.mUnsubscribe?.(),this.mUnsubscribe=null,this.mPendingRenderFrame!==0&&(cancelAnimationFrame(this.mPendingRenderFrame),this.mPendingRenderFrame=0)}onContextMenu(t){if(!(t.target instanceof Element))return;let e=t.target.getAttribute("data-connection-id");e&&(t.preventDefault(),t.stopPropagation(),this.deleteConnectionById(e))}clearPaths(t){let e=t.querySelectorAll("path");for(let o of e)o.remove()}deleteConnectionById(t){let e=this.mConnectionRegistry.get(t);if(!e)return;let o=e.sourcePort.node.outputs.map.get(e.sourcePort.definitionId)??e.sourcePort,l=e.targetPort.node.inputs.map.get(e.targetPort.definitionId)??e.targetPort;this.mManager.graph.disconnectPorts(o,l)}getSvgLayerOrNull(){try{return this.svgLayer}catch{return null}}renderConnections(){let t=this.getSvgLayerOrNull();if(!t)return;let e=this.mManager.activeFunction;if(!e){this.clearPaths(t),this.mConnectionRegistry.clear();return}this.clearPaths(t),this.mConnectionRegistry.clear();let o=this.mManager.integrity.errorItems,l=0;for(let m of e.nodes)for(let g of m.outputs.list)for(let y of g.connectedPorts){let T=`c${l++}`,S=this.mManager.grid.getPortGridPoint(g),c=this.mManager.grid.getPortGridPoint(y),n=o.has(g)||o.has(y);this.mConnectionRegistry.set(T,{sourcePort:g,targetPort:y}),this.renderConnectionPath(t,T,g,S,c,!n)}}renderConnectionPath(t,e,o,l,m,g){let y=this.mManager.grid.createConnectionPath(l,m,o),T=document.createElementNS(Uo,"path");T.setAttribute("d",y),T.setAttribute("data-connection-id",e),T.setAttribute("data-hit-area","true"),T.setAttribute("fill","none"),T.style.cursor="pointer",T.style.pointerEvents="stroke",T.style.stroke="transparent",T.style.strokeLinecap="round",T.style.strokeLinejoin="round",T.style.strokeWidth=`${ki}`,t.appendChild(T);let S=document.createElementNS(Uo,"path");S.setAttribute("d",y),S.setAttribute("data-connection-id",e),S.setAttribute("fill","none"),S.style.pointerEvents="none",S.style.stroke=g?"#a6adc8":"#f38ba8",S.style.strokeLinecap="round",S.style.strokeLinejoin="round",S.style.strokeWidth="2",g||S.setAttribute("stroke-dasharray","6 3"),t.appendChild(S)}scheduleRender(){this.mPendingRenderFrame===0&&(this.mPendingRenderFrame=requestAnimationFrame(()=>{this.mPendingRenderFrame=0,this.renderConnections()}))}static{zo()}};function es(){function f(c,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),c.push(a)}}function t(c,n,u,a,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=f(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,r,b,v,E,w){var p=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof p=="function")h=t(p,a,s,E,r,b,v,w,i),h!==void 0&&(l(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var M=p.length-1;M>=0;M--){var P=p[M];if(h=t(P,a,s,E,r,b,v,w,i),h!==void 0){l(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var _=d;d=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=d;d=function(I,D){return V.call(I,D)}}c.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,C;if(h?(x=c,s=s-5,b=b||[],C=b):(x=c.prototype,r=r||[],C=r),s!==0&&!i){var M=h?E:v,P=M.get(d)||0;if(P===!0||P===3&&s!==4||P===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!P&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,p,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(c,n,u){if(n.length>0){for(var a=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),r=w)}return[S(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function S(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||S(n,v),{e:E,get c(){return T(n,a,v)}}}}function Jo(f,t,e,o){return(Jo=es())(f,t,e,o)}var Ko,Zo,be;Ko=xt({access:X.Read,selector:/^potatno-preview$/});var qo=class{static{({c:[be,Zo]}=Jo(this,[],[Ko]))}constructor(t=O.use(Z),e=O.use(U),o=O.use(et)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(o.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let o=this.mTarget.childNodes.length>0;return o&&(this.mTarget.innerHTML=""),o}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{Zo()}};var Qo=`:host {\r
    display: block;\r
    position: relative;\r
\r
