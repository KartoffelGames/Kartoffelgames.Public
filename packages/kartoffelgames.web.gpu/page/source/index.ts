...
import { WebGpuGenerator } from '../../source/base/base/implementation/web_gpu/web-gpu-generator';
...
(async () => {
    const lGpu: GpuDevice = await GpuDevice.request(new WebGpuGenerator('high-performance'));
