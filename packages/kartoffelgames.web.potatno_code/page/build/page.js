...
potatno-code-editor {\r
    ...
    width: 100%;\r
    height: 100%;\r
}`;var ee=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new _t(this.mProject);for(let o of t.functions)e.addFunction(this.deserializeFunction(o,e));return e}deserializeFunction(t,e){let o=new gt(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let d of t.imports)o.addImport(d);for(let d of t.inputs)o.addInput({label:d.label,dataType:d.dataType});for(let d of t.outputs)o.addOutput({label:d.label,dataType:d.dataType});let a=new Map;for(let d of t.nodes)a.set(d.id,this.deserializeNode(d,o,e));for(let d of t.connections){if(!a.has(d.sourceNodeId)||!a.has(d.targetNodeId))continue;let g=a.get(d.sourceNodeId),y=a.get(d.targetNodeId),w=g.outputs.map.get(d.sourcePortId),C=y.inputs.map.get(d.targetPortId);!w||!C||w.connect(C)}return o}deserializeNode(t,e,o){let a=o.nodeDefinitions.find(g=>g.id===t.definitionId),d=(()=>{if(a)return e.addNodeByDefinition(a,t.transformation);let g=t.ports.filter(w=>w.direction==="input").map(w=>({dataType:w.dataType,definitionId:w.definitionId,label:w.label,portType:w.portType})),y=t.ports.filter(w=>w.direction==="output").map(w=>({dataType:w.dataType,definitionId:w.definitionId,label:w.label,portType:w.portType}));return new Tt(this.mProject,o,e,{definitionId:t.definitionId,ports:{input:g,output:y},label:t.label,transformation:{...t.transformation}})})();d.label=t.label,e.addNode(d);for(let g of t.ports)if(g.portType==="value"&&g.directValue.length>0){let y=d.inputs.map.get(g.definitionId);y&&y.setDirectValue(g.directValue)}return d.preview=t.preview??null,d}};var re=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((y,w)=>{e.set(y,`n${w}`)});let o=[...t.nodes].map(y=>this.serializeNode(y,e.get(y))),a=[];for(let y of t.nodes){let w=e.get(y);for(let C of y.outputs.list)for(let c of C.connectedPorts){let n=e.get(c.node);a.push({sourceNodeId:w,sourcePortId:C.definitionId,targetNodeId:n,targetPortId:c.definitionId})}}let d=t.inputs.map(y=>({label:y.label,dataType:y.dataType})),g=t.outputs.map(y=>({label:y.label,dataType:y.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:d,outputs:g,imports:[...t.imports],nodes:o,connections:a}}serializeNode(t,e){let o=[...t.inputs.list,...t.outputs.list].map(d=>({definitionId:d.definitionId,label:d.label,direction:d.direction,portType:d.portType,dataType:d.portType==="value"?d.dataType:null,directValue:[...d.directValue]})),a=t.preview?{portDefinitionId:t.preview.portDefinitionId,displayId:t.preview.displayId}:null;return{id:e,definitionId:t.definitionId,label:t.label,transformation:{...t.transformation},ports:o,preview:a}}};var yo=`:host {\r
    /* Globals */\r
...
`;function gs(){function f(c,n){return function(l){e(n,"addInitializer"),o(l,"An initializer"),c.push(l)}}function t(c,n,u,l,r,b,v,E,x){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},m={v:!1};s.addInitializer=f(l,m);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(x,s)}finally{m.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function d(c,n,u,l,r,b,v,E,x){var p=u[0],s,m,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof p=="function")h=t(p,l,s,E,r,b,v,x,i),h!==void 0&&(a(r,h),r===0?m=h:r===1?(m=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,E,r,b,v,x,i),h!==void 0){a(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(m===void 0?m=A:typeof m=="function"?m=[m,A]:m.push(A))}}if(r===0||r===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var V=m;m=function(I,D){return V.call(I,D)}}c.push(m)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],r,b,v=new Map,E=new Map,x=0;x<n.length;x++){var p=n[x];if(Array.isArray(p)){var s=p[1],m=p[2],i=p.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(l,T,p,m,s,h,i,P,u)}}return y(l,r),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function w(c,n,u){if(n.length>0){for(var l=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var x=n[v](r,{kind:"class",name:b,addInitializer:f(l,E),metadata:u})}finally{E.v=!0}x!==void 0&&(a(10,x),r=x)}return[C(r,u),function(){for(var p=0;p<l.length;p++)l[p].call(r)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return l.length||C(n,v),{e:E,get c(){return w(n,l,v)}}}}function Vo(f,t,e,o){return(Vo=gs())(f,t,e,o)}var zo,Lo,$o,Go,Bo,_o,Ro,Oo,Fo,Wt;zo=Z({selector:"potatno-resize-box",template:No,style:Ao}),$o=G.state({proxy:!0}),Go=Mt("resize"),Bo=Mt("resize-end");var jo=class{static{({e:[_o,Ro,Oo,Fo],c:[Wt,Lo]}=Vo(this,[[$o,1,"mConfiguration"],[Go,1,"mResize"],[Bo,1,"mResizeEnd"],[rt,3,"bottom"],[rt,3,"left"],[rt,3,"right"],[rt,3,"snap"],[rt,3,"top"],[rt,3,"virtual"],[rt,2,"resize"]],[zo]))}constructor(t=R.use($)){this.mComponentElement=t.element,this.mConfiguration={snap:1,isVirtual:!1,enabledDirections:{top:!1,right:!1,bottom:!1,left:!1}}}mComponentElement;#t=(Fo(this),_o(this));get mConfiguration(){return this.#t}set mConfiguration(t){this.#t=t}#e=Ro(this);get mResize(){return this.#e}set mResize(t){this.#e=t}#r=Oo(this);get mResizeEnd(){return this.#r}set mResizeEnd(t){this.#r=t}get bottom(){return this.mConfiguration.enabledDirections.bottom}set bottom(t){this.mConfiguration.enabledDirections.bottom=this.parseBoolean(t)}get left(){return this.mConfiguration.enabledDirections.left}set left(t){this.mConfiguration.enabledDirections.left=this.parseBoolean(t)}get right(){return this.mConfiguration.enabledDirections.right}set right(t){this.mConfiguration.enabledDirections.right=this.parseBoolean(t)}get snap(){return this.mConfiguration.snap}set snap(t){this.mConfiguration.snap=parseInt(t.toString())}get top(){return this.mConfiguration.enabledDirections.top}set top(t){this.mConfiguration.enabledDirections.top=this.parseBoolean(t)}get virtual(){return this.mConfiguration.isVirtual}set virtual(t){this.mConfiguration.isVirtual=this.parseBoolean(t)}resize(t,e){let o=this.mComponentElement.getBoundingClientRect(),a=o.width,d=o.height;return this.mComponentElement.style.setProperty("width",`${t}px`),this.mComponentElement.style.setProperty("height",`${e}px`),t!==a||e!==d}resizeCorner(t){this.handleResize(t,"both")}resizeHorizontal(t){this.handleResize(t,"horizontal")}resizeVertical(t){this.handleResize(t,"vertical")}createResizeEvent(t,e,o,a,d){let g=t;return e===a&&(g&=~(Gt.right|Gt.left)),o===d&&(g&=~(Gt.top|Gt.bottom)),new pr(e,o,g)}handleResize(t,e){t.preventDefault(),t.stopPropagation();let o=this.mComponentElement.getBoundingClientRect(),a=this.mComponentElement.offsetWidth?o.width/this.mComponentElement.offsetWidth:1,d=this.mComponentElement.offsetHeight?o.height/this.mComponentElement.offsetHeight:1,g=o.width/a,y=o.height/d,w=t.clientX,C=t.clientY,c=1;Math.abs(w-o.left)<Math.abs(w-o.right)&&(c=-1);let n=1;Math.abs(C-o.top)<Math.abs(C-o.bottom)&&(n=-1);let u=0;u+=c===1?Gt.right:Gt.left,u+=n===1?Gt.bottom:Gt.top;let l=g,r=y,b=E=>{let x=(E.clientX-w)/a*c,p=(E.clientY-C)/d*n,s=g+x,m=y+p;e==="horizontal"&&(s=g),e==="vertical"&&(m=y),[l,r]=this.updateComponentSize(u,s,m,l,r)},v=()=>{document.removeEventListener("pointermove",b),document.removeEventListener("pointerup",v),(l!==g||r!==y)&&this.mResizeEnd.dispatchEvent(this.createResizeEvent(u,l,r,g,y))};document.addEventListener("pointermove",b),document.addEventListener("pointerup",v)}parseBoolean(t){return!!(()=>{if(typeof t=="string"){let o=t.toLowerCase();if(["true","false"].includes(o))return o==="true"}return t})()}updateComponentSize(t,e,o,a,d){let g=a;(this.mConfiguration.enabledDirections.left||this.mConfiguration.enabledDirections.right)&&(g=Math.floor(Math.abs(e)/this.mConfiguration.snap)*this.mConfiguration.snap*(e/Math.abs(e)),this.mConfiguration.isVirtual||this.mComponentElement.style.setProperty("width",`${g}px`));let y=d;return(this.mConfiguration.enabledDirections.top||this.mConfiguration.enabledDirections.bottom)&&(y=Math.floor(Math.abs(o)/this.mConfiguration.snap)*this.mConfiguration.snap*(o/Math.abs(o)),this.mConfiguration.isVirtual||this.mComponentElement.style.setProperty("height",`${y}px`)),(g!==a||y!==d)&&this.mResize.dispatchEvent(this.createResizeEvent(t,g,y,a,d)),[g,y]}static{Lo()}},pr=class{mHeight;mResizeHandle;mWidth;get height(){return this.mHeight}get resizeHandle(){return this.mResizeHandle}get width(){return this.mWidth}constructor(t,e,o){this.mHeight=e,this.mResizeHandle=o,this.mWidth=t}},Gt={top:1,right:2,bottom:4,left:8};var Uo=`:host {\r
    position: absolute;\r
    z-index: 200;\r
}\r
\r
...
`;function bs(){function f(c,n){return function(l){e(n,"addInitializer"),o(l,"An initializer"),c.push(l)}}function t(c,n,u,l,r,b,v,E,x){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},m={v:!1};s.addInitializer=f(l,m);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(x,s)}finally{m.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function d(c,n,u,l,r,b,v,E,x){var p=u[0],s,m,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof p=="function")h=t(p,l,s,E,r,b,v,x,i),h!==void 0&&(a(r,h),r===0?m=h:r===1?(m=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,E,r,b,v,x,i),h!==void 0){a(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(m===void 0?m=A:typeof m=="function"?m=[m,A]:m.push(A))}}if(r===0||r===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var V=m;m=function(I,D){return V.call(I,D)}}c.push(m)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],r,b,v=new Map,E=new Map,x=0;x<n.length;x++){var p=n[x];if(Array.isArray(p)){var s=p[1],m=p[2],i=p.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(l,T,p,m,s,h,i,P,u)}}return y(l,r),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function w(c,n,u){if(n.length>0){for(var l=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var x=n[v](r,{kind:"class",name:b,addInitializer:f(l,E),metadata:u})}finally{E.v=!0}x!==void 0&&(a(10,x),r=x)}return[C(r,u),function(){for(var p=0;p<l.length;p++)l[p].call(r)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return l.length||C(n,v),{e:E,get c(){return w(n,l,v)}}}}function Qo(f,t,e,o){return(Qo=bs())(f,t,e,o)}function ws(f){return f}var ko,Xo,tn,en,rn,on,nn,Yo,Wo,Zo,qo,Jo,Ko,oe;ko=Z({selector:"potatno-node-selection-popup",template:Ho,style:Uo,components:[Wt]}),tn=G.state({complexValue:!0}),en=$t("searchInput"),rn=Mt("node-select"),on=G.state(),nn=G.state();new class extends ws{constructor(){super(oe),Xo()}static{class f{static{({e:[Yo,Wo,Zo,qo,Jo,Ko],c:[oe,Xo]}=Qo(this,[[tn,1,"results"],[en,1,"searchInput"],[rn,1,"mNodeSelect"],[on,1,"searchValue"],[nn,1,"selectedDefinitionId"]],[ko]))}static POPUP_WIDTH=280;static POPUP_HEIGHT=320;mComponent;mManager;#t=(Ko(this),Yo(this));get results(){return this.#t}set results(e){this.#t=e}#e=Wo(this);get searchInput(){return this.#e}set searchInput(e){this.#e=e}#r=Zo(this);get mNodeSelect(){return this.#r}set mNodeSelect(e){this.#r=e}#o=qo(this);get searchValue(){return this.#o}set searchValue(e){this.#o=e}#n=Jo(this);get selectedDefinitionId(){return this.#n}set selectedDefinitionId(e){this.#n=e}constructor(e=R.use($),o=R.use(X)){this.mManager=o,this.mComponent=e,this.selectedDefinitionId=null,this.results=new Array,this.searchValue=""}onConnect(){this.searchInput.focus()}onKeyDown(e){if(this.results.length!==0){if(e.key==="ArrowDown"||e.key==="ArrowUp"){e.preventDefault();let o=this.results.findIndex(g=>g.definition.id===this.selectedDefinitionId);o=Math.max(0,o);let a=e.key==="ArrowDown"?1:-1,d=(o+a+this.results.length)%this.results.length;this.selectedDefinitionId=this.results[d].definition.id;return}e.key==="Enter"&&this.sendSelectedEntry(this.selectedDefinitionId)}}onUpdate(){this.rebuildResults();let e=this.mComponent.element.shadowRoot.querySelector(".selection-popup__result.selected");e&&e.scrollIntoView()}stopPropagation(e){e.stopPropagation()}rebuildResults(){if(!this.mManager.activeFunction){this.results=new Array;return}let e=this.mManager.activeFunction.dynamicNodeDefinitions.map(a=>({category:a.category.name,definition:a,label:a.label.toLowerCase(),color:this.mManager.generateStringColor(a.category.name),icon:a.category.icon})),o=this.searchValue.trim().toLowerCase();this.results=e.filter(a=>a.label.includes(o)),this.results.some(a=>a.definition.id===this.selectedDefinitionId)||(this.selectedDefinitionId=this.results[0]?.definition.id??null)}sendSelectedEntry(e){if(e===null)return;let o=this.results.find(a=>a.definition.id===e);o&&this.mNodeSelect.dispatchEvent(o.definition)}}}};var sn=`:host {\r
    position: absolute;\r
    top: 0;\r
    left: 0;\r
    height: 1px;\r
...
`;function Es(){function f(c,n){return function(l){e(n,"addInitializer"),o(l,"An initializer"),c.push(l)}}function t(c,n,u,l,r,b,v,E,x){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},m={v:!1};s.addInitializer=f(l,m);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(x,s)}finally{m.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function d(c,n,u,l,r,b,v,E,x){var p=u[0],s,m,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof p=="function")h=t(p,l,s,E,r,b,v,x,i),h!==void 0&&(a(r,h),r===0?m=h:r===1?(m=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,E,r,b,v,x,i),h!==void 0){a(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(m===void 0?m=A:typeof m=="function"?m=[m,A]:m.push(A))}}if(r===0||r===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var V=m;m=function(I,D){return V.call(I,D)}}c.push(m)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],r,b,v=new Map,E=new Map,x=0;x<n.length;x++){var p=n[x];if(Array.isArray(p)){var s=p[1],m=p[2],i=p.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(l,T,p,m,s,h,i,P,u)}}return y(l,r),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function w(c,n,u){if(n.length>0){for(var l=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var x=n[v](r,{kind:"class",name:b,addInitializer:f(l,E),metadata:u})}finally{E.v=!0}x!==void 0&&(a(10,x),r=x)}return[C(r,u),function(){for(var p=0;p<l.length;p++)l[p].call(r)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return l.length||C(n,v),{e:E,get c(){return w(n,l,v)}}}}function mn(f,t,e,o){return(mn=Es())(f,t,e,o)}var dn,ln,fn,cn,un,gr;dn=Z({selector:"potatno-connection-layer",template:an,style:sn}),fn=$t("svgLayer");var hn=class{static{({e:[cn,un],c:[gr,ln]}=mn(this,[[fn,1,"svgLayer"]],[dn]))}constructor(t=R.use(X)){this.mConnectionRegistry=new Map,this.mManager=t;let e=0;this.mUnsubscribe=this.mManager.subscribe(O.SpecialActiveFunction|O.Node|O.Connection,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.renderConnections()}))})}mConnectionRegistry;mManager;mUnsubscribe;#t=(un(this),cn(this));get svgLayer(){return this.#t}set svgLayer(t){this.#t=t}onConnectionDelete(t){if(t.button!==2||!(t.target instanceof Element))return;let e=parseInt(t.target.getAttribute("data-connection-id")??"");if(isNaN(e))return;t.preventDefault(),t.stopPropagation();let o=this.mConnectionRegistry.get(e);o&&this.mManager.graph.disconnectPorts(o.sourcePort,o.targetPort)}onDeconstruct(){this.mUnsubscribe()}renderConnectionPath(t,e,o,a,d){let g="http://www.w3.org/2000/svg",y=this.mManager.connections.getConnectionPath(o,a),w=document.createElementNS(g,"path");w.classList.add("path"),w.classList.toggle(".path--invalid",!d),w.setAttribute("d",y),o.portType==="value"&&w.style.setProperty("--path-color",this.mManager.generateStringColor(o.resolvedDataType));let C=document.createElementNS(g,"path");C.classList.add("path","path--mouse-target"),C.setAttribute("d",y),C.setAttribute("data-connection-id",e.toString()),t.appendChild(w),t.appendChild(C)}renderConnections(){this.svgLayer.innerHTML="",this.mConnectionRegistry.clear();let t=this.mManager.activeFunction;if(!t)return;let e=this.mManager.integrity.errorItems,o=0;for(let a of t.nodes)for(let d of a.outputs.list)for(let g of d.connectedPorts){let y=o++;this.mConnectionRegistry.set(y,{sourcePort:d,targetPort:g});let w=e.has(d)||e.has(g);this.renderConnectionPath(this.svgLayer,y,d,g,!w)}}static{ln()}};function Ds(){function f(c,n){return function(l){e(n,"addInitializer"),o(l,"An initializer"),c.push(l)}}function t(c,n,u,l,r,b,v,E,x){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},m={v:!1};s.addInitializer=f(l,m);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(x,s)}finally{m.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function d(c,n,u,l,r,b,v,E,x){var p=u[0],s,m,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof p=="function")h=t(p,l,s,E,r,b,v,x,i),h!==void 0&&(a(r,h),r===0?m=h:r===1?(m=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,E,r,b,v,x,i),h!==void 0){a(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(m===void 0?m=A:typeof m=="function"?m=[m,A]:m.push(A))}}if(r===0||r===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var V=m;m=function(I,D){return V.call(I,D)}}c.push(m)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],r,b,v=new Map,E=new Map,x=0;x<n.length;x++){var p=n[x];if(Array.isArray(p)){var s=p[1],m=p[2],i=p.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(l,T,p,m,s,h,i,P,u)}}return y(l,r),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function w(c,n,u){if(n.length>0){for(var l=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var x=n[v](r,{kind:"class",name:b,addInitializer:f(l,E),metadata:u})}finally{E.v=!0}x!==void 0&&(a(10,x),r=x)}return[C(r,u),function(){for(var p=0;p<l.length;p++)l[p].call(r)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return l.length||C(n,v),{e:E,get c(){return w(n,l,v)}}}}function vn(f,t,e,o){return(vn=Ds())(f,t,e,o)}var yn,pn,Ce;yn=pt({access:Y.Read,selector:/^potatno-preview$/});var gn=class{static{({c:[Ce,pn]}=vn(this,[],[yn]))}constructor(t=R.use(J),e=R.use(H),o=R.use(ot)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(o.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let o=this.mTarget.childNodes.length>0;return o&&(this.mTarget.innerHTML=""),o}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{pn()}};var bn=`:host {\r
    display: block;\r
    position: relative;\r
\r
...
`;function Rs(){function f(c,n){return function(l){e(n,"addInitializer"),o(l,"An initializer"),c.push(l)}}function t(c,n,u,l,r,b,v,E,x){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},m={v:!1};s.addInitializer=f(l,m);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(x,s)}finally{m.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function d(c,n,u,l,r,b,v,E,x){var p=u[0],s,m,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof p=="function")h=t(p,l,s,E,r,b,v,x,i),h!==void 0&&(a(r,h),r===0?m=h:r===1?(m=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,E,r,b,v,x,i),h!==void 0){a(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(m===void 0?m=A:typeof m=="function"?m=[m,A]:m.push(A))}}if(r===0||r===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var V=m;m=function(I,D){return V.call(I,D)}}c.push(m)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],r,b,v=new Map,E=new Map,x=0;x<n.length;x++){var p=n[x];if(Array.isArray(p)){var s=p[1],m=p[2],i=p.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(l,T,p,m,s,h,i,P,u)}}return y(l,r),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function w(c,n,u){if(n.length>0){for(var l=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var x=n[v](r,{kind:"class",name:b,addInitializer:f(l,E),metadata:u})}finally{E.v=!0}x!==void 0&&(a(10,x),r=x)}return[C(r,u),function(){for(var p=0;p<l.length;p++)l[p].call(r)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return l.length||C(n,v),{e:E,get c(){return w(n,l,v)}}}}function Qn(f,t,e,o){return(Qn=Rs())(f,t,e,o)}var kn,Yn,ti,ei,ri,Wn,Zn,qn,Jn,br;kn=Z({selector:"potatno-node-graph",template:Xn,style:Hn,components:[oe,yr,gr]}),ti=G.state(),ei=G.state({complexValue:!0}),ri=G.state();var Kn=class{static{({e:[Wn,Zn,qn,Jn],c:[br,Yn]}=Qn(this,[[ti,1,"mTransformVersion"],[ei,1,"selectBox"],[ri,1,"popupPosition"]],[kn]))}constructor(t=R.use($),e=R.use(X)){this.mComponent=t,this.mMouseInside=!1,this.mManager=e,this.mSelectedNodes=new Set,this.popupPosition=null,this.selectBox=null,t.element.addEventListener("pointerdown",o=>{this.onCanvasPointerDown(o)}),t.element.addEventListener("wheel",o=>{this.onCanvasWheel(o)}),t.element.addEventListener("contextmenu",o=>{o.preventDefault()}),t.element.addEventListener("pointerenter",()=>{this.mMouseInside=!0}),t.element.addEventListener("pointerleave",()=>{this.mMouseInside=!1}),this.mKeyboardHandler=o=>this.onKeyDown(o),document.addEventListener("keydown",this.mKeyboardHandler),this.mUnsubscribeFunctionChange=this.mManager.subscribe(O.Document|O.Function|O.SpecialActiveFunction,()=>{this.popupPosition=null,this.selectBox=null,this.mSelectedNodes.clear(),this.mComponent.updater.updateAsync()}),this.mUnsubscribeGraphChange=this.mManager.subscribe(O.NodeAdd|O.NodeDelete,()=>{this.mComponent.updater.updateAsync()})}mComponent;mManager;mSelectedNodes;mKeyboardHandler;mMouseInside;mUnsubscribeFunctionChange;mUnsubscribeGraphChange;#t=(Jn(this),Wn(this,0));get mTransformVersion(){return this.#t}set mTransformVersion(t){this.#t=t}#e=Zn(this);get selectBox(){return this.#e}set selectBox(t){this.#e=t}#r=qn(this);get popupPosition(){return this.#r}set popupPosition(t){this.#r=t}get gridBackgroundStyle(){this.mTransformVersion;let t=this.mManager.grid.gridSize*this.mManager.grid.zoom,e=this.mManager.grid.panX%t,o=this.mManager.grid.panY%t;return[`background-size: ${t}px ${t}px`,`background-position: ${e}px ${o}px`].join("; ")}get gridTransformStyle(){return this.mTransformVersion,`transform: translate(${this.mManager.grid.panX}px, ${this.mManager.grid.panY}px) scale(${this.mManager.grid.zoom})`}get nodes(){return this.mManager.activeFunction?this.mManager.activeFunction.nodes:new Set}get selectedNode(){return this.mSelectedNodes}onConnect(){this.mManager.connections.gridElement=this.mComponent.element}onDeconstruct(){this.mUnsubscribeFunctionChange(),this.mUnsubscribeGraphChange(),document.removeEventListener("keydown",this.mKeyboardHandler)}onCanvasPointerDown(t){switch(this.popupPosition=null,t.button){case 1:{t.preventDefault(),this.pointerDrag(t,"panning");return}case 2:{this.openAddNodePopupAtPointer(t.clientX,t.clientY);return}case 0:t.ctrlKey||this.mSelectedNodes.clear(),this.pointerDrag(t,"selecting")}}onCanvasWheel(t){t.preventDefault();let e=this.convertGlobalToGridPosition(t.clientX,t.clientY);this.mManager.grid.zoomAt(e.x,e.y,t.deltaY>0?-.1:.1),this.mTransformVersion++}createNodeOnPopupPosition(t){if(!this.mManager.activeFunction||!this.popupPosition)return;let e=this.mManager.graph.addNode(this.mManager.activeFunction,t,{x:this.popupPosition.grid.x,y:this.popupPosition.grid.y,height:0,width:0});this.popupPosition=null,this.mSelectedNodes.clear(),this.mSelectedNodes.add(e)}pointerDrag(t,e){let o=this.convertGlobalToGridPosition(t.clientX,t.clientY),a=o,d=y=>{let w=this.convertGlobalToGridPosition(y.clientX,y.clientY);switch(e){case"panning":{this.mManager.grid.pan(w.x-a.x,w.y-a.y),this.mTransformVersion++;break}case"selecting":{this.selectBox={x:Math.min(o.x,w.x),y:Math.min(o.y,w.y),width:Math.abs(w.x-o.x),height:Math.abs(w.y-o.y)};break}}a=w},g=()=>{document.removeEventListener("pointermove",d),document.removeEventListener("pointerup",g),e==="selecting"&&this.selectBox&&(this.selectNodesInBox(this.selectBox),this.selectBox=null)};document.addEventListener("pointermove",d),document.addEventListener("pointerup",g)}onKeyDown(t){if(!this.mMouseInside)return;let e=document.activeElement;if(!(e instanceof HTMLInputElement||e instanceof HTMLTextAreaElement||e instanceof HTMLSelectElement)){switch(t.key){case"Escape":{this.popupPosition=null;return}case"Delete":{for(let o of this.mSelectedNodes)this.mManager.graph.removeNode(o);this.mSelectedNodes.clear();return}}if(t.ctrlKey)switch(t.key){case"z":{t.preventDefault(),this.mManager.history.undo();return}case"y":{t.preventDefault(),this.mManager.history.redo();return}case"c":{this.mManager.clipboard.copy(this.mSelectedNodes);return}case"v":t.preventDefault(),this.pasteFromClipboard()}}}convertGlobalToGridPosition(t,e){let o=this.mComponent.element.getBoundingClientRect();return{x:t-o.left,y:e-o.top}}moveAllSelected(t,e){for(let o of this.mSelectedNodes)o!==t&&this.mManager.graph.transformNode(o,a=>{a.moveTo(a.transformation.x+e.x,a.transformation.y+e.y)})}selectNode(t,e){t.stopPropagation(),this.popupPosition=null,t.ctrlKey?this.mSelectedNodes.has(e)?this.mSelectedNodes.delete(e):this.mSelectedNodes.add(e):this.mSelectedNodes.has(e)||(this.mSelectedNodes.clear(),this.mSelectedNodes.add(e)),this.mComponent.updater.updateAsync()}openAddNodePopupAtPointer(t,e){let o=this.mComponent.element,a=this.convertGlobalToGridPosition(t,e),d=Math.max(0,o.clientWidth-oe.POPUP_WIDTH-8),g=Math.max(0,o.clientHeight-oe.POPUP_HEIGHT-8),y=this.mManager.grid.gridSize,w=this.convertScreenToGridCoordinate(a.x,a.y),C={x:Math.round(w.x/y)*y,y:Math.round(w.y/y)*y};this.popupPosition={screenX:Math.max(8,Math.min(a.x,d)),screenY:Math.max(8,Math.min(a.y,g)),grid:{x:Math.floor(C.x/y),y:Math.floor(C.y/y)}}}convertScreenToGridCoordinate(t,e){return{x:(t-this.mManager.grid.panX)/this.mManager.grid.zoom,y:(e-this.mManager.grid.panY)/this.mManager.grid.zoom}}pasteFromClipboard(){if(!this.mManager.activeFunction)return;let e=this.mManager.clipboard.paste();if(e.length!==0){this.mSelectedNodes.clear();for(let o of e)this.mSelectedNodes.add(o)}}selectNodesInBox(t){let e=this.mManager.activeFunction;if(!e)return;let o=this.convertScreenToGridCoordinate(t.x,t.y),a=this.convertScreenToGridCoordinate(t.x+t.width,t.y+t.height),d=this.mManager.grid.gridSize;for(let g of e.nodes){let y=g.transformation.x*d,w=g.transformation.y*d,C=y+g.transformation.width*d,c=w+g.transformation.height*d;y<a.x&&C>o.x&&w<a.y&&c>o.y&&this.mSelectedNodes.add(g)}}static{Yn()}};var ne=class{mCodeGenerator;mId;mLabel;mNodesProvider;mStatics;get codeGenerator(){return this.mCodeGenerator}get id(){return this.mId}get label(){return this.mLabel}get statics(){return this.mStatics}constructor(t){this.mId=t.id,this.mLabel=t.label,this.mNodesProvider=t.nodes,this.mStatics=t.statics,this.mCodeGenerator=t.generator.code}getNodeDefinitions(t){let e=a=>{if(!a)return new Array;let d=new Array;return a(g=>{d.push(g)},t),d},o={};return Object.defineProperty(o,"entry",{get:()=>e(this.mNodesProvider.entry)}),Object.defineProperty(o,"exit",{get:()=>e(this.mNodesProvider.exit)}),Object.defineProperty(o,"dynamic",{get:()=>e(this.mNodesProvider.dynamic)}),o}},St={none:0,imports:1,inputs:2,outputs:4};var oi=`:host {\r
    display: flex;\r
    flex-direction: column;\r
    height: 100%;\r
    overflow: hidden;\r
