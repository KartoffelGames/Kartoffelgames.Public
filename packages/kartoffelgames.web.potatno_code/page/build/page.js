...
`;function ha(){function g(l,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),l.push(a)}}function t(l,n,u,a,o,b,f,D,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:b,private:f,metadata:D},d={v:!1};s.addInitializer=g(a,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,o,b,f,D,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,a,s,D,o,b,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,a,s,D,o,b,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(l.push(function(I,E){return i.get.call(I,E)}),l.push(function(I,E){return i.set.call(I,E)})):o===2?l.push(i):l.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,a,s))}function v(l,n,u){for(var a=[],o,b,f=new Map,D=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=l,s=s-5,b=b||[],P=b):(x=l.prototype,o=o||[],P=o),s!==0&&!i){var M=h?D:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,x,p,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],o=l,b=l.name,f=n.length-1;f>=0;f--){var D={v:!1};try{var w=n[f](o,{kind:"class",name:b,addInitializer:g(a,D),metadata:u})}finally{D.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<a.length;p++)a[p].call(o)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(b===void 0?null:b),D=v(n,u,f);return a.length||C(n,f),{e:D,get c(){return T(n,a,f)}}}}function _r(g,t,e,r){return(_r=ha())(g,t,e,r)}var Nr,Mr,Ar;Nr=B({selector:"kg-information",template:Pr,style:Cr});var Sr=class{static{({c:[Ar,Mr]}=_r(this,[],[Nr]))}static{Mr()}};var Lr=`:host {\r
    display: block;\r
