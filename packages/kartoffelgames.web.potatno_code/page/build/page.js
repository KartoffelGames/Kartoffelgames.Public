...
\r
        .new & {\r
            /* Animated svg buildup. 100k is big enought for long lines, so a animation itself must run long itself. */\r
            stroke-dasharray: 100000;\r
            stroke-dashoffset: 100000;\r
            animation: animateDash 50s linear forwards;\r
        }\r
\r
        .error & {\r
            stroke: var(--potatno-color-error);\r
            filter: drop-shadow(0px 0px 2px var(--potatno-color-error));\r
        }\r
\r
        &.path--invalid {\r
