...
export class PgslEnumTrace {
    ...
    private readonly mValues: Map<string, PgslExpression>;
     ...
     */
    public get values(): ReadonlyMap<string, PgslExpression> {
        return this.mValues;
    }
...
export type PgslEnumTraceValues = Array<{ name: string; value: PgslExpression; }>;