...
potatno-code-editor {\r
    ...
    width: 100%;\r
    height: 100%;\r
}`;var ee=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new _t(this.mProject);for(let o of t.functions)e.addFunction(this.deserializeFunction(o,e));return e}deserializeFunction(t,e){let o=new gt(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let m of t.imports)o.addImport(m);for(let m of t.inputs)o.addInput({label:m.label,dataType:m.dataType});for(let m of t.outputs)o.addOutput({label:m.label,dataType:m.dataType});let a=new Map;for(let m of t.nodes)a.set(m.id,this.deserializeNode(m,o,e));for(let m of t.connections){if(!a.has(m.sourceNodeId)||!a.has(m.targetNodeId))continue;let g=a.get(m.sourceNodeId),y=a.get(m.targetNodeId),x=g.outputs.map.get(m.sourcePortId),C=y.inputs.map.get(m.targetPortId);!x||!C||x.connect(C)}return o}deserializeNode(t,e,o){let a=o.nodeDefinitions.find(g=>g.id===t.definitionId),m=(()=>{if(a)return e.addNodeByDefinition(a,t.transformation);let g=t.ports.filter(x=>x.direction==="input").map(x=>({dataType:x.dataType,definitionId:x.definitionId,label:x.label,portType:x.portType})),y=t.ports.filter(x=>x.direction==="output").map(x=>({dataType:x.dataType,definitionId:x.definitionId,label:x.label,portType:x.portType}));return new Tt(this.mProject,o,e,{definitionId:t.definitionId,ports:{input:g,output:y},label:t.label,transformation:{...t.transformation}})})();m.label=t.label,e.addNode(m);for(let g of t.ports)if(g.portType==="value"&&g.directValue.length>0){let y=m.inputs.map.get(g.definitionId);y&&y.setDirectValue(g.directValue)}return m.preview=t.preview??null,m}};var re=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((y,x)=>{e.set(y,`n${x}`)});let o=[...t.nodes].map(y=>this.serializeNode(y,e.get(y))),a=[];for(let y of t.nodes){let x=e.get(y);for(let C of y.outputs.list)for(let c of C.connectedPorts){let n=e.get(c.node);a.push({sourceNodeId:x,sourcePortId:C.definitionId,targetNodeId:n,targetPortId:c.definitionId})}}let m=t.inputs.map(y=>({label:y.label,dataType:y.dataType})),g=t.outputs.map(y=>({label:y.label,dataType:y.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:m,outputs:g,imports:[...t.imports],nodes:o,connections:a}}serializeNode(t,e){let o=[...t.inputs.list,...t.outputs.list].map(m=>({definitionId:m.definitionId,label:m.label,direction:m.direction,portType:m.portType,dataType:m.portType==="value"?m.dataType:null,directValue:[...m.directValue]})),a=t.preview?{portDefinitionId:t.preview.portDefinitionId,displayId:t.preview.displayId}:null;return{id:e,definitionId:t.definitionId,label:t.label,transformation:{...t.transformation},ports:o,preview:a}}};var yo=`:host {\r
    /* Globals */\r
...
`;function ms(){function f(c,n){return function(l){e(n,"addInitializer"),o(l,"An initializer"),c.push(l)}}function t(c,n,u,l,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=f(l,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(c,n,u,l,r,b,v,E,w){var p=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof p=="function")h=t(p,l,s,E,r,b,v,w,i),h!==void 0&&(a(r,h),r===0?d=h:r===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,E,r,b,v,w,i),h!==void 0){a(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var V=d;d=function(I,D){return V.call(I,D)}}c.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,T,p,d,s,h,i,P,u)}}return y(l,r),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function x(c,n,u){if(n.length>0){for(var l=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(l,E),metadata:u})}finally{E.v=!0}w!==void 0&&(a(10,w),r=w)}return[C(r,u),function(){for(var p=0;p<l.length;p++)l[p].call(r)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return l.length||C(n,v),{e:E,get c(){return x(n,l,v)}}}}function Vo(f,t,e,o){return(Vo=ms())(f,t,e,o)}var zo,Lo,$o,Go,Bo,_o,Ro,Oo,Fo,Wt;zo=Z({selector:"potatno-resize-box",template:No,style:Ao}),$o=G.state({proxy:!0}),Go=Mt("resize"),Bo=Mt("resize-end");var jo=class{static{({e:[_o,Ro,Oo,Fo],c:[Wt,Lo]}=Vo(this,[[$o,1,"mConfiguration"],[Go,1,"mResize"],[Bo,1,"mResizeEnd"],[rt,3,"bottom"],[rt,3,"left"],[rt,3,"right"],[rt,3,"snap"],[rt,3,"top"],[rt,3,"virtual"],[rt,2,"resize"]],[zo]))}constructor(t=R.use($)){this.mComponentElement=t.element,this.mConfiguration={snap:1,isVirtual:!1,enabledDirections:{top:!1,right:!1,bottom:!1,left:!1}}}mComponentElement;#t=(Fo(this),_o(this));get mConfiguration(){return this.#t}set mConfiguration(t){this.#t=t}#e=Ro(this);get mResize(){return this.#e}set mResize(t){this.#e=t}#r=Oo(this);get mResizeEnd(){return this.#r}set mResizeEnd(t){this.#r=t}get bottom(){return this.mConfiguration.enabledDirections.bottom}set bottom(t){this.mConfiguration.enabledDirections.bottom=this.parseBoolean(t)}get left(){return this.mConfiguration.enabledDirections.left}set left(t){this.mConfiguration.enabledDirections.left=this.parseBoolean(t)}get right(){return this.mConfiguration.enabledDirections.right}set right(t){this.mConfiguration.enabledDirections.right=this.parseBoolean(t)}get snap(){return this.mConfiguration.snap}set snap(t){this.mConfiguration.snap=parseInt(t.toString())}get top(){return this.mConfiguration.enabledDirections.top}set top(t){this.mConfiguration.enabledDirections.top=this.parseBoolean(t)}get virtual(){return this.mConfiguration.isVirtual}set virtual(t){this.mConfiguration.isVirtual=this.parseBoolean(t)}resize(t,e){let o=this.mComponentElement.getBoundingClientRect(),a=o.width,m=o.height;return this.mComponentElement.style.setProperty("width",`${t}px`),this.mComponentElement.style.setProperty("height",`${e}px`),t!==a||e!==m}resizeCorner(t){this.handleResize(t,"both")}resizeHorizontal(t){this.handleResize(t,"horizontal")}resizeVertical(t){this.handleResize(t,"vertical")}createResizeEvent(t,e,o,a,m){let g=t;return e===a&&(g&=~(Gt.right|Gt.left)),o===m&&(g&=~(Gt.top|Gt.bottom)),new gr(e,o,g)}handleResize(t,e){t.preventDefault(),t.stopPropagation();let o=this.mComponentElement.getBoundingClientRect(),a=this.mComponentElement.offsetWidth?o.width/this.mComponentElement.offsetWidth:1,m=this.mComponentElement.offsetHeight?o.height/this.mComponentElement.offsetHeight:1,g=o.width/a,y=o.height/m,x=t.clientX,C=t.clientY,c=1;Math.abs(x-o.left)<Math.abs(x-o.right)&&(c=-1);let n=1;Math.abs(C-o.top)<Math.abs(C-o.bottom)&&(n=-1);let u=0;u+=c===1?Gt.right:Gt.left,u+=n===1?Gt.bottom:Gt.top;let l=g,r=y,b=E=>{let w=(E.clientX-x)/a*c,p=(E.clientY-C)/m*n,s=g+w,d=y+p;e==="horizontal"&&(s=g),e==="vertical"&&(d=y),[l,r]=this.updateComponentSize(u,s,d,l,r)},v=()=>{document.removeEventListener("pointermove",b),document.removeEventListener("pointerup",v),(l!==g||r!==y)&&this.mResizeEnd.dispatchEvent(this.createResizeEvent(u,l,r,g,y))};document.addEventListener("pointermove",b),document.addEventListener("pointerup",v)}parseBoolean(t){return!!(()=>{if(typeof t=="string"){let o=t.toLowerCase();if(["true","false"].includes(o))return o==="true"}return t})()}updateComponentSize(t,e,o,a,m){let g=a;(this.mConfiguration.enabledDirections.left||this.mConfiguration.enabledDirections.right)&&(g=Math.floor(Math.abs(e)/this.mConfiguration.snap)*this.mConfiguration.snap*(e/Math.abs(e)),this.mConfiguration.isVirtual||this.mComponentElement.style.setProperty("width",`${g}px`));let y=m;return(this.mConfiguration.enabledDirections.top||this.mConfiguration.enabledDirections.bottom)&&(y=Math.floor(Math.abs(o)/this.mConfiguration.snap)*this.mConfiguration.snap*(o/Math.abs(o)),this.mConfiguration.isVirtual||this.mComponentElement.style.setProperty("height",`${y}px`)),(g!==a||y!==m)&&this.mResize.dispatchEvent(this.createResizeEvent(t,g,y,a,m)),[g,y]}static{Lo()}},gr=class{mHeight;mResizeHandle;mWidth;get height(){return this.mHeight}get resizeHandle(){return this.mResizeHandle}get width(){return this.mWidth}constructor(t,e,o){this.mHeight=e,this.mResizeHandle=o,this.mWidth=t}},Gt={top:1,right:2,bottom:4,left:8};var Uo=`:host {\r
    position: absolute;\r
    z-index: 200;\r
}\r
\r
...
`;function gs(){function f(c,n){return function(l){e(n,"addInitializer"),o(l,"An initializer"),c.push(l)}}function t(c,n,u,l,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=f(l,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(c,n,u,l,r,b,v,E,w){var p=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof p=="function")h=t(p,l,s,E,r,b,v,w,i),h!==void 0&&(a(r,h),r===0?d=h:r===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,E,r,b,v,w,i),h!==void 0){a(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var V=d;d=function(I,D){return V.call(I,D)}}c.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,T,p,d,s,h,i,P,u)}}return y(l,r),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function x(c,n,u){if(n.length>0){for(var l=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(l,E),metadata:u})}finally{E.v=!0}w!==void 0&&(a(10,w),r=w)}return[C(r,u),function(){for(var p=0;p<l.length;p++)l[p].call(r)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return l.length||C(n,v),{e:E,get c(){return x(n,l,v)}}}}function Qo(f,t,e,o){return(Qo=gs())(f,t,e,o)}function vs(f){return f}var ko,Xo,tn,en,rn,on,nn,Yo,Wo,Zo,qo,Jo,Ko,oe;ko=Z({selector:"potatno-node-selection-popup",template:Ho,style:Uo,components:[Wt]}),tn=G.state({complexValue:!0}),en=$t("searchInput"),rn=Mt("node-select"),on=G.state(),nn=G.state();new class extends vs{constructor(){super(oe),Xo()}static{class f{static{({e:[Yo,Wo,Zo,qo,Jo,Ko],c:[oe,Xo]}=Qo(this,[[tn,1,"results"],[en,1,"searchInput"],[rn,1,"mNodeSelect"],[on,1,"searchValue"],[nn,1,"selectedDefinitionId"]],[ko]))}static POPUP_WIDTH=280;static POPUP_HEIGHT=320;mComponent;mManager;#t=(Ko(this),Yo(this));get results(){return this.#t}set results(e){this.#t=e}#e=Wo(this);get searchInput(){return this.#e}set searchInput(e){this.#e=e}#r=Zo(this);get mNodeSelect(){return this.#r}set mNodeSelect(e){this.#r=e}#o=qo(this);get searchValue(){return this.#o}set searchValue(e){this.#o=e}#n=Jo(this);get selectedDefinitionId(){return this.#n}set selectedDefinitionId(e){this.#n=e}constructor(e=R.use($),o=R.use(X)){this.mManager=o,this.mComponent=e,this.selectedDefinitionId=null,this.results=new Array,this.searchValue=""}onConnect(){this.searchInput.focus()}onKeyDown(e){if(this.results.length!==0){if(e.key==="ArrowDown"||e.key==="ArrowUp"){e.preventDefault();let o=this.results.findIndex(g=>g.definition.id===this.selectedDefinitionId);o=Math.max(0,o);let a=e.key==="ArrowDown"?1:-1,m=(o+a+this.results.length)%this.results.length;this.selectedDefinitionId=this.results[m].definition.id;return}e.key==="Enter"&&this.sendSelectedEntry(this.selectedDefinitionId)}}onUpdate(){this.rebuildResults();let e=this.mComponent.element.shadowRoot.querySelector(".selection-popup__result.selected");e&&e.scrollIntoView()}stopPropagation(e){e.stopPropagation()}rebuildResults(){if(!this.mManager.activeFunction){this.results=new Array;return}let e=this.mManager.activeFunction.dynamicNodeDefinitions.map(a=>({category:a.category.name,definition:a,label:a.label.toLowerCase(),color:this.mManager.generateStringColor(a.category.name),icon:a.category.icon})),o=this.searchValue.trim().toLowerCase();this.results=e.filter(a=>a.label.includes(o)),this.results.some(a=>a.definition.id===this.selectedDefinitionId)||(this.selectedDefinitionId=this.results[0]?.definition.id??null)}sendSelectedEntry(e){if(e===null)return;let o=this.results.find(a=>a.definition.id===e);o&&this.mNodeSelect.dispatchEvent(o.definition)}}}};var sn=`:host {\r
    position: absolute;\r
    top: 0;\r
    left: 0;\r
    height: 1px;\r
...
`;function ws(){function f(c,n){return function(l){e(n,"addInitializer"),o(l,"An initializer"),c.push(l)}}function t(c,n,u,l,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=f(l,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(c,n,u,l,r,b,v,E,w){var p=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof p=="function")h=t(p,l,s,E,r,b,v,w,i),h!==void 0&&(a(r,h),r===0?d=h:r===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,E,r,b,v,w,i),h!==void 0){a(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var V=d;d=function(I,D){return V.call(I,D)}}c.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,T,p,d,s,h,i,P,u)}}return y(l,r),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function x(c,n,u){if(n.length>0){for(var l=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(l,E),metadata:u})}finally{E.v=!0}w!==void 0&&(a(10,w),r=w)}return[C(r,u),function(){for(var p=0;p<l.length;p++)l[p].call(r)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return l.length||C(n,v),{e:E,get c(){return x(n,l,v)}}}}function dn(f,t,e,o){return(dn=ws())(f,t,e,o)}var mn,ln,fn,cn,un,vr;mn=Z({selector:"potatno-connection-layer",template:an,style:sn}),fn=$t("svgLayer");var hn=class{static{({e:[cn,un],c:[vr,ln]}=dn(this,[[fn,1,"svgLayer"]],[mn]))}constructor(t=R.use(X)){this.mConnectionRegistry=new Map,this.mManager=t;let e=0;this.mUnsubscribe=this.mManager.subscribe(O.SpecialActiveFunction|O.Node|O.Connection,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.renderConnections()}))})}mConnectionRegistry;mManager;mUnsubscribe;#t=(un(this),cn(this));get svgLayer(){return this.#t}set svgLayer(t){this.#t=t}onConnectionDelete(t){if(t.button!==2||!(t.target instanceof Element))return;let e=parseInt(t.target.getAttribute("data-connection-id")??"");if(isNaN(e))return;t.preventDefault(),t.stopPropagation();let o=this.mConnectionRegistry.get(e);o&&this.mManager.graph.disconnectPorts(o.sourcePort,o.targetPort)}onDeconstruct(){this.mUnsubscribe()}renderConnectionPath(t,e,o,a,m){let g="http://www.w3.org/2000/svg",y=this.mManager.connections.getConnectionPath(o,a),x=document.createElementNS(g,"path");x.classList.add("path"),x.classList.toggle(".path--invalid",!m),x.setAttribute("d",y),o.portType==="value"&&x.style.setProperty("--path-color",this.mManager.generateStringColor(o.resolvedDataType));let C=document.createElementNS(g,"path");C.classList.add("path","path--mouse-target"),C.setAttribute("d",y),C.setAttribute("data-connection-id",e.toString()),t.appendChild(x),t.appendChild(C)}renderConnections(){this.svgLayer.innerHTML="",this.mConnectionRegistry.clear();let t=this.mManager.activeFunction;if(!t)return;let e=this.mManager.integrity.errorItems,o=0;for(let a of t.nodes)for(let m of a.outputs.list)for(let g of m.connectedPorts){let y=o++;this.mConnectionRegistry.set(y,{sourcePort:m,targetPort:g});let x=e.has(m)||e.has(g);this.renderConnectionPath(this.svgLayer,y,m,g,!x)}}static{ln()}};function xs(){function f(c,n){return function(l){e(n,"addInitializer"),o(l,"An initializer"),c.push(l)}}function t(c,n,u,l,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=f(l,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(c,n,u,l,r,b,v,E,w){var p=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof p=="function")h=t(p,l,s,E,r,b,v,w,i),h!==void 0&&(a(r,h),r===0?d=h:r===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,E,r,b,v,w,i),h!==void 0){a(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var V=d;d=function(I,D){return V.call(I,D)}}c.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,T,p,d,s,h,i,P,u)}}return y(l,r),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function x(c,n,u){if(n.length>0){for(var l=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(l,E),metadata:u})}finally{E.v=!0}w!==void 0&&(a(10,w),r=w)}return[C(r,u),function(){for(var p=0;p<l.length;p++)l[p].call(r)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return l.length||C(n,v),{e:E,get c(){return x(n,l,v)}}}}function vn(f,t,e,o){return(vn=xs())(f,t,e,o)}var yn,pn,Ce;yn=pt({access:Y.Read,selector:/^potatno-preview$/});var gn=class{static{({c:[Ce,pn]}=vn(this,[],[yn]))}constructor(t=R.use(J),e=R.use(H),o=R.use(ot)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(o.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let o=this.mTarget.childNodes.length>0;return o&&(this.mTarget.innerHTML=""),o}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{pn()}};var bn=`:host {\r
    display: block;\r
    position: relative;\r
\r
...
`;function Ds(){function f(c,n){return function(l){e(n,"addInitializer"),o(l,"An initializer"),c.push(l)}}function t(c,n,u,l,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=f(l,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(c,n,u,l,r,b,v,E,w){var p=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof p=="function")h=t(p,l,s,E,r,b,v,w,i),h!==void 0&&(a(r,h),r===0?d=h:r===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,E,r,b,v,w,i),h!==void 0){a(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var V=d;d=function(I,D){return V.call(I,D)}}c.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,T,p,d,s,h,i,P,u)}}return y(l,r),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function x(c,n,u){if(n.length>0){for(var l=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(l,E),metadata:u})}finally{E.v=!0}w!==void 0&&(a(10,w),r=w)}return[C(r,u),function(){for(var p=0;p<l.length;p++)l[p].call(r)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return l.length||C(n,v),{e:E,get c(){return x(n,l,v)}}}}function Dn(f,t,e,o){return(Dn=Ds())(f,t,e,o)}function Is(f){return f}var In,xn,Cn,Tn,En,qe;In=Z({selector:"potatno-port",template:wn,style:bn}),Cn=$t("dragConnection");new class extends Is{constructor(){super(qe),xn()}static{class f{static{({e:[Tn,En],c:[qe,xn]}=Dn(this,[[Cn,1,"dragConnectionSvg"],[rt,3,"port"]],[In]))}static DRAG_MIME_TYPE="application/x-potatno-port";static mDraggedPortInformation;mComponent;mDragPositionEventHandler;mManager;mPort;mUnsubscribe;get dragPositionEventHandler(){return this.mDragPositionEventHandler}#t=(En(this),Tn(this));get dragConnectionSvg(){return this.#t}set dragConnectionSvg(e){this.#t=e}get hasError(){return this.port===null?!1:this.mManager.integrity.errorItems.has(this.port)}get inputDefinitions(){if(!this.port)return new Array;let e=this.port.project.types.getType(this.port.resolvedDataType);return e.inputs.map((o,a)=>({htmlType:(()=>{switch(o.type){case"boolean":return"checkbox";case"number":return"number";case"string":return"text"}})(),index:a,name:o.name,value:this.port.directValue[a]??"",totalCount:e.inputs.length}))}get port(){return this.mPort}set port(e){if(this.mPort!==e){if(e===null)throw new N("A null port cant be assigned.",this);this.mPort=e,this.mComponent.updater.updateAsync()}}get portColor(){return!this.port||this.port.portType==="flow"?"var(--potatno-color-text)":this.mManager.generateStringColor(this.port.resolvedDataType)}get portDirection(){return this.port?.direction??"output"}get portHandleClasses(){if(!this.port)return"";let e=[this.port.portType];return this.port.connectedPorts.size>0&&e.push("connected"),this.hasError&&e.push("error"),e.join(" ")}get portName(){return this.port?.label??""}get portType(){return!this.port||this.port.portType!=="value"?"":this.port.resolvedDataType??""}get showValueInput(){return!this.port||this.port.portType!=="value"||this.port.direction!=="input"||this.port.connectedPorts.size>0||f.mDraggedPortInformation&&f.mDraggedPortInformation.port===this.port?!1:!this.port.node.project.types.isGenericType(this.port.dataType??"")}constructor(e=R.use($),o=R.use(X)){this.mComponent=e,this.mManager=o,this.mPort=null,this.mDragPositionEventHandler=a=>{f.mDraggedPortInformation&&f.mDraggedPortInformation.port===this.port&&(performance.now()-a.timeStamp>100||this.renderDragWire(a.clientX,a.clientY))},this.mUnsubscribe=this.mManager.subscribe(O.Connection,()=>{this.mComponent.updater.updateAsync()})}onConnect(){document.addEventListener("dragover",this.mDragPositionEventHandler,{capture:!0})}onDeconstruct(){this.mUnsubscribe(),document.removeEventListener("dragover",this.mDragPositionEventHandler,{capture:!0})}onDirectValueInput(e,o){if(!this.port)return;let a=e.target,m=[...this.port.directValue];m[o]=a.type==="checkbox"?a.checked?"true":"false":a.value,this.mManager.graph.setPortDirectValue(this.port,m)}onDragEnd(e){e.stopPropagation(),e.preventDefault(),this.dragConnectionSvg.innerHTML="",this.mComponent.updater.updateAsync()}onDragOver(e){this.draggedPortCanConnect(e.dataTransfer)&&(e.preventDefault(),e.stopPropagation(),e.dataTransfer&&(e.dataTransfer.dropEffect="link"))}onDragStart(e){if(!this.port||!e.dataTransfer){e.preventDefault();return}e.stopPropagation(),e.dataTransfer.effectAllowed="link",e.dataTransfer.setData(f.DRAG_MIME_TYPE,this.port.definitionId),e.dataTransfer.setDragImage(document.createElement("div"),0,0);let o=this.mManager.connections.getPortGridPoint(this.port);this.port.direction==="input"&&(o.x-=1),f.mDraggedPortInformation={port:this.port,portPosition:{x:o.x+1,y:o.y},lastPointerGridPosition:{x:0,y:0}},this.mComponent.updater.updateAsync()}onDrop(e){if(!this.draggedPortCanConnect(e.dataTransfer)||(e.preventDefault(),e.stopPropagation(),!f.mDraggedPortInformation)||!this.port)return;let o=f.mDraggedPortInformation.port;this.mManager.graph.connectPorts(o,this.port)}createDragPath(e,o){if(!this.port)return"";let a=this.mManager.connections.pixelToGridSpace(e,o);return this.mManager.connections.createTemporaryPath(this.port,a)}draggedPortCanConnect(e){if(!this.port||!f.mDraggedPortInformation||!e||!e.types.includes(f.DRAG_MIME_TYPE))return!1;let o=f.mDraggedPortInformation.port;return o!==this.port&&o.direction!==this.port.direction&&o.portType===this.port.portType}renderDragWire(e,o){if(!f.mDraggedPortInformation)return;let a=this.dragConnectionSvg.firstChild;a||(a=document.createElementNS("http://www.w3.org/2000/svg","path"),this.dragConnectionSvg.appendChild(a));let m=this.mManager.connections.pixelToGridSpace(e,o);if(m.x===f.mDraggedPortInformation.lastPointerGridPosition.x&&m.y===f.mDraggedPortInformation.lastPointerGridPosition.y)return;f.mDraggedPortInformation.lastPointerGridPosition.x=m.x,f.mDraggedPortInformation.lastPointerGridPosition.y=m.y;let g=f.mDraggedPortInformation.portPosition,y=g.x*this.mManager.grid.gridSize,x=g.y*this.mManager.grid.gridSize;this.dragConnectionSvg.style.setProperty("transform",`translate(${-y}px, ${-x}px)`),a.setAttribute("d",this.createDragPath(e,o))}}}};var Pn=`:host {\r
    display: block;\r
    font-family: var(--potatno-font-family);\r
    font-size: var(--potatno-font-size);\r
\r
...
`;function Ns(){function f(c,n){return function(l){e(n,"addInitializer"),o(l,"An initializer"),c.push(l)}}function t(c,n,u,l,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=f(l,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(c,n,u,l,r,b,v,E,w){var p=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof p=="function")h=t(p,l,s,E,r,b,v,w,i),h!==void 0&&(a(r,h),r===0?d=h:r===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,E,r,b,v,w,i),h!==void 0){a(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var V=d;d=function(I,D){return V.call(I,D)}}c.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,T,p,d,s,h,i,P,u)}}return y(l,r),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function x(c,n,u){if(n.length>0){for(var l=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(l,E),metadata:u})}finally{E.v=!0}w!==void 0&&(a(10,w),r=w)}return[C(r,u),function(){for(var p=0;p<l.length;p++)l[p].call(r)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return l.length||C(n,v),{e:E,get c(){return x(n,l,v)}}}}function Jn(f,t,e,o){return(Jn=Ns())(f,t,e,o)}function Ls(f){return f}var Kn,Yn,Qn,kn,Wn,Zn,qn,Je;Kn=Z({selector:"potatno-node-graph",template:Xn,style:Hn,components:[oe,br,vr]}),Qn=G.state({complexValue:!0}),kn=G.state();new class extends Ls{constructor(){super(Je),Yn()}static{class f{static{({e:[Wn,Zn,qn],c:[Je,Yn]}=Jn(this,[[Qn,1,"selectBox"],[kn,1,"popupPosition"]],[Kn]))}static ZOOM_STRENGTH=.1;mComponent;mManager;mSelectedNodes;mKeyboardHandler;mIsMouseInsideGrid;mUnsubscribeFunctionChange;mUnsubscribeGraphChange;#t=(qn(this),Wn(this));get selectBox(){return this.#t}set selectBox(e){this.#t=e}#e=Zn(this);get popupPosition(){return this.#e}set popupPosition(e){this.#e=e}get gridBackgroundStyle(){let e=this.mManager.grid.gridSize*this.mManager.grid.zoom,o=this.mManager.grid.panX%e,a=this.mManager.grid.panY%e;return`background-size: ${e}px ${e}px; background-position: ${o}px ${a}px;`}get gridTransformStyle(){return`transform: translate(${this.mManager.grid.panX}px, ${this.mManager.grid.panY}px) scale(${this.mManager.grid.zoom})`}get nodes(){return this.mManager.activeFunction?this.mManager.activeFunction.nodes:new Set}get selectedNode(){return this.mSelectedNodes}constructor(e=R.use($),o=R.use(X)){this.mComponent=e,this.mManager=o,this.mSelectedNodes=new Set,this.mIsMouseInsideGrid=!1,this.popupPosition=null,this.selectBox=null,e.element.addEventListener("pointerdown",a=>{this.onCanvasPointerDown(a)}),e.element.addEventListener("wheel",a=>{this.onCanvasWheel(a)}),e.element.addEventListener("contextmenu",a=>{a.preventDefault()}),e.element.addEventListener("pointerenter",()=>{this.mIsMouseInsideGrid=!0}),e.element.addEventListener("pointerleave",()=>{this.mIsMouseInsideGrid=!1}),this.mKeyboardHandler=a=>{this.onKeyDown(a)},document.addEventListener("keydown",this.mKeyboardHandler),this.mUnsubscribeFunctionChange=this.mManager.subscribe(O.Document|O.Function|O.SpecialActiveFunction,()=>{this.popupPosition=null,this.selectBox=null,this.clearSelection()}),this.mUnsubscribeGraphChange=this.mManager.subscribe(O.NodeAdd|O.NodeDelete|O.SpecialGrid,()=>{this.mComponent.updater.updateAsync()})}onConnect(){this.mManager.connections.gridElement=this.mComponent.element}onDeconstruct(){this.mUnsubscribeFunctionChange(),this.mUnsubscribeGraphChange(),document.removeEventListener("keydown",this.mKeyboardHandler)}onCanvasPointerDown(e){switch(this.popupPosition=null,e.button){case 0:{e.ctrlKey||this.clearSelection(),this.pointerDrag(e,"selecting");return}case 1:{e.preventDefault(),this.pointerDrag(e,"panning");return}case 2:{this.openAddNodePopupAtPointer(e.clientX,e.clientY);return}}}onCanvasWheel(e){e.preventDefault();let o=e.deltaY>0?-1:1,a=this.convertGlobalToGridPosition(e.clientX,e.clientY);this.mManager.grid.zoomAt(a.x,a.y,o*f.ZOOM_STRENGTH)}createNodeOnPopupPosition(e){if(!this.mManager.activeFunction)return;let o=this.mManager.graph.addNode(this.mManager.activeFunction,e,{x:this.popupPosition?.grid.x??0,y:this.popupPosition?.grid.y??0,height:0,width:0});this.popupPosition=null,this.clearSelection(),this.mSelectedNodes.add(o)}pointerDrag(e,o){let a=this.convertGlobalToGridPosition(e.clientX,e.clientY),m=a,g=x=>{let C=this.convertGlobalToGridPosition(x.clientX,x.clientY);switch(o){case"panning":{this.mManager.grid.pan(C.x-m.x,C.y-m.y);break}case"selecting":{this.selectBox={x:Math.min(a.x,C.x),y:Math.min(a.y,C.y),width:Math.abs(C.x-a.x),height:Math.abs(C.y-a.y)};break}}m=C},y=()=>{document.removeEventListener("pointermove",g),document.removeEventListener("pointerup",y),o==="selecting"&&this.selectBox&&(this.selectNodesInBox(this.selectBox),this.selectBox=null)};document.addEventListener("pointermove",g),document.addEventListener("pointerup",y)}onKeyDown(e){if(!this.mIsMouseInsideGrid)return;let o=document.activeElement;if(!(o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement||o instanceof HTMLSelectElement)){switch(e.key){case"Escape":{this.popupPosition=null;return}case"Delete":{for(let a of this.mSelectedNodes)this.mManager.graph.removeNode(a);this.clearSelection();return}}if(e.ctrlKey)switch(e.key){case"z":{e.preventDefault(),this.mManager.history.undo();return}case"y":{e.preventDefault(),this.mManager.history.redo();return}case"c":{this.mManager.clipboard.copy(this.mSelectedNodes);return}case"v":e.preventDefault(),this.pasteFromClipboard()}}}convertGlobalToGridPosition(e,o){let a=this.mComponent.element.getBoundingClientRect();return{x:e-a.left,y:o-a.top}}moveAllSelected(e,o){for(let a of this.mSelectedNodes)a!==e&&this.mManager.graph.transformNode(a,m=>{m.moveTo(m.transformation.x+o.x,m.transformation.y+o.y)})}selectNode(e,o){e.stopPropagation(),this.popupPosition=null,e.ctrlKey?this.mSelectedNodes.has(o)?this.mSelectedNodes.delete(o):this.mSelectedNodes.add(o):this.mSelectedNodes.has(o)||(this.clearSelection(),this.mSelectedNodes.add(o)),this.mComponent.updater.updateAsync()}openAddNodePopupAtPointer(e,o){let a=this.mComponent.element,m=this.convertGlobalToGridPosition(e,o),g=this.convertLocalToGridCoordinate(m.x,m.y),y=8,x=Math.max(0,a.clientWidth-oe.POPUP_WIDTH-y),C=Math.max(0,a.clientHeight-oe.POPUP_HEIGHT-y);this.popupPosition={local:{x:Math.max(y,Math.min(m.x,x)),y:Math.max(y,Math.min(m.y,C))},grid:{x:Math.round(g.x/this.mManager.grid.gridSize),y:Math.round(g.y/this.mManager.grid.gridSize)}}}convertLocalToGridCoordinate(e,o){return{x:(e-this.mManager.grid.panX)/this.mManager.grid.zoom,y:(o-this.mManager.grid.panY)/this.mManager.grid.zoom}}clearSelection(){this.mSelectedNodes.clear(),this.mComponent.updater.updateAsync()}pasteFromClipboard(){if(!this.mManager.activeFunction)return;let o=this.mManager.clipboard.paste();if(o.length!==0){this.clearSelection();for(let a of o)this.mSelectedNodes.add(a)}}selectNodesInBox(e){let o=this.mManager.activeFunction;if(!o)return;let a=this.convertLocalToGridCoordinate(e.x,e.y),m=this.convertLocalToGridCoordinate(e.x+e.width,e.y+e.height),g=this.mManager.grid.gridSize;for(let y of o.nodes){let x=y.transformation.x*g,C=y.transformation.y*g,c=x+y.transformation.width*g,n=C+y.transformation.height*g;x<m.x&&c>a.x&&C<m.y&&n>a.y&&this.mSelectedNodes.add(y)}}}}};var ne=class{mCodeGenerator;mId;mLabel;mNodesProvider;mStatics;get codeGenerator(){return this.mCodeGenerator}get id(){return this.mId}get label(){return this.mLabel}get statics(){return this.mStatics}constructor(t){this.mId=t.id,this.mLabel=t.label,this.mNodesProvider=t.nodes,this.mStatics=t.statics,this.mCodeGenerator=t.generator.code}getNodeDefinitions(t){let e=a=>{if(!a)return new Array;let m=new Array;return a(g=>{m.push(g)},t),m},o={};return Object.defineProperty(o,"entry",{get:()=>e(this.mNodesProvider.entry)}),Object.defineProperty(o,"exit",{get:()=>e(this.mNodesProvider.exit)}),Object.defineProperty(o,"dynamic",{get:()=>e(this.mNodesProvider.dynamic)}),o}},St={none:0,imports:1,inputs:2,outputs:4};var ti=`:host {\r
    display: flex;\r
    flex-direction: column;\r
    height: 100%;\r
    overflow: hidden;\r
...
`;function Os(){function f(c,n){return function(l){e(n,"addInitializer"),o(l,"An initializer"),c.push(l)}}function t(c,n,u,l,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=f(l,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function a(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var l;throw c===0?l="field":c===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(c,n,u,l,r,b,v,E,w){var p=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,T,P;if(typeof p=="function")h=t(p,l,s,E,r,b,v,w,i),h!==void 0&&(a(r,h),r===0?d=h:r===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,E,r,b,v,w,i),h!==void 0){a(r,h);var A;r===0?A=h:r===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var V=d;d=function(I,D){return V.call(I,D)}}c.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):r===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,l,s))}function g(c,n,u){for(var l=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,T,p,d,s,h,i,P,u)}}return y(l,r),y(l,b),l}function y(c,n){n&&c.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function x(c,n,u){if(n.length>0){for(var l=[],r=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(l,E),metadata:u})}finally{E.v=!0}w!==void 0&&(a(10,w),r=w)}return[C(r,u),function(){for(var p=0;p<l.length;p++)l[p].call(r)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return l.length||C(n,v),{e:E,get c(){return x(n,l,v)}}}}function si(f,t,e,o){return(si=Os())(f,t,e,o)}var ai,ri,li,oi,ni,wr;ai=Z({selector:"potatno-function-properties",template:ei,style:ti}),li=G.state({complexValue:!0});var ii=class{static{({e:[oi,ni],c:[wr,ri]}=si(this,[[li,1,"functionProperties"]],[ai]))}constructor(t=R.use(X)){this.mManager=t,this.mSelectedImportId="",this.mProjectTypes=new Set,this.functionProperties=this.convertFunctionProperties(),this.mUnsubscribe=this.mManager.subscribe(O.Document|O.Function|O.SpecialActiveFunction,()=>{this.mProjectTypes.clear();for(let[e]of this.mManager.project.types.types)this.mProjectTypes.add(e);this.functionProperties=this.convertFunctionProperties()})}mManager;mProjectTypes;mSelectedImportId;mUnsubscribe;#t=(ni(this),oi(this));get functionProperties(){return this.#t}set functionProperties(t){this.#t=t}get projectTypes(){return this.mProjectTypes}get selectedImportId(){return this.mSelectedImportId}set selectedImportId(t){this.mSelectedImportId=t}get unusedImports(){return this.mManager.activeFunction?this.mManager.activeFunction.project.imports.filter(t=>!this.functionProperties.imports.find(e=>t.id===e.id)):new Array}addPort(t){let e=this.projectTypes.values().next().value;if(!e)return;let o=t===this.functionProperties.inputs?"Input":"Output";t.push({label:o,dataType:e,hasError:!1}),this.submitChange()}addSelectedImport(){let t=this.unusedImports;if(t.length===0)return;let e=t.find(o=>o.id===this.mSelectedImportId);e||(e=t.at(0)),this.functionProperties.imports.push(e),this.submitChange()}deleteImport(t){let e=this.functionProperties.imports.indexOf(t);e!==-1&&(this.functionProperties.imports.splice(e,1),this.submitChange())}deletePort(t,e){let o=e.indexOf(t);o!==-1&&(e.splice(o,1),this.submitChange())}onDeconstruct(){this.mUnsubscribe()}async submitChange(){let t=!1,e=new Set;for(let g of this.functionProperties.inputs)g.hasError=e.has(g.label),t||=g.hasError,e.add(g.label);let o=new Set;for(let g of this.functionProperties.outputs)g.hasError=o.has(g.label),t||=g.hasError,o.add(g.label);if(t){this.functionProperties=this.functionProperties;return}let a=this.mManager.activeFunction,m=this.functionProperties;await new Promise(g=>{globalThis.setTimeout(g,10)}),this.mManager.graph.updateFunction(a,g=>{if(g.label=m.label,!m.statics.inputs){for(;g.inputs.length>0;)g.removeInput(g.inputs.at(0));for(let y of m.inputs)g.addInput({dataType:y.dataType,label:y.label})}if(!m.statics.outputs){for(;g.outputs.length>0;)g.removeOutput(g.outputs.at(0));for(let y of m.outputs)g.addOutput({dataType:y.dataType,label:y.label})}if(!m.statics.imports){for(let y of g.imports)g.removeImport(y);for(let y of m.imports)g.addImport(y.id)}})}convertFunctionProperties(){let t={label:"",inputs:new Array,outputs:new Array,imports:new Array,statics:{label:!0,imports:!0,inputs:!0,outputs:!0}},e=this.mManager.activeFunction;if(!e)return t;let o=e.project.getFunction(e.definitionId);o&&(t.statics.label=e.isSystem,t.statics.imports=(o.statics&St.imports)!==0,t.statics.inputs=(o.statics&St.inputs)!==0,t.statics.outputs=(o.statics&St.outputs)!==0),t.label=e.label;for(let a of e.project.imports)e.imports.has(a.id)&&t.imports.push({id:a.id,label:a.label});for(let a of e.inputs)t.inputs.push({label:a.label,dataType:a.dataType,hasError:!1});for(let a of e.outputs)t.outputs.push({label:a.label,dataType:a.dataType,hasError:!1});return t}static{ri()}};var Ke=class{mDependencies;mDocument;mEntryPoint;get code(){return this.mDocument.project.generator.code(this)}get dependencies(){return this.mDependencies}get entryPoint(){return this.mEntryPoint}constructor(t,e,o){this.mDocument=t,this.mEntryPoint=e,this.mDependencies=o}};var Qe=class{mFunction;mGraphs;get code(){let t=this.mFunction.project.getFunction(this.mFunction.definitionId);if(!t)throw new N("Function result has an invalid function definition id.",this);return t.codeGenerator.body(this)}get function(){return this.mFunction}get graphs(){return Array.from(this.mGraphs.values())}constructor(t){this.mFunction=t,this.mGraphs=new Map}addGraph(t){this.mGraphs.set(t.entryNode.definitionId,t)}graphResultOf(t){return this.mGraphs.get(t)}};var ke=class{mBodyCode;mDependencies;mEntryNode;mExitNode;mNodeIds;mPorts;get code(){return this.mBodyCode}get dependencies(){return this.mDependencies}get entryNode(){return this.mEntryNode}get exitNode(){return this.mExitNode}get nodes(){return this.mNodeIds}get ports(){return this.mPorts}constructor(t){this.mBodyCode=t.bodyCode,this.mDependencies=[...t.dependencies],this.mEntryNode=t.entryNode,this.mExitNode=t.exitNode,this.mNodeIds=t.nodeIds,this.mPorts=t.portValues}};var ie=class{mProject;constructor(t){this.mProject=t}generateDocument(t,e=!1){let o=[...t.functions].find(a=>a.isSystem);if(!o)throw new N("No entry point function found for code generation.",this);return this.generateFunction(o,e)}generateFunction(t,e=!1){return this.buildDocumentResult(t.document,t.getExitNodes(),e)}generateNode(t,e=!1){return this.buildDocumentResult(t.document,[t],e)}buildDocumentResult(t,e,o){if(t.validate().errors.length>0)throw new N("Code generation exited. Code graph validation failed.",this);let m={counter:{nodeIndex:0,portIndex:0},debug:o,nodeDefinitions:new Map},g=this.generateFunctionWithDependencies(m,e,new Set),y=g.pop();return new Ke(t,y,g)}countNodeEncounter(t,e){let o=new Map,a=new Set,m=new Array(t);for(;m.length>0;){let g=m.pop();if(o.set(g,(o.get(g)??0)+1),!(g===e||a.has(g))){a.add(g);for(let y of g.inputs.flow)for(let x of this.resolveFlowConjunctions(y))m.push(x.node);for(let y of g.inputs.value){let x=this.resolveValueConjunctions(y);x&&m.push(x.node)}}}return o}createScope(t,e){return{emittedNodes:new Set,remaining:this.countNodeEncounter(t,e)}}emitNode(t,e,o,a,m){if(!t.nodeDefinitions.get(o.function)){let l=new Map;for(let r of o.function.nodeDefinitions)l.set(r.id,r);t.nodeDefinitions.set(o.function,l)}let g=t.nodeDefinitions.get(o.function).get(o.definitionId);if(!g)throw new N(`Node definition "${o.definitionId}" not found for node "${o.label}".`,this);g instanceof xt&&e.dependencies.push(g.function);let y={},x=new Array;for(let l of o.inputs.value){let r=this.resolveInputValue(t,e,l);y[l.definitionId]=r.inputPort,e.ports.set(l,r.inputPort.value),r.emitResult&&x.push(r.emitResult)}let C={};for(let l of o.outputs.list)C[l.definitionId]={value:this.generatePortValue(t,e,l),code:{inner:a[l.definitionId]??""}};let c=g.codeGenerator({inputs:y,outputs:C,code:{next:m??""}}),n=this.getGeneratedNodeId(t,e,o);t.debug&&(c=this.mProject.generator.value.hook(`start-${n}`)+c+this.mProject.generator.value.hook(`end-${n}`));let u=new Array;for(let l of x)u.push(...l.codeOutput);return u.push(c),{codeOutput:u,lastGeneratedNode:o,endFlowPort:null}}findBranchStartPoint(t){let e=this.getNodesInputFlowPorts(t),o=e.length,a=new Map,m=new Array,g=(y,x)=>{let C=(a.has(y)||a.set(y,new Set),a.get(y)),c=C.size;for(let n of x)C.add(n);return C.size>c&&m.push(y),C};for(let[y,x]of e.entries())g(x.node,[y]);for(;m.length>0;){let y=m.shift(),x=a.get(y);for(let C of this.getNodesInputFlowPorts(y))if(g(C.node,x).size===o)return C.node}throw new N("No common branch point found for merge node.",this)}generateFunctionWithDependencies(t,e,o){let a=new Array;if(e.length===0)return a;let m=e.at(0).function;o.add(m);let g=new Qe(m);a.push(g);for(let y of e){let x=this.generateNodeCode(t,y);g.addGraph(x);for(let C of x.dependencies)o.has(C)||a.push(...this.generateFunctionWithDependencies(t,C.getExitNodes(),o))}return a.reverse()}generateNodeCode(t,e){let o={dependencies:new Array,nodes:new Map,ports:new Map,scope:this.createScope(e,null)},a=this.walkBackward(t,o,e,null),m=a.codeOutput.join(" ");return new ke({bodyCode:m,dependencies:o.dependencies,entryNode:a.lastGeneratedNode,exitNode:e,nodeIds:new Map(o.nodes),portValues:new Map(o.ports)})}generatePortValue(t,e,o){if(!e.ports.has(o)){let a=this.mProject.generator.value.name(o.label),m=this.mProject.generator.value.id(a,t.counter.portIndex++);e.ports.set(o,m)}return e.ports.get(o)}getGeneratedNodeId(t,e,o){if(!e.nodes.has(o)){let m=(++t.counter.nodeIndex).toString(16).toUpperCase().padStart(8,"0");e.nodes.set(o,m)}return e.nodes.get(o)}getNodesInputFlowPorts(t){let e=new Array;for(let o of t.inputs.flow)e.push(...this.resolveFlowConjunctions(o));return[...new Set(e)]}handleFlowMerge(t,e,o,a,m){let g=m.join(" "),y=this.findBranchStartPoint(o),x={},C=e.scope;try{for(let c of a){e.scope=this.createScope(c.node,y);let n=this.walkBackward(t,e,c.node,y);x[n.endFlowPort.definitionId]=n.codeOutput.join(" ")}}finally{e.scope=C}return this.emitNode(t,e,y,x,g)}resolveFlowConjunctions(t){let e=new Array;for(let o of t.connectedPorts){if(o.node.definitionId!==Nt.DEFINITION_ID){e.push(o);continue}let a=o.node.inputs.flow[0];!a||a.connectedPorts.size===0||e.push(...this.resolveFlowConjunctions(a))}return e}resolveInputValue(t,e,o){let a=this.resolveValueConjunctions(o);if(!a){if(this.mProject.types.isGenericType(o.dataType))throw new N("Generic value inputs must be allways connected",this);return{inputPort:{value:this.mProject.types.getType(o.dataType).convert([...o.directValue]),isDirectValue:!0},emitResult:null}}let m=a.node,g=!m.hasFlowPorts,y=(()=>{if(!m.hasFlowPorts){if(e.scope.emittedNodes.has(m))return null;let x=e.scope.remaining.get(m);if(g&&(x=0),e.scope.remaining.set(m,x),x<=0)return e.scope.emittedNodes.add(m),this.emitNode(t,e,m,{})}return null})();return{inputPort:{value:this.generatePortValue(t,e,a),isDirectValue:!1},emitResult:y}}resolveValueConjunctions(t){if(t.connectedPorts.size===0)return null;let e=t.connectedPorts.values().next().value;if(e.node.definitionId!==Lt.DEFINITION_ID)return e;let o=e.node.inputs.value[0];return!o||o.connectedPorts.size===0?null:this.resolveValueConjunctions(o)}walkBackward(t,e,o,a){let m={codeOutput:new Array,lastGeneratedNode:null,endFlowPort:null},g=null,y=o;for(;y!==null&&y!==a;){let x={};g!==null&&(x[g.definitionId]=m.codeOutput.join(" "),m.codeOutput=new Array);let C=m.codeOutput;m=this.emitNode(t,e,y,x),m.codeOutput=[...m.codeOutput,...C];let c=this.getNodesInputFlowPorts(y);if(c.length===0)break;c.length>1&&(m=this.handleFlowMerge(t,e,y,c,m.codeOutput),c=this.getNodesInputFlowPorts(m.lastGeneratedNode)),g=c[0]??null,y=g?.node??null}if(!m.lastGeneratedNode)throw new N(`Walk did not reach an entry node from exit "${o.label}".`,this);if(a&&y!==a)throw new N("Malformed graph. End node not reached",this);return m.endFlowPort=g,m}};var st=class{static MAIN="MAIN";mBuild;mDefaultParameters;mFunction;mTypes;get defaultParameters(){return this.mDefaultParameters}get function(){return this.mFunction}get types(){return this.mTypes}constructor(t,e){this.mFunction=t,this.mDefaultParameters=e.defaultParameters,this.mTypes=new Set(e.types),this.mBuild=e.build}compile(t,e){return this.mBuild({defaultParameters:this.mDefaultParameters,function:this.mFunction,projectTypes:t.entryPoint.function.project.types},t,e)}};var ci=`:host {\r
