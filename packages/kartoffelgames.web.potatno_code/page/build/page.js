...
`;function gs(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=f(a,d);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,v,E,w){var p=u[0],s,d,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof p=="function")h=t(p,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?d=h:r===1?(d=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var S=p.length-1;S>=0;S--){var M=p[S];if(h=t(M,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var N;r===0?N=h:r===1?(N=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,N!==void 0&&(d===void 0?d=N:typeof d=="function"?d=[d,N]:d.push(N))}}if(r===0||r===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,R=0;R<F.length;R++)L=F[R].call(I,L);return L}}else{var V=d;d=function(I,D){return V.call(I,D)}}l.push(d)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var S=h?E:v,M=S.get(d)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!M&&s>2?S.set(d,s):S.set(d,!0)}m(a,x,p,d,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[P(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function P(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||P(n,v),{e:E,get c(){return T(n,a,v)}}}}function $o(f,t,e,o){return($o=gs())(f,t,e,o)}var Go,_o,Bo,Uo,Ho,Oo,Fo,jo,Vo,Ht;Go=W({selector:"potatno-resize-box",template:Ro,style:Lo}),Bo=$.state({proxy:!0}),Uo=Ut("resize"),Ho=Ut("resize-end");var zo=class{static{({e:[Oo,Fo,jo,Vo],c:[Ht,_o]}=$o(this,[[Bo,1,"mEnabledDirections"],[Uo,1,"mResize"],[Ho,1,"mResizeEnd"],[rt,3,"bottom"],[rt,3,"left"],[rt,3,"right"],[rt,3,"snap"],[rt,3,"top"]],[Go]))}constructor(t=_.use(G)){this.mComponentElement=t.element,this.mEnabledDirections={snap:1,enabledDirections:{top:!1,right:!1,bottom:!1,left:!1}}}mComponentElement;#t=(Vo(this),Oo(this));get mEnabledDirections(){return this.#t}set mEnabledDirections(t){this.#t=t}#e=Fo(this);get mResize(){return this.#e}set mResize(t){this.#e=t}#r=jo(this);get mResizeEnd(){return this.#r}set mResizeEnd(t){this.#r=t}get bottom(){return this.mEnabledDirections.enabledDirections.bottom}set bottom(t){this.mEnabledDirections.enabledDirections.bottom=this.parseBoolean(t)}get left(){return this.mEnabledDirections.enabledDirections.left}set left(t){this.mEnabledDirections.enabledDirections.left=this.parseBoolean(t)}get right(){return this.mEnabledDirections.enabledDirections.right}set right(t){this.mEnabledDirections.enabledDirections.right=this.parseBoolean(t)}get snap(){return this.mEnabledDirections.snap}set snap(t){this.mEnabledDirections.snap=parseInt(t.toString())}get top(){return this.mEnabledDirections.enabledDirections.top}set top(t){this.mEnabledDirections.enabledDirections.top=this.parseBoolean(t)}resizeCorner(t){this.handleResize(t,"both")}resizeHorizontal(t){this.handleResize(t,"horizontal")}resizeVertical(t){this.handleResize(t,"vertical")}handleResize(t,e){t.preventDefault(),t.stopPropagation();let o=this.mComponentElement.getBoundingClientRect(),c=o.width,m=o.height,g=t.clientX,y=t.clientY,T=1;Math.abs(g-o.left)<Math.abs(g-o.right)&&(T=-1);let P=1;Math.abs(y-o.top)<Math.abs(y-o.bottom)&&(P=-1);let l=c,n=m,u=r=>{let b=(r.clientX-g)*T,v=(r.clientY-y)*P,E=c+b,w=m+v;e==="horizontal"&&(E=c),e==="vertical"&&(w=m),[l,n]=this.updateComponentSize(E,w,l,n)},a=()=>{document.removeEventListener("pointermove",u),document.removeEventListener("pointerup",a),(l!==c||n!==m)&&this.mResizeEnd.dispatchEvent(new Xe(l,n))};document.addEventListener("pointermove",u),document.addEventListener("pointerup",a)}parseBoolean(t){return!!(()=>{if(typeof t=="string"){let o=t.toLowerCase();if(["true","false"].includes(o))return o==="true"}return t})()}updateComponentSize(t,e,o,c){let m=o,g=c;return(this.mEnabledDirections.enabledDirections.left||this.mEnabledDirections.enabledDirections.right)&&(m=Math.floor(Math.abs(t)/this.mEnabledDirections.snap)*this.mEnabledDirections.snap*(t/Math.abs(t)),this.mComponentElement.style.setProperty("width",`${m}px`)),(this.mEnabledDirections.enabledDirections.top||this.mEnabledDirections.enabledDirections.bottom)&&(g=Math.floor(Math.abs(e)/this.mEnabledDirections.snap)*this.mEnabledDirections.snap*(e/Math.abs(e)),this.mComponentElement.style.setProperty("height",`${g}px`)),(m!==o||g!==c)&&this.mResize.dispatchEvent(new Xe(m,g)),[m,g]}static{_o()}},Xe=class{mWidth;mHeight;get width(){return this.mWidth}get height(){return this.mHeight}constructor(t,e){this.mWidth=t,this.mHeight=e}};var Xo=`:host {\r
    position: absolute;\r
    z-index: 200;\r
}\r
\r
...
`;var An=`<!-- Resizeable part of node -->
<potatno-resize-box class="node {{this.hasErrorClass}}" top="true" right="true" bottom="true" left="true" [snap]="25" (resize-end)="this.resizeNode($event.value)">
...
\r
    $for(nodeState of this.visibleNodes) {\r
        <potatno-node class="grid-content__node {{this.nodeState.selected ? 'selected' : ''}}" style="left:{{this.nodeState.pixelX}}px; top:{{this.nodeState.pixelY}}px; width:{{this.nodeState.pixelW}}px; height:{{this.nodeState.pixelH}}px;" [nodeData]="this.nodeState.node" (pointerdown)="this.onNodePointerDown($event, this.nodeState.node)"/>\r
    }\r
</div>\r
\r
...
}`;var oi=`<potatno-resize-box class="resize-box" left="true">\r
\r
    <!-- Function name -->\r
    <div class="section">\r
