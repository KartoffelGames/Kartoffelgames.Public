...
import forwardEntryPoints from '../../source/shader/forward-entry-points.pgsl' with { type: 'text' };
import forwardImport from '../../source/shader/forward-import.pgsl' with { type: 'text' };
import forwardObjectGroup from '../../source/shader/object-group-forward.pgsl' with { type: 'text' };
import sharedTypes from '../../source/shader/shared-types.pgsl' with { type: 'text' };
import forwardWorldGroup from '../../source/shader/world-group-forward.pgsl' with { type: 'text' };
