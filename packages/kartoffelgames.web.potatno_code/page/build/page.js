...
.port {\r
    position: relative;\r
    display: flex;\r
    width: var(--potatno-port-width);\r
    z-index: 99;\r
    align-items: center;\r
    justify-content: center;\r
\r
...
\r
        .output & {\r
            transform: translateX(calc(var(--potatno-port-width) / 2));\r
        }\r
\r
        .input & {\r
            transform: translateX(calc(var(--potatno-port-width) / -2));\r
