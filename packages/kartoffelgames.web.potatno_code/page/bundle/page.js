...
potatno-code-editor {\r
    ...
    width: 100%;\r
    height: 100%;\r
}`;var ne=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new Vt(this.mProject),i=[];for(let h of t.functions){let d=this.deserializeFunctionHead(h,e);i.push([d,h]),e.addFunction(d)}for(let[h,d]of i)this.deserializeFunctionBody(h,d,e);return e}deserializeFunctionBody(t,e,i){let h=new Map;for(let d of e.nodes)h.set(d.id,this.deserializeNode(d,t,i));for(let d of e.connections){if(!h.has(d.sourceNodeId)||!h.has(d.targetNodeId))continue;let v=h.get(d.sourceNodeId),w=h.get(d.targetNodeId),D=v.outputs.map.get(d.sourcePortId),S=w.inputs.map.get(d.targetPortId);!D||!S||D.connect(S)}}deserializeFunctionHead(t,e){let i=new lt(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let h of t.imports)i.addImport(h);for(let h of t.inputs)i.addInput({label:h.label,dataType:h.dataType});for(let h of t.outputs)i.addOutput({label:h.label,dataType:h.dataType});return i}deserializeNode(t,e,i){let h=i.nodeDefinitions.find(v=>v.id===t.definitionId),d=(()=>{if(h)return e.addNodeByDefinition(h,t.transformation);let v=t.ports.filter(D=>D.direction==="input").map(D=>({dataType:D.dataType,definitionId:D.definitionId,label:D.label,portType:D.portType})),w=t.ports.filter(D=>D.direction==="output").map(D=>({dataType:D.dataType,definitionId:D.definitionId,label:D.label,portType:D.portType}));return new pt(this.mProject,i,e,{definitionId:t.definitionId,ports:{input:v,output:w},label:t.label,transformation:{...t.transformation}})})();d.label=t.label,e.addNode(d);for(let v of t.ports)if(v.portType==="value"&&v.directValue.length>0){let w=d.inputs.map.get(v.definitionId);w&&w.setDirectValue(v.directValue)}return d.preview=t.preview??null,d}};var ie=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((w,D)=>{e.set(w,`n${D}`)});let i=[...t.nodes].map(w=>this.serializeNode(w,e.get(w))),h=[];for(let w of t.nodes){let D=e.get(w);for(let S of w.outputs.list)for(let l of S.connectedPorts){let r=e.get(l.node);h.push({sourceNodeId:D,sourcePortId:S.definitionId,targetNodeId:r,targetPortId:l.definitionId})}}let d=t.inputs.map(w=>({label:w.label,dataType:w.dataType})),v=t.outputs.map(w=>({label:w.label,dataType:w.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:d,outputs:v,imports:[...t.imports],nodes:i,connections:h}}serializeNode(t,e){let i=[...t.inputs.list,...t.outputs.list].map(d=>({definitionId:d.definitionId,label:d.label,direction:d.direction,portType:d.portType,dataType:d.portType==="value"?d.dataType:null,directValue:[...d.directValue]})),h=t.preview?{portDefinitionId:t.preview.portDefinitionId,displayId:t.preview.displayId}:null;return{id:e,definitionId:t.definitionId,label:t.label,transformation:{...t.transformation},ports:i,preview:h}}};var Nr=`:host {   \r
    /* Font */\r
...
`;function Hl(){function y(l,r){return function(c){e(r,"addInitializer"),i(c,"An initializer"),l.push(c)}}function t(l,r,u,c,o,b,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+r:r,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=y(c,f);var n,a;if(o===0?p?(n=u.get,a=u.set):(n=function(){return this[r]},a=function(g){this[r]=g}):o===2?n=function(){return u.value}:((o===1||o===3)&&(n=function(){return u.get.call(this)}),(o===1||o===4)&&(a=function(g){u.set.call(this,g)})),p)s.access=n&&a?{get:n,set:a}:n?{get:n}:{set:a};else{if(n){var I=n;n=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return r in g};s.access=n&&a?{has:E,get:n,set:a}:n?{has:E,get:n}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,r){if(l.v)throw new Error("attempted to call "+r+" after decoration was finished")}function i(l,r){if(typeof l!="function")throw new TypeError(r+" must be a function")}function h(l,r){var u=typeof r;if(l===1){if(u!=="object"||r===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");r.get!==void 0&&i(r.get,"accessor.get"),r.set!==void 0&&i(r.set,"accessor.set"),r.init!==void 0&&i(r.init,"accessor.init")}else if(u!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,r,u,c,o,b,p,T,x){var m=u[0],s,f,n;p?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(r,c)),o===1?n={get:s.get,set:s.set}:o===2?n=s.value:o===3?n=s.get:o===4&&(n=s.set);var a,I,P;if(typeof m=="function")a=t(m,c,s,T,o,b,p,x,n),a!==void 0&&(h(o,a),o===0?f=a:o===1?(f=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,b,p,x,n),a!==void 0){h(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,C){return C};else if(typeof f!="function"){var F=f;f=function(M,C){for(var N=C,L=0;L<F.length;L++)N=F[L].call(M,N);return N}}else{var j=f;f=function(M,C){return j.call(M,C)}}l.push(f)}o!==0&&(o===1?(s.get=n.get,s.set=n.set):o===2?s.value=n:o===3?s.get=n:o===4&&(s.set=n),p?o===1?(l.push(function(M,C){return n.get.call(M,C)}),l.push(function(M,C){return n.set.call(M,C)})):o===2?l.push(n):l.push(function(M,C){return n.call(M,C)}):Object.defineProperty(r,c,s))}function v(l,r,u){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<r.length;x++){var m=r[x];if(Array.isArray(m)){var s=m[1],f=m[2],n=m.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!n){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,I,m,f,s,a,n,P,u)}}return w(c,o),w(c,b),c}function w(l,r){r&&l.push(function(u){for(var c=0;c<r.length;c++)r[c].call(u);return u})}function D(l,r,u){if(r.length>0){for(var c=[],o=l,b=l.name,p=r.length-1;p>=0;p--){var T={v:!1};try{var x=r[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:u})}finally{T.v=!0}x!==void 0&&(h(10,x),o=x)}return[S(o,u),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,r){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:r})}return function(r,u,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(r,u,p);return c.length||S(r,p),{e:T,get c(){return D(r,c,p)}}}}function $r(y,t,e,i){return($r=Hl())(y,t,e,i)}var Br,Or,Gr,Ur,Hr,Xr,Fr,zr,jr,Mt;Br=U({selector:"kg-button",template:Rr,style:Lr}),Gr=V.state(),Ur=V.state(),Hr=$(),Xr=$();var Vr=class{static{({e:[Fr,zr,jr],c:[Mt,Or]}=$r(this,[[Gr,1,"mSelected"],[Ur,1,"mType"],[Hr,3,"selected"],[Xr,3,"type"]],[Br]))}constructor(){this.mType="primary",this.mSelected=!1}#t=(jr(this),Fr(this));get mSelected(){return this.#t}set mSelected(t){this.#t=t}#e=zr(this);get mType(){return this.#e}set mType(t){this.#e=t}get selected(){return this.mSelected}set selected(t){this.mSelected=this.parseBoolean(t)}get type(){return this.mType}set type(t){if(t!=="primary"&&t!=="secondary"){this.mType="secondary";return}this.mType=t}parseBoolean(t){if(typeof t=="string"){if(t==="")return!0;let e=t.toLowerCase();if(e==="true"||e==="false")return e==="true"}return!!t}static{Or()}};var Yr=`:host {\r
...
`;function Wl(){function y(l,r){return function(c){e(r,"addInitializer"),i(c,"An initializer"),l.push(c)}}function t(l,r,u,c,o,b,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+r:r,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=y(c,f);var n,a;if(o===0?p?(n=u.get,a=u.set):(n=function(){return this[r]},a=function(g){this[r]=g}):o===2?n=function(){return u.value}:((o===1||o===3)&&(n=function(){return u.get.call(this)}),(o===1||o===4)&&(a=function(g){u.set.call(this,g)})),p)s.access=n&&a?{get:n,set:a}:n?{get:n}:{set:a};else{if(n){var I=n;n=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return r in g};s.access=n&&a?{has:E,get:n,set:a}:n?{has:E,get:n}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,r){if(l.v)throw new Error("attempted to call "+r+" after decoration was finished")}function i(l,r){if(typeof l!="function")throw new TypeError(r+" must be a function")}function h(l,r){var u=typeof r;if(l===1){if(u!=="object"||r===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");r.get!==void 0&&i(r.get,"accessor.get"),r.set!==void 0&&i(r.set,"accessor.set"),r.init!==void 0&&i(r.init,"accessor.init")}else if(u!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,r,u,c,o,b,p,T,x){var m=u[0],s,f,n;p?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(r,c)),o===1?n={get:s.get,set:s.set}:o===2?n=s.value:o===3?n=s.get:o===4&&(n=s.set);var a,I,P;if(typeof m=="function")a=t(m,c,s,T,o,b,p,x,n),a!==void 0&&(h(o,a),o===0?f=a:o===1?(f=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,b,p,x,n),a!==void 0){h(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,C){return C};else if(typeof f!="function"){var F=f;f=function(M,C){for(var N=C,L=0;L<F.length;L++)N=F[L].call(M,N);return N}}else{var j=f;f=function(M,C){return j.call(M,C)}}l.push(f)}o!==0&&(o===1?(s.get=n.get,s.set=n.set):o===2?s.value=n:o===3?s.get=n:o===4&&(s.set=n),p?o===1?(l.push(function(M,C){return n.get.call(M,C)}),l.push(function(M,C){return n.set.call(M,C)})):o===2?l.push(n):l.push(function(M,C){return n.call(M,C)}):Object.defineProperty(r,c,s))}function v(l,r,u){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<r.length;x++){var m=r[x];if(Array.isArray(m)){var s=m[1],f=m[2],n=m.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!n){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,I,m,f,s,a,n,P,u)}}return w(c,o),w(c,b),c}function w(l,r){r&&l.push(function(u){for(var c=0;c<r.length;c++)r[c].call(u);return u})}function D(l,r,u){if(r.length>0){for(var c=[],o=l,b=l.name,p=r.length-1;p>=0;p--){var T={v:!1};try{var x=r[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:u})}finally{T.v=!0}x!==void 0&&(h(10,x),o=x)}return[S(o,u),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,r){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:r})}return function(r,u,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(r,u,p);return c.length||S(r,p),{e:T,get c(){return D(r,c,p)}}}}function Jr(y,t,e,i){return(Jr=Wl())(y,t,e,i)}var Kr,Zr,Qr;Kr=U({selector:"kg-information",template:Wr,style:Yr});var qr=class{static{({c:[Qr,Zr]}=Jr(this,[],[Kr]))}static{Zr()}};var kr=`:host {\r
...
}`;var tn="$slot";function Jl(){function y(l,r){return function(c){e(r,"addInitializer"),i(c,"An initializer"),l.push(c)}}function t(l,r,u,c,o,b,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+r:r,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=y(c,f);var n,a;if(o===0?p?(n=u.get,a=u.set):(n=function(){return this[r]},a=function(g){this[r]=g}):o===2?n=function(){return u.value}:((o===1||o===3)&&(n=function(){return u.get.call(this)}),(o===1||o===4)&&(a=function(g){u.set.call(this,g)})),p)s.access=n&&a?{get:n,set:a}:n?{get:n}:{set:a};else{if(n){var I=n;n=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return r in g};s.access=n&&a?{has:E,get:n,set:a}:n?{has:E,get:n}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,r){if(l.v)throw new Error("attempted to call "+r+" after decoration was finished")}function i(l,r){if(typeof l!="function")throw new TypeError(r+" must be a function")}function h(l,r){var u=typeof r;if(l===1){if(u!=="object"||r===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");r.get!==void 0&&i(r.get,"accessor.get"),r.set!==void 0&&i(r.set,"accessor.set"),r.init!==void 0&&i(r.init,"accessor.init")}else if(u!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,r,u,c,o,b,p,T,x){var m=u[0],s,f,n;p?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(r,c)),o===1?n={get:s.get,set:s.set}:o===2?n=s.value:o===3?n=s.get:o===4&&(n=s.set);var a,I,P;if(typeof m=="function")a=t(m,c,s,T,o,b,p,x,n),a!==void 0&&(h(o,a),o===0?f=a:o===1?(f=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,b,p,x,n),a!==void 0){h(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,C){return C};else if(typeof f!="function"){var F=f;f=function(M,C){for(var N=C,L=0;L<F.length;L++)N=F[L].call(M,N);return N}}else{var j=f;f=function(M,C){return j.call(M,C)}}l.push(f)}o!==0&&(o===1?(s.get=n.get,s.set=n.set):o===2?s.value=n:o===3?s.get=n:o===4&&(s.set=n),p?o===1?(l.push(function(M,C){return n.get.call(M,C)}),l.push(function(M,C){return n.set.call(M,C)})):o===2?l.push(n):l.push(function(M,C){return n.call(M,C)}):Object.defineProperty(r,c,s))}function v(l,r,u){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<r.length;x++){var m=r[x];if(Array.isArray(m)){var s=m[1],f=m[2],n=m.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!n){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,I,m,f,s,a,n,P,u)}}return w(c,o),w(c,b),c}function w(l,r){r&&l.push(function(u){for(var c=0;c<r.length;c++)r[c].call(u);return u})}function D(l,r,u){if(r.length>0){for(var c=[],o=l,b=l.name,p=r.length-1;p>=0;p--){var T={v:!1};try{var x=r[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:u})}finally{T.v=!0}x!==void 0&&(h(10,x),o=x)}return[S(o,u),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,r){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:r})}return function(r,u,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(r,u,p);return c.length||S(r,p),{e:T,get c(){return D(r,c,p)}}}}function rn(y,t,e,i){return(rn=Jl())(y,t,e,i)}var nn,en,se;nn=U({selector:"kg-popup",template:tn,style:kr});var on=class{static{({c:[se,en]}=rn(this,[],[nn]))}static{en()}};var sn=`:host {\r
...
<div class="content-container">\r
    $slot\r
</div>`;function kl(){function y(l,r){return function(c){e(r,"addInitializer"),i(c,"An initializer"),l.push(c)}}function t(l,r,u,c,o,b,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+r:r,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=y(c,f);var n,a;if(o===0?p?(n=u.get,a=u.set):(n=function(){return this[r]},a=function(g){this[r]=g}):o===2?n=function(){return u.value}:((o===1||o===3)&&(n=function(){return u.get.call(this)}),(o===1||o===4)&&(a=function(g){u.set.call(this,g)})),p)s.access=n&&a?{get:n,set:a}:n?{get:n}:{set:a};else{if(n){var I=n;n=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return r in g};s.access=n&&a?{has:E,get:n,set:a}:n?{has:E,get:n}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,r){if(l.v)throw new Error("attempted to call "+r+" after decoration was finished")}function i(l,r){if(typeof l!="function")throw new TypeError(r+" must be a function")}function h(l,r){var u=typeof r;if(l===1){if(u!=="object"||r===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");r.get!==void 0&&i(r.get,"accessor.get"),r.set!==void 0&&i(r.set,"accessor.set"),r.init!==void 0&&i(r.init,"accessor.init")}else if(u!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,r,u,c,o,b,p,T,x){var m=u[0],s,f,n;p?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(r,c)),o===1?n={get:s.get,set:s.set}:o===2?n=s.value:o===3?n=s.get:o===4&&(n=s.set);var a,I,P;if(typeof m=="function")a=t(m,c,s,T,o,b,p,x,n),a!==void 0&&(h(o,a),o===0?f=a:o===1?(f=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,b,p,x,n),a!==void 0){h(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,C){return C};else if(typeof f!="function"){var F=f;f=function(M,C){for(var N=C,L=0;L<F.length;L++)N=F[L].call(M,N);return N}}else{var j=f;f=function(M,C){return j.call(M,C)}}l.push(f)}o!==0&&(o===1?(s.get=n.get,s.set=n.set):o===2?s.value=n:o===3?s.get=n:o===4&&(s.set=n),p?o===1?(l.push(function(M,C){return n.get.call(M,C)}),l.push(function(M,C){return n.set.call(M,C)})):o===2?l.push(n):l.push(function(M,C){return n.call(M,C)}):Object.defineProperty(r,c,s))}function v(l,r,u){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<r.length;x++){var m=r[x];if(Array.isArray(m)){var s=m[1],f=m[2],n=m.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!n){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,I,m,f,s,a,n,P,u)}}return w(c,o),w(c,b),c}function w(l,r){r&&l.push(function(u){for(var c=0;c<r.length;c++)r[c].call(u);return u})}function D(l,r,u){if(r.length>0){for(var c=[],o=l,b=l.name,p=r.length-1;p>=0;p--){var T={v:!1};try{var x=r[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:u})}finally{T.v=!0}x!==void 0&&(h(10,x),o=x)}return[S(o,u),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,r){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:r})}return function(r,u,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(r,u,p);return c.length||S(r,p),{e:T,get c(){return D(r,c,p)}}}}function dn(y,t,e,i){return(dn=kl())(y,t,e,i)}var pn,ln,gn,vn,yn,bn,wn,xn,Tn,Dn,En,Cn,In,cn,un,hn,fn,Yt;pn=U({selector:"kg-resize-box",template:an,style:sn}),gn=V.state({proxy:!0}),vn=rt("resize"),yn=rt("resize-end"),bn=$(),wn=$(),xn=$(),Tn=$(),Dn=$(),En=$(),Cn=$(),In=$();var mn=class{static{({e:[cn,un,hn,fn],c:[Yt,ln]}=dn(this,[[gn,1,"mConfiguration"],[vn,1,"mResize"],[yn,1,"mResizeEnd"],[bn,3,"bottom"],[wn,3,"height"],[xn,3,"left"],[Tn,3,"right"],[Dn,3,"snap"],[En,3,"top"],[Cn,3,"virtual"],[In,3,"width"]],[pn]))}constructor(t=O.use(G)){this.mComponentElement=t.element,this.mConfiguration={snap:1,isVirtual:!1,enabledDirections:{top:!1,right:!1,bottom:!1,left:!1}}}mComponentElement;#t=(fn(this),cn(this));get mConfiguration(){return this.#t}set mConfiguration(t){this.#t=t}#e=un(this);get mResize(){return this.#e}set mResize(t){this.#e=t}#o=hn(this);get mResizeEnd(){return this.#o}set mResizeEnd(t){this.#o=t}get bottom(){return this.mConfiguration.enabledDirections.bottom}set bottom(t){this.mConfiguration.enabledDirections.bottom=this.parseBoolean(t)}get height(){return this.mComponentElement.clientHeight}set height(t){this.updateComponentHeight(t,!0)}get left(){return this.mConfiguration.enabledDirections.left}set left(t){this.mConfiguration.enabledDirections.left=this.parseBoolean(t)}get right(){return this.mConfiguration.enabledDirections.right}set right(t){this.mConfiguration.enabledDirections.right=this.parseBoolean(t)}get snap(){return this.mConfiguration.snap}set snap(t){this.mConfiguration.snap=parseInt(t.toString())}get top(){return this.mConfiguration.enabledDirections.top}set top(t){this.mConfiguration.enabledDirections.top=this.parseBoolean(t)}get virtual(){return this.mConfiguration.isVirtual}set virtual(t){this.mConfiguration.isVirtual=this.parseBoolean(t)}get width(){return this.mComponentElement.clientWidth}set width(t){this.updateComponentWidth(t,!0)}resizeCorner(t){this.handleResize(t,"both")}resizeHorizontal(t){this.handleResize(t,"horizontal")}resizeVertical(t){this.handleResize(t,"vertical")}applyComponentSize(t,e,i){let h=this.updateComponentWidth(e,!1),d=this.updateComponentHeight(i,!1);return(h!==this.width||d!==this.height)&&this.mResize.dispatchEvent(this.createResizeEvent(t,h,d,this.width,this.height)),[h,d]}createResizeEvent(t,e,i,h,d){let v=t;return e===h&&(v&=~(bt.right|bt.left)),i===d&&(v&=~(bt.top|bt.bottom)),new eo(e,i,v)}handleResize(t,e){t.preventDefault(),t.stopPropagation();let i=this.mComponentElement.getBoundingClientRect(),h=this.mComponentElement.offsetWidth?i.width/this.mComponentElement.offsetWidth:1,d=this.mComponentElement.offsetHeight?i.height/this.mComponentElement.offsetHeight:1,v=i.width/h,w=i.height/d,D=t.clientX,S=t.clientY,l=1;Math.abs(D-i.left)<Math.abs(D-i.right)&&(l=-1);let r=1;Math.abs(S-i.top)<Math.abs(S-i.bottom)&&(r=-1);let u=0;u+=l===1?bt.right:bt.left,u+=r===1?bt.bottom:bt.top;let c=v,o=w,b=T=>{let x=(T.clientX-D)/h*l,m=(T.clientY-S)/d*r,s=v+x,f=w+m;e==="horizontal"&&(s=v),e==="vertical"&&(f=w),[c,o]=this.applyComponentSize(u,s,f)},p=()=>{document.removeEventListener("pointermove",b),document.removeEventListener("pointerup",p),(c!==v||o!==w)&&this.mResizeEnd.dispatchEvent(this.createResizeEvent(u,c,o,v,w))};document.addEventListener("pointermove",b),document.addEventListener("pointerup",p)}parseBoolean(t){return!!(()=>{if(typeof t=="string"){if(t==="")return!0;let i=t.toLowerCase();if(["true","false"].includes(i))return i==="true"}return t})()}updateComponentHeight(t,e){if(!this.mConfiguration.enabledDirections.top&&!this.mConfiguration.enabledDirections.bottom)return this.height;t=Math.max(1,t);let i=Math.ceil(Math.abs(t)/this.mConfiguration.snap)*this.mConfiguration.snap*(t/Math.abs(t));return i=Math.max(0,i),(!this.mConfiguration.isVirtual||e)&&this.mComponentElement.style.setProperty("height",`${i}px`),i}updateComponentWidth(t,e){if(!this.mConfiguration.enabledDirections.left&&!this.mConfiguration.enabledDirections.right)return this.height;t=Math.max(1,t);let i=Math.ceil(Math.abs(t)/this.mConfiguration.snap)*this.mConfiguration.snap*(t/Math.abs(t));return i=Math.max(0,i),(!this.mConfiguration.isVirtual||e)&&this.mComponentElement.style.setProperty("width",`${i}px`),i}static{ln()}},eo=class{mHeight;mResizeHandle;mWidth;get height(){return this.mHeight}get resizeHandle(){return this.mResizeHandle}get width(){return this.mWidth}constructor(t,e,i){this.mHeight=e,this.mResizeHandle=i,this.mWidth=t}},bt={top:1,right:2,bottom:4,left:8};var Pn=`:host {\r
...
`;function dc(){function y(l,r){return function(c){e(r,"addInitializer"),i(c,"An initializer"),l.push(c)}}function t(l,r,u,c,o,b,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+r:r,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=y(c,f);var n,a;if(o===0?p?(n=u.get,a=u.set):(n=function(){return this[r]},a=function(g){this[r]=g}):o===2?n=function(){return u.value}:((o===1||o===3)&&(n=function(){return u.get.call(this)}),(o===1||o===4)&&(a=function(g){u.set.call(this,g)})),p)s.access=n&&a?{get:n,set:a}:n?{get:n}:{set:a};else{if(n){var I=n;n=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return r in g};s.access=n&&a?{has:E,get:n,set:a}:n?{has:E,get:n}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,r){if(l.v)throw new Error("attempted to call "+r+" after decoration was finished")}function i(l,r){if(typeof l!="function")throw new TypeError(r+" must be a function")}function h(l,r){var u=typeof r;if(l===1){if(u!=="object"||r===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");r.get!==void 0&&i(r.get,"accessor.get"),r.set!==void 0&&i(r.set,"accessor.set"),r.init!==void 0&&i(r.init,"accessor.init")}else if(u!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,r,u,c,o,b,p,T,x){var m=u[0],s,f,n;p?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(r,c)),o===1?n={get:s.get,set:s.set}:o===2?n=s.value:o===3?n=s.get:o===4&&(n=s.set);var a,I,P;if(typeof m=="function")a=t(m,c,s,T,o,b,p,x,n),a!==void 0&&(h(o,a),o===0?f=a:o===1?(f=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,b,p,x,n),a!==void 0){h(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,C){return C};else if(typeof f!="function"){var F=f;f=function(M,C){for(var N=C,L=0;L<F.length;L++)N=F[L].call(M,N);return N}}else{var j=f;f=function(M,C){return j.call(M,C)}}l.push(f)}o!==0&&(o===1?(s.get=n.get,s.set=n.set):o===2?s.value=n:o===3?s.get=n:o===4&&(s.set=n),p?o===1?(l.push(function(M,C){return n.get.call(M,C)}),l.push(function(M,C){return n.set.call(M,C)})):o===2?l.push(n):l.push(function(M,C){return n.call(M,C)}):Object.defineProperty(r,c,s))}function v(l,r,u){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<r.length;x++){var m=r[x];if(Array.isArray(m)){var s=m[1],f=m[2],n=m.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!n){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,I,m,f,s,a,n,P,u)}}return w(c,o),w(c,b),c}function w(l,r){r&&l.push(function(u){for(var c=0;c<r.length;c++)r[c].call(u);return u})}function D(l,r,u){if(r.length>0){for(var c=[],o=l,b=l.name,p=r.length-1;p>=0;p--){var T={v:!1};try{var x=r[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:u})}finally{T.v=!0}x!==void 0&&(h(10,x),o=x)}return[S(o,u),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,r){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:r})}return function(r,u,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(r,u,p);return c.length||S(r,p),{e:T,get c(){return D(r,c,p)}}}}function Hi(y,t,e,i){return(Hi=dc())(y,t,e,i)}function pc(y){return y}var Xi,zi,Yi,Wi,Zi,qi,Ji,Ki,ji,Vi,$i,Bi,Gi,Ui,le;Xi=U({selector:"potatno-node-selection-popup",template:Fi,style:Oi,components:[se]}),Yi=$(),Wi=V.state({complexValue:!0}),Zi=yt("searchInput"),qi=rt("node-select"),Ji=V.state(),Ki=V.state();new class extends pc{constructor(){super(le),zi()}static{class y{static{({e:[ji,Vi,$i,Bi,Gi,Ui],c:[le,zi]}=Hi(this,[[Yi,3,"contextport"],[Wi,1,"results"],[Zi,1,"searchInput"],[qi,1,"mNodeSelect"],[Ji,1,"searchValue"],[Ki,1,"selectedDefinitionId"]],[Xi]))}static POPUP_HEIGHT=320;static POPUP_WIDTH=280;mComponent;mManager;mNodes;get contextport(){return this.mNodes.context}set contextport(e){this.mNodes.context=e,this.mNodes.list.filtered=this.contexturizeNodeList(this.mNodes.context)}#t=(Ui(this),ji(this));get results(){return this.#t}set results(e){this.#t=e}#e=Vi(this);get searchInput(){return this.#e}set searchInput(e){this.#e=e}#o=$i(this);get mNodeSelect(){return this.#o}set mNodeSelect(e){this.#o=e}#r=Bi(this);get searchValue(){return this.#r}set searchValue(e){this.#r=e}#n=Gi(this);get selectedDefinitionId(){return this.#n}set selectedDefinitionId(e){this.#n=e}constructor(e=O.use(G),i=O.use(H)){this.mManager=i,this.mComponent=e,this.selectedDefinitionId=null,this.results=new Array,this.searchValue="";let h=this.fetchNodeEntries();this.mNodes={context:null,list:{full:h,filtered:h}}}onConnect(){this.searchInput?.focus()}onKeyDown(e){if(this.results.length!==0){if(e.key==="ArrowDown"||e.key==="ArrowUp"){e.preventDefault();let i=this.results.findIndex(v=>v.definition.id===this.selectedDefinitionId);i=Math.max(0,i);let h=e.key==="ArrowDown"?1:-1,d=(i+h+this.results.length)%this.results.length;this.selectedDefinitionId=this.results[d].definition.id;return}e.key==="Enter"&&this.sendSelectedEntry(this.selectedDefinitionId)}}onUpdate(){this.results=this.filterResults(),this.results.some(i=>i.definition.id===this.selectedDefinitionId)||(this.selectedDefinitionId=this.results[0]?.definition.id??null);let e=this.mComponent.element.shadowRoot.querySelector(".selection-popup__result.selected");e&&e.scrollIntoView({block:"center"})}stopPropagation(e,i){e.stopPropagation(),i&&e.preventDefault()}contexturizeNodeList(e){return e?this.mNodes.list.full.filter(i=>!!this.findMatchingPortDefinition(e,i.definition)):this.mNodes.list.full}fetchNodeEntries(){return this.mManager.activeFunction.dynamicNodeDefinitions.map(e=>({category:e.category.name,definition:e,label:e.label.toLowerCase(),color:this.mManager.generateStringColor(e.category.name),icon:e.category.icon}))}filterResults(){let e=this.searchValue.trim().toLowerCase();return this.mNodes.list.filtered.filter(i=>i.label.includes(e))}findMatchingPortDefinition(e,i){let h=e.direction==="input"?i.outputs:i.inputs;for(let d of h)if(d.portType===e.portType&&d.dataType===e.dataType)return d;return null}sendSelectedEntry(e){if(e===null)return;let i=this.results.find(h=>h.definition.id===e);i&&this.mNodeSelect.dispatchEvent({definition:i.definition,port:this.mNodes.context?{source:this.mNodes.context,target:this.findMatchingPortDefinition(this.mNodes.context,i.definition)}:null})}}}};var Qi=`:host {\r
...
\r
    .edit & {\r
        ...
        border-radius: var(--potatno-border-radius);\r
        margin: 0.125rem 0.125rem 0 0.125rem;\r
    }\r
\r
    .node-header__icon {\r
        flex-shrink: 0;\r
...
`;function yc(){function y(l,r){return function(c){e(r,"addInitializer"),i(c,"An initializer"),l.push(c)}}function t(l,r,u,c,o,b,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+r:r,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=y(c,f);var n,a;if(o===0?p?(n=u.get,a=u.set):(n=function(){return this[r]},a=function(g){this[r]=g}):o===2?n=function(){return u.value}:((o===1||o===3)&&(n=function(){return u.get.call(this)}),(o===1||o===4)&&(a=function(g){u.set.call(this,g)})),p)s.access=n&&a?{get:n,set:a}:n?{get:n}:{set:a};else{if(n){var I=n;n=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return r in g};s.access=n&&a?{has:E,get:n,set:a}:n?{has:E,get:n}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,r){if(l.v)throw new Error("attempted to call "+r+" after decoration was finished")}function i(l,r){if(typeof l!="function")throw new TypeError(r+" must be a function")}function h(l,r){var u=typeof r;if(l===1){if(u!=="object"||r===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");r.get!==void 0&&i(r.get,"accessor.get"),r.set!==void 0&&i(r.set,"accessor.set"),r.init!==void 0&&i(r.init,"accessor.init")}else if(u!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,r,u,c,o,b,p,T,x){var m=u[0],s,f,n;p?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(r,c)),o===1?n={get:s.get,set:s.set}:o===2?n=s.value:o===3?n=s.get:o===4&&(n=s.set);var a,I,P;if(typeof m=="function")a=t(m,c,s,T,o,b,p,x,n),a!==void 0&&(h(o,a),o===0?f=a:o===1?(f=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,b,p,x,n),a!==void 0){h(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,C){return C};else if(typeof f!="function"){var F=f;f=function(M,C){for(var N=C,L=0;L<F.length;L++)N=F[L].call(M,N);return N}}else{var j=f;f=function(M,C){return j.call(M,C)}}l.push(f)}o!==0&&(o===1?(s.get=n.get,s.set=n.set):o===2?s.value=n:o===3?s.get=n:o===4&&(s.set=n),p?o===1?(l.push(function(M,C){return n.get.call(M,C)}),l.push(function(M,C){return n.set.call(M,C)})):o===2?l.push(n):l.push(function(M,C){return n.call(M,C)}):Object.defineProperty(r,c,s))}function v(l,r,u){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<r.length;x++){var m=r[x];if(Array.isArray(m)){var s=m[1],f=m[2],n=m.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!n){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,I,m,f,s,a,n,P,u)}}return w(c,o),w(c,b),c}function w(l,r){r&&l.push(function(u){for(var c=0;c<r.length;c++)r[c].call(u);return u})}function D(l,r,u){if(r.length>0){for(var c=[],o=l,b=l.name,p=r.length-1;p>=0;p--){var T={v:!1};try{var x=r[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:u})}finally{T.v=!0}x!==void 0&&(h(10,x),o=x)}return[S(o,u),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,r){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:r})}return function(r,u,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(r,u,p);return c.length||S(r,p),{e:T,get c(){return D(r,c,p)}}}}function cs(y,t,e,i){return(cs=yc())(y,t,e,i)}var us,ts,hs,fs,ms,ds,ps,gs,vs,es,os,rs,ns,is,ss,as,_o;us=U({selector:"potatno-comment-node",template:ki,style:Qi,components:[Yt]}),hs=V.state(),fs=V.state(),ms=V.state(),ds=$(),ps=yt("CommentInput"),gs=rt("node-drag"),vs=yt("ResizeBox");var ls=class{static{({e:[es,os,rs,ns,is,ss,as],c:[_o,ts]}=cs(this,[[hs,1,"editMode"],[fs,1,"enableBigview"],[ms,1,"gridZoom"],[ds,3,"nodeData"],[ps,1,"mCommentInput"],[gs,1,"mDrag"],[vs,1,"mResizeBox"]],[us]))}constructor(t=O.use(G),e=O.use(H)){this.mComponent=t,this.mManager=e,this.mNodeData=null,this.editMode=!1,this.enableBigview=!1,this.gridZoom=0,this.updateForZoomLevel(),this.mUnsubscribeGrid=this.mManager.subscribe(R.SpecialGrid,()=>{this.updateForZoomLevel()}),this.mUnsubscribe=this.mManager.subscribe(R.Node,i=>{i.item===this.mNodeData&&this.resyncComponent(this.nodeData)}),this.mUnsubscribeResize=this.mManager.subscribe(R.ProgrammResize,()=>{this.mNodeData&&this.resyncComponent(this.mNodeData)})}mComponent;mManager;mNodeData;mUnsubscribe;mUnsubscribeGrid;mUnsubscribeResize;get comment(){return this.nodeData.label??""}set comment(t){this.nodeData.label=t}#t=(as(this),es(this));get editMode(){return this.#t}set editMode(t){this.#t=t}#e=os(this);get enableBigview(){return this.#e}set enableBigview(t){this.#e=t}#o=rs(this);get gridZoom(){return this.#o}set gridZoom(t){this.#o=t}get gridSize(){return this.mManager.grid.gridSize}get nodeData(){if(!this.mNodeData)throw new A("Node data not set.",this);return this.mNodeData}set nodeData(t){this.mNodeData=t,t&&(this.resyncComponent(t),this.mComponent.updater.update())}#r=ns(this);get mCommentInput(){return this.#r}set mCommentInput(t){this.#r=t}#n=is(this);get mDrag(){return this.#n}set mDrag(t){this.#n=t}#i=ss(this);get mResizeBox(){return this.#i}set mResizeBox(t){this.#i=t}dragNodeOrEnableEdit(t){if(t.preventDefault(),this.editMode||(t.button===2&&this.mManager.graph.removeNode(this.nodeData),t.button!==0))return;let e=this.nodeData.transformation.x*this.mManager.grid.gridSize,i=this.nodeData.transformation.y*this.mManager.grid.gridSize,h=this.nodeData.transformation.x,d=this.nodeData.transformation.y,v=this.mComponent.element.getBoundingClientRect(),w=this.mComponent.element.offsetWidth?v.width/this.mComponent.element.offsetWidth:1,D=this.mComponent.element.offsetHeight?v.height/this.mComponent.element.offsetHeight:1,S=t.clientX,l=t.clientY,r=c=>{c.stopPropagation();let o=(c.clientX-S)/w,b=(c.clientY-l)/D,p=Math.round((e+o)/this.mManager.grid.gridSize),T=Math.round((i+b)/this.mManager.grid.gridSize);h===p&&d===T||(this.mManager.graph.transformNode(this.nodeData,x=>{x.moveTo(p,T)}),this.mDrag.dispatchEvent(new Mo(p-h,T-d)),h=p,d=T)},u=()=>{document.removeEventListener("pointermove",r),document.removeEventListener("pointerup",u)};document.addEventListener("pointermove",r),document.addEventListener("pointerup",u)}escapeEditMode(t){(t.key==="Escape"||t.key==="Enter")&&(t.preventDefault(),this.editMode=!1)}onConnect(){this.resyncComponent(this.nodeData)}onDeconstruct(){this.mUnsubscribe(),this.mUnsubscribeGrid(),this.mUnsubscribeResize()}onUpdate(){this.mCommentInput&&this.getFocusedElement(document)!==this.mCommentInput&&this.mCommentInput.select()}transformNodeData(t){this.mManager.graph.transformNode(this.nodeData,e=>{let i=e.transformation.width,h=e.transformation.height;e.resizeTo(t.width/this.mManager.grid.gridSize,t.height/this.mManager.grid.gridSize);let d=e.transformation.width-i,v=e.transformation.height-h;v!==0&&(t.resizeHandle&bt.top)>0&&e.moveTo(e.transformation.x,e.transformation.y-v),d!==0&&(t.resizeHandle&bt.left)>0&&e.moveTo(e.transformation.x-d,e.transformation.y)})}getFocusedElement(t){let e=t.activeElement;return e?e.shadowRoot?this.getFocusedElement(e.shadowRoot):e:null}resyncComponent(t){let e=t.transformation.x*this.mManager.grid.gridSize,i=t.transformation.y*this.mManager.grid.gridSize;if(this.mComponent.element.style.setProperty("left",`${e}px`),this.mComponent.element.style.setProperty("top",`${i}px`),this.mResizeBox){let h=t.transformation.width*this.mManager.grid.gridSize,d=t.transformation.height*this.mManager.grid.gridSize;this.mResizeBox.width=h,this.mResizeBox.height=d}this.mComponent.updater.updateAsync()}updateForZoomLevel(){this.enableBigview=this.mManager.grid.zoom<.25,this.enableBigview&&(this.gridZoom=this.mManager.grid.zoom),this.mComponent.element.style.setProperty("z-index",(this.enableBigview?9999:-1).toString())}static{ts()}},Mo=class{mX;mY;get x(){return this.mX}get y(){return this.mY}constructor(t,e){this.mX=t,this.mY=e}};var ys=`:host {
    ...
    /* Center the handle. The parent positions the host on the node edge. */
    display: flex;
    align-items: center;
    justify-content: center;
    width: var(--potatno-port-width);
    height: var(--potatno-port-width);
...
.handle {
    ...
    &.flow {
        ...
        &.output {
            ...
            &.connected {
                translate: calc(var(--potatno-port-width) / 2) 0;
...
`;var Ms=`<div class="node" style="--type-color: {{this.portColor}}" (dragover)="this.onDragOver($event)" (drop)="this.onDrop($event)">\r
\r
...
}`;var Gs=`<svg class="svg-layer" xmlns="http://www.w3.org/2000/svg" >\r
...
`;function Pc(){function y(l,r){return function(c){e(r,"addInitializer"),i(c,"An initializer"),l.push(c)}}function t(l,r,u,c,o,b,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+r:r,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=y(c,f);var n,a;if(o===0?p?(n=u.get,a=u.set):(n=function(){return this[r]},a=function(g){this[r]=g}):o===2?n=function(){return u.value}:((o===1||o===3)&&(n=function(){return u.get.call(this)}),(o===1||o===4)&&(a=function(g){u.set.call(this,g)})),p)s.access=n&&a?{get:n,set:a}:n?{get:n}:{set:a};else{if(n){var I=n;n=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return r in g};s.access=n&&a?{has:E,get:n,set:a}:n?{has:E,get:n}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,r){if(l.v)throw new Error("attempted to call "+r+" after decoration was finished")}function i(l,r){if(typeof l!="function")throw new TypeError(r+" must be a function")}function h(l,r){var u=typeof r;if(l===1){if(u!=="object"||r===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");r.get!==void 0&&i(r.get,"accessor.get"),r.set!==void 0&&i(r.set,"accessor.set"),r.init!==void 0&&i(r.init,"accessor.init")}else if(u!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,r,u,c,o,b,p,T,x){var m=u[0],s,f,n;p?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(r,c)),o===1?n={get:s.get,set:s.set}:o===2?n=s.value:o===3?n=s.get:o===4&&(n=s.set);var a,I,P;if(typeof m=="function")a=t(m,c,s,T,o,b,p,x,n),a!==void 0&&(h(o,a),o===0?f=a:o===1?(f=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,b,p,x,n),a!==void 0){h(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,C){return C};else if(typeof f!="function"){var F=f;f=function(M,C){for(var N=C,L=0;L<F.length;L++)N=F[L].call(M,N);return N}}else{var j=f;f=function(M,C){return j.call(M,C)}}l.push(f)}o!==0&&(o===1?(s.get=n.get,s.set=n.set):o===2?s.value=n:o===3?s.get=n:o===4&&(s.set=n),p?o===1?(l.push(function(M,C){return n.get.call(M,C)}),l.push(function(M,C){return n.set.call(M,C)})):o===2?l.push(n):l.push(function(M,C){return n.call(M,C)}):Object.defineProperty(r,c,s))}function v(l,r,u){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<r.length;x++){var m=r[x];if(Array.isArray(m)){var s=m[1],f=m[2],n=m.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!n){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,I,m,f,s,a,n,P,u)}}return w(c,o),w(c,b),c}function w(l,r){r&&l.push(function(u){for(var c=0;c<r.length;c++)r[c].call(u);return u})}function D(l,r,u){if(r.length>0){for(var c=[],o=l,b=l.name,p=r.length-1;p>=0;p--){var T={v:!1};try{var x=r[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:u})}finally{T.v=!0}x!==void 0&&(h(10,x),o=x)}return[S(o,u),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,r){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:r})}return function(r,u,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(r,u,p);return c.length||S(r,p),{e:T,get c(){return D(r,c,p)}}}}function Ws(y,t,e,i){return(Ws=Pc())(y,t,e,i)}var Zs,Us,qs,Hs,Xs,No;Zs=U({selector:"potatno-connection-layer",template:Gs,style:Bs}),qs=V.state({complexValue:!0});var Ys=class{static{({e:[Hs,Xs],c:[No,Us]}=Ws(this,[[qs,1,"connections"]],[Zs]))}constructor(t=O.use(H)){this.mManager=t,this.connections=new Map;let e=0;this.mUnsubscribe=this.mManager.subscribe(R.SpecialActiveFunction|R.Node|R.Connection|R.ProgrammResize,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.updateConnections()}))})}mManager;mUnsubscribe;#t=(Xs(this),Hs(this));get connections(){return this.#t}set connections(t){this.#t=t}createConjunction(t,e){t.preventDefault(),t.stopPropagation();let i=e.port.output.portType==="flow"?this.mManager.project.nodeDefinitions.get(K.DEFINITION_ID):this.mManager.project.nodeDefinitions.get(et.DEFINITION_ID),h=this.mManager.grid.pixelToGridSpace(t.clientX,t.clientY),d=this.mManager.graph.addNode(this.mManager.activeFunction,i,{x:h.x,y:h.y,height:0,width:0});this.mManager.graph.disconnectPorts(e.port.output,e.port.input);let v=d.inputs.list[0],w=d.outputs.list[0];this.mManager.graph.connectPorts(v,e.port.output),this.mManager.graph.connectPorts(v,e.port.input),this.mManager.graph.connectPorts(w,e.port.output),this.mManager.graph.connectPorts(w,e.port.input)}deleteConnection(t,e){t.button===2&&(t.preventDefault(),t.stopPropagation(),this.mManager.graph.disconnectPorts(e.port.output,e.port.input))}onDeconstruct(){this.mUnsubscribe()}createConnection(t,e,i){let h=this.mManager.integrity.errorItems,d=h.has(e)||h.has(i),v=(()=>{switch(i.portType){case"value":return i;case"flow":return e}})(),w=e.portType==="flow"?"":this.mManager.generateStringColor(e.resolvedDataType),D=this.mManager.connections.getConnectionPath(e,i);return{color:w,path:{attributeValue:D.attributeValue,length:D.length},state:{isNew:!t.has(v),hasError:d},port:{primary:v,output:e,input:i}}}updateConnections(){let t=this.connections;this.connections=new Map;for(let e of this.mManager.activeFunction.nodes)for(let i of e.outputs.list)for(let h of i.connectedPorts){let d=this.createConnection(t,i,h);this.connections.set(d.port.primary,d)}}static{Us()}};function Mc(){function y(l,r){return function(c){e(r,"addInitializer"),i(c,"An initializer"),l.push(c)}}function t(l,r,u,c,o,b,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+r:r,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=y(c,f);var n,a;if(o===0?p?(n=u.get,a=u.set):(n=function(){return this[r]},a=function(g){this[r]=g}):o===2?n=function(){return u.value}:((o===1||o===3)&&(n=function(){return u.get.call(this)}),(o===1||o===4)&&(a=function(g){u.set.call(this,g)})),p)s.access=n&&a?{get:n,set:a}:n?{get:n}:{set:a};else{if(n){var I=n;n=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return r in g};s.access=n&&a?{has:E,get:n,set:a}:n?{has:E,get:n}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,r){if(l.v)throw new Error("attempted to call "+r+" after decoration was finished")}function i(l,r){if(typeof l!="function")throw new TypeError(r+" must be a function")}function h(l,r){var u=typeof r;if(l===1){if(u!=="object"||r===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");r.get!==void 0&&i(r.get,"accessor.get"),r.set!==void 0&&i(r.set,"accessor.set"),r.init!==void 0&&i(r.init,"accessor.init")}else if(u!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,r,u,c,o,b,p,T,x){var m=u[0],s,f,n;p?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(r,c)),o===1?n={get:s.get,set:s.set}:o===2?n=s.value:o===3?n=s.get:o===4&&(n=s.set);var a,I,P;if(typeof m=="function")a=t(m,c,s,T,o,b,p,x,n),a!==void 0&&(h(o,a),o===0?f=a:o===1?(f=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,b,p,x,n),a!==void 0){h(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,C){return C};else if(typeof f!="function"){var F=f;f=function(M,C){for(var N=C,L=0;L<F.length;L++)N=F[L].call(M,N);return N}}else{var j=f;f=function(M,C){return j.call(M,C)}}l.push(f)}o!==0&&(o===1?(s.get=n.get,s.set=n.set):o===2?s.value=n:o===3?s.get=n:o===4&&(s.set=n),p?o===1?(l.push(function(M,C){return n.get.call(M,C)}),l.push(function(M,C){return n.set.call(M,C)})):o===2?l.push(n):l.push(function(M,C){return n.call(M,C)}):Object.defineProperty(r,c,s))}function v(l,r,u){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<r.length;x++){var m=r[x];if(Array.isArray(m)){var s=m[1],f=m[2],n=m.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!n){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,I,m,f,s,a,n,P,u)}}return w(c,o),w(c,b),c}function w(l,r){r&&l.push(function(u){for(var c=0;c<r.length;c++)r[c].call(u);return u})}function D(l,r,u){if(r.length>0){for(var c=[],o=l,b=l.name,p=r.length-1;p>=0;p--){var T={v:!1};try{var x=r[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:u})}finally{T.v=!0}x!==void 0&&(h(10,x),o=x)}return[S(o,u),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,r){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:r})}return function(r,u,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(r,u,p);return c.length||S(r,p),{e:T,get c(){return D(r,c,p)}}}}function Qs(y,t,e,i){return(Qs=Mc())(y,t,e,i)}var ks,Js,Ae;ks=Ct({access:q.Read,selector:/^potatno-preview$/});var Ks=class{static{({c:[Ae,Js]}=Qs(this,[],[ks]))}constructor(t=O.use(k),e=O.use(W),i=O.use(st)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(i.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let i=this.mTarget.childNodes.length>0;return i&&(this.mTarget.innerHTML=""),i}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{Js()}};var ta=`:host {
    --potatno-port-value-size: 6px;
    --potatno-port-flow-size: 16px;
...
.port-values {
    ...
    &::after {
        ...
        right: 2px;
        height: 2px;
        width: calc(var(--potatno-port-values-line-length) - 2px);
        pointer-events: none;
        background-color: var(--potatno-port-color);
    }
...
`;var ea=`<div class="port-wrapper {{this.portDirection}}" style="--type-color: {{this.portColor}}" (dragover)="this.onDragOver($event)" (drop)="this.onDrop($event)">\r
\r
...
\r
    <!-- Ports -->\r
    <div class="node-body {{this.hasError ? 'error' : ''}}" style="--node-width: {{ this.nodeTransformation.width }}; --node-category-color: {{this.nodeColor}}">\r
\r
...
}`;function Rc(){function y(l,r){return function(c){e(r,"addInitializer"),i(c,"An initializer"),l.push(c)}}function t(l,r,u,c,o,b,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+r:r,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=y(c,f);var n,a;if(o===0?p?(n=u.get,a=u.set):(n=function(){return this[r]},a=function(g){this[r]=g}):o===2?n=function(){return u.value}:((o===1||o===3)&&(n=function(){return u.get.call(this)}),(o===1||o===4)&&(a=function(g){u.set.call(this,g)})),p)s.access=n&&a?{get:n,set:a}:n?{get:n}:{set:a};else{if(n){var I=n;n=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return r in g};s.access=n&&a?{has:E,get:n,set:a}:n?{has:E,get:n}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,r){if(l.v)throw new Error("attempted to call "+r+" after decoration was finished")}function i(l,r){if(typeof l!="function")throw new TypeError(r+" must be a function")}function h(l,r){var u=typeof r;if(l===1){if(u!=="object"||r===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");r.get!==void 0&&i(r.get,"accessor.get"),r.set!==void 0&&i(r.set,"accessor.set"),r.init!==void 0&&i(r.init,"accessor.init")}else if(u!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,r,u,c,o,b,p,T,x){var m=u[0],s,f,n;p?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(r,c)),o===1?n={get:s.get,set:s.set}:o===2?n=s.value:o===3?n=s.get:o===4&&(n=s.set);var a,I,P;if(typeof m=="function")a=t(m,c,s,T,o,b,p,x,n),a!==void 0&&(h(o,a),o===0?f=a:o===1?(f=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,b,p,x,n),a!==void 0){h(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,C){return C};else if(typeof f!="function"){var F=f;f=function(M,C){for(var N=C,L=0;L<F.length;L++)N=F[L].call(M,N);return N}}else{var j=f;f=function(M,C){return j.call(M,C)}}l.push(f)}o!==0&&(o===1?(s.get=n.get,s.set=n.set):o===2?s.value=n:o===3?s.get=n:o===4&&(s.set=n),p?o===1?(l.push(function(M,C){return n.get.call(M,C)}),l.push(function(M,C){return n.set.call(M,C)})):o===2?l.push(n):l.push(function(M,C){return n.call(M,C)}):Object.defineProperty(r,c,s))}function v(l,r,u){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<r.length;x++){var m=r[x];if(Array.isArray(m)){var s=m[1],f=m[2],n=m.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!n){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,I,m,f,s,a,n,P,u)}}return w(c,o),w(c,b),c}function w(l,r){r&&l.push(function(u){for(var c=0;c<r.length;c++)r[c].call(u);return u})}function D(l,r,u){if(r.length>0){for(var c=[],o=l,b=l.name,p=r.length-1;p>=0;p--){var T={v:!1};try{var x=r[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:u})}finally{T.v=!0}x!==void 0&&(h(10,x),o=x)}return[S(o,u),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,r){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:r})}return function(r,u,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(r,u,p);return c.length||S(r,p),{e:T,get c(){return D(r,c,p)}}}}function Ta(y,t,e,i){return(Ta=Rc())(y,t,e,i)}var Da,da,Ea,Ca,Ia,Pa,Ma,_a,pa,ga,va,ya,ba,wa,Oo;Da=U({selector:"potatno-node",template:ma,style:fa,modules:[Ae],components:[Lo,Mt,no]}),Ea=rt("node-drag"),Ca=V.state(),Ia=$(),Pa=V.state({proxy:!0}),Ma=V.state({complexValue:!0}),_a=V.state({complexValue:!0});var xa=class{static{({e:[pa,ga,va,ya,ba,wa],c:[Oo,da]}=Ta(this,[[Ea,1,"mDrag"],[Ca,1,"isPreviewDisplaySelectionOpen"],[Ia,3,"nodeData"],[Pa,1,"nodeTransformation"],[Ma,1,"previewPorts"],[_a,1,"previewDisplays"]],[Da]))}constructor(t=O.use(G),e=O.use(H)){this.mComponent=t,this.mManager=e,this.mNodeDefinition=null,this.mNodeData=null,this.isPreviewDisplaySelectionOpen=!1,this.nodeTransformation={height:0,width:0},this.previewPorts=new Array,this.previewDisplays=new Array,this.mUnsubscribeNodeChange=this.mManager.subscribe(R.Node,i=>{i.item===this.mNodeData&&this.resyncComponent(this.nodeData)}),this.mUnsubscribeValidation=this.mManager.subscribe(R.SpecialValidation,()=>{this.mComponent.updater.updateAsync()})}mComponent;mManager;mNodeData;mNodeDefinition;mUnsubscribeNodeChange;mUnsubscribeValidation;get canPreview(){return this.previewPorts.length>0}#t=(wa(this),pa(this));get mDrag(){return this.#t}set mDrag(t){this.#t=t}get hasError(){if(this.mManager.integrity.errorItems.has(this.nodeData))return!0;for(let t of this.nodeData.inputs.list)if(this.mManager.integrity.errorItems.has(t))return!0;for(let t of this.nodeData.outputs.list)if(this.mManager.integrity.errorItems.has(t))return!0;return!1}get inputPorts(){return this.nodeData.inputs.list}get isFunction(){return this.mNodeDefinition instanceof wt}get isPreviewActive(){return!!this.nodeData.preview}#e=ga(this);get isPreviewDisplaySelectionOpen(){return this.#e}set isPreviewDisplaySelectionOpen(t){this.#e=t}get nodeColor(){return this.mManager.generateStringColor(this.mNodeDefinition?.category.name??"")}get nodeData(){if(!this.mNodeData)throw new A("Node data not set.",this);return this.mNodeData}set nodeData(t){this.mNodeData=t,this.mNodeDefinition=null,this.mNodeData&&(this.mNodeDefinition=this.mManager.activeFunction.nodeDefinitions.find(e=>e.id===this.mNodeData.definitionId)??null,this.resyncComponent(t),this.mComponent.updater.update())}get nodeIcon(){return this.mNodeDefinition?.category.icon??""}get nodeLabel(){return this.nodeData.label??""}#o=va(this);get nodeTransformation(){return this.#o}set nodeTransformation(t){this.#o=t}get outputPorts(){return this.nodeData.outputs.list}#r=ya(this);get previewPorts(){return this.#r}set previewPorts(t){this.#r=t}#n=ba(this);get previewDisplays(){return this.#n}set previewDisplays(t){this.#n=t}get previewDisplayId(){return this.nodeData.preview?.displayId??""}get previewDriver(){if(!this.nodeData.preview)return null;let t=this.nodeData.outputs.map.get(this.nodeData.preview.portDefinitionId);return t?this.mManager.preview.requestDriver(t,this.nodeData.preview.displayId):null}get previewPortDefinitionId(){return this.nodeData.preview?.portDefinitionId??""}dragNode(t){if(t.button===2&&this.mManager.graph.removeNode(this.nodeData),t.button!==0)return;let e=this.nodeData.transformation.x*this.mManager.grid.gridSize,i=this.nodeData.transformation.y*this.mManager.grid.gridSize,h=this.nodeData.transformation.x,d=this.nodeData.transformation.y,v=this.mComponent.element.getBoundingClientRect(),w=this.mComponent.element.offsetWidth?v.width/this.mComponent.element.offsetWidth:1,D=this.mComponent.element.offsetHeight?v.height/this.mComponent.element.offsetHeight:1,S=t.clientX,l=t.clientY,r=c=>{c.stopPropagation();let o=(c.clientX-S)/w,b=(c.clientY-l)/D,p=Math.round((e+o)/this.mManager.grid.gridSize),T=Math.round((i+b)/this.mManager.grid.gridSize);h===p&&d===T||(this.mManager.graph.transformNode(this.nodeData,x=>{x.moveTo(p,T)}),this.mDrag.dispatchEvent(new Ro(p-h,T-d)),h=p,d=T)},u=()=>{document.removeEventListener("pointermove",r),document.removeEventListener("pointerup",u)};document.addEventListener("pointermove",r),document.addEventListener("pointerup",u)}onDeconstruct(){this.mUnsubscribeNodeChange(),this.mUnsubscribeValidation()}openFunction(){this.mNodeDefinition instanceof wt&&this.mManager.setActiveFunction(this.mNodeDefinition.function)}selectPreviewDisplay(t){this.mManager.graph.updateNode(this.nodeData,e=>{e.preview={portDefinitionId:e.preview.portDefinitionId,displayId:t}}),document.activeElement instanceof HTMLElement&&document.activeElement.blur()}selectPreviewPort(t){let e=(()=>{let i=this.previewPorts;return i.length===0?null:typeof t<"u"?i.find(h=>h.definitionId===t)??null:this.nodeData.preview?null:i[0]})();if(!e)return this.mManager.graph.updateNode(this.nodeData,i=>{i.preview=null});this.mManager.graph.updateNode(this.nodeData,i=>{let h=i.project.getFunction(i.function.definitionId),d=i.project.preview.availableDisplays(h,e.resolvedDataType);d.length===0&&(i.preview=null);let v=i.preview&&d.includes(i.preview.displayId)?i.preview.displayId:d[0];i.preview={portDefinitionId:e.definitionId,displayId:v}}),this.resyncComponent(this.nodeData)}getPreviewDisplays(t){if(!t)return new Array;let e=this.nodeData.outputs.map.get(t);if(!e)return new Array;let i=e.project.getFunction(e.node.function.definitionId);return i?e.project.preview.availableDisplays(i,e.resolvedDataType).map(d=>({id:d,label:e.project.preview.getDisplay(d)?.name??d})):new Array}getPreviewablePorts(t){let e=t.project.getFunction(t.function.definitionId);if(!this.mManager.activeFunction.dynamicNodeDefinitions.find(d=>d.id===t.definitionId))return new Array;let h=new Map;return t.outputs.value.filter(d=>{let v=d.resolvedDataType;if(h.has(v))return h.get(v);let w=t.project.preview.availableDisplays(e,d.resolvedDataType);return h.set(v,w.length>0),h.get(v)})}resyncComponent(t){let e=t.transformation.x,i=t.transformation.y;this.mComponent.element.style.setProperty("left",`calc(var(--potatno-grid-size) * ${e})`),this.mComponent.element.style.setProperty("top",`calc(var(--potatno-grid-size) * ${i} - 8px)`),this.nodeTransformation.width=t.transformation.width,this.nodeTransformation.height=t.transformation.height,this.previewPorts=this.getPreviewablePorts(this.nodeData),this.previewDisplays=this.getPreviewDisplays(t.preview?.portDefinitionId??null)}static{da()}},Ro=class{mX;mY;get x(){return this.mX}get y(){return this.mY}constructor(t,e){this.mX=t,this.mY=e}};var Sa=`:host {\r
    position: relative;\r
    flex: 1;\r
    display: flex;\r
    min-height: 0;\r
...
}`;var Aa=`<!-- Serves only as a background. -->\r
...
}`;var Ba=`<kg-resize-box class="resize-box" left top bottom="false">\r
    <div class="header">\r
...
\r
    <potatno-function-properties />\r
</div>`;function Hc(){function y(l,r){return function(c){e(r,"addInitializer"),i(c,"An initializer"),l.push(c)}}function t(l,r,u,c,o,b,p,T,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+r:r,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=y(c,f);var n,a;if(o===0?p?(n=u.get,a=u.set):(n=function(){return this[r]},a=function(g){this[r]=g}):o===2?n=function(){return u.value}:((o===1||o===3)&&(n=function(){return u.get.call(this)}),(o===1||o===4)&&(a=function(g){u.set.call(this,g)})),p)s.access=n&&a?{get:n,set:a}:n?{get:n}:{set:a};else{if(n){var I=n;n=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return r in g};s.access=n&&a?{has:E,get:n,set:a}:n?{has:E,get:n}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,r){if(l.v)throw new Error("attempted to call "+r+" after decoration was finished")}function i(l,r){if(typeof l!="function")throw new TypeError(r+" must be a function")}function h(l,r){var u=typeof r;if(l===1){if(u!=="object"||r===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");r.get!==void 0&&i(r.get,"accessor.get"),r.set!==void 0&&i(r.set,"accessor.set"),r.init!==void 0&&i(r.init,"accessor.init")}else if(u!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,r,u,c,o,b,p,T,x){var m=u[0],s,f,n;p?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(r,c)),o===1?n={get:s.get,set:s.set}:o===2?n=s.value:o===3?n=s.get:o===4&&(n=s.set);var a,I,P;if(typeof m=="function")a=t(m,c,s,T,o,b,p,x,n),a!==void 0&&(h(o,a),o===0?f=a:o===1?(f=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,T,o,b,p,x,n),a!==void 0){h(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||n.get,P=a.set||n.set,n={get:I,set:P}):n=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,C){return C};else if(typeof f!="function"){var F=f;f=function(M,C){for(var N=C,L=0;L<F.length;L++)N=F[L].call(M,N);return N}}else{var j=f;f=function(M,C){return j.call(M,C)}}l.push(f)}o!==0&&(o===1?(s.get=n.get,s.set=n.set):o===2?s.value=n:o===3?s.get=n:o===4&&(s.set=n),p?o===1?(l.push(function(M,C){return n.get.call(M,C)}),l.push(function(M,C){return n.set.call(M,C)})):o===2?l.push(n):l.push(function(M,C){return n.call(M,C)}):Object.defineProperty(r,c,s))}function v(l,r,u){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<r.length;x++){var m=r[x];if(Array.isArray(m)){var s=m[1],f=m[2],n=m.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!n){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,I,m,f,s,a,n,P,u)}}return w(c,o),w(c,b),c}function w(l,r){r&&l.push(function(u){for(var c=0;c<r.length;c++)r[c].call(u);return u})}function D(l,r,u){if(r.length>0){for(var c=[],o=l,b=l.name,p=r.length-1;p>=0;p--){var T={v:!1};try{var x=r[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:u})}finally{T.v=!0}x!==void 0&&(h(10,x),o=x)}return[S(o,u),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function S(l,r){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:r})}return function(r,u,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(r,u,p);return c.length||S(r,p),{e:T,get c(){return D(r,c,p)}}}}function sl(y,t,e,i){return(sl=Hc())(y,t,e,i)}var al,rl,ll,cl,nl,zo;al=U({selector:"potatno-code-editor",template:ol,style:el,components:[Io,io,Po,Fo]}),ll=$(),cl=$();var il=class{static{({e:[nl],c:[zo,rl]}=sl(this,[[ll,3,"document"],[cl,2,"triggerPreviewUpdate"]],[al]))}constructor(t=O.use(G),e=O.use(H)){nl(this),this.mComponent=t,this.mManager=e,this.mUnsubscribe=this.mManager.subscribe(R.Document|R.SpecialActiveFunction,()=>{this.mComponent.updater.updateAsync()})}mComponent;mManager;mUnsubscribe;get document(){return this.mManager.graph.document}set document(t){this.mManager.graph.setDocument(t)}get hasPreview(){let t=this.mManager.activeFunction,e=t.project.getFunction(t.definitionId);return e?t.project.preview.availableDisplays(e).length>0:!1}triggerPreviewUpdate(){return this.mManager.preview.execute()}onDeconstruct(){this.mUnsubscribe()}static{rl()}};var co=class extends ge{mCodeEditor;mProject;mUiManager;get document(){return this.mCodeEditor.document}set document(t){this.mCodeEditor.document=t}get project(){return this.mProject}constructor(t){super(),this.mProject=t,this.addStyle(Nr),this.addStyle(Ar),this.mUiManager=new H(t),this.setInjection(H,this.mUiManager),this.mCodeEditor=this.addContent(zo)}deconstruct(){this.mUiManager.deconstruct()}load(t){let e=JSON.parse(t);if(!Array.isArray(e.functions))throw new A("Could not load document. Document has a wrong format.",this);let i=new ne(this.mProject).deserialize(e);this.document=i}save(){let t=new ie().serialize(this.document);return JSON.stringify(t)}update(){this.mCodeEditor.triggerPreviewUpdate()}};var B=class extends at{constructor(t){super({id:t.id,label:t.label,category:t.category,regions:t.regions??null,generators:{ports:{inputs:e=>{for(let i of t.ports.inputs)e(i)},outputs:e=>{for(let i of t.ports.outputs)e(i)}},code:t.generators.code}})}};var uo=class{mDisplays;get displayIds(){return[...this.mDisplays.keys()]}constructor(){this.mDisplays=new Map}addDisplay(t){this.mDisplays.set(t.id,t)}availableDisplays(t,e=null){let i=new Array;for(let[h,d]of this.mDisplays)d.executor.function.id===t.id&&(e===null||d.allowsType(e))&&i.push(h);return i}getDisplay(t){return this.mDisplays.get(t)??null}};var ho=class{mCodeGenerator;mEntryPoint;mImports;mNodeDefinitions;mPreview;mTypes;mUserFunctions;get entryPoint(){return this.mEntryPoint}get generator(){return this.mCodeGenerator}get imports(){return this.mImports}get nodeDefinitions(){return this.mNodeDefinitions}get preview(){return this.mPreview}get types(){return this.mTypes}get userFunctions(){return this.mUserFunctions}constructor(t,e,i){this.mTypes=t,this.mCodeGenerator=i.generator,this.mPreview=new uo,this.mNodeDefinitions=new Map,this.mImports=new Array,this.mUserFunctions=new Map,this.mEntryPoint=e,this.addNodeDefinition(new K),this.addNodeDefinition(new et),this.addNodeDefinition(new xt)}addImport(t){this.mImports.push(t)}addNodeDefinition(t){this.mNodeDefinitions.set(t.id,t)}getFunction(t){return this.mEntryPoint.id===t?this.mEntryPoint:this.mUserFunctions.get(t)}setDynamicFunction(t){this.mUserFunctions.set(t.id,t)}};var fo=class{mTypes;get typeNames(){return Array.from(this.mTypes.keys())}get types(){return this.mTypes}constructor(t){this.mTypes=new Map;for(let[e,i]of Object.entries(t))this.mTypes.set(e,{name:e,...i})}getDefaultValue(t){return this.getType(t).default.value}getType(t){if(!this.mTypes.has(t))throw new Error(`Type "${t}" is not defined in the project types definition.`);return this.mTypes.get(t)}isGenericType(t){return typeof t!="string"?!1:/^<[^>]+>$/.test(t)}};var mo=class extends fo{constructor(){super({number:{default:{string:["0"],value:0},convert:t=>{let e=t[0],i=parseFloat(e);if(isNaN(i))throw new Error(`Invalid number: "${e}"`);return i.toString()},inputs:[{name:"value",type:"number"}]},string:{default:{string:[""],value:""},convert:t=>t[0],inputs:[{name:"value",type:"string"}]},boolean:{default:{string:["false"],value:!1},convert:t=>{let e=t[0].toLowerCase();if(e==="true")return"true";if(e==="false")return"false";throw new Error(`Invalid boolean: "${t[0]}"`)},inputs:[{name:"value",type:"boolean"}]}})}};var po=class extends ae{constructor(){super({id:"pixelShader",label:"Pixel Shader",statics:zt.inputs|zt.outputs,nodes:{entry:t=>{t(new B({id:"OnPixel",label:"OnPixel",category:{name:"event"},ports:{inputs:[],outputs:[{label:"exec",id:"exec",portType:"flow"},{label:"x",id:"x",portType:"value",dataType:"number"},{label:"y",id:"y",portType:"value",dataType:"number"}]},generators:{code:e=>{let i=e.outputs.x.value,h=e.outputs.y.value;return`(${i}, ${h}) => { ${e.outputs.exec.code.inner} }`}}}))},exit:t=>{t(new B({id:"PixelResult",label:"PixelResult",category:{name:"Output"},ports:{inputs:[{label:"exec",id:"exec",portType:"flow"},{label:"red",id:"red",portType:"value",dataType:"number"},{label:"green",id:"green",portType:"value",dataType:"number"},{label:"blue",id:"blue",portType:"value",dataType:"number"}],outputs:[]},generators:{code:e=>`return [${e.inputs.red.value}, ${e.inputs.green.value}, ${e.inputs.blue.value}];`}}))}},generator:{code:{body:t=>{let e=t.graphResultOf("OnPixel");return`const ${t.function.definitionId} = ${e?.code??"() => [0, 0, 0]"};`},value:t=>`${t.function.definitionId}()`}}})}};var go=class extends ae{constructor(){super({id:"Helper Function",label:"Helper Function",statics:zt.none,nodes:{entry:(t,e)=>{t(new at({id:"HelperFunctionEntry",label:"Entry",category:{name:"event"},generators:{ports:{outputs:i=>{i({label:"exec",id:"exec",portType:"flow"});for(let h of e.inputs)i({label:h.label,id:h.label,portType:"value",dataType:h.dataType})},inputs:()=>{}},code:i=>`(${Object.entries(i.outputs).filter(([d])=>d!=="exec").map(([,d])=>d.value).join(", ")}) => { ${i.outputs.exec.code.inner} }`}}))},exit:(t,e)=>{t(new at({id:"HelperFunctionReturn",label:"Return",category:{name:"event"},generators:{ports:{outputs:()=>{},inputs:i=>{i({label:"exec",id:"exec",portType:"flow"});for(let h of e.outputs)i({label:h.label,id:h.label,portType:"value",dataType:h.dataType})}},code:i=>`return { ${Object.entries(i.inputs).map(([d,v])=>`${d}: (${v.value})`).join(", ")} };`}}))}},generator:{code:{body:t=>{let e=t.function.project.generator.value.name(t.function.label),i=t.graphResultOf("HelperFunctionEntry");return`const ${e} = ${i?.code??"() => ({})"};`},value:t=>{let e=t.function.project.generator.value.name(t.function.label),i=Object.entries(t.inputs).map(([,v])=>v.value).join(", "),h=Object.entries(t.outputs).map(([v,w])=>`${v}: ${w.value}`).join(", "),d=t.outputs.Output?.code.inner??"";return h===""?`${e}(${i}); ${d}`:`const { ${h} } = ${e}(${i}); ${d}`}}}})}};var vo=class extends ho{mUserFunction;get userFunction(){return this.mUserFunction}constructor(){let t=new mo,e=new po,i=new go;super(t,e,{generator:{code:h=>{let d="";for(let v of h.dependencies)d+=`${v.code}
`;return d+=h.entryPoint.code,d},value:{id:(h,d)=>`${h}_${d}`,name:h=>{let d=h.replaceAll(/[^A-Za-z0-9_]/g,"");return/^[0-9]/.test(d)?`_${d}`:d},hook:h=>`/*[${h}]*/`}}}),this.mUserFunction=i,this.setDynamicFunction(i),this.addBaseNodeDefinitions()}addBaseNodeDefinitions(){this.addNodeDefinition(new B({id:"Add",label:"Add",category:{name:"operator"},ports:{inputs:[{label:"a",id:"a",portType:"value",dataType:"number"},{label:"b",id:"b",portType:"value",dataType:"number"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.result.value} = ${t.inputs.a.value} + ${t.inputs.b.value};`}})),this.addNodeDefinition(new B({id:"Subtract",label:"Subtract",category:{name:"operator"},ports:{inputs:[{label:"a",id:"a",portType:"value",dataType:"number"},{label:"b",id:"b",portType:"value",dataType:"number"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.result.value} = ${t.inputs.a.value} - ${t.inputs.b.value};`}})),this.addNodeDefinition(new B({id:"Multiply",label:"Multiply",category:{name:"operator"},ports:{inputs:[{label:"a",id:"a",portType:"value",dataType:"number"},{label:"b",id:"b",portType:"value",dataType:"number"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.result.value} = ${t.inputs.a.value} * ${t.inputs.b.value};`}})),this.addNodeDefinition(new B({id:"Divide",label:"Divide",category:{name:"operator"},ports:{inputs:[{label:"a",id:"a",portType:"value",dataType:"number"},{label:"b",id:"b",portType:"value",dataType:"number"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.result.value} = ${t.inputs.a.value} / ${t.inputs.b.value};`}})),this.addNodeDefinition(new B({id:"Modulo",label:"Modulo",category:{name:"operator"},ports:{inputs:[{label:"a",id:"a",portType:"value",dataType:"number"},{label:"b",id:"b",portType:"value",dataType:"number"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.result.value} = ${t.inputs.a.value} % ${t.inputs.b.value};`}})),this.addNodeDefinition(new B({id:"Equal",label:"Equal",category:{name:"operator"},ports:{inputs:[{label:"a",id:"a",portType:"value",dataType:"number"},{label:"b",id:"b",portType:"value",dataType:"number"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"boolean"}]},generators:{code:t=>`const ${t.outputs.result.value} = ${t.inputs.a.value} === ${t.inputs.b.value};`}})),this.addNodeDefinition(new B({id:"Not Equal",label:"Not Equal",category:{name:"operator"},ports:{inputs:[{label:"a",id:"a",portType:"value",dataType:"number"},{label:"b",id:"b",portType:"value",dataType:"number"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"boolean"}]},generators:{code:t=>`const ${t.outputs.result.value} = ${t.inputs.a.value} !== ${t.inputs.b.value};`}})),this.addNodeDefinition(new B({id:"Less Than",label:"Less Than",category:{name:"operator"},ports:{inputs:[{label:"a",id:"a",portType:"value",dataType:"number"},{label:"b",id:"b",portType:"value",dataType:"number"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"boolean"}]},generators:{code:t=>`const ${t.outputs.result.value} = ${t.inputs.a.value} < ${t.inputs.b.value};`}})),this.addNodeDefinition(new B({id:"Greater Than",label:"Greater Than",category:{name:"operator"},ports:{inputs:[{label:"a",id:"a",portType:"value",dataType:"number"},{label:"b",id:"b",portType:"value",dataType:"number"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"boolean"}]},generators:{code:t=>`const ${t.outputs.result.value} = ${t.inputs.a.value} > ${t.inputs.b.value};`}})),this.addNodeDefinition(new B({id:"And",label:"And",category:{name:"operator"},ports:{inputs:[{label:"a",id:"a",portType:"value",dataType:"boolean"},{label:"b",id:"b",portType:"value",dataType:"boolean"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"boolean"}]},generators:{code:t=>`const ${t.outputs.result.value} = ${t.inputs.a.value} && ${t.inputs.b.value};`}})),this.addNodeDefinition(new B({id:"Or",label:"Or",category:{name:"operator"},ports:{inputs:[{label:"a",id:"a",portType:"value",dataType:"boolean"},{label:"b",id:"b",portType:"value",dataType:"boolean"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"boolean"}]},generators:{code:t=>`const ${t.outputs.result.value} = ${t.inputs.a.value} || ${t.inputs.b.value};`}})),this.addNodeDefinition(new B({id:"Not",label:"Not",category:{name:"operator"},ports:{inputs:[{label:"a",id:"a",portType:"value",dataType:"boolean"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"boolean"}]},generators:{code:t=>`const ${t.outputs.result.value} = !${t.inputs.a.value};`}})),this.addNodeDefinition(new B({id:"Number to String",label:"Number to String",category:{name:"type-conversion"},ports:{inputs:[{label:"input",id:"input",portType:"value",dataType:"number"}],outputs:[{label:"output",id:"output",portType:"value",dataType:"string"}]},generators:{code:t=>`const ${t.outputs.output.value} = String(${t.inputs.input.value});`}})),this.addNodeDefinition(new B({id:"String to Number",label:"String to Number",category:{name:"type-conversion"},ports:{inputs:[{label:"input",id:"input",portType:"value",dataType:"string"}],outputs:[{label:"output",id:"output",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.output.value} = Number(${t.inputs.input.value});`}})),this.addNodeDefinition(new B({id:"Boolean to String",label:"Boolean to String",category:{name:"type-conversion"},ports:{inputs:[{label:"input",id:"input",portType:"value",dataType:"boolean"}],outputs:[{label:"output",id:"output",portType:"value",dataType:"string"}]},generators:{code:t=>`const ${t.outputs.output.value} = String(${t.inputs.input.value});`}})),this.addNodeDefinition(new B({id:"If",label:"If",category:{name:"flow"},ports:{inputs:[{label:"exec",id:"exec",portType:"flow"},{label:"condition",id:"condition",portType:"value",dataType:"boolean"}],outputs:[{label:"then",id:"then",portType:"flow"},{label:"else",id:"else",portType:"flow"}]},generators:{code:t=>`if (${t.inputs.condition.value}) {
${t.outputs.then.code.inner}
} else {
${t.outputs.else.code.inner}
}`}})),this.addNodeDefinition(new B({id:"While",label:"While",category:{name:"flow"},ports:{inputs:[{label:"exec",id:"exec",portType:"flow"},{label:"condition",id:"condition",portType:"value",dataType:"boolean"}],outputs:[{label:"body",id:"body",portType:"flow"}]},generators:{code:t=>`while (${t.inputs.condition.value}) {
${t.outputs.body.code.inner}
}`}})),this.addNodeDefinition(new B({id:"For Loop",label:"For Loop",category:{name:"flow"},ports:{inputs:[{label:"exec",id:"exec",portType:"flow"},{label:"count",id:"count",portType:"value",dataType:"number"}],outputs:[{label:"exec",id:"exec",portType:"flow"},{label:"index",id:"index",portType:"value",dataType:"number"}]},generators:{code:t=>`for (let ${t.outputs.index.value} = 0; ${t.outputs.index.value} < ${t.inputs.count.value}; ${t.outputs.index.value}++) {
${t.outputs.exec.code.inner}
}`}})),this.addNodeDefinition(new B({id:"Console Log",label:"Console Log",category:{name:"Function"},ports:{inputs:[{label:"message",id:"message",portType:"value",dataType:"string"}],outputs:[]},generators:{code:t=>`console.log(${t.inputs.message.value});`}})),this.addNodeDefinition(new B({id:"String Concat",label:"String Concat",category:{name:"Function"},ports:{inputs:[{label:"a",id:"a",portType:"value",dataType:"string"},{label:"b",id:"b",portType:"value",dataType:"string"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"string"}]},generators:{code:t=>`const ${t.outputs.result.value} = ${t.inputs.a.value} + ${t.inputs.b.value};`}}))}};var ue=class{mId;mLabel;mNodes;get id(){return this.mId}get label(){return this.mLabel}get nodes(){return this.mNodes}constructor(t,e){this.mId=t,this.mLabel=e,this.mNodes=new Array}addNode(t){this.mNodes.push(t)}};var yo=class extends ue{constructor(){super("Math","Math"),this.addNode(new B({id:"Math.PI",label:"Math.PI",category:{name:"value"},ports:{inputs:[],outputs:[{label:"value",id:"value",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.value.value} = Math.PI;`}})),this.addNode(new B({id:"Math.E",label:"Math.E",category:{name:"value"},ports:{inputs:[],outputs:[{label:"value",id:"value",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.value.value} = Math.E;`}})),this.addNode(new B({id:"Math.abs",label:"Math.abs",category:{name:"Function"},ports:{inputs:[{label:"value",id:"value",portType:"value",dataType:"number"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.result.value} = Math.abs(${t.inputs.value.value});`}})),this.addNode(new B({id:"Math.floor",label:"Math.floor",category:{name:"Function"},ports:{inputs:[{label:"value",id:"value",portType:"value",dataType:"number"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.result.value} = Math.floor(${t.inputs.value.value});`}})),this.addNode(new B({id:"Math.ceil",label:"Math.ceil",category:{name:"Function"},ports:{inputs:[{label:"value",id:"value",portType:"value",dataType:"number"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.result.value} = Math.ceil(${t.inputs.value.value});`}})),this.addNode(new B({id:"Math.random",label:"Math.random",category:{name:"Function"},ports:{inputs:[],outputs:[{label:"result",id:"result",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.result.value} = Math.random();`}})),this.addNode(new B({id:"Math.sin",label:"Math.sin",category:{name:"Function"},ports:{inputs:[{label:"value",id:"value",portType:"value",dataType:"number"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.result.value} = Math.sin(${t.inputs.value.value});`}})),this.addNode(new B({id:"Math.cos",label:"Math.cos",category:{name:"Function"},ports:{inputs:[{label:"value",id:"value",portType:"value",dataType:"number"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.result.value} = Math.cos(${t.inputs.value.value});`}})),this.addNode(new B({id:"Math.min",label:"Math.min",category:{name:"Function"},ports:{inputs:[{label:"a",id:"a",portType:"value",dataType:"number"},{label:"b",id:"b",portType:"value",dataType:"number"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.result.value} = Math.min(${t.inputs.a.value}, ${t.inputs.b.value});`}})),this.addNode(new B({id:"Math.max",label:"Math.max",category:{name:"Function"},ports:{inputs:[{label:"a",id:"a",portType:"value",dataType:"number"},{label:"b",id:"b",portType:"value",dataType:"number"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.result.value} = Math.max(${t.inputs.a.value}, ${t.inputs.b.value});`}})),this.addNode(new B({id:"Math.clamp",label:"Math.clamp",category:{name:"Function"},ports:{inputs:[{label:"value",id:"value",portType:"value",dataType:"number"},{label:"min",id:"min",portType:"value",dataType:"number"},{label:"max",id:"max",portType:"value",dataType:"number"}],outputs:[{label:"result",id:"result",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.result.value} = Math.min(Math.max(${t.inputs.value.value}, ${t.inputs.min.value}), ${t.inputs.max.value});`}}))}};var bo=class extends ue{constructor(){super("Time","Time"),this.addNode(new B({id:"CurrentTime",label:"CurrentTime",category:{name:"value"},ports:{inputs:[],outputs:[{label:"seconds",id:"seconds",portType:"value",dataType:"number"}]},generators:{code:t=>`const ${t.outputs.seconds.value} = (performance.now() / 1000);`}}))}};var wo=class{mCachedCallable;mDisplay;mElement;mSpecifiedParameters;mTarget;get display(){return this.mDisplay}get element(){return this.mElement||(this.mElement=this.mDisplay.generate()),this.mElement}constructor(t,e){this.mDisplay=t,this.mTarget=e,this.mCachedCallable=null,this.mElement=null,this.mSpecifiedParameters={...this.mDisplay.executor.defaultParameters}}execute(){this.mCachedCallable&&this.mDisplay.update(this.element,this.mCachedCallable)}refresh(){let t=this.mTarget instanceof it?this.mTarget.node.function:this.mTarget,e=(()=>{try{return new ce(t.project).generateFunction(t,!0)}catch{return null}})();if(!e){this.mCachedCallable=null;return}let i=null;if(this.mTarget instanceof it&&(i=this.resolvePortTarget(e,this.mTarget),!i)){this.mCachedCallable=null;return}let h=this.mDisplay.executor.compile(e,i);if(!this.mDisplay.allowsType(h.type)){this.mCachedCallable=null;return}let d=this.mDisplay.adapterFor(h.type);this.mCachedCallable=v=>d(h.execute({...this.mDisplay.executor.defaultParameters,...this.mSpecifiedParameters,...v}))}specifyParameters(t){this.mSpecifiedParameters={...this.mSpecifiedParameters,...t}}resolvePortTarget(t,e){let[i,h]=(()=>{for(let v of t.entryPoint.graphs)if(v.ports.has(e)&&v.nodes.has(e.node))return[v.ports.get(e),v.nodes.get(e.node)];return[null,null]})();if(!i||!h)return null;let d=e.direction==="input"?"start":"end";return{documentPort:e,nodeHook:e.project.generator.value.hook(`${d}-${h}`),value:i}}};var he=class{mExecutor;mGenerate;mId;mName;mTypeAdapters;mUpdate;get executor(){return this.mExecutor}get id(){return`${this.mId}-${this.mExecutor.function.id}`}get name(){return this.mName}constructor(t,e){this.mId=e.id,this.mName=e.name,this.mExecutor=t,this.mGenerate=e.generate,this.mUpdate=e.update,this.mTypeAdapters=new Map;for(let[i,h]of Object.entries(e.typeAdapter))this.mExecutor.types.has(i)&&this.mTypeAdapters.set(i,h)}adapterFor(t){let e=t;if(!this.mTypeAdapters.has(e))throw new A(`Display "${this.mId}" has no type adapter for type "${t}".`,this);return this.mTypeAdapters.get(e)}allowsType(t){return this.mTypeAdapters.has(t)}createDriver(t){return new wo(this,t)}generate(){return this.mGenerate()}update(t,e){return this.mUpdate(t,e)}};var Ne=class y extends he{static MATRIX_SIZE=3;static VALUE_LENGTH=5;constructor(t){super(t,{id:"matrix",name:"Matrix 3x3",generate:()=>{let e=document.createElement("div");return e.style.boxSizing="border-box",e.style.display="grid",e.style.gap="2px",e.style.gridTemplateColumns=`repeat(${y.MATRIX_SIZE}, minmax(0, 1fr))`,e.style.height="100%",e.style.width="100%",e.style.fontFamily="var(--potatno-font-family)",e.style.fontSize="var(--potatno-font-size-small)",e.style.color="#fff",e},typeAdapter:{[ht.MAIN]:e=>e.map(i=>this.formatPreviewValue(i)),number:e=>[this.formatPreviewValue(e)],string:e=>[this.formatPreviewValue(e)],boolean:e=>[this.formatPreviewValue(e)]},update:async(e,i)=>{await this.updateMatrixPreview(e,i)}})}formatPreviewValue(t){if(typeof t=="number"){if(!Number.isFinite(t))return t.toString().slice(0,y.VALUE_LENGTH);let e=Math.trunc(Math.abs(t)).toString().length,i=Math.max(0,y.VALUE_LENGTH-e-(t<0?1:0)-1);return t.toFixed(i).slice(0,y.VALUE_LENGTH)}return String(t).slice(0,y.VALUE_LENGTH)}async updateMatrixPreview(t,e){for(;t.children.length<y.MATRIX_SIZE*y.MATRIX_SIZE;){let i=document.createElement("div");i.style.alignItems="center",i.style.background="var(--potatno-color-background-dark)",i.style.border="1px solid var(--potatno-color-border)",i.style.boxSizing="border-box",i.style.color="var(--potatno-color-text)",i.style.display="flex",i.style.justifyContent="center",i.style.minWidth="0",i.style.overflow="hidden",i.style.padding="2px",i.style.textOverflow="clip",i.style.whiteSpace="pre-line",t.append(i)}for(let i=0;i<y.MATRIX_SIZE;i++)for(let h=0;h<y.MATRIX_SIZE;h++){let d=i*y.MATRIX_SIZE+h,v=y.MATRIX_SIZE===1?0:h/(y.MATRIX_SIZE-1),w=y.MATRIX_SIZE===1?0:i/(y.MATRIX_SIZE-1),D=e({x:v,y:w});t.children[d].textContent=D.join(`
`)}}};var Le=class y extends he{static PREVIEW_PIXEL_SIZE=7.5;mCanvasContext;mCanvasImageData;constructor(t){super(t,{id:"2dCanvas",name:"Canvas 2D",generate:()=>{let e=document.createElement("canvas");return e.style.width="100%",e.style.height="100%",e.style.imageRendering="pixelated",e},typeAdapter:{[ht.MAIN]:e=>e,number:e=>[e,e,e],boolean:e=>{let i=e?1:0;return[i,i,i]}},update:async(e,i)=>{await this.updateCanvasPreview(e,i)}}),this.mCanvasImageData=new WeakMap,this.mCanvasContext=new WeakMap}async updateCanvasPreview(t,e){this.mCanvasContext.has(t)||this.mCanvasContext.set(t,t.getContext("2d"));let i=this.mCanvasContext.get(t),h=Math.max(1,Math.round(t.clientWidth/y.PREVIEW_PIXEL_SIZE)),d=Math.max(1,Math.round(t.clientHeight/y.PREVIEW_PIXEL_SIZE));(t.width!==h||t.height!==d||!this.mCanvasImageData.has(t))&&(t.width=h,t.height=d,this.mCanvasImageData.set(t,i.createImageData(h,d)));let v=this.mCanvasImageData.get(t),w=v.data;for(let D=0;D<d;D++)for(let S=0;S<h;S++){let l=S/h,r=D/d,u=e({x:l,y:r}),c=(D*h+S)*4;w[c]=Math.floor(Math.max(0,Math.min(1,u[0]||0))*255),w[c+1]=Math.floor(Math.max(0,Math.min(1,u[1]||0))*255),w[c+2]=Math.floor(Math.max(0,Math.min(1,u[2]||0))*255),w[c+3]=255}i.putImageData(v,0,0)}};var _t=new vo;_t.addImport(new yo);_t.addImport(new bo);var ul=new ht(_t.entryPoint,{defaultParameters:{x:0,y:0},types:[ht.MAIN,"number","string","boolean"],build:(y,t,e)=>{let i=t.code,h=y.function.id;if(!e){let w=new Function(`${i}
return ${h};`)();return{type:ht.MAIN,execute:D=>w(D.x,D.y)}}let d=i.replace(e.nodeHook,`; return ${e.value};`),v=new Function(`${d}
return ${h};`)();return{type:e.documentPort.resolvedDataType,execute:w=>v(w.x,w.y)}}}),hl=new ht(_t.userFunction,{defaultParameters:{x:0,y:0},types:["number","string","boolean"],build:(y,t,e)=>{if(!e)return{type:"number",execute:()=>0};let i=t.entryPoint.function,h=i.project.generator.value.name(i.label),d=i.inputs.map(D=>y.projectTypes.getDefaultValue(D.dataType)),v=t.code.replace(e.nodeHook,`return ${e.value};`),w=new Function(`${v}
return ${h};`)();return{type:e.documentPort.resolvedDataType,execute:()=>w(...d)}}});_t.preview.addDisplay(new Le(ul));_t.preview.addDisplay(new Le(hl));_t.preview.addDisplay(new Ne(ul));_t.preview.addDisplay(new Ne(hl));var Xc=document.getElementById("application-root"),Re=new co(_t);Re.appendTo(Xc);Re.document=new Vt(_t);fl();function fl(){try{Re.update()}catch(y){}requestAnimationFrame(fl)}document.getElementById("load-button").addEventListener("click",Zc);document.getElementById("save-button").addEventListener("click",qc);var xo=document.getElementById("font-size-slider"),Yc=document.getElementById("font-size-value"),Wc=16,ml=()=>{let y=Math.round(parseFloat(xo.value)/Wc*100);Yc.textContent=`${y}%`};xo.value=parseFloat(getComputedStyle(document.documentElement).fontSize).toString();ml();xo.addEventListener("input",()=>{document.documentElement.style.fontSize=`${xo.value}px`,ml()});var dl="potatno-code-document.json";async function Zc(){if(window.confirm("Load saved document?"))try{let i=await(await(await navigator.storage.getDirectory()).getFileHandle(dl)).getFile();Re.load(await i.text())}catch{window.alert("Could not load document.")}}async function qc(){if(window.confirm("Override saved document?"))try{let i=await(await(await navigator.storage.getDirectory()).getFileHandle(dl,{create:!0})).createWritable();await i.write(Re.save()),await i.close()}catch{window.alert("Could not save document.")}}(()=>{let y=window.location.protocol==="https:"?"wss":"ws",t=new WebSocket(`${y}://${window.location.host}`);t.addEventListener("open",()=>{console.log("Refresh connection established")}),t.addEventListener("message",e=>{e.data==="REFRESH"&&(console.log("Bundle finished. Start refresh"),window.location.reload())})})();})();
