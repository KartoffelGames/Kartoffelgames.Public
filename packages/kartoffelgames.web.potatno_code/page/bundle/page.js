...
potatno-code-editor {\r
    ...
    width: 100%;\r
    height: 100%;\r
}`;var ne=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new jt(this.mProject),r=[];for(let u of t.functions){let m=this.deserializeFunctionHead(u,e);r.push([m,u]),e.addFunction(m)}for(let[u,m]of r)this.deserializeFunctionBody(u,m,e);return e}deserializeFunctionBody(t,e,r){let u=new Map;for(let m of e.nodes)u.set(m.id,this.deserializeNode(m,t,r));for(let m of e.connections){if(!u.has(m.sourceNodeId)||!u.has(m.targetNodeId))continue;let y=u.get(m.sourceNodeId),w=u.get(m.targetNodeId),D=y.outputs.map.get(m.sourcePortId),S=w.inputs.map.get(m.targetPortId);!D||!S||D.connect(S)}}deserializeFunctionHead(t,e){let r=new at(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let u of t.imports)r.addImport(u);for(let u of t.inputs)r.addInput({label:u.label,dataType:u.dataType});for(let u of t.outputs)r.addOutput({label:u.label,dataType:u.dataType});return r}deserializeNode(t,e,r){let u=r.nodeDefinitions.find(y=>y.id===t.definitionId),m=(()=>{if(u)return e.addNodeByDefinition(u,t.transformation);let y=t.ports.filter(D=>D.direction==="input").map(D=>({dataType:D.dataType,definitionId:D.definitionId,label:D.label,portType:D.portType})),w=t.ports.filter(D=>D.direction==="output").map(D=>({dataType:D.dataType,definitionId:D.definitionId,label:D.label,portType:D.portType}));return new dt(this.mProject,r,e,{definitionId:t.definitionId,ports:{input:y,output:w},label:t.label,transformation:{...t.transformation}})})();m.label=t.label,e.addNode(m);for(let y of t.ports)if(y.portType==="value"&&y.directValue.length>0){let w=m.inputs.map.get(y.definitionId);w&&w.setDirectValue(y.directValue)}return m.preview=t.preview??null,m}};var ie=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((w,D)=>{e.set(w,`n${D}`)});let r=[...t.nodes].map(w=>this.serializeNode(w,e.get(w))),u=[];for(let w of t.nodes){let D=e.get(w);for(let S of w.outputs.list)for(let l of S.connectedPorts){let n=e.get(l.node);u.push({sourceNodeId:D,sourcePortId:S.definitionId,targetNodeId:n,targetPortId:l.definitionId})}}let m=t.inputs.map(w=>({label:w.label,dataType:w.dataType})),y=t.outputs.map(w=>({label:w.label,dataType:w.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:m,outputs:y,imports:[...t.imports],nodes:r,connections:u}}serializeNode(t,e){let r=[...t.inputs.list,...t.outputs.list].map(m=>({definitionId:m.definitionId,label:m.label,direction:m.direction,portType:m.portType,dataType:m.portType==="value"?m.dataType:null,directValue:[...m.directValue]})),u=t.preview?{portDefinitionId:t.preview.portDefinitionId,displayId:t.preview.displayId}:null;return{id:e,definitionId:t.definitionId,label:t.label,transformation:{...t.transformation},ports:r,preview:u}}};var Cr=`:host {\r
    /* Globals */\r
...
`;function za(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,T,x){var d;switch(o){case 1:d="accessor";break;case 2:d="method";break;case 3:d="getter";break;case 4:d="setter";break;default:d="field"}var s={kind:d,name:p?"#"+n:n,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,b,p,T,x){var d=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof d=="function")a=t(d,c,s,T,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=d.length-1;E>=0;E--){var g=d[E];if(a=t(g,c,s,T,o,b,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<n.length;x++){var d=n[x];if(Array.isArray(d)){var s=d[1],f=d[2],i=d.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,b=b||[],P=b):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}m(c,C,d,f,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var d=0;d<c.length;d++)c[d].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function yn(v,t,e,r){return(yn=za())(v,t,e,r)}var bn,mn,wn,xn,dn,pn,gn,xo;bn=B({selector:"potatno-function-list",template:fn,style:hn,components:[Mt,se,Ht]}),wn=$.state({complexValue:!0}),xn=$.state();var vn=class{static{({e:[dn,pn,gn],c:[xo,mn]}=yn(this,[[wn,1,"documentFunctions"],[xn,1,"showPopup"]],[bn]))}constructor(t=O.use(Y)){this.mManager=t,this.documentFunctions=new Array,this.showPopup=!1,this.mUnsubscribe=this.mManager.subscribe(R.Document|R.Function|R.SpecialActiveFunction,()=>{this.documentFunctions=this.mManager.graph.document.functions.map(e=>({id:e.id,label:e.label,isSystem:e.isSystem,function:e}))})}mManager;mUnsubscribe;#t=(gn(this),dn(this));get documentFunctions(){return this.#t}set documentFunctions(t){this.#t=t}#e=pn(this);get showPopup(){return this.#e}set showPopup(t){this.#e=t}get activeFunctionId(){return this.mManager.activeFunction.id}get userFunctionDefinitions(){return[...this.mManager.project.userFunctions.values()]}createFunction(t){this.showPopup=!1,this.mManager.graph.addFunction(t.id)}deleteFunction(t){this.mManager.graph.removeFunction(t.id)}onDeconstruct(){this.mUnsubscribe()}selectFunction(t){this.mManager.setActiveFunction(t.function)}static{mn()}};var Tn=`:host {\r
    position: absolute;\r
    z-index: 200;\r
\r
...
`;function $a(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,T,x){var d;switch(o){case 1:d="accessor";break;case 2:d="method";break;case 3:d="getter";break;case 4:d="setter";break;default:d="field"}var s={kind:d,name:p?"#"+n:n,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,b,p,T,x){var d=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof d=="function")a=t(d,c,s,T,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=d.length-1;E>=0;E--){var g=d[E];if(a=t(g,c,s,T,o,b,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<n.length;x++){var d=n[x];if(Array.isArray(d)){var s=d[1],f=d[2],i=d.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,b=b||[],P=b):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}m(c,C,d,f,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var d=0;d<c.length;d++)c[d].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function An(v,t,e,r){return(An=$a())(v,t,e,r)}function Ga(v){return v}var Ln,En,Rn,On,Fn,zn,jn,Vn,In,Cn,Pn,Mn,Sn,_n,Nn,ae;Ln=B({selector:"potatno-node-selection-popup",template:Dn,style:Tn,components:[se]}),Rn=$.state({complexValue:!0}),On=$.state({complexValue:!0}),Fn=yt("searchInput"),zn=vt("node-select"),jn=$.state(),Vn=$.state();new class extends Ga{constructor(){super(ae),En()}static{class v{static{({e:[In,Cn,Pn,Mn,Sn,_n,Nn],c:[ae,En]}=An(this,[[[H,Rn],1,"contextport"],[On,1,"results"],[Fn,1,"searchInput"],[zn,1,"mNodeSelect"],[jn,1,"searchValue"],[Vn,1,"selectedDefinitionId"]],[Ln]))}static POPUP_HEIGHT=320;static POPUP_WIDTH=280;mAvailableEntries;mComponent;mManager;#t=(Nn(this),In(this));get contextport(){return this.#t}set contextport(e){this.#t=e}#e=Cn(this);get results(){return this.#e}set results(e){this.#e=e}#o=Pn(this);get searchInput(){return this.#o}set searchInput(e){this.#o=e}#r=Mn(this);get mNodeSelect(){return this.#r}set mNodeSelect(e){this.#r=e}#n=Sn(this);get searchValue(){return this.#n}set searchValue(e){this.#n=e}#i=_n(this);get selectedDefinitionId(){return this.#i}set selectedDefinitionId(e){this.#i=e}constructor(e=O.use(G),r=O.use(Y)){this.mManager=r,this.mComponent=e,this.mAvailableEntries=this.fetchNodeEntries(),this.selectedDefinitionId=null,this.results=new Array,this.searchValue="",this.contextport=null}onConnect(){this.searchInput?.focus()}onKeyDown(e){if(this.results.length!==0){if(e.key==="ArrowDown"||e.key==="ArrowUp"){e.preventDefault();let r=this.results.findIndex(y=>y.definition.id===this.selectedDefinitionId);r=Math.max(0,r);let u=e.key==="ArrowDown"?1:-1,m=(r+u+this.results.length)%this.results.length;this.selectedDefinitionId=this.results[m].definition.id;return}e.key==="Enter"&&this.sendSelectedEntry(this.selectedDefinitionId)}}onUpdate(){this.results=this.filterResults(),this.results.some(r=>r.definition.id===this.selectedDefinitionId)||(this.selectedDefinitionId=this.results[0]?.definition.id??null);let e=this.mComponent.element.shadowRoot.querySelector(".selection-popup__result.selected");e&&e.scrollIntoView()}stopPropagation(e,r){e.stopPropagation(),r&&e.preventDefault()}fetchNodeEntries(){return this.mManager.activeFunction.dynamicNodeDefinitions.map(e=>({category:e.category.name,definition:e,label:e.label.toLowerCase(),color:this.mManager.generateStringColor(e.category.name),icon:e.category.icon}))}filterResults(){let e=this.searchValue.trim().toLowerCase();return this.mAvailableEntries.filter(r=>r.label.includes(e))}sendSelectedEntry(e){if(e===null)return;let r=this.results.find(u=>u.definition.id===e);r&&this.mNodeSelect.dispatchEvent(r.definition)}}}};var $n=`:host {\r
...
`;function ka(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,T,x){var d;switch(o){case 1:d="accessor";break;case 2:d="method";break;case 3:d="getter";break;case 4:d="setter";break;default:d="field"}var s={kind:d,name:p?"#"+n:n,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,b,p,T,x){var d=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof d=="function")a=t(d,c,s,T,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=d.length-1;E>=0;E--){var g=d[E];if(a=t(g,c,s,T,o,b,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<n.length;x++){var d=n[x];if(Array.isArray(d)){var s=d[1],f=d[2],i=d.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,b=b||[],P=b):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}m(c,C,d,f,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var d=0;d<c.length;d++)c[d].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function Oi(v,t,e,r){return(Oi=ka())(v,t,e,r)}var Fi,Ni,zi,Ai,Li,Co;Fi=B({selector:"potatno-connection-layer",template:_i,style:Si}),zi=$.state({complexValue:!0});var Ri=class{static{({e:[Ai,Li],c:[Co,Ni]}=Oi(this,[[zi,1,"connections"]],[Fi]))}constructor(t=O.use(Y)){this.mManager=t,this.connections=new Map;let e=0;this.mUnsubscribe=this.mManager.subscribe(R.SpecialActiveFunction|R.Node|R.Connection,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.updateConnections()}))})}mManager;mUnsubscribe;#t=(Li(this),Ai(this));get connections(){return this.#t}set connections(t){this.#t=t}createConjunction(t,e){t.preventDefault(),t.stopPropagation();let r=e.port.output.portType==="flow"?this.mManager.project.nodeDefinitions.get(K.DEFINITION_ID):this.mManager.project.nodeDefinitions.get(et.DEFINITION_ID),u=this.mManager.grid.pixelToGridSpace(t.clientX,t.clientY),m=this.mManager.graph.addNode(this.mManager.activeFunction,r,{x:u.x,y:u.y,height:0,width:0});this.mManager.graph.disconnectPorts(e.port.output,e.port.input);let y=m.inputs.list[0],w=m.outputs.list[0];this.mManager.graph.connectPorts(y,e.port.output),this.mManager.graph.connectPorts(y,e.port.input),this.mManager.graph.connectPorts(w,e.port.output),this.mManager.graph.connectPorts(w,e.port.input)}deleteConnection(t,e){t.button===2&&(t.preventDefault(),t.stopPropagation(),this.mManager.graph.disconnectPorts(e.port.output,e.port.input))}onDeconstruct(){this.mUnsubscribe()}createConnection(t,e,r){let u=this.mManager.integrity.errorItems,m=u.has(e)||u.has(r),y=(()=>{switch(r.portType){case"value":return r;case"flow":return e}})(),w=e.portType==="flow"?"":this.mManager.generateStringColor(e.resolvedDataType),D=this.mManager.connections.getConnectionPath(e,r);return{color:w,path:{attributeValue:D.attributeValue,length:D.length},state:{isNew:!t.has(y),hasError:m},port:{primary:y,output:e,input:r}}}updateConnections(){let t=this.connections;this.connections=new Map;for(let e of this.mManager.activeFunction.nodes)for(let r of e.outputs.list)for(let u of r.connectedPorts){let m=this.createConnection(t,r,u);this.connections.set(m.port.primary,m)}}static{Ni()}};function tl(){function v(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,T,x){var d;switch(o){case 1:d="accessor";break;case 2:d="method";break;case 3:d="getter";break;case 4:d="setter";break;default:d="field"}var s={kind:d,name:p?"#"+n:n,static:b,private:p,metadata:T},f={v:!1};s.addInitializer=v(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,b,p,T,x){var d=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof d=="function")a=t(d,c,s,T,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=d.length-1;E>=0;E--){var g=d[E];if(a=t(g,c,s,T,o,b,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,_!==void 0&&(f===void 0?f=_:typeof f=="function"?f=[f,_]:f.push(_))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function y(l,n,h){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<n.length;x++){var d=n[x];if(Array.isArray(d)){var s=d[1],f=d[2],i=d.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,b=b||[],P=b):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}m(c,C,d,f,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:v(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var d=0;d<c.length;d++)c[d].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=y(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function $i(v,t,e,r){return($i=tl())(v,t,e,r)}var Gi,ji,_e;Gi=It({access:q.Read,selector:/^potatno-preview$/});var Vi=class{static{({c:[_e,ji]}=$i(this,[],[Gi]))}constructor(t=O.use(k),e=O.use(W),r=O.use(it)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(r.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let r=this.mTarget.childNodes.length>0;return r&&(this.mTarget.innerHTML=""),r}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{ji()}};var Bi=`:host {\r
    --node-border-radius: 2px;\r
    --node-border-color: color-mix(in srgb, var(--potatno-color-text) 30%, var(--potatno-color-background));\r
