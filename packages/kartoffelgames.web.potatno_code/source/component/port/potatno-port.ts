...
export class PotatnoPortComponent extends Processor {
    ...
    private getTypeColor(pType: string): string {
        ...
        // Use golden angle (137.5°) steps for maximum hue separation.
