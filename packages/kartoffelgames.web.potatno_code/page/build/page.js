...
`;var bo=`<potatno-resize-box class="resize-box" right="true">\r
    <div class="function-list-content">\r
        $for(functionItem of this.documentFunctions) {\r
            <div class="function-entry {{ this.functionItem.id === this.activeFunctionId ? 'function-entry active' : '' }}" (click)="this.selectFunction(this.functionItem)">\r
                <span class="function-icon">\r
...
\r
                <span class="function-name">{{this.functionItem.label}}</span>\r
\r
                $if(!this.functionItem.isSystem) {\r
                    <button class="delete-button" (click)="this.deleteFunction(this.functionItem)">\u2715</button>\r
                }\r
            </div>\r
        }\r
    </div>\r
\r
    $if(this.userFunctionDefinitions.length > 0) {\r
        <div class="add-button-wrapper">\r
            <button class="add-button" (click)="this.showPopup = !this.showPopup">\r
                <span class="add-icon">+</span>\r
                <span>Add Function</span>\r
            </button>\r
\r
            $if(this.showPopup) {\r
                <div class="popup-overlay" (click)="this.showPopup = !this.showPopup"></div>\r
                <div class="popup">\r
                    <div class="popup-header">Select Function Type</div>\r
                    $for(functionDefinition of this.userFunctionDefinitions) {\r
                        <button class="popup-item" (click)="this.createFunction(this.functionDefinition)">\r
                            <span class="function-icon">f</span>\r
                            <span>{{this.functionDefinition.label}}</span>\r
                        </button>\r
                    }\r
                </div>\r
            }\r
