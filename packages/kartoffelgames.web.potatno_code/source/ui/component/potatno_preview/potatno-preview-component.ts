...
import { KgButtonComponent, KgListItemComponent, KgResizeBoxComponent } from '@kartoffelgames/web-components';
...
@PwbComponent({
    ...
    components: [KgResizeBoxComponent, KgButtonComponent, KgListItemComponent]
})
