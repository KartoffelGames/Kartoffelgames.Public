...
}`;var zr=`<div class="resize-layer {{this.snap > 1 ? 'snap' : ''}}" style="width: {{this.transformation.width}}px; height: {{this.transformation.height}}px;">\r
    \r
...
}`;var fn=`<!-- Resizeable part of node -->\r
...
}`;var Xi=`<potatno-resize-box class="resize-box" left="true">\r
\r
    <!-- Function name -->\r
    <div class="section">\r
