...
`;(function(f){f.Function="function",f.Comment="comment",f.Input="input",f.Output="output",f.Reroute="reroute"})(nt||(nt={}));var At=class f{static META={[nt.Function]:{icon:"f",cssColor:"var(--pn-accent-blue)",label:"Function"},[nt.Comment]:{icon:"\u{1F4AC}",cssColor:"var(--pn-accent-yellow)",label:"Comment"},[nt.Input]:{icon:"\u2192",cssColor:"var(--pn-accent-green)",label:"Input"},[nt.Output]:{icon:"\u2190",cssColor:"var(--pn-accent-red)",label:"Output"},[nt.Reroute]:{icon:"\u25C7",cssColor:"var(--pn-text-muted)",label:"Reroute"}};static get(t){let e=f.META[t];return e||{icon:"\u25C6",cssColor:`hsl(${f.hashStringToHue(t)}, 60%, 55%)`,label:t.charAt(0).toUpperCase()+t.slice(1)}}static hashStringToHue(t){let e=0;for(let o=0;o<t.length;o++)e=(e<<5)-e+t.charCodeAt(o),e=e&e;return Math.abs(e)%360}},nt;var Eo=`:host {
    position: absolute;
    z-index: 1500;
}
...
`;var nn=`<div #portWrapper [className]="this.portWrapperClasses" [title]="this.portTypeLabel" style="--port-color: {{this.portColor}}" (pointerdown)="this.onPointerDown($event)">
    <div [className]="this.portHandleClasses"></div>
...
`;var si=`<div class="resize-handle" (pointerdown)="this.onResizePointerDown($event)"></div>
