...
export class TwoWayBindingAttributeModule implements IPwbAttributeModuleOnUpdate {
     ...
     */
    public constructor(pTargetReference: ModuleTargetNode, pValueReference: ComponentValuesReference, pAttributeReference: ModuleAttributeReference, pComponentManagerReference: ComponentManagerReference) {
