...
potatno-code-editor {\r
    ...
    width: 100%;\r
    height: 100%;\r
}`;var ne=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new Vt(this.mProject),r=[];for(let u of t.functions){let m=this.deserializeFunctionHead(u,e);r.push([m,u]),e.addFunction(m)}for(let[u,m]of r)this.deserializeFunctionBody(u,m,e);return e}deserializeFunctionBody(t,e,r){let u=new Map;for(let m of e.nodes)u.set(m.id,this.deserializeNode(m,t,r));for(let m of e.connections){if(!u.has(m.sourceNodeId)||!u.has(m.targetNodeId))continue;let v=u.get(m.sourceNodeId),w=u.get(m.targetNodeId),D=v.outputs.map.get(m.sourcePortId),S=w.inputs.map.get(m.targetPortId);!D||!S||D.connect(S)}}deserializeFunctionHead(t,e){let r=new lt(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let u of t.imports)r.addImport(u);for(let u of t.inputs)r.addInput({label:u.label,dataType:u.dataType});for(let u of t.outputs)r.addOutput({label:u.label,dataType:u.dataType});return r}deserializeNode(t,e,r){let u=r.nodeDefinitions.find(v=>v.id===t.definitionId),m=(()=>{if(u)return e.addNodeByDefinition(u,t.transformation);let v=t.ports.filter(D=>D.direction==="input").map(D=>({dataType:D.dataType,definitionId:D.definitionId,label:D.label,portType:D.portType})),w=t.ports.filter(D=>D.direction==="output").map(D=>({dataType:D.dataType,definitionId:D.definitionId,label:D.label,portType:D.portType}));return new pt(this.mProject,r,e,{definitionId:t.definitionId,ports:{input:v,output:w},label:t.label,transformation:{...t.transformation}})})();m.label=t.label,e.addNode(m);for(let v of t.ports)if(v.portType==="value"&&v.directValue.length>0){let w=m.inputs.map.get(v.definitionId);w&&w.setDirectValue(v.directValue)}return m.preview=t.preview??null,m}};var ie=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((w,D)=>{e.set(w,`n${D}`)});let r=[...t.nodes].map(w=>this.serializeNode(w,e.get(w))),u=[];for(let w of t.nodes){let D=e.get(w);for(let S of w.outputs.list)for(let l of S.connectedPorts){let n=e.get(l.node);u.push({sourceNodeId:D,sourcePortId:S.definitionId,targetNodeId:n,targetPortId:l.definitionId})}}let m=t.inputs.map(w=>({label:w.label,dataType:w.dataType})),v=t.outputs.map(w=>({label:w.label,dataType:w.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:m,outputs:v,imports:[...t.imports],nodes:r,connections:u}}serializeNode(t,e){let r=[...t.inputs.list,...t.outputs.list].map(m=>({definitionId:m.definitionId,label:m.label,direction:m.direction,portType:m.portType,dataType:m.portType==="value"?m.dataType:null,directValue:[...m.directValue]})),u=t.preview?{portDefinitionId:t.preview.portDefinitionId,displayId:t.preview.displayId}:null;return{id:e,definitionId:t.definitionId,label:t.label,transformation:{...t.transformation},ports:r,preview:u}}};var Nr=`:host {   \r
    /* Font */\r
...
}`;var Lr=`<div class="button">\r
    $slot\r
</div>\r
`;function Rl(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,T,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:b,private:p,metadata:T},d={v:!1};s.addInitializer=y(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var I=i;i=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,b,p,T,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,I,P;if(typeof f=="function")a=t(f,c,s,T,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var g=f[E];if(a=t(g,c,s,T,o,b,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(M,C){return C};else if(typeof d!="function"){var F=d;d=function(M,C){for(var A=C,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,C){return j.call(M,C)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,C){return i.get.call(M,C)}),l.push(function(M,C){return i.set.call(M,C)})):o===2?l.push(i):l.push(function(M,C){return i.call(M,C)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(d)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!g&&s>2?E.set(d,s):E.set(d,!0)}m(c,I,f,d,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function Vr(y,t,e,r){return(Vr=Rl())(y,t,e,r)}var $r,Rr,Br,Gr,Ur,Hr,Or,Fr,zr,Mt;$r=U({selector:"kg-button",template:Lr,style:Ar}),Br=V.state(),Gr=V.state(),Ur=$(),Hr=$();var jr=class{static{({e:[Or,Fr,zr],c:[Mt,Rr]}=Vr(this,[[Br,1,"mSelected"],[Gr,1,"mType"],[Ur,3,"selected"],[Hr,3,"type"]],[$r]))}constructor(){this.mType="primary",this.mSelected=!1}#t=(zr(this),Or(this));get mSelected(){return this.#t}set mSelected(t){this.#t=t}#e=Fr(this);get mType(){return this.#e}set mType(t){this.#e=t}get selected(){return this.mSelected}set selected(t){this.mSelected=this.parseBoolean(t)}get type(){return this.mType}set type(t){if(t!=="primary"&&t!=="secondary"){this.mType="secondary";return}this.mType=t}parseBoolean(t){if(typeof t=="string"){if(t==="")return!0;let e=t.toLowerCase();if(e==="true"||e==="false")return e==="true"}return!!t}static{Rr()}};var Xr=`:host {\r
...
@position-try --kg-information-top-left {\r
    ...
    bottom: calc(anchor(top) + 0.625em);\r
    left: auto;\r
}`;var Yr=`<div class="icon">i</div>\r
<div class="information">\r
    $slot\r
</div>\r
`;function zl(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,T,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:b,private:p,metadata:T},d={v:!1};s.addInitializer=y(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var I=i;i=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,b,p,T,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,I,P;if(typeof f=="function")a=t(f,c,s,T,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var g=f[E];if(a=t(g,c,s,T,o,b,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(M,C){return C};else if(typeof d!="function"){var F=d;d=function(M,C){for(var A=C,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,C){return j.call(M,C)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,C){return i.get.call(M,C)}),l.push(function(M,C){return i.set.call(M,C)})):o===2?l.push(i):l.push(function(M,C){return i.call(M,C)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(d)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!g&&s>2?E.set(d,s):E.set(d,!0)}m(c,I,f,d,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function qr(y,t,e,r){return(qr=zl())(y,t,e,r)}var Jr,Wr,Kr;Jr=U({selector:"kg-information",template:Yr,style:Xr});var Zr=class{static{({c:[Kr,Wr]}=qr(this,[],[Jr]))}static{Wr()}};var Qr=`:host {\r
...
}`;var kr="$slot";function $l(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,T,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:b,private:p,metadata:T},d={v:!1};s.addInitializer=y(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var I=i;i=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,b,p,T,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,I,P;if(typeof f=="function")a=t(f,c,s,T,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var g=f[E];if(a=t(g,c,s,T,o,b,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(M,C){return C};else if(typeof d!="function"){var F=d;d=function(M,C){for(var A=C,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,C){return j.call(M,C)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,C){return i.get.call(M,C)}),l.push(function(M,C){return i.set.call(M,C)})):o===2?l.push(i):l.push(function(M,C){return i.call(M,C)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(d)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!g&&s>2?E.set(d,s):E.set(d,!0)}m(c,I,f,d,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function on(y,t,e,r){return(on=$l())(y,t,e,r)}var rn,tn,se;rn=U({selector:"kg-popup",template:kr,style:Qr});var en=class{static{({c:[se,tn]}=on(this,[],[rn]))}static{tn()}};var nn=`:host {\r
...
}`;var sn=`<!-- In order of top-left clockwise. Needed for styling -->\r
...
<div class="content-container">\r
    $slot\r
</div>`;function Ul(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,T,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:b,private:p,metadata:T},d={v:!1};s.addInitializer=y(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var I=i;i=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,b,p,T,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,I,P;if(typeof f=="function")a=t(f,c,s,T,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var g=f[E];if(a=t(g,c,s,T,o,b,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(M,C){return C};else if(typeof d!="function"){var F=d;d=function(M,C){for(var A=C,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,C){return j.call(M,C)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,C){return i.get.call(M,C)}),l.push(function(M,C){return i.set.call(M,C)})):o===2?l.push(i):l.push(function(M,C){return i.call(M,C)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(d)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!g&&s>2?E.set(d,s):E.set(d,!0)}m(c,I,f,d,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function fn(y,t,e,r){return(fn=Ul())(y,t,e,r)}var mn,an,pn,gn,vn,yn,bn,wn,xn,Tn,Dn,En,Cn,ln,cn,un,hn,Yt;mn=U({selector:"kg-resize-box",template:sn,style:nn}),pn=V.state({proxy:!0}),gn=rt("resize"),vn=rt("resize-end"),yn=$(),bn=$(),wn=$(),xn=$(),Tn=$(),Dn=$(),En=$(),Cn=$();var dn=class{static{({e:[ln,cn,un,hn],c:[Yt,an]}=fn(this,[[pn,1,"mConfiguration"],[gn,1,"mResize"],[vn,1,"mResizeEnd"],[yn,3,"bottom"],[bn,3,"height"],[wn,3,"left"],[xn,3,"right"],[Tn,3,"snap"],[Dn,3,"top"],[En,3,"virtual"],[Cn,3,"width"]],[mn]))}constructor(t=O.use(G)){this.mComponentElement=t.element,this.mConfiguration={snap:1,isVirtual:!1,enabledDirections:{top:!1,right:!1,bottom:!1,left:!1}}}mComponentElement;#t=(hn(this),ln(this));get mConfiguration(){return this.#t}set mConfiguration(t){this.#t=t}#e=cn(this);get mResize(){return this.#e}set mResize(t){this.#e=t}#o=un(this);get mResizeEnd(){return this.#o}set mResizeEnd(t){this.#o=t}get bottom(){return this.mConfiguration.enabledDirections.bottom}set bottom(t){this.mConfiguration.enabledDirections.bottom=this.parseBoolean(t)}get height(){return this.mComponentElement.clientHeight}set height(t){this.updateComponentHeight(t,!0)}get left(){return this.mConfiguration.enabledDirections.left}set left(t){this.mConfiguration.enabledDirections.left=this.parseBoolean(t)}get right(){return this.mConfiguration.enabledDirections.right}set right(t){this.mConfiguration.enabledDirections.right=this.parseBoolean(t)}get snap(){return this.mConfiguration.snap}set snap(t){this.mConfiguration.snap=parseInt(t.toString())}get top(){return this.mConfiguration.enabledDirections.top}set top(t){this.mConfiguration.enabledDirections.top=this.parseBoolean(t)}get virtual(){return this.mConfiguration.isVirtual}set virtual(t){this.mConfiguration.isVirtual=this.parseBoolean(t)}get width(){return this.mComponentElement.clientWidth}set width(t){this.updateComponentWidth(t,!0)}resizeCorner(t){this.handleResize(t,"both")}resizeHorizontal(t){this.handleResize(t,"horizontal")}resizeVertical(t){this.handleResize(t,"vertical")}applyComponentSize(t,e,r){let u=this.updateComponentWidth(e,!1),m=this.updateComponentHeight(r,!1);return(u!==this.width||m!==this.height)&&this.mResize.dispatchEvent(this.createResizeEvent(t,u,m,this.width,this.height)),[u,m]}createResizeEvent(t,e,r,u,m){let v=t;return e===u&&(v&=~(bt.right|bt.left)),r===m&&(v&=~(bt.top|bt.bottom)),new eo(e,r,v)}handleResize(t,e){t.preventDefault(),t.stopPropagation();let r=this.mComponentElement.getBoundingClientRect(),u=this.mComponentElement.offsetWidth?r.width/this.mComponentElement.offsetWidth:1,m=this.mComponentElement.offsetHeight?r.height/this.mComponentElement.offsetHeight:1,v=r.width/u,w=r.height/m,D=t.clientX,S=t.clientY,l=1;Math.abs(D-r.left)<Math.abs(D-r.right)&&(l=-1);let n=1;Math.abs(S-r.top)<Math.abs(S-r.bottom)&&(n=-1);let h=0;h+=l===1?bt.right:bt.left,h+=n===1?bt.bottom:bt.top;let c=v,o=w,b=T=>{let x=(T.clientX-D)/u*l,f=(T.clientY-S)/m*n,s=v+x,d=w+f;e==="horizontal"&&(s=v),e==="vertical"&&(d=w),[c,o]=this.applyComponentSize(h,s,d)},p=()=>{document.removeEventListener("pointermove",b),document.removeEventListener("pointerup",p),(c!==v||o!==w)&&this.mResizeEnd.dispatchEvent(this.createResizeEvent(h,c,o,v,w))};document.addEventListener("pointermove",b),document.addEventListener("pointerup",p)}parseBoolean(t){return!!(()=>{if(typeof t=="string"){if(t==="")return!0;let r=t.toLowerCase();if(["true","false"].includes(r))return r==="true"}return t})()}updateComponentHeight(t,e){if(!this.mConfiguration.enabledDirections.top&&!this.mConfiguration.enabledDirections.bottom)return this.height;t=Math.max(1,t);let r=Math.ceil(Math.abs(t)/this.mConfiguration.snap)*this.mConfiguration.snap*(t/Math.abs(t));return r=Math.max(0,r),(!this.mConfiguration.isVirtual||e)&&this.mComponentElement.style.setProperty("height",`${r}px`),r}updateComponentWidth(t,e){if(!this.mConfiguration.enabledDirections.left&&!this.mConfiguration.enabledDirections.right)return this.height;t=Math.max(1,t);let r=Math.ceil(Math.abs(t)/this.mConfiguration.snap)*this.mConfiguration.snap*(t/Math.abs(t));return r=Math.max(0,r),(!this.mConfiguration.isVirtual||e)&&this.mComponentElement.style.setProperty("width",`${r}px`),r}static{an()}},eo=class{mHeight;mResizeHandle;mWidth;get height(){return this.mHeight}get resizeHandle(){return this.mResizeHandle}get width(){return this.mWidth}constructor(t,e,r){this.mHeight=e,this.mResizeHandle=r,this.mWidth=t}},bt={top:1,right:2,bottom:4,left:8};var In=`:host {\r
...
`;var Pn=`<!-- Four soft edge handles placed next to the panel. Top/bottom resize height, left/right resize width. -->
$if(this.top) {
...
`;function Yl(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,T,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:b,private:p,metadata:T},d={v:!1};s.addInitializer=y(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var I=i;i=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,b,p,T,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,I,P;if(typeof f=="function")a=t(f,c,s,T,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var g=f[E];if(a=t(g,c,s,T,o,b,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(M,C){return C};else if(typeof d!="function"){var F=d;d=function(M,C){for(var A=C,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,C){return j.call(M,C)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,C){return i.get.call(M,C)}),l.push(function(M,C){return i.set.call(M,C)})):o===2?l.push(i):l.push(function(M,C){return i.call(M,C)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(d)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!g&&s>2?E.set(d,s):E.set(d,!0)}m(c,I,f,d,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function Rn(y,t,e,r){return(Rn=Yl())(y,t,e,r)}var On,Mn,Fn,zn,jn,Vn,$n,Bn,Gn,Un,Hn,_n,Sn,Nn,An,ro;On=U({selector:"kg-resize-panel",template:Pn,style:In}),Fn=V.state({proxy:!0}),zn=rt("resize"),jn=rt("resize-end"),Vn=$(),$n=$(),Bn=$(),Gn=$(),Un=$(),Hn=$();var Ln=class{static{({e:[_n,Sn,Nn,An],c:[ro,Mn]}=Rn(this,[[Fn,1,"mConfiguration"],[zn,1,"mResize"],[jn,1,"mResizeEnd"],[Vn,3,"bottom"],[$n,3,"height"],[Bn,3,"left"],[Gn,3,"right"],[Un,3,"top"],[Hn,3,"width"]],[On]))}constructor(t=O.use(G)){this.mComponentElement=t.element,this.mConfiguration={enabledDirections:{top:!1,right:!1,bottom:!1,left:!1}}}mComponentElement;#t=(An(this),_n(this));get mConfiguration(){return this.#t}set mConfiguration(t){this.#t=t}#e=Sn(this);get mResize(){return this.#e}set mResize(t){this.#e=t}#o=Nn(this);get mResizeEnd(){return this.#o}set mResizeEnd(t){this.#o=t}get bottom(){return this.mConfiguration.enabledDirections.bottom}set bottom(t){this.mConfiguration.enabledDirections.bottom=this.parseBoolean(t)}get height(){return this.mComponentElement.clientHeight}set height(t){this.updateComponentHeight(t)}get left(){return this.mConfiguration.enabledDirections.left}set left(t){this.mConfiguration.enabledDirections.left=this.parseBoolean(t)}get right(){return this.mConfiguration.enabledDirections.right}set right(t){this.mConfiguration.enabledDirections.right=this.parseBoolean(t)}get top(){return this.mConfiguration.enabledDirections.top}set top(t){this.mConfiguration.enabledDirections.top=this.parseBoolean(t)}get width(){return this.mComponentElement.clientWidth}set width(t){this.updateComponentWidth(t)}resizeHorizontal(t){this.handleResize(t,"horizontal")}resizeVertical(t){this.handleResize(t,"vertical")}applyComponentSize(t,e,r){let u=this.updateComponentWidth(e),m=this.updateComponentHeight(r);return(u!==this.width||m!==this.height)&&this.mResize.dispatchEvent(this.createResizeEvent(t,u,m,this.width,this.height)),[u,m]}createResizeEvent(t,e,r,u,m){let v=t;return e===u&&(v&=~(Ft.right|Ft.left)),r===m&&(v&=~(Ft.top|Ft.bottom)),new oo(e,r,v)}handleResize(t,e){t.preventDefault(),t.stopPropagation();let r=this.mComponentElement.getBoundingClientRect(),u=this.mComponentElement.offsetWidth?r.width/this.mComponentElement.offsetWidth:1,m=this.mComponentElement.offsetHeight?r.height/this.mComponentElement.offsetHeight:1,v=r.width/u,w=r.height/m,D=t.clientX,S=t.clientY,l=1;Math.abs(D-r.left)<Math.abs(D-r.right)&&(l=-1);let n=1;Math.abs(S-r.top)<Math.abs(S-r.bottom)&&(n=-1);let h=0;h+=l===1?Ft.right:Ft.left,h+=n===1?Ft.bottom:Ft.top;let c=v,o=w,b=T=>{let x=(T.clientX-D)/u*l,f=(T.clientY-S)/m*n,s=v+x,d=w+f;e==="horizontal"&&(s=v),e==="vertical"&&(d=w),[c,o]=this.applyComponentSize(h,s,d)},p=()=>{document.removeEventListener("pointermove",b),document.removeEventListener("pointerup",p),(c!==v||o!==w)&&this.mResizeEnd.dispatchEvent(this.createResizeEvent(h,c,o,v,w))};document.addEventListener("pointermove",b),document.addEventListener("pointerup",p)}parseBoolean(t){return!!(()=>{if(typeof t=="string"){if(t==="")return!0;let r=t.toLowerCase();if(["true","false"].includes(r))return r==="true"}return t})()}updateComponentHeight(t){if(!this.mConfiguration.enabledDirections.top&&!this.mConfiguration.enabledDirections.bottom)return this.height;let e=Math.max(1,t);return this.mComponentElement.style.setProperty("height",`${e}px`),e}updateComponentWidth(t){if(!this.mConfiguration.enabledDirections.left&&!this.mConfiguration.enabledDirections.right)return this.width;let e=Math.max(1,t);return this.mComponentElement.style.setProperty("width",`${e}px`),e}static{Mn()}},oo=class{mHeight;mResizeHandle;mWidth;get height(){return this.mHeight}get resizeHandle(){return this.mResizeHandle}get width(){return this.mWidth}constructor(t,e,r){this.mHeight=e,this.mResizeHandle=r,this.mWidth=t}},Ft={top:1,right:2,bottom:4,left:8};var Xn=`:host {
...
`;function ql(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,T,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:b,private:p,metadata:T},d={v:!1};s.addInitializer=y(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var I=i;i=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,b,p,T,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,I,P;if(typeof f=="function")a=t(f,c,s,T,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var g=f[E];if(a=t(g,c,s,T,o,b,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(M,C){return C};else if(typeof d!="function"){var F=d;d=function(M,C){for(var A=C,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,C){return j.call(M,C)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,C){return i.get.call(M,C)}),l.push(function(M,C){return i.set.call(M,C)})):o===2?l.push(i):l.push(function(M,C){return i.call(M,C)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(d)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!g&&s>2?E.set(d,s):E.set(d,!0)}m(c,I,f,d,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function ei(y,t,e,r){return(ei=ql())(y,t,e,r)}var oi,Wn,ri,ni,ii,si,ai,li,ci,ui,hi,di,fi,Zn,qn,Jn,Kn,Qn,kn,no;oi=U({selector:"kg-select",template:Yn,style:Xn}),ri=V.state({complexValue:!0}),ni=V.state(),ii=V.state(),si=V.state(),ai=rt("change"),li=$(),ci=$(),ui=$(),hi=$(),di=$(),fi=$();var ti=class{static{({e:[Zn,qn,Jn,Kn,Qn,kn],c:[no,Wn]}=ei(this,[[ri,1,"mOptions"],[ni,1,"mPlaceholder"],[ii,1,"mType"],[si,1,"mValue"],[ai,1,"mChange"],[li,3,"labelKey"],[ci,3,"options"],[ui,3,"placeholder"],[hi,3,"type"],[di,3,"value"],[fi,3,"valueKey"]],[oi]))}constructor(){this.mType="primary",this.mValue="",this.mOptions=new Array,this.mPlaceholder="",this.mValueMapping={valueKey:"value",labelKey:"label"}}mValueMapping;#t=(kn(this),Zn(this));get mOptions(){return this.#t}set mOptions(t){this.#t=t}#e=qn(this);get mPlaceholder(){return this.#e}set mPlaceholder(t){this.#e=t}#o=Jn(this);get mType(){return this.#o}set mType(t){this.#o=t}#r=Kn(this);get mValue(){return this.#r}set mValue(t){this.#r=t}#n=Qn(this);get mChange(){return this.#n}set mChange(t){this.#n=t}get labelKey(){return this.mValueMapping.labelKey}set labelKey(t){this.mValueMapping.labelKey=(t??"").toString()}get options(){return this.mOptions}set options(t){this.mOptions=Array.isArray(t)?t:new Array}get placeholder(){return this.mPlaceholder}set placeholder(t){this.mPlaceholder=(t??"").toString()}get type(){return this.mType}set type(t){if(t!=="primary"&&t!=="secondary"){this.mType="secondary";return}this.mType=t}get value(){return this.mValue}set value(t){this.mValue=(t??"").toString()}get valueKey(){return this.mValueMapping.valueKey}set valueKey(t){this.mValueMapping.valueKey=(t??"").toString()}onChange(t){let e=t.target;this.mValue=e.value,this.mChange.dispatchEvent(this.mValue)}itemLabel(t){return t[this.mValueMapping.labelKey]}itemValue(t){return t[this.mValueMapping.valueKey]}static{Wn()}};var mi=`:host {\r
    display: flex;\r
    flex-direction: column;\r
}\r
\r
...
}`;var pi=`<kg-resize-panel class="resize-panel" right>\r
...
`;function Ql(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,T,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:b,private:p,metadata:T},d={v:!1};s.addInitializer=y(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var I=i;i=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,b,p,T,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,I,P;if(typeof f=="function")a=t(f,c,s,T,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var g=f[E];if(a=t(g,c,s,T,o,b,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(M,C){return C};else if(typeof d!="function"){var F=d;d=function(M,C){for(var A=C,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,C){return j.call(M,C)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,C){return i.get.call(M,C)}),l.push(function(M,C){return i.set.call(M,C)})):o===2?l.push(i):l.push(function(M,C){return i.call(M,C)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(d)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!g&&s>2?E.set(d,s):E.set(d,!0)}m(c,I,f,d,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function xi(y,t,e,r){return(xi=Ql())(y,t,e,r)}var Ti,gi,Di,Ei,vi,yi,bi,Io;Ti=U({selector:"potatno-function-list",template:pi,style:mi,components:[ro,se,Mt]}),Di=V.state({complexValue:!0}),Ei=V.state();var wi=class{static{({e:[vi,yi,bi],c:[Io,gi]}=xi(this,[[Di,1,"documentFunctions"],[Ei,1,"showPopup"]],[Ti]))}constructor(t=O.use(Y)){this.mManager=t,this.documentFunctions=new Array,this.showPopup=!1,this.mUnsubscribe=this.mManager.subscribe(R.Document|R.Function|R.SpecialActiveFunction,()=>{this.documentFunctions=this.mManager.graph.document.functions.map(e=>({id:e.id,label:e.label,isSystem:e.isSystem,function:e}))})}mManager;mUnsubscribe;#t=(bi(this),vi(this));get documentFunctions(){return this.#t}set documentFunctions(t){this.#t=t}#e=yi(this);get showPopup(){return this.#e}set showPopup(t){this.#e=t}get activeFunctionId(){return this.mManager.activeFunction.id}get userFunctionDefinitions(){return[...this.mManager.project.userFunctions.values()]}createFunction(t){this.showPopup=!1,this.mManager.graph.addFunction(t.id)}deleteFunction(t){this.mManager.graph.removeFunction(t.id)}onDeconstruct(){this.mUnsubscribe()}selectFunction(t){this.mManager.setActiveFunction(t.function)}static{gi()}};var ae=class{mCodeGenerator;mId;mLabel;mNodesProvider;mStatics;get codeGenerator(){return this.mCodeGenerator}get id(){return this.mId}get label(){return this.mLabel}get statics(){return this.mStatics}constructor(t){this.mId=t.id,this.mLabel=t.label,this.mNodesProvider=t.nodes,this.mStatics=t.statics,this.mCodeGenerator=t.generator.code}getNodeDefinitions(t){let e=u=>{if(!u)return new Array;let m=new Array;return u(v=>{m.push(v)},t),m},r={};return Object.defineProperty(r,"entry",{get:()=>e(this.mNodesProvider.entry)}),Object.defineProperty(r,"exit",{get:()=>e(this.mNodesProvider.exit)}),Object.defineProperty(r,"dynamic",{get:()=>e(this.mNodesProvider.dynamic)}),r}},zt={none:0,imports:1,inputs:2,outputs:4};var Ci=`:host {\r
    display: flex;\r
    flex-direction: column;\r
}\r
\r
...
}`;var Ii=`<kg-resize-panel class="resize-panel" left>\r
    <div class="panel-content">\r
        <!-- Function name -->\r
        <div class="section">\r
...
`;function ec(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,T,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:b,private:p,metadata:T},d={v:!1};s.addInitializer=y(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var I=i;i=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,b,p,T,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,I,P;if(typeof f=="function")a=t(f,c,s,T,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var g=f[E];if(a=t(g,c,s,T,o,b,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(M,C){return C};else if(typeof d!="function"){var F=d;d=function(M,C){for(var A=C,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,C){return j.call(M,C)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,C){return i.get.call(M,C)}),l.push(function(M,C){return i.set.call(M,C)})):o===2?l.push(i):l.push(function(M,C){return i.call(M,C)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(d)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!g&&s>2?E.set(d,s):E.set(d,!0)}m(c,I,f,d,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function Ni(y,t,e,r){return(Ni=ec())(y,t,e,r)}var Ai,Pi,Li,Mi,_i,Po;Ai=U({selector:"potatno-function-properties",template:Ii,style:Ci,components:[Yt,Mt]}),Li=V.state({complexValue:!0});var Si=class{static{({e:[Mi,_i],c:[Po,Pi]}=Ni(this,[[Li,1,"functionProperties"]],[Ai]))}constructor(t=O.use(Y)){this.mManager=t,this.mSelectedImportId="",this.mProjectTypes=new Set,this.functionProperties=this.convertFunctionProperties(null),this.mUnsubscribeFunctionUpdate=this.mManager.subscribe(R.Function,()=>{this.functionProperties=this.convertFunctionProperties(this.functionProperties)}),this.mUnsubscribeFunctionSwitch=this.mManager.subscribe(R.Document|R.SpecialActiveFunction,()=>{this.mProjectTypes.clear();for(let[e]of this.mManager.project.types.types)this.mProjectTypes.add(e);this.functionProperties=this.convertFunctionProperties(null)})}mManager;mProjectTypes;mSelectedImportId;mUnsubscribeFunctionUpdate;mUnsubscribeFunctionSwitch;#t=(_i(this),Mi(this));get functionProperties(){return this.#t}set functionProperties(t){this.#t=t}get projectTypes(){return this.mProjectTypes}get selectedImportId(){return this.mSelectedImportId}set selectedImportId(t){this.mSelectedImportId=t}get unusedImports(){return this.mManager.activeFunction.project.imports.filter(t=>!this.functionProperties.imports.find(e=>t.id===e.id))}addPort(t){let e=this.projectTypes.values().next().value;if(!e)return;let r=t===this.functionProperties.inputs?"Input":"Output";this.resetNewState(),t.push({new:!0,label:r,dataType:e,hasError:!1}),this.submitChange()}addSelectedImport(){let t=this.unusedImports;if(t.length===0)return;let e=t.find(r=>r.id===this.mSelectedImportId);e||(e=t.at(0)),this.resetNewState(),this.functionProperties.imports.push({new:!0,id:e.id,label:e.label}),this.submitChange()}deleteImport(t){let e=this.functionProperties.imports.indexOf(t);e!==-1&&(this.functionProperties.imports.splice(e,1),this.resetNewState(),this.submitChange())}deletePort(t,e){let r=e.indexOf(t);r!==-1&&(e.splice(r,1),this.resetNewState(),this.submitChange())}onDeconstruct(){this.mUnsubscribeFunctionUpdate(),this.mUnsubscribeFunctionSwitch()}async submitChange(){let t=!1,e=new Set;for(let v of this.functionProperties.inputs)v.hasError=e.has(v.label),t||=v.hasError,e.add(v.label);let r=new Set;for(let v of this.functionProperties.outputs)v.hasError=r.has(v.label),t||=v.hasError,r.add(v.label);if(t){this.functionProperties=this.functionProperties;return}let u=this.mManager.activeFunction,m=this.functionProperties;await new Promise(v=>{globalThis.setTimeout(v,10)}),this.mManager.graph.updateFunction(u,v=>{if(v.label=m.label,!m.statics.inputs){for(;v.inputs.length>0;)v.removeInput(v.inputs.at(0));for(let w of m.inputs)v.addInput({dataType:w.dataType,label:w.label})}if(!m.statics.outputs){for(;v.outputs.length>0;)v.removeOutput(v.outputs.at(0));for(let w of m.outputs)v.addOutput({dataType:w.dataType,label:w.label})}if(!m.statics.imports){for(let w of v.imports)v.removeImport(w);for(let w of m.imports)v.addImport(w.id)}})}convertFunctionProperties(t){let e={label:"",inputs:new Array,outputs:new Array,imports:new Array,statics:{label:!0,imports:!0,inputs:!0,outputs:!0}},r=this.mManager.activeFunction,u=r.project.getFunction(r.definitionId);u&&(e.statics.label=r.isSystem,e.statics.imports=(u.statics&zt.imports)!==0,e.statics.inputs=(u.statics&zt.inputs)!==0,e.statics.outputs=(u.statics&zt.outputs)!==0),e.label=r.label;for(let m of r.project.imports){if(!r.imports.has(m.id))continue;let v=t?t.imports.find(D=>D.id===m.id)?.new??!1:!1;e.imports.push({new:v,id:m.id,label:m.label})}for(let m of r.inputs){let v=t?t.inputs.find(D=>D.label===m.label)?.new??!1:!1;e.inputs.push({new:v,label:m.label,dataType:m.dataType,hasError:!1})}for(let m of r.outputs){let v=t?t.outputs.find(D=>D.label===m.label)?.new??!1:!1;e.outputs.push({new:v,label:m.label,dataType:m.dataType,hasError:!1})}return e}resetNewState(){for(let t of this.functionProperties.inputs)t.new=!1;for(let t of this.functionProperties.outputs)t.new=!1;for(let t of this.functionProperties.imports)t.new=!1}static{Pi()}};var Ri=`:host {\r
    position: absolute;\r
    z-index: 200;\r
\r
...
}`;var Oi=`<kg-popup class="selection-popup" animate="top" (pointerdown)="this.stopPropagation($event, false)" (wheel)="this.stopPropagation($event, false)" (contextmenu)="this.stopPropagation($event, true);">\r
\r
...
`;function nc(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,T,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:b,private:p,metadata:T},d={v:!1};s.addInitializer=y(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var I=i;i=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,b,p,T,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,I,P;if(typeof f=="function")a=t(f,c,s,T,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var g=f[E];if(a=t(g,c,s,T,o,b,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(M,C){return C};else if(typeof d!="function"){var F=d;d=function(M,C){for(var A=C,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,C){return j.call(M,C)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,C){return i.get.call(M,C)}),l.push(function(M,C){return i.set.call(M,C)})):o===2?l.push(i):l.push(function(M,C){return i.call(M,C)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(d)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!g&&s>2?E.set(d,s):E.set(d,!0)}m(c,I,f,d,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function Ui(y,t,e,r){return(Ui=nc())(y,t,e,r)}function ic(y){return y}var Hi,Fi,Xi,Yi,Wi,Zi,qi,Ji,zi,ji,Vi,$i,Bi,Gi,le;Hi=U({selector:"potatno-node-selection-popup",template:Oi,style:Ri,components:[se]}),Xi=$(),Yi=V.state({complexValue:!0}),Wi=yt("searchInput"),Zi=rt("node-select"),qi=V.state(),Ji=V.state();new class extends ic{constructor(){super(le),Fi()}static{class y{static{({e:[zi,ji,Vi,$i,Bi,Gi],c:[le,Fi]}=Ui(this,[[Xi,3,"contextport"],[Yi,1,"results"],[Wi,1,"searchInput"],[Zi,1,"mNodeSelect"],[qi,1,"searchValue"],[Ji,1,"selectedDefinitionId"]],[Hi]))}static POPUP_HEIGHT=320;static POPUP_WIDTH=280;mComponent;mManager;mNodes;get contextport(){return this.mNodes.context}set contextport(e){this.mNodes.context=e,this.mNodes.list.filtered=this.contexturizeNodeList(this.mNodes.context)}#t=(Gi(this),zi(this));get results(){return this.#t}set results(e){this.#t=e}#e=ji(this);get searchInput(){return this.#e}set searchInput(e){this.#e=e}#o=Vi(this);get mNodeSelect(){return this.#o}set mNodeSelect(e){this.#o=e}#r=$i(this);get searchValue(){return this.#r}set searchValue(e){this.#r=e}#n=Bi(this);get selectedDefinitionId(){return this.#n}set selectedDefinitionId(e){this.#n=e}constructor(e=O.use(G),r=O.use(Y)){this.mManager=r,this.mComponent=e,this.selectedDefinitionId=null,this.results=new Array,this.searchValue="";let u=this.fetchNodeEntries();this.mNodes={context:null,list:{full:u,filtered:u}}}onConnect(){this.searchInput?.focus()}onKeyDown(e){if(this.results.length!==0){if(e.key==="ArrowDown"||e.key==="ArrowUp"){e.preventDefault();let r=this.results.findIndex(v=>v.definition.id===this.selectedDefinitionId);r=Math.max(0,r);let u=e.key==="ArrowDown"?1:-1,m=(r+u+this.results.length)%this.results.length;this.selectedDefinitionId=this.results[m].definition.id;return}e.key==="Enter"&&this.sendSelectedEntry(this.selectedDefinitionId)}}onUpdate(){this.results=this.filterResults(),this.results.some(r=>r.definition.id===this.selectedDefinitionId)||(this.selectedDefinitionId=this.results[0]?.definition.id??null);let e=this.mComponent.element.shadowRoot.querySelector(".selection-popup__result.selected");e&&e.scrollIntoView({block:"center"})}stopPropagation(e,r){e.stopPropagation(),r&&e.preventDefault()}contexturizeNodeList(e){return e?this.mNodes.list.full.filter(r=>!!this.findMatchingPortDefinition(e,r.definition)):this.mNodes.list.full}fetchNodeEntries(){return this.mManager.activeFunction.dynamicNodeDefinitions.map(e=>({category:e.category.name,definition:e,label:e.label.toLowerCase(),color:this.mManager.generateStringColor(e.category.name),icon:e.category.icon}))}filterResults(){let e=this.searchValue.trim().toLowerCase();return this.mNodes.list.filtered.filter(r=>r.label.includes(e))}findMatchingPortDefinition(e,r){let u=e.direction==="input"?r.outputs:r.inputs;for(let m of u)if(m.portType===e.portType&&m.dataType===e.dataType)return m;return null}sendSelectedEntry(e){if(e===null)return;let r=this.results.find(u=>u.definition.id===e);r&&this.mNodeSelect.dispatchEvent({definition:r.definition,port:this.mNodes.context?{source:this.mNodes.context,target:this.findMatchingPortDefinition(this.mNodes.context,r.definition)}:null})}}}};var Ki=`:host {\r
...
}`;var Qi=`<!-- Resizeable part of node -->\r
...
`;function lc(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,T,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:b,private:p,metadata:T},d={v:!1};s.addInitializer=y(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var I=i;i=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,b,p,T,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,I,P;if(typeof f=="function")a=t(f,c,s,T,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var g=f[E];if(a=t(g,c,s,T,o,b,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(M,C){return C};else if(typeof d!="function"){var F=d;d=function(M,C){for(var A=C,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,C){return j.call(M,C)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,C){return i.get.call(M,C)}),l.push(function(M,C){return i.set.call(M,C)})):o===2?l.push(i):l.push(function(M,C){return i.call(M,C)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(d)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!g&&s>2?E.set(d,s):E.set(d,!0)}m(c,I,f,d,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function ls(y,t,e,r){return(ls=lc())(y,t,e,r)}var cs,ki,us,hs,ds,fs,ms,ps,gs,ts,es,os,rs,ns,is,ss,_o;cs=U({selector:"potatno-comment-node",template:Qi,style:Ki,components:[Yt]}),us=V.state(),hs=V.state(),ds=V.state(),fs=$(),ms=yt("CommentInput"),ps=rt("node-drag"),gs=yt("ResizeBox");var as=class{static{({e:[ts,es,os,rs,ns,is,ss],c:[_o,ki]}=ls(this,[[us,1,"editMode"],[hs,1,"enableBigview"],[ds,1,"gridZoom"],[fs,3,"nodeData"],[ms,1,"mCommentInput"],[ps,1,"mDrag"],[gs,1,"mResizeBox"]],[cs]))}constructor(t=O.use(G),e=O.use(Y)){this.mComponent=t,this.mManager=e,this.mNodeData=null,this.editMode=!1,this.enableBigview=!1,this.gridZoom=0,this.updateForZoomLevel(),this.mUnsubscribeGrid=this.mManager.subscribe(R.SpecialGrid,()=>{this.updateForZoomLevel()}),this.mUnsubscribe=this.mManager.subscribe(R.Node,r=>{r.item===this.mNodeData&&this.resyncComponent(this.nodeData)}),this.mUnsubscribeResize=this.mManager.subscribe(R.ProgrammResize,()=>{this.mNodeData&&this.resyncComponent(this.mNodeData)})}mComponent;mManager;mNodeData;mUnsubscribe;mUnsubscribeGrid;mUnsubscribeResize;get comment(){return this.nodeData.label??""}set comment(t){this.nodeData.label=t}#t=(ss(this),ts(this));get editMode(){return this.#t}set editMode(t){this.#t=t}#e=es(this);get enableBigview(){return this.#e}set enableBigview(t){this.#e=t}#o=os(this);get gridZoom(){return this.#o}set gridZoom(t){this.#o=t}get gridSize(){return this.mManager.grid.gridSize}get nodeData(){if(!this.mNodeData)throw new N("Node data not set.",this);return this.mNodeData}set nodeData(t){this.mNodeData=t,t&&(this.resyncComponent(t),this.mComponent.updater.update())}#r=rs(this);get mCommentInput(){return this.#r}set mCommentInput(t){this.#r=t}#n=ns(this);get mDrag(){return this.#n}set mDrag(t){this.#n=t}#i=is(this);get mResizeBox(){return this.#i}set mResizeBox(t){this.#i=t}dragNodeOrEnableEdit(t){if(t.preventDefault(),this.editMode||(t.button===2&&this.mManager.graph.removeNode(this.nodeData),t.button!==0))return;let e=this.nodeData.transformation.x*this.mManager.grid.gridSize,r=this.nodeData.transformation.y*this.mManager.grid.gridSize,u=this.nodeData.transformation.x,m=this.nodeData.transformation.y,v=this.mComponent.element.getBoundingClientRect(),w=this.mComponent.element.offsetWidth?v.width/this.mComponent.element.offsetWidth:1,D=this.mComponent.element.offsetHeight?v.height/this.mComponent.element.offsetHeight:1,S=t.clientX,l=t.clientY,n=c=>{c.stopPropagation();let o=(c.clientX-S)/w,b=(c.clientY-l)/D,p=Math.round((e+o)/this.mManager.grid.gridSize),T=Math.round((r+b)/this.mManager.grid.gridSize);u===p&&m===T||(this.mManager.graph.transformNode(this.nodeData,x=>{x.moveTo(p,T)}),this.mDrag.dispatchEvent(new Mo(p-u,T-m)),u=p,m=T)},h=()=>{document.removeEventListener("pointermove",n),document.removeEventListener("pointerup",h)};document.addEventListener("pointermove",n),document.addEventListener("pointerup",h)}escapeEditMode(t){(t.key==="Escape"||t.key==="Enter")&&(t.preventDefault(),this.editMode=!1)}onConnect(){this.resyncComponent(this.nodeData)}onDeconstruct(){this.mUnsubscribe(),this.mUnsubscribeGrid(),this.mUnsubscribeResize()}onUpdate(){this.mCommentInput&&this.getFocusedElement(document)!==this.mCommentInput&&this.mCommentInput.select()}transformNodeData(t){this.mManager.graph.transformNode(this.nodeData,e=>{let r=e.transformation.width,u=e.transformation.height;e.resizeTo(t.width/this.mManager.grid.gridSize,t.height/this.mManager.grid.gridSize);let m=e.transformation.width-r,v=e.transformation.height-u;v!==0&&(t.resizeHandle&bt.top)>0&&e.moveTo(e.transformation.x,e.transformation.y-v),m!==0&&(t.resizeHandle&bt.left)>0&&e.moveTo(e.transformation.x-m,e.transformation.y)})}getFocusedElement(t){let e=t.activeElement;return e?e.shadowRoot?this.getFocusedElement(e.shadowRoot):e:null}resyncComponent(t){let e=t.transformation.x*this.mManager.grid.gridSize,r=t.transformation.y*this.mManager.grid.gridSize;if(this.mComponent.element.style.setProperty("left",`${e}px`),this.mComponent.element.style.setProperty("top",`${r}px`),this.mResizeBox){let u=t.transformation.width*this.mManager.grid.gridSize,m=t.transformation.height*this.mManager.grid.gridSize;this.mResizeBox.width=u,this.mResizeBox.height=m}this.mComponent.updater.updateAsync()}updateForZoomLevel(){this.enableBigview=this.mManager.grid.zoom<.25,this.enableBigview&&(this.gridZoom=this.mManager.grid.zoom),this.mComponent.element.style.setProperty("z-index",(this.enableBigview?9999:-1).toString())}static{ki()}},Mo=class{mX;mY;get x(){return this.mX}get y(){return this.mY}constructor(t,e){this.mX=t,this.mY=e}};var vs=`:host {\r
...
}`;var ys=`<div class="port-wrapper {{this.portDirection}}" style="--type-color: {{this.portColor}}" (dragover)="this.onDragOver($event)" (drop)="this.onDrop($event)">\r
\r
...
}`;var Ss=`<div class="node" style="--type-color: {{this.portColor}}" (dragover)="this.onDragOver($event)" (drop)="this.onDrop($event)">\r
\r
...
}`;var Hs=`<svg class="svg-layer" xmlns="http://www.w3.org/2000/svg" >\r
...
`;function vc(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,T,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:b,private:p,metadata:T},d={v:!1};s.addInitializer=y(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var I=i;i=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,b,p,T,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,I,P;if(typeof f=="function")a=t(f,c,s,T,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var g=f[E];if(a=t(g,c,s,T,o,b,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(M,C){return C};else if(typeof d!="function"){var F=d;d=function(M,C){for(var A=C,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,C){return j.call(M,C)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,C){return i.get.call(M,C)}),l.push(function(M,C){return i.set.call(M,C)})):o===2?l.push(i):l.push(function(M,C){return i.call(M,C)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(d)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!g&&s>2?E.set(d,s):E.set(d,!0)}m(c,I,f,d,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function qs(y,t,e,r){return(qs=vc())(y,t,e,r)}var Js,Xs,Ks,Ys,Ws,Ao;Js=U({selector:"potatno-connection-layer",template:Hs,style:Us}),Ks=V.state({complexValue:!0});var Zs=class{static{({e:[Ys,Ws],c:[Ao,Xs]}=qs(this,[[Ks,1,"connections"]],[Js]))}constructor(t=O.use(Y)){this.mManager=t,this.connections=new Map;let e=0;this.mUnsubscribe=this.mManager.subscribe(R.SpecialActiveFunction|R.Node|R.Connection|R.ProgrammResize,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.updateConnections()}))})}mManager;mUnsubscribe;#t=(Ws(this),Ys(this));get connections(){return this.#t}set connections(t){this.#t=t}createConjunction(t,e){t.preventDefault(),t.stopPropagation();let r=e.port.output.portType==="flow"?this.mManager.project.nodeDefinitions.get(K.DEFINITION_ID):this.mManager.project.nodeDefinitions.get(et.DEFINITION_ID),u=this.mManager.grid.pixelToGridSpace(t.clientX,t.clientY),m=this.mManager.graph.addNode(this.mManager.activeFunction,r,{x:u.x,y:u.y,height:0,width:0});this.mManager.graph.disconnectPorts(e.port.output,e.port.input);let v=m.inputs.list[0],w=m.outputs.list[0];this.mManager.graph.connectPorts(v,e.port.output),this.mManager.graph.connectPorts(v,e.port.input),this.mManager.graph.connectPorts(w,e.port.output),this.mManager.graph.connectPorts(w,e.port.input)}deleteConnection(t,e){t.button===2&&(t.preventDefault(),t.stopPropagation(),this.mManager.graph.disconnectPorts(e.port.output,e.port.input))}onDeconstruct(){this.mUnsubscribe()}createConnection(t,e,r){let u=this.mManager.integrity.errorItems,m=u.has(e)||u.has(r),v=(()=>{switch(r.portType){case"value":return r;case"flow":return e}})(),w=e.portType==="flow"?"":this.mManager.generateStringColor(e.resolvedDataType),D=this.mManager.connections.getConnectionPath(e,r);return{color:w,path:{attributeValue:D.attributeValue,length:D.length},state:{isNew:!t.has(v),hasError:m},port:{primary:v,output:e,input:r}}}updateConnections(){let t=this.connections;this.connections=new Map;for(let e of this.mManager.activeFunction.nodes)for(let r of e.outputs.list)for(let u of r.connectedPorts){let m=this.createConnection(t,r,u);this.connections.set(m.port.primary,m)}}static{Xs()}};function yc(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,b,p,T,x){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:p?"#"+n:n,static:b,private:p,metadata:T},d={v:!1};s.addInitializer=y(c,d);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var I=i;i=function(g){return arguments.length===0&&(g=this),I.call(g)}}if(a){var P=a;a=function(g,_){return arguments.length===1&&(_=g,g=this),P.call(g,_)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{d.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function m(l,n,h,c,o,b,p,T,x){var f=h[0],s,d,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,I,P;if(typeof f=="function")a=t(f,c,s,T,o,b,p,x,i),a!==void 0&&(u(o,a),o===0?d=a:o===1?(d=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a);else for(var E=f.length-1;E>=0;E--){var g=f[E];if(a=t(g,c,s,T,o,b,p,x,i),a!==void 0){u(o,a);var _;o===0?_=a:o===1?(_=a.init,I=a.get||i.get,P=a.set||i.set,i={get:I,set:P}):i=a,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(M,C){return C};else if(typeof d!="function"){var F=d;d=function(M,C){for(var A=C,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=d;d=function(M,C){return j.call(M,C)}}l.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,C){return i.get.call(M,C)}),l.push(function(M,C){return i.set.call(M,C)})):o===2?l.push(i):l.push(function(M,C){return i.call(M,C)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,b,p=new Map,T=new Map,x=0;x<n.length;x++){var f=n[x];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,a=s>=5,I,P;if(a?(I=l,s=s-5,b=b||[],P=b):(I=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?T:p,g=E.get(d)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!g&&s>2?E.set(d,s):E.set(d,!0)}m(c,I,f,d,s,a,i,P,h)}}return w(c,o),w(c,b),c}function w(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function D(l,n,h){if(n.length>0){for(var c=[],o=l,b=l.name,p=n.length-1;p>=0;p--){var T={v:!1};try{var x=n[p](o,{kind:"class",name:b,addInitializer:y(c,T),metadata:h})}finally{T.v=!0}x!==void 0&&(u(10,x),o=x)}return[S(o,h),function(){for(var f=0;f<c.length;f++)c[f].call(o)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(b===void 0?null:b),T=v(n,h,p);return c.length||S(n,p),{e:T,get c(){return D(n,c,p)}}}}function ta(y,t,e,r){return(ta=yc())(y,t,e,r)}var ea,Qs,Ne;ea=Ct({access:q.Read,selector:/^potatno-preview$/});var ks=class{static{({c:[Ne,Qs]}=ta(this,[],[ea]))}constructor(t=O.use(k),e=O.use(W),r=O.use(st)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(r.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let r=this.mTarget.childNodes.length>0;return r&&(this.mTarget.innerHTML=""),r}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{Qs()}};var oa=`:host {\r
...
}`;var xa=`<!-- Serves only as a background. -->\r
...
}`;var Na=`<kg-resize-box class="resize-box" left top bottom="false">\r
    <div class="header">\r
