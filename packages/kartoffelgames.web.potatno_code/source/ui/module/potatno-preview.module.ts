...
import { AccessMode, type IAttributeOnUpdate, type LevelProcedure, ModuleAttribute, ModuleDataLevel, ModuleTargetNode, PwbAttributeModule } from '@kartoffelgames/web-potato-web-builder';
