...
`;(function(f){f.Function="function",f.Comment="comment",f.Input="input",f.Output="output",f.Reroute="reroute"})(it||(it={}));var At=class f{static META={[it.Function]:{icon:"f",cssColor:"var(--pn-accent-blue)",label:"Function"},[it.Comment]:{icon:"\u{1F4AC}",cssColor:"var(--pn-accent-yellow)",label:"Comment"},[it.Input]:{icon:"\u2192",cssColor:"var(--pn-accent-green)",label:"Input"},[it.Output]:{icon:"\u2190",cssColor:"var(--pn-accent-red)",label:"Output"},[it.Reroute]:{icon:"\u25C7",cssColor:"var(--pn-text-muted)",label:"Reroute"}};static get(t){let e=f.META[t];return e||{icon:"\u25C6",cssColor:`hsl(${f.hashStringToHue(t)}, 60%, 55%)`,label:t.charAt(0).toUpperCase()+t.slice(1)}}static hashStringToHue(t){let e=0;for(let o=0;o<t.length;o++)e=(e<<5)-e+t.charCodeAt(o),e=e&e;return Math.abs(e)%360}},it;var Eo=`:host {
    position: absolute;
    z-index: 1500;
}
...
`;function gs(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,g,T,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:g?"#"+n:n,static:b,private:g,metadata:T},h={v:!1};s.addInitializer=f(a,h);var i,d;r===0?g?(i=u.get,d=u.set):(i=function(){return this[n]},d=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(d=function(x){u.set.call(this,x)})),s.access=i&&d?{get:i,set:d}:i?{get:i}:{set:d};try{return l(w,s)}finally{h.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,g,T,w){var p=u[0],s,h,i;g?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var d,x,C;if(typeof p=="function")d=t(p,a,s,T,r,b,g,w,i),d!==void 0&&(c(r,d),r===0?h=d:r===1?(h=d.init,x=d.get||i.get,C=d.set||i.set,i={get:x,set:C}):i=d);else for(var P=p.length-1;P>=0;P--){var M=p[P];if(d=t(M,a,s,T,r,b,g,w,i),d!==void 0){c(r,d);var N;r===0?N=d:r===1?(N=d.init,x=d.get||i.get,C=d.set||i.set,i={get:x,set:C}):i=d,N!==void 0&&(h===void 0?h=N:typeof h=="function"?h=[h,N]:h.push(N))}}if(r===0||r===1){if(h===void 0)h=function(I,D){return D};else if(typeof h!="function"){var _=h;h=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=h;h=function(I,D){return V.call(I,D)}}l.push(h)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),g?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function v(l,n,u){for(var a=[],r,b,g=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],h=p[2],i=p.length>3,d=s>=5,x,C;if(d?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var P=d?T:g,M=P.get(h)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+h);!M&&s>2?P.set(h,s):P.set(h,!0)}m(a,x,p,h,s,d,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function E(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,g=n.length-1;g>=0;g--){var T={v:!1};try{var w=n[g](r,{kind:"class",name:b,addInitializer:f(a,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var g=Object.create(b===void 0?null:b),T=v(n,u,g);return a.length||S(n,g),{e:T,get c(){return E(n,a,g)}}}}function Zo(f,t,e,o){return(Zo=gs())(f,t,e,o)}var qo,Uo,Jo,Ko,Qo,Go,Ho,Xo,Yo,vs=12,sr="http://www.w3.org/2000/svg",ar="data-temp-connection",ys;qo=J({selector:"potatno-connection-layer",template:Bo,style:zo}),Jo=G.state(),Ko=G.state({complexValue:!0}),Qo=ot("svgLayer");var Wo=class{static{({e:[Go,Ho,Xo,Yo],c:[ys,Uo]}=Zo(this,[[[tt,Jo],1,"interaction"],[[tt,Ko],1,"tempConnection"],[Qo,1,"svgLayer"]],[qo]))}constructor(t=O.use(K)){this.mConnectionRegistry=new Map,this.mManager=t,this.mPendingRenderFrame=0,this.mUnsubscribe=null}mConnectionRegistry;mManager;mPendingRenderFrame;mUnsubscribe;#t=(Yo(this),Go(this,null));get interaction(){return this.#t}set interaction(t){this.#t=t}#e=Ho(this,null);get tempConnection(){return this.#e}set tempConnection(t){this.#e=t}#r=Xo(this);get svgLayer(){return this.#r}set svgLayer(t){this.#r=t}onConnect(){this.mUnsubscribe=this.mManager.subscribe(F.Document|F.Function|F.SpecialActiveFunction|F.Node|F.NodeTransform|F.Connection,null,()=>{this.scheduleRender()}),this.scheduleRender()}onDeconstruct(){this.mUnsubscribe?.(),this.mUnsubscribe=null,this.mPendingRenderFrame!==0&&(cancelAnimationFrame(this.mPendingRenderFrame),this.mPendingRenderFrame=0)}onUpdate(){this.renderTempConnection()}onContextMenu(t){if(!(t.target instanceof Element))return;let e=t.target.getAttribute("data-connection-id");e&&(t.preventDefault(),t.stopPropagation(),this.deleteConnectionById(e))}clearPaths(t,e){let o=e?"path":`path:not([${ar}])`,c=t.querySelectorAll(o);for(let m of c)m.remove()}deleteConnectionById(t){let e=this.mConnectionRegistry.get(t);if(!e)return;let o=e.sourcePort.node.outputs.map.get(e.sourcePort.definitionId)??e.sourcePort,c=e.targetPort.node.inputs.map.get(e.targetPort.definitionId)??e.targetPort;this.mManager.graph.disconnectPorts(o,c)}generateGridPath(t,e,o){let c=this.mManager.grid.gridSize,m=e.x>=t.x?1:-1,v={x:this.snapToGridCenter(t.x+m*c),y:this.snapToGridCenter(t.y)},y={x:this.snapToGridCenter(e.x-m*c),y:this.snapToGridCenter(e.y)},E=Math.min(v.x,y.x),S=Math.max(v.x,y.x),l=this.snapToGridCenter(v.x+(y.x-v.x)/2),n=this.getSourceConnectionLaneOffset(o)*m,u=Math.max(E,Math.min(S,this.snapToGridCenter(l+n)));return this.generateRoundedPath([t,v,{x:u,y:v.y},{x:u,y:y.y},y,e])}getSourceConnectionLaneOffset(t){if(!t||t.direction!=="output")return 0;let e=t.node.outputs.list,o=e.indexOf(t);return o===-1?0:(e.length-o-1)*this.mManager.grid.gridSize}generateRoundedPath(t){let e=this.mManager.grid.gridSize,o=Math.min(8,e/3),c=[];for(let y of t){let E=c[c.length-1];(!E||E.x!==y.x||E.y!==y.y)&&c.push(y)}if(c.length<2)return"";let m=`M ${c[0].x} ${c[0].y}`;for(let y=1;y<c.length-1;y++){let E=c[y-1],S=c[y],l=c[y+1],n=Math.hypot(S.x-E.x,S.y-E.y),u=Math.hypot(l.x-S.x,l.y-S.y),a=Math.min(o,n/2,u/2);if(a<=0){m+=` L ${S.x} ${S.y}`;continue}let r=this.moveTowards(S,E,a),b=this.moveTowards(S,l,a);m+=` L ${r.x} ${r.y} Q ${S.x} ${S.y} ${b.x} ${b.y}`}let v=c[c.length-1];return`${m} L ${v.x} ${v.y}`}getPortAnchorElement(t){if(t instanceof HTMLElement){let e=t.shadowRoot?.querySelector(".port-handle")??null;if(e)return e}return t}getPortPosition(t){let e=this.interaction?.zoom??1,o=this.mManager.grid.gridSize,c=this.mManager.grid.getPortElement(t),m=this.getSvgLayerOrNull();if(c&&m){let u=this.getPortAnchorElement(c),a=m.getBoundingClientRect(),r=u.getBoundingClientRect();return{x:this.snapToGridCenter((r.left+r.width/2-a.left)/e),y:this.snapToGridCenter((r.top+r.height/2-a.top)/e)}}let v=t.node,y=v.transformation.x*o,E=v.transformation.y*o,S=v.transformation.width*o,l=t.direction==="output"?v.outputs.list:v.inputs.list,n=0;for(let u of l){if(u===t)break;n++}return{x:t.direction==="output"?y+S-o/2:y+o/2,y:E+o+(n+.5)*o}}getSvgLayerOrNull(){try{return this.svgLayer}catch{return null}}moveTowards(t,e,o){let c=Math.hypot(e.x-t.x,e.y-t.y);return c===0?t:{x:t.x+(e.x-t.x)/c*o,y:t.y+(e.y-t.y)/c*o}}renderConnections(){let t=this.getSvgLayerOrNull();if(!t)return;let e=this.mManager.activeFunction;if(!e){this.clearPaths(t,!0),this.mConnectionRegistry.clear();return}this.clearPaths(t,!1),this.mConnectionRegistry.clear();let o=this.mManager.integrity.errorItems,c=0;for(let m of e.nodes)for(let v of m.outputs.list)for(let y of v.connectedPorts){let E=`c${c++}`,S=this.getPortPosition(v),l=this.getPortPosition(y),n=o.has(v)||o.has(y);this.mConnectionRegistry.set(E,{sourcePort:v,targetPort:y}),this.renderConnectionPath(t,E,v,S,l,!n)}this.renderTempConnection()}renderConnectionPath(t,e,o,c,m,v){let y=this.generateGridPath(c,m,o),E=document.createElementNS(sr,"path");E.setAttribute("d",y),E.setAttribute("data-connection-id",e),E.setAttribute("data-hit-area","true"),E.setAttribute("fill","none"),E.style.cursor="pointer",E.style.pointerEvents="stroke",E.style.stroke="transparent",E.style.strokeLinecap="round",E.style.strokeLinejoin="round",E.style.strokeWidth=`${vs}`,t.appendChild(E);let S=document.createElementNS(sr,"path");S.setAttribute("d",y),S.setAttribute("data-connection-id",e),S.setAttribute("fill","none"),S.style.pointerEvents="none",S.style.stroke=v?"#a6adc8":"#f38ba8",S.style.strokeLinecap="round",S.style.strokeLinejoin="round",S.style.strokeWidth="2",v||S.setAttribute("stroke-dasharray","6 3"),t.appendChild(S)}renderTempConnection(){let t=this.getSvgLayerOrNull();if(!t)return;let e=t.querySelector(`[${ar}]`);e&&e.remove();let o=this.tempConnection;if(!o)return;let c=document.createElementNS(sr,"path");c.setAttribute("d",this.generateGridPath(o.start,o.end,null)),c.setAttribute("fill","none"),c.setAttribute(ar,"true"),c.style.opacity="0.6",c.style.pointerEvents="none",c.style.stroke="#bac2de",c.style.strokeDasharray="8 4",c.style.strokeLinecap="round",c.style.strokeLinejoin="round",c.style.strokeWidth="2",t.appendChild(c)}scheduleRender(){this.mPendingRenderFrame===0&&(this.mPendingRenderFrame=requestAnimationFrame(()=>{this.mPendingRenderFrame=0,this.renderConnections()}))}snapToGridCenter(t){let e=this.mManager.grid.gridSize;return Math.round((t-e/2)/e)*e+e/2}static{Uo()}};function bs(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,g,T,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:g?"#"+n:n,static:b,private:g,metadata:T},h={v:!1};s.addInitializer=f(a,h);var i,d;r===0?g?(i=u.get,d=u.set):(i=function(){return this[n]},d=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(d=function(x){u.set.call(this,x)})),s.access=i&&d?{get:i,set:d}:i?{get:i}:{set:d};try{return l(w,s)}finally{h.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,g,T,w){var p=u[0],s,h,i;g?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var d,x,C;if(typeof p=="function")d=t(p,a,s,T,r,b,g,w,i),d!==void 0&&(c(r,d),r===0?h=d:r===1?(h=d.init,x=d.get||i.get,C=d.set||i.set,i={get:x,set:C}):i=d);else for(var P=p.length-1;P>=0;P--){var M=p[P];if(d=t(M,a,s,T,r,b,g,w,i),d!==void 0){c(r,d);var N;r===0?N=d:r===1?(N=d.init,x=d.get||i.get,C=d.set||i.set,i={get:x,set:C}):i=d,N!==void 0&&(h===void 0?h=N:typeof h=="function"?h=[h,N]:h.push(N))}}if(r===0||r===1){if(h===void 0)h=function(I,D){return D};else if(typeof h!="function"){var _=h;h=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=h;h=function(I,D){return V.call(I,D)}}l.push(h)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),g?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function v(l,n,u){for(var a=[],r,b,g=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],h=p[2],i=p.length>3,d=s>=5,x,C;if(d?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var P=d?T:g,M=P.get(h)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+h);!M&&s>2?P.set(h,s):P.set(h,!0)}m(a,x,p,h,s,d,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function E(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,g=n.length-1;g>=0;g--){var T={v:!1};try{var w=n[g](r,{kind:"class",name:b,addInitializer:f(a,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var g=Object.create(b===void 0?null:b),T=v(n,u,g);return a.length||S(n,g),{e:T,get c(){return E(n,a,g)}}}}function en(f,t,e,o){return(en=bs())(f,t,e,o)}var rn,ko,we;rn=xt({access:X.Read,selector:/^potatno-preview$/});var tn=class{static{({c:[we,ko]}=en(this,[],[rn]))}constructor(t=O.use(Z),e=O.use(H),o=O.use(rt)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(o.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let o=this.mTarget.childNodes.length>0;return o&&(this.mTarget.innerHTML=""),o}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{ko()}};var on=`:host {\r
    display: block;\r
    position: relative;\r
}\r
\r
...
\r
.port-wrapper:hover .port-handle {\r
    transform: translateX(-2px);\r
}\r
\r
/* Rectangle body */\r
.port-handle.port-type-flow::before {\r
    content: '';\r
    position: absolute;\r
    top: 0;\r
    width: var(--pn-node-port-body-size);\r
    height: 100%;\r
    background: var(--port-color, var(--pn-text-muted));\r
}\r
\r
/* Triangle tip */\r
.port-handle.port-type-flow::after {\r
    content: '';\r
    position: absolute;\r
    top: 0;\r
    width: 0;\r
...
.port-handle.port-type-flow.direction-output::before {\r
    left: 0;\r
    border-radius: 1px 0 0 1px;\r
}\r
.port-handle.port-type-flow.direction-output::after {\r
    left: var(--pn-node-port-body-size);\r
    border-left: var(--pn-node-port-tip-size) solid var(--port-color, var(--pn-text-muted));\r
}\r
\r
/* Input: arrow points left */\r
.port-handle.port-type-flow.direction-input::before {\r
    right: 0;\r
    border-radius: 0 1px 1px 0;\r
}\r
.port-handle.port-type-flow.direction-input::after {\r
    right: var(--pn-node-port-body-size);\r
    border-right: var(--pn-node-port-tip-size) solid var(--port-color, var(--pn-text-muted));\r
}\r
\r
/* Value ports: smaller circular shape */\r
.port-handle.port-type-value {\r
    align-self: center;\r
    background: var(--port-color, var(--pn-text-muted));\r
    border-radius: 50%;\r
    height: calc(var(--pn-node-value-port-size) - 1px);\r
    width: calc(var(--pn-node-value-port-size) - 1px);\r
    border: 1px solid var(--port-color);\r
}\r
\r
/* Connected: solid fill (default) */\r
.port-handle.port-type-flow.connected::before { background: var(--port-color, var(--pn-text-muted)); }\r
.port-handle.port-type-flow.connected.direction-output::after { border-left-color: var(--port-color, var(--pn-text-muted)); }\r
.port-handle.port-type-flow.connected.direction-input::after { border-right-color: var(--port-color, var(--pn-text-muted)); }\r
.port-handle.port-type-value.connected { background: var(--port-color, var(--pn-text-muted)); }\r
\r
/* Disconnected: dimmed */\r
.port-handle.port-type-flow.disconnected::before { background: color-mix(in srgb, var(--port-color, var(--pn-text-muted)) 30%, var(--pn-node-bg)); }\r
.port-handle.port-type-flow.disconnected.direction-output::after { border-left-color: color-mix(in srgb, var(--port-color, var(--pn-text-muted)) 30%, var(--pn-node-bg)); }\r
.port-handle.port-type-flow.disconnected.direction-input::after { border-right-color: color-mix(in srgb, var(--port-color, var(--pn-text-muted)) 30%, var(--pn-node-bg)); }\r
.port-handle.port-type-value.disconnected { background: color-mix(in srgb, var(--port-color, var(--pn-text-muted)) 30%, var(--pn-node-bg)); }\r
\r
/* Invalid: red glow */\r
.port-handle.port-type-flow.invalid::before { background: var(--pn-accent-danger); }\r
.port-handle.port-type-flow.invalid.direction-output::after { border-left-color: var(--pn-accent-danger); }\r
.port-handle.port-type-flow.invalid.direction-input::after { border-right-color: var(--pn-accent-danger); }\r
.port-handle.port-type-value.invalid { background: var(--pn-accent-danger); }\r
.port-handle.invalid { filter: drop-shadow(0 0 4px var(--pn-accent-danger)); }\r
\r
/* Has-error: red glow (validation error from graph) */\r
.port-handle.port-type-flow.has-error::before { background: var(--pn-accent-danger, #f38ba8); }\r
.port-handle.port-type-flow.has-error.direction-output::after { border-left-color: var(--pn-accent-danger, #f38ba8); }\r
.port-handle.port-type-flow.has-error.direction-input::after { border-right-color: var(--pn-accent-danger, #f38ba8); }\r
.port-handle.port-type-value.has-error { background: var(--pn-accent-danger, #f38ba8); }\r
.port-handle.has-error { filter: drop-shadow(0 0 4px var(--pn-accent-danger, #f38ba8)); }\r
\r
.port-label {\r
...
\r
.direct-value-inputs {\r
    /* Place the right edge of this element at the left edge of the port handle so the inputs body does not overlap the port handle at all. */\r
    position: absolute;\r
    right: 100%;\r
    top: 50%;\r
...
.direct-value-field {\r
    display: flex;\r
    gap: 3px;\r
    background: color-mix(in srgb, var(--port-color) 12%, var(--pn-node-bg));\r
    border: 1px solid var(--port-color);\r
    border-radius: 2px;\r
...
\r
/* Arrow tip pointing right toward the port handle */\r
.direct-value-field::after {\r
    ...
    width: 11px;\r
    height: 1;\r
    background-color: var(--port-color);\r
    pointer-events: none;\r
}\r
\r
.direct-value-label {\r
    font-size: var(--pn-font-size-xs, 10px);\r
    color: color-mix(in srgb, var(--port-color) 80%, var(--pn-text-secondary));\r
    white-space: nowrap;\r
    user-select: none;\r
    flex-shrink: 0;\r
}\r
...
.direct-value-input {\r
    background: color-mix(in srgb, var(--port-color) 8%, var(--pn-node-bg, #1e1e1e));\r
    border: 1px solid color-mix(in srgb, var(--port-color) 35%, transparent);\r
    border-radius: 2px;\r
    color: var(--pn-text-primary);\r
    font-size: var(--pn-font-size-sm);\r
    padding: 1px 3px;\r
...
.direct-value-input:focus {\r
    outline: none;\r
    border-color: var(--port-color);\r
    box-shadow: 0 0 0 1px color-mix(in srgb, var(--port-color) 30%, transparent);\r
}\r
\r
.direct-value-input[type='checkbox'] {\r
    width: auto;\r
    min-width: auto;\r
    accent-color: var(--port-color);\r
    cursor: pointer;\r
    margin: 0px;\r
}\r
`;var nn=`<div #portWrapper [className]="this.portWrapperClasses" [title]="this.portTypeLabel" style="--port-color: {{this.portColor}}" (pointerdown)="this.onPointerDown($event)">
    <div #portHandle [className]="this.portHandleClasses"></div>
    <span class="port-label">{{this.portName}}</span>
</div>

$if(this.showDirectValueInput) {
    <div class="direct-value-inputs" style="--port-color: {{this.portColor}}">
        $for(inputDef of this.directValueInputDefs) {
            <div class="direct-value-field">
                ...
                <input [type]="this.inputDef.htmlType" class="direct-value-input" [value]="this.inputDef.value" (change)="this.onDirectValueInput($event, this.inputDef.index)"/>
            </div>
        }
    </div>
}
`;function Ts(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,g,T,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:g?"#"+n:n,static:b,private:g,metadata:T},h={v:!1};s.addInitializer=f(a,h);var i,d;r===0?g?(i=u.get,d=u.set):(i=function(){return this[n]},d=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(d=function(x){u.set.call(this,x)})),s.access=i&&d?{get:i,set:d}:i?{get:i}:{set:d};try{return l(w,s)}finally{h.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,g,T,w){var p=u[0],s,h,i;g?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var d,x,C;if(typeof p=="function")d=t(p,a,s,T,r,b,g,w,i),d!==void 0&&(c(r,d),r===0?h=d:r===1?(h=d.init,x=d.get||i.get,C=d.set||i.set,i={get:x,set:C}):i=d);else for(var P=p.length-1;P>=0;P--){var M=p[P];if(d=t(M,a,s,T,r,b,g,w,i),d!==void 0){c(r,d);var N;r===0?N=d:r===1?(N=d.init,x=d.get||i.get,C=d.set||i.set,i={get:x,set:C}):i=d,N!==void 0&&(h===void 0?h=N:typeof h=="function"?h=[h,N]:h.push(N))}}if(r===0||r===1){if(h===void 0)h=function(I,D){return D};else if(typeof h!="function"){var _=h;h=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=h;h=function(I,D){return V.call(I,D)}}l.push(h)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),g?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function v(l,n,u){for(var a=[],r,b,g=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],h=p[2],i=p.length>3,d=s>=5,x,C;if(d?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var P=d?T:g,M=P.get(h)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+h);!M&&s>2?P.set(h,s):P.set(h,!0)}m(a,x,p,h,s,d,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function E(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,g=n.length-1;g>=0;g--){var T={v:!1};try{var w=n[g](r,{kind:"class",name:b,addInitializer:f(a,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var g=Object.create(b===void 0?null:b),T=v(n,u,g);return a.length||S(n,g),{e:T,get c(){return E(n,a,g)}}}}function pn(f,t,e,o){return(pn=Ts())(f,t,e,o)}var fn,sn,gn,vn,yn,bn,wn,an,ln,cn,un,dn,hn,lr;fn=J({selector:"potatno-port",template:nn,style:on}),gn=G.state(),vn=G.state(),yn=Et("port-drag-start"),bn=ot("portHandle"),wn=ot("portWrapper");var mn=class{static{({e:[an,ln,cn,un,dn,hn],c:[lr,sn]}=pn(this,[[[tt,gn],1,"port"],[[tt,vn],1,"ownerNode"],[yn,1,"mPortDragStart"],[bn,1,"portHandleElement"],[wn,1,"portWrapperElement"]],[fn]))}constructor(t=O.use(z),e=O.use(K)){this.mComponent=t,this.mLastRegisteredElement=null,this.mLastRegisteredPort=null,this.mManager=e,this.mUnsubscribe=null}mComponent;mLastRegisteredElement;mLastRegisteredPort;mManager;mUnsubscribe;#t=(hn(this),an(this,null));get port(){return this.#t}set port(t){this.#t=t}#e=ln(this,null);get ownerNode(){return this.#e}set ownerNode(t){this.#e=t}#r=cn(this);get mPortDragStart(){return this.#r}set mPortDragStart(t){this.#r=t}#o=un(this);get portHandleElement(){return this.#o}set portHandleElement(t){this.#o=t}#n=dn(this);get portWrapperElement(){return this.#n}set portWrapperElement(t){this.#n=t}get hasError(){return this.port!==null&&this.mManager.integrity.errorItems.has(this.port)}get portName(){return this.port?.label??""}get portTypeLabel(){return this.port?.dataType??""}get portWrapperClasses(){return`port-wrapper ${this.port?.direction==="output"?"direction-output":"direction-input"}`}get portHandleClasses(){if(!this.port)return"port-handle disconnected direction-input";let t=["port-handle"];return t.push(this.port.connectedPorts.size>0?"connected":"disconnected"),t.push(this.port.direction==="output"?"direction-output":"direction-input"),t.push(this.port.portType==="value"?"port-type-value":"port-type-flow"),this.hasError&&t.push("has-error"),t.join(" ")}get portColor(){if(!this.port||this.port.portType==="flow")return"var(--pn-text-primary)";if(this.port.node.project.types.isGenericType(this.port.dataType??"")){if(this.port.connectedPorts.size>0){let t=[...this.port.connectedPorts][0];return this.getTypeColor(t.dataType??"")}return"var(--pn-text-muted)"}return this.getTypeColor(this.port.dataType??"")}get showDirectValueInput(){return this.port?this.port.portType==="value"&&this.port.direction==="input"&&this.port.connectedPorts.size===0&&!this.port.node.project.types.isGenericType(this.port.dataType??""):!1}get directValueInputDefs(){return!this.port||this.port.portType!=="value"?[]:this.port.node.project.types.isGenericType(this.port.dataType??"")?[]:this.port.project.types.getType(this.port.dataType??"").inputs.map((e,o)=>({htmlType:e.type==="number"?"number":e.type==="boolean"?"checkbox":"text",index:o,name:e.name,value:this.port.directValue[o]??""}))}onConnect(){this.mUnsubscribe=this.mManager.subscribe(F.Connection|F.Node,null,()=>{this.mComponent.updater.update()})}onDeconstruct(){this.mUnsubscribe?.(),this.mUnsubscribe=null}onUpdate(){let t=this.port,e=this.ownerNode;if(!t||!e)return;let o=this.mComponent.element;t===this.mLastRegisteredPort&&o===this.mLastRegisteredElement||(this.mLastRegisteredElement=o,this.mLastRegisteredPort=t,this.mManager.grid.registerPortElement(t,o))}onPointerDown(t){t.stopPropagation(),t.preventDefault(),!(!this.port||!this.ownerNode)&&this.mPortDragStart.dispatchEvent({node:this.ownerNode,port:this.port,element:this.portHandleElement})}onDirectValueInput(t,e){if(!this.port)return;let o=t.target,c=[...this.port.directValue];c[e]=o.type==="checkbox"?o.checked?"true":"false":o.value,this.mManager.graph.setPortDirectValue(this.port,c)}getTypeColor(t){let e=0;for(let c=0;c<t.length;c++)e=t.charCodeAt(c)+((e<<5)-e);return`hsl(${Math.abs(e)*137.508%360}, 70%, 60%)`}static{sn()}};var xn=`:host {
    display: block;
    height: 100%;
    width: 100%;
    font-family: var(--pn-font-family);
...
`;var ri=`<div class="properties-header">Properties</div>\r
...
`;var li=`<div class="resize-handle" (pointerdown)="this.onResizePointerDown($event)"></div>
...
`;function Fs(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,g,T,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:g?"#"+n:n,static:b,private:g,metadata:T},h={v:!1};s.addInitializer=f(a,h);var i,d;r===0?g?(i=u.get,d=u.set):(i=function(){return this[n]},d=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(d=function(x){u.set.call(this,x)})),s.access=i&&d?{get:i,set:d}:i?{get:i}:{set:d};try{return l(w,s)}finally{h.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,g,T,w){var p=u[0],s,h,i;g?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var d,x,C;if(typeof p=="function")d=t(p,a,s,T,r,b,g,w,i),d!==void 0&&(c(r,d),r===0?h=d:r===1?(h=d.init,x=d.get||i.get,C=d.set||i.set,i={get:x,set:C}):i=d);else for(var P=p.length-1;P>=0;P--){var M=p[P];if(d=t(M,a,s,T,r,b,g,w,i),d!==void 0){c(r,d);var N;r===0?N=d:r===1?(N=d.init,x=d.get||i.get,C=d.set||i.set,i={get:x,set:C}):i=d,N!==void 0&&(h===void 0?h=N:typeof h=="function"?h=[h,N]:h.push(N))}}if(r===0||r===1){if(h===void 0)h=function(I,D){return D};else if(typeof h!="function"){var _=h;h=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=h;h=function(I,D){return V.call(I,D)}}l.push(h)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),g?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function v(l,n,u){for(var a=[],r,b,g=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],h=p[2],i=p.length>3,d=s>=5,x,C;if(d?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var P=d?T:g,M=P.get(h)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+h);!M&&s>2?P.set(h,s):P.set(h,!0)}m(a,x,p,h,s,d,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function E(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,g=n.length-1;g>=0;g--){var T={v:!1};try{var w=n[g](r,{kind:"class",name:b,addInitializer:f(a,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var g=Object.create(b===void 0?null:b),T=v(n,u,g);return a.length||S(n,g),{e:T,get c(){return E(n,a,g)}}}}function mi(f,t,e,o){return(mi=Fs())(f,t,e,o)}var pi,ci,fi,ui,di,_s;pi=J({selector:"potatno-preview",template:li,style:ai,modules:[we]}),fi=ot("PreviewContainer");var hi=class{static{({e:[ui,di],c:[_s,ci]}=mi(this,[[fi,1,"containerElement"]],[pi]))}constructor(t=O.use(z),e=O.use(K)){this.mComponent=t,this.mDragging=!1,this.mManager=e,this.mSelectedDisplayId="",this.mSelectedOutputId="",this.mStartHeight=0,this.mStartWidth=0,this.mStartX=0,this.mStartY=0,this.mTrackedFunction=null,this.mUnsubscribe=null}mComponent;mDragging;mManager;mStartHeight;mStartWidth;mStartX;mStartY;mTrackedFunction;mUnsubscribe;mSelectedDisplayId;mSelectedOutputId;#t=(di(this),ui(this));get containerElement(){return this.#t}set containerElement(t){this.#t=t}get displayOptions(){let t=this.mManager.activeFunction,e=this.mManager.project,o=t&&e?e.getFunction(t.definitionId):void 0;return!t||!e||!o?new Array:this.createDisplayOptions(e,this.availableDisplayIds(e,o,t,this.selectedOutputId))}get errors(){return this.mManager.integrity.errors}get hasErrors(){return!this.mManager.integrity.isValid}get outputOptions(){let t=this.mManager.activeFunction,e=this.mManager.project,o=t&&e?e.getFunction(t.definitionId):void 0;if(!t||!e||!o)return[];let c=new Array;e.preview.availableDisplays(o,et.MAIN).length>0&&c.push({id:et.MAIN,label:"Main"});let m=new Set;for(let v of t.getExitNodes())for(let y of v.inputs.value)m.has(y.definitionId)||e.preview.availableDisplays(o,y.resolvedDataType).length!==0&&(m.add(y.definitionId),c.push({id:y.definitionId,label:y.label}));return c}get previewDriver(){let t=this.mManager.activeFunction;if(!t)return null;if(this.selectedOutputId===et.MAIN)return this.mManager.preview.requestDriver(t,this.selectedDisplayId);let e=this.findFunctionOutputPort(t,this.selectedOutputId);return e?this.mManager.preview.requestDriver(e,this.selectedDisplayId):null}get selectedDisplayId(){let t=this.displayOptions;return this.mSelectedDisplayId!==""&&t.some(e=>e.id===this.mSelectedDisplayId)?this.mSelectedDisplayId:t.at(0)?.id??""}get selectedOutputId(){let t=this.outputOptions;return this.mSelectedOutputId!==""&&t.some(e=>e.id===this.mSelectedOutputId)?this.mSelectedOutputId:t[0]?.id??""}get showOutputSelector(){let t=this.mManager.activeFunction,e=this.mManager.project;return!t||!e?!1:this.outputOptions.length>0}onConnect(){this.mUnsubscribe=this.mManager.subscribe(F.Document|F.Function|F.SpecialActiveFunction|F.Node|F.Connection,null,()=>{this.mComponent.updater.update()})}onDeconstruct(){this.mUnsubscribe?.(),this.mUnsubscribe=null}onDisplaySelect(t){this.mSelectedDisplayId=t.target.value,this.mComponent.updater.update()}onOutputSelect(t){this.mSelectedOutputId=t.target.value,this.mComponent.updater.update()}onResizePointerDown(t){t.preventDefault(),t.stopPropagation(),this.mDragging=!0,this.mStartX=t.clientX,this.mStartY=t.clientY;let e=this.containerElement;if(!e)return;this.mStartWidth=e.offsetWidth,this.mStartHeight=e.offsetHeight,t.target.setPointerCapture(t.pointerId);let o=m=>{if(!this.mDragging)return;let v=this.mStartX-m.clientX,y=this.mStartY-m.clientY;e.style.width=Math.max(200,this.mStartWidth+v)+"px",e.style.height=Math.max(150,this.mStartHeight+y)+"px"},c=m=>{this.mDragging=!1,m.target.releasePointerCapture(m.pointerId),document.removeEventListener("pointermove",o),document.removeEventListener("pointerup",c)};document.addEventListener("pointermove",o),document.addEventListener("pointerup",c)}availableDisplayIds(t,e,o,c){if(c===et.MAIN)return t.preview.availableDisplays(e,et.MAIN);let m=this.findFunctionOutputPort(o,c);return m?t.preview.availableDisplays(e,m.resolvedDataType):t.preview.availableDisplays(e)}createDisplayOptions(t,e){return e.map(o=>({id:o,label:t.preview.getDisplay(o)?.name??o}))}findFunctionOutputPort(t,e){for(let o of t.getExitNodes()){let c=o.inputs.map.get(e);if(c&&c.portType==="value")return c}return null}static{ci()}};function js(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,g,T,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:g?"#"+n:n,static:b,private:g,metadata:T},h={v:!1};s.addInitializer=f(a,h);var i,d;r===0?g?(i=u.get,d=u.set):(i=function(){return this[n]},d=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(d=function(x){u.set.call(this,x)})),s.access=i&&d?{get:i,set:d}:i?{get:i}:{set:d};try{return l(w,s)}finally{h.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(l,n,u,a,r,b,g,T,w){var p=u[0],s,h,i;g?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var d,x,C;if(typeof p=="function")d=t(p,a,s,T,r,b,g,w,i),d!==void 0&&(c(r,d),r===0?h=d:r===1?(h=d.init,x=d.get||i.get,C=d.set||i.set,i={get:x,set:C}):i=d);else for(var P=p.length-1;P>=0;P--){var M=p[P];if(d=t(M,a,s,T,r,b,g,w,i),d!==void 0){c(r,d);var N;r===0?N=d:r===1?(N=d.init,x=d.get||i.get,C=d.set||i.set,i={get:x,set:C}):i=d,N!==void 0&&(h===void 0?h=N:typeof h=="function"?h=[h,N]:h.push(N))}}if(r===0||r===1){if(h===void 0)h=function(I,D){return D};else if(typeof h!="function"){var _=h;h=function(I,D){for(var R=D,L=0;L<_.length;L++)R=_[L].call(I,R);return R}}else{var V=h;h=function(I,D){return V.call(I,D)}}l.push(h)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),g?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function v(l,n,u){for(var a=[],r,b,g=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],h=p[2],i=p.length>3,d=s>=5,x,C;if(d?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var P=d?T:g,M=P.get(h)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+h);!M&&s>2?P.set(h,s):P.set(h,!0)}m(a,x,p,h,s,d,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function E(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,g=n.length-1;g>=0;g--){var T={v:!1};try{var w=n[g](r,{kind:"class",name:b,addInitializer:f(a,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),r=w)}return[S(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function S(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var g=Object.create(b===void 0?null:b),T=v(n,u,g);return a.length||S(n,g),{e:T,get c(){return E(n,a,g)}}}}function xi(f,t,e,o){return(xi=js())(f,t,e,o)}var Ti,gi,Ei,Di,vi,yi,bi,cr;Ti=J({selector:"potatno-code-editor",template:uo,style:co}),Ei=ot("panelLeft"),Di=ot("panelRight");var wi=class{static{({e:[vi,yi,bi],c:[cr,gi]}=xi(this,[[Ei,1,"panelLeft"],[Di,1,"panelRight"],[tt,4,"project"],[tt,4,"file"],[tt,2,"triggerPreviewUpdate"]],[Ti]))}constructor(t=O.use(z),e=O.use(K)){this.mComponent=t,this.mManager=e,this.mProject=null,this.mResizeMoveHandler=null,this.mResizeState=null,this.mResizeUpHandler=null,this.mUnsubscribe=null}mComponent;mManager;mProject;mResizeMoveHandler;mResizeState;mResizeUpHandler;mUnsubscribe;#t=(bi(this),vi(this));get panelLeft(){return this.#t}set panelLeft(t){this.#t=t}#e=yi(this);get panelRight(){return this.#e}set panelRight(t){this.#e=t}get hasPreview(){let t=this.mManager.project,e=this.mManager.activeFunction;if(!t||!e)return!1;let o=t.getFunction(e.definitionId);return o?t.preview.availableDisplays(o).length>0:!1}get file(){return this.mManager.graph.document}set project(t){this.mProject=t}set file(t){this.mProject&&this.mManager.initialize(this.mProject,t)}triggerPreviewUpdate(){return this.mManager.preview.execute()}onConnect(){this.mUnsubscribe=this.mManager.subscribe(F.Document|F.Function|F.SpecialActiveFunction,null,()=>{this.mComponent.updater.update()})}onDeconstruct(){this.mUnsubscribe?.(),this.mUnsubscribe=null,this.mManager.deconstruct(),this.stopPanelResize()}onResizeLeftStart(t){t.preventDefault(),this.startPanelResize("left",t)}onResizeRightStart(t){t.preventDefault(),this.startPanelResize("right",t)}startPanelResize(t,e){this.stopPanelResize();let o=t==="left"?this.panelLeft:this.panelRight;this.mResizeState={panel:t,startWidth:o.offsetWidth,startX:e.clientX};let c=v=>{if(!this.mResizeState)return;let y=t==="left"?v.clientX-this.mResizeState.startX:this.mResizeState.startX-v.clientX;o.style.width=`${Math.max(200,Math.min(500,this.mResizeState.startWidth+y))}px`},m=()=>{document.removeEventListener("pointermove",c),document.removeEventListener("pointerup",m),this.mResizeMoveHandler=null,this.mResizeState=null,this.mResizeUpHandler=null};this.mResizeMoveHandler=c,this.mResizeUpHandler=m,document.addEventListener("pointermove",c),document.addEventListener("pointerup",m)}stopPanelResize(){this.mResizeMoveHandler&&(document.removeEventListener("pointermove",this.mResizeMoveHandler),this.mResizeMoveHandler=null),this.mResizeUpHandler&&(document.removeEventListener("pointerup",this.mResizeUpHandler),this.mResizeUpHandler=null),this.mResizeState=null}static{gi()}};var Ii=`:host {\r
    display: block;\r
    width: 100%;\r
    height: 100%;\r
}\r
...
\r
    ...
    --pn-node-port-cell-offset: -5.5px;\r
    --pn-node-port-gap: var(--pn-grid-size);\r
    --pn-node-port-tip-size: 5px;\r
    --pn-node-value-port-size: 10px;\r
