...
`;function As(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},m={v:!1};s.addInitializer=p(a,m);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,r,b,v,E,w){var f=u[0],s,m,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?m=h:r===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,A!==void 0&&(m===void 0?m=A:typeof m=="function"?m=[m,A]:m.push(A))}}if(r===0||r===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=m;m=function(I,D){return z.call(I,D)}}l.push(m)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=l,s=s-5,b=b||[],P=b):(x=l.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(a,x,f,m,s,h,i,P,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[C(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return T(n,a,v)}}}}function en(p,t,e,o){return(en=As())(p,t,e,o)}function Ns(p){return p}var rn,Zo,on,nn,sn,an,ln,qo,Jo,Ko,Qo,ko,tn,ie;rn=Y({selector:"potatno-node-selection-popup",template:Wo,style:Yo,components:[qt]}),on=G.state({complexValue:!0}),nn=Dt("searchInput"),sn=vt("node-select"),an=G.state(),ln=G.state();new class extends Ns{constructor(){super(ie),Zo()}static{class p{static{({e:[qo,Jo,Ko,Qo,ko,tn],c:[ie,Zo]}=en(this,[[on,1,"results"],[nn,1,"searchInput"],[sn,1,"mNodeSelect"],[an,1,"searchValue"],[ln,1,"selectedDefinitionId"]],[rn]))}static POPUP_WIDTH=280;static POPUP_HEIGHT=320;mComponent;mManager;#t=(tn(this),qo(this));get results(){return this.#t}set results(e){this.#t=e}#e=Jo(this);get searchInput(){return this.#e}set searchInput(e){this.#e=e}#r=Ko(this);get mNodeSelect(){return this.#r}set mNodeSelect(e){this.#r=e}#o=Qo(this);get searchValue(){return this.#o}set searchValue(e){this.#o=e}#n=ko(this);get selectedDefinitionId(){return this.#n}set selectedDefinitionId(e){this.#n=e}constructor(e=R.use($),o=R.use(H)){this.mManager=o,this.mComponent=e,this.selectedDefinitionId=null,this.results=new Array,this.searchValue=""}onConnect(){this.searchInput?.focus()}onKeyDown(e){if(this.results.length!==0){if(e.key==="ArrowDown"||e.key==="ArrowUp"){e.preventDefault();let o=this.results.findIndex(g=>g.definition.id===this.selectedDefinitionId);o=Math.max(0,o);let c=e.key==="ArrowDown"?1:-1,d=(o+c+this.results.length)%this.results.length;this.selectedDefinitionId=this.results[d].definition.id;return}e.key==="Enter"&&this.sendSelectedEntry(this.selectedDefinitionId)}}onUpdate(){this.rebuildResults();let e=this.mComponent.element.shadowRoot.querySelector(".selection-popup__result.selected");e&&e.scrollIntoView()}stopPropagation(e){e.stopPropagation()}rebuildResults(){if(!this.mManager.activeFunction){this.results=new Array;return}let e=this.mManager.activeFunction.dynamicNodeDefinitions.map(c=>({category:c.category.name,definition:c,label:c.label.toLowerCase(),color:this.mManager.generateStringColor(c.category.name),icon:c.category.icon})),o=this.searchValue.trim().toLowerCase();this.results=e.filter(c=>c.label.includes(o)),this.results.some(c=>c.definition.id===this.selectedDefinitionId)||(this.selectedDefinitionId=this.results[0]?.definition.id??null)}sendSelectedEntry(e){if(e===null)return;let o=this.results.find(c=>c.definition.id===e);o&&this.mNodeSelect.dispatchEvent(o.definition)}}}};var cn=`:host {\r
    display: block;\r
    font-family: var(--potatno-font-family);\r
    font-size: var(--potatno-font-size);\r
    z-index: -1;\r
...
.node-header {\r
    ...
    align-items: center;\r
    color: var(--potatno-color-text);\r
    background-color: var(--node-comment-color);\r
    font-weight: bold;\r
    font-size: var(--potatno-font-size-small);\r
    cursor: grab;\r
\r
...
\r
    ...
    --background-50-color: color-mix(in srgb, var(--background-100-color) 30%, transparent);\r
    --background-10-color: color-mix(in srgb, var(--background-100-color) 10%, transparent);\r
\r
    background-color: var(--background-10-color);\r
    background-image: linear-gradient(180deg, var(--background-100-color) 0%, var(--background-50-color) calc(var(--potatno-grid-size) / 1), transparent calc(var(--potatno-grid-size) * 3));\r
}`;var un=`<!-- Resizeable part of node -->\r
<potatno-resize-box #ResizeBox class="node" top="true" right="true" bottom="true" left="true" [snap]="25" [virtual]="true" (resize)="this.transformNodeData($event.value)">\r
    <div class="node-header" (pointerdown)="this.dragNode($event)">\r
        <span class="node-header__icon">\u270E</span>\r
        <span class="node-header__label">{{this.comment}}</span>\r
    </div>\r
\r
    <div class="node-body"/>\r
</potatno-resize-box>\r
`;function Rs(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},m={v:!1};s.addInitializer=p(a,m);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,r,b,v,E,w){var f=u[0],s,m,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?m=h:r===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,A!==void 0&&(m===void 0?m=A:typeof m=="function"?m=[m,A]:m.push(A))}}if(r===0||r===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=m;m=function(I,D){return z.call(I,D)}}l.push(m)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=l,s=s-5,b=b||[],P=b):(x=l.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(a,x,f,m,s,h,i,P,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[C(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return T(n,a,v)}}}}function gn(p,t,e,o){return(gn=Rs())(p,t,e,o)}var vn,hn,yn,bn,mn,dn,fn,br;vn=Y({selector:"potatno-comment-node",template:un,style:cn,components:[qt]}),yn=vt("node-drag"),bn=Dt("ResizeBox");var pn=class{static{({e:[mn,dn,fn],c:[br,hn]}=gn(this,[[tt,3,"nodeData"],[yn,1,"mDrag"],[bn,1,"resizeBox"]],[vn]))}constructor(t=R.use($),e=R.use(H)){this.mComponent=t,this.mManager=e,this.mNodeData=null,this.mUnsubscribe=this.mManager.subscribe(O.Node,o=>{o.item===this.nodeData&&this.resyncComponent(this.nodeData)})}mComponent;mManager;mUnsubscribe;mNodeData;get nodeData(){return this.mNodeData}set nodeData(t){this.mNodeData=t,t&&(this.resyncComponent(t),this.mComponent.updater.update())}#t=(fn(this),mn(this));get mDrag(){return this.#t}set mDrag(t){this.#t=t}#e=dn(this);get resizeBox(){return this.#e}set resizeBox(t){this.#e=t}get comment(){return this.nodeData?.label??""}onDeconstruct(){this.mUnsubscribe()}onConnect(){this.nodeData&&this.resyncComponent(this.nodeData)}dragNode(t){if(!this.nodeData)return;t.preventDefault();let e=this.nodeData.transformation.x*this.mManager.grid.gridSize,o=this.nodeData.transformation.y*this.mManager.grid.gridSize,c=this.nodeData.transformation.x,d=this.nodeData.transformation.y,g=this.mComponent.element.getBoundingClientRect(),y=this.mComponent.element.offsetWidth?g.width/this.mComponent.element.offsetWidth:1,T=this.mComponent.element.offsetHeight?g.height/this.mComponent.element.offsetHeight:1,C=t.clientX,l=t.clientY,n=a=>{a.stopPropagation();let r=(a.clientX-C)/y,b=(a.clientY-l)/T,v=Math.round((e+r)/this.mManager.grid.gridSize),E=Math.round((o+b)/this.mManager.grid.gridSize);c===v&&d===E||(this.mManager.graph.transformNode(this.nodeData,w=>{w.moveTo(v,E)}),this.mDrag.dispatchEvent(new yr(v-c,E-d)),c=v,d=E)},u=()=>{document.removeEventListener("pointermove",n),document.removeEventListener("pointerup",u)};document.addEventListener("pointermove",n),document.addEventListener("pointerup",u)}transformNodeData(t){this.mManager.graph.transformNode(this.nodeData,e=>{let o=e.transformation.width,c=e.transformation.height;e.resizeTo(t.width/this.mManager.grid.gridSize,t.height/this.mManager.grid.gridSize);let d=e.transformation.width-o,g=e.transformation.height-c;g!==0&&(t.resizeHandle&yt.top)>0&&e.moveTo(e.transformation.x,e.transformation.y-g),d!==0&&(t.resizeHandle&yt.left)>0&&e.moveTo(e.transformation.x-d,e.transformation.y)})}resyncComponent(t){let e=t.transformation.x*this.mManager.grid.gridSize,o=t.transformation.y*this.mManager.grid.gridSize;if(this.mComponent.element.style.setProperty("left",`${e}px`),this.mComponent.element.style.setProperty("top",`${o}px`),this.resizeBox){let c=t.transformation.width*this.mManager.grid.gridSize,d=t.transformation.height*this.mManager.grid.gridSize;this.resizeBox.resize(c,d)}}static{hn()}},yr=class{mX;mY;get x(){return this.mX}get y(){return this.mY}constructor(t,e){this.mX=t,this.mY=e}};var wn=`:host {\r
    position: absolute;\r
    top: 0;\r
    left: 0;\r
    height: 1px;\r
...
`;var xn=`<svg #svgLayer class="svg-layer" xmlns="http://www.w3.org/2000/svg" (pointerdown)="this.onConnectionDelete($event)"></svg>\r
`;function js(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},m={v:!1};s.addInitializer=p(a,m);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,r,b,v,E,w){var f=u[0],s,m,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?m=h:r===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,A!==void 0&&(m===void 0?m=A:typeof m=="function"?m=[m,A]:m.push(A))}}if(r===0||r===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=m;m=function(I,D){return z.call(I,D)}}l.push(m)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=l,s=s-5,b=b||[],P=b):(x=l.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(a,x,f,m,s,h,i,P,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[C(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return T(n,a,v)}}}}function Cn(p,t,e,o){return(Cn=js())(p,t,e,o)}var Pn,Tn,Mn,En,Dn,wr;Pn=Y({selector:"potatno-connection-layer",template:xn,style:wn}),Mn=Dt("svgLayer");var In=class{static{({e:[En,Dn],c:[wr,Tn]}=Cn(this,[[Mn,1,"svgLayer"]],[Pn]))}constructor(t=R.use(H)){this.mConnectionRegistry=new Map,this.mManager=t;let e=0;this.mUnsubscribe=this.mManager.subscribe(O.SpecialActiveFunction|O.Node|O.Connection,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.renderConnections()}))})}mConnectionRegistry;mManager;mUnsubscribe;#t=(Dn(this),En(this));get svgLayer(){return this.#t}set svgLayer(t){this.#t=t}onConnectionDelete(t){if(t.button!==2||!(t.target instanceof Element))return;let e=parseInt(t.target.getAttribute("data-connection-id")??"");if(isNaN(e))return;t.preventDefault(),t.stopPropagation();let o=this.mConnectionRegistry.get(e);o&&this.mManager.graph.disconnectPorts(o.sourcePort,o.targetPort)}onDeconstruct(){this.mUnsubscribe()}renderConnectionPath(t,e,o,c,d){let g="http://www.w3.org/2000/svg",y=this.mManager.connections.getConnectionPath(o,c),T=document.createElementNS(g,"path");T.classList.add("path"),T.classList.toggle(".path--invalid",!d),T.setAttribute("d",y),o.portType==="value"&&T.style.setProperty("--path-color",this.mManager.generateStringColor(o.resolvedDataType));let C=document.createElementNS(g,"path");C.classList.add("path","path--mouse-target"),C.setAttribute("d",y),C.setAttribute("data-connection-id",e.toString()),t.appendChild(T),t.appendChild(C)}renderConnections(){if(!this.svgLayer)return;this.svgLayer.innerHTML="",this.mConnectionRegistry.clear();let t=this.mManager.activeFunction;if(!t)return;let e=this.mManager.integrity.errorItems,o=0;for(let c of t.nodes)for(let d of c.outputs.list)for(let g of d.connectedPorts){let y=o++;this.mConnectionRegistry.set(y,{sourcePort:d,targetPort:g});let T=e.has(d)||e.has(g);this.renderConnectionPath(this.svgLayer,y,d,g,!T)}}static{Tn()}};function zs(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},m={v:!1};s.addInitializer=p(a,m);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,r,b,v,E,w){var f=u[0],s,m,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?m=h:r===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,A!==void 0&&(m===void 0?m=A:typeof m=="function"?m=[m,A]:m.push(A))}}if(r===0||r===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=m;m=function(I,D){return z.call(I,D)}}l.push(m)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=l,s=s-5,b=b||[],P=b):(x=l.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(a,x,f,m,s,h,i,P,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[C(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return T(n,a,v)}}}}function Nn(p,t,e,o){return(Nn=zs())(p,t,e,o)}var Ln,Sn,Pe;Ln=gt({access:W.Read,selector:/^potatno-preview$/});var An=class{static{({c:[Pe,Sn]}=Nn(this,[],[Ln]))}constructor(t=R.use(Q),e=R.use(X),o=R.use(ot)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(o.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let o=this.mTarget.childNodes.length>0;return o&&(this.mTarget.innerHTML=""),o}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{Sn()}};var _n=`:host {\r
    display: block;\r
    position: relative;\r
\r
...
\r
}`;var Bn=`<!-- Resizeable part of node -->\r
...
.selection-box {\r
    ...
    pointer-events: none;\r
    z-index: 1000;\r
}`;var ii=`<!-- Serves only as a background. -->\r
...
`;function Zs(){function p(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var f;switch(r){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},m={v:!1};s.addInitializer=p(a,m);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,r,b,v,E,w){var f=u[0],s,m,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,P;if(typeof f=="function")h=t(f,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?m=h:r===1?(m=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,A!==void 0&&(m===void 0?m=A:typeof m=="function"?m=[m,A]:m.push(A))}}if(r===0||r===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=m;m=function(I,D){return z.call(I,D)}}l.push(m)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],m=f[2],i=f.length>3,h=s>=5,x,P;if(h?(x=l,s=s-5,b=b||[],P=b):(x=l.prototype,r=r||[],P=r),s!==0&&!i){var M=h?E:v,S=M.get(m)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!S&&s>2?M.set(m,s):M.set(m,!0)}d(a,x,f,m,s,h,i,P,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[C(r,u),function(){for(var f=0;f<a.length;f++)a[f].call(r)}]}}function C(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return T(n,a,v)}}}}function ui(p,t,e,o){return(ui=Zs())(p,t,e,o)}function qs(p){return p}var hi,si,mi,di,ai,li,ci,Ke;hi=Y({selector:"potatno-node-graph",template:ii,style:ni,components:[ie,Tr,br,wr]}),mi=G.state({complexValue:!0}),di=G.state();new class extends qs{constructor(){super(Ke),si()}static{class p{static{({e:[ai,li,ci],c:[Ke,si]}=ui(this,[[mi,1,"selectBox"],[di,1,"popupPosition"]],[hi]))}static ZOOM_STRENGTH=.1;mComponent;mManager;mSelectedNodes;mKeyboardHandler;mIsMouseInsideGrid;mUnsubscribeFunctionChange;mUnsubscribeGraphChange;#t=(ci(this),ai(this));get selectBox(){return this.#t}set selectBox(e){this.#t=e}#e=li(this);get popupPosition(){return this.#e}set popupPosition(e){this.#e=e}get gridBackgroundStyle(){let e=this.mManager.grid.gridSize*this.mManager.grid.zoom,o=this.mManager.grid.panX%e,c=this.mManager.grid.panY%e;return`background-size: ${e}px ${e}px; background-position: ${o}px ${c}px;`}get gridTransformStyle(){return`transform: translate(${this.mManager.grid.panX}px, ${this.mManager.grid.panY}px) scale(${this.mManager.grid.zoom})`}get nodes(){return this.mManager.activeFunction?this.mManager.activeFunction.nodes:new Set}get selectedNode(){return this.mSelectedNodes}constructor(e=R.use($),o=R.use(H)){this.mComponent=e,this.mManager=o,this.mSelectedNodes=new Set,this.mIsMouseInsideGrid=!1,this.popupPosition=null,this.selectBox=null,e.element.addEventListener("pointerdown",c=>{this.onPointerDown(c)}),e.element.addEventListener("wheel",c=>{this.onScroll(c)}),e.element.addEventListener("contextmenu",c=>{c.preventDefault()}),e.element.addEventListener("pointerenter",()=>{this.mIsMouseInsideGrid=!0}),e.element.addEventListener("pointerleave",()=>{this.mIsMouseInsideGrid=!1}),this.mKeyboardHandler=c=>{this.onKeyDown(c)},document.addEventListener("keydown",this.mKeyboardHandler),this.mUnsubscribeFunctionChange=this.mManager.subscribe(O.Document|O.Function|O.SpecialActiveFunction,()=>{this.popupPosition=null,this.selectBox=null,this.clearSelection()}),this.mUnsubscribeGraphChange=this.mManager.subscribe(O.NodeAdd|O.NodeDelete|O.SpecialGrid,()=>{this.mComponent.updater.updateAsync()})}onConnect(){this.mManager.connections.gridElement=this.mComponent.element}onDeconstruct(){this.mUnsubscribeFunctionChange(),this.mUnsubscribeGraphChange(),document.removeEventListener("keydown",this.mKeyboardHandler)}onPointerDown(e){switch(this.popupPosition=null,e.button){case 0:{e.ctrlKey||this.clearSelection(),this.pointerDrag(e,"selecting");return}case 1:{e.preventDefault(),this.pointerDrag(e,"panning");return}case 2:{this.openAddNodePopupAtPointer(e.clientX,e.clientY);return}}}onScroll(e){e.preventDefault();let o=e.deltaY>0?-1:1,c=this.convertGlobalToGridPosition(e.clientX,e.clientY);this.mManager.grid.zoomAt(c.x,c.y,o*p.ZOOM_STRENGTH)}createNodeOnPopupPosition(e){if(!this.mManager.activeFunction)return;let o=this.mManager.graph.addNode(this.mManager.activeFunction,e,{x:this.popupPosition?.grid.x??0,y:this.popupPosition?.grid.y??0,height:0,width:0});this.popupPosition=null,this.clearSelection(),this.mSelectedNodes.add(o)}typeOfNode(e){switch(e.definitionId){case Ft.DEFINITION_ID:return"comment";case wt.DEFINITION_ID:case bt.DEFINITION_ID:return"conjunction";default:return"node"}}pointerDrag(e,o){let c=this.convertGlobalToGridPosition(e.clientX,e.clientY),d=c,g=T=>{let C=this.convertGlobalToGridPosition(T.clientX,T.clientY);switch(o){case"panning":{this.mManager.grid.pan(C.x-d.x,C.y-d.y);break}case"selecting":{this.selectBox={x:Math.min(c.x,C.x),y:Math.min(c.y,C.y),width:Math.abs(C.x-c.x),height:Math.abs(C.y-c.y)};break}}d=C},y=()=>{if(document.removeEventListener("pointermove",g),document.removeEventListener("pointerup",y),o==="selecting"&&this.selectBox){let T=this.convertLocalToGridCoordinate(this.selectBox.x,this.selectBox.y),C=this.convertLocalToGridCoordinate(this.selectBox.x+this.selectBox.width,this.selectBox.y+this.selectBox.height),l=this.mManager.grid.gridSize;this.selectNodesInRectangle({top:T.y/l,right:C.x/l,bottom:C.y/l,left:T.x/l}),this.selectBox=null}};document.addEventListener("pointermove",g),document.addEventListener("pointerup",y)}onKeyDown(e){if(!this.mIsMouseInsideGrid)return;let o=document.activeElement;if(!(o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement||o instanceof HTMLSelectElement)){switch(e.key){case"Escape":{this.popupPosition=null;return}case"Delete":{for(let c of this.mSelectedNodes)this.mManager.graph.removeNode(c);this.clearSelection();return}}if(e.ctrlKey)switch(e.key){case"z":{e.preventDefault(),this.mManager.history.undo();return}case"y":{e.preventDefault(),this.mManager.history.redo();return}case"c":{this.mManager.clipboard.copy(this.mSelectedNodes);return}case"v":e.preventDefault(),this.pasteFromClipboard()}}}convertGlobalToGridPosition(e,o){let c=this.mComponent.element.getBoundingClientRect();return{x:e-c.left,y:o-c.top}}moveAllSelected(e,o){for(let c of this.mSelectedNodes)c!==e&&this.mManager.graph.transformNode(c,d=>{d.moveTo(d.transformation.x+o.x,d.transformation.y+o.y)})}selectNode(e,o){e.stopPropagation(),this.popupPosition=null,e.ctrlKey?this.mSelectedNodes.has(o)?this.mSelectedNodes.delete(o):this.mSelectedNodes.add(o):this.mSelectedNodes.has(o)||(this.clearSelection(),this.mSelectedNodes.add(o)),this.mComponent.updater.updateAsync()}openAddNodePopupAtPointer(e,o){let c=this.mComponent.element,d=this.convertGlobalToGridPosition(e,o),g=this.convertLocalToGridCoordinate(d.x,d.y),y=8,T=Math.max(0,c.clientWidth-ie.POPUP_WIDTH-y),C=Math.max(0,c.clientHeight-ie.POPUP_HEIGHT-y);this.popupPosition={local:{x:Math.max(y,Math.min(d.x,T)),y:Math.max(y,Math.min(d.y,C))},grid:{x:Math.round(g.x/this.mManager.grid.gridSize),y:Math.round(g.y/this.mManager.grid.gridSize)}}}convertLocalToGridCoordinate(e,o){return{x:(e-this.mManager.grid.panX)/this.mManager.grid.zoom,y:(o-this.mManager.grid.panY)/this.mManager.grid.zoom}}clearSelection(){this.mSelectedNodes.clear(),this.mComponent.updater.updateAsync()}pasteFromClipboard(){if(!this.mManager.activeFunction)return;let o=this.mManager.clipboard.paste();if(o.length!==0){this.clearSelection();for(let c of o)this.mSelectedNodes.add(c)}}selectNodesInRectangle(e){let o=this.mManager.activeFunction;if(o)for(let c of o.nodes){let d=c.transformation.y,g=c.transformation.x,y=g+c.transformation.width,T=d+c.transformation.height;g<e.right&&y>e.left&&d<e.bottom&&T>e.top&&this.mSelectedNodes.add(c)}}}}};var se=class{mCodeGenerator;mId;mLabel;mNodesProvider;mStatics;get codeGenerator(){return this.mCodeGenerator}get id(){return this.mId}get label(){return this.mLabel}get statics(){return this.mStatics}constructor(t){this.mId=t.id,this.mLabel=t.label,this.mNodesProvider=t.nodes,this.mStatics=t.statics,this.mCodeGenerator=t.generator.code}getNodeDefinitions(t){let e=c=>{if(!c)return new Array;let d=new Array;return c(g=>{d.push(g)},t),d},o={};return Object.defineProperty(o,"entry",{get:()=>e(this.mNodesProvider.entry)}),Object.defineProperty(o,"exit",{get:()=>e(this.mNodesProvider.exit)}),Object.defineProperty(o,"dynamic",{get:()=>e(this.mNodesProvider.dynamic)}),o}},Rt={none:0,imports:1,inputs:2,outputs:4};var fi=`:host {\r
    display: flex;\r
    flex-direction: column;\r
    height: 100%;\r
    overflow: hidden;\r
...
}`;var pi=`<potatno-resize-box class="resize-box" left="true">\r
\r
    <!-- Function name -->\r
    <div class="section">\r
