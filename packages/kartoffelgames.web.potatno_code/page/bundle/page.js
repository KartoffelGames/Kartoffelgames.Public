...
`;function Xc(){function v(l,o){return function(c){e(o,"addInitializer"),i(c,"An initializer"),l.push(c)}}function t(l,o,u,c,r,b,d,T,x){var m;switch(r){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:d?"#"+o:o,static:b,private:d,metadata:T},f={v:!1};s.addInitializer=v(c,f);var n,a;if(r===0?d?(n=u.get,a=u.set):(n=function(){return this[o]},a=function(p){this[o]=p}):r===2?n=function(){return u.value}:((r===1||r===3)&&(n=function(){return u.get.call(this)}),(r===1||r===4)&&(a=function(p){u.set.call(this,p)})),d)s.access=n&&a?{get:n,set:a}:n?{get:n}:{set:a};else{if(n){var I=n;n=function(p){return arguments.length===0&&(p=this),I.call(p)}}if(a){var M=a;a=function(p,P){return arguments.length===1&&(P=p,p=this),M.call(p,P)}}var D=function(p){return o in p};s.access=n&&a?{has:D,get:n,set:a}:n?{has:D,get:n}:{has:D,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,o){if(l.v)throw new Error("attempted to call "+o+" after decoration was finished")}function i(l,o){if(typeof l!="function")throw new TypeError(o+" must be a function")}function h(l,o){var u=typeof o;if(l===1){if(u!=="object"||o===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");o.get!==void 0&&i(o.get,"accessor.get"),o.set!==void 0&&i(o.set,"accessor.set"),o.init!==void 0&&i(o.init,"accessor.init")}else if(u!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function g(l,o,u,c,r,b,d,T,x){var m=u[0],s,f,n;d?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(o,c)),r===1?n={get:s.get,set:s.set}:r===2?n=s.value:r===3?n=s.get:r===4&&(n=s.set);var a,I,M;if(typeof m=="function")a=t(m,c,s,T,r,b,d,x,n),a!==void 0&&(h(r,a),r===0?f=a:r===1?(f=a.init,I=a.get||n.get,M=a.set||n.set,n={get:I,set:M}):n=a);else for(var D=m.length-1;D>=0;D--){var p=m[D];if(a=t(p,c,s,T,r,b,d,x,n),a!==void 0){h(r,a);var P;r===0?P=a:r===1?(P=a.init,I=a.get||n.get,M=a.set||n.set,n={get:I,set:M}):n=a,P!==void 0&&(f===void 0?f=P:typeof f=="function"?f=[f,P]:f.push(P))}}if(r===0||r===1){if(f===void 0)f=function(_,E){return E};else if(typeof f!="function"){var O=f;f=function(_,E){for(var N=E,L=0;L<O.length;L++)N=O[L].call(_,N);return N}}else{var z=f;f=function(_,E){return z.call(_,E)}}l.push(f)}r!==0&&(r===1?(s.get=n.get,s.set=n.set):r===2?s.value=n:r===3?s.get=n:r===4&&(s.set=n),d?r===1?(l.push(function(_,E){return n.get.call(_,E)}),l.push(function(_,E){return n.set.call(_,E)})):r===2?l.push(n):l.push(function(_,E){return n.call(_,E)}):Object.defineProperty(o,c,s))}function y(l,o,u){for(var c=[],r,b,d=new Map,T=new Map,x=0;x<o.length;x++){var m=o[x];if(Array.isArray(m)){var s=m[1],f=m[2],n=m.length>3,a=s>=5,I,M;if(a?(I=l,s=s-5,b=b||[],M=b):(I=l.prototype,r=r||[],M=r),s!==0&&!n){var D=a?T:d,p=D.get(f)||0;if(p===!0||p===3&&s!==4||p===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!p&&s>2?D.set(f,s):D.set(f,!0)}g(c,I,m,f,s,a,n,M,u)}}return w(c,r),w(c,b),c}function w(l,o){o&&l.push(function(u){for(var c=0;c<o.length;c++)o[c].call(u);return u})}function C(l,o,u){if(o.length>0){for(var c=[],r=l,b=l.name,d=o.length-1;d>=0;d--){var T={v:!1};try{var x=o[d](r,{kind:"class",name:b,addInitializer:v(c,T),metadata:u})}finally{T.v=!0}x!==void 0&&(h(10,x),r=x)}return[S(r,u),function(){for(var m=0;m<c.length;m++)c[m].call(r)}]}}function S(l,o){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:o})}return function(o,u,c,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var d=Object.create(b===void 0?null:b),T=y(o,u,d);return c.length||S(o,d),{e:T,get c(){return C(o,c,d)}}}}function On(v,t,e,i){return(On=Xc())(v,t,e,i)}var Fn,_n,zn,jn,Vn,Bn,$n,Gn,Un,Hn,Pn,Sn,An,Nn,Ln,Yt;Fn=$({selector:"kg-list-item",template:Mn,style:In}),zn=B(),jn=V.state(),Vn=B(),Bn=V.state(),$n=V.state(),Gn=B(),Un=V.state(),Hn=B();var Rn=class{static{({e:[Pn,Sn,An,Nn,Ln],c:[Yt,_n]}=On(this,[[[zn,jn],1,"icon"],[[Vn,Bn],1,"barcolor"],[$n,1,"mSelectable"],[Gn,3,"selectable"],[Un,1,"mSelected"],[Hn,3,"selected"]],[Fn]))}constructor(){this.icon="",this.barcolor="",this.mSelectable=!1,this.mSelected=!1}#t=(Ln(this),Pn(this));get icon(){return this.#t}set icon(t){this.#t=t}#e=Sn(this);get barcolor(){return this.#e}set barcolor(t){this.#e=t}#r=An(this);get mSelectable(){return this.#r}set mSelectable(t){this.#r=t}get selectable(){return this.mSelectable}set selectable(t){this.mSelectable=this.parseBoolean(t)}#o=Nn(this);get mSelected(){return this.#o}set mSelected(t){this.#o=t}get selected(){return this.mSelected}set selected(t){this.mSelected=this.parseBoolean(t)}parseBoolean(t){if(typeof t=="string"){if(t==="")return!0;let e=t.toLowerCase();if(e==="true"||e==="false")return e==="true"}return!!t}static{_n()}};var Xn=`:host {\r
...
}`;var wa=`<div class="node {{this.selected ? 'selected' : ''}}" style="--type-color: {{this.portColor}}" (pointerup)="this.onDrop($event)">\r
\r
    <div class="port input" drop-handler [title]="this.portValueType" (drag-start)="this.onDragStart()" (drag-end)="this.onDragEnd()">\r
...
`;var Za=`<div class="port-wrapper {{this.portDirection}}" style="--type-color: {{this.portColor}}" (pointerup)="this.onDrop($event)">\r
\r
    <!-- Actual port handle. -->\r
    <div class="port" drop-handler [title]="this.portValueType" (drag-start)="this.onDragStart()" (drag-end)="this.onDragEnd()">\r
