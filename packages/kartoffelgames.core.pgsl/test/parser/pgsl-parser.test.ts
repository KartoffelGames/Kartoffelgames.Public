...
Deno.test('PgslParser.parse()', async (pContext) => {
    await pContext.step('Module scope variable declarations', async (pContext) => {
        ...
        await pContext.step('Const declaration', async (pContext) => {
        ...
        await pContext.step('Param declaration', async (pContext) => {
            await pContext.step('Declaration with const value', () => {
                // Setup.
                const lSourceCode: string = `
        ...
        await pContext.step('Private declaration', async (pContext) => {
        ...
        await pContext.step('Workgroup declaration', async (pContext) => {
        ...
        await pContext.step('Uniform declaration', async (pContext) => {
            await pContext.step('Declaration with const value', () => {
                // Setup.
                const lSourceCode: string = `
        ...
        await pContext.step('Storage declaration', async (pContext) => {
