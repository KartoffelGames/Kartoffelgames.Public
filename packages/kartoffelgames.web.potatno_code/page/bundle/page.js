...
\r
    <div class="drag-area" drop-handler (drag-move)="this.dragNode($event)" (pointerdown)="this.removeNode($event)"/>\r
\r
...
\r
    ...
    <!-- Header -->\r
    <div class="node-header" drop-handler (drag-move)="this.dragNode($event)" (pointerdown)="this.removeNode($event)">\r
        <span class="node-header__bar"></span>\r
