...
`});var _s,Ys=d(()=>{_s=`<div class="editor-layout">\r
...
`});var ea,Qs=d(()=>{ea=`<div #viewport class="viewport" (pointerdown)="this.onPointerDown($event)" (pointermove)="this.onPointerMove($event)" (pointerup)="this.onPointerUp($event)" (wheel)="this.onWheel($event)" (contextmenu)="this.onContextMenu($event)" (keydown)="this.onKeyDown($event)" tabindex="0">\r
...
`});var ba,ga=d(()=>{ba=`<div class="function-list-content">\r
...
</div>`});var Ta,va,Pa,xa,Ca,Ia,wa,ee,Ar,Sr,Lr,Oe,Mr=d(()=>{me();ya();ga();wa=[z({selector:"potatno-function-list",template:ba,style:fa})];Oe=class extends(Ia=E,Ca=[w],xa=[w],Pa=[O("function-select")],va=[O("function-add")],Ta=[O("function-delete")],Ia){constructor(){super(...arguments);b(this,"functions",u(ee,20,this,[])),u(ee,23,this);b(this,"activeFunctionId",u(ee,24,this,"")),u(ee,27,this);k(this,Ar,u(ee,8,this)),u(ee,11,this);k(this,Sr,u(ee,12,this)),u(ee,15,this);k(this,Lr,u(ee,16,this)),u(ee,19,this)}getEntryClass(t){return t===this.activeFunctionId?"function-entry active":"function-entry"}onFunctionSelect(t){this.mFunctionSelect.dispatchEvent(t)}onFunctionAdd(){this.mFunctionAdd.dispatchEvent(void 0)}onFunctionDelete(t,n){t.stopPropagation(),this.mFunctionDelete.dispatchEvent(n)}};ee=D(Ia),Ar=new WeakMap,Sr=new WeakMap,Lr=new WeakMap,y(ee,4,"mFunctionSelect",Pa,Oe,Ar),y(ee,4,"mFunctionAdd",va,Oe,Sr),y(ee,4,"mFunctionDelete",Ta,Oe,Lr),y(ee,5,"functions",Ca,Oe),y(ee,5,"activeFunctionId",xa,Oe),Oe=y(ee,0,"PotatnoFunctionList",wa,Oe),u(ee,1,Oe)});var Na,Ea=d(()=>{Na=`:host {\r
    display: block;\r
    width: 100%;\r
    font-family: var(--pn-font-family);\r
    font-size: var(--pn-font-size);\r
...
`});var Da,ka=d(()=>{Da=`$if(this.nodeData) {\r
    $if(this.isReroute) {\r
...
`});var Ma,La=d(()=>{Ma=`<div [className]="this.portWrapperClasses" [title]="this.type">\r
...
`});var Ra,Oa,Fa,Ga,Ba,ja,Va,Ua,za,$a,Ha,Ka,Xa,Wa,B,Rr,Or,Fr,Gr,re,Br=d(()=>{me();Aa();La();Wa=[z({selector:"potatno-port",template:Ma,style:Sa})];re=class extends(Xa=E,Ka=[w],Ha=[w],$a=[w],za=[w],Ua=[w],Va=[w],ja=[w],Ba=[w],Ga=[O("port-drag-start")],Fa=[O("port-hover")],Oa=[O("port-leave")],Ra=[oe("portCircle")],Xa){constructor(){super(...arguments);b(this,"name",u(B,24,this,"")),u(B,27,this);b(this,"type",u(B,28,this,"")),u(B,31,this);b(this,"portId",u(B,32,this,"")),u(B,35,this);b(this,"nodeId",u(B,36,this,"")),u(B,39,this);b(this,"direction",u(B,40,this,"input")),u(B,43,this);b(this,"connected",u(B,44,this,!1)),u(B,47,this);b(this,"invalid",u(B,48,this,!1)),u(B,51,this);b(this,"portKind",u(B,52,this,"data")),u(B,55,this);k(this,Rr,u(B,8,this)),u(B,11,this);k(this,Or,u(B,12,this)),u(B,15,this);k(this,Fr,u(B,16,this)),u(B,19,this);k(this,Gr,u(B,20,this)),u(B,23,this)}get portWrapperClasses(){return this.direction==="output"?"port-wrapper direction-output":"port-wrapper direction-input"}get portCircleClasses(){let t=["port-circle"];return this.connected?t.push("connected"):t.push("disconnected"),this.invalid&&t.push("invalid"),t.push(this.direction==="output"?"direction-output":"direction-input"),t.join(" ")}get portColor(){return this.portKind==="flow"?"var(--pn-text-primary)":this.getTypeColor(this.type)}onPointerDown(t){t.stopPropagation(),t.preventDefault(),this.mPortDragStart.dispatchEvent({nodeId:this.nodeId,portId:this.portId,portKind:this.portKind,direction:this.direction,type:this.type,element:this.portCircleElement})}onPointerEnter(t){this.mPortHover.dispatchEvent({nodeId:this.nodeId,portId:this.portId,portKind:this.portKind,direction:this.direction,type:this.type,element:this.portCircleElement})}onPointerLeave(t){this.mPortLeave.dispatchEvent(void 0)}getTypeColor(t){let n=0;for(let s=0;s<t.length;s++)n=t.charCodeAt(s)+((n<<5)-n);return`hsl(${Math.abs(n)%256*137.508%360}, 70%, 60%)`}};B=D(Xa),Rr=new WeakMap,Or=new WeakMap,Fr=new WeakMap,Gr=new WeakMap,y(B,4,"mPortDragStart",Ga,re,Rr),y(B,4,"mPortHover",Fa,re,Or),y(B,4,"mPortLeave",Oa,re,Fr),y(B,4,"portCircleElement",Ra,re,Gr),y(B,5,"name",Ka,re),y(B,5,"type",Ha,re),y(B,5,"portId",$a,re),y(B,5,"nodeId",za,re),y(B,5,"direction",Ua,re),y(B,5,"connected",Va,re),y(B,5,"invalid",ja,re),y(B,5,"portKind",Ba,re),re=y(B,0,"PotatnoPortComponent",Wa,re),u(B,1,re)});var Za,Ya,_a,qa,Ja,Qa,el,tl,nl,ol,rl,il,sl,al,ll,M,jr,Vr,Ur,zr,$r,Hr,Kr,Xr,Wr,Zr,te,cl=d(()=>{me();it();Ea();ka();Br();ll=[z({selector:"potatno-node",template:Da,style:Na})];te=class extends(al=E,sl=[w],il=[w],rl=[w],ol=[oe("NodePreview")],nl=[O("node-select")],tl=[O("node-drag-start")],el=[O("port-drag-start")],Qa=[O("port-hover")],Ja=[O("port-leave")],qa=[O("open-function")],_a=[O("value-change")],Ya=[O("comment-change")],Za=[O("resize-start")],al){constructor(){super(...arguments);b(this,"nodeData",u(M,48,this,null)),u(M,51,this);b(this,"selected",u(M,52,this,!1)),u(M,55,this);b(this,"gridSize",u(M,56,this,20)),u(M,59,this);k(this,jr,u(M,8,this)),u(M,11,this);k(this,Vr,u(M,12,this)),u(M,15,this);k(this,Ur,u(M,16,this)),u(M,19,this);k(this,zr,u(M,20,this)),u(M,23,this);k(this,$r,u(M,24,this)),u(M,27,this);k(this,Hr,u(M,28,this)),u(M,31,this);k(this,Kr,u(M,32,this)),u(M,35,this);k(this,Xr,u(M,36,this)),u(M,39,this);k(this,Wr,u(M,40,this)),u(M,43,this);k(this,Zr,u(M,44,this)),u(M,47,this)}get nodeStyle(){return this.nodeData?`left: ${this.nodeData.position.x*this.gridSize}px; top: ${this.nodeData.position.y*this.gridSize}px; width: ${this.nodeData.size.w*this.gridSize}px;`:""}get nodeId(){return this.nodeData?.id??""}get selectedClass(){return this.selected?"selected":""}get isComment(){return this.nodeData?.category==="comment"}get isReroute(){return this.nodeData?.category==="reroute"}get commentSizeStyle(){return this.nodeData?`height: ${this.nodeData.size.h*this.gridSize}px;`:""}get isValue(){return this.nodeData?.category==="value"}get isFunction(){return this.nodeData?.category==="function"}get showOpenButton(){return!1}get inputPorts(){return this.nodeData?.inputs??[]}get outputPorts(){return this.nodeData?.outputs??[]}get flowInputPorts(){return this.nodeData?.flowInputs??[]}get flowOutputPorts(){return this.nodeData?.flowOutputs??[]}get hasPreviewElement(){return this.nodeData?.previewElement!==null&&this.nodeData?.previewElement!==void 0}onUpdate(){let t=this.nodeData?.previewElement,n=this.mPreviewContainer;n&&t&&t.parentElement!==n&&(n.innerHTML="",n.appendChild(t))}onNodePointerDown(t){t.target.tagName?.toLowerCase()!=="potatno-port"&&(this.mNodeSelect.dispatchEvent({nodeId:this.nodeId,shiftKey:t.shiftKey}),this.mNodeDragStart.dispatchEvent({nodeId:this.nodeId,startX:t.clientX,startY:t.clientY}))}onPortDragStart(t){this.mPortDragStart.dispatchEvent(t.value)}onPortHover(t){this.mPortHover.dispatchEvent(t.value)}onPortLeave(t){this.mPortLeave.dispatchEvent(void 0)}onOpenFunction(t){t.stopPropagation(),this.mOpenFunction.dispatchEvent({definitionName:this.nodeData?.definitionName??""})}onValueInput(t){let n=t.target;this.mValueChange.dispatchEvent({nodeId:this.nodeId,property:"value",value:n.value})}onCommentInput(t){let n=t.target;this.mCommentChange.dispatchEvent({nodeId:this.nodeId,text:n.value})}onResizeStart(t){t.stopPropagation(),t.preventDefault(),this.mResizeStart.dispatchEvent({nodeId:this.nodeId,startX:t.clientX,startY:t.clientY})}};M=D(al),jr=new WeakMap,Vr=new WeakMap,Ur=new WeakMap,zr=new WeakMap,$r=new WeakMap,Hr=new WeakMap,Kr=new WeakMap,Xr=new WeakMap,Wr=new WeakMap,Zr=new WeakMap,y(M,4,"mPreviewContainer",ol,te,jr),y(M,4,"mNodeSelect",nl,te,Vr),y(M,4,"mNodeDragStart",tl,te,Ur),y(M,4,"mPortDragStart",el,te,zr),y(M,4,"mPortHover",Qa,te,$r),y(M,4,"mPortLeave",Ja,te,Hr),y(M,4,"mOpenFunction",qa,te,Kr),y(M,4,"mValueChange",_a,te,Xr),y(M,4,"mCommentChange",Ya,te,Wr),y(M,4,"mResizeStart",Za,te,Zr),y(M,5,"nodeData",sl,te),y(M,5,"selected",il,te),y(M,5,"gridSize",rl,te),te=y(M,0,"PotatnoNodeComponent",ll,te),u(M,1,te)});var dl,ul=d(()=>{dl=`:host {\r
    display: flex;\r
    flex-direction: column;\r
    height: 100%;\r
    overflow: hidden;\r
...
`});var ml,pl=d(()=>{ml=`<div class="search-wrapper">\r
...
</div>`});var hl,yl,fl,gl,nt,Yr,It,_r=d(()=>{me();it();ul();pl();gl=[z({selector:"potatno-node-library",template:ml,style:dl})];It=class extends(fl=E,yl=[O("node-drag-start")],hl=[w],fl){constructor(){super(...arguments);u(nt,5,this);b(this,"mNodeDefinitions",[]);b(this,"mCachedFilteredGroups",[]);k(this,Yr,u(nt,8,this)),u(nt,11,this);b(this,"mSearchQuery","");b(this,"mCollapsedCategories",{})}set nodeDefinitions(t){this.mNodeDefinitions=t,this.rebuildFilteredGroups()}get nodeDefinitions(){return this.mNodeDefinitions}get filteredGroups(){return this.mCachedFilteredGroups}rebuildFilteredGroups(){let t=this.mSearchQuery.toLowerCase(),n=new Map;for(let s of this.mNodeDefinitions){if(t&&!s.name.toLowerCase().includes(t))continue;let a=n.get(s.category);a||(a=[],n.set(s.category,a)),a.push(s)}let o=[],i=Object.values(Ke);for(let s of i){let a=n.get(s);if(a&&a.length>0){let l=kt.get(s);o.push({category:s,icon:l.icon,label:l.label,cssColor:l.cssColor,nodes:a})}}this.mCachedFilteredGroups=o}onSearchInput(t){this.mSearchQuery=t.target.value,this.rebuildFilteredGroups()}toggleCategory(t){this.mCollapsedCategories[t]=!this.mCollapsedCategories[t],this.rebuildFilteredGroups()}isCategoryCollapsed(t){return!!this.mCollapsedCategories[t]}getToggleClass(t){return this.mCollapsedCategories[t]?"category-toggle collapsed":"category-toggle"}onNodeMouseDown(t){this.mNodeDragStart.dispatchEvent(t)}};nt=D(fl),Yr=new WeakMap,y(nt,4,"mNodeDragStart",yl,It,Yr),y(nt,3,"nodeDefinitions",hl,It),It=y(nt,0,"PotatnoNodeLibrary",gl,It),u(nt,1,It)});var Tl,bl=d(()=>{Tl=`:host {\r
    display: flex;\r
    flex-direction: column;\r
    height: 100%;\r
    overflow: hidden;\r
...
`});var Pl,vl=d(()=>{Pl=`<div class="tab-bar">\r
...
</div>`});var xl,Cl,Il,wl,El,Nl,kl,Dl,Al,X,qr,Jr,Qr,ei,Ne,Sl=d(()=>{me();bl();vl();_r();Mr();Al=[z({selector:"potatno-panel-left",template:Pl,style:Tl})];Ne=class extends(Dl=E,kl=[w],Nl=[w],El=[w],wl=[O("node-drag-start")],Il=[O("function-select")],Cl=[O("function-add")],xl=[O("function-delete")],Dl){constructor(){super(...arguments);b(this,"nodeDefinitions",u(X,24,this,[])),u(X,27,this);b(this,"functions",u(X,28,this,[])),u(X,31,this);b(this,"activeFunctionId",u(X,32,this,"")),u(X,35,this);k(this,qr,u(X,8,this)),u(X,11,this);k(this,Jr,u(X,12,this)),u(X,15,this);k(this,Qr,u(X,16,this)),u(X,19,this);k(this,ei,u(X,20,this)),u(X,23,this);b(this,"mActiveTabIndex",0)}get activeTabIndex(){return this.mActiveTabIndex}getTabClass(t){return t===this.mActiveTabIndex?"tab-button active":"tab-button"}onTabClick(t){this.mActiveTabIndex=t}onNodeDragStart(t){this.mNodeDragStart.dispatchEvent(t.value)}onFunctionSelect(t){this.mFunctionSelect.dispatchEvent(t.value)}onFunctionAdd(t){this.mFunctionAdd.dispatchEvent(void 0)}onFunctionDelete(t){this.mFunctionDelete.dispatchEvent(t.value)}};X=D(Dl),qr=new WeakMap,Jr=new WeakMap,Qr=new WeakMap,ei=new WeakMap,y(X,4,"mNodeDragStart",wl,Ne,qr),y(X,4,"mFunctionSelect",Il,Ne,Jr),y(X,4,"mFunctionAdd",Cl,Ne,Qr),y(X,4,"mFunctionDelete",xl,Ne,ei),y(X,5,"nodeDefinitions",kl,Ne),y(X,5,"functions",Nl,Ne),y(X,5,"activeFunctionId",El,Ne),Ne=y(X,0,"PotatnoPanelLeft",Al,Ne),u(X,1,Ne)});var Ml,Ll=d(()=>{Ml=`:host {\r
    display: flex;\r
    flex-direction: column;\r
    height: 100%;\r
    overflow: hidden;\r
...
`});var Ol,Rl=d(()=>{Ol=`<div class="properties-header">Properties</div>\r
...
`});var ql,_l=d(()=>{ql=`<div class="resize-handle" (pointerdown)="this.onResizePointerDown($event)"></div>\r
...
`});var cc,lc=d(()=>{cc=`<div [className]="this.getHandleClass()" (pointerdown)="this.onPointerDown($event)"></div>\r
`});var uc,dc,pc,mc,He,ri,wt,hc=d(()=>{me();sc();lc();mc=[z({selector:"potatno-resize-handle",template:cc,style:ac})];wt=class extends(pc=E,dc=[w],uc=[O("resize")],pc){constructor(){super(...arguments);b(this,"direction",u(He,12,this,"vertical")),u(He,15,this);k(this,ri,u(He,8,this)),u(He,11,this);b(this,"mDragging",!1);b(this,"mStartPosition",0)}getHandleClass(){return`resize-handle ${this.direction}`}onPointerDown(t){t.preventDefault(),this.mDragging=!0,this.mStartPosition=this.direction==="vertical"?t.clientX:t.clientY,t.target.setPointerCapture(t.pointerId);let n=i=>{if(!this.mDragging)return;let s=this.direction==="vertical"?i.clientX:i.clientY,a=s-this.mStartPosition;this.mStartPosition=s,this.mResize.dispatchEvent({delta:a})},o=i=>{this.mDragging=!1,i.target.releasePointerCapture(i.pointerId),document.removeEventListener("pointermove",n),document.removeEventListener("pointerup",o)};document.addEventListener("pointermove",n),document.addEventListener("pointerup",o)}};He=D(pc),ri=new WeakMap,y(He,4,"mResize",uc,wt,ri),y(He,5,"direction",dc,wt),wt=y(He,0,"PotatnoResizeHandle",mc,wt),u(He,1,wt)});var fc,yc=d(()=>{fc=`.search-wrapper {\r
    display: flex;\r
    align-items: center;\r
    background: var(--pn-bg-surface);\r
    border: 1px solid var(--pn-border-default);\r
...
`});var bc,gc=d(()=>{bc=`<div class="search-wrapper">\r
...
`});var Tc,vc,Pc,xc,Cc,ke,ii,ot,Ic=d(()=>{me();yc();gc();Cc=[z({selector:"potatno-search-input",template:bc,style:fc})];ot=class extends(xc=E,Pc=[w],vc=[w],Tc=[O("search-change")],xc){constructor(){super(...arguments);b(this,"placeholder",u(ke,12,this,"Search...")),u(ke,15,this);b(this,"value",u(ke,16,this,"")),u(ke,19,this);k(this,ii,u(ke,8,this)),u(ke,11,this)}onInput(t){let n=t.target;this.value=n.value,this.mSearchChange.dispatchEvent(this.value)}};ke=D(xc),ii=new WeakMap,y(ke,4,"mSearchChange",Tc,ot,ii),y(ke,5,"placeholder",Pc,ot),y(ke,5,"value",vc,ot),ot=y(ke,0,"PotatnoSearchInput",Cc,ot),u(ke,1,ot)});var Ec,wc=d(()=>{Ec=`.tabs-header {\r
    display: flex;\r
    background: var(--pn-bg-secondary);\r
    border-bottom: 1px solid var(--pn-border-default);\r
}\r
...
`});var kc,Nc=d(()=>{kc=`<div class="tabs-header">\r
...
${r.bodyCode}${t}
}`});C.setEntryPoint(new vo(C,{id:"pixelShader",label:"Pixel Shader",statics:{imports:!0,inputs:!1,outputs:!1},nodes:{static:[G.create(C,{id:"OnPixel",category:"event",inputs:{},outputs:{x:{nodeType:"value",dataType:"number"},y:{nodeType:"value",dataType:"number"}},codeGenerator:r=>`// Pixel coordinates
...
__pixel_b = ${r.inputs.blue.valueId};`,preview:{data:{updatePreviewData:()=>({})}}})]}}));C.setPreview(r=>{Zt=document.createElement("canvas"),Zt.width=100,Zt.height=100,Zt.style.cssText="width: 100px; height: 100px; image-rendering: pixelated; background: #000;",r.appendChild(Zt),xo=Zt.getContext("2d")},r=>{});Co=new To(C);Co.appendTo(document.body);Co.file=new Nt;pi()});(()=>{let r=new WebSocket("ws://127.0.0.1:8088");r.addEventListener("open",()=>{console.log("Refresh connection established")}),r.addEventListener("message",e=>{console.log("Bundle finished. Start refresh"),e.data==="REFRESH"&&window.location.reload()})})();Promise.resolve().then(()=>Qc());
