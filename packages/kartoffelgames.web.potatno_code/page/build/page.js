...
.port-label {\r
    ...
    font-size: var(--pn-font-size-sm);\r
    line-height: var(--pn-node-port-gap);\r
    white-space: nowrap;\r
    user-select: none;\r
}\r
\r
...
.direct-value-inputs {\r
    position: absolute;\r
    /* Place the right edge of this element at the left edge of the port handle\r
       so the inputs body does not overlap the port handle at all. */\r
    right: 100%;\r
    top: 50%;\r
...
`;var nn=`<div #portWrapper [className]="this.portWrapperClasses"
    ...
    <div #portHandle [className]="this.portHandleClasses">
    </div>
