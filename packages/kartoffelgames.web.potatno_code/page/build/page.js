...
}`;var Yr="$slot";function Sa(){function g(a,n){return function(l){e(n,"addInitializer"),r(l,"An initializer"),a.push(l)}}function t(a,n,u,l,o,b,f,T,w){var p;switch(o){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:f?"#"+n:n,static:b,private:f,metadata:T},d={v:!1};s.addInitializer=g(l,d);var i,h;o===0?f?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return a(w,s)}finally{d.v=!0}}function e(a,n){if(a.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(a,n){if(typeof a!="function")throw new TypeError(n+" must be a function")}function c(a,n){var u=typeof n;if(a===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var l;throw a===0?l="field":a===10?l="class":l="method",new TypeError(l+" decorators must return a function or void 0")}}function m(a,n,u,l,o,b,f,T,w){var p=u[0],s,d,i;f?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,l)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,x,P;if(typeof p=="function")h=t(p,l,s,T,o,b,f,w,i),h!==void 0&&(c(o,h),o===0?d=h:o===1?(d=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h);else for(var M=p.length-1;M>=0;M--){var S=p[M];if(h=t(S,l,s,T,o,b,f,w,i),h!==void 0){c(o,h);var _;o===0?_=h:o===1?(_=h.init,x=h.get||i.get,P=h.set||i.set,i={get:x,set:P}):i=h,_!==void 0&&(d===void 0?d=_:typeof d=="function"?d=[d,_]:d.push(_))}}if(o===0||o===1){if(d===void 0)d=function(I,E){return E};else if(typeof d!="function"){var F=d;d=function(I,E){for(var A=E,L=0;L<F.length;L++)A=F[L].call(I,A);return A}}else{var j=d;d=function(I,E){return j.call(I,E)}}a.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),f?o===1?(a.push(function(I,E){return i.get.call(I,E)}),a.push(function(I,E){return i.set.call(I,E)})):o===2?a.push(i):a.push(function(I,E){return i.call(I,E)}):Object.defineProperty(n,l,s))}function v(a,n,u){for(var l=[],o,b,f=new Map,T=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],d=p[2],i=p.length>3,h=s>=5,x,P;if(h?(x=a,s=s-5,b=b||[],P=b):(x=a.prototype,o=o||[],P=o),s!==0&&!i){var M=h?T:f,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(l,x,p,d,s,h,i,P,u)}}return y(l,o),y(l,b),l}function y(a,n){n&&a.push(function(u){for(var l=0;l<n.length;l++)n[l].call(u);return u})}function D(a,n,u){if(n.length>0){for(var l=[],o=a,b=a.name,f=n.length-1;f>=0;f--){var T={v:!1};try{var w=n[f](o,{kind:"class",name:b,addInitializer:g(l,T),metadata:u})}finally{T.v=!0}w!==void 0&&(c(10,w),o=w)}return[C(o,u),function(){for(var p=0;p<l.length;p++)l[p].call(o)}]}}function C(a,n){return Object.defineProperty(a,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,l,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var f=Object.create(b===void 0?null:b),T=v(n,u,f);return l.length||C(n,f),{e:T,get c(){return D(n,l,f)}}}}function qr(g,t,e,r){return(qr=Sa())(g,t,e,r)}var Jr,Wr,se;Jr=B({selector:"kg-popup",template:Yr,style:Hr});var Zr=class{static{({c:[se,Wr]}=qr(this,[],[Jr]))}static{Wr()}};var Kr=`:host {\r
