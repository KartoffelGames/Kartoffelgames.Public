...
`)){let m=e.value.split(`
`);l=e.lineNumber+m.length-1,r=1+m[m.length-1].length}else r=e.columnNumber+e.value.length,l=e.lineNumber;return{graph:t.graph,lineStart:e.lineNumber,columnStart:e.columnNumber,lineEnd:l,columnEnd:r}}graphIsCircular(t){let e=this.mGraphStack.top;if(!e.circularGraphs.has(t))return!1;if(t.isJunction){if(e.circularGraphs.get(t)>p.MAX_JUNCTION_CIRCULAR_REFERENCES)throw new N("Junction graph called circular too often.",this);return!1}return!0}moveNextToken(){let t=this.mGraphStack.top;if(t.circularGraphs.size>0&&(t.circularGraphs=new ot),t.graph&&t.graph.isJunction)throw new N("Junction graph must not have own nodes.",this);if(t.token.cursor++,t.token.cursor<this.mTokenCache.length)return;let e=this.mTokenGenerator.next();if(e.done){this.mTokenCache.push(null);return}this.mLastTokenPosition.column=e.value.columnNumber,this.mLastTokenPosition.line=e.value.lineNumber,this.mTokenCache.push(e.value)}popGraphStack(t){let e=this.mGraphStack.pop(),r=this.mGraphStack.top;if(t&&(e.token.cursor=e.token.start),e.token.cursor!==e.token.start&&r.circularGraphs.size>0&&(r.circularGraphs=new ot),!this.mTrimTokenCache){r.token.cursor=e.token.cursor;return}e.linear?(this.mTokenCache.splice(0,e.token.cursor),r.token.start=0,r.token.cursor=0):r.token.cursor=e.token.cursor}pushGraphStack(t,e){let r=this.mGraphStack.top,l={graph:t,linear:e&&r.linear,circularGraphs:new ot(r.circularGraphs),token:{start:r.token.cursor,cursor:r.token.cursor}},m=l.circularGraphs.get(t)??0;l.circularGraphs.set(t,m+1),this.mGraphStack.push(l)}};var we=class p{static NODE_NULL_RESULT=Symbol("FAILED_NODE_VALUE_PARSE");static NODE_VALUE_LIST_END_MEET=Symbol("FAILED_NODE_VALUE_PARSE");mConfiguration;mLexer;mRootPart;get lexer(){return this.mLexer}constructor(t,e){this.mLexer=t,this.mRootPart=null,this.mConfiguration={keepTraceIncidents:!1,trimTokenCache:!1,...e}}parse(t,e){if(this.mRootPart===null)throw new N("Parser has not root part set.",this);let r=new $e(this.mLexer.tokenize(t,e),this.mConfiguration.keepTraceIncidents,this.mConfiguration.trimTokenCache),l=(()=>{try{return this.beginParseProcess(r,this.mRootPart)}catch(g){if(g instanceof Wt)return r.incidentTrace.push(g.message,r.currentGraph,g.lineStart,g.columnStart,g.lineEnd,g.columnEnd,!0,g),Z.PARSER_ERROR;let y=g instanceof Error?g.message:g.toString(),x=r.getGraphPosition();return r.incidentTrace.push(y,r.currentGraph,x.lineStart,x.columnStart,x.lineEnd,x.columnEnd,!0,g),Z.PARSER_ERROR}})();if(l===Z.PARSER_ERROR)throw new Z(r.incidentTrace);let m=r.collapse();if(m.length!==0){let g=m[0];if(r.incidentTrace.top.range.lineEnd===1&&r.incidentTrace.top.range.columnEnd===1){let y=`Tokens could not be parsed. Graph end meet without reaching last token. Current: "${g.value}" (${g.type})`;r.incidentTrace.push(y,this.mRootPart,g.lineNumber,g.columnNumber,g.lineNumber,g.columnNumber)}throw new Z(r.incidentTrace)}return l}setRootGraph(t){this.mRootPart=t}beginParseProcess(t,e){t.moveNextToken(),t.processStack.push({type:"graph-parse",parameter:{graph:e,linear:!0},state:0});let r=p.NODE_NULL_RESULT;for(;t.processStack.top;)r=this.processStack(t,t.processStack.top,r);return r}processChainedNodeParseProcess(t,e,r){switch(e.state){case 0:{let g=e.parameter.node.connections.next;return g===null?(t.processStack.pop(),{}):(e.state++,t.processStack.push({type:"node-parse",parameter:{node:g},state:0,values:{}}),p.NODE_NULL_RESULT)}case 1:{let l=r;return l===Z.PARSER_ERROR?(t.processStack.pop(),Z.PARSER_ERROR):(t.processStack.pop(),l)}}throw new N(`Invalid node next parse state "${e.state}".`,this)}processGraphParseProcess(t,e,r){let l=e.parameter.graph;switch(e.state){case 0:{if(t.graphIsCircular(l)){let g=t.getGraphPosition();return t.incidentTrace.push("Circular graph detected.",l,g.lineStart,g.columnStart,g.lineEnd,g.columnEnd),t.processStack.pop(),Z.PARSER_ERROR}let m=e.parameter.linear;return t.pushGraphStack(l,m),e.state++,t.processStack.push({type:"node-parse",parameter:{node:l.node},state:0,values:{}}),p.NODE_NULL_RESULT}case 1:{let m=r;if(m===Z.PARSER_ERROR)return t.popGraphStack(!0),t.processStack.pop(),Z.PARSER_ERROR;let g=l.convert(m,t);if(typeof g=="symbol"){let y=t.getGraphPosition();return t.incidentTrace.push(g.description??"Unknown data convert error",y.graph,y.lineStart,y.columnStart,y.lineEnd,y.columnEnd),t.popGraphStack(!0),t.processStack.pop(),Z.PARSER_ERROR}return t.popGraphStack(!1),t.processStack.pop(),g}}throw new N(`Invalid graph parse state "${e.state}".`,this)}processNodeParseProcess(t,e,r){let l=e.parameter.node;switch(e.state){case 0:return t.processStack.push({type:"node-value-parse",parameter:{node:l,valueIndex:0},state:0,values:{}}),e.state++,p.NODE_NULL_RESULT;case 1:{let m=r;return m===Z.PARSER_ERROR?(t.processStack.pop(),Z.PARSER_ERROR):(e.values.nodeValueResult=m,t.processStack.push({type:"node-next-parse",parameter:{node:l},state:0}),e.state++,p.NODE_NULL_RESULT)}case 2:{let m=r;if(m===Z.PARSER_ERROR)return t.processStack.pop(),Z.PARSER_ERROR;let g=l.mergeData(e.values.nodeValueResult,m);return t.processStack.pop(),g}}throw new N(`Invalid node parse state "${e.state}".`,this)}processNodeValueParseProcess(t,e,r){let l=e.parameter.node;switch(e.state){case 0:{if(r!==p.NODE_NULL_RESULT&&r!==Z.PARSER_ERROR)return e.values.parseResult=r,e.state++,p.NODE_NULL_RESULT;let m=e.parameter.valueIndex,g=l.connections;if(m>=g.values.length)return e.values.parseResult=p.NODE_VALUE_LIST_END_MEET,e.state++,p.NODE_NULL_RESULT;e.parameter.valueIndex++;let y=t.currentToken,x=g.values[m];if(typeof x=="string"){if(!y){if(g.required){let C=t.getTokenPosition();t.incidentTrace.push(`Unexpected end of statement. Token "${x}" expected.`,t.currentGraph,C.lineStart,C.columnStart,C.lineEnd,C.columnEnd)}return p.NODE_NULL_RESULT}if(x!==y.type){if(g.required){let C=t.getTokenPosition();t.incidentTrace.push(`Unexpected token "${y.value}". "${x}" expected`,t.currentGraph,C.lineStart,C.columnStart,C.lineEnd,C.columnEnd)}return p.NODE_NULL_RESULT}return t.moveNextToken(),y.value}else{let C=g.values.length===1||g.values.length===m+1;return t.processStack.push({type:"graph-parse",parameter:{graph:x,linear:C},state:0}),p.NODE_NULL_RESULT}}case 1:{let m=e.values.parseResult,g=l.connections;if(m===p.NODE_VALUE_LIST_END_MEET&&!g.required){t.processStack.pop();return}return m===p.NODE_VALUE_LIST_END_MEET?(t.processStack.pop(),Z.PARSER_ERROR):(t.processStack.pop(),m)}}throw new N(`Invalid node value parse state "${e.state}".`,this)}processStack(t,e,r){switch(e.type){case"graph-parse":return this.processGraphParseProcess(t,e,r);case"node-parse":return this.processNodeParseProcess(t,e,r);case"node-value-parse":return this.processNodeValueParseProcess(t,e,r);case"node-next-parse":return this.processChainedNodeParseProcess(t,e,r)}}};var k=class p{static define(t,e=!1){return new p(t,e)}mDataConverterList;mGraphCollector;mIsJunction;mResolvedGraphNode;get isJunction(){return this.mIsJunction}get node(){return this.mResolvedGraphNode||(this.mResolvedGraphNode=this.mGraphCollector().root),this.mResolvedGraphNode}constructor(t,e){this.mGraphCollector=t,this.mDataConverterList=new Array,this.mResolvedGraphNode=null,this.mIsJunction=e}convert(t,e){if(this.mDataConverterList.length===0)return t;let r=e.getGraphBoundingToken(),l=r[0]??void 0,m=r[1]??void 0;if(this.mDataConverterList.length===1)return this.mDataConverterList[0](t,l,m);let g=t;for(let y of this.mDataConverterList)if(g=y(g,l,m),typeof g=="symbol")return g;return g}converter(t){let e=new p(this.mGraphCollector,this.isJunction);return e.mDataConverterList.push(...this.mDataConverterList,t),e}};var U=class p{static new(){let t=new p("",!1,[]);return t.mRootNode=null,t}mConnections;mIdentifier;mRootNode;get configuration(){return{dataKey:this.mIdentifier.dataKey,isList:this.mIdentifier.type==="list",isRequired:this.mConnections.required,isBranch:this.mConnections.values.length>1}}get connections(){return this.mConnections}get root(){if(!this.mRootNode)throw new N("Staring nodes must be chained with another node to be used.",this);return this.mRootNode}constructor(t,e,r,l){if(t==="")this.mIdentifier={type:"empty",dataKey:"",mergeKey:""};else if(t.endsWith("[]"))this.mIdentifier={type:"list",mergeKey:"",dataKey:t.substring(0,t.length-2)};else if(t.includes("<-")){let g=t.split("<-");this.mIdentifier={type:"merge",dataKey:g[0],mergeKey:g[1]}}else this.mIdentifier={type:"single",mergeKey:"",dataKey:t};let m=r.map(g=>g instanceof p?k.define(()=>g):g);this.mConnections={required:e,values:m,next:null},l?this.mRootNode=l:this.mRootNode=this}mergeData(t,e){if(this.mIdentifier.type==="empty")return e;let r=e,l=typeof t>"u";if(this.mIdentifier.type==="single"){if(this.mIdentifier.dataKey in e)throw new N(`Graph path has a duplicate value identifier "${this.mIdentifier.dataKey}"`,this);return l||(r[this.mIdentifier.dataKey]=t),e}if(this.mIdentifier.type==="list"){let y;l?y=new Array:Array.isArray(t)?y=t:y=[t];let x=(()=>{if(this.mIdentifier.dataKey in e){let C=r[this.mIdentifier.dataKey];return Array.isArray(C)?(C.unshift(...y),C):(y.push(C),y)}return y})();return r[this.mIdentifier.dataKey]=x,e}if(l)return e;let m=(()=>{if(!this.mIdentifier.mergeKey)throw new N("Cant merge data without a merge key.",this);if(typeof t!="object"||t===null)throw new N("Node data must be an object when merge key is set.",this);if(!(this.mIdentifier.mergeKey in t))throw new N(`Node data does not contain merge key "${this.mIdentifier.mergeKey}"`,this);return t[this.mIdentifier.mergeKey]})();if(typeof m>"u")return e;let g=r[this.mIdentifier.dataKey];if(typeof g>"u")return r[this.mIdentifier.dataKey]=m,r;if(!Array.isArray(g))throw new N("Chain data merge value is not an array but should be.",this);return Array.isArray(m)?g.unshift(...m):g.unshift(m),e}optional(t,e){let r=typeof e>"u"?"":t,l=typeof e>"u"?t:e,m=new Array;Array.isArray(l)?m.push(...l):m.push(l);let g=new p(r,!1,m,this.mRootNode);return this.setChainedNode(g),g}required(t,e){let r=typeof e>"u"?"":t,l=typeof e>"u"?t:e,m=new Array;Array.isArray(l)?m.push(...l):m.push(l);let g=new p(r,!0,m,this.mRootNode);return this.setChainedNode(g),g}setChainedNode(t){if(this.mConnections.next!==null)throw new N("Node can only be chained to a single node.",this);this.mConnections.next=t}};var j={XmlIdentifier:"Identifier",XmlAssignment:"XmlAssignment",XmlValue:"XmlValue",XmlComment:"XmlComment",XmlOpenClosingBracket:"XmlOpenClosingBracket",XmlCloseBracket:"XmlCloseBracket",XmlOpenBracket:"XmlOpenBracket",XmlCloseClosingBracket:"XmlCloseClosingBracket",XmlExplicitValueIdentifier:"XmlExplicitValueIdentifier",ExpressionStart:"ExpressionStart",ExpressionEnd:"ExpressionEnd",ExpressionValue:"ExpressionValue",InstructionStart:"InstructionStart",InstructionInstructionValue:"InstructionInstructionValue",InstructionBodyStartBraket:"InstructionBodyStartBraket",InstructionBodyCloseBraket:"InstructionBodyCloseBraket",InstructionInstructionClosingBracket:"InstructionInstructionClosingBracket",InstructionInstructionOpeningBracket:"InstructionInstructionOpeningBracket"};var Ge=class extends be{constructor(){super(),this.validWhitespaces=` 
\r`,this.trimWhitespace=!0;let t=this.createTokenPattern({pattern:{regex:/(?:(?!}}).)*/,type:j.ExpressionValue}}),e=this.createTokenPattern({pattern:{start:{regex:/{{/,type:j.ExpressionStart},end:{regex:/}}[ \n\r]?/,type:j.ExpressionEnd}}},s=>{s.useChildPattern(t)}),r=this.createTokenPattern({pattern:{regex:/[^>\s\n="/]+/,type:j.XmlIdentifier}}),l=this.createTokenPattern({pattern:{regex:/(?:(?!{{|"|<).)+/,type:j.XmlValue}}),m=this.createTokenPattern({pattern:{regex:/<!--.*?-->/,type:j.XmlComment}}),g=this.createTokenPattern({pattern:{regex:/=/,type:j.XmlAssignment}}),y=this.createTokenPattern({pattern:{start:{regex:/"/,type:j.XmlExplicitValueIdentifier},end:{regex:/"/,type:j.XmlExplicitValueIdentifier}}},s=>{s.useChildPattern(e),s.useChildPattern(l)}),x=this.createTokenPattern({pattern:{start:{regex:/<\//,type:j.XmlOpenClosingBracket},end:{regex:/>/,type:j.XmlCloseBracket}}},s=>{s.useChildPattern(r)}),C=this.createTokenPattern({pattern:{start:{regex:/</,type:j.XmlOpenBracket},end:{regex:/(?<closeClosingBracket>\/>)|(?<closeBracket>>)/,type:{closeClosingBracket:j.XmlCloseClosingBracket,closeBracket:j.XmlCloseBracket}}}},s=>{s.useChildPattern(g),s.useChildPattern(r),s.useChildPattern(y)}),c=this.createTokenPattern({pattern:{regex:/[^()"'`/)]+/,type:j.InstructionInstructionValue}}),n=this.createTokenPattern({pattern:{innerType:j.InstructionInstructionValue,start:{regex:/\//,type:j.InstructionInstructionValue},end:{regex:/\//,type:j.InstructionInstructionValue}}},s=>{s.useChildPattern(a),s.useChildPattern(o),s.useChildPattern(b),s.useChildPattern(u),s.useChildPattern(c)}),u=this.createTokenPattern({pattern:{innerType:j.InstructionInstructionValue,start:{regex:/\(/,type:j.InstructionInstructionValue},end:{regex:/\)/,type:j.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(a),s.useChildPattern(o),s.useChildPattern(b),s.useChildPattern(c)}),a=this.createTokenPattern({pattern:{innerType:j.InstructionInstructionValue,start:{regex:/"/,type:j.InstructionInstructionValue},end:{regex:/"/,type:j.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(o),s.useChildPattern(b),s.useChildPattern(u),s.useChildPattern(c)}),o=this.createTokenPattern({pattern:{innerType:j.InstructionInstructionValue,start:{regex:/'/,type:j.InstructionInstructionValue},end:{regex:/'/,type:j.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(a),s.useChildPattern(b),s.useChildPattern(u),s.useChildPattern(c)}),b=this.createTokenPattern({pattern:{innerType:j.InstructionInstructionValue,start:{regex:/`/,type:j.InstructionInstructionValue},end:{regex:/`/,type:j.InstructionInstructionValue}}},s=>{s.useChildPattern(n),s.useChildPattern(a),s.useChildPattern(o),s.useChildPattern(u),s.useChildPattern(c)}),v=this.createTokenPattern({pattern:{regex:/\$[^(\s\n/{]+/,type:j.InstructionStart}}),E=this.createTokenPattern({pattern:{start:{regex:/\(/,type:j.InstructionInstructionOpeningBracket},end:{regex:/\)/,type:j.InstructionInstructionClosingBracket}}},s=>{s.useChildPattern(n),s.useChildPattern(a),s.useChildPattern(o),s.useChildPattern(b),s.useChildPattern(u),s.useChildPattern(c)}),w=this.createTokenPattern({pattern:{start:{regex:/{/,type:j.InstructionBodyStartBraket},end:{regex:/}/,type:j.InstructionBodyCloseBraket}}},s=>{for(let d of f)s.useChildPattern(d)}),f=[m,x,C,y,e,v,E,w,l];for(let s of f)this.useRootTokenPattern(s)}};var xe=class extends we{constructor(){super(new Ge),this.initGraph()}initGraph(){let t=k.define(()=>U.new().required(j.ExpressionStart).optional("value",j.ExpressionValue).required("end",j.ExpressionEnd)).converter(o=>({expression:new Nt(o.value??""),hasTrailingWhitespace:o.end.length>2})),e=k.define(()=>{let o=e;return U.new().required("data[]",U.new().required("value",[t,U.new().required("text",j.XmlValue)])).optional("data<-data",o)}),r=k.define(()=>U.new().required("name",j.XmlIdentifier).optional("attributeValue",U.new().required(j.XmlAssignment).required(j.XmlExplicitValueIdentifier).optional("list<-data",e).required(j.XmlExplicitValueIdentifier))).converter(o=>{let b=new Array;if(o.attributeValue?.list)for(let v of o.attributeValue.list)"expression"in v.value?(b.push(v.value.expression),v.value.hasTrailingWhitespace&&b.push(" ")):b.push(v.value.text);return{name:o.name,values:b}}),l=k.define(()=>{let o=l;return U.new().required("data[]",r).optional("data<-data",o)}),m=k.define(()=>{let o=m;return U.new().required("data[]",U.new().required("value",[t,U.new().required("text",j.XmlValue),U.new().required(j.XmlExplicitValueIdentifier).required("text",j.XmlValue).required(j.XmlExplicitValueIdentifier)])).optional("data<-data",o)}),g=k.define(()=>U.new().required("list<-data",m)).converter(o=>{let b=new Lt;for(let v of o.list)"expression"in v.value?(b.addValue(v.value.expression),v.value.hasTrailingWhitespace&&b.addValue(" ")):b.addValue(v.value.text);return b}),y=k.define(()=>U.new().required(j.XmlComment)).converter(()=>null),x=k.define(()=>U.new().required(j.XmlOpenBracket).required("openingTagName",j.XmlIdentifier).optional("attributes<-data",l).required("closing",[U.new().required(j.XmlCloseClosingBracket),U.new().required(j.XmlCloseBracket).required("values",u).required(j.XmlOpenClosingBracket).required("closingTageName",j.XmlIdentifier).required(j.XmlCloseBracket)])).converter(o=>{if("closingTageName"in o.closing&&o.openingTagName!==o.closing.closingTageName)throw new N(`Opening (${o.openingTagName}) and closing tagname (${o.closing.closingTageName}) does not match`,this);let b=new _t(o.openingTagName);if(o.attributes)for(let v of o.attributes)b.setAttribute(v.name).addValue(...v.values);return"values"in o.closing&&b.appendChild(...o.closing.values),b}),C=k.define(()=>{let o=C;return U.new().required("list[]",j.InstructionInstructionValue).optional("list<-list",o)}),c=k.define(()=>U.new().required("instructionName",j.InstructionStart).optional("instruction",U.new().required(j.InstructionInstructionOpeningBracket).required("value<-list",C).required(j.InstructionInstructionClosingBracket)).optional("body",U.new().required(j.InstructionBodyStartBraket).required("value",u).required(j.InstructionBodyCloseBraket))).converter(o=>{let b=o.instructionName.substring(1),v=o.instruction?.value.join("")??"",E=new Yt(b,v);return o.body&&E.appendChild(...o.body.value),E}),n=k.define(()=>{let o=n;return U.new().required("list[]",[y,x,c,g]).optional("list<-list",o)}),u=k.define(()=>{let o=n;return U.new().optional("list<-list",o)}).converter(o=>{let b=new Array;if(o.list)for(let v of o.list)v!==null&&b.push(v);return b}),a=k.define(()=>U.new().required("content",u)).converter(o=>{let b=new lt;return b.appendChild(...o.content),b});this.setRootGraph(a)}};var G=class p extends Re{static mTemplateCache=new ot;static mXmlParser=new xe;mComponentElement;mIsUpdated;mRootBuilder;get element(){return this.mComponentElement.htmlElement}constructor(t){super({constructor:t.processorConstructor,parent:null}),J.registerComponent(this,t.htmlElement),this.setProcessorInjection(p,this),this.addConstructionHook(l=>{J.registerComponent(this,this.mComponentElement.htmlElement,l)}),p.mTemplateCache.has(t.processorConstructor)||p.mTemplateCache.set(t.processorConstructor,p.mXmlParser.parse(t.templateString??""));let e=p.mTemplateCache.get(t.processorConstructor).clone();this.mIsUpdated=!1,this.mComponentElement=new ye(t.htmlElement),this.mRootBuilder=new te(e,new ze(this,t.expressionModule),new ht(this),"ROOT"),this.mComponentElement.shadowRoot.appendChild(this.mRootBuilder.anchor),this.setProcessorInjection(It,new It(this.mRootBuilder.values));let r=this.updater.zone.getAttachment(Dt.ATTACHMENT_KEY);if(r)for(let[l,m]of r.injections)this.setProcessorInjection(l,m)}addStyle(t){let e=document.createElement("style");e.innerHTML=t,this.mComponentElement.shadowRoot.prepend(e)}attributeChanged(t,e,r){this.call("onAttributeChange",t,e,r)}connected(){this.mIsUpdated||this.updater.update(),this.call("onConnect")}deconstruct(){this.call("onDeconstruct"),this.mRootBuilder.deconstruct(),super.deconstruct()}disconnected(){this.call("onDisconnect")}onUpdate(){return this.mIsUpdated||(this.mIsUpdated=!0),this.mRootBuilder.update()?(this.call("onUpdate"),!0):!1}};function Y(p){return(t,e)=>{R.registerInjectable(t,e.metadata,"instanced"),J.registerConstructor(t,p.selector);let r=class extends HTMLElement{mComponent;constructor(){super(),this.mComponent=new G({processorConstructor:t,templateString:p.template??null,expressionModule:p.expressionmodule,htmlElement:this}).setup(),p.style&&this.mComponent.addStyle(p.style)}connectedCallback(){this.mComponent.connected()}disconnectedCallback(){this.mComponent.disconnected()}};globalThis.customElements.define(p.selector,r)}}function Zt(p){return(t,e)=>{R.registerInjectable(t,e.metadata,"instanced"),at.register(Vt,t,{access:p.access,targetRestrictions:p.targetRestrictions})}}function vt(p){return(t,e)=>{R.registerInjectable(t,e.metadata,"instanced"),at.register(gt,t,{access:p.access,selector:p.selector})}}function Rt(p){return(t,e)=>{R.registerInjectable(t,e.metadata,"instanced"),at.register(Ut,t,{instructionType:p.instructionType})}}function os(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function _o(p,t,e,r){return(_o=os())(p,t,e,r)}function rs(p){return p}var Ro,Lo,Te;Ro=Zt({access:W.Read,targetRestrictions:[G]});new class extends rs{constructor(){super(Te),Lo()}static{class p{static{({c:[Te,Lo]}=_o(this,[],[Ro]))}static METADATA_USER_EVENT_LISTENER_PROPERIES="pwb:user_event_listener_properties";mEventListenerList;mTargetElement;constructor(e=R.use(G)){let r=new Array,l=e.processorConstructor;do{let m=nt.get(l).getMetadata(p.METADATA_USER_EVENT_LISTENER_PROPERIES);if(m)for(let g of m)r.push(g)}while(l=Object.getPrototypeOf(l));this.mEventListenerList=new Array,this.mTargetElement=e.element;for(let m of r){let[g,y]=m,x=Reflect.get(e.processor,g);x=x.bind(e.processor),this.mEventListenerList.push([y,x]),this.mTargetElement.addEventListener(y,x)}}onDeconstruct(){for(let e of this.mEventListenerList){let[r,l]=e;this.mTargetElement.removeEventListener(r,l)}}}}};var Ee=class extends window.Event{mValue;get value(){return this.mValue}constructor(t,e){super(t),this.mValue=e}};var De=class{mElement;mEventName;constructor(t,e){this.mEventName=t,this.mElement=e}dispatchEvent(t){let e=new Ee(this.mEventName,t);this.mElement.dispatchEvent(e)}};function yt(p){return(t,e)=>{if(e.static)throw new N("Event target is not for a static property.",yt);let r=new WeakMap;return{get(){if(!r.has(this)){let l=(()=>{try{return J.ofProcessor(this).component}catch{throw new N("PwbComponentEvent target class is not a component.",this)}})();r.set(this,new De(p,l.element))}return r.get(this)}}}}function ns(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function Fo(p,t,e,r){return(Fo=ns())(p,t,e,r)}function is(p){return p}var jo,Oo,Ie;jo=Zt({access:W.ReadWrite,targetRestrictions:[G]});new class extends is{constructor(){super(Ie),Oo()}static{class p{static{({c:[Ie,Oo]}=Fo(this,[],[jo]))}static METADATA_EXPORTED_PROPERTIES="pwb:exported_properties";mComponent;constructor(e=R.use(G)){this.mComponent=e;let r=new Ht,l=e.processorConstructor;do{let g=nt.get(l).getMetadata(p.METADATA_EXPORTED_PROPERTIES);g&&r.push(...g)}while(l=Object.getPrototypeOf(l));let m=new Set(r);m.size>0&&this.connectExportedProperties(m)}connectExportedProperties(e){this.exportPropertyAsAttribute(e),this.patchHtmlAttributes(e)}exportPropertyAsAttribute(e){for(let r of e){let l={};l.enumerable=!0,l.configurable=!0,delete l.value,delete l.writable,l.set=m=>{Reflect.set(this.mComponent.processor,r,m)},l.get=()=>{let m=Reflect.get(this.mComponent.processor,r);return typeof m=="function"&&(m=m.bind(this.mComponent.processor)),m},Object.defineProperty(this.mComponent.element,r,l)}}patchHtmlAttributes(e){let r=this.mComponent.element.getAttribute;new MutationObserver(m=>{for(let g of m){let y=g.attributeName,x=r.call(this.mComponent.element,y);Reflect.set(this.mComponent.element,y,x),this.mComponent.attributeChanged(y,g.oldValue,x)}}).observe(this.mComponent.element,{attributeFilter:[...e],attributeOldValue:!0});for(let m of e)if(this.mComponent.element.hasAttribute(m)){let g=r.call(this.mComponent.element,m);this.mComponent.element.setAttribute(m,g)}this.mComponent.element.getAttribute=m=>e.has(m)?Reflect.get(this.mComponent.element,m):r.call(this.mComponent.element,m)}}}};function tt(p,t){if(t.static)throw new N("Event target is not for a static property.",tt);let e=nt.forInternalDecorator(t.metadata),r=e.getMetadata(Ie.METADATA_EXPORTED_PROPERTIES)??new Array;r.push(t.name),e.setMetadata(Ie.METADATA_EXPORTED_PROPERTIES,r)}function bt(p){return(t,e)=>{if(e.static)throw new N("Child decorator is not for a static property.",bt);return{get(){let m=(()=>{try{return J.ofProcessor(this).component}catch{throw new N("PwbChild target class is not a component.",this)}})().getProcessorInjection(It).data.store[p];return m instanceof Element?m:null}}}}function ss(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function $o(p,t,e,r){return($o=ss())(p,t,e,r)}var Go,zo,as;Go=Rt({instructionType:"dynamic-content"});var Vo=class{static{({c:[as,zo]}=$o(this,[],[Go]))}constructor(t=R.use(et),e=R.use(H)){this.mModuleValues=e,this.mLastTemplate=null,this.mProcedure=this.mModuleValues.createExpressionProcedure(t.value)}mLastTemplate;mModuleValues;mProcedure;onUpdate(){let t=this.mProcedure.execute();if(!t||!(t instanceof lt))throw new N("Dynamic content method has a wrong result type.",this);if(this.mLastTemplate!==null&&this.mLastTemplate.equals(t))return null;let e=t.clone();this.mLastTemplate=e;let r=new ct;return r.addElement(e,new ht(this.mModuleValues.data)),r}static{zo()}};function ls(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function Ho(p,t,e,r){return(Ho=ls())(p,t,e,r)}var Xo,Bo,cs;Xo=vt({access:W.Write,selector:/^\([[\w\-$]+\)$/});var Uo=class{static{({c:[cs,Bo]}=Ho(this,[],[Xo]))}constructor(t=R.use(Q),e=R.use(H),r=R.use(rt)){this.mTarget=t,this.mEventName=r.name.substring(1,r.name.length-1);let l=e.createExpressionProcedure(r.value,["$event"]);this.mListener=m=>{l.setTemporaryValue("$event",m),l.execute()},this.mTarget.addEventListener(this.mEventName,this.mListener)}mEventName;mListener;mTarget;onDeconstruct(){this.mTarget.removeEventListener(this.mEventName,this.mListener)}static{Bo()}};function us(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function Zo(p,t,e,r){return(Zo=us())(p,t,e,r)}var qo,Yo,hs;qo=Rt({instructionType:"for"});var Wo=class{static{({c:[hs,Yo]}=Zo(this,[],[qo]))}constructor(t=R.use(dt),e=R.use(H),r=R.use(et)){this.mTemplate=t,this.mModuleValues=e,this.mLastEntries=new Array;let l=r.value,g=new RegExp(/^\s*([a-zA-Z]+[a-zA-Z0-9]*)\s*of\s+([^;]+)\s*(;\s*([a-zA-Z]+[a-zA-Z0-9]*)\s*=\s*(.*)\s*)?$/).exec(l);if(!g)throw new N(`For-Parameter value has wrong format: ${l}`,this);let y=g[1],x=g[2],C=g[4]??null,c=g[5],n=this.mModuleValues.createExpressionProcedure(x),u=C?this.mModuleValues.createExpressionProcedure(c,["$index",y]):null;this.mExpression={iterateVariableName:y,iterateValueProcedure:n,indexExportVariableName:C,indexExportProcedure:u}}mExpression;mLastEntries;mModuleValues;mTemplate;onUpdate(){let t=new ct,e=this.mExpression.iterateValueProcedure.execute();if(typeof e=="object"&&e!==null||Array.isArray(e)){let r=Symbol.iterator in e?Object.entries([...e]):Object.entries(e);if(this.compareEntries(r,this.mLastEntries))return null;this.mLastEntries=r;for(let[l,m]of r)this.addTemplateForElement(t,this.mExpression,m,l);return t}else return null}addTemplateForElement=(t,e,r,l)=>{let m=new ht(this.mModuleValues.data);if(m.setTemporaryValue(e.iterateVariableName,r),e.indexExportProcedure&&e.indexExportVariableName){e.indexExportProcedure.setTemporaryValue("$index",l),e.indexExportProcedure.setTemporaryValue(e.iterateVariableName,r);let y=e.indexExportProcedure.execute();m.setTemporaryValue(e.indexExportVariableName,y)}let g=new lt;g.appendChild(...this.mTemplate.childList),t.addElement(g,m)};compareEntries(t,e){if(t.length!==e.length)return!1;for(let r=0;r<t.length;r++){let[l,m]=t[r],[g,y]=e[r];if(l!==g||m!==y)return!1}return!0}static{Yo()}};function ds(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function Qo(p,t,e,r){return(Qo=ds())(p,t,e,r)}var ko,Jo,ms;ko=Rt({instructionType:"if"});var Ko=class{static{({c:[ms,Jo]}=Qo(this,[],[ko]))}constructor(t=R.use(dt),e=R.use(H),r=R.use(et)){this.mTemplateReference=t,this.mModuleValues=e,this.mProcedure=this.mModuleValues.createExpressionProcedure(r.value),this.mLastBoolean=!1}mLastBoolean;mModuleValues;mProcedure;mTemplateReference;onUpdate(){let t=this.mProcedure.execute();if(!!t!==this.mLastBoolean){this.mLastBoolean=!!t;let e=new ct;if(t){let r=new lt;r.appendChild(...this.mTemplateReference.childList),e.addElement(r,new ht(this.mModuleValues.data))}return e}else return null}static{Jo()}};function fs(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function or(p,t,e,r){return(or=fs())(p,t,e,r)}var rr,tr,ps;rr=vt({access:W.Read,selector:/^\[[\w$]+\]$/});var er=class{static{({c:[ps,tr]}=or(this,[],[rr]))}constructor(t=R.use(Q),e=R.use(H),r=R.use(rt)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(r.value),this.mTargetProperty=r.name.substring(1,r.name.length-1),this.mLastValue=Symbol("Uncomparable")}mLastValue;mProcedure;mTarget;mTargetProperty;onUpdate(){let t=this.mProcedure.execute();return t===this.mLastValue?!1:(this.mLastValue=t,Reflect.set(this.mTarget,this.mTargetProperty,t),!0)}static{tr()}};function gs(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function sr(p,t,e,r){return(sr=gs())(p,t,e,r)}var ar,nr,vs;ar=vt({access:W.Write,selector:/^#[[\w$]+$/});var ir=class{static{({c:[vs,nr]}=sr(this,[],[ar]))}constructor(t=R.use(Q),e=R.use(rt),r=R.use(It)){this.mChildName=e.name.substring(1),this.mComponentScopeValue=r,this.mTargetNode=t,this.mComponentScopeValue.setTemporaryValue(this.mChildName,this.mTargetNode)}mChildName;mComponentScopeValue;mTargetNode;onDeconstruct(){this.mComponentScopeValue.data.store[this.mChildName]===this.mTargetNode&&this.mComponentScopeValue.data.deleteTemporaryValue(this.mChildName)}static{nr()}};function ys(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function ur(p,t,e,r){return(ur=ys())(p,t,e,r)}var hr,lr,bs;hr=Rt({instructionType:"slot"});var cr=class{static{({c:[bs,lr]}=ur(this,[],[hr]))}constructor(t=R.use(H),e=R.use(et)){this.mModuleValues=t,this.mSlotName=e.value,this.mIsSetup=!1}mIsSetup;mModuleValues;mSlotName;onUpdate(){if(this.mIsSetup)return null;this.mIsSetup=!0;let t=new _t("slot");this.mSlotName!==""&&t.setAttribute("name").addValue(this.mSlotName);let e=new lt;e.appendChild(t);let r=new ct;return r.addElement(e,this.mModuleValues.data),r}static{lr()}};function ws(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function fr(p,t,e,r){return(fr=ws())(p,t,e,r)}var pr,dr,xs;pr=vt({access:W.ReadWrite,selector:/^\[\([[\w$]+\)\]$/});var mr=class{static{({c:[xs,dr]}=fr(this,[],[pr]))}constructor(t=R.use(G),e=R.use(Q),r=R.use(H),l=R.use(rt)){this.mTargetNode=e,this.mAttributeKey=l.name.substring(2,l.name.length-2),this.mReadProcedure=r.createExpressionProcedure(l.value),this.mWriteProcedure=r.createExpressionProcedure(`${l.value} = $DATA;`,["$DATA"]),this.mLastDataValue=Symbol("Uncomparable");let m=g=>{this.mLastDataValue!==g&&t.updater.updateAsync()};this.mTargetNode.addEventListener("input",g=>{m(Reflect.get(this.mTargetNode,this.mAttributeKey))}),this.mTargetNode.addEventListener("change",g=>{m(Reflect.get(this.mTargetNode,this.mAttributeKey))})}mAttributeKey;mLastDataValue;mReadProcedure;mTargetNode;mWriteProcedure;onUpdate(){let t=this.mReadProcedure.execute();if(t!==this.mLastDataValue)return Reflect.set(this.mTargetNode,this.mAttributeKey,t),this.mLastDataValue=t,!0;let e=Reflect.get(this.mTargetNode,this.mAttributeKey);return e!==t?(this.mWriteProcedure.setTemporaryValue("$DATA",e),this.mWriteProcedure.execute(),this.mLastDataValue=e,!0):!1}static{dr()}};function Ts(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function yr(p,t,e,r){return(yr=Ts())(p,t,e,r)}var br,gr,Es;br=Zt({access:W.Read,targetRestrictions:[gt]});var vr=class{static{({c:[Es,gr]}=yr(this,[],[br]))}constructor(t=R.use(gt),e=R.use(Q)){let r=new Array,l=t.processorConstructor;do{let m=nt.get(l).getMetadata(Te.METADATA_USER_EVENT_LISTENER_PROPERIES);if(m)for(let g of m)r.push(g)}while(l=Object.getPrototypeOf(l));this.mEventListenerList=new Array,this.mTargetElement=e;for(let m of r){let[g,y]=m,x=Reflect.get(t.processor,g);x=x.bind(t.processor),this.mEventListenerList.push([y,x]),this.mTargetElement.addEventListener(y,x)}}mEventListenerList;mTargetElement;onDeconstruct(){for(let t of this.mEventListenerList){let[e,r]=t;this.mTargetElement.removeEventListener(e,r)}}static{gr()}};var wr=`:host {\r
    display: block;\r
    width: 100%;\r
    height: 100%;\r
}\r
...
potatno-code-editor {\r
    ...
    width: 100%;\r
    height: 100%;\r
}`;var re=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new jt(this.mProject);for(let r of t.functions)e.addFunction(this.deserializeFunction(r,e));return e}deserializeFunction(t,e){let r=new Et(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let m of t.imports)r.addImport(m);for(let m of t.inputs)r.addInput({label:m.label,dataType:m.dataType});for(let m of t.outputs)r.addOutput({label:m.label,dataType:m.dataType});let l=new Map;for(let m of t.nodes)l.set(m.id,this.deserializeNode(m,r,e));for(let m of t.connections){if(!l.has(m.sourceNodeId)||!l.has(m.targetNodeId))continue;let g=l.get(m.sourceNodeId),y=l.get(m.targetNodeId),x=g.outputs.map.get(m.sourcePortId),C=y.inputs.map.get(m.targetPortId);!x||!C||x.connect(C)}return r}deserializeNode(t,e,r){let l=r.nodeDefinitions.find(g=>g.id===t.definitionId),m=(()=>{if(l)return e.addNodeByDefinition(l,t.transformation);let g=t.ports.filter(x=>x.direction==="input").map(x=>({dataType:x.dataType,definitionId:x.definitionId,label:x.label,portType:x.portType})),y=t.ports.filter(x=>x.direction==="output").map(x=>({dataType:x.dataType,definitionId:x.definitionId,label:x.label,portType:x.portType}));return new St(this.mProject,r,e,{definitionId:t.definitionId,ports:{input:g,output:y},label:t.label,transformation:{...t.transformation}})})();m.label=t.label,e.addNode(m);for(let g of t.ports)if(g.portType==="value"&&g.directValue.length>0){let y=m.inputs.map.get(g.definitionId);y&&y.setDirectValue(g.directValue)}return m.preview=t.preview??null,m}};var ne=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((y,x)=>{e.set(y,`n${x}`)});let r=[...t.nodes].map(y=>this.serializeNode(y,e.get(y))),l=[];for(let y of t.nodes){let x=e.get(y);for(let C of y.outputs.list)for(let c of C.connectedPorts){let n=e.get(c.node);l.push({sourceNodeId:x,sourcePortId:C.definitionId,targetNodeId:n,targetPortId:c.definitionId})}}let m=t.inputs.map(y=>({label:y.label,dataType:y.dataType})),g=t.outputs.map(y=>({label:y.label,dataType:y.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:m,outputs:g,imports:[...t.imports],nodes:r,connections:l}}serializeNode(t,e){let r=[...t.inputs.list,...t.outputs.list].map(m=>({definitionId:m.definitionId,label:m.label,direction:m.direction,portType:m.portType,dataType:m.portType==="value"?m.dataType:null,directValue:[...m.directValue]})),l=t.preview?{portDefinitionId:t.preview.portDefinitionId,displayId:t.preview.displayId}:null;return{id:e,definitionId:t.definitionId,label:t.label,transformation:{...t.transformation},ports:r,preview:l}}};var xr=`:host {\r
    /* Globals */\r
...
`;function Ns(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function Gr(p,t,e,r){return(Gr=Ns())(p,t,e,r)}var Br,Or,Ur,Hr,Xr,Fr,jr,zr,Vr,qt;Br=Y({selector:"potatno-resize-box",template:Rr,style:_r}),Ur=$.state({proxy:!0}),Hr=yt("resize"),Xr=yt("resize-end");var $r=class{static{({e:[Fr,jr,zr,Vr],c:[qt,Or]}=Gr(this,[[Ur,1,"mConfiguration"],[Hr,1,"mResize"],[Xr,1,"mResizeEnd"],[tt,3,"bottom"],[tt,3,"left"],[tt,3,"right"],[tt,3,"snap"],[tt,3,"top"],[tt,3,"virtual"],[tt,2,"resize"]],[Br]))}constructor(t=R.use(G)){this.mComponentElement=t.element,this.mConfiguration={snap:1,isVirtual:!1,enabledDirections:{top:!1,right:!1,bottom:!1,left:!1}}}mComponentElement;#t=(Vr(this),Fr(this));get mConfiguration(){return this.#t}set mConfiguration(t){this.#t=t}#e=jr(this);get mResize(){return this.#e}set mResize(t){this.#e=t}#o=zr(this);get mResizeEnd(){return this.#o}set mResizeEnd(t){this.#o=t}get bottom(){return this.mConfiguration.enabledDirections.bottom}set bottom(t){this.mConfiguration.enabledDirections.bottom=this.parseBoolean(t)}get left(){return this.mConfiguration.enabledDirections.left}set left(t){this.mConfiguration.enabledDirections.left=this.parseBoolean(t)}get right(){return this.mConfiguration.enabledDirections.right}set right(t){this.mConfiguration.enabledDirections.right=this.parseBoolean(t)}get snap(){return this.mConfiguration.snap}set snap(t){this.mConfiguration.snap=parseInt(t.toString())}get top(){return this.mConfiguration.enabledDirections.top}set top(t){this.mConfiguration.enabledDirections.top=this.parseBoolean(t)}get virtual(){return this.mConfiguration.isVirtual}set virtual(t){this.mConfiguration.isVirtual=this.parseBoolean(t)}resize(t,e){let r=this.mComponentElement.getBoundingClientRect(),l=r.width,m=r.height;return this.mComponentElement.style.setProperty("width",`${t}px`),this.mComponentElement.style.setProperty("height",`${e}px`),t!==l||e!==m}resizeCorner(t){this.handleResize(t,"both")}resizeHorizontal(t){this.handleResize(t,"horizontal")}resizeVertical(t){this.handleResize(t,"vertical")}createResizeEvent(t,e,r,l,m){let g=t;return e===l&&(g&=~(wt.right|wt.left)),r===m&&(g&=~(wt.top|wt.bottom)),new yo(e,r,g)}handleResize(t,e){t.preventDefault(),t.stopPropagation();let r=this.mComponentElement.getBoundingClientRect(),l=this.mComponentElement.offsetWidth?r.width/this.mComponentElement.offsetWidth:1,m=this.mComponentElement.offsetHeight?r.height/this.mComponentElement.offsetHeight:1,g=r.width/l,y=r.height/m,x=t.clientX,C=t.clientY,c=1;Math.abs(x-r.left)<Math.abs(x-r.right)&&(c=-1);let n=1;Math.abs(C-r.top)<Math.abs(C-r.bottom)&&(n=-1);let u=0;u+=c===1?wt.right:wt.left,u+=n===1?wt.bottom:wt.top;let a=g,o=y,b=E=>{let w=(E.clientX-x)/l*c,f=(E.clientY-C)/m*n,s=g+w,d=y+f;e==="horizontal"&&(s=g),e==="vertical"&&(d=y),[a,o]=this.updateComponentSize(u,s,d,a,o)},v=()=>{document.removeEventListener("pointermove",b),document.removeEventListener("pointerup",v),(a!==g||o!==y)&&this.mResizeEnd.dispatchEvent(this.createResizeEvent(u,a,o,g,y))};document.addEventListener("pointermove",b),document.addEventListener("pointerup",v)}parseBoolean(t){return!!(()=>{if(typeof t=="string"){let r=t.toLowerCase();if(["true","false"].includes(r))return r==="true"}return t})()}updateComponentSize(t,e,r,l,m){let g=l;(this.mConfiguration.enabledDirections.left||this.mConfiguration.enabledDirections.right)&&(g=Math.floor(Math.abs(e)/this.mConfiguration.snap)*this.mConfiguration.snap*(e/Math.abs(e)),this.mConfiguration.isVirtual||this.mComponentElement.style.setProperty("width",`${g}px`));let y=m;return(this.mConfiguration.enabledDirections.top||this.mConfiguration.enabledDirections.bottom)&&(y=Math.floor(Math.abs(r)/this.mConfiguration.snap)*this.mConfiguration.snap*(r/Math.abs(r)),this.mConfiguration.isVirtual||this.mComponentElement.style.setProperty("height",`${y}px`)),(g!==l||y!==m)&&this.mResize.dispatchEvent(this.createResizeEvent(t,g,y,l,m)),[g,y]}static{Or()}},yo=class{mHeight;mResizeHandle;mWidth;get height(){return this.mHeight}get resizeHandle(){return this.mResizeHandle}get width(){return this.mWidth}constructor(t,e,r){this.mHeight=e,this.mResizeHandle=r,this.mWidth=t}},wt={top:1,right:2,bottom:4,left:8};var Yr=`:host {\r
    position: absolute;\r
    z-index: 200;\r
}\r
\r
...
}`;var Wr=`<div class="selection-popup" (pointerdown)="this.stopPropagation($event, false)" (wheel)="this.stopPropagation($event, false)" (contextmenu)="this.stopPropagation($event, true);">\r
...
`;function Rs(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function en(p,t,e,r){return(en=Rs())(p,t,e,r)}function Os(p){return p}var on,Zr,rn,nn,sn,an,ln,qr,Jr,Kr,Qr,kr,tn,ie;on=Y({selector:"potatno-node-selection-popup",template:Wr,style:Yr,components:[qt]}),rn=$.state({complexValue:!0}),nn=bt("searchInput"),sn=yt("node-select"),an=$.state(),ln=$.state();new class extends Os{constructor(){super(ie),Zr()}static{class p{static{({e:[qr,Jr,Kr,Qr,kr,tn],c:[ie,Zr]}=en(this,[[rn,1,"results"],[nn,1,"searchInput"],[sn,1,"mNodeSelect"],[an,1,"searchValue"],[ln,1,"selectedDefinitionId"]],[on]))}static POPUP_WIDTH=280;static POPUP_HEIGHT=320;mComponent;mManager;#t=(tn(this),qr(this));get results(){return this.#t}set results(e){this.#t=e}#e=Jr(this);get searchInput(){return this.#e}set searchInput(e){this.#e=e}#o=Kr(this);get mNodeSelect(){return this.#o}set mNodeSelect(e){this.#o=e}#r=Qr(this);get searchValue(){return this.#r}set searchValue(e){this.#r=e}#n=kr(this);get selectedDefinitionId(){return this.#n}set selectedDefinitionId(e){this.#n=e}constructor(e=R.use(G),r=R.use(X)){this.mManager=r,this.mComponent=e,this.selectedDefinitionId=null,this.results=new Array,this.searchValue=""}onConnect(){this.searchInput?.focus()}onKeyDown(e){if(this.results.length!==0){if(e.key==="ArrowDown"||e.key==="ArrowUp"){e.preventDefault();let r=this.results.findIndex(g=>g.definition.id===this.selectedDefinitionId);r=Math.max(0,r);let l=e.key==="ArrowDown"?1:-1,m=(r+l+this.results.length)%this.results.length;this.selectedDefinitionId=this.results[m].definition.id;return}e.key==="Enter"&&this.sendSelectedEntry(this.selectedDefinitionId)}}onUpdate(){this.rebuildResults();let e=this.mComponent.element.shadowRoot.querySelector(".selection-popup__result.selected");e&&e.scrollIntoView()}stopPropagation(e,r){e.stopPropagation(),r&&e.preventDefault()}rebuildResults(){let e=this.mManager.activeFunction.dynamicNodeDefinitions.map(l=>({category:l.category.name,definition:l,label:l.label.toLowerCase(),color:this.mManager.generateStringColor(l.category.name),icon:l.category.icon})),r=this.searchValue.trim().toLowerCase();this.results=e.filter(l=>l.label.includes(r)),this.results.some(l=>l.definition.id===this.selectedDefinitionId)||(this.selectedDefinitionId=this.results[0]?.definition.id??null)}sendSelectedEntry(e){if(e===null)return;let r=this.results.find(l=>l.definition.id===e);r&&this.mNodeSelect.dispatchEvent(r.definition)}}}};var cn=`:host {\r
    display: block;\r
    font-family: var(--potatno-font-family);\r
    font-size: var(--potatno-font-size);\r
    z-index: -1;\r
...
`;function zs(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function yn(p,t,e,r){return(yn=zs())(p,t,e,r)}var bn,hn,wn,xn,Tn,En,dn,mn,fn,pn,gn,wo;bn=Y({selector:"potatno-comment-node",template:un,style:cn,components:[qt]}),wn=$.state(),xn=yt("node-drag"),Tn=bt("ResizeBox"),En=bt("CommentInput");var vn=class{static{({e:[dn,mn,fn,pn,gn],c:[wo,hn]}=yn(this,[[wn,1,"editMode"],[tt,3,"nodeData"],[xn,1,"mDrag"],[Tn,1,"resizeBox"],[En,1,"commentInput"]],[bn]))}constructor(t=R.use(G),e=R.use(X)){this.mComponent=t,this.mManager=e,this.mNodeData=null,this.mDoubleClickState=null,this.editMode=!1,this.mUnsubscribe=this.mManager.subscribe(O.Node,r=>{r.item===this.nodeData&&this.resyncComponent(this.nodeData)})}mComponent;mManager;mUnsubscribe;mNodeData;mDoubleClickState;#t=(gn(this),dn(this));get editMode(){return this.#t}set editMode(t){this.#t=t}get nodeData(){return this.mNodeData}set nodeData(t){this.mNodeData=t,t&&(this.resyncComponent(t),this.mComponent.updater.update())}#e=mn(this);get mDrag(){return this.#e}set mDrag(t){this.#e=t}#o=fn(this);get resizeBox(){return this.#o}set resizeBox(t){this.#o=t}get comment(){return this.nodeData?.label??""}set comment(t){this.nodeData&&(this.nodeData.label=t)}#r=pn(this);get commentInput(){return this.#r}set commentInput(t){this.#r=t}onConnect(){this.nodeData&&this.resyncComponent(this.nodeData)}onDeconstruct(){this.mUnsubscribe()}onUpdate(){this.commentInput&&this.getFocusedElement(document)!==this.commentInput&&this.commentInput.select()}getFocusedElement(t){let e=t.activeElement;return e?e.shadowRoot?this.getFocusedElement(e.shadowRoot):e:null}dragNodeOrEnableEdit(t){if(!this.nodeData||(this.mDoubleClickState?this.editMode=!0:this.mDoubleClickState={timer:globalThis.setTimeout(()=>{this.mDoubleClickState=null},300)},this.editMode))return;t.preventDefault();let e=this.nodeData.transformation.x*this.mManager.grid.gridSize,r=this.nodeData.transformation.y*this.mManager.grid.gridSize,l=this.nodeData.transformation.x,m=this.nodeData.transformation.y,g=this.mComponent.element.getBoundingClientRect(),y=this.mComponent.element.offsetWidth?g.width/this.mComponent.element.offsetWidth:1,x=this.mComponent.element.offsetHeight?g.height/this.mComponent.element.offsetHeight:1,C=t.clientX,c=t.clientY,n=a=>{a.stopPropagation();let o=(a.clientX-C)/y,b=(a.clientY-c)/x,v=Math.round((e+o)/this.mManager.grid.gridSize),E=Math.round((r+b)/this.mManager.grid.gridSize);l===v&&m===E||(this.mManager.graph.transformNode(this.nodeData,w=>{w.moveTo(v,E)}),this.mDrag.dispatchEvent(new bo(v-l,E-m)),l=v,m=E)},u=()=>{document.removeEventListener("pointermove",n),document.removeEventListener("pointerup",u)};document.addEventListener("pointermove",n),document.addEventListener("pointerup",u)}escapeEditMode(t){(t.key==="Escape"||t.key==="Enter")&&(t.preventDefault(),this.editMode=!1)}transformNodeData(t){this.mManager.graph.transformNode(this.nodeData,e=>{let r=e.transformation.width,l=e.transformation.height;e.resizeTo(t.width/this.mManager.grid.gridSize,t.height/this.mManager.grid.gridSize);let m=e.transformation.width-r,g=e.transformation.height-l;g!==0&&(t.resizeHandle&wt.top)>0&&e.moveTo(e.transformation.x,e.transformation.y-g),m!==0&&(t.resizeHandle&wt.left)>0&&e.moveTo(e.transformation.x-m,e.transformation.y)})}resyncComponent(t){let e=t.transformation.x*this.mManager.grid.gridSize,r=t.transformation.y*this.mManager.grid.gridSize;if(this.mComponent.element.style.setProperty("left",`${e}px`),this.mComponent.element.style.setProperty("top",`${r}px`),this.resizeBox){let l=t.transformation.width*this.mManager.grid.gridSize,m=t.transformation.height*this.mManager.grid.gridSize;this.resizeBox.resize(l,m)}}static{hn()}},bo=class{mX;mY;get x(){return this.mX}get y(){return this.mY}constructor(t,e){this.mX=t,this.mY=e}};var Dn=`:host {\r
    position: absolute;\r
    top: 0;\r
    left: 0;\r
    height: 1px;\r
...
`;function Gs(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function An(p,t,e,r){return(An=Gs())(p,t,e,r)}var Nn,Cn,Ln,Pn,Mn,xo;Nn=Y({selector:"potatno-connection-layer",template:In,style:Dn}),Ln=bt("svgLayer");var Sn=class{static{({e:[Pn,Mn],c:[xo,Cn]}=An(this,[[Ln,1,"svgLayer"]],[Nn]))}constructor(t=R.use(X)){this.mConnectionRegistry=new Map,this.mManager=t;let e=0;this.mUnsubscribe=this.mManager.subscribe(O.SpecialActiveFunction|O.Node|O.Connection,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.renderConnections()}))})}mConnectionRegistry;mManager;mUnsubscribe;#t=(Mn(this),Pn(this));get svgLayer(){return this.#t}set svgLayer(t){this.#t=t}onConnectionDelete(t){if(t.button!==2||!(t.target instanceof Element))return;let e=parseInt(t.target.getAttribute("data-connection-id")??"");if(isNaN(e))return;t.preventDefault(),t.stopPropagation();let r=this.mConnectionRegistry.get(e);r&&this.mManager.graph.disconnectPorts(r.sourcePort,r.targetPort)}onDeconstruct(){this.mUnsubscribe()}renderConnectionPath(t,e,r,l,m){let g="http://www.w3.org/2000/svg",y=this.mManager.connections.getConnectionPath(r,l),x=document.createElementNS(g,"path");x.classList.add("path"),x.classList.toggle(".path--invalid",!m),x.setAttribute("d",y),r.portType==="value"&&x.style.setProperty("--path-color",this.mManager.generateStringColor(r.resolvedDataType));let C=document.createElementNS(g,"path");C.classList.add("path","path--mouse-target"),C.setAttribute("d",y),C.setAttribute("data-connection-id",e.toString()),t.appendChild(x),t.appendChild(C)}renderConnections(){if(!this.svgLayer)return;this.svgLayer.innerHTML="",this.mConnectionRegistry.clear();let t=this.mManager.integrity.errorItems,e=0;for(let r of this.mManager.activeFunction.nodes)for(let l of r.outputs.list)for(let m of l.connectedPorts){let g=e++;this.mConnectionRegistry.set(g,{sourcePort:l,targetPort:m});let y=t.has(l)||t.has(m);this.renderConnectionPath(this.svgLayer,g,l,m,!y)}}static{Cn()}};function Bs(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function On(p,t,e,r){return(On=Bs())(p,t,e,r)}var Fn,_n,Pe;Fn=vt({access:W.Read,selector:/^potatno-preview$/});var Rn=class{static{({c:[Pe,_n]}=On(this,[],[Fn]))}constructor(t=R.use(Q),e=R.use(H),r=R.use(rt)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(r.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let r=this.mTarget.childNodes.length>0;return r&&(this.mTarget.innerHTML=""),r}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{_n()}};var jn=`:host {\r
    display: block;\r
    position: relative;\r
\r
...
`;function Xs(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function Bn(p,t,e,r){return(Bn=Xs())(p,t,e,r)}function Ys(p){return p}var Un,Vn,Hn,$n,Gn,Je;Un=Y({selector:"potatno-port",template:zn,style:jn}),Hn=bt("dragConnection");new class extends Ys{constructor(){super(Je),Vn()}static{class p{static{({e:[$n,Gn],c:[Je,Vn]}=Bn(this,[[Hn,1,"dragConnectionSvg"],[tt,3,"port"]],[Un]))}static DRAG_MIME_TYPE="application/x-potatno-port";static mDraggedPortInformation;mComponent;mDragPositionEventHandler;mManager;mPort;mUnsubscribe;get dragPositionEventHandler(){return this.mDragPositionEventHandler}#t=(Gn(this),$n(this));get dragConnectionSvg(){return this.#t}set dragConnectionSvg(e){this.#t=e}get hasError(){return this.port===null?!1:this.mManager.integrity.errorItems.has(this.port)}get inputDefinitions(){if(!this.port)return new Array;let e=this.port.project.types.getType(this.port.resolvedDataType);return e.inputs.map((r,l)=>({htmlType:(()=>{switch(r.type){case"boolean":return"checkbox";case"number":return"number";case"string":return"text"}})(),index:l,name:r.name,value:this.port.directValue[l]??"",totalCount:e.inputs.length}))}get port(){return this.mPort}set port(e){if(this.mPort!==e){if(e===null)throw new N("A null port cant be assigned.",this);this.mPort=e,this.mComponent.updater.update()}}get portColor(){return!this.port||this.port.portType==="flow"?"var(--potatno-color-text)":this.mManager.generateStringColor(this.port.resolvedDataType)}get portDirection(){return this.port?.direction??"output"}get portHandleClasses(){if(!this.port)return"";let e=[this.port.portType];return this.port.connectedPorts.size>0&&e.push("connected"),this.hasError&&e.push("error"),e.join(" ")}get portName(){return this.port?.label??""}get portType(){return!this.port||this.port.portType!=="value"?"":this.port.resolvedDataType??""}get showValueInput(){return!this.port||this.port.portType!=="value"||this.port.direction!=="input"||this.port.connectedPorts.size>0||p.mDraggedPortInformation&&p.mDraggedPortInformation.port===this.port?!1:!this.port.node.project.types.isGenericType(this.port.dataType??"")}constructor(e=R.use(G),r=R.use(X)){this.mComponent=e,this.mManager=r,this.mPort=null,this.mDragPositionEventHandler=l=>{p.mDraggedPortInformation&&p.mDraggedPortInformation.port===this.port&&(performance.now()-l.timeStamp>100||this.renderDragWire(l.clientX,l.clientY))},this.mUnsubscribe=this.mManager.subscribe(O.Connection,()=>{this.mComponent.updater.updateAsync()})}onConnect(){document.addEventListener("dragover",this.mDragPositionEventHandler,{capture:!0})}onDeconstruct(){this.mUnsubscribe(),document.removeEventListener("dragover",this.mDragPositionEventHandler,{capture:!0})}onDirectValueInput(e,r){if(!this.port)return;let l=e.target,m=[...this.port.directValue];m[r]=l.type==="checkbox"?l.checked?"true":"false":l.value,this.mManager.graph.setPortDirectValue(this.port,m)}onDragEnd(e){e.stopPropagation(),e.preventDefault(),this.dragConnectionSvg&&(this.dragConnectionSvg.innerHTML=""),this.mComponent.updater.updateAsync()}onDragOver(e){this.draggedPortCanConnect(e.dataTransfer)&&(e.preventDefault(),e.stopPropagation(),e.dataTransfer&&(e.dataTransfer.dropEffect="link"))}onDragStart(e){if(!this.port||!e.dataTransfer){e.preventDefault();return}e.stopPropagation(),e.dataTransfer.effectAllowed="link",e.dataTransfer.setData(p.DRAG_MIME_TYPE,this.port.definitionId),e.dataTransfer.setDragImage(document.createElement("div"),0,0);let r=this.mManager.connections.getPortGridPoint(this.port);this.port.direction==="input"&&(r.x-=1),p.mDraggedPortInformation={port:this.port,portPosition:{x:r.x+1,y:r.y},lastPointerGridPosition:{x:0,y:0}},this.mComponent.updater.updateAsync()}onDrop(e){if(!this.draggedPortCanConnect(e.dataTransfer)||(e.preventDefault(),e.stopPropagation(),!p.mDraggedPortInformation)||!this.port)return;let r=p.mDraggedPortInformation.port;this.mManager.graph.connectPorts(r,this.port)}createDragPath(e,r){if(!this.port)return"";let l=this.mManager.connections.pixelToGridSpace(e,r);return this.mManager.connections.createTemporaryPath(this.port,l)}draggedPortCanConnect(e){if(!this.port||!p.mDraggedPortInformation||!e||!e.types.includes(p.DRAG_MIME_TYPE))return!1;let r=p.mDraggedPortInformation.port;return r!==this.port&&r.direction!==this.port.direction&&r.portType===this.port.portType}renderDragWire(e,r){if(!p.mDraggedPortInformation||!this.dragConnectionSvg)return;let l=this.dragConnectionSvg.firstChild;l||(l=document.createElementNS("http://www.w3.org/2000/svg","path"),this.dragConnectionSvg.appendChild(l));let m=this.mManager.connections.pixelToGridSpace(e,r);if(m.x===p.mDraggedPortInformation.lastPointerGridPosition.x&&m.y===p.mDraggedPortInformation.lastPointerGridPosition.y)return;p.mDraggedPortInformation.lastPointerGridPosition.x=m.x,p.mDraggedPortInformation.lastPointerGridPosition.y=m.y;let g=p.mDraggedPortInformation.portPosition,y=g.x*this.mManager.grid.gridSize,x=g.y*this.mManager.grid.gridSize;this.dragConnectionSvg.style.setProperty("transform",`translate(${-y}px, ${-x}px)`),l.setAttribute("d",this.createDragPath(e,r))}}}};var Xn=`:host {\r
    display: block;\r
    font-family: var(--potatno-font-family);\r
    font-size: var(--potatno-font-size);\r
\r
...
\r
        ...
        `;function qs(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function ei(p,t,e,r){return(ei=qs())(p,t,e,r)}var oi,Wn,ri,ni,ii,si,ai,Zn,qn,Jn,Kn,Qn,kn,Eo;oi=Y({selector:"potatno-node",template:Yn,style:Xn,modules:[Pe],components:[Je]}),ri=yt("node-drag"),ni=$.state(),ii=$.state({proxy:!0}),si=$.state({complexValue:!0}),ai=$.state({complexValue:!0});var ti=class{static{({e:[Zn,qn,Jn,Kn,Qn,kn],c:[Eo,Wn]}=ei(this,[[ri,1,"mDrag"],[ni,1,"isPreviewDisplaySelectionOpen"],[tt,3,"nodeData"],[ii,1,"nodeTransformation"],[si,1,"previewPorts"],[ai,1,"previewDisplays"]],[oi]))}constructor(t=R.use(G),e=R.use(X)){this.mComponent=t,this.mManager=e,this.mNodeDefinition=null,this.mNodeData=null,this.isPreviewDisplaySelectionOpen=!1,this.nodeTransformation={height:0,width:0},this.previewPorts=new Array,this.previewDisplays=new Array,this.mUnsubscribe=this.mManager.subscribe(O.Node,r=>{r.item===this.nodeData&&this.resyncComponent(this.nodeData)})}mComponent;mManager;mNodeData;mNodeDefinition;mUnsubscribe;get canPreview(){return this.previewPorts.length>0}#t=(kn(this),Zn(this));get mDrag(){return this.#t}set mDrag(t){this.#t=t}get hasError(){if(!this.nodeData)return!1;if(this.mManager.integrity.errorItems.has(this.nodeData))return!0;for(let t of this.nodeData.inputs.list)if(this.mManager.integrity.errorItems.has(t))return!0;for(let t of this.nodeData.outputs.list)if(this.mManager.integrity.errorItems.has(t))return!0;return!1}get inputPorts(){return this.nodeData?this.nodeData.inputs.list:new Array}get isFunction(){return this.mNodeDefinition instanceof Mt}get isPreviewActive(){return!!this.nodeData?.preview}#e=qn(this);get isPreviewDisplaySelectionOpen(){return this.#e}set isPreviewDisplaySelectionOpen(t){this.#e=t}get nodeColor(){return this.mManager.generateStringColor(this.mNodeDefinition?.category.name??"")}get nodeData(){return this.mNodeData}set nodeData(t){this.mNodeData=t,this.mNodeDefinition=null,t&&(this.mNodeDefinition=this.mManager.activeFunction.nodeDefinitions.find(e=>e.id===this.nodeData.definitionId)??null,this.resyncComponent(t),this.mComponent.updater.update())}get nodeIcon(){return this.mNodeDefinition?.category.icon??""}get nodeLabel(){return this.nodeData?.label??""}#o=Jn(this);get nodeTransformation(){return this.#o}set nodeTransformation(t){this.#o=t}get outputPorts(){return this.nodeData?this.nodeData.outputs.list:new Array}#r=Kn(this);get previewPorts(){return this.#r}set previewPorts(t){this.#r=t}#n=Qn(this);get previewDisplays(){return this.#n}set previewDisplays(t){this.#n=t}get previewDisplayId(){return this.nodeData?.preview?.displayId??""}get previewDriver(){if(!this.nodeData?.preview)return null;let t=this.nodeData.outputs.map.get(this.nodeData.preview.portDefinitionId);return t?this.mManager.preview.requestDriver(t,this.nodeData.preview.displayId):null}get previewPortDefinitionId(){return this.nodeData?.preview?.portDefinitionId??""}dragNode(t){if(!this.nodeData)return;t.preventDefault();let e=this.nodeData.transformation.x*this.mManager.grid.gridSize,r=this.nodeData.transformation.y*this.mManager.grid.gridSize,l=this.nodeData.transformation.x,m=this.nodeData.transformation.y,g=this.mComponent.element.getBoundingClientRect(),y=this.mComponent.element.offsetWidth?g.width/this.mComponent.element.offsetWidth:1,x=this.mComponent.element.offsetHeight?g.height/this.mComponent.element.offsetHeight:1,C=t.clientX,c=t.clientY,n=a=>{a.stopPropagation();let o=(a.clientX-C)/y,b=(a.clientY-c)/x,v=Math.round((e+o)/this.mManager.grid.gridSize),E=Math.round((r+b)/this.mManager.grid.gridSize);l===v&&m===E||(this.mManager.graph.transformNode(this.nodeData,w=>{w.moveTo(v,E)}),this.mDrag.dispatchEvent(new To(v-l,E-m)),l=v,m=E)},u=()=>{document.removeEventListener("pointermove",n),document.removeEventListener("pointerup",u)};document.addEventListener("pointermove",n),document.addEventListener("pointerup",u)}onDeconstruct(){this.mUnsubscribe()}openFunction(){this.mNodeDefinition instanceof Mt&&this.mManager.setActiveFunction(this.mNodeDefinition.function)}selectPreviewDisplay(t){this.mManager.graph.updateNode(this.nodeData,e=>{e.preview={portDefinitionId:e.preview.portDefinitionId,displayId:t}}),document.activeElement instanceof HTMLElement&&document.activeElement.blur()}selectPreviewPort(t){if(!this.nodeData)return;let e=(()=>{let r=this.previewPorts;return r.length===0?null:typeof t<"u"?r.find(l=>l.definitionId===t)??null:this.nodeData.preview?null:r[0]})();if(!e)return this.mManager.graph.updateNode(this.nodeData,r=>{r.preview=null});this.mManager.graph.updateNode(this.nodeData,r=>{let l=r.project.getFunction(r.function.definitionId),m=r.project.preview.availableDisplays(l,e.resolvedDataType);m.length===0&&(r.preview=null);let g=r.preview&&m.includes(r.preview.displayId)?r.preview.displayId:m[0];r.preview={portDefinitionId:e.definitionId,displayId:g}}),this.resyncComponent(this.nodeData)}getPreviewDisplays(t){if(!this.nodeData||!t)return new Array;let e=this.nodeData.outputs.map.get(t);if(!e)return new Array;let r=e.project.getFunction(e.node.function.definitionId);return r?e.project.preview.availableDisplays(r,e.resolvedDataType).map(m=>({id:m,label:e.project.preview.getDisplay(m)?.name??m})):new Array}getPreviewablePorts(t){let e=t.project.getFunction(t.function.definitionId);if(!this.mManager.activeFunction.dynamicNodeDefinitions.find(m=>m.id===t.definitionId))return new Array;let l=new Map;return t.outputs.value.filter(m=>{let g=m.resolvedDataType;if(l.has(g))return l.get(g);let y=t.project.preview.availableDisplays(e,m.resolvedDataType);return l.set(g,y.length>0),l.get(g)})}resyncComponent(t){let e=t.transformation.x*this.mManager.grid.gridSize,r=t.transformation.y*this.mManager.grid.gridSize;this.mComponent.element.style.setProperty("left",`${e}px`),this.mComponent.element.style.setProperty("top",`${r}px`),this.nodeTransformation.width=t.transformation.width,this.nodeTransformation.height=t.transformation.height,this.previewPorts=this.getPreviewablePorts(this.nodeData),this.previewDisplays=this.getPreviewDisplays(t.preview?.portDefinitionId??null)}static{Wn()}},To=class{mX;mY;get x(){return this.mX}get y(){return this.mY}constructor(t,e){this.mX=t,this.mY=e}};var li=`:host {\r
    position: relative;\r
    flex: 1;\r
    display: flex;\r
    min-height: 0;\r
...
`;function Qs(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function fi(p,t,e,r){return(fi=Qs())(p,t,e,r)}function ks(p){return p}var pi,ui,gi,vi,hi,di,mi,Ke;pi=Y({selector:"potatno-node-graph",template:ci,style:li,components:[ie,Eo,wo,xo]}),gi=$.state({complexValue:!0}),vi=$.state();new class extends ks{constructor(){super(Ke),ui()}static{class p{static{({e:[hi,di,mi],c:[Ke,ui]}=fi(this,[[gi,1,"selectBox"],[vi,1,"popupPosition"]],[pi]))}static ZOOM_STRENGTH=.1;mComponent;mManager;mSelectedNodes;mKeyboardHandler;mIsMouseInsideGrid;mUnsubscribeFunctionChange;mUnsubscribeGraphChange;#t=(mi(this),hi(this));get selectBox(){return this.#t}set selectBox(e){this.#t=e}#e=di(this);get popupPosition(){return this.#e}set popupPosition(e){this.#e=e}get gridBackgroundStyle(){let e=this.mManager.grid.gridSize*this.mManager.grid.zoom,r=this.mManager.grid.panX%e,l=this.mManager.grid.panY%e;return`background-size: ${e}px ${e}px; background-position: ${r}px ${l}px;`}get gridTransformStyle(){return`transform: translate(${this.mManager.grid.panX}px, ${this.mManager.grid.panY}px) scale(${this.mManager.grid.zoom})`}get nodes(){return this.mManager.activeFunction.nodes}get selectedNode(){return this.mSelectedNodes}constructor(e=R.use(G),r=R.use(X)){this.mComponent=e,this.mManager=r,this.mSelectedNodes=new Set,this.mIsMouseInsideGrid=!1,this.popupPosition=null,this.selectBox=null,e.element.addEventListener("pointerdown",l=>{this.onPointerDown(l)}),e.element.addEventListener("wheel",l=>{this.onScroll(l)}),e.element.addEventListener("contextmenu",l=>{l.preventDefault()}),e.element.addEventListener("pointerenter",()=>{this.mIsMouseInsideGrid=!0}),e.element.addEventListener("pointerleave",()=>{this.mIsMouseInsideGrid=!1}),this.mKeyboardHandler=l=>{this.onKeyDown(l)},document.addEventListener("keydown",this.mKeyboardHandler),this.mUnsubscribeFunctionChange=this.mManager.subscribe(O.Document|O.Function|O.SpecialActiveFunction,()=>{this.popupPosition=null,this.selectBox=null,this.selectNodes([],!1)}),this.mUnsubscribeGraphChange=this.mManager.subscribe(O.NodeAdd|O.NodeDelete|O.SpecialGrid,()=>{this.mComponent.updater.updateAsync()})}onConnect(){this.mManager.connections.gridElement=this.mComponent.element}onDeconstruct(){this.mUnsubscribeFunctionChange(),this.mUnsubscribeGraphChange(),document.removeEventListener("keydown",this.mKeyboardHandler)}onPointerDown(e){switch(this.popupPosition=null,e.button){case 0:{e.ctrlKey||this.selectNodes([],!1),this.pointerDrag(e,"selecting");return}case 1:{e.preventDefault(),this.pointerDrag(e,"panning");return}case 2:{this.openAddNodePopupAtPointer(e.clientX,e.clientY);return}}}onScroll(e){e.preventDefault();let r=e.deltaY>0?-1:1,l=this.convertGlobalToGridPosition(e.clientX,e.clientY);this.mManager.grid.zoomAt(l.x,l.y,r*p.ZOOM_STRENGTH)}createNodeOnPopupPosition(e){let r=this.mManager.graph.addNode(this.mManager.activeFunction,e,{x:this.popupPosition?.grid.x??0,y:this.popupPosition?.grid.y??0,height:0,width:0});this.popupPosition=null,this.selectNodes([r],!1)}typeOfNode(e){switch(e.definitionId){case mt.DEFINITION_ID:return"comment";case Tt.DEFINITION_ID:case xt.DEFINITION_ID:return"conjunction";default:return"node"}}pointerDrag(e,r){let l=this.convertGlobalToGridPosition(e.clientX,e.clientY),m=l,g=x=>{let C=this.convertGlobalToGridPosition(x.clientX,x.clientY);switch(r){case"panning":{this.mManager.grid.pan(C.x-m.x,C.y-m.y);break}case"selecting":{this.selectBox={x:Math.min(l.x,C.x),y:Math.min(l.y,C.y),width:Math.abs(C.x-l.x),height:Math.abs(C.y-l.y)};break}}m=C},y=x=>{if(document.removeEventListener("pointermove",g),document.removeEventListener("pointerup",y),r==="selecting"&&this.selectBox){let C=this.convertLocalToGridCoordinate(this.selectBox.x,this.selectBox.y),c=this.convertLocalToGridCoordinate(this.selectBox.x+this.selectBox.width,this.selectBox.y+this.selectBox.height),n=this.mManager.grid.gridSize,u=this.getNodesInRectangle({top:C.y/n,right:c.x/n,bottom:c.y/n,left:C.x/n});this.selectNodes(u,x.ctrlKey),this.selectBox=null}};document.addEventListener("pointermove",g),document.addEventListener("pointerup",y)}onKeyDown(e){if(!this.mIsMouseInsideGrid)return;let r=document.activeElement;if(!(r instanceof HTMLInputElement||r instanceof HTMLTextAreaElement||r instanceof HTMLSelectElement)){switch(e.key){case"Escape":{this.popupPosition=null;return}case"Delete":{for(let l of this.mSelectedNodes)this.mManager.graph.removeNode(l);this.selectNodes([],!1);return}}if(e.ctrlKey)switch(e.key){case"z":{e.preventDefault(),this.mManager.history.undo();return}case"y":{e.preventDefault(),this.mManager.history.redo();return}case"c":{this.mManager.clipboard.copy(this.mSelectedNodes);return}case"v":e.preventDefault(),this.pasteFromClipboard()}}}convertGlobalToGridPosition(e,r){let l=this.mComponent.element.getBoundingClientRect();return{x:e-l.left,y:r-l.top}}moveAllSelected(e,r){for(let l of this.mSelectedNodes)l!==e&&this.mManager.graph.transformNode(l,m=>{m.moveTo(m.transformation.x+r.x,m.transformation.y+r.y)})}selectNodes(e,r){this.popupPosition=null;let l=!!r;r instanceof PointerEvent&&(r.stopPropagation(),l=r.ctrlKey);let m=new Set;if(!l)if(e.length===1&&this.mSelectedNodes.has(e.at(0)))for(let y of this.mSelectedNodes)m.add(y);else this.mSelectedNodes.clear();let g=[...e];for(let y=0;y<g.length;y++){let x=g[y];m.has(x)||(m.add(x),x.definitionId===mt.DEFINITION_ID&&g.push(...this.getNodesInRectangle({top:x.transformation.y,right:x.transformation.x+x.transformation.width,bottom:x.transformation.y+x.transformation.height,left:x.transformation.x})),this.mSelectedNodes.has(x)?this.mSelectedNodes.delete(x):this.mSelectedNodes.add(x))}this.mComponent.updater.updateAsync()}openAddNodePopupAtPointer(e,r){let l=this.mComponent.element,m=this.convertGlobalToGridPosition(e,r),g=this.convertLocalToGridCoordinate(m.x,m.y),y=8,x=Math.max(0,l.clientWidth-ie.POPUP_WIDTH-y),C=Math.max(0,l.clientHeight-ie.POPUP_HEIGHT-y);this.popupPosition={local:{x:Math.max(y,Math.min(m.x,x)),y:Math.max(y,Math.min(m.y,C))},grid:{x:Math.round(g.x/this.mManager.grid.gridSize),y:Math.round(g.y/this.mManager.grid.gridSize)}}}convertLocalToGridCoordinate(e,r){return{x:(e-this.mManager.grid.panX)/this.mManager.grid.zoom,y:(r-this.mManager.grid.panY)/this.mManager.grid.zoom}}pasteFromClipboard(){let e=this.mManager.clipboard.paste();e.length!==0&&this.selectNodes(e,!1)}getNodesInRectangle(e){let r=new Array;for(let l of this.mManager.activeFunction.nodes){let m=l.transformation.y,g=l.transformation.x,y=g+l.transformation.width,x=m+l.transformation.height;if(g<e.right&&y>e.left&&m<e.bottom&&x>e.top){if(e.top>m&&e.right<y&&e.bottom<x&&e.left>g)continue;r.push(l)}}return r}}}};var se=class{mCodeGenerator;mId;mLabel;mNodesProvider;mStatics;get codeGenerator(){return this.mCodeGenerator}get id(){return this.mId}get label(){return this.mLabel}get statics(){return this.mStatics}constructor(t){this.mId=t.id,this.mLabel=t.label,this.mNodesProvider=t.nodes,this.mStatics=t.statics,this.mCodeGenerator=t.generator.code}getNodeDefinitions(t){let e=l=>{if(!l)return new Array;let m=new Array;return l(g=>{m.push(g)},t),m},r={};return Object.defineProperty(r,"entry",{get:()=>e(this.mNodesProvider.entry)}),Object.defineProperty(r,"exit",{get:()=>e(this.mNodesProvider.exit)}),Object.defineProperty(r,"dynamic",{get:()=>e(this.mNodesProvider.dynamic)}),r}},Ot={none:0,imports:1,inputs:2,outputs:4};var yi=`:host {\r
    display: flex;\r
    flex-direction: column;\r
    height: 100%;\r
    overflow: hidden;\r
...
`;function oa(){function p(c,n){return function(a){e(n,"addInitializer"),r(a,"An initializer"),c.push(a)}}function t(c,n,u,a,o,b,v,E,w){var f;switch(o){case 1:f="accessor";break;case 2:f="method";break;case 3:f="getter";break;case 4:f="setter";break;default:f="field"}var s={kind:f,name:v?"#"+n:n,static:b,private:v,metadata:E},d={v:!1};s.addInitializer=p(a,d);var i,h;o===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(T){this[n]=T}):o===2?i=function(){return u.value}:((o===1||o===3)&&(i=function(){return u.get.call(this)}),(o===1||o===4)&&(h=function(T){u.set.call(this,T)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return c(w,s)}finally{d.v=!0}}function e(c,n){if(c.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(c,n){if(typeof c!="function")throw new TypeError(n+" must be a function")}function l(c,n){var u=typeof n;if(c===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(u!=="function"){var a;throw c===0?a="field":c===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function m(c,n,u,a,o,b,v,E,w){var f=u[0],s,d,i;v?o===0||o===1?s={get:u[3],set:u[4]}:o===3?s={get:u[3]}:o===4?s={set:u[3]}:s={value:u[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var h,T,P;if(typeof f=="function")h=t(f,a,s,E,o,b,v,w,i),h!==void 0&&(l(o,h),o===0?d=h:o===1?(d=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h);else for(var M=f.length-1;M>=0;M--){var S=f[M];if(h=t(S,a,s,E,o,b,v,w,i),h!==void 0){l(o,h);var A;o===0?A=h:o===1?(A=h.init,T=h.get||i.get,P=h.set||i.set,i={get:T,set:P}):i=h,A!==void 0&&(d===void 0?d=A:typeof d=="function"?d=[d,A]:d.push(A))}}if(o===0||o===1){if(d===void 0)d=function(I,D){return D};else if(typeof d!="function"){var F=d;d=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var z=d;d=function(I,D){return z.call(I,D)}}c.push(d)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),v?o===1?(c.push(function(I,D){return i.get.call(I,D)}),c.push(function(I,D){return i.set.call(I,D)})):o===2?c.push(i):c.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(c,n,u){for(var a=[],o,b,v=new Map,E=new Map,w=0;w<n.length;w++){var f=n[w];if(Array.isArray(f)){var s=f[1],d=f[2],i=f.length>3,h=s>=5,T,P;if(h?(T=c,s=s-5,b=b||[],P=b):(T=c.prototype,o=o||[],P=o),s!==0&&!i){var M=h?E:v,S=M.get(d)||0;if(S===!0||S===3&&s!==4||S===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!S&&s>2?M.set(d,s):M.set(d,!0)}m(a,T,f,d,s,h,i,P,u)}}return y(a,o),y(a,b),a}function y(c,n){n&&c.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function x(c,n,u){if(n.length>0){for(var a=[],o=c,b=c.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](o,{kind:"class",name:b,addInitializer:p(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(l(10,w),o=w)}return[C(o,u),function(){for(var f=0;f<a.length;f++)a[f].call(o)}]}}function C(c,n){return Object.defineProperty(c,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,o){if(o!==void 0)var b=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||C(n,v),{e:E,get c(){return x(n,a,v)}}}}function Di(p,t,e,r){return(Di=oa())(p,t,e,r)}var Ii,wi,Ci,xi,Ti,Do;Ii=Y({selector:"potatno-function-properties",template:bi,style:yi}),Ci=$.state({complexValue:!0});var Ei=class{static{({e:[xi,Ti],c:[Do,wi]}=Di(this,[[Ci,1,"functionProperties"]],[Ii]))}constructor(t=R.use(X)){this.mManager=t,this.mSelectedImportId="",this.mProjectTypes=new Set,this.functionProperties=this.convertFunctionProperties(),this.mUnsubscribe=this.mManager.subscribe(O.Document|O.Function|O.SpecialActiveFunction,()=>{this.mProjectTypes.clear();for(let[e]of this.mManager.project.types.types)this.mProjectTypes.add(e);this.functionProperties=this.convertFunctionProperties()})}mManager;mProjectTypes;mSelectedImportId;mUnsubscribe;#t=(Ti(this),xi(this));get functionProperties(){return this.#t}set functionProperties(t){this.#t=t}get projectTypes(){return this.mProjectTypes}get selectedImportId(){return this.mSelectedImportId}set selectedImportId(t){this.mSelectedImportId=t}get unusedImports(){return this.mManager.activeFunction.project.imports.filter(t=>!this.functionProperties.imports.find(e=>t.id===e.id))}addPort(t){let e=this.projectTypes.values().next().value;if(!e)return;let r=t===this.functionProperties.inputs?"Input":"Output";t.push({label:r,dataType:e,hasError:!1}),this.submitChange()}addSelectedImport(){let t=this.unusedImports;if(t.length===0)return;let e=t.find(r=>r.id===this.mSelectedImportId);e||(e=t.at(0)),this.functionProperties.imports.push(e),this.submitChange()}deleteImport(t){let e=this.functionProperties.imports.indexOf(t);e!==-1&&(this.functionProperties.imports.splice(e,1),this.submitChange())}deletePort(t,e){let r=e.indexOf(t);r!==-1&&(e.splice(r,1),this.submitChange())}onDeconstruct(){this.mUnsubscribe()}async submitChange(){let t=!1,e=new Set;for(let g of this.functionProperties.inputs)g.hasError=e.has(g.label),t||=g.hasError,e.add(g.label);let r=new Set;for(let g of this.functionProperties.outputs)g.hasError=r.has(g.label),t||=g.hasError,r.add(g.label);if(t){this.functionProperties=this.functionProperties;return}let l=this.mManager.activeFunction,m=this.functionProperties;await new Promise(g=>{globalThis.setTimeout(g,10)}),this.mManager.graph.updateFunction(l,g=>{if(g.label=m.label,!m.statics.inputs){for(;g.inputs.length>0;)g.removeInput(g.inputs.at(0));for(let y of m.inputs)g.addInput({dataType:y.dataType,label:y.label})}if(!m.statics.outputs){for(;g.outputs.length>0;)g.removeOutput(g.outputs.at(0));for(let y of m.outputs)g.addOutput({dataType:y.dataType,label:y.label})}if(!m.statics.imports){for(let y of g.imports)g.removeImport(y);for(let y of m.imports)g.addImport(y.id)}})}convertFunctionProperties(){let t={label:"",inputs:new Array,outputs:new Array,imports:new Array,statics:{label:!0,imports:!0,inputs:!0,outputs:!0}},e=this.mManager.activeFunction,r=e.project.getFunction(e.definitionId);r&&(t.statics.label=e.isSystem,t.statics.imports=(r.statics&Ot.imports)!==0,t.statics.inputs=(r.statics&Ot.inputs)!==0,t.statics.outputs=(r.statics&Ot.outputs)!==0),t.label=e.label;for(let l of e.project.imports)e.imports.has(l.id)&&t.imports.push({id:l.id,label:l.label});for(let l of e.inputs)t.inputs.push({label:l.label,dataType:l.dataType,hasError:!1});for(let l of e.outputs)t.outputs.push({label:l.label,dataType:l.dataType,hasError:!1});return t}static{wi()}};var Qe=class{mDependencies;mDocument;mEntryPoint;get code(){return this.mDocument.project.generator.code(this)}get dependencies(){return this.mDependencies}get entryPoint(){return this.mEntryPoint}constructor(t,e,r){this.mDocument=t,this.mEntryPoint=e,this.mDependencies=r}};var ke=class{mFunction;mGraphs;get code(){let t=this.mFunction.project.getFunction(this.mFunction.definitionId);if(!t)throw new N("Function result has an invalid function definition id.",this);return t.codeGenerator.body(this)}get function(){return this.mFunction}get graphs(){return Array.from(this.mGraphs.values())}constructor(t){this.mFunction=t,this.mGraphs=new Map}addGraph(t){this.mGraphs.set(t.entryNode.definitionId,t)}graphResultOf(t){return this.mGraphs.get(t)}};var to=class{mBodyCode;mDependencies;mEntryNode;mExitNode;mNodeIds;mPorts;get code(){return this.mBodyCode}get dependencies(){return this.mDependencies}get entryNode(){return this.mEntryNode}get exitNode(){return this.mExitNode}get nodes(){return this.mNodeIds}get ports(){return this.mPorts}constructor(t){this.mBodyCode=t.bodyCode,this.mDependencies=[...t.dependencies],this.mEntryNode=t.entryNode,this.mExitNode=t.exitNode,this.mNodeIds=t.nodeIds,this.mPorts=t.portValues}};var ae=class{mProject;constructor(t){this.mProject=t}generateDocument(t,e=!1){let r=[...t.functions].find(l=>l.isSystem);if(!r)throw new N("No entry point function found for code generation.",this);return this.generateFunction(r,e)}generateFunction(t,e=!1){return this.buildDocumentResult(t.document,t.getExitNodes(),e)}generateNode(t,e=!1){return this.buildDocumentResult(t.document,[t],e)}buildDocumentResult(t,e,r){if(t.validate().errors.length>0)throw new N("Code generation exited. Code graph validation failed.",this);let m={counter:{nodeIndex:0,portIndex:0},debug:r,nodeDefinitions:new Map},g=this.generateFunctionWithDependencies(m,e,new Set),y=g.pop();return new Qe(t,y,g)}countNodeEncounter(t,e){let r=new Map,l=new Set,m=new Array(t);for(;m.length>0;){let g=m.pop();if(r.set(g,(r.get(g)??0)+1),!(g===e||l.has(g))){l.add(g);for(let y of g.inputs.flow)for(let x of this.resolveFlowConjunctions(y))m.push(x.node);for(let y of g.inputs.value){let x=this.resolveValueConjunctions(y);x&&m.push(x.node)}}}return r}createScope(t,e){return{emittedNodes:new Set,remaining:this.countNodeEncounter(t,e)}}emitNode(t,e,r,l,m){if(!t.nodeDefinitions.get(r.function)){let a=new Map;for(let o of r.function.nodeDefinitions)a.set(o.id,o);t.nodeDefinitions.set(r.function,a)}let g=t.nodeDefinitions.get(r.function).get(r.definitionId);if(!g)throw new N(`Node definition "${r.definitionId}" not found for node "${r.label}".`,this);g instanceof Mt&&e.dependencies.push(g.function);let y={},x=new Array;for(let a of r.inputs.value){let o=this.resolveInputValue(t,e,a);y[a.definitionId]=o.inputPort,e.ports.set(a,o.inputPort.value),o.emitResult&&x.push(o.emitResult)}let C={};for(let a of r.outputs.list)C[a.definitionId]={value:this.generatePortValue(t,e,a),code:{inner:l[a.definitionId]??""}};let c=g.codeGenerator({inputs:y,outputs:C,code:{next:m??""}}),n=this.getGeneratedNodeId(t,e,r);t.debug&&(c=this.mProject.generator.value.hook(`start-${n}`)+c+this.mProject.generator.value.hook(`end-${n}`));let u=new Array;for(let a of x)u.push(...a.codeOutput);return u.push(c),{codeOutput:u,lastGeneratedNode:r,endFlowPort:null}}findBranchStartPoint(t){let e=this.getNodesInputFlowPorts(t),r=e.length,l=new Map,m=new Array,g=(y,x)=>{let C=(l.has(y)||l.set(y,new Set),l.get(y)),c=C.size;for(let n of x)C.add(n);return C.size>c&&m.push(y),C};for(let[y,x]of e.entries())g(x.node,[y]);for(;m.length>0;){let y=m.shift(),x=l.get(y);for(let C of this.getNodesInputFlowPorts(y))if(g(C.node,x).size===r)return C.node}throw new N("No common branch point found for merge node.",this)}generateFunctionWithDependencies(t,e,r){let l=new Array;if(e.length===0)return l;let m=e.at(0).function;r.add(m);let g=new ke(m);l.push(g);for(let y of e){let x=this.generateNodeCode(t,y);g.addGraph(x);for(let C of x.dependencies)r.has(C)||l.push(...this.generateFunctionWithDependencies(t,C.getExitNodes(),r))}return l.reverse()}generateNodeCode(t,e){let r={dependencies:new Array,nodes:new Map,ports:new Map,scope:this.createScope(e,null)},l=this.walkBackward(t,r,e,null),m=l.codeOutput.join(" ");return new to({bodyCode:m,dependencies:r.dependencies,entryNode:l.lastGeneratedNode,exitNode:e,nodeIds:new Map(r.nodes),portValues:new Map(r.ports)})}generatePortValue(t,e,r){if(!e.ports.has(r)){let l=this.mProject.generator.value.name(r.label),m=this.mProject.generator.value.id(l,t.counter.portIndex++);e.ports.set(r,m)}return e.ports.get(r)}getGeneratedNodeId(t,e,r){if(!e.nodes.has(r)){let m=(++t.counter.nodeIndex).toString(16).toUpperCase().padStart(8,"0");e.nodes.set(r,m)}return e.nodes.get(r)}getNodesInputFlowPorts(t){let e=new Array;for(let r of t.inputs.flow)e.push(...this.resolveFlowConjunctions(r));return[...new Set(e)]}handleFlowMerge(t,e,r,l,m){let g=m.join(" "),y=this.findBranchStartPoint(r),x={},C=e.scope;try{for(let c of l){e.scope=this.createScope(c.node,y);let n=this.walkBackward(t,e,c.node,y);x[n.endFlowPort.definitionId]=n.codeOutput.join(" ")}}finally{e.scope=C}return this.emitNode(t,e,y,x,g)}resolveFlowConjunctions(t){let e=new Array;for(let r of t.connectedPorts){if(r.node.definitionId!==xt.DEFINITION_ID){e.push(r);continue}let l=r.node.inputs.flow[0];!l||l.connectedPorts.size===0||e.push(...this.resolveFlowConjunctions(l))}return e}resolveInputValue(t,e,r){let l=this.resolveValueConjunctions(r);if(!l){if(this.mProject.types.isGenericType(r.dataType))throw new N("Generic value inputs must be allways connected",this);return{inputPort:{value:this.mProject.types.getType(r.dataType).convert([...r.directValue]),isDirectValue:!0},emitResult:null}}let m=l.node,g=!m.hasFlowPorts,y=(()=>{if(!m.hasFlowPorts){if(e.scope.emittedNodes.has(m))return null;let x=e.scope.remaining.get(m);if(g&&(x=0),e.scope.remaining.set(m,x),x<=0)return e.scope.emittedNodes.add(m),this.emitNode(t,e,m,{})}return null})();return{inputPort:{value:this.generatePortValue(t,e,l),isDirectValue:!1},emitResult:y}}resolveValueConjunctions(t){if(t.connectedPorts.size===0)return null;let e=t.connectedPorts.values().next().value;if(e.node.definitionId!==Tt.DEFINITION_ID)return e;let r=e.node.inputs.value[0];return!r||r.connectedPorts.size===0?null:this.resolveValueConjunctions(r)}walkBackward(t,e,r,l){let m={codeOutput:new Array,lastGeneratedNode:null,endFlowPort:null},g=null,y=r;for(;y!==null&&y!==l;){let x={};g!==null&&(x[g.definitionId]=m.codeOutput.join(" "),m.codeOutput=new Array);let C=m.codeOutput;m=this.emitNode(t,e,y,x),m.codeOutput=[...m.codeOutput,...C];let c=this.getNodesInputFlowPorts(y);if(c.length===0)break;c.length>1&&(m=this.handleFlowMerge(t,e,y,c,m.codeOutput),c=this.getNodesInputFlowPorts(m.lastGeneratedNode)),g=c[0]??null,y=g?.node??null}if(!m.lastGeneratedNode)throw new N(`Walk did not reach an entry node from exit "${r.label}".`,this);if(l&&y!==l)throw new N("Malformed graph. End node not reached",this);return m.endFlowPort=g,m}};var st=class{static MAIN="MAIN";mBuild;mDefaultParameters;mFunction;mTypes;get defaultParameters(){return this.mDefaultParameters}get function(){return this.mFunction}get types(){return this.mTypes}constructor(t,e){this.mFunction=t,this.mDefaultParameters=e.defaultParameters,this.mTypes=new Set(e.types),this.mBuild=e.build}compile(t,e){return this.mBuild({defaultParameters:this.mDefaultParameters,function:this.mFunction,projectTypes:t.entryPoint.function.project.types},t,e)}};var Pi=`:host {\r
