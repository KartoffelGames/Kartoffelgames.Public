...
\r
    ...
    top: 0;\r
    left: 0;\r
    width: calc(var(--potatno-grid-size) * var(--comment-node-width) * 1px);\r
    height: calc(var(--potatno-grid-size) * var(--comment-node-height) * 1px);\r
    font-size: calc(120px / var(--zoom-factor));\r
\r
...
}`;var Bn=`<div class="port-wrapper {{this.portDirection}}" style="--type-color: {{this.portColor}}" (dragover)="this.onDragOver($event)" (drop)="this.onDrop($event)">\r
\r
...
.selection-box {\r
    ...
    pointer-events: none;\r
    z-index: 1000;\r
}`;var mi=`<!-- Serves only as a background. -->\r
