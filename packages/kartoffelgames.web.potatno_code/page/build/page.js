...
`});var Cs,vs=p(()=>{Cs=`<div class="editor-layout">\r
...
`});var Ks,Hs=p(()=>{Ks=`<div class="search-wrapper">\r
...
</div>`});var Xs,Ws,Zs,Ys,nt,bo,Pt,To=p(()=>{pe();xt();zs();Hs();Ys=[j({selector:"potatno-node-library",template:Ks,style:$s})];Pt=class extends(Zs=I,Ws=[D("node-drag-start")],Xs=[P],Zs){constructor(){super(...arguments);u(nt,5,this);f(this,"mNodeDefinitions",[]);f(this,"mCachedFilteredGroups",[]);k(this,bo,u(nt,8,this)),u(nt,11,this);f(this,"mSearchQuery","");f(this,"mCollapsedCategories",{})}set nodeDefinitions(t){this.mNodeDefinitions=t,this.rebuildFilteredGroups()}get nodeDefinitions(){return this.mNodeDefinitions}get filteredGroups(){return this.mCachedFilteredGroups}rebuildFilteredGroups(){let t=this.mSearchQuery.toLowerCase(),n=new Map;for(let s of this.mNodeDefinitions){if(t&&!s.name.toLowerCase().includes(t))continue;let a=n.get(s.category);a||(a=[],n.set(s.category,a)),a.push(s)}let r=[],o=Object.values(Qe);for(let s of o){let a=n.get(s);if(a&&a.length>0){let l=Xt.get(s);r.push({category:s,icon:l.icon,label:l.label,cssColor:l.cssColor,nodes:a})}}this.mCachedFilteredGroups=r}onSearchInput(t){this.mSearchQuery=t.target.value,this.rebuildFilteredGroups()}toggleCategory(t){this.mCollapsedCategories[t]=!this.mCollapsedCategories[t],this.rebuildFilteredGroups()}isCategoryCollapsed(t){return!!this.mCollapsedCategories[t]}getToggleClass(t){return this.mCollapsedCategories[t]?"category-toggle collapsed":"category-toggle"}onNodeMouseDown(t){this.mNodeDragStart.dispatchEvent(t)}};nt=E(Zs),bo=new WeakMap,d(nt,4,"mNodeDragStart",Ws,Pt,bo),d(nt,3,"nodeDefinitions",Xs,Pt),Pt=d(nt,0,"PotatnoNodeLibrary",Ys,Pt),u(nt,1,Pt)});var qs,_s=p(()=>{qs=`:host {\r
    display: flex;\r
    flex-direction: column;\r
    height: 100%;\r
    overflow: hidden;\r
...
`});var Qs,Js=p(()=>{Qs=`<div class="function-list-content">\r
...
</div>`});var ea,ta,na,ra,oa,ia,sa,Q,vo,Co,xo,Re,Po=p(()=>{pe();_s();Js();sa=[j({selector:"potatno-function-list",template:Qs,style:qs})];Re=class extends(ia=I,oa=[P],ra=[P],na=[D("function-select")],ta=[D("function-add")],ea=[D("function-delete")],ia){constructor(){super(...arguments);f(this,"functions",u(Q,20,this,[])),u(Q,23,this);f(this,"activeFunctionId",u(Q,24,this,"")),u(Q,27,this);k(this,vo,u(Q,8,this)),u(Q,11,this);k(this,Co,u(Q,12,this)),u(Q,15,this);k(this,xo,u(Q,16,this)),u(Q,19,this)}getEntryClass(t){return t===this.activeFunctionId?"function-entry active":"function-entry"}onFunctionSelect(t){this.mFunctionSelect.dispatchEvent(t)}onFunctionAdd(){this.mFunctionAdd.dispatchEvent(void 0)}onFunctionDelete(t,n){t.stopPropagation(),this.mFunctionDelete.dispatchEvent(n)}};Q=E(ia),vo=new WeakMap,Co=new WeakMap,xo=new WeakMap,d(Q,4,"mFunctionSelect",na,Re,vo),d(Q,4,"mFunctionAdd",ta,Re,Co),d(Q,4,"mFunctionDelete",ea,Re,xo),d(Q,5,"functions",oa,Re),d(Q,5,"activeFunctionId",ra,Re),Re=d(Q,0,"PotatnoFunctionList",sa,Re),u(Q,1,Re)});var la,aa=p(()=>{la=`:host {\r
    display: flex;\r
    flex-direction: column;\r
    height: 100%;\r
    overflow: hidden;\r
...
`});var ua,ca=p(()=>{ua=`<div class="tab-bar">\r
...
</div>`});var pa,da,ma,ha,ya,ga,fa,ba,Ta,H,Io,wo,Eo,ko,Ee,va=p(()=>{pe();aa();ca();To();Po();Ta=[j({selector:"potatno-panel-left",template:ua,style:la})];Ee=class extends(ba=I,fa=[P],ga=[P],ya=[P],ha=[D("node-drag-start")],ma=[D("function-select")],da=[D("function-add")],pa=[D("function-delete")],ba){constructor(){super(...arguments);f(this,"nodeDefinitions",u(H,24,this,[])),u(H,27,this);f(this,"functions",u(H,28,this,[])),u(H,31,this);f(this,"activeFunctionId",u(H,32,this,"")),u(H,35,this);k(this,Io,u(H,8,this)),u(H,11,this);k(this,wo,u(H,12,this)),u(H,15,this);k(this,Eo,u(H,16,this)),u(H,19,this);k(this,ko,u(H,20,this)),u(H,23,this);f(this,"mActiveTabIndex",0)}get activeTabIndex(){return this.mActiveTabIndex}getTabClass(t){return t===this.mActiveTabIndex?"tab-button active":"tab-button"}onTabClick(t){this.mActiveTabIndex=t}onNodeDragStart(t){this.mNodeDragStart.dispatchEvent(t.value)}onFunctionSelect(t){this.mFunctionSelect.dispatchEvent(t.value)}onFunctionAdd(t){this.mFunctionAdd.dispatchEvent(void 0)}onFunctionDelete(t){this.mFunctionDelete.dispatchEvent(t.value)}};H=E(ba),Io=new WeakMap,wo=new WeakMap,Eo=new WeakMap,ko=new WeakMap,d(H,4,"mNodeDragStart",ha,Ee,Io),d(H,4,"mFunctionSelect",ma,Ee,wo),d(H,4,"mFunctionAdd",da,Ee,Eo),d(H,4,"mFunctionDelete",pa,Ee,ko),d(H,5,"nodeDefinitions",fa,Ee),d(H,5,"functions",ga,Ee),d(H,5,"activeFunctionId",ya,Ee),Ee=d(H,0,"PotatnoPanelLeft",Ta,Ee),u(H,1,Ee)});var xa,Ca=p(()=>{xa=`:host {\r
    display: flex;\r
    flex-direction: column;\r
    height: 100%;\r
    overflow: hidden;\r
...
`});var Ia,Pa=p(()=>{Ia=`<div class="properties-header">Properties</div>\r
...
`});var ja,Va=p(()=>{ja=`<div class="resize-handle" (pointerdown)="this.onResizePointerDown($event)"></div>\r
...
`});var Ua,za,$a,Ha,Ka,Xa,ve,Ao,Do,$e,Wa=p(()=>{pe();Ga();Va();Xa=[j({selector:"potatno-preview",template:ja,style:Ba})];$e=class extends(Ka=I,Ha=[P,de("PreviewContent")],$a=[de("PreviewContainer")],za=[P],Ua=[P],Ka){constructor(){super(...arguments);u(ve,5,this);k(this,Ao,u(ve,8,this)),u(ve,11,this);k(this,Do,u(ve,12,this)),u(ve,15,this);f(this,"errors",u(ve,16,this,[])),u(ve,19,this);f(this,"mDragging",!1);f(this,"mStartX",0);f(this,"mStartY",0);f(this,"mStartWidth",0);f(this,"mStartHeight",0)}get hasErrors(){return this.errors.length>0}setContent(t){let n=this.contentElement;for(;n.firstChild;)n.removeChild(n.firstChild);n.appendChild(t)}onResizePointerDown(t){t.preventDefault(),t.stopPropagation(),this.mDragging=!0,this.mStartX=t.clientX,this.mStartY=t.clientY;let n=this.containerElement;if(!n)return;this.mStartWidth=n.offsetWidth,this.mStartHeight=n.offsetHeight,t.target.setPointerCapture(t.pointerId);let r=s=>{if(!this.mDragging)return;let a=this.mStartX-s.clientX,l=this.mStartY-s.clientY,c=Math.max(200,this.mStartWidth+a),h=Math.max(150,this.mStartHeight+l);n.style.width=c+"px",n.style.height=h+"px"},o=s=>{this.mDragging=!1,s.target.releasePointerCapture(s.pointerId),document.removeEventListener("pointermove",r),document.removeEventListener("pointerup",o)};document.addEventListener("pointermove",r),document.addEventListener("pointerup",o)}};ve=E(Ka),Ao=new WeakMap,Do=new WeakMap,d(ve,4,"contentElement",Ha,$e,Ao),d(ve,4,"containerElement",$a,$e,Do),d(ve,1,"setContent",Ua,$e),d(ve,5,"errors",za,$e),$e=d(ve,0,"PotatnoPreview",Xa,$e),u(ve,1,$e)});var Ya,Za=p(()=>{Ya=`:host {\r
    display: block;\r
    width: 100%;\r
    height: 100%;\r
    overflow: hidden;\r
...
`});var qa,_a=p(()=>{qa=`<div #viewport class="viewport" (pointerdown)="this.onPointerDown($event)" (pointermove)="this.onPointerMove($event)" (pointerup)="this.onPointerUp($event)" (wheel)="this.onWheel($event)" (contextmenu)="this.onContextMenu($event)" (keydown)="this.onKeyDown($event)" tabindex="0">\r
...
`});var yl,hl=p(()=>{yl=`$if(this.nodeData) {\r
    $if(this.isReroute) {\r
...
`});var Tl,bl=p(()=>{Tl=`<div [className]="this.portWrapperClasses" [title]="this.type">\r
...
`});var vl,Cl,xl,Pl,Il,wl,El,kl,Nl,Al,Dl,Sl,Ll,Ml,R,Bo,Vo,jo,Uo,te,zo=p(()=>{pe();gl();bl();Ml=[j({selector:"potatno-port",template:Tl,style:fl})];te=class extends(Ll=I,Sl=[P],Dl=[P],Al=[P],Nl=[P],kl=[P],El=[P],wl=[P],Il=[P],Pl=[D("port-drag-start")],xl=[D("port-hover")],Cl=[D("port-leave")],vl=[de("portCircle")],Ll){constructor(){super(...arguments);f(this,"name",u(R,24,this,"")),u(R,27,this);f(this,"type",u(R,28,this,"")),u(R,31,this);f(this,"portId",u(R,32,this,"")),u(R,35,this);f(this,"nodeId",u(R,36,this,"")),u(R,39,this);f(this,"direction",u(R,40,this,"input")),u(R,43,this);f(this,"connected",u(R,44,this,!1)),u(R,47,this);f(this,"invalid",u(R,48,this,!1)),u(R,51,this);f(this,"portKind",u(R,52,this,"data")),u(R,55,this);k(this,Bo,u(R,8,this)),u(R,11,this);k(this,Vo,u(R,12,this)),u(R,15,this);k(this,jo,u(R,16,this)),u(R,19,this);k(this,Uo,u(R,20,this)),u(R,23,this)}get portWrapperClasses(){return this.direction==="output"?"port-wrapper direction-output":"port-wrapper direction-input"}get portCircleClasses(){let t=["port-circle"];return this.connected?t.push("connected"):t.push("disconnected"),this.invalid&&t.push("invalid"),t.push(this.direction==="output"?"direction-output":"direction-input"),t.join(" ")}get portColor(){return this.portKind==="flow"?"var(--pn-text-primary)":this.getTypeColor(this.type)}onPointerDown(t){t.stopPropagation(),t.preventDefault(),this.mPortDragStart.dispatchEvent({nodeId:this.nodeId,portId:this.portId,portKind:this.portKind,direction:this.direction,type:this.type,element:this.portCircleElement})}onPointerEnter(t){this.mPortHover.dispatchEvent({nodeId:this.nodeId,portId:this.portId,portKind:this.portKind,direction:this.direction,type:this.type,element:this.portCircleElement})}onPointerLeave(t){this.mPortLeave.dispatchEvent(void 0)}getTypeColor(t){let n=0;for(let s=0;s<t.length;s++)n=t.charCodeAt(s)+((n<<5)-n);return`hsl(${Math.abs(n)%256*137.508%360}, 70%, 60%)`}};R=E(Ll),Bo=new WeakMap,Vo=new WeakMap,jo=new WeakMap,Uo=new WeakMap,d(R,4,"mPortDragStart",Pl,te,Bo),d(R,4,"mPortHover",xl,te,Vo),d(R,4,"mPortLeave",Cl,te,jo),d(R,4,"portCircleElement",vl,te,Uo),d(R,5,"name",Sl,te),d(R,5,"type",Dl,te),d(R,5,"portId",Al,te),d(R,5,"nodeId",Nl,te),d(R,5,"direction",kl,te),d(R,5,"connected",El,te),d(R,5,"invalid",wl,te),d(R,5,"portKind",Il,te),te=d(R,0,"PotatnoPortComponent",Ml,te),u(R,1,te)});var Rl,Ol,Fl,Gl,Bl,Vl,jl,Ul,zl,$l,Hl,Kl,Xl,Wl,O,$o,Ho,Ko,Xo,Wo,Zo,Yo,_o,qo,ne,Zl=p(()=>{pe();xt();dl();hl();zo();Wl=[j({selector:"potatno-node",template:yl,style:ml})];ne=class extends(Xl=I,Kl=[P],Hl=[P],$l=[P],zl=[D("node-select")],Ul=[D("node-drag-start")],jl=[D("port-drag-start")],Vl=[D("port-hover")],Bl=[D("port-leave")],Gl=[D("open-function")],Fl=[D("value-change")],Ol=[D("comment-change")],Rl=[D("resize-start")],Xl){constructor(){super(...arguments);f(this,"nodeData",u(O,44,this,null)),u(O,47,this);f(this,"selected",u(O,48,this,!1)),u(O,51,this);f(this,"gridSize",u(O,52,this,20)),u(O,55,this);k(this,$o,u(O,8,this)),u(O,11,this);k(this,Ho,u(O,12,this)),u(O,15,this);k(this,Ko,u(O,16,this)),u(O,19,this);k(this,Xo,u(O,20,this)),u(O,23,this);k(this,Wo,u(O,24,this)),u(O,27,this);k(this,Zo,u(O,28,this)),u(O,31,this);k(this,Yo,u(O,32,this)),u(O,35,this);k(this,_o,u(O,36,this)),u(O,39,this);k(this,qo,u(O,40,this)),u(O,43,this)}get nodeStyle(){return this.nodeData?`left: ${this.nodeData.position.x*this.gridSize}px; top: ${this.nodeData.position.y*this.gridSize}px; width: ${this.nodeData.size.w*this.gridSize}px;`:""}get nodeId(){return this.nodeData?.id??""}get selectedClass(){return this.selected?"selected":""}get isComment(){return this.nodeData?.category==="comment"}get isReroute(){return this.nodeData?.category==="reroute"}get commentSizeStyle(){return this.nodeData?`height: ${this.nodeData.size.h*this.gridSize}px;`:""}get isValue(){return this.nodeData?.category==="value"}get isFunction(){return this.nodeData?.category==="function"}get showOpenButton(){return!1}get inputPorts(){return this.nodeData?.inputs??[]}get outputPorts(){return this.nodeData?.outputs??[]}get flowInputPorts(){return this.nodeData?.flowInputs??[]}get flowOutputPorts(){return this.nodeData?.flowOutputs??[]}onNodePointerDown(t){t.target.tagName?.toLowerCase()!=="potatno-port"&&(this.mNodeSelect.dispatchEvent({nodeId:this.nodeId,shiftKey:t.shiftKey}),this.mNodeDragStart.dispatchEvent({nodeId:this.nodeId,startX:t.clientX,startY:t.clientY}))}onPortDragStart(t){this.mPortDragStart.dispatchEvent(t.value)}onPortHover(t){this.mPortHover.dispatchEvent(t.value)}onPortLeave(t){this.mPortLeave.dispatchEvent(void 0)}onOpenFunction(t){t.stopPropagation(),this.mOpenFunction.dispatchEvent({definitionName:this.nodeData?.definitionName??""})}onValueInput(t){let n=t.target;this.mValueChange.dispatchEvent({nodeId:this.nodeId,property:"value",value:n.value})}onCommentInput(t){let n=t.target;this.mCommentChange.dispatchEvent({nodeId:this.nodeId,text:n.value})}onResizeStart(t){t.stopPropagation(),t.preventDefault(),this.mResizeStart.dispatchEvent({nodeId:this.nodeId,startX:t.clientX,startY:t.clientY})}};O=E(Xl),$o=new WeakMap,Ho=new WeakMap,Ko=new WeakMap,Xo=new WeakMap,Wo=new WeakMap,Zo=new WeakMap,Yo=new WeakMap,_o=new WeakMap,qo=new WeakMap,d(O,4,"mNodeSelect",zl,ne,$o),d(O,4,"mNodeDragStart",Ul,ne,Ho),d(O,4,"mPortDragStart",jl,ne,Ko),d(O,4,"mPortHover",Vl,ne,Xo),d(O,4,"mPortLeave",Bl,ne,Wo),d(O,4,"mOpenFunction",Gl,ne,Zo),d(O,4,"mValueChange",Fl,ne,Yo),d(O,4,"mCommentChange",Ol,ne,_o),d(O,4,"mResizeStart",Rl,ne,qo),d(O,5,"nodeData",Kl,ne),d(O,5,"selected",Hl,ne),d(O,5,"gridSize",$l,ne),ne=d(O,0,"PotatnoNodeComponent",Wl,ne),u(O,1,ne)});var _l,Yl=p(()=>{_l=`.tabs-header {\r
    display: flex;\r
    background: var(--pn-bg-secondary);\r
    border-bottom: 1px solid var(--pn-border-default);\r
}\r
...
`});var Jl,ql=p(()=>{Jl=`<div class="tabs-header">\r
...
`});var Ql,ec,tc,nc,rc,ke,Jo,rt,oc=p(()=>{pe();Yl();ql();rc=[j({selector:"potatno-tabs",template:Jl,style:_l})];rt=class extends(nc=I,tc=[P],ec=[P],Ql=[D("tab-change")],nc){constructor(){super(...arguments);f(this,"tabs",u(ke,12,this,[])),u(ke,15,this);f(this,"activeIndex",u(ke,16,this,0)),u(ke,19,this);k(this,Jo,u(ke,8,this)),u(ke,11,this)}getTabClass(t){return t===this.activeIndex?"tab-button active":"tab-button"}onTabClick(t){this.activeIndex=t,this.mTabChange.dispatchEvent(t)}};ke=E(nc),Jo=new WeakMap,d(ke,4,"mTabChange",Ql,rt,Jo),d(ke,5,"tabs",tc,rt),d(ke,5,"activeIndex",ec,rt),rt=d(ke,0,"PotatnoTabs",rc,rt),u(ke,1,rt)});var sc,ic=p(()=>{sc=`.resize-handle {\r
...
`});var lc,ac=p(()=>{lc=`<div [className]="this.getHandleClass()" (pointerdown)="this.onPointerDown($event)"></div>\r
`});var cc,uc,pc,dc,He,Qo,It,mc=p(()=>{pe();ic();ac();dc=[j({selector:"potatno-resize-handle",template:lc,style:sc})];It=class extends(pc=I,uc=[P],cc=[D("resize")],pc){constructor(){super(...arguments);f(this,"direction",u(He,12,this,"vertical")),u(He,15,this);k(this,Qo,u(He,8,this)),u(He,11,this);f(this,"mDragging",!1);f(this,"mStartPosition",0)}getHandleClass(){return`resize-handle ${this.direction}`}onPointerDown(t){t.preventDefault(),this.mDragging=!0,this.mStartPosition=this.direction==="vertical"?t.clientX:t.clientY,t.target.setPointerCapture(t.pointerId);let n=o=>{if(!this.mDragging)return;let s=this.direction==="vertical"?o.clientX:o.clientY,a=s-this.mStartPosition;this.mStartPosition=s,this.mResize.dispatchEvent({delta:a})},r=o=>{this.mDragging=!1,o.target.releasePointerCapture(o.pointerId),document.removeEventListener("pointermove",n),document.removeEventListener("pointerup",r)};document.addEventListener("pointermove",n),document.addEventListener("pointerup",r)}};He=E(pc),Qo=new WeakMap,d(He,4,"mResize",cc,It,Qo),d(He,5,"direction",uc,It),It=d(He,0,"PotatnoResizeHandle",dc,It),u(He,1,It)});var yc,hc=p(()=>{yc=`.search-wrapper {\r
    display: flex;\r
    align-items: center;\r
    background: var(--pn-bg-surface);\r
    border: 1px solid var(--pn-border-default);\r
...
`});var fc,gc=p(()=>{fc=`<div class="search-wrapper">\r
...
`),Oe.style.color="#cdd6f4"):(Oe.textContent="(no output)",Oe.style.color="#6c7086")}catch(e){Oe.textContent=`Error: ${e.message??e}`,Oe.style.color="#f38ba8"}});Uc=new gr(B);Uc.appendTo(document.body);Uc.file=new Wt});(()=>{let i=new WebSocket("ws://127.0.0.1:8088");i.addEventListener("open",()=>{console.log("Refresh connection established")}),i.addEventListener("message",e=>{console.log("Bundle finished. Start refresh"),e.data==="REFRESH"&&window.location.reload()})})();Promise.resolve().then(()=>zc());
