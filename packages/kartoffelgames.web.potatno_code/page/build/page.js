...
\r
        ...
        `;function As(){function f(l,n){return function(a){e(n,"addInitializer"),o(a,"An initializer"),l.push(a)}}function t(l,n,u,a,r,b,v,E,w){var p;switch(r){case 1:p="accessor";break;case 2:p="method";break;case 3:p="getter";break;case 4:p="setter";break;default:p="field"}var s={kind:p,name:v?"#"+n:n,static:b,private:v,metadata:E},m={v:!1};s.addInitializer=f(a,m);var i,h;r===0?v?(i=u.get,h=u.set):(i=function(){return this[n]},h=function(x){this[n]=x}):r===2?i=function(){return u.value}:((r===1||r===3)&&(i=function(){return u.get.call(this)}),(r===1||r===4)&&(h=function(x){u.set.call(this,x)})),s.access=i&&h?{get:i,set:h}:i?{get:i}:{set:h};try{return l(w,s)}finally{m.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function o(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function c(l,n){var u=typeof n;if(l===1){if(u!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&o(n.get,"accessor.get"),n.set!==void 0&&o(n.set,"accessor.set"),n.init!==void 0&&o(n.init,"accessor.init")}else if(u!=="function"){var a;throw l===0?a="field":l===10?a="class":a="method",new TypeError(a+" decorators must return a function or void 0")}}function d(l,n,u,a,r,b,v,E,w){var p=u[0],s,m,i;v?r===0||r===1?s={get:u[3],set:u[4]}:r===3?s={get:u[3]}:r===4?s={set:u[3]}:s={value:u[3]}:r!==0&&(s=Object.getOwnPropertyDescriptor(n,a)),r===1?i={get:s.get,set:s.set}:r===2?i=s.value:r===3?i=s.get:r===4&&(i=s.set);var h,x,C;if(typeof p=="function")h=t(p,a,s,E,r,b,v,w,i),h!==void 0&&(c(r,h),r===0?m=h:r===1?(m=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h);else for(var S=p.length-1;S>=0;S--){var M=p[S];if(h=t(M,a,s,E,r,b,v,w,i),h!==void 0){c(r,h);var A;r===0?A=h:r===1?(A=h.init,x=h.get||i.get,C=h.set||i.set,i={get:x,set:C}):i=h,A!==void 0&&(m===void 0?m=A:typeof m=="function"?m=[m,A]:m.push(A))}}if(r===0||r===1){if(m===void 0)m=function(I,D){return D};else if(typeof m!="function"){var F=m;m=function(I,D){for(var L=D,_=0;_<F.length;_++)L=F[_].call(I,L);return L}}else{var V=m;m=function(I,D){return V.call(I,D)}}l.push(m)}r!==0&&(r===1?(s.get=i.get,s.set=i.set):r===2?s.value=i:r===3?s.get=i:r===4&&(s.set=i),v?r===1?(l.push(function(I,D){return i.get.call(I,D)}),l.push(function(I,D){return i.set.call(I,D)})):r===2?l.push(i):l.push(function(I,D){return i.call(I,D)}):Object.defineProperty(n,a,s))}function g(l,n,u){for(var a=[],r,b,v=new Map,E=new Map,w=0;w<n.length;w++){var p=n[w];if(Array.isArray(p)){var s=p[1],m=p[2],i=p.length>3,h=s>=5,x,C;if(h?(x=l,s=s-5,b=b||[],C=b):(x=l.prototype,r=r||[],C=r),s!==0&&!i){var S=h?E:v,M=S.get(m)||0;if(M===!0||M===3&&s!==4||M===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+m);!M&&s>2?S.set(m,s):S.set(m,!0)}d(a,x,p,m,s,h,i,C,u)}}return y(a,r),y(a,b),a}function y(l,n){n&&l.push(function(u){for(var a=0;a<n.length;a++)n[a].call(u);return u})}function T(l,n,u){if(n.length>0){for(var a=[],r=l,b=l.name,v=n.length-1;v>=0;v--){var E={v:!1};try{var w=n[v](r,{kind:"class",name:b,addInitializer:f(a,E),metadata:u})}finally{E.v=!0}w!==void 0&&(c(10,w),r=w)}return[P(r,u),function(){for(var p=0;p<a.length;p++)a[p].call(r)}]}}function P(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,u,a,r){if(r!==void 0)var b=r[Symbol.metadata||Symbol.for("Symbol.metadata")];var v=Object.create(b===void 0?null:b),E=g(n,u,v);return a.length||P(n,v),{e:E,get c(){return T(n,a,v)}}}}function Fn(f,t,e,o){return(Fn=As())(f,t,e,o)}var jn,Mn,Vn,zn,$n,Bn,An,Nn,Ln,_n,Rn,vr;jn=Z({selector:"potatno-node",template:Sn,style:Cn,modules:[Ie],components:[Ze,Wt]}),Vn=$.state(),zn=$.state({proxy:!0}),$n=$.state({complexValue:!0}),Bn=$.state({complexValue:!0});var On=class{static{({e:[An,Nn,Ln,_n,Rn],c:[vr,Mn]}=Fn(this,[[Vn,1,"isPreviewDisplaySelectionOpen"],[rt,3,"nodeData"],[zn,1,"nodeTransformation"],[$n,1,"previewPorts"],[Bn,1,"previewDisplays"]],[jn]))}constructor(t=R.use(B),e=R.use(X)){this.mComponent=t,this.mManager=e,this.mNodeDefinition=null,this.mNodeData=null,this.isPreviewDisplaySelectionOpen=!1,this.nodeTransformation={height:0,width:0},this.previewPorts=new Array,this.previewDisplays=new Array,this.mUnsubscribe=this.mManager.subscribe(O.Node,o=>{o.item===this.nodeData&&this.resyncComponent(this.nodeData)})}mComponent;mManager;mNodeData;mNodeDefinition;mUnsubscribe;get canPreview(){return this.previewPorts.length>0}get hasError(){if(!this.nodeData)return!1;if(this.mManager.integrity.errorItems.has(this.nodeData))return!0;for(let t of this.nodeData.inputs.list)if(this.mManager.integrity.errorItems.has(t))return!0;for(let t of this.nodeData.outputs.list)if(this.mManager.integrity.errorItems.has(t))return!0;return!1}get inputPorts(){return this.nodeData?this.nodeData.inputs.list:new Array}get isFunction(){return this.mNodeDefinition instanceof xt}get isPreviewActive(){return!!this.nodeData?.preview}#t=(Rn(this),An(this));get isPreviewDisplaySelectionOpen(){return this.#t}set isPreviewDisplaySelectionOpen(t){this.#t=t}get nodeColor(){return this.mManager.generateStringColor(this.mNodeDefinition?.category.name??"")}get nodeData(){return this.mNodeData}set nodeData(t){this.mNodeData=t,this.mNodeDefinition=null,t&&(this.mNodeDefinition=this.mManager.activeFunction?this.mManager.activeFunction.nodeDefinitions.find(e=>e.id===this.nodeData.definitionId)??null:null,this.resyncComponent(t))}get nodeIcon(){return this.mNodeDefinition?.category.icon??""}get nodeLabel(){return this.nodeData?.label??""}#e=Nn(this);get nodeTransformation(){return this.#e}set nodeTransformation(t){this.#e=t}get outputPorts(){return this.nodeData?this.nodeData.outputs.list:new Array}#r=Ln(this);get previewPorts(){return this.#r}set previewPorts(t){this.#r=t}#o=_n(this);get previewDisplays(){return this.#o}set previewDisplays(t){this.#o=t}get previewDisplayId(){return this.nodeData?.preview?.displayId??""}get previewDriver(){if(!this.nodeData?.preview)return null;let t=this.nodeData.outputs.map.get(this.nodeData.preview.portDefinitionId);return t?this.mManager.preview.requestDriver(t,this.nodeData.preview.displayId):null}get previewPortDefinitionId(){return this.nodeData?.preview?.portDefinitionId??""}dragNode(t){if(!this.nodeData)return;t.preventDefault(),t.stopPropagation();let e=this.nodeData.transformation.x*this.mManager.grid.gridSize,o=this.nodeData.transformation.y*this.mManager.grid.gridSize,c=t.clientX,d=t.clientY,g=T=>{let P=T.clientX-c,l=T.clientY-d,n=(e+P)/this.mManager.grid.gridSize,u=(o+l)/this.mManager.grid.gridSize;this.mManager.graph.transformNode(this.nodeData,a=>{a.moveTo(n,u)})},y=()=>{document.removeEventListener("pointermove",g),document.removeEventListener("pointerup",y)};document.addEventListener("pointermove",g),document.addEventListener("pointerup",y)}onDeconstruct(){this.mUnsubscribe()}openFunction(){this.mNodeDefinition instanceof xt&&this.mManager.setActiveFunction(this.mNodeDefinition.function)}selectPreviewDisplay(t){this.mManager.graph.updateNode(this.nodeData,e=>{e.preview={portDefinitionId:e.preview.portDefinitionId,displayId:t}}),document.activeElement instanceof HTMLElement&&document.activeElement.blur()}selectPreviewPort(t){if(!this.nodeData)return;let e=(()=>{let o=this.previewPorts;return o.length===0?null:typeof t<"u"?o.find(c=>c.definitionId===t)??null:this.nodeData.preview?null:o[0]})();if(!e)return this.mManager.graph.updateNode(this.nodeData,o=>{o.preview=null});this.mManager.graph.updateNode(this.nodeData,o=>{let c=o.project.getFunction(o.function.definitionId),d=o.project.preview.availableDisplays(c,e.resolvedDataType);d.length===0&&(o.preview=null);let g=o.preview&&d.includes(o.preview.displayId)?o.preview.displayId:d[0];o.preview={portDefinitionId:e.definitionId,displayId:g}}),this.resyncComponent(this.nodeData)}getPreviewDisplays(t){if(!this.nodeData||!t)return new Array;let e=this.nodeData.outputs.map.get(t);if(!e)return new Array;let o=e.project.getFunction(e.node.function.definitionId);return o?e.project.preview.availableDisplays(o,e.resolvedDataType).map(d=>({id:d,label:e.project.preview.getDisplay(d)?.name??d})):new Array}getPreviewablePorts(t){if(!this.mManager.activeFunction)return new Array;let e=t.project.getFunction(t.function.definitionId);if(!this.mManager.activeFunction.dynamicNodeDefinitions.find(d=>d.id===t.definitionId))return new Array;let c=new Map;return t.outputs.value.filter(d=>{let g=d.resolvedDataType;if(c.has(g))return c.get(g);let y=t.project.preview.availableDisplays(e,d.resolvedDataType);return c.set(g,y.length>0),c.get(g)})}resyncComponent(t){let e=t.transformation.x*this.mManager.grid.gridSize,o=t.transformation.y*this.mManager.grid.gridSize;this.mComponent.element.style.setProperty("left",`${e}px`),this.mComponent.element.style.setProperty("top",`${o}px`),this.nodeTransformation.width=t.transformation.width,this.nodeTransformation.height=t.transformation.height,this.previewPorts=this.getPreviewablePorts(this.nodeData),this.previewDisplays=this.getPreviewDisplays(t.preview?.portDefinitionId??null)}static{Mn()}};var Gn=`:host {\r
    position: relative;\r
    flex: 1;\r
    display: flex;\r
    min-height: 0;\r
...
.selection-box {\r
    ...
    pointer-events: none;\r
    z-index: 1000;\r
}`;var Un=`<!-- Serves only as a background. -->\r
...
\r
    $for(node of this.nodes) {\r
        <potatno-node class="grid-content__node {{this.selectedNode.has(this.node) ? 'selected' : ''}}" [nodeData]="this.node"/>\r
    }\r
</div>\r
\r
