...
}`;var Tn=`<kg-resize-box class="resize-box" right>\r
...
}`;var Ss=`<kg-resize-box class="resize-box" left>\r
\r
    <!-- Function name -->\r
    <div class="section">\r
