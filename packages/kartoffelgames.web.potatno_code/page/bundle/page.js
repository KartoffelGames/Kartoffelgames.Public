...
potatno-code-editor {\r
    ...
    width: 100%;\r
    height: 100%;\r
}`;var re=class{mProject;constructor(t){this.mProject=t}deserialize(t){let e=new jt(this.mProject),r=[];for(let u of t.functions){let d=this.deserializeFunctionHead(u,e);r.push([d,u]),e.addFunction(d)}for(let[u,d]of r)this.deserializeFunctionBody(u,d,e);return e}deserializeFunctionBody(t,e,r){let u=new Map;for(let d of e.nodes)u.set(d.id,this.deserializeNode(d,t,r));for(let d of e.connections){if(!u.has(d.sourceNodeId)||!u.has(d.targetNodeId))continue;let v=u.get(d.sourceNodeId),b=u.get(d.targetNodeId),T=v.outputs.map.get(d.sourcePortId),_=b.inputs.map.get(d.targetPortId);!T||!_||T.connect(_)}}deserializeFunctionHead(t,e){let r=new at(this.mProject,e,{definitionId:t.definitionId,id:t.id,label:t.label,isSystem:t.isSystem});for(let u of t.imports)r.addImport(u);for(let u of t.inputs)r.addInput({label:u.label,dataType:u.dataType});for(let u of t.outputs)r.addOutput({label:u.label,dataType:u.dataType});return r}deserializeNode(t,e,r){let u=r.nodeDefinitions.find(v=>v.id===t.definitionId),d=(()=>{if(u)return e.addNodeByDefinition(u,t.transformation);let v=t.ports.filter(T=>T.direction==="input").map(T=>({dataType:T.dataType,definitionId:T.definitionId,label:T.label,portType:T.portType})),b=t.ports.filter(T=>T.direction==="output").map(T=>({dataType:T.dataType,definitionId:T.definitionId,label:T.label,portType:T.portType}));return new mt(this.mProject,r,e,{definitionId:t.definitionId,ports:{input:v,output:b},label:t.label,transformation:{...t.transformation}})})();d.label=t.label,e.addNode(d);for(let v of t.ports)if(v.portType==="value"&&v.directValue.length>0){let b=d.inputs.map.get(v.definitionId);b&&b.setDirectValue(v.directValue)}return d.preview=t.preview??null,d}};var ne=class{constructor(){}serialize(t){return{functions:[...t.functions].map(e=>this.serializeFunction(e))}}serializeFunction(t){let e=new Map;[...t.nodes].forEach((b,T)=>{e.set(b,`n${T}`)});let r=[...t.nodes].map(b=>this.serializeNode(b,e.get(b))),u=[];for(let b of t.nodes){let T=e.get(b);for(let _ of b.outputs.list)for(let l of _.connectedPorts){let n=e.get(l.node);u.push({sourceNodeId:T,sourcePortId:_.definitionId,targetNodeId:n,targetPortId:l.definitionId})}}let d=t.inputs.map(b=>({label:b.label,dataType:b.dataType})),v=t.outputs.map(b=>({label:b.label,dataType:b.dataType}));return{id:t.id,label:t.label,isSystem:t.isSystem,definitionId:t.definitionId,inputs:d,outputs:v,imports:[...t.imports],nodes:r,connections:u}}serializeNode(t,e){let r=[...t.inputs.list,...t.outputs.list].map(d=>({definitionId:d.definitionId,label:d.label,direction:d.direction,portType:d.portType,dataType:d.portType==="value"?d.dataType:null,directValue:[...d.directValue]})),u=t.preview?{portDefinitionId:t.preview.portDefinitionId,displayId:t.preview.displayId}:null;return{id:e,definitionId:t.definitionId,label:t.label,transformation:{...t.transformation},ports:r,preview:u}}};var Cr=`:host {\r
    /* Globals */\r
...
`;function Ua(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:D},f={v:!1};s.addInitializer=y(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,S){return arguments.length===1&&(S=g,g=this),P.call(g,S)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,D,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(f===void 0?f=S:typeof f=="function"?f=[f,S]:f.push(S))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:y(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[_(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function _(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||_(n,p),{e:D,get c(){return T(n,c,p)}}}}function Xr(y,t,e,r){return(Xr=Ua())(y,t,e,r)}var Hr,Br,Yr;Hr=B({selector:"kg-information",template:Gr,style:$r});var Ur=class{static{({c:[Yr,Br]}=Xr(this,[],[Hr]))}static{Br()}};var Wr=`:host {\r
...
}`;var Zr="$slot";function Ya(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:D},f={v:!1};s.addInitializer=y(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,S){return arguments.length===1&&(S=g,g=this),P.call(g,S)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,D,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(f===void 0?f=S:typeof f=="function"?f=[f,S]:f.push(S))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:y(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[_(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function _(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||_(n,p),{e:D,get c(){return T(n,c,p)}}}}function Kr(y,t,e,r){return(Kr=Ya())(y,t,e,r)}var Qr,qr,ie;Qr=B({selector:"kg-popup",template:Zr,style:Wr});var Jr=class{static{({c:[ie,qr]}=Kr(this,[],[Qr]))}static{qr()}};var kr=`:host {\r
...
}`;var Tn=`<kg-resize-box class="resize-box" right="true">\r
...
`;function Qa(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:D},f={v:!1};s.addInitializer=y(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,S){return arguments.length===1&&(S=g,g=this),P.call(g,S)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,D,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(f===void 0?f=S:typeof f=="function"?f=[f,S]:f.push(S))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:y(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[_(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function _(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||_(n,p),{e:D,get c(){return T(n,c,p)}}}}function Mn(y,t,e,r){return(Mn=Qa())(y,t,e,r)}var Sn,Dn,_n,Nn,En,In,Cn,xo;Sn=B({selector:"potatno-function-list",template:Tn,style:xn,components:[Mt,ie,Ht]}),_n=$.state({complexValue:!0}),Nn=$.state();var Pn=class{static{({e:[En,In,Cn],c:[xo,Dn]}=Mn(this,[[_n,1,"documentFunctions"],[Nn,1,"showPopup"]],[Sn]))}constructor(t=O.use(Y)){this.mManager=t,this.documentFunctions=new Array,this.showPopup=!1,this.mUnsubscribe=this.mManager.subscribe(R.Document|R.Function|R.SpecialActiveFunction,()=>{this.documentFunctions=this.mManager.graph.document.functions.map(e=>({id:e.id,label:e.label,isSystem:e.isSystem,function:e}))})}mManager;mUnsubscribe;#t=(Cn(this),En(this));get documentFunctions(){return this.#t}set documentFunctions(t){this.#t=t}#e=In(this);get showPopup(){return this.#e}set showPopup(t){this.#e=t}get activeFunctionId(){return this.mManager.activeFunction.id}get userFunctionDefinitions(){return[...this.mManager.project.userFunctions.values()]}createFunction(t){this.showPopup=!1,this.mManager.graph.addFunction(t.id)}deleteFunction(t){this.mManager.graph.removeFunction(t.id)}onDeconstruct(){this.mUnsubscribe()}selectFunction(t){this.mManager.setActiveFunction(t.function)}static{Dn()}};var An=`:host {\r
    position: absolute;\r
    z-index: 200;\r
\r
...
}`;var Ln=`<kg-popup class="selection-popup" animate="top" (pointerdown)="this.stopPropagation($event, false)" (wheel)="this.stopPropagation($event, false)" (contextmenu)="this.stopPropagation($event, true);">\r
\r
...
}`;var gi=`<div class="port-wrapper {{this.portDirection}}" style="--type-color: {{this.portColor}}" (dragover)="this.onDragOver($event)" (drop)="this.onDrop($event)">\r
\r
...
}`;var Mi=`<div class="node" style="--type-color: {{this.portColor}}" (dragover)="this.onDragOver($event)" (drop)="this.onDrop($event)">\r
\r
...
}`;var Bi=`<svg class="svg-layer" xmlns="http://www.w3.org/2000/svg" >\r
...
`;function ml(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:D},f={v:!1};s.addInitializer=y(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,S){return arguments.length===1&&(S=g,g=this),P.call(g,S)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,D,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(f===void 0?f=S:typeof f=="function"?f=[f,S]:f.push(S))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:y(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[_(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function _(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||_(n,p),{e:D,get c(){return T(n,c,p)}}}}function Wi(y,t,e,r){return(Wi=ml())(y,t,e,r)}var Zi,Ui,qi,Xi,Hi,Co;Zi=B({selector:"potatno-connection-layer",template:Bi,style:Gi}),qi=$.state({complexValue:!0});var Yi=class{static{({e:[Xi,Hi],c:[Co,Ui]}=Wi(this,[[qi,1,"connections"]],[Zi]))}constructor(t=O.use(Y)){this.mManager=t,this.connections=new Map;let e=0;this.mUnsubscribe=this.mManager.subscribe(R.SpecialActiveFunction|R.Node|R.Connection,()=>{e===0&&(e=requestAnimationFrame(()=>{e=0,this.updateConnections()}))})}mManager;mUnsubscribe;#t=(Hi(this),Xi(this));get connections(){return this.#t}set connections(t){this.#t=t}createConjunction(t,e){t.preventDefault(),t.stopPropagation();let r=e.port.output.portType==="flow"?this.mManager.project.nodeDefinitions.get(K.DEFINITION_ID):this.mManager.project.nodeDefinitions.get(et.DEFINITION_ID),u=this.mManager.grid.pixelToGridSpace(t.clientX,t.clientY),d=this.mManager.graph.addNode(this.mManager.activeFunction,r,{x:u.x,y:u.y,height:0,width:0});this.mManager.graph.disconnectPorts(e.port.output,e.port.input);let v=d.inputs.list[0],b=d.outputs.list[0];this.mManager.graph.connectPorts(v,e.port.output),this.mManager.graph.connectPorts(v,e.port.input),this.mManager.graph.connectPorts(b,e.port.output),this.mManager.graph.connectPorts(b,e.port.input)}deleteConnection(t,e){t.button===2&&(t.preventDefault(),t.stopPropagation(),this.mManager.graph.disconnectPorts(e.port.output,e.port.input))}onDeconstruct(){this.mUnsubscribe()}createConnection(t,e,r){let u=this.mManager.integrity.errorItems,d=u.has(e)||u.has(r),v=(()=>{switch(r.portType){case"value":return r;case"flow":return e}})(),b=e.portType==="flow"?"":this.mManager.generateStringColor(e.resolvedDataType),T=this.mManager.connections.getConnectionPath(e,r);return{color:b,path:{attributeValue:T.attributeValue,length:T.length},state:{isNew:!t.has(v),hasError:d},port:{primary:v,output:e,input:r}}}updateConnections(){let t=this.connections;this.connections=new Map;for(let e of this.mManager.activeFunction.nodes)for(let r of e.outputs.list)for(let u of r.connectedPorts){let d=this.createConnection(t,r,u);this.connections.set(d.port.primary,d)}}static{Ui()}};function pl(){function y(l,n){return function(c){e(n,"addInitializer"),r(c,"An initializer"),l.push(c)}}function t(l,n,h,c,o,w,p,D,x){var m;switch(o){case 1:m="accessor";break;case 2:m="method";break;case 3:m="getter";break;case 4:m="setter";break;default:m="field"}var s={kind:m,name:p?"#"+n:n,static:w,private:p,metadata:D},f={v:!1};s.addInitializer=y(c,f);var i,a;if(o===0?p?(i=h.get,a=h.set):(i=function(){return this[n]},a=function(g){this[n]=g}):o===2?i=function(){return h.value}:((o===1||o===3)&&(i=function(){return h.get.call(this)}),(o===1||o===4)&&(a=function(g){h.set.call(this,g)})),p)s.access=i&&a?{get:i,set:a}:i?{get:i}:{set:a};else{if(i){var C=i;i=function(g){return arguments.length===0&&(g=this),C.call(g)}}if(a){var P=a;a=function(g,S){return arguments.length===1&&(S=g,g=this),P.call(g,S)}}var E=function(g){return n in g};s.access=i&&a?{has:E,get:i,set:a}:i?{has:E,get:i}:{has:E,set:a}}try{return l(x,s)}finally{f.v=!0}}function e(l,n){if(l.v)throw new Error("attempted to call "+n+" after decoration was finished")}function r(l,n){if(typeof l!="function")throw new TypeError(n+" must be a function")}function u(l,n){var h=typeof n;if(l===1){if(h!=="object"||n===null)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");n.get!==void 0&&r(n.get,"accessor.get"),n.set!==void 0&&r(n.set,"accessor.set"),n.init!==void 0&&r(n.init,"accessor.init")}else if(h!=="function"){var c;throw l===0?c="field":l===10?c="class":c="method",new TypeError(c+" decorators must return a function or void 0")}}function d(l,n,h,c,o,w,p,D,x){var m=h[0],s,f,i;p?o===0||o===1?s={get:h[3],set:h[4]}:o===3?s={get:h[3]}:o===4?s={set:h[3]}:s={value:h[3]}:o!==0&&(s=Object.getOwnPropertyDescriptor(n,c)),o===1?i={get:s.get,set:s.set}:o===2?i=s.value:o===3?i=s.get:o===4&&(i=s.set);var a,C,P;if(typeof m=="function")a=t(m,c,s,D,o,w,p,x,i),a!==void 0&&(u(o,a),o===0?f=a:o===1?(f=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a);else for(var E=m.length-1;E>=0;E--){var g=m[E];if(a=t(g,c,s,D,o,w,p,x,i),a!==void 0){u(o,a);var S;o===0?S=a:o===1?(S=a.init,C=a.get||i.get,P=a.set||i.set,i={get:C,set:P}):i=a,S!==void 0&&(f===void 0?f=S:typeof f=="function"?f=[f,S]:f.push(S))}}if(o===0||o===1){if(f===void 0)f=function(M,I){return I};else if(typeof f!="function"){var F=f;f=function(M,I){for(var A=I,L=0;L<F.length;L++)A=F[L].call(M,A);return A}}else{var j=f;f=function(M,I){return j.call(M,I)}}l.push(f)}o!==0&&(o===1?(s.get=i.get,s.set=i.set):o===2?s.value=i:o===3?s.get=i:o===4&&(s.set=i),p?o===1?(l.push(function(M,I){return i.get.call(M,I)}),l.push(function(M,I){return i.set.call(M,I)})):o===2?l.push(i):l.push(function(M,I){return i.call(M,I)}):Object.defineProperty(n,c,s))}function v(l,n,h){for(var c=[],o,w,p=new Map,D=new Map,x=0;x<n.length;x++){var m=n[x];if(Array.isArray(m)){var s=m[1],f=m[2],i=m.length>3,a=s>=5,C,P;if(a?(C=l,s=s-5,w=w||[],P=w):(C=l.prototype,o=o||[],P=o),s!==0&&!i){var E=a?D:p,g=E.get(f)||0;if(g===!0||g===3&&s!==4||g===4&&s!==3)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+f);!g&&s>2?E.set(f,s):E.set(f,!0)}d(c,C,m,f,s,a,i,P,h)}}return b(c,o),b(c,w),c}function b(l,n){n&&l.push(function(h){for(var c=0;c<n.length;c++)n[c].call(h);return h})}function T(l,n,h){if(n.length>0){for(var c=[],o=l,w=l.name,p=n.length-1;p>=0;p--){var D={v:!1};try{var x=n[p](o,{kind:"class",name:w,addInitializer:y(c,D),metadata:h})}finally{D.v=!0}x!==void 0&&(u(10,x),o=x)}return[_(o,h),function(){for(var m=0;m<c.length;m++)c[m].call(o)}]}}function _(l,n){return Object.defineProperty(l,Symbol.metadata||Symbol.for("Symbol.metadata"),{configurable:!0,enumerable:!0,value:n})}return function(n,h,c,o){if(o!==void 0)var w=o[Symbol.metadata||Symbol.for("Symbol.metadata")];var p=Object.create(w===void 0?null:w),D=v(n,h,p);return c.length||_(n,p),{e:D,get c(){return T(n,c,p)}}}}function Qi(y,t,e,r){return(Qi=pl())(y,t,e,r)}var ki,Ji,_e;ki=It({access:q.Read,selector:/^potatno-preview$/});var Ki=class{static{({c:[_e,Ji]}=Qi(this,[],[ki]))}constructor(t=O.use(k),e=O.use(W),r=O.use(it)){this.mTarget=t,this.mProcedure=e.createExpressionProcedure(r.value)}mProcedure;mTarget;onUpdate(){let t=this.mProcedure.execute();if(!t){let r=this.mTarget.childNodes.length>0;return r&&(this.mTarget.innerHTML=""),r}let e=t.element;return this.mTarget.contains(e)?!1:(this.mTarget.innerHTML="",this.mTarget.appendChild(e),!0)}static{Ji()}};var ts=`:host {\r
    --node-border-radius: 2px;\r
    --node-border-color: color-mix(in srgb, var(--potatno-color-text) 30%, var(--potatno-color-background));\r
...
\r
}`;var es=`<!-- Resizeable part of node -->\r
...
}`;var bs=`<!-- Serves only as a background. -->\r
...
}`;var Ss=`<kg-resize-box class="resize-box" left="true">\r
\r
    <!-- Function name -->\r
    <div class="section">\r
...
}`;var js=`<kg-resize-box class="resize-box" left="true" top="true">\r
    <div class="header">\r
