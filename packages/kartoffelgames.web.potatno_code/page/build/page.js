...
.port-handle.port-type-flow.connected::before {\r
    background: var(--port-color, var(--pn-text-muted));\r
}\r
\r
.port-handle.port-type-flow.connected.direction-output::after {\r
    border-left-color: var(--port-color, var(--pn-text-muted));\r
}\r
\r
.port-handle.port-type-flow.connected.direction-input::after {\r
    border-right-color: var(--port-color, var(--pn-text-muted));\r
}\r
\r
.port-handle.port-type-value.connected {\r
    background: var(--port-color, var(--pn-text-muted));\r
}\r
\r
/* Disconnected: dimmed */\r
.port-handle.port-type-flow.disconnected::before {\r
    background: color-mix(in srgb, var(--port-color, var(--pn-text-muted)) 30%, var(--pn-node-bg));\r
}\r
\r
.port-handle.port-type-flow.disconnected.direction-output::after {\r
    border-left-color: color-mix(in srgb, var(--port-color, var(--pn-text-muted)) 30%, var(--pn-node-bg));\r
}\r
\r
.port-handle.port-type-flow.disconnected.direction-input::after {\r
    border-right-color: color-mix(in srgb, var(--port-color, var(--pn-text-muted)) 30%, var(--pn-node-bg));\r
}\r
\r
.port-handle.port-type-value.disconnected {\r
    background: color-mix(in srgb, var(--port-color, var(--pn-text-muted)) 30%, var(--pn-node-bg));\r
}\r
\r
/* Invalid: red glow */\r
.port-handle.port-type-flow.invalid::before {\r
    background: var(--pn-accent-danger);\r
}\r
\r
.port-handle.port-type-flow.invalid.direction-output::after {\r
    border-left-color: var(--pn-accent-danger);\r
}\r
\r
.port-handle.port-type-flow.invalid.direction-input::after {\r
    border-right-color: var(--pn-accent-danger);\r
}\r
\r
.port-handle.port-type-value.invalid {\r
    background: var(--pn-accent-danger);\r
}\r
\r
.port-handle.invalid {\r
    filter: drop-shadow(0 0 4px var(--pn-accent-danger));\r
}\r
\r
/* Has-error: red glow (validation error from graph) */\r
.port-handle.port-type-flow.has-error::before {\r
    background: var(--pn-accent-danger, #f38ba8);\r
}\r
\r
.port-handle.port-type-flow.has-error.direction-output::after {\r
    border-left-color: var(--pn-accent-danger, #f38ba8);\r
}\r
\r
.port-handle.port-type-flow.has-error.direction-input::after {\r
    border-right-color: var(--pn-accent-danger, #f38ba8);\r
}\r
\r
.port-handle.port-type-value.has-error {\r
    background: var(--pn-accent-danger, #f38ba8);\r
}\r
\r
.port-handle.has-error {\r
    filter: drop-shadow(0 0 4px var(--pn-accent-danger, #f38ba8));\r
}\r
\r
\r
...
.direct-value-input[type='checkbox'] {\r
    ...
    cursor: pointer;\r
    margin: 0px;\r
}`;var nn=`<!-- Main port. Defining dimensions and -->
<div class="port-wrapper {{this.portDirection}}" style="--port-color: {{this.portColor}}">

    <div class="port {{this.portWrapperClasses}}" [title]="this.portTypeLabel" (pointerdown)="this.onPointerDown($event)">
        <div class="port__handle {{this.portHandleClasses}}"></div>
        <div class="port__label">{{this.portName}}</div>
    </div>

    $if(this.showDirectValueInput) {
        <div class="direct-value-inputs" (pointerdown)="$event.stopImmediatePropagation()">
...
.node-inputs {\r
    ...
    margin-left: var(--pn-node-port-cell-offset);\r
}\r
\r
.node-outputs {\r
    align-items: flex-end;\r
    margin-left: auto;\r
    margin-right: var(--pn-node-port-cell-offset);\r
}\r
\r
...
`;var Qn=`<div class="properties-header">Properties</div>\r
...
`;var ni=`<div class="resize-handle" (pointerdown)="this.onResizePointerDown($event)"></div>
