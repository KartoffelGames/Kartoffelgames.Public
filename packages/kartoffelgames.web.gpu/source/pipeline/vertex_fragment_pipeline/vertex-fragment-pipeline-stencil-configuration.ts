...
import type { StencilOperation } from '../../constant/stencil-operation.enum.ts';
import type { VertexFragmentPipelineStencilConfigurationData } from './vertex-fragment-pipeline.ts';
