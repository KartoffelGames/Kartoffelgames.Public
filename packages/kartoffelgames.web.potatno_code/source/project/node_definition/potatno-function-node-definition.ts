...
/**
 * A live node definition from a PotatnoDocumentFunction.
 *
 * The stable id comes from PotatnoDocumentFunction.id,
 * ensuring that nodes referencing this definition keep their identity across sessions.
 */
