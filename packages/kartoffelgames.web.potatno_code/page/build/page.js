...
.selection-box {\r
    ...
    pointer-events: none;\r
    z-index: 1000;\r
}`;var jn=`<!-- Serves only as a background. -->\r
...
}`;var Qn=`<potatno-resize-box class="resize-box" left="true">\r
\r
    <!-- Function name -->\r
    <div class="section">\r
...
}`;var ai=`<potatno-resize-box class="resize-box" left="true" top="true">\r
    <div class="header">\r
